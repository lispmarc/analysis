...
<\body>
  ...
  <\definition>
    Let <math|a\<in\><around*|[|0,\<infty\>|[>> be a positive number and
    <math|x\<in\>\<bbb-R\>> then <math|a<rsup|x>=exp<around*|(|x\<cdot\>log<around*|(|a|)>|)>>
  </definition>

  <\remark>
    The restrictions in the above definition are needed for
    <math|log<around*|(|a|)>> is only defined if
    <math|a\<in\>\<bbb-R\><rsub|+>=<around*|]|0,\<infty\>|[>>.
  </remark>
  ...
  <\theorem>
    ...
    <math|a\<in\><around*|]|0,\<infty\>|[>> then we that\ 
    ...
    <\enumerate>
      ...
      <item><math|e<rsup|x>=exp<around*|(|x|)>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\>\|a<rsup|n>=<wide*|a*\<ldots\>a|\<wide-underbrace\>><rsub|n
      times>|}>> then we have\ 

      <\description>
        <item*|<math|0\<in\>\<cal-S\>>><math|a<rsup|0>=exp<around*|(|0*\<cdot\>log<around*|(|a|)>|)>=exp<around*|(|0|)>\<equallim\><rsub|<text|<reference|properties
        ...
        <\eqnarray*>
          <tformat|<table|<row|<cell|a<rsup|n+1>>|<cell|=>|<cell|exp<around*|(|<around*|(|n+1|)>\<cdot\>log<around*|(|a|)>|)>>>|<row|<cell|>|<cell|=>|<cell|exp<around*|(|n\<cdot\>log<around*|(|a|)>+log<around*|(|a|)>|\<nobracket\>>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|exp(x+y)=exp(x)exp(y)>>>>|<cell|exp<around*|(|n\<cdot\>log<around*|(|a|)>|)>\<cdot\>exp<around*|(|log<around*|(|a|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|n\<in\>\<cal-S\>>>|<cell|<wide*|a\<ldots\>a|\<wide-underbrace\>><rsub|n
      ...
      <item><math|e<rsup|x>=exp<around*|(|x\<cdot\>log<around*|(|e|)>|)>\<equallim\><rsub|<text|<reference|properties
      of log> (3)>>exp<around*|(|x\<cdot\>1|)>=exp<around*|(|x|)>>

      <item>\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|a<rsup|x>|)><rsup|y>>|<cell|=>|<cell|<around*|(|exp<around*|(|x\<cdot\>log<around*|(|a|)>|)>|)><rsup|y>>>|<row|<cell|>|<cell|=>|<cell|exp<around*|(|y\<cdot\>log<around*|(|exp<around*|(|x\<cdot\>log<around*|(|a|)>|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|exp<around*|(|y\<cdot\><around*|(|x\<cdot\>log<around*|(|a|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|exp<around*|(|<around*|(|x\<cdot\>y|)>\<cdot\>log<around*|(|a|)>|)>>>|<row|<cell|>|<cell|=>|<cell|a<rsup|x\<cdot\>y>>>>>
      </eqnarray*>

      <item><math|log<around*|(|a<rsup|x>|)>=log<around*|(|exp<around*|(|x\<cdot\>log<around*|(|a|)>|)>|)>=x\<cdot\>log<around*|(|a|)>>
    </enumerate>
  </proof>
  ...
  <\theorem>
    ...
    then we have that <math|a\<cdot\>b\<less\><frac|a<rsup|p>|p>+<frac|b<rsup|q>|q>>
  </theorem>
...
<\references>
  <\collection>
    <associate|(a-b)+(c-d)=(a+c)-(b+d)|<tuple|16.21|602>>
    <associate|-sup A=inf -A|<tuple|16.27|605>>
    <associate|0\<less\>=y then z=x+y=\<gtr\>z\<less\>=y|<tuple|16.19|601>>
    <associate|0\<less\>cos(x),sin(x)|<tuple|17.45|676>>
    <associate|Abel-Dirichlet|<tuple|17.15|661>>
    <associate|Balls and convergence domains|<tuple|17.12|659>>
    <associate|Euler's number|<tuple|17.29|668>>
    <associate|Napierian|<tuple|17.33|669>>
    <associate|Power series|<tuple|17.2|657>>
    <associate|Young's inequality|<tuple|17.38|?>>
    <associate|a serie of extented positive reals converges always and is
    independent of the order|<tuple|16.110|650>>
    <associate|a-b=c-d=\<gtr\>a+d=c+b|<tuple|16.22|602>>
    <associate|absolute value in the extended reals|<tuple|16.28|606>>
    <associate|absolute value on the extended real
    properties|<tuple|16.30|606>>
    <associate|adding of positive extented reals|<tuple|16.24|603>>
    <associate|alternative definition of limit in the extented
    reals|<tuple|16.79|638>>
    <associate|alternative graph of sum of functions|<tuple|16.97|647>>
    <associate|associativity of inifinite series|<tuple|16.115|654>>
    <associate|associativity of series of extended reals|<tuple|16.113|652>>
    <associate|auto-1|<tuple|16|593>>
    <associate|auto-10|<tuple|16.32|607>>
    <associate|auto-11|<tuple|16.32|607>>
    <associate|auto-12|<tuple|16.32|607>>
    <associate|auto-13|<tuple|16.33|607>>
    <associate|auto-14|<tuple|16.33|607>>
    <associate|auto-15|<tuple|16.2.1|611>>
    <associate|auto-16|<tuple|16.39|611>>
    <associate|auto-17|<tuple|16.39|611>>
    <associate|auto-18|<tuple|16.39|611>>
    <associate|auto-19|<tuple|16.42|611>>
    <associate|auto-2|<tuple|16.1|593>>
    <associate|auto-20|<tuple|16.43|611>>
    <associate|auto-21|<tuple|16.44|611>>
    <associate|auto-22|<tuple|16.52|619>>
    <associate|auto-23|<tuple|16.52|619>>
    <associate|auto-24|<tuple|16.2.2|632>>
    <associate|auto-25|<tuple|16.60|632>>
    <associate|auto-26|<tuple|16.60|632>>
    <associate|auto-27|<tuple|16.64|634>>
    <associate|auto-28|<tuple|16.64|634>>
    <associate|auto-29|<tuple|16.2.3|645>>
    <associate|auto-3|<tuple|16.2|593>>
    <associate|auto-30|<tuple|16.116|655>>
    <associate|auto-31|<tuple|17|657>>
    <associate|auto-32|<tuple|17.1|657>>
    <associate|auto-33|<tuple|17.1.1|657>>
    <associate|auto-34|<tuple|17.4|657>>
    <associate|auto-35|<tuple|17.4|657>>
    <associate|auto-36|<tuple|17.8|658>>
    <associate|auto-37|<tuple|17.8|658>>
    <associate|auto-38|<tuple|17.1.2|659>>
    <associate|auto-39|<tuple|17.19|662>>
    <associate|auto-4|<tuple|16.8|595>>
    <associate|auto-40|<tuple|17.1.3|662>>
    <associate|auto-41|<tuple|17.29|668>>
    <associate|auto-42|<tuple|17.33|669>>
    <associate|auto-43|<tuple|17.33|669>>
    <associate|auto-44|<tuple|17.40|671>>
    <associate|auto-45|<tuple|17.40|671>>
    <associate|auto-46|<tuple|17.44|676>>
    <associate|auto-5|<tuple|16.8|595>>
    <associate|auto-6|<tuple|16.9|595>>
    <associate|auto-7|<tuple|16.9|595>>
    <associate|auto-8|<tuple|16.2|606>>
    <associate|auto-9|<tuple|16.32|607>>
    <associate|ball inclusion|<tuple|17.11|659>>
    <associate|closed sets in the extended reals|<tuple|16.34|608>>
    <associate|condition for supremum (infinum) to be
    infinite|<tuple|16.11|595>>
    <associate|convergence domain and balls|<tuple|17.7|658>>
    <associate|convergence domain of exponential function|<tuple|17.18|662>>
    <associate|convergence in real implies that lim inferior = lim
    superior|<tuple|16.69|635>>
    <associate|convergence of derived powerseries|<tuple|17.22|663>>
    <associate|convergence of powerseries (1)|<tuple|17.6|657>>
    <associate|convergence radius|<tuple|17.8|658>>
    <associate|countable sum of countable sums is a countable
    sum|<tuple|16.114|654>>
    <associate|d'Alembert|<tuple|17.17|661>>
    <associate|definition of limit in the extented reals|<tuple|16.70|636>>
    <associate|density of the extented reals|<tuple|16.7|595>>
    <associate|derivative of the exponential function|<tuple|17.24|666>>
    <associate|difference in extented reals|<tuple|16.18|601>>
    <associate|distributivity in the extented reals|<tuple|16.25|603>>
    <associate|eq 13.1.123|<tuple|16.6|608>>
    <associate|eq 13.1.300|<tuple|16.1|604>>
    <associate|eq 13.11.40|<tuple|16.18|639>>
    <associate|eq 13.12.40|<tuple|16.19|639>>
    <associate|eq 13.13.40|<tuple|16.20|639>>
    <associate|eq 13.14.41|<tuple|16.21|650>>
    <associate|eq 13.15.41|<tuple|16.22|651>>
    <associate|eq 13.16.41|<tuple|16.23|651>>
    <associate|eq 13.17.50|<tuple|16.30|654>>
    <associate|eq 13.2.123|<tuple|16.7|608>>
    <associate|eq 13.2.300|<tuple|16.2|604>>
    <associate|eq 13.3|<tuple|16.14|635>>
    <associate|eq 13.3.301|<tuple|16.3|605>>
    <associate|eq 13.4|<tuple|16.15|635>>
    <associate|eq 13.4.39|<tuple|16.10|633>>
    <associate|eq 13.5|<tuple|16.16|635>>
    <associate|eq 13.5.39|<tuple|16.11|633>>
    <associate|eq 13.6|<tuple|16.17|635>>
    <associate|eq 13.6.39|<tuple|16.12|633>>
    <associate|eq 13.7.39|<tuple|16.13|633>>
    <associate|eq 14.22.423|<tuple|16.24|652>>
    <associate|eq 14.23.409|<tuple|16.31|655>>
    <associate|eq 14.23.424|<tuple|16.26|653>>
    <associate|eq 14.23.425|<tuple|16.25|652>>
    <associate|eq 14.24.409|<tuple|16.32|655>>
    <associate|eq 14.24.424|<tuple|16.27|653>>
    <associate|eq 14.25.411|<tuple|16.33|655>>
    <associate|eq 14.25.424|<tuple|16.28|653>>
    <associate|eq 14.26.424|<tuple|16.29|653>>
    <associate|eq 14.4.472|<tuple|16.4|605>>
    <associate|eq 14.5.472|<tuple|16.5|606>>
    <associate|eq 17.1.514|<tuple|17.7|662>>
    <associate|eq 17.1.515|<tuple|17.1|657>>
    <associate|eq 17.10.515|<tuple|17.10|663>>
    <associate|eq 17.11.515|<tuple|17.11|663>>
    <associate|eq 17.12.073|<tuple|17.12|665>>
    <associate|eq 17.13.073|<tuple|17.13|666>>
    <associate|eq 17.14.073|<tuple|17.14|666>>
    <associate|eq 17.15.073|<tuple|17.15|667>>
    <associate|eq 17.16.002|<tuple|17.16|667>>
    <associate|eq 17.17.002.1|<tuple|17.17|668>>
    <associate|eq 17.18.002|<tuple|17.18|669>>
    <associate|eq 17.19.002|<tuple|17.19|669>>
    <associate|eq 17.2.514|<tuple|17.8|662>>
    <associate|eq 17.2.515|<tuple|17.2|657>>
    <associate|eq 17.20.003|<tuple|17.20|675>>
    <associate|eq 17.21.003|<tuple|17.21|675>>
    <associate|eq 17.22.003|<tuple|17.22|675>>
    <associate|eq 17.23.003|<tuple|17.23|675>>
    <associate|eq 17.24.004|<tuple|17.24|676>>
    <associate|eq 17.3.515|<tuple|17.3|658>>
    <associate|eq 17.4.515.1|<tuple|17.4|661>>
    <associate|eq 17.5.515|<tuple|17.5|661>>
    <associate|eq 17.6.515|<tuple|17.6|661>>
    <associate|eq 17.9.515|<tuple|17.9|663>>
    <associate|equivalence of limits on increasing (decreasing) sequences of
    extented reals|<tuple|16.75|637>>
    <associate|every non empty set in the extented reals has a
    limit|<tuple|16.10|595>>
    <associate|existance of lim inf and lim sup|<tuple|16.63|633>>
    <associate|exp exceeds every number|<tuple|17.31|668>>
    <associate|exp is a bijection|<tuple|17.32|669>>
    <associate|exp is convex|<tuple|17.28|?>>
    <associate|exp(x) is continuous|<tuple|17.25|666>>
    <associate|exp(x+y)=exp(x)exp(y)|<tuple|17.26|666>>
    <associate|exp(z)|<tuple|17.19|662>>
    <associate|exponential as power|<tuple|17.30|668>>
    <associate|extented reals|<tuple|16.2|593>>
    <associate|finite infinite sum means finite terms|<tuple|16.107|650>>
    <associate|finite sum of constants in the extented
    reals|<tuple|16.102|649>>
    <associate|finite sum of denumerable sums|<tuple|16.112|651>>
    <associate|finite sum of extented reals|<tuple|16.89|645>>
    <associate|finite sum of extented reals properties|<tuple|16.101|648>>
    <associate|finite sum of extented reals starting at n|<tuple|16.90|645>>
    <associate|finite sum of extented reals written as infinite
    sum|<tuple|16.108|650>>
    <associate|finite sum of limits of functions|<tuple|16.98|647>>
    <associate|finite sum of limits of scalar product with
    functions|<tuple|16.100|648>>
    <associate|finite sum of non negative extented reals is non
    negative|<tuple|16.91|645>>
    <associate|graph of sum of functions|<tuple|16.96|647>>
    <associate|increasing (decreasing) sequence|<tuple|16.60|632>>
    <associate|increasing (decreasing) sequence converges|<tuple|16.62|632>>
    <associate|independence of limit inf and limit sup of start
    index|<tuple|16.65|634>>
    <associate|inequality of Abel|<tuple|17.14|660>>
    <associate|infinity can not be a right limit|<tuple|16.41|611>>
    <associate|interchange infinite and finite sum|<tuple|16.111|650>>
    <associate|left (right) continuity|<tuple|16.52|619>>
    <associate|left and right limit implies limit|<tuple|16.48|617>>
    <associate|left limit of a function|<tuple|16.42|611>>
    <associate|left, right limit of sum and scalar product|<tuple|16.47|612>>
    <associate|lemma 15.75|<tuple|16.84|644>>
    <associate|lemma 17.2|<tuple|17.16|661>>
    <associate|lim inf -xn|<tuple|16.67|634>>
    <associate|lim inf and lim sup|<tuple|16.64|634>>
    <associate|lim sup xn+x|<tuple|16.66|634>>
    <associate|limit and absolut value|<tuple|16.80|639>>
    <associate|limit and continuity in the extented reals|<tuple|16.51|619>>
    <associate|limit at infinity of ascending (descending)
    functions|<tuple|16.56|628>>
    <associate|limit for f\<less\>=L or L\<less\>=f|<tuple|16.58|631>>
    <associate|limit for f\<less\>=g|<tuple|16.57|629>>
    <associate|limit n|<tuple|16.86|645>>
    <associate|limit of 1/f|<tuple|16.85|644>>
    <associate|limit of a constant function|<tuple|16.45|612>>
    <associate|limit of a function|<tuple|16.44|611>>
    <associate|limit of constant extented real|<tuple|16.72|636>>
    <associate|limit of constants|<tuple|16.78|637>>
    <associate|limit of finite sums in the extented reals|<tuple|16.94|646>>
    <associate|limit of functions and sequences|<tuple|16.77|637>>
    <associate|limit of monotone functions|<tuple|16.55|626>>
    <associate|limit points|<tuple|16.39|611>>
    <associate|limit points and plus or min infinity|<tuple|16.40|611>>
    <associate|limit xi+x|<tuple|16.73|636>>
    <associate|limits at infinity|<tuple|16.50|618>>
    <associate|limxi=x=\<gtr\>\|x-xi\|-\<gtr\>0|<tuple|16.87|645>>
    <associate|notation for limit of increasing/decreasing
    sequences|<tuple|16.76|637>>
    <associate|open sets and addition scalar
    multiplication|<tuple|16.36|609>>
    <associate|pi|<tuple|17.44|676>>
    <associate|power series 0|<tuple|17.3|657>>
    <associate|properties of exp (1)|<tuple|17.27|667>>
    <associate|properties of exp (2)|<tuple|17.39|671>>
    <associate|properties of general power|<tuple|17.37|?>>
    <associate|properties of log|<tuple|17.34|669>>
    <associate|properties of the limit in the extented
    reals|<tuple|16.81|639>>
    <associate|right limit|<tuple|16.43|611>>
    <associate|series and product with a scalar|<tuple|16.104|649>>
    <associate|series are increasing|<tuple|16.92|646>>
    <associate|series of positive extented reals is
    increasing|<tuple|16.105|649>>
    <associate|sets for basis of topology on the extented
    reals|<tuple|16.32|607>>
    <associate|special cases of limits|<tuple|16.53|619>>
    <associate|sum and order relation in the extented
    reals|<tuple|16.106|649>>
    <associate|sum from -infinity to infinity|<tuple|16.116|655>>
    <associate|sum of extented reals and product|<tuple|16.93|646>>
    <associate|sum of extented reals is indepenent of order the
    reals|<tuple|16.109|650>>
    <associate|sup of set and sum|<tuple|16.26|604>>
    <associate|supremum (infinum) of increasing (decreasing) sequence is
    indpendent of start|<tuple|16.74|636>>
    <associate|supremum, infinum of extented real set|<tuple|16.9|595>>
    <associate|supremum, infinum of real set|<tuple|16.8|595>>
    <associate|the limit inferior is lower then limit
    superior|<tuple|16.68|635>>
    <associate|the positive extented reals form a abelian
    semi-group|<tuple|16.23|603>>
    <associate|the topology on the extented reals is
    Hausdorff|<tuple|16.38|610>>
    <associate|topology on extented reals|<tuple|16.33|607>>
    <associate|trigoniometic properties|<tuple|17.41|671>>
    <associate|trigoniometric functions|<tuple|17.40|671>>
    <associate|uniqueness of limits in extented reals|<tuple|16.46|612>>
    <associate|usefull properties of open sets in the extented reals
    |<tuple|16.54|625>>
    <associate|x+z=y+z=\<gtr\>x=y|<tuple|16.16|598>>
    <associate|x\<less\>=y=\<gtr\>-y\<less\>=-x|<tuple|16.14|597>>
    <associate|x\<less\>=y=\<gtr\>lx\<less\>=ly|<tuple|16.15|597>>
    <associate|x\<less\>=y=\<gtr\>x+z\<less\>=y+z|<tuple|16.17|600>>
    <associate|zero and convergentie domain|<tuple|17.5|657>>
    <associate|zeroes of cos has a minimum|<tuple|17.43|675>>
  </collection>
</references>
