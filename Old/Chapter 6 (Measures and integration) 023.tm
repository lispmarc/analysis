...
<\body>
  ...
  <\definition>
    Let <math|n\<in\>\<bbb-N\><rsub|0>> then we define:
  ...
  <\definition>
    ...
    <math|\<cal-H\><rsup|n>=<around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>\<wedge\>i\<in\>\<bbb-N\><rsub|1<space|1em>>|}>>
  </definition>

  We prove now that <math|\<cal-H\><rsup|n>> is a collection of closed sets.

  <\lemma>
    <label|Lower half spaces are closed>Let <math|n\<in\>\<bbb-N\><rsub|0>>
    then ^<math|\<forall\>H\<in\>\<cal-H\><rsup|n>> we have that <math|H> is
    closed in <math|\<cal-T\><rsub|\<bbb-R\><rsup|n>>>
  </lemma>

  <\proof>
    Take <math|H\<in\>\<cal-H\><rsup|n>> then there exists a
    <math|i\<in\><around*|{|1,\<ldots\>,n|}>> and a <math|a\<in\>\<bbb-R\>>
    such that <math|H=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|x<rsub|i>\<leqslant\>a|}>>.
    Take <math|x\<in\>\<bbb-R\><rsup|n>\\H> then <math|a\<less\>x<rsub|i>> so
    that <math|\<varepsilon\>=x<rsub|i>-a\<gtr\>0>. Let
    <math|y\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|max>><around*|(|x,\<varepsilon\>|)>>
    then <math|x<rsub|i>-y<rsub|i>\<less\><around*|\||y<rsub|i>-x<rsub|i>|\|>\<leqslant\>max<around*|(|<around*|{|<around*|\||y<rsub|i>-x<rsub|i>|\|>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)>\<less\>\<varepsilon\>=x<rsub|i>-a>.
    So <math|x<rsub|i>-y<rsub|i>\<less\>x<rsub|i>-a\<Rightarrow\>a\<less\>y<rsub|i>>
    proving that <math|y\<in\>H> hence <math|x\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|max>><around*|(|x,\<varepsilon\>|)>\<subseteq\>H>.
    So <math|\<bbb-R\><rsup|n>\\H> is open proving that <math|H> is closed.
  </proof>

  <\lemma>
    let <math|n\<in\>\<bbb-N\><rsub|0>> then we have that
    <math|\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>=\<sigma\><around*|[|\<cal-H\><rsup|n>|]>>
  </lemma>

  <\proof>
    If <math|H\<in\>\<cal-H\><rsup|n>> then by the previous lemma [see
    <reference|Lower half spaces are closed>] we have <math|H> is closed
    hence <math|H\<in\>\<sigma\><around*|[|<around*|{|C\<subseteq\>\<bbb-R\><rsup|n>\|C<text|
    is closed in >\<cal-T\><rsub|\<bbb-R\><rsup|n>>|}>|]>\<equallim\><rsub|<text|<reference|Borel
    algebra on R^n (1)>>>\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>>. Hence
    <math|\<cal-H\><rsup|n>\<subseteq\>\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>>
    othat

    <\equation>
      <label|eq 18.60.022>\<sigma\><around*|[|\<cal-H\><rsup|n>|]>\<subseteq\>\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>
    </equation>
...
<\references>
  <\collection>
    ...
    <associate|Borel algebra on R^n|<tuple|18.37|?>>
    <associate|Borel algebra on R^n (1)|<tuple|18.37|?>>
    <associate|Borel algebras on R|<tuple|18.23|?>>
    <associate|Caratheodore|<tuple|18.53|?>>
    <associate|Dyadic cube properties|<tuple|18.33|?>>
    <associate|Dyadic cubes|<tuple|18.30|?>>
    <associate|Dyadic interval basic property|<tuple|18.32|?>>
    <associate|Lebesgue measure space|<tuple|18.59|?>>
    <associate|Lower half spaces|<tuple|18.38|?>>
    <associate|Lower half spaces are closed|<tuple|18.39|?>>
    <associate|R can be covered by open intervals|<tuple|18.56|?>>
    ...
    <associate|auto-15|<tuple|Lower half spaces|?>>
    <associate|auto-16|<tuple|18.3|?>>
    <associate|auto-17|<tuple|18.3.1|?>>
    <associate|auto-18|<tuple|18.3.2|?>>
    <associate|auto-19|<tuple|Carathéodory theorem|?>>
    <associate|auto-2|<tuple|18.1|?>>
    <associate|auto-20|<tuple|18.3.3|?>>
    <associate|auto-21|<tuple|Lebesgue measurable space|?>>
    <associate|auto-22|<tuple|Lebesgue measure|?>>
    <associate|auto-23|<tuple|Lebesgue measurable set|?>>
    ...
    <associate|countable additivity implies additivity|<tuple|18.43|?>>
    ...
    <associate|eq 18.108.021|<tuple|18.110|?>>
    <associate|eq 18.109.021|<tuple|18.111|?>>
    <associate|eq 18.11.021|<tuple|18.11|?>>
    <associate|eq 18.111.021|<tuple|18.112|?>>
    <associate|eq 18.112.021|<tuple|18.114|?>>
    <associate|eq 18.112.021.1|<tuple|18.113|?>>
    <associate|eq 18.113.021|<tuple|18.115|?>>
    <associate|eq 18.114.021|<tuple|18.116|?>>
    <associate|eq 18.115.021|<tuple|18.117|?>>
    <associate|eq 18.116.021|<tuple|18.118|?>>
    <associate|eq 18.117.021|<tuple|18.119|?>>
    <associate|eq 18.118.021|<tuple|18.120|?>>
    <associate|eq 18.119.021|<tuple|18.121|?>>
    <associate|eq 18.12.021|<tuple|18.12|?>>
    <associate|eq 18.120.021|<tuple|18.122|?>>
    <associate|eq 18.121.021|<tuple|18.123|?>>
    <associate|eq 18.122.021|<tuple|18.124|?>>
    <associate|eq 18.123.021|<tuple|18.125|?>>
    ...
    <associate|eq 18.36.016|<tuple|18.61|?>>
    <associate|eq 18.36.021|<tuple|18.36|?>>
    <associate|eq 18.37.016|<tuple|18.62|?>>
    <associate|eq 18.37.021|<tuple|18.37|?>>
    <associate|eq 18.38.016|<tuple|18.63|?>>
    <associate|eq 18.38.021|<tuple|18.38|?>>
    <associate|eq 18.39.016|<tuple|18.63|?>>
    <associate|eq 18.39.022|<tuple|18.39|?>>
    <associate|eq 18.4.016|<tuple|18.4|?>>
    <associate|eq 18.40.016|<tuple|18.65|?>>
    <associate|eq 18.40.022|<tuple|18.40|?>>
    <associate|eq 18.41.016|<tuple|18.66|?>>
    <associate|eq 18.41.022|<tuple|18.41|?>>
    <associate|eq 18.42.016|<tuple|18.67|?>>
    <associate|eq 18.42.022|<tuple|18.42|?>>
    <associate|eq 18.43.016|<tuple|18.68|?>>
    <associate|eq 18.43.022|<tuple|18.43|?>>
    <associate|eq 18.44.016|<tuple|18.69|?>>
    <associate|eq 18.44.022|<tuple|18.44|?>>
    <associate|eq 18.45.016|<tuple|18.70|?>>
    <associate|eq 18.45.022|<tuple|18.45|?>>
    <associate|eq 18.46.016|<tuple|18.71|?>>
    <associate|eq 18.46.022|<tuple|18.46|?>>
    <associate|eq 18.47.016|<tuple|18.72|?>>
    <associate|eq 18.47.022|<tuple|18.47|?>>
    <associate|eq 18.48.016|<tuple|18.73|?>>
    <associate|eq 18.48.022|<tuple|18.48|?>>
    <associate|eq 18.49.016|<tuple|18.74|?>>
    <associate|eq 18.49.022|<tuple|18.49|?>>
    <associate|eq 18.50.016|<tuple|18.75|?>>
    <associate|eq 18.50.022|<tuple|18.50|?>>
    <associate|eq 18.51.016|<tuple|18.76|?>>
    <associate|eq 18.51.022|<tuple|18.51|?>>
    <associate|eq 18.52.016|<tuple|18.86|?>>
    <associate|eq 18.52.018|<tuple|18.77|?>>
    <associate|eq 18.52.022|<tuple|18.52|?>>
    <associate|eq 18.53.016|<tuple|18.87|?>>
    <associate|eq 18.53.018|<tuple|18.78|?>>
    <associate|eq 18.53.022|<tuple|18.53|?>>
    <associate|eq 18.54.016|<tuple|18.88|?>>
    <associate|eq 18.54.018|<tuple|18.79|?>>
    <associate|eq 18.54.022|<tuple|18.54|?>>
    <associate|eq 18.55.016|<tuple|18.89|?>>
    <associate|eq 18.55.018|<tuple|18.80|?>>
    <associate|eq 18.55.022|<tuple|18.55|?>>
    <associate|eq 18.56.016|<tuple|18.90|?>>
    <associate|eq 18.56.018|<tuple|18.81|?>>
    <associate|eq 18.56.022|<tuple|18.56|?>>
    <associate|eq 18.57.016|<tuple|18.91|?>>
    <associate|eq 18.57.018|<tuple|18.82|?>>
    <associate|eq 18.57.022|<tuple|18.57|?>>
    <associate|eq 18.58.016|<tuple|18.92|?>>
    <associate|eq 18.58.018|<tuple|18.83|?>>
    <associate|eq 18.58.022|<tuple|18.58|?>>
    <associate|eq 18.59.016|<tuple|18.93|?>>
    <associate|eq 18.59.018|<tuple|18.84|?>>
    <associate|eq 18.59.022|<tuple|18.59|?>>
    <associate|eq 18.60.016|<tuple|18.94|?>>
    <associate|eq 18.60.018|<tuple|18.85|?>>
    <associate|eq 18.60.022|<tuple|18.60|?>>
    <associate|eq 18.61.016|<tuple|18.95|?>>
    <associate|eq 18.62.016|<tuple|18.96|?>>
    <associate|eq 18.74.018|<tuple|18.97|?>>
    <associate|eq 18.75.018|<tuple|18.98|?>>
    <associate|eq 18.76.018|<tuple|18.99|?>>
    <associate|eq 18.77.018|<tuple|18.100|?>>
    <associate|eq 18.78.018|<tuple|18.101|?>>
    <associate|eq 18.79.018|<tuple|18.102|?>>
    <associate|eq 18.8.020|<tuple|18.8|?>>
    <associate|eq 18.80.018|<tuple|18.103|?>>
    <associate|eq 18.81.018|<tuple|18.104|?>>
    <associate|eq 18.82.018|<tuple|18.105|?>>
    <associate|eq 18.83.018|<tuple|18.106|?>>
    <associate|eq 18.84.018|<tuple|18.107|?>>
    <associate|eq 18.85.018|<tuple|18.108|?>>
    <associate|eq 18.86.018|<tuple|18.109|?>>
    ...
    <associate|measurable set alternative definition|<tuple|18.52|?>>
    <associate|measurable space|<tuple|18.10|?>>
    <associate|measure|<tuple|18.42|?>>
    <associate|measure is subadditive|<tuple|18.45|?>>
    <associate|measure properties (1)|<tuple|18.44|?>>
    <associate|measure properties (2)|<tuple|18.46|?>>
    <associate|measureable set|<tuple|18.51|?>>
    <associate|open,half open and bounded intervals are
    different|<tuple|18.21|?>>
    <associate|outer measure|<tuple|18.48|?>>
    <associate|outer measure finite subadditivity|<tuple|18.49|?>>
    <associate|outer measure on R|<tuple|18.58|?>>
    <associate|outermeasure construction|<tuple|18.50|?>>
    <associate|properties of algebras|<tuple|18.7|?>>
    <associate|semi additivity of the length in the reals|<tuple|18.57|?>>
    ...
    <associate|the set of Dyadic cubes is denumerable|<tuple|18.34|?>>
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      ...
      <tuple|<tuple|Lower half spaces>|<pageref|auto-15>>

      <tuple|<tuple|Carathéodory theorem>|<pageref|auto-19>>

      <tuple|<tuple|Lebesgue measurable space>|<pageref|auto-21>>

      <tuple|<tuple|Lebesgue measure>|<pageref|auto-22>>

      <tuple|<tuple|Lebesgue measurable set>|<pageref|auto-23>>
    </associate>
    <\associate|toc>
