...
<\body>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      and <math|f<around*|(|x<around*|(|g<around*|(|x,z|)>|)>|)>=z>.
      ...
      <item>Further <math|\<forall\>x,z\<in\>W<rsub|0>>\ 
    ...
    <\proof>
      ...
      <\equation>
        \<pi\><rsup|X\<times\>Y><rsub|1>,\<pi\><rsup|X\<times\>Y><rsub|2>,\<pi\><rsup|X\<times\>Z><rsub|1><infix-and>\<pi\><rsup|X\<times\>Z><rsub|2><infix-and>their
        restrictions to open sets \ are of class C<rsup|\<infty\>>
      </equation>
      ...
      then as <math|\<forall\><around*|(|x,y|)>\<in\>U\<times\>V> we have
      that\ 
      ...
      with <math|<around*|(|x<rsub|0>,y<rsub|0>|)>\<in\>U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>>
      ...
      <\equation>
        <label|eq 14.249.112>x=\<pi\><rsup|X\<times\>Y><rsub|1><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>>|)><rsup|-1><around*|(|x,z|)>|)><infix-and>z=f<around*|(|x,\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>>|)><rsup|-1><around*|(|x,z|)>|)>|)>
      </equation>
      ...
      <\equation>
        ...
        g<around*|(|z|)>=\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>>|)><rsup|-1><around*|(|x,z|)>|)>\<in\>\<pi\><rsup|X\<times\>Y><rsub|2><around*|(|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>|)>\<subseteq\><rsub|>V
        <around*|[|as U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>\<subseteq\>U\<times\>V|]>
      </equation>

      where\ 

      <\equation>
        <label|eq 14.251.112.1>V<rsub|0>=\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>|)>
      ...
      <math|C<rsup|\<infty\>>> and <math|><math|<around*|(|\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>>|)><rsup|-1>><space|1em>is
      ...
      and derive a contradiction. As <math|<around*|(|x<rsub|1>,z<rsub|1>|)>\<in\>W<rsub|0>=V<rsub|\<varphi\><around*|(|x<rsub|0>,y<rsub|0>|)>>\<equallim\><rsub|<text|<reference|eq
      12.129>>>\<varphi\><rsub|\|U<around*|(|x<rsub|0>,y<rsub|0>|)>><around*|(|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>|)>>
      ...
      <\equation>
        <label|eq 14.255.112><around*|(|x<rsub|1>,g<around*|(|x<rsub|1>,z<rsub|1>|)>|)>,<around*|(|x<rsub|2>,h<around*|(|x<rsub|2>,z<rsub|2>|)>|)>\<in\>U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>
      </equation>

      So that\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>><around*|(|x<rsub|1>,g<around*|(|x<rsub|1>,z<rsub|1>|)>|)>>|<cell|\<equallim\><rsub|<text|<reference|eq
        ...
        14.255.112>>>>|<cell|\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>><around*|(|x<rsub|1>,h<around*|(|x<rsub|1>,z<rsub|1>|)>|)>>>>>
      </eqnarray*>

      which as <math|><math|\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>>>
      ...
      Now to prove <math|<around*|(|2.a|)>> note that by <reference|eq
      12.128> and <reference|diffeomorphism are toplinear> we have
      <math|\<forall\><around*|(|x,y|)>\<in\>U<rsub|x<rsub|0>,y<rsub|0>>>
      that <math|D <around*|(|\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>>|)><around*|(|x,y|)>>
      is bijective or using the fact that <math|D
      <around*|(|\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>>|)><around*|(|x,y|)>\<equallim\><rsub|<text|<reference|differentiability
      and restricted mapping>>>D \<varphi\><around*|(|x,y|)>> we have\ 

      <\equation>
        <label|eq 14.256.112.3>\<forall\><around*|(|x,y|)>\<in\>U<rsub|x<rsub|0>,y<rsub|0>><space|1em>D\<varphi\><around*|(|x,y|)>
        \ is bijective
      </equation>
      ...
      <\eqnarray*>
        ...
        14.247.112.3>>>>|<cell|<around*|(|0,D<rsub|1>f<around*|(|x,y|)><around*|(|0|)>+D<rsub|2>f<around*|(|x,f<around*|(|x,y|)>|)><around*|(|r|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|0,D<rsub|1>f<around*|(|x,y|)><around*|(|0|)>+D<rsub|2>f<around*|(|x,f<around*|(|x,y|)>|)><around*|(|s|)>|)>>>|<row|<cell|>|<cell|=>|<cell|D\<varphi\><around*|(|x,y|)><around*|(|0,s|)>>>>>
      </eqnarray*>

      proving as <math|D \<varphi\><around*|(|x,y|)>> is bijective that
      <math|r=s> or that <math|D<rsub|2>f<around*|(|x,y|)>> is bijective.\ 

      <\equation>
        <label|eq 14.258.112.4>D<rsub|2>f<around*|(|x,y|)> is injective hence
        </equation>
      ...
      <reference|eq 14.258.112.4> proves that
      <math|D<rsub|2>f<around*|(|x,y|)>> is bijective and TODO

      <\equation>
        <label|eq 14.259.112.4>D<rsub|2>f<around*|(|x,g<around*|(|x,y|)>|)>
        is bijective
      </equation>
      ...
      \ <math|<around*|\<nobracket\>|D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>\<circ\>D<rsub|1>g<around*|(|x,z|\<nobracket\>>|)>=-><math|D<rsub|1>f<around*|(|x,g<around*|(|x,z|)>|)>>.\ 

      <\equation*>
        D<rsub|1><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>=D
        f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\><around*|(|D<rsub|1>\<psi\><around*|(|x,z|)>+D<rsub|2>\<psi\><around*|(|x,z|)>\<circ\>D<rsub|1>g<around*|(|x,z|)>|)>
      </equation*>
...
<\references>
  <\collection>
    ...
    <associate|D(f@g) where g is multivalued|<tuple|14.44|?>>
    ...
    <associate|eq 12.128|<tuple|14.248|470>>
    <associate|eq 12.129|<tuple|14.249|?>>
    <associate|eq 12.130|<tuple|14.251|470>>
    <associate|eq 12.131|<tuple|14.260|471>>
    <associate|eq 12.132|<tuple|14.261|471>>
    <associate|eq 12.133|<tuple|14.262|471>>
    <associate|eq 12.134|<tuple|14.265|471>>
    <associate|eq 12.135|<tuple|14.266|471>>
    <associate|eq 12.136|<tuple|14.267|471>>
    <associate|eq 12.137|<tuple|14.268|471>>
    <associate|eq 12.138|<tuple|14.269|471>>
    <associate|eq 12.139|<tuple|14.270|471>>
    <associate|eq 12.140|<tuple|14.271|471>>
    <associate|eq 12.141|<tuple|14.271|471>>
    ...
    <associate|eq 14.247.3|<tuple|14.247|?>>
    <associate|eq 14.249.112|<tuple|14.250|?>>
    <associate|eq 14.25.101|<tuple|14.41|?>>
    <associate|eq 14.25.110|<tuple|14.25|?>>
    <associate|eq 14.251.112.1|<tuple|14.252|?>>
    ...
    <associate|eq 14.259.112|<tuple|14.263|?>>
    <associate|eq 14.259.112.4|<tuple|14.259|?>>
    <associate|eq 14.26.101|<tuple|14.42|?>>
    <associate|eq 14.260.112|<tuple|14.264|?>>
