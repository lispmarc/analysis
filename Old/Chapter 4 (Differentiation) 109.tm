...
<\body>
  ...
  <\corollary>
    ...
    exists with <math|<around*|(|\<bbb-1\><rsub|X>+H|)><rsup|-1>=\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>>
  </corollary>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|H>|<cell|=>|<cell|L+<around*|(|H-L|)>>>|<row|<cell|>|<cell|=>|<cell|L\<circ\>\<bbb-1\><rsub|X>+<around*|(|L\<circ\>L<rsup|-1>|)>\<circ\><around*|(|H-L|)>>>|<row|<cell|>|<cell|=>|<cell|L\<circ\><around*|(|\<bbb-1\><rsub|X>+L<rsup|-1>\<circ\><around*|(|H-L|)>|)>>>>>
      </eqnarray*>
      ...
      <math|<around*|(|\<bbb-1\><rsub|X>+H|)>\<in\>\<cal-G\>L<around*|(|X|)>>
      and <math|<around*|(|\<bbb-1\><rsub|X>+H|)><rsup|-1>=<big|sum><rsub|i=1><rsup|\<infty\>><around*|(|-1|)>\<cdot\><around*|\<\|\|\>|H|\<\|\|\>><rsup|i>\<equallim\><rsub|<text|<reference|subserie
      property>>>-H+<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>>.
      As <math|H,<around*|(|\<bbb-1\><rsub|X>+H|)><rsup|-1>\<in\>L<around*|(|X,X|)>>\ 

      \;

      \;

      consider the following cases for <math|L>:

      <\description>
        <item*|<math|L=\<bbb-1\><rsub|X>>>If
        <math|H\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|\<bbb-1\><rsub|X>,1|)>>
        then <math|<around*|\<\|\|\>|H-\<bbb-1\><rsub|X>|\<\|\|\>>\<leqslant\>1>
        so using <reference|I+H has inverse if norm of H is less then 1> it
        follows that <math|H=\<bbb-1\><rsub|X>+<around*|(|H-\<bbb-1\><rsub|X>|)>\<in\>\<cal-G\>L<around*|(|X|)>>
        proving\ 

        <\equation>
          <label|eq 14.163.107>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|\<bbb-1\><rsub|X>,1|)>\<subseteq\>\<cal-G\>L<around*|(|X|)>
        </equation>

        Further if <math|H\<in\>L<around*|(|X,X|)>> with
        <math|<around*|\<\|\|\>|H|\<\|\|\>>\<less\>1> then we have\ 
        ...
        As <math|><math|\<tau\><around*|(|\<bbb-1\><rsub|X>+H|)>,\<tau\><around*|(|\<bbb-1\><rsub|X>|)>,H\<in\>L<around*|(|X,X|)>>
        and <math|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>\<equallim\><rsub|<text|<reference|eq
        14.164.107>>>\<tau\><rsub|X><around*|(|\<bbb-1\><rsub|X>+H|)>-\<tau\><rsub|X><around*|(|\<bbb-1\><rsub|X>|)>+H>
        it follows that\ 

        <\equation>
          <label|eq 14.165.107><big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>\<in\>L<around*|(|X,X|)>
        </equation>
        ...
        <\eqnarray*>
          ...
          H=0>>|<row|<cell|<frac|1|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i><around*|(|\<alpha\>\<cdot\>x+\<beta\>\<cdot\>y|)>
          ...
          14.165.107>>>>|<cell|>>|<row|<cell|<choice|<tformat|<table|<row|<cell|\<alpha\>\<cdot\>C<rsub|X,X,0><around*|(|x|)>+\<beta\>\<cdot\>C<rsub|X,X,0><around*|(|y|)>
        ...
        <\eqnarray*>
          ...
          H\<neq\>0>>>>>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|max<around*|(|0,<around*|\||<frac|1<rsub|>|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><around*|\<\|\|\>|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|\<\|\|\>>|\<nobracket\>>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|1<rsub|>|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><around*|\<\|\|\>|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X>>>>>
        </eqnarray*>

        proving by <reference|continuous linear maps in a normed space> that\ 

        <\equation>
          <label|eq 14.166.107.1>\<forall\>H\<in\>L<around*|(|X,X|)> with
          <around*|\<\|\|\>|H|\<\|\|\>>\<less\>1<space|1em>we have
          \ \<varepsilon\><around*|(|H|)>\<in\>L<around*|(|X,X|)><infix-and><around*|\<\|\|\>|\<varepsilon\><around*|(|H|)>|\<\|\|\>>\<leqslant\><frac|1<rsub|>|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><around*|\<\|\|\>|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|\<\|\|\>>
        </equation>

        hence we can define the function <math|\<varepsilon\>> \ 

        <\equation>
          <label|eq 14.166.107>\<varepsilon\>:B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|0,1|)>\<rightarrow\>L<around*|(|X,X|)>
        ...
        <\equation>
          <label|eq 14.167.107>\<tau\><around*|(|\<bbb-1\><rsub|H>+H|)>-\<tau\><around*|(|\<bbb-1\><rsub|X>|)>-<around*|(|-\<bbb-1\><rsub|X>\<circ\>H\<circ\>\<bbb-1\><rsub|X>|)>=\<varepsilon\><around*|(|H|)>\<cdot\><around*|\<\|\|\>|H|\<\|\|\>>
        </equation>
        ...
        Further as using <reference|power of a continuous linear mapping is
        linear and continuous> we have that
        <math|<around*|\<\|\|\>|<around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|\<\|\|\>>=<around*|\<\|\|\>|H<rsup|i>|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|H|\<\|\|\>><rsup|i>>
        we can apply dominent convertgence [see <reference|convergent
        criteria of a serie in a Banach space>] on <reference|eq 14.168.107>
        proving that <math|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H>
        converges and that <math|<around*|\<\|\|\>|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|\<\|\|\>>\<leqslant\><frac|<around*|\<\|\|\>|H|\<\|\|\>><rsup|2>|1-<around*|\<\|\|\>|H|\<\|\|\>>>>.
        So using <reference|eq 14.166.107.1> we have\ 
        ...
        is a <math|\<varepsilon\>>-mapping [see <reference|e-mappings>]. As
        by <reference|eq 14.167.107><math|>
        ...
        and <math|-\<bbb-1\><rsub|X>\<circ\>H\<circ\>\<bbb-1\><rsub|X>\<in\>L<around*|(|X,X|)>>
        we have by <reference|alternative definition of differentiability
        (2)> we have that\ 

        <\equation>
          <label|eq 14.171.108>D \<tau\><around*|(|\<bbb-1\><rsub|X>|)>
          exist<infix-and>D\<tau\><around*|(|\<bbb-1\><rsub|X>|)><around*|(|H|)>=-\<bbb-1\><rsub|X>\<circ\>H\<circ\>\<bbb-1\><rsub|X>
        </equation>
        ...
        and as <math|<around*|(|\<bbb-1\><rsub|X>+H\<circ\>L<rsup|-1>|)>\<circ\>L=\<bbb-1\><rsub|X>\<circ\>L+H\<circ\>L\<circ\>L<rsup|-1>=L+H>
        it follows that\ 

        <\equation>
          <label|eq 14.173.108>\<forall\>H\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|0,\<delta\>|)>
          we have L+H\<in\>\<b-G\>L<around*|(|X|)>
        </equation>
      ...
      <\enumerate>
        ...
        <math|\<bbb-1\><rsub|X>\<in\>\<cal-G\>L<around*|(|X|)>> with
        <math|\<forall\>H\<in\>L<around*|(|X,X|)>> that
        <math|D\<tau\><around*|(|1<rsub|X>|)><around*|(|H|)>=-<around*|(|\<bbb-1\><rsub|X>|)><rsup|-1>\<circ\>H\<circ\><around*|(|\<bbb-1\><rsub|X>|)><rsup|-1>>.
...
<\references>
  <\collection>
    ...
    <associate|GL(X) is a group|<tuple|14.143|458>>
    ...
    <associate|Mean value theorem for balls|<tuple|14.120|?>>
    ...
    <associate|eq 12.100|<tuple|14.199|467>>
    <associate|eq 12.101|<tuple|14.200|468>>
    <associate|eq 12.102|<tuple|14.201|468>>
    <associate|eq 12.103|<tuple|14.202|468>>
    <associate|eq 12.104|<tuple|14.203|468>>
    <associate|eq 12.105|<tuple|14.204|468>>
    <associate|eq 12.106|<tuple|14.205|468>>
    <associate|eq 12.107|<tuple|14.206|468>>
    <associate|eq 12.108|<tuple|14.207|468>>
    <associate|eq 12.109|<tuple|14.208|468>>
    <associate|eq 12.12|<tuple|14.23|422>>
    <associate|eq 12.128|<tuple|14.211|470>>
    <associate|eq 12.129|<tuple|14.212|?>>
    <associate|eq 12.130|<tuple|14.213|470>>
    <associate|eq 12.131|<tuple|14.217|471>>
    <associate|eq 12.132|<tuple|14.218|471>>
    <associate|eq 12.133|<tuple|14.219|471>>
    <associate|eq 12.134|<tuple|14.220|471>>
    <associate|eq 12.135|<tuple|14.221|471>>
    <associate|eq 12.136|<tuple|14.222|471>>
    <associate|eq 12.137|<tuple|14.223|471>>
    <associate|eq 12.138|<tuple|14.224|471>>
    <associate|eq 12.139|<tuple|14.225|471>>
    <associate|eq 12.140|<tuple|14.226|471>>
    <associate|eq 12.141|<tuple|14.226|471>>
    ...
    <associate|eq 12.76|<tuple|14.175|462>>
    <associate|eq 12.77|<tuple|14.176|462>>
    <associate|eq 12.78|<tuple|14.177|462>>
    <associate|eq 12.79|<tuple|14.178|462>>
    <associate|eq 12.80|<tuple|14.179|463>>
    <associate|eq 12.81|<tuple|14.180|463>>
    <associate|eq 12.82|<tuple|14.181|463>>
    <associate|eq 12.83|<tuple|14.182|463>>
    <associate|eq 12.84|<tuple|14.183|463>>
    <associate|eq 12.85|<tuple|14.184|463>>
    <associate|eq 12.86|<tuple|14.185|464>>
    <associate|eq 12.87|<tuple|14.186|465>>
    <associate|eq 12.88|<tuple|14.187|466>>
    <associate|eq 12.89|<tuple|14.188|466>>
    <associate|eq 12.9|<tuple|14.190|466>>
    <associate|eq 12.90|<tuple|14.189|466>>
    <associate|eq 12.92|<tuple|14.191|466>>
    <associate|eq 12.93|<tuple|14.192|466>>
    <associate|eq 12.94|<tuple|14.193|466>>
    <associate|eq 12.95|<tuple|14.194|466>>
    <associate|eq 12.96|<tuple|14.195|467>>
    <associate|eq 12.97|<tuple|14.196|467>>
    <associate|eq 12.98|<tuple|14.197|467>>
    <associate|eq 12.99|<tuple|14.198|467>>
    ...
    <associate|eq 14.149.020|<tuple|14.209|?>>
    <associate|eq 14.149.107|<tuple|14.149|?>>
    <associate|eq 14.15.100|<tuple|14.16|?>>
    <associate|eq 14.150.020|<tuple|14.210|?>>
    <associate|eq 14.150.107|<tuple|14.150|?>>
    <associate|eq 14.16.100|<tuple|14.17|?>>
    <associate|eq 14.160.107|<tuple|14.160|?>>
    <associate|eq 14.163.107|<tuple|14.163|?>>
    <associate|eq 14.164.107|<tuple|14.164|?>>
    <associate|eq 14.165.107|<tuple|14.165|?>>
    <associate|eq 14.166.107|<tuple|14.167|?>>
    <associate|eq 14.166.107.1|<tuple|14.166|?>>
    <associate|eq 14.167.107|<tuple|14.168|?>>
    <associate|eq 14.168.107|<tuple|14.169|?>>
    <associate|eq 14.17.100|<tuple|14.18|?>>
    <associate|eq 14.170.108|<tuple|14.170|?>>
    <associate|eq 14.171.108|<tuple|14.171|?>>
    <associate|eq 14.172.108|<tuple|14.172|?>>
    <associate|eq 14.173.108|<tuple|14.173|?>>
    <associate|eq 14.174.108|<tuple|14.173|?>>
    ...
    <associate|evaluation function of L^m(X;Y)|<tuple|14.137|?>>
    ...
    toplinear|<tuple|14.141|458>>
    <associate|inverse function theorem|<tuple|14.158|465>>
    <associate|inverse mapping is c-infinite|<tuple|14.151|461>>
    ...
    <associate|sum of linear function and infinite sum|<tuple|14.148|459>>
    ...
    <associate|toplinear in normed space|<tuple|14.140|457>>
