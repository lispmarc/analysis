...
<\body>
  <assign|chapter-nr|12><chapter|Differentiability in normed vector spaces>
  ...
  A function is differentiable at a point if we can aproximate the function
  with a continuous linear function in a small enough neighborhood around the
  point. To ensure that we don't have to worry that we evaluate the function
  outside its domain we define given a set <math|U> the set <math|U<rsub|x>>.
  ...
  <\proof>
    This follows directly from <reference|normed space properties>.
  </proof>
  ...
  <\theorem>
    ...
    <math|U<rsub|x>=U-x=<around*|{|y-x\|y\<in\>U|}>>
  </theorem>

  <\proof>
    If <math|h\<in\>U<rsub|x>\<Rightarrow\>y=x+h\<in\>U\<Rightarrow\>h=y-x,y\<in\>U\<Rightarrow\>h\<in\>U<rsub|x>>.
    If <math|h\<in\>U-x\<Rightarrow\>\<exists\>y\<in\>U> such that
    <math|h=y-x\<Rightarrow\>x+h=y\<in\>U\<Rightarrow\>h\<in\>U<rsub|x>>.
  </proof>

  Let's now define the differentiability of a function, normally people
  define differentiability for a function <math|f:U\<rightarrow\>Y> where
  <math|U\<subseteq\>X> is a open set and <math|X,Y>are normed spaces.
  However when we have to work with diffeomorph functions, we will encounter
  bijective functions <math|f:U\<rightarrow\>V> where <math|U,V> are open
  sets in respectively <math|X,Y>, to avoid any ambiguity we define thus
  differentiability for functions <math|f:U\<rightarrow\>V>.\ 
  ...
  Next we will prove that the linear aproximation of <math|f> is unique.

  <\theorem>
    <label|uniqueness of differential>Let
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be real normed space, <math|U\<subseteq\>X> a open
    set,<math|V\<subseteq\>Y>, <math|x\<in\>U> and <math|f:U\<rightarrow\>V>
    differentiable at <math|x> then the <math|L> used in the above definition
    is unique
  </theorem>

  <\proof>
    We prove this by contradiction, so assume that there exists
    <math|L<rsub|1>,L<rsub|2>> with <math|L<rsub|1>\<neq\>L<rsub|2>> that
    satisfies the definition of differentiability. By the definition of
    <math|L<rsub|1>,L<rsub|2>> giving a <math|\<varepsilon\>\<gtr\>0> there
    exists a <math|\<delta\><rsub|1>,\<delta\><rsub|2>> such that if
    <math|h\<in\>U<rsub|x>> and <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|i>>
    then <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-L<rsub|i><around*|(|h|)>|\<\|\|\>><rsub|Y>\<leqslant\><frac|\<varepsilon\>|2>>,
    <math|i\<in\><around*|{|1,2|}>>. As <math|U> is open there exists a
    <math|\<delta\><rprime|'>\<gtr\>0> such that
    <math|B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\><rprime|'>|)>\<subseteq\>U>.
    Take then <math|\<delta\>=min<around*|(|\<delta\><rsub|1>,\<delta\><rsub|2>,\<delta\><rprime|'>|)>>
    and consider the following exclusive cases for <math|h> with
    <math|h\<in\>X>

    <\enumerate>
      <item><dueto|<math|h=0>>then <math|<around*|\<\|\|\>|L<rsub|1><around*|(|h|)>-L<rsub|2><around*|(|h|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|L<rsub|1><around*|(|0|)>-L<rsub|2><around*|(|0|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|0-0|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|0|\<\|\|\>>=0\<leqslant\>\<varepsilon\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>

      <item><dueto|<math|h\<neq\>0>>then <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<neq\>0>
      take <math|h<rprime|'>=<frac|\<delta\>|2<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>\<cdot\>h>
      then <math|<around*|\<\|\|\>|h<rprime|'>|\<\|\|\>><rsub|X>=<frac|\<delta\>|2<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>=<frac|\<delta\>|2>>
      so that <math|<around*|\<\|\|\>|<around*|(|x+h<rprime|'>|)>-x|\<\|\|\>><rsub|X>=<around*|\<\|\|\>|h<rprime|'>|\<\|\|\>><rsub|X>\<leqslant\><frac|\<delta\><rprime|'>|2>\<less\>\<delta\><rprime|'>\<Rightarrow\>x+h<rprime|'>\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\><rprime|'>|)>\<subseteq\>U\<Rightarrow\>h<rprime|'>\<in\>U<rsub|x>>.
      Also <math|<around*|\<\|\|\>|h<rprime|'>|\<\|\|\>><rsub|X>\<leqslant\><frac|\<delta\><rsub|i>|2>\<less\>\<delta\><rsub|i>>
      so that <math|<around*|\<\|\|\>|f<around*|(|x+h<rprime|'>|)>-f<around*|(|x|)>-L<rsub|i><around*|(|h<rprime|'>|)>|\<\|\|\>><rsub|Y>\<leqslant\><frac|\<varepsilon\>|2>\<cdot\><around*|\<\|\|\>|h<rprime|'>|\<\|\|\>>\<Rightarrow\><around*|\<\|\|\>|L<rsub|2><around*|(|h<rprime|'>|)>-L<rsub|1><around*|(|h<rprime|'>|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|f<around*|(|x+h<rprime|'>|)>-f<around*|(|x|)>-L<rsub|1><around*|(|h<rprime|'>|)>-<around*|(|f<around*|(|x+h<rprime|'>|)>-f<around*|(|x|)>-L<rsub|2><around*|(|h<rprime|'>|)>|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|f<around*|(|x+h<rprime|'>|)>-f<around*|(|x|)>-L<rsub|1><around*|(|h<rprime|'>|)>|\<\|\|\>><rsub|Y>+<around*|\<\|\|\>|f<around*|(|x+h<rprime|'>|)>-f<around*|(|x|)>-L<rsub|2><around*|(|h<rprime|'>|)>|\<\|\|\>><rsub|Y>\<leqslant\><frac|\<varepsilon\>|2>\<cdot\><around*|\<\|\|\>|h<rprime|'>|\<\|\|\>><rsub|X>+<frac|\<varepsilon\>|2>\<cdot\><around*|\<\|\|\>|h<rprime|'>|\<\|\|\>><rsub|X>=\<varepsilon\>\<cdot\><around*|\<\|\|\>|h<rprime|'>|\<\|\|\>><rsub|X>\<Rightarrow\><frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>><around*|\<\|\|\>|L<rsub|2><around*|(|h|)>-L<rsub|1><around*|(|h|)>|\<\|\|\>><rsub|Y>\<equallim\><rsub|<frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>\<gtr\>0\<wedge\>L<rsub|1>,L<rsub|2>
      are linear><around*|\<\|\|\>|L<rsub|2><around*|(|<frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>h|)>-L<rsub|1><around*|(|<frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>h|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|L<rsub|2><around*|(|h<rprime|'>|)>-L<rsub|1><around*|(|h<rprime|'>|)>|\<\|\|\>>\<leqslant\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h<rprime|'>|\<\|\|\>><rsub|X>=\<varepsilon\><around*|\<\|\|\>|<frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>h|\<\|\|\>><rsub|X>=<frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<Rightarrow\><around*|\<\|\|\>|L<rsub|1><around*|(|h|)>-L<rsub|2><around*|(|h|)>|\<\|\|\>><rsub|1>\<leqslant\>\<varepsilon\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>
    </enumerate>

    this proves that given a <math|\<varepsilon\>\<gtr\>0> and
    <math|h\<in\>X> we have <math|<around*|\<\|\|\>|<around*|(|L<rsub|2>-L<rsub|1>|)><around*|(|h|)>|\<\|\|\>>=<around*|\<\|\|\>|L<rsub|2><around*|(|h|)>-L<rsub|1><around*|(|h|)>|\<\|\|\>><rsub|Y>\<leqslant\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>
    which means by linearity of <math|L<rsub|2>-L<rsub|1>> and <reference|the
    alternative definition of the norm of a continuous linear function> that
    given a <math|\<varepsilon\>\<gtr\>0> we have
    <math|<around*|\<\|\|\>|L<rsub|2>-L<rsub|1>|\<\|\|\>>\<leqslant\>\<varepsilon\>>.
    If now <math|L<rsub|1>\<neq\>L<rsub|2>> then
    <math|0\<neq\>L<rsub|1>-L<rsub|2>\<Rightarrow\>0\<less\><frac|<around*|\<\|\|\>|L<rsub|2>-L<rsub|1>|\<\|\|\>>|2>>
    so if we take <math|\<varepsilon\>=<frac|<around*|\<\|\|\>|L<rsub|2>-L<rsub|1>|\<\|\|\>>|2>\<gtr\>0\<Rightarrow\>2\<cdot\>\<varepsilon\>=<around*|\<\|\|\>|L<rsub|2>-L<rsub|1>|\<\|\|\>>\<leqslant\>\<varepsilon\>\<Rightarrow\>\<varepsilon\>+\<varepsilon\>\<leqslant\>\<varepsilon\>>
    and then <math|0\<less\>\<varepsilon\>\<leqslant\>0> a contradiction so
    that <math|L<rsub|1>=L<rsub|2>>.
  </proof>

  The unique continuous linear aproximation of a function at a point is
  ...
  <\definition>
    ...
    <math|V\<subseteq\>Y> and <math|f:U\<rightarrow\>V> differentiable at
    <math|x> then the unique (by the previous theorem)
    <math|L\<in\>L<around*|(|X,Y|)>> such that
    <math|\<forall\>\<varepsilon\>\<gtr\>0> there exists a
    ...
    exists a unique <math|D f<around*|(|x|)>\<in\>L<around*|(|X,Y|)>> such
    that \ <math|\<forall\>\<varepsilon\>\<gtr\>0> there exists a
    <math|\<delta\>\<gtr\>0> such that if <math|h\<in\>U<rsub|x>> and
    <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\>> then
    <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-Df<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>\<leqslant\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>
  </definition>

  Let's now create some alternative definitions for differentiability at a
  point.
  ...
  <\definition>
    ...
    <math|0\<in\>U<rsub|x>> and for which
    <math|\<varepsilon\><around*|(|0|)>=0> (using the subspace topology on
    <math|U<rsub|x>>)
  </definition>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      \ we have <math|<frac|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-Df<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>\<less\>\<varepsilon\>>

      <item>There exists a linear function <math|D
      f<around*|(|x|)>:X\<rightarrow\>Y> such that
      <math|\<forall\><around*|{|h<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>
      with <math|<below|lim|h\<rightarrow\>0>h<rsub|i>=0> and
      <math|\<forall\>i\<in\>\<bbb-N\><rsub|0>> <math|h<rsub|i>\<gtr\>0> we
      have that <math|<below|lim|n\<rightarrow\>\<infty\>><frac|<around*|\<\|\|\>|f<around*|(|x+h<rsub|i>|)>-f<around*|(|x|)>-D
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|1\<Rightarrow\>2>>Define
      <math|\<varepsilon\>:U<rsub|x>\<rightarrow\>Y> by
      <math|h\<rightarrow\>\<varepsilon\><around*|(|h|)>=<frac|f<around*|(|x+h|)>-f<around*|(|x|)>-D
      f<around*|(|x|)><around*|(|h|)>|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>+1>>.
      Then <math|\<varepsilon\><around*|(|0|)>=<frac|f<around*|(|x|)>-f<around*|(|x|)>-D
      f<around*|(|x|)><around*|(|0|)>|1>=0>, also if <math|\<zeta\>\<gtr\>0>
      there exists by (1) a <math|\<delta\>\<gtr\>0> such that if
      <math|h\<in\>U<rsub|x>> with <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\>>
      then <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
      f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>\<leqslant\>\<zeta\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>
      so that <math|<around*|\<\|\|\>|\<varepsilon\><around*|(|h|)>-\<varepsilon\><around*|(|0|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|\<varepsilon\><around*|(|h|)>-0|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|\<varepsilon\><around*|(|h|)>|\<\|\|\>><rsub|Y>\<equallim\><rsub|<frac|1|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X+1>>\<gtr\>0><frac|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
      f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>+1>\<leqslant\><frac|\<zeta\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>+1>\<less\>\<zeta\>>
      which by <reference|continuity of function in a normed space> and
      <reference|subspace topology of a metric space> means that
      <math|\<varepsilon\>> is continuous at <math|0>.

      <item><dueto|<math|2\<Rightarrow\>3>>Let
      <math|\<varepsilon\>:U<rsub|x>\<rightarrow\>Y> be the
      ...
      then <math|<frac|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
      ...
      <item><dueto|<math|3\<Rightarrow\>1>>Let <math|\<varepsilon\>\<gtr\>0>,
      find a <math|\<delta\>\<gtr\>0> such that for <math|h\<in\>U<rsub|x>>
      with <math|0\<less\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\>>
      ...
      <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\>> two cases

      <\enumerate>
        <item><dueto|<math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>=0>>then
        <math|h=0> so that <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
        ...
        <item><dueto|<math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<gtr\>0>>then
      ...
      <math|<around*|{|h<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>> be a
      sequence of strict positive real numbers with limit <math|0>. As
      <math|x\<in\>U> open there exists a <math|d\<gtr\>0> such that
      <math|x\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,d|)>\<subseteq\>U>,
      so as <math|<below|lim|n\<rightarrow\>0>h<rsub|i>=0> there exists a
      <math|N<rsub|1>\<in\>\<bbb-N\><rsub|0>> such that
      <math|\<forall\>n\<geqslant\>N<rsub|1>> we have
      <math|<around*|\<\|\|\>|h<rsub|i>|\<\|\|\>>\<less\>d> and thus
      <math|<around*|\<\|\|\>|<around*|(|x+h<rsub|n>|)>-x|\<\|\|\>><rsub|X>=<around*|\<\|\|\>|h<rsub|n>|\<\|\|\>><rsub|X>\<less\>d\<Rightarrow\>x+h<rsub|n>\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,d|)>\<subseteq\>U\<Rightarrow\>h<rsub|n>\<in\>U<rsub|x>>.
      To summarize we have

      <\equation>
        <label|eq 13.1.318>\<forall\>n\<geqslant\>N<rsub|1> we have
        h<rsub|n>\<in\>U<rsub|x>
      </equation>

      Take now <math|\<varepsilon\>\<gtr\>0> then by (3) there exists a
      ...
      a <math|N<rsub|2>\<in\>\<bbb-N\><rsub|0>> such that
      <math|\<forall\>n\<geqslant\>N<rsub|2>> we have
      <math|0\<less\><around*|\<\|\|\>|h<rsub|n>|\<\|\|\>>\<less\>\<delta\><rsub|\<varepsilon\>>>.
      Take now <math|N=max<around*|(|N<rsub|1>,N<rsub|2>|)>> then if
      <math|n\<geqslant\>N> we have using <reference|eq 13.1.318> that
      <math|h<rsub|n>\<in\>U<rsub|x>> and
      <math|0\<less\><around*|\<\|\|\>|h<rsub|n>|\<\|\|\>>\<less\>\<delta\><rsub|\<varepsilon\>>>
      ...
      <item><dueto|<math|4\<Rightarrow\>3>>Assume that <math|f> is not
      differentiable at <math|x> then there exists a
      <math|\<varepsilon\><rsub|0>\<gtr\>0> such that
      <math|\<forall\>\<delta\>\<gtr\>0> there exists a
      <math|h\<in\>U<rsub|x>> with <math|0\<less\><around*|\<\|\|\>|h|\<\|\|\>>\<less\>\<delta\>>
      so that <math|<frac|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
      f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>|<around*|\<\|\|\>|x|\<\|\|\>><rsub|X>>\<gtr\>\<varepsilon\><rsub|0>>.
      For every <math|n\<in\>\<bbb-N\><rsub|0>> there exists a
      <math|h<rsub|n>\<in\>U<rsub|x>> with
      <math|0\<less\><around*|\<\|\|\>|h<rsub|n>|\<\|\|\>>\<less\><frac|1|n>>
      so that <math|<frac|<around*|\<\|\|\>|f<around*|(|x+h<rsub|n>|)>-f<around*|(|x|)>-D
      ...
      porperty (see <reference|consequence of the archimedean property for
      the reals>) a <math|N<rsub|\<delta\>>\<in\>\<bbb-N\><rsub|0>> such that
      <math|<frac|1|N<rsub|\<delta\>>>\<less\>\<delta\>> so if
      <math|n\<geqslant\>N<rsub|\<delta\>>> we have
      <math|<around*|\||<frac|1|n>-0|\|>=<frac|1|n>\<leqslant\><frac|1|N<rsub|\<delta\>>>\<less\>\<delta\>>
      proving that <math|<below|lim|n\<rightarrow\>\<infty\>>h<rsub|n>=0>. So
      by the hypothese we have that <math|<below|lim|n\<rightarrow\>\<infty\>><frac|<around*|\<\|\|\>|f<around*|(|x+h<rsub|n>|)>-f<around*|(|x|)>-D
      f<around*|(|x|)><around*|(|h<rsub|n>|)>|\<\|\|\>><rsub|Y>|<around*|\<\|\|\>|h<rsub|n>|\<\|\|\>><rsub|X>>=0>
      and thus there exists a <math|N\<in\>\<bbb-N\><rsub|0>> such that
      ...
      f<around*|(|x|)><around*|(|h<rsub|N>|)>|\<\|\|\>><rsub|Y>|<around*|\<\|\|\>|h<rsub|N>|\<\|\|\>>>\<less\>\<varepsilon\><rsub|0>>.
      As the assumption gives a contradiction we must have that <math|f> is
  ...
  <\remark>
    ...
    requirement for the continuity of <math|D f<around*|(|x|)>>.
  </remark>

  The following theorem is the reason that we require <math|L> to be a
  continuous map.

  <\theorem>
    <label|differentiability at x implies continuity at x>If
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|n\<in\>\<bbb-N\>>, <math|U\<subseteq\>X> a open
    set, <math|x\<in\>U>, <math|V\<subseteq\>Y> and <math|f:U\<rightarrow\>V>
    a function that is differentiable at <math|x> then <math|f> is continuous
    at <math|x>.
  </theorem>

  <\proof>
    Let <math|x\<in\>U> and <math|W> open in the subspace topology of
    <math|V> with <math|f<around*|(|x|)>>. As <math|W> is open in <math|V>
    there exists a <math|H> open in <math|Y> such that
    <math|f<around*|(|x|)>\<in\>W=H<big|cap>V>, but then from the openess of
    <math|H> we have

    <\equation>
      <label|eq 0.12.1>\<exists\>\<delta\><rsub|1>\<gtr\>0 such that
      f<around*|(|x|)>\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|Y>><around*|(|f<around*|(|x|)>,\<delta\><rsub|1>|)>\<subseteq\>H,W=V<big|cap>H,W
      open in Y
    </equation>

    From the alternative definition of differentiability at <math|x>
    (see<reference|alternative definitions of differentiability>) there
    exists a <math|\<varepsilon\>>-mapping
    <math|\<varepsilon\>:U<rsub|x>\<rightarrow\>Y> such that

    <\equation>
      <label|eq 0.12.2>\<forall\>h\<in\>U<rsub|x>\<vDash\>f<around*|(|x+h|)>-f<around*|(|x|)>-D
      f<around*|(|x|)><around*|(|h|)>=\<varepsilon\><around*|(|h|)>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>
    </equation>

    From the continuity of <math|\<varepsilon\>> at <math|0> and the fact
    that <math|\<varepsilon\><around*|(|0|)>=0> we have

    <\equation>
      <label|eq 0.12.3>\<exists\>\<delta\><rsub|2>\<gtr\>0\<vDash\>if
      h\<in\>U<rsub|x> and <around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|2>\<Rightarrow\><around*|\<\|\|\>|\<varepsilon\><around*|(|h|)>|\<\|\|\>><rsub|Y>\<less\><frac|\<delta\><rsub|1>|2>
    </equation>

    From the continuity of <math|D f<around*|(|x|)>> at <math|0> we have also

    <\equation>
      <label|eq 0.12.4>\<exists\>\<delta\><rsub|3>\<gtr\>0\<vDash\>if
      <around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|3>\<Rightarrow\><around*|\<\|\|\>|D
      f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>\<less\><frac|\<delta\><rsub|1>|2>
    </equation>

    As <math|U> is open in <math|X> we have

    <\equation>
      <label|eq 1.12.5>\<exists\>\<delta\><rsub|4>\<vDash\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\><rsub|4>|)>\<subseteq\>U
    </equation>

    Define now <math|\<delta\>=min<around*|(|\<delta\><rsub|2>,\<delta\><rsub|3>,\<delta\>,1<rsub|>|)>>
    then if <math|y\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\>|)>\<subseteq\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\><rsub|4>|)>\<Rightarrow\>y\<in\>U>,
    take now <math|h=y-x\<Rightarrow\>x+h\<in\>U\<Rightarrow\>h\<in\>U<rsub|x>>
    as also <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>=<around*|\<\|\|\>|y-x|\<\|\|\>><rsub|X>\<less\>\<delta\>\<leqslant\>\<delta\><rsub|2>>
    we have by <reference|eq 0.12.3> that

    <\equation>
      <label|eq 0.12.6>y\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x\<comma\>\<delta\>|)>\<Rightarrow\><around*|\<\|\|\>|\<varepsilon\><around*|(|y-x|)>|\<\|\|\>><rsub|Y>\<less\><frac|\<delta\><rsub|1>|2>
    </equation>

    From <math|<around*|\<\|\|\>|y-x|\<\|\|\>><rsub|X>=<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\>=\<delta\><rsub|3>>
    and <reference|eq 0.12.4> we have

    <\equation>
      <label|eq 0.12.7>y\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\>|)>\<Rightarrow\><around*|\<\|\|\>|D
      f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>\<less\><tfrac|\<delta\><rsub|1>|2>
    </equation>

    So if <math|y\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\>|)>\<Rightarrowlim\><rsub|h=y-x\<in\>U<rsub|x>,<text|<reference|eq
    12.2>>>f<around*|(|y|)>-f<around*|(|x|)>=D
    f<around*|(|x|)><around*|(|y-x|)>+\<varepsilon\><around*|(|y-x|)>\<cdot\><around*|\<\|\|\>|y-x|\<\|\|\>><rsub|X>\<Rightarrow\><around*|\<\|\|\>|f<around*|(|y|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|D
    f<around*|(|x|)> <around*|(|y-x|)>|\<\|\|\>><rsub|Y>+<around*|\<\|\|\>|\<varepsilon\><around*|(|y-x|)>|\<\|\|\>><rsub|Y>\<cdot\><around*|\<\|\|\>|y-x|\<\|\|\>><rsub|X>\<less\><rsub|<text|<reference|eq
    0.12.6> and <reference|eq 0.12.7>>><frac|\<delta\><rsub|1>|2>+<frac|\<delta\><rsub|1>|2>\<cdot\><around*|\<\|\|\>|y-x|\<\|\|\>><rsub|X>\<less\><tfrac|\<delta\><rsub|1>|2>+<frac|\<delta\><rsub|1>|2>=\<delta\><rsub|1>>
    (as <math|<around*|\<\|\|\>|y-x|\<\|\|\>><rsub|X>\<less\>\<delta\>\<leqslant\>1>.
    This proves together with <math|f<around*|(|y|)>\<in\>V> that
    <math|f<around*|(|B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\>|)>|)>\<subseteq\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|Y>><around*|(|f<around*|(|x|)>,\<delta\><rsub|1>|)><big|cap>V>
    or using <reference|eq 0.12.1> that <math|f<around*|(|B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|x,\<delta\>|)>|)>\<subseteq\>W>,
    so we found a open set <math|x\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\>|)>>
    (in the subspace topology of <math|U> as
    <math|B<rsub|<rsub|<around*|\<\|\|\>||\<\|\|\>>>X><around*|(|x,\<delta\>|)>\<subseteq\>U>)
    such that <math|f<around*|(|B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\>|)>|)>\<subseteq\>W\<ni\>f<around*|(|x|)>>
    proving continuity.
  </proof>
  ...
  <\theorem>
    ...
    on <math|Y>, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y> (as
    norms are equivalent the topology on <math|X,Y> is the same for the two
    norms), <math|f:U\<rightarrow\>V> a function then if <math|f> is
    differentiable at <math|x\<in\>U> with differential <math|D
    f<around*|(|x|)>> (using norms <math|<around*|\<\|\|\>||\<\|\|\>><rsub|X<rsub|1>>,<around*|\<\|\|\>||\<\|\|\>><rsub|Y<rsub|1>>>)
  ...
  <\proof>
    From the equivalence of the normes we have by <reference|equivalence of
    norms> that there exists <math|\<alpha\><rsub|X>,\<beta\><rsub|X>,\<alpha\><rsub|Y>,\<beta\><rsub|Y>\<gtr\>0>
    such that <math|\<forall\>x\<in\>X\<vDash\>\<alpha\><rsub|X>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X<rsub|2>>\<leqslant\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X<rsub|1>>\<leqslant\>\<beta\><rsub|X>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X<rsub|2>>>
    and <math|\<forall\>y\<in\>Y\<vDash\>\<alpha\><rsub|Y>\<cdot\><around*|\<\|\|\>|y|\<\|\|\>><rsub|Y<rsub|1>>\<leqslant\><around*|\<\|\|\>|y|\<\|\|\>><rsub|Y<rsub|2>>\<leqslant\>\<beta\><rsub|Y>\<cdot\><around*|\<\|\|\>|y|\<\|\|\>><rsub|Y<rsub|1>>>.
    Assume now that <math|f:U\<rightarrow\>V> is differentiable at <math|x>
    with differential <math|D f<around*|(|x|)>> then given
    <math|\<varepsilon\>\<gtr\>0> there exists a
    <math|\<delta\><rprime|'>\<gtr\>0> such that
    <math|\<forall\>h\<in\>U<rsub|x>> with
    <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|1>>\<less\>\<delta\><rprime|'>>
    we have <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
    f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y<rsub|1>>\<leqslant\><around*|(|<frac|1|\<beta\><rsub|Y>\<cdot\>\<beta\><rsub|X>>\<cdot\>\<varepsilon\>|)>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X<rsub|1>>>.
    Define now <math|\<delta\>=<frac|\<delta\><rprime|'>|\<beta\><rsub|X>>\<gtr\>0>
    then <math|\<forall\>h\<in\>U<rsub|X>> with
    <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|2>>\<less\>\<delta\>> we
    have <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|2>>\<less\><frac|\<delta\><rprime|'>|\<beta\><rsub|X>>\<Rightarrow\>\<beta\><rsub|X>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|2>>\<less\>\<delta\><rprime|'>\<Rightarrow\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|1>>\<less\>\<delta\><rsub|>
    <rsub|>> giving by the above that <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
    f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y<rsub|1>>\<leqslant\><frac|1|\<beta\><rsub|Y>\<cdot\>\<beta\><rsub|X>>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|1>>\<cdot\>\<varepsilon\>\<Rightarrow\>\<beta\><rsub|Y>\<cdot\><around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
    f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y<rsub|1>>\<leqslant\>\<varepsilon\>\<cdot\><frac|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|1>>|\<beta\><rsub|X>>\<Rightarrow\><around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
    f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y<rsub|1>>\<leqslant\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|2>>>
    proving that <math|\<forall\>h\<in\>U<rsub|X>> with
    <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|2>>\<less\>\<delta\>> we
    have <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
    f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y<rsub|2>>\<leqslant\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|2>>>
    and this together with the fact that <math|D f<around*|(|x|)>> is also a
  ...
  <math|x> is a essential a local property and is not dependend on neither
  <math|U> or <math|V> but just on the value of <math|f> near <math|x>.
  ...
  <\theorem>
    ...
    <\enumerate>
      <item>If <math|f:U\<rightarrow\>V> is differentiable at <math|x> then
      <math|\<forall\>W> open with <math|x\<in\>W\<subseteq\>U> and
      <math|\<forall\>Z\<subseteq\>Y> with
      <math|f<around*|(|W|)>\<subseteq\>Z> we have that
      <math|f<rsub|\|W>:W\<rightarrow\>Z> is differentiable at <math|x>.

      <item>If there exists a <math|W\<subseteq\>X> open with
      <math|x\<in\>W\<subseteq\>U> and a <math|Z\<subseteq\>Y> with
      <math|f<around*|(|W|)>\<subseteq\>Z> \ such that
      <math|f<rsub|\|W>:W\<rightarrow\>Z> is differentiable at <math|x> then
      <math|f:W\<rightarrow\>V> is differentiable at <math|x>.
    </enumerate>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\equation>
        <label|eq 12.1>if <around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<leqslant\>\<delta\><rsub|1>\<Rightarrow\>h\<in\>W<rsub|x>
      </equation>
  ...
  Let's study now some trival examples of functions differentiable at a
  point.
  ...
  <\example>
    ...
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|y\<in\>Y>, <math|U\<subseteq\>X> open,
    <math|y\<in\>V\<subseteq\>Y> and <math|C<rsub|U,y>=<around*|{|<around*|(|x,y|)>\|x\<in\>U|}>>
    (the graph of a constant function) then
    <math|C<rsub|U,y>:U\<rightarrow\>V> is differentiable at every
    <math|x\<in\>U> and <math|D C<rsub|U,y><around*|(|x|)>=C<rsub|X,0>>.
  </example>
  ...
  <\proof>
    ...
    proving that <math|C<rsub|X,0>\<in\>L<around*|(|X,Y|)>>.
  </proof>
  ...
  <\example>
    ...
    if <math|L\<in\>L<around*|(|X,Y|)>> then
    <math|L<rsub|\|U>:U\<rightarrow\>V> (<math|V\<subseteq\>Y> with
    <math|L<around*|(|U|)>\<subseteq\>V>) is differentiable at every
    <math|x\<in\>U> with differential <math|D L<rsub|\|U><around*|(|x|)>=L>
  </example>

  <\proof>
    If <math|\<varepsilon\>\<gtr\>0> and <math|h\<in\>U<rsub|x>> with
    <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>1> then
    <math|<around*|\<\|\|\>|L<rsub|\|U><around*|(|x+h|)>-L<rsub|\|U><around*|(|x|)>-L<around*|(|h|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|L<around*|(|x+h|)>-L<around*|(|x|)>-L<around*|(|h|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|L<around*|(|x|)>+L<around*|(|h|)>-L<around*|(|x|)>-L<around*|(|h|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|0|\<\|\|\>><rsub|Y>=0\<leqslant\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>
    proving that <math|L<rsub|\|U>> is differentiable at every
    <math|x\<in\>U> with <math|D L<rsub|\|U><around*|(|x|)>=L>
  </proof>
  ...
  <\definition>
    ...
    open set, <math|V\<subseteq\>Y> and a function <math|f:U\<rightarrow\>V>
    then <math|f> has a <with|font-series|bold|derivative> at <math|x> noted
    by <math|f<rprime|'><around*|(|x|)>> if and only if
    <math|\<forall\>\<varepsilon\>\<gtr\>0> there exists a
  ...
  The next theorem shows the relation between the derivative and the
  differential
  ...
  <\theorem>
    ...
    normed space, <math|U\<subseteq\>\<bbb-K\>> a open set, <math|x\<in\>U> a
    open set, <math|V\<subseteq\>Y> and a function <math|f:U\<rightarrow\>V>
    then <math|f> is differentiable at <math|x> with differential <math|D
    f<around*|(|x|)>> if and only if <math|f> has a derivative
    <math|f<rprime|'><around*|(|x|)>> at <math|x>. Furthermore if <math|f> is
    differentiable (or equivalent has a derivative) then <math|D
    f<around*|(|x|)>:\<bbb-K\>\<rightarrow\>Y> is defined by
    ...
    this theorem also proves that the derivative must be unique.
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|\<Rightarrow\>>>If <math|f> is differentiable with
      ...
      f<around*|(|x|)><around*|(|1|)>> is indeed a derivative of <math|f> at
      <math|x> and that <math|D f<around*|(|x|)><around*|(|h|)>=f<rprime|'><around*|(|x|)>\<cdot\>h>

      <item><dueto|<math|\<Leftarrow\>>>Define <math|D
      f<around*|(|x|)>:\<bbb-K\>\<rightarrow\>Y> by
      <math|h\<rightarrow\>f<rprime|'><around*|(|x|)>\<cdot\>h> where
      <math|f<rprime|'><around*|(|x|)>> is a derivative of <math|f>, which is
      ...
      derivative must be unique.
    </enumerate>
  </proof>

  <\definition>
    <label|(x1,..,xi-1,*,xi+1,..,xn)><index|<math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>>>Given
    ...
    <math|x=<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>\<in\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>\\<around*|{|i|}>>X<rsub|i>>
    we define <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>:X<rsub|i>\<rightarrow\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>
    by <math|t\<rightarrow\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><around*|(|t|)>=<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,t,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>=<choice|<tformat|<table|<row|<cell|x<rsub|j>
  ...
  <\theorem>
    ...
    of vector spaces over the field <math|\<bbb-K\>> then given a
    <math|i\<in\><around*|{|1,\<ldots\>,n|}>> and
    <math|<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>\<in\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>\\<around*|{|i|}>>X<rsub|i>>,
    where <math|0<rsub|j>\<in\>X<rsub|j>> is the neutral element of
    <math|X<rsub|j>>, then <math|<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>>
    is linear.
  </theorem>

  <\proof>
    Let <math|\<alpha\>,\<beta\>\<in\>\<bbb-K\>> and
    <math|x,y\<in\>X<rsub|i>> then <math|<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)><around*|(|\<alpha\>\<cdot\>x+\<beta\>\<cdot\>y|)>=<choice|<tformat|<table|<row|<cell|0<rsub|j>
    if j\<in\><around*|{|1,\<ldots\>,n|}>\\<around*|{|i|}>>>|<row|<cell|\<alpha\>\<cdot\>x+\<beta\>\<cdot\>y
    if j=i>>>>>=<choice|<tformat|<table|<row|<cell|0<rsub|j>=\<alpha\>\<cdot\>0<rsub|j>
    if j\<in\><around*|{|1,\<ldots\>,n|}>\\<around*|{|i|}>>>|<row|<cell|\<alpha\>\<cdot\>x
    if j=i>>>>>+<choice|<tformat|<table|<row|<cell|0<rsub|j>=\<beta\>\<cdot\>0<rsub|j>
    if j\<in\><around*|{|1,\<ldots\>,n|}>\\<around*|{|i|}>>>|<row|<cell|\<beta\>\<cdot\>y
    if j=i>>>>>=\<alpha\>\<cdot\><choice|<tformat|<table|<row|<cell|0<rsub|j>
    if j\<in\><around*|{|1,\<ldots\>,n|}>\\<around*|{|i|}>>>|<row|<cell|x if
    j=i>>>>>+\<beta\>\<cdot\><choice|<tformat|<table|<row|<cell|0<rsub|j> if
    j\<in\><around*|{|1,\<ldots\>,n|}>\\<around*|{|i|}>>>|<row|<cell|y if
    j=i>>>>>=\<alpha\>\<cdot\><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|j+1>,\<ldots\>,0<rsub|n>|)><around*|(|x|)>+\<beta\>\<cdot\><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>>.
  </proof>
  ...
  <\theorem>
    ...
    we have <math|x=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>\<cdot\>x<rsub|i>>
  </theorem>

  <\proof>
    First note that <math|<around*|(|<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>0<rsub|n>|)><around*|(|x|)>|)><rsub|k>=\<delta\><rsub|i,k>\<cdot\>x>
    so that <math|\<forall\>k\<in\><around*|{|1,\<ldots\>,n|}>> we have
    <math|<around*|(|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)><around*|(|x<rsub|i>|)>|)><rsub|k>\<equallim\><rsub|<text|<reference|projection
    of sum>>><big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|(|<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,*\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)><around*|(|x<rsub|i>|)>|)><rsub|k>=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>x<rsub|k>\<cdot\>\<delta\><rsub|i,k>=x<rsub|k>>
    proving that <math|x=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>\<cdot\>x<rsub|i>>
  </proof>
  ...
  <\theorem>
    ...
    forms a normed vector space over <math|\<bbb-K\>>) then
    <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>,
    <math|\<forall\>t\<in\>X<rsub|i>> and
    <math|\<forall\>x=<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>\<in\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>
    we have that <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>:X<rsub|i>\<rightarrow\><big|prod><rsub|j\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|j>>
    is differentiable at <math|t> with <math|D<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><around*|(|t|)>=<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>>.
  </theorem>

  <\proof>
    First using the previous theorem we have that
    <math|<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>>
    is linear. Next as <math|\<forall\>x\<in\>X<rsub|i>> we have that
    <math|<around*|\<\|\|\>|<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)><around*|(|x|)>|\<\|\|\>>=<around*|\<\|\|\>|<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,x,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>|\<\|\|\>>=<around*|\<\|\|\>|x|\<\|\|\>><rsub|i>=1\<cdot\><around*|\<\|\|\>|x<rsub|i>|\<\|\|\>>>
    we have that <math|<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<star\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>>
    is continuous. Take now <math|\<varepsilon\>\<gtr\>0>,
    <math|t\<in\>X<rsub|i>> then if <math|h\<in\><around*|(|X<rsub|i>|)><rsub|t>=X<rsub|i>>
    with <math|<around*|\<\|\|\>|t<rsub|i>|\<\|\|\>><rsub|i>\<less\>1> we
    have <math|<around*|\<\|\|\>|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><around*|(|t+h|)>-<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><around*|(|t|)>-<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)><around*|(|h|)>|\<\|\|\>>=<around*|\<\|\|\>|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,t+h,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>-<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,t,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>-<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,h,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>|\<\|\|\>>=<around*|\<\|\|\>|<around*|(|x<rsub|1>-x<rsub|1>,\<ldots\>,x<rsub|i-1>-x<rsub|i-1>,<around*|(|t+h|)>-h,x<rsub|i+1>-x<rsub|i+1>,\<ldots\>,x<rsub|n>-x<rsub|n>|)>-<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,h,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>|\<\|\|\>>=<around*|\<\|\|\>|<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,h,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>-<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,h,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>|\<\|\|\>>=<around*|\<\|\|\>|0|\<\|\|\>>=0\<leqslant\>\<varepsilon\>>.
    This proves that <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>>
    is differentiable at <math|t> with differential
    <math|<around*|(|0<rsub|1>,\<ldots\>.,0<rsub|i-1>,0<rsub|i+1>,\<ldots\>,o<rsub|n>|)>>.
  </proof>
  ...
  <\note>
    ...
    product space together with the maximum norm
    <math|<around*|\<\|\|\>||\<\|\|\>>> (see <reference|norm of finite
    product of normed spaces>) then <math|\<forall\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>\<in\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>
    ...
    coninuous at that point) that <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
    <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>>
    is continous at <math|X<rsub|i>>. So given a open set
    <math|U\<subseteq\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>
    we have that <math|<around*|{|t\<in\>X<rsub|i>\|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,t,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>\<in\>U|}>=<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsup|-1><around*|(|U|)>>
  ...
  <\theorem>
    ...
    <math|f+g:U\<rightarrow\>V<rsub|f>+V<rsub|g>> is differentiable at
    <math|x> with <math|D<around*|(|f+g|)><around*|(|x|)>=D
    f<around*|(|x|)>+D g<around*|(|x|)>>. Also if
    <math|\<alpha\>\<in\>\<bbb-K\>> then <math|\<alpha\>\<cdot\>f:U\<rightarrow\>\<alpha\>\<cdot\>V<rsub|f>>
    is differentiable at <math|x> with <math|D<around*|(|\<alpha\>\<cdot\>f|)><around*|(|x|)>=\<alpha\>\<cdot\>D
    f<around*|(|x|)>>.
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <item>If <math|\<alpha\>\<in\>\<bbb-K\>> then we have the following
      cases to consider:

      <\enumerate>
        <item><dueto|<math|\<alpha\>=0>>then
        <math|\<alpha\>\<cdot\>f=C<rsub|U,0>> differentiable with
        <math|D<around*|(|\<alpha\>\<cdot\>f|)><around*|(|x|)>=C<rsub|X,0>=0\<cdot\>D
        f<around*|(|x|)>>

        <item><dueto|<math|\<alpha\>\<neq\>0>><math|\<Rightarrow\><around*|\||\<alpha\>|\|>\<gtr\>0>,
        let <math|\<varepsilon\>\<gtr\>0> then by differentiability of
        <math|f> there exists a <math|\<delta\>\<gtr\>0> such that if
        <math|h\<in\>U<rsub|x>> with <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\>>
        we have <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
        f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>\<leqslant\><frac|\<varepsilon\>|<around*|\||\<alpha\>|\|>>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<Rightarrow\><around*|\<\|\|\>|<around*|(|\<alpha\>\<cdot\>f|)><around*|(|x+h|)>-<around*|(|\<alpha\>\<cdot\>f|)><around*|(|x|)>-\<alpha\>\<cdot\>D
        f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|\<alpha\>\<cdot\>f<around*|(|x+h|)>-\<alpha\>\<cdot\>f<around*|(|x|)>-\<alpha\>\<cdot\>D
        f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>=<around*|\||\<alpha\>|\|>\<cdot\><around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
        f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\||\<alpha\>|\|>\<cdot\><frac|\<varepsilon\>|<around*|\||\<alpha\>|\|>>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>=\<varepsilon\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>
  ...
  <\theorem>
    ...
    be normed spaces over <math|\<bbb-K\>>, <math|U\<subseteq\>X> a open set,
    <math|V\<subseteq\>Y>, <math|W\<subseteq\>Y> a open set,
    <math|S\<subseteq\>Z>, <math|f:U\<rightarrow\>V>,
    <math|g:W\<rightarrow\>S> functions [so using <reference|composition of
    functions (3)> <math|g\<circ\>f:U<big|cap>f<rsup|-1><around*|(|W|)>\<rightarrow\>S>
    is a function], \ <math|f> is differentiable at
    <math|x\<in\>U<big|cap>f<rsup|-1><around*|(|W|)>> and <math|g> is
    differentiable at <math|f<around*|(|x|)>\<in\>W> then
    <math|g\<circ\>f:U<big|cap>f<rsup|-1><around*|(|W|)>\<rightarrow\>S> is
    differentiable at <math|x> with <math|D<around*|(|g\<circ\>f|)><around*|(|x|)>=D
    g<around*|(|f<around*|(|x|)>|)>\<circ\>D f<around*|(|x|)>>
  </theorem>

  <\proof>
    First as <math|f:U\<rightarrow\>V> is differentiable at <math|x> <math|f>
    is continuous at <math|x> (see <reference|differentiability at x implies
    continuity at x>), then as <math|W> is open there exists a
    <math|T\<subseteq\>U> open with <math|f<around*|(|T|)>\<subseteq\>W\<Rightarrow\>f<rsup|-1><around*|(|W|)>\<Rightarrow\>x\<in\>T\<subseteq\>U<big|cap>f<rsup|-1><around*|(|W|)>>,
    using <reference|differentiability and restricted mapping> we have that
    <math|f<rsub|\|T>:T\<rightarrow\>V> is differentiable at <math|x\<in\>T>.
    By the alternative definition for differentiability (see
    <reference|alternative definitions of differentiability>) there exists
    <math|\<varepsilon\>>-mappings <math|\<varepsilon\><rsub|f>:T<rsub|x>\<rightarrow\>Y>
    and <math|\<varepsilon\><rsub|g>:W<rsub|f<around*|(|x|)>>\<rightarrow\>Y>
    such that

    <\equation>
      <label|eq 12.3>\<forall\>h\<in\>T<rsub|x> we have
      f<around*|(|x+h|)>-f<around*|(|x|)>-D
      f<around*|(|x|)><around*|(|h|)>=\<varepsilon\><rsub|f><around*|(|h|)>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>
    </equation>

    <\equation>
      <label|eq 12.4>\<forall\>k\<in\>W<rsub|f<around*|(|x|)>> we have
      g<around*|(|f<around*|(|x|)>+k|)>-g<around*|(|f<around*|(|x|)>|)>-D
      g<around*|(|f<around*|(|x|)>|)><around*|(|k|)>=\<varepsilon\><rsub|g><around*|(|k|)>\<cdot\><around*|\<\|\|\>|k|\<\|\|\>><rsub|Y>
    </equation>

    If <math|h\<in\>T<rsub|x>\<Rightarrow\>x+h\<in\>T\<Rightarrow\>f<around*|(|x+h|)>\<in\>f<around*|(|T|)>\<subseteq\>W>
    so if <math|k=f<around*|(|x+h|)>-f<around*|(|x|)>> then
    <math|f<around*|(|x|)>+k=f<around*|(|x+h|)>\<in\>W\<Rightarrow\>f<around*|(|x+h|)>-f<around*|(|x|)>=k\<in\>W<rsub|f<around*|(|x|)>>>
    giving

    <\equation>
      <label|eq 0.12.5>\<forall\>h\<in\>T<rsub|x> we have
      f<around*|(|x+h|)>-f<around*|(|x|)>\<in\>W<rsub|f<around*|(|x|)>>
    </equation>

    Thus by <reference|eq 12.4> we have <math|g<around*|(|f<around*|(|x|)>+<around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>|)>-g<around*|(|f<around*|(|x|)>|)>-Dg<around*|(|f<around*|(|x|)>|)><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>=\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>\<cdot\><around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>\<Rightarrow\>g<around*|(|f<around*|(|x+h|)>|)>-g<around*|(|f<around*|(|x|)>|)>-Dg<around*|(|f<around*|(|x|)>|)><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>=\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>\<cdot\><around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>\<Rightarrowlim\><rsub|<text|<reference|eq
    12.3>>>g<around*|(|f<around*|(|x+h|)>|)>-g<around*|(|f<around*|(|x|)>|)>-Dg<around*|(|f<around*|(|x|)>|)><around*|(|\<varepsilon\><rsub|f><around*|(|h|)>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>+Df<around*|(|x|)><around*|(|h|)>|)>=\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>\<cdot\><around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>\<Rightarrow\><around*|(|g\<circ\>f|)><around*|(|x+h|)>-<around*|(|g\<circ\>f|)><around*|(|x|)>-Dg<around*|(|f<around*|(|x|)>|)><around*|(|Df<around*|(|x|)><around*|(|h|)>|)>=\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>\<cdot\><around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>+Dg<around*|(|f<around*|(|x|)>|)><around*|(|\<varepsilon\><rsub|f><around*|(|h|)>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>|)>>
    giving \ 

    <\equation>
      <label|eq 12.5>\<forall\>h\<in\>T<rsub|x> we have
      <around*|(|g\<circ\>f|)><around*|(|x+h|)>-<around*|(|g\<circ\>f|)><around*|(|x|)>-<around*|(|Dg<around*|(|f<around*|(|x|)>|)>\<circ\>Df<around*|(|x|)>|)><around*|(|h|)>=\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>\<cdot\><around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>+Dg<around*|(|f<around*|(|x|)>|)><around*|(|\<varepsilon\><rsub|f><around*|(|h|)>|)>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>
    </equation>

    Define now <math|\<zeta\>:T<rsub|x>\<rightarrow\>Z> by

    <\equation>
      <label|eq 12.6>\<zeta\><around*|(|h|)>=<choice|<tformat|<table|<row|<cell|\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>\<cdot\><frac|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>+Dg<around*|(|f<around*|(|x|)>|)><around*|(|\<varepsilon\><rsub|f><around*|(|h|)>|)>
      if h\<neq\>0>>|<row|<cell|0 if h=0>>>>>
    </equation>

    then using <reference|eq 12.5> we have

    <\equation>
      <label|eq 12.7>\<forall\>h\<in\>T<rsub|x> we have that
      <around*|(|g\<circ\>f|)><around*|(|x+h|)>-<around*|(|g\<circ\>f|)><around*|(|x|)>-<around*|(|Dg<around*|(|f<around*|(|x|)>|)>\<circ\>Df<around*|(|x|)>|)><around*|(|h|)>=\<zeta\><around*|(|h|)>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>
    </equation>

    If we now prove that <math|\<zeta\>> is continuous at <math|0> so that
    <math|\<zeta\>> is a <math|\<varepsilon\>>-mapping we have by the
    alternative definition of differentiability (see <reference|alternative
    definitions of differentiability>) that
    <math|g\<circ\>f:U<big|cap>f<rsup|-1><around*|(|W|)>\<rightarrow\>Z> \ is
    differentiable at <math|x> with differential
    <math|D<around*|(|g\<circ\>f|)><around*|(|x|)>=D
    g<around*|(|f<around*|(|x|)>|)>\<circ\>D f<around*|(|x|)>>. First as
    <math|\<varepsilon\><rsub|f>> is continuous at <math|0> there exists a
    <math|\<delta\><rsub|1>\<gtr\>0> such that if <math|h\<in\>T<rsub|x>> and
    <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|1>>
    then <math|<around*|\<\|\|\>|\<varepsilon\><rsub|f><around*|(|h|)>|\<\|\|\>><rsub|Y>\<less\>1\<Rightarrowlim\><rsub|<text|<reference|eq
    12.3>>><around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|\<varepsilon\><rsub|f><around*|(|h|)>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>+D
    f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|\<varepsilon\><rsub|f><around*|(|h|)>|\<\|\|\>><rsub|Y>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>+<around*|\<\|\|\>|D
    f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>+<around*|\<\|\|\>|D
    f<around*|(|x|)>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>=<around*|(|1+<around*|\<\|\|\>|D
    f<around*|(|x|)>|\<\|\|\>>|)>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>
    so that

    <\equation>
      <label|eq 12.8>if 0\<less\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|1>
      then <around*|\<\|\|\>|\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>|\<\|\|\>><rsub|Z>\<cdot\><frac|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>\<leqslant\><around*|\<\|\|\>|\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>|\<\|\|\>><rsub|Z><around*|(|1+<around*|\<\|\|\>|Df<around*|(|x|)>|\<\|\|\>>|)>
    </equation>

    Take now <math|\<varepsilon\>\<gtr\>0> arbitrary then by continuity of
    <math|\<varepsilon\><rsub|g>> at <math|0> there exists a
    <math|\<delta\><rsub|2>\<gtr\>0> so that

    <\equation>
      <label|eq 12.9\<longminus\>1>if k\<in\>W<rsub|f<around*|(|x|)>> and
      <around*|\<\|\|\>|k|\<\|\|\>><rsub|Y>\<less\>\<delta\><rsub|2> then
    ...
    <math|h\<in\>T<rsub|x>> (and thus <math|f<around*|(|x+h|)>-f<around*|(|x|)>\<in\>W<rsub|f<around*|(|x|)>>>
    as seen in <reference|eq 0.12.5>) and
    <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|3>>
    then <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>\<less\>\<delta\><rsub|2>\<Rightarrowlim\><rsub|<text|<reference|eq
    12.9\<longminus\>1>>><around*|\<\|\|\>|\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>|\<\|\|\>><rsub|Z>\<less\><frac|\<varepsilon\>|2\<cdot\><around*|(|1+<around*|\<\|\|\>|Df<around*|(|x|)>|\<\|\|\>>|)>>>
    and thus using <reference|eq 12.8> we have

    <\equation>
      <label|eq 12.10>if h\<in\>T<rsub|x> and
      0\<less\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>min<around*|(|\<delta\><rsub|1>,\<delta\><rsub|2>,\<delta\><rsub|3>|)>
      then <around*|\<\|\|\>|\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>|\<\|\|\>><rsub|Z>\<cdot\><frac|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>\<less\><frac|\<varepsilon\>|2>
    </equation>
    ...
    then <math|<around*|\<\|\|\>|\<varepsilon\><rsub|f><around*|(|h|)>|\<\|\|\>><rsub|Y>\<less\><frac|\<varepsilon\>|2\<cdot\><around*|(|1+<around*|\<\|\|\>|Dg<around*|(|f<around*|(|x|)>|)>|\<\|\|\>>|)>>>
    and thus

    <\equation>
      <label|eq 12.11>if <around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|4>
      then <around*|\<\|\|\>|D g<around*|(|f<around*|(|x|)>|)><around*|(|\<varepsilon\><rsub|f><around*|(|h|)>|)>|\<\|\|\>><rsub|Z>\<less\><frac|\<varepsilon\>|2>
    </equation>

    So finally if we take <math|\<delta\>=min<around*|(|\<delta\><rsub|1>,\<delta\><rsub|2>,\<delta\><rsub|3>,\<delta\><rsub|4>|)>>
    then if <math|h\<in\>T<rsub|x>> with <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\>>
    then we have to consider the following cases:

    <\enumerate>
      <item><dueto|<math|h=0>>then <math|<around*|\<\|\|\>|\<zeta\><around*|(|h|)>-0|\<\|\|\>><rsub|Z>=<around*|\<\|\|\>|0|\<\|\|\>><rsub|Z>=0\<less\>\<varepsilon\>>

      <item><dueto|<math|h\<neq\>0>>then <math|0\<less\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\>>
      ...
      by using <reference|eq 12.10> and <reference|eq 12.11>.
    </enumerate>

    As in all cases (1) and (2) we have <math|<around*|\<\|\|\>|\<zeta\><around*|(|h|)>-0|\<\|\|\>><rsub|Z>\<less\>\<varepsilon\>>
    we have proved continuity at <math|0> for <math|\<zeta\>> and that
    <math|\<zeta\><around*|(|0|)>=0>.
  </proof>
  ...
  <\corollary>
    ...
    <math|g:V\<rightarrow\>Y> functions with
  ...
  <\proof>
    If <math|x\<in\>U\<Rightarrow\>f<around*|(|x|)>\<in\>f<around*|(|U|)>\<subseteq\>V\<Rightarrow\>f<around*|(|x|)>\<in\>V\<Rightarrow\>x\<in\>f<rsup|-1><around*|(|V|)>>
    so that <math|U<big|cap>f<rsup|-1><around*|(|V|)>=U> open or
    <math|U\<subseteq\>f<rsup|-1><around*|(|U|)>>. Using the previous theorem
    and the fact that <math|Y> is open in <math|Y> and <math|Z> is open in
    <math|Z> we have then that <math|g\<circ\>f:U\<rightarrow\>Z> is
    differentiable at <math|x\<in\>U> with <math|D
    <around*|(|g\<circ\>f|)><around*|(|x|)>=D
    f<around*|(|g<around*|(|x|)>|)>\<circ\>D f<around*|(|x|)>>
  </proof>

  <subsection|Partial differential>
  ...
  <\definition>
    ...
    <math|X=<around*|\<langle\>|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    ...
    <math|x=<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>\<in\>U> and
    <math|f:U\<rightarrow\>V>, a function,
    <math|i\<in\><around*|{|1,\<ldots\>,n|}>>, then <math|f:U\<rightarrow\>V>
    ...
    if <math|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsub|>:<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsup|-1><around*|(|U|)>\<rightarrow\>V>
    is differentiable at <math|x<rsub|i>> with
    <math|D<rsub|i>f<around*|(|x|)>=D<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>|)><around*|(|x<rsub|i>|)>>
    [This make sense as by <reference|(x1,..,xi-1,*,xi+1,..,xn)^-1(U)>
    <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsup|-1><around*|(|U|)>>
    is open in <math|X<rsub|i>> and we have trivially
    <math|x<rsub|i>\<in\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsup|-1><around*|(|U|)>>
    as <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><around*|(|x<rsub|i>|)>=x\<in\>U>].
  </definition>
  ...
  <\theorem>
    ...
    <math|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    be a finite family of normed spaces, <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    a normed space, a open set <math|V\<subseteq\>Y>,
    <math|<around*|\<langle\>|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    a normed space equipped with the maximum norm (see <reference|norm of
    finite product of normed spaces>), <math|U\<subseteq\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>,
    <math|x=<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>\<in\>U>, a open set
    <math|> and <math|f:U\<rightarrow\>V> is differentiable at
    <math|x\<in\>U> \ then <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
    <math|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>:<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsup|-1><around*|(|U|)>\<rightarrow\>Y>
    is differentiable at <math|x<rsub|i>> with
    <math|D<rsub|i><rsup|<rsub|>>f<around*|(|x|)>=D
    f<rsup|<around*|(|i|)>><around*|(|x<rsub|i>|)>=D
    f<around*|(|x|)>\<circ\><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>>
    [so that <math|D f<rsup|<around*|(|i|)>><around*|(|x<rsub|i>|)><around*|(|t|)>=D
    f<around*|(|x|)><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,t,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>>].
    Further by using <reference|sum of (01,...,*,...0n)> we have <math|D
    f<around*|(|x|)><around*|(|h|)>=D f<around*|(|x|)><around*|(|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)><around*|(|h<rsub|i>|)>|)>\<equallim\><rsub|D
    f<around*|(|x|)> is linear><big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>D
    f<around*|(|x|)><around*|(|<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)><around*|(|h<rsub|i>|)>|)>=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>D<rsub|i>f<around*|(|x|)><around*|(|h<rsub|i>|)>=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|(|D<rsub|i>f<around*|(|x|)>\<circ\>\<pi\><rsub|i>|)><around*|(|h|)>>
    giving that <math|D f<around*|(|x|)>=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>D<rsub|i>f<around*|(|x|)>\<circ\>\<pi\><rsub|i>>.
  </theorem>

  <\proof>
    Using <reference|(x1,...,*,...) is differentiable> and
    <reference|differentiability and restricted mapping> we have that
    <math|<around*|(|x<rsub|1>,\<ldots\>.,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>:X<rsub|i>\<rightarrow\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>
    is differentiable with <math|D<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><around*|(|x<rsub|i>|)>=<around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>>.
    Using the chain rule <reference|chain rule> we have that
    <math|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>:<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsup|-1><around*|(|U|)><big|cap>X<rsub|i>=<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsup|-1><around*|(|U|)>\<rightarrow\>Y>
    is differentiable at <math|x<rsub|i>> with
    <math|D<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>|)><around*|(|x<rsub|i>|)>=D
    f<around*|(|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsub|><around*|(|x<rsub|i>|)>|)>\<circ\>D<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><around*|(|x<rsub|i>|)>=D
    f<around*|(|x|)>\<circ\><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>>.
  </proof>

  Just like we have defined the derivative of a function, we define now the
  ...
  <\definition>
    ...
    <math|i\<in\><around*|{|1,\<ldots\>,n|}>> then <math|f> has a
    <with|font-series|bold|partial derivative> <with|font-series|bold|at>
    <math|x> noted by <math|\<partial\><rsub|i>f<around*|(|x|)>\<in\>Y> if
    and only if <math|\<forall\>\<varepsilon\>\<gtr\>0> there exists a
    <math|\<delta\>\<gtr\>0> such that if
    <math|0\<less\><around*|\||h|\|>\<less\>\<delta\>> and
    <math|h\<in\><around*|[|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsup|-1><around*|(|U|)>|]><rsub|x<rsub|i>>>
    then <math|<around*|\<\|\|\>|<frac|f<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,x<rsub|i>+h,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>-f<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>|h>-\<partial\><rsub|i>f<around*|(|x|)>|\<\|\|\>><rsub|Y>\<less\>\<delta\>>
  </definition>

  If in the above theorem we replace <math|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>>
  by <math|<around*|\<langle\>|\<bbb-K\>\<nocomma\>,<around*|\|||\|>|\<rangle\>>>
  we get the following theorem

  <\theorem>
    <label|differentiability of K^n>Let <math|<around*|\<langle\>|\<bbb-K\><rsup|n>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    be the vector space <math|\<bbb-K\><rsup|n>> equipped with the maximum
    norm based on <math|<around*|\|||\|>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>|<rsub|>|\<\|\|\>><rsub|Y>|\<rangle\>>>
    a normed space, \ <math|V\<subseteq\>Y,U\<subseteq\>\<bbb-K\><rsup|n>> a
    open set, <math|x\<in\>U> and <math|f:U\<rightarrow\>V> a function that
    is differentiable at <math|x=<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>>
    then <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>> <math|f> has a
    partial derivative <math|\<partial\><rsub|i>f<around*|(|x|)>> and the
    ...
    If <math|<around*|{|e<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    ...
    (using the matrix product <math|\<cdot\>>)
  </theorem>

  TODO

  <\proof>
    Using <reference|differentiability on products of metric spaces> we have
    that <math|D<rsub|i>f<around*|(|x|)>=D
    f<around*|(|x|)>\<circ\><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>>
    and <math|D f<around*|(|x|)><around*|(|h|)>=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>D<rsub|i>f<rsup|><around*|(|x|)><around*|(|h<rsub|i>|)>>.
    Now as <math|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>:<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsup|-1><around*|(|U|)>\<subseteq\>\<bbb-K\>\<rightarrow\>Y>
    we can use <reference|differentias and derivates> to find that
    <math|D<rsub|i>f<around*|(|x|)>=D<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>|)><around*|(|x<rsub|i>|)>:\<bbb-K\>\<rightarrow\>Y>
    is defined by <math|k\<rightarrow\>D<rsub|i>f<around*|(|x|)><around*|(|k|)>=D<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>|)><around*|(|x<rsub|i>|)><around*|(|k|)>=<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>|)><rprime|'><around*|(|x<rsub|i>|)>\<cdot\>k>
    where <math|D<rsub|i>f<around*|(|x|)><around*|(|1|)>=D<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>|)><around*|(|x<rsub|i>|)><around*|(|1|)>=<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>|)><rprime|'><around*|(|x<rsub|i>|)>>.
    Here the derivative <math|<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>|)><rprime|'><around*|(|x<rsub|i>|)>>
    is defined to be the unique value such that given a
    <math|\<varepsilon\>\<gtr\>0> there exists a <math|\<delta\>\<gtr\>0>
    such that if <math|0\<less\><around*|\||h|\|>\<less\>\<delta\>> then
    \ <math|<around*|\<\|\|\>|<frac|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><around*|(|x<rsub|i>+h|)>-f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><around*|(|x<rsub|i>|)>|h>-<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>|)><rprime|'><around*|(|x<rsub|i>|)>|\<\|\|\>><rsub|Y>\<less\>\<varepsilon\>>
    and as <math|<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsub|\|\<pi\><rsub|i><around*|(|U|)>>|)><around*|(|x<rsub|i>+h|)>-<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsub|\|\<pi\><rsub|i><around*|(|U|)>>|)><around*|(|x<rsub|i>|)>=f<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,x<rsub|i>+h,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>-f<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>>
    \ we have that <math|<around*|(|f\<circ\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsub|\|\<pi\><rsub|i><around*|(|U|)>>|)><rprime|'><around*|(|x<rsub|i>|)>=\<partial\><rsub|i>f<around*|(|x|)>>,
    so we have <math|D<rsub|i>f<around*|(|x|)><around*|(|k|)>=\<partial\><rsub|i>f<around*|(|x|)>\<cdot\>k>.
    Further <math|\<partial\><rsub|i>f<around*|(|x|)>=D<rsub|i>f<around*|(|x|)><around*|(|1|)>=<around*|(|D
    f<around*|(|x|)>\<circ\><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,\<ast\>,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>|)><around*|(|1|)>=D
    f<around*|(|x|)><around*|(|0<rsub|1>,\<ldots\>,0<rsub|i-1>,1,0<rsub|i+1>,\<ldots\>,0<rsub|n>|)>=D
    f<around*|(|x|)><around*|(|e<rsub|i>|)>>. Finally <math|D
    f<around*|(|x|)><around*|(|h|)>=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>D<rsub|i>f<around*|(|x|)><around*|(|h<rsub|i>|)>=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<partial\><rsub|i>f<around*|(|x|)>\<cdot\>h<rsub|i>=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>h<rsub|i>\<cdot\>D
  ...
  <\theorem>
    ...
    open, <math|x\<in\>U>, a open set <math|V\<subseteq\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>Y<rsub|i>>
    and <math|f:X\<rightarrow\>V> a function
    <math|x\<rightarrow\>f<around*|(|x|)>=<around*|(|f<rsub|1><around*|(|x|)>,\<ldots\>,f<rsub|n><around*|(|x|)>|)>>
    where <math|f<rsub|i>=\<pi\><rsub|i>\<circ\>f:U\<rightarrow\>\<pi\><rsub|i><around*|(|V|)>>.
    Then <math|f> is differentiable at <math|x> iff and only if
    <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>> <math|f<rsub|i>> is
    differentiable at <math|x>. If <math|D f<around*|(|x|)>> exists then
    <math|D f<around*|(|x|)><around*|(|h|)>=<around*|(|Df<rsub|1><around*|(|x|)><around*|(|h|)>,\<ldots\>,Df<rsub|n><around*|(|x|)><around*|(|h|)>|)>>
    or equivalently <math|\<pi\><rsub|i>\<circ\>D f<around*|(|x|)>=D
    f<rsub|i><around*|(|x|)>>.
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|\<Rightarrow\>>>As <math|f> is differentiable, given
      <math|\<varepsilon\>\<gtr\>0> there exists a <math|\<delta\>\<gtr\>0>
      such that if <math|h\<in\>U<rsub|x>> and
      <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\>> then
      \ <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-Df<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|h<rsub|>|\<\|\|\>><rsub|X>\<cdot\>\<varepsilon\><rsub|>>,
      ...
      so that <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>> we have if
      ...
      <item><dueto|<math|\<Leftarrow\>>>Suppose that
      <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
      ...
      then <math|<around*|\<\|\|\>|f<rsub|i><around*|(|x+h|)>-f<rsub|i><around*|(|x|)>-D
      ...
      as <math|D f<rsub|i><around*|(|x|)>> \ is linear and as
      ...
      so that <math|D f<around*|(|x|)>> is also continuous. Take now
      ...
      we have <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<leqslant\>\<delta\><rsub|i>\<Rightarrow\><around*|\<\|\|\>|f<rsub|i><around*|(|x+h|)>-f<rsub|i><around*|(|x|)>-D
      f<rsub|i><around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|i>\<leqslant\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<Rightarrow\><around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-Df<around*|(|x|)><around*|(|h|)>|\<\|\|\>>=max<around*|(|<around*|{|<around*|\<\|\|\>|f<rsub|i><around*|(|x+h|)>-f<rsub|i><around*|(|x|)>-D
  ...
  <\theorem>
    ...
    be two vector spaces based on <math|<around*|\<langle\>|\<bbb-K\>,<around*|\|||\|>|\<rangle\>>>,a
    open set <math|U\<subseteq\>\<bbb-K\><rsup|n>>, <math|x\<in\>U>, a open
    set <math|V\<subseteq\>\<bbb-K\><rsup|m>> and <math|f:U\<rightarrow\>V> a
    differentiable function then <math|\<forall\>j\<in\><around*|{|1,\<ldots\>,m|}>>
    we have <math|\<pi\><rsub|j><around*|(|D
    f<around*|(|x|)><around*|(|h|)>|)>=<around*|(|D
    ...
    If we define the matrix <math|\<partial\><around*|(|f<rsub|1>,\<ldots\>,f<rsub|m>|)><around*|(|x|)>=<matrix|<tformat|<table|<row|<cell|\<partial\><rsub|1>f<rsub|1><around*|(|x|)>>|<cell|\<cdots\>>|<cell|\<partial\><rsub|n>f<rsub|1><around*|(|x|)>>>|<row|<cell|.>|<cell|>|<cell|.>>|<row|<cell|.>|<cell|>|<cell|.>>|<row|<cell|.>|<cell|>|<cell|.>>|<row|<cell|\<partial\><rsub|1>f<rsub|m><around*|(|x|)>>|<cell|>|<cell|\<partial\><rsub|n>f<rsub|m><around*|(|x|)>>>>>>>
    ...
    f<around*|(|x|)><around*|(|h|)>=\<partial\><around*|(|f<rsub|1>,\<ldots\>,f<rsub|m>|)><around*|(|x|)>\<cdot\>h>.
    The matrix <math|\<partial\><around*|(|f<rsub|1>,\<ldots\>,f<rsub|m>|)>>
    is called the Jacobian matrix of <math|f>.
  </theorem>

  <\proof>
    Using <reference|differentiability of map to product of spaces> we have
    that <math|D f<around*|(|x|)>=<around*|(|D
    f<rsub|i><around*|(|x|)>,\<ldots\>,D f<rsub|m><around*|(|x|)>|)>> so that
    <math|<around*|(|D f<around*|(|x|)><around*|(|h|)>|)><rsub|j>=D
    f<rsub|j><around*|(|x|)><around*|(|h|)><rsub|>>. As
    <math|f<rsub|j>:U\<subseteq\>\<bbb-K\><rsup|n>\<rightarrow\>\<pi\><rsub|j><around*|(|V|)>>
  ...
  <\theorem>
    ...
    and <math|L\<in\>L<around*|(|X<rsub|1>,X<rsub|2>;Y|)>> then
    <math|L:X<rsub|1>\<times\>X<rsub|2>\<rightarrow\>Y> is differentiable at
    <math|x> and <math|D L<around*|(|x<rsub|1>,x<rsub|2>|)>=L<around*|(|x<rsub|1>,\<ast\>|)>+L<around*|(|\<ast\>,x<rsub|2>|)>>
  ...
  <\proof>
    ...
    is linear. <math|<around*|(|L<around*|(|x<rsub|1>,\<ast\>|)>+L<around*|(|\<ast\>,x<rsub|2>|)>|)><around*|(|\<alpha\>\<cdot\><around*|(|h<rsub|1>,h<rsub|2>|)>+\<beta\>\<cdot\><around*|(|g<rsub|1>,g<rsub|2>|)>|)>=<around*|(|L<around*|(|x<rsub|1>,\<ast\>|)>+L<around*|(|\<ast\>,x<rsub|2>|)>|)><around*|(|\<alpha\>\<cdot\>h<rsub|1>+\<beta\>\<cdot\>g<rsub|1>,\<alpha\>\<cdot\>h<rsub|2>+\<beta\>\<cdot\>g<rsub|2>|)>=L<around*|(|x<rsub|1>,\<alpha\>\<cdot\>h<rsub|2>+\<beta\>\<cdot\>g<rsub|2>|)>+L<around*|(|\<alpha\>\<cdot\>h<rsub|1>+\<beta\>\<cdot\>g<rsub|1>,x<rsub|2>|)>=\<alpha\>\<cdot\>L<around*|(|x<rsub|1>,h<rsub|2>|)>+\<alpha\>\<cdot\>L<around*|(|h<rsub|1>,x<rsub|2>|)>+\<beta\>\<cdot\>L<around*|(|x<rsub|1>,g<rsub|2>|)>+\<beta\>\<cdot\>L<around*|(|g<rsub|1>,x<rsub|2>|)>=\<alpha\>\<cdot\><around*|(|L<around*|(|x<rsub|1>,\<ast\>|)>+L<around*|(|\<ast\>,x<rsub|2>|)>|)><around*|(|h<rsub|1>,h<rsub|2>|)>+\<beta\>\<cdot\><around*|(|L<around*|(|x<rsub|1>,\<ast\>|)>+L<around*|(|\<ast\>,x<rsub|2>|)>|)><around*|(|g<rsub|1>,g<rsub|2>|)>>.\ 
    ...
    then (definition of maximum norm) <math|<around*|\<\|\|\>|h<rsub|1>|\<\|\|\>><rsub|1>\<leqslant\>1>
    and <math|<around*|\<\|\|\>|h<rsub|2>|\<\|\|\>><rsub|2>\<leqslant\>1>
    then <math|<around*|\<\|\|\>|<around*|(|L<around*|(|x<rsub|1>,\<ast\>|)>+L<around*|(|\<ast\>,x<rsub|2>|)>|)><around*|(|h<rsub|1>,h<rsub|2>|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|L<around*|(|x<rsub|1>,h<rsub|2>|)>+L<around*|(|h<rsub|1>,x<rsub|2>|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|L<around*|(|x<rsub|1>,h<rsub|2>|)>|\<\|\|\>><rsub|Y>+<around*|\<\|\|\>|L<around*|(|h<rsub|1>,x<rsub|2>|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|L|\<\|\|\>>\<cdot\><around*|\<\|\|\>|x<rsub|1>|\<\|\|\>><rsub|1>\<cdot\><around*|\<\|\|\>|h<rsub|2>|\<\|\|\>><rsub|2>+<around*|\<\|\|\>|L|\<\|\|\>>\<cdot\><around*|\<\|\|\>|x<rsub|2>|\<\|\|\>><rsub|2>\<cdot\><around*|\<\|\|\>|h<rsub|1>|\<\|\|\>><rsub|1>\<leqslant\><around*|\<\|\|\>|L|\<\|\|\>>\<cdot\><around*|(|<around*|\<\|\|\>|x|\<\|\|\>><rsub|1>+<around*|\<\|\|\>|x<rsub|2>|\<\|\|\>><rsub|2>|)>>
    which by <reference|continuity and multilinearity> means that continuity
    is proved.

    Finally let <math|\<varepsilon\>\<gtr\>0> and take
    <math|\<delta\>\<less\><frac|\<varepsilon\>|<around*|\<\|\|\>|L|\<\|\|\>>+1>>
    ...
    then <math|<around*|\<\|\|\>|L<around*|(|<around*|(|x<rsub|1>,x<rsub|2>|)>+<around*|(|h<rsub|1>,h<rsub|2>|)>|)>-L<around*|(|<around*|(|x,y|)>|)>-<around*|(|L<around*|(|x<rsub|1>,\<ast\>|)>+L<around*|(|*\<ast\>,x<rsub|2>|)>|)><around*|(|h<rsub|1>,h<rsub|2>|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|L<around*|(|x<rsub|1>+h<rsub|1>,x<rsub|2>+h|)>-L<around*|(|x,y|)>-L<around*|(|x<rsub|1>,h<rsub|2>|)>-L<around*|(|h<rsub|1>,x<rsub|2>|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|L<around*|(|x<rsub|1>,x<rsub|2>+h<rsub|2>|)>+L<around*|(|h<rsub|1>,x<rsub|2>+h<rsub|2>|)>-L<around*|(|x,y|)>-L<around*|(|x<rsub|1>,h<rsub|2>|)>-L<around*|(|h<rsub|1>,x<rsub|2>|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|L<around*|(|x<rsub|1>,x<rsub|2>|)>+L<around*|(|x<rsub|1>,h<rsub|2>|)>+L<around*|(|h<rsub|1>,x<rsub|2>|)>+L<around*|(|h<rsub|1>,h<rsub|2>|)>-L<around*|(|x<rsub|1>,x<rsub|2>|)>-L<around*|(|x<rsub|1>,h<rsub|2>|)>-L<around*|(|h<rsub|1>,x<rsub|2>|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|L<around*|(|h<rsub|1>,h<rsub|2>|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|L|\<\|\|\>>\<cdot\><around*|\<\|\|\>|h<rsub|1>|\<\|\|\>><rsub|1>\<cdot\><around*|\<\|\|\>|h<rsub|2>|\<\|\|\>><rsub|2>\<less\><around*|\<\|\|\>|L|\<\|\|\>>\<cdot\><frac|\<varepsilon\>|<around*|\<\|\|\>|L|\<\|\|\>>+1>\<cdot\><around*|\<\|\|\>|h<rsub|2>|\<\|\|\>>\<less\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h<rsub|2>|\<\|\|\>>\<leqslant\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|<around*|(|h<rsub|1>,h<rsub|2>|)>|\<\|\|\>>>
    proving that <math|DL<around*|(|x,y|)>=L<around*|(|x<rsub|1>,\<ast\>|)>+L<around*|(|\<ast\>,x<rsub|2>|)>>
  </proof>

  We can use the above theorem to proof the differential of a product of
  functions
  ...
  <\corollary>
    ...
    is differentiable at <math|x> with <math|D<around*|(|f\<cdot\>g|)><around*|(|x|)>=g<around*|(|x|)>\<cdot\>Df<around*|(|x|)>+f<around*|(|x|)>\<cdot\>Dg<around*|(|x|)>>.
  </corollary>
  ...
  <\proof>
    ...
    <math|<around*|(|x,y|)>\<Rightarrow\>x\<cdot\>y> is clearly bi-linear and
    continuous [as if <math|<around*|\<\|\|\>|<around*|(|x,y|)>|\<\|\|\>>\<leqslant\>1\<Rightarrow\><around*|\||x|\|>,<around*|\||y|\|>\<leqslant\>1>
    so that <math|<around*|\||x\<cdot\>y|\|>\<leqslant\><around*|\||x|\|>\<cdot\><around*|\||y|\|>\<leqslant\>1>]
    so that it is differentiable with <math|D
    p<around*|(|x,y|)>=x\<cdot\>\<ast\>*+\<ast\>\<cdot\>y>. Now as
    <math|f\<cdot\>g=p\<circ\>h> we have by the chain rule (see
  ...
  <\corollary>
    ...
    <math|f,g:U\<rightarrow\>\<bbb-K\>> have a derivative at <math|x> then
    <math|f\<cdot\>g> has a derivative at <math|x> and
  ...
  <\proof>
    ...
    and derivates> has a derivative. Also using <reference|differentias and
  ...
  <\corollary>
    ...
    <math|z\<in\>\<bbb-N\><rsub|0>> define then
    <math|\<ast\><rsup|z>:\<bbb-K\>\<rightarrow\>\<bbb-K\>> by
    <math|x\<rightarrow\>x<rsup|z>> then <math|\<ast\><rsup|z>> has a
    derivative at <math|x\<in\>\<bbb-K\>> given by
    <math|<around*|(|\<ast\><rsup|z>|)><rprime|'><around*|(|x|)>=z\<cdot\>\<ast\><rsup|z-1><around*|(|x|)><rsup|>>,
    if <math|z\<in\><around*|{|-z\|z\<in\>\<bbb-N\><rsub|0>|}>> then
    <math|\<ast\><rsup|z>:\<bbb-K\>\\<around*|{|0|}>\<rightarrow\>\<bbb-K\>\\<around*|{|0|}>>
    defined by <math|x\<rightarrow\>x<rsup|z>=<frac|1|x<rsup|-z>>> has a
    derivative at <math|x\<in\>\<bbb-K\>\\<around*|{|0|}>> (open set) given
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|z\<in\>\<bbb-N\><rsub|0>>>We proceed here by
      induction so let <math|S=<around*|{|z\<in\>\<bbb-N\><rsub|0>\|\<ast\><rsup|z>
      has a derivate z\<cdot\>\<ast\><rsup|z-1>|}>> then we have\ 

      <\enumerate>
        <item>If <math|z=1> then <math|\<ast\><rsup|1>:\<bbb-K\>\<rightarrow\>\<bbb-K\>>
        is linear so that <math|<around*|(|\<ast\><rsup|1>|)><rprime|'><around*|(|x|)>=D\<ast\><rsup|1><around*|(|x|)><around*|(|1|)>=\<ast\><rsup|1><around*|(|1|)>=1<rsup|1>=1=1\<cdot\>x<rsup|0>=1\<cdot\>x<rsup|z-1>*>
        so that <math|1\<in\>S>

        <item>Assume now that <math|z\<in\>S> then we have that
      ...
      <item><dueto|<math|z\<in\><around*|{|-z\|z\<in\>\<bbb-N\><rsub|0>|}>>>again
      we prove this by induction so let <math|S=<around*|{|z\<in\>\<bbb-N\><rsub|0>\|\<ast\><rsup|-z>
      has a derivate <around*|(|-z|)>\<cdot\>\<ast\><rsup|<around*|(|-z-1|)>>|}>>
      then we have

      <\enumerate>
        <item>If <math|z=1> then <math|\<ast\><rsup|-1>:\<bbb-K\>\\<around*|{|0|}>\<rightarrow\>\<bbb-K\>\\<around*|{|0|}>>
        is defined by <math|x\<rightarrow\><frac|1|x>> now if
        <math|x,h\<in\>\<bbb-K\>\\<around*|{|0|}>>
        <math|<frac|<frac|1|x+h>-<frac|1|x>|h>+<frac|1|x<rsup|2>>=<frac|<frac|x|x\<cdot\><around*|(|x+h|)>>-<frac|x+h|x\<cdot\><around*|(|x+h|)>>|h>+<frac|1|x<rsup|2>>=<frac|<frac|-h|x\<cdot\><around*|(|x+h|)>>|h>+<frac|1|x<rsup|2>>=<frac|-1|x\<cdot\><around*|(|x+h|)>>+<frac|1|x<rsup|2>>=<frac|1|x>\<cdot\><around*|(|<frac|-1|x+h>+<frac|1|x>|)>=<frac|1|x>\<cdot\><frac|-x+x+h|x\<cdot\><around*|(|x+h|)>>=<frac|h|x<rsup|2>\<cdot\><around*|(|x+h|)>>>
        giving

        <\equation>
          <label|eq 12.12><frac|<frac|1|x+h>-<frac|1|x>|h>+<frac|1|x<rsup|2>>=<frac|h|x<rsup|2>\<cdot\><around*|(|x+h|)>>
        </equation>

        Given <math|\<varepsilon\>\<gtr\>0> take then
        <math|0\<less\>\<delta\>\<less\>min<around*|(|<frac|\<varepsilon\>\<cdot\><around*|\||x|\|><rsup|3>|2>,<frac|<around*|\||x|\|>|2>|)>>
        then if <math|0\<less\><around*|\||h|\|>\<less\>\<delta\>> we have
        <math|<around*|\||h|\|>\<less\><frac|<around*|\||x|\|>|2>> giving
        <math|-<frac|<around*|\||x|\|>|2>\<less\>-<around*|\||h|\|>\<Rightarrow\><frac|<around*|\||x|\|>|2>=<around*|\||x|\|>-<frac|<around*|\||x|\|>|2>\<less\><around*|\||x|\|>-<around*|\||h|\|>\<leqslant\><around*|\||x+h|\|>>
        ...
        and thus <math|<around*|\||<frac|h|x<rsup|2>\<cdot\><around*|(|x+h|)>>|\|>=<frac|<around*|\||h|\|>|<around*|\||x|\|><rsup|2>\<cdot\><around*|\||x+h|\|>>\<less\><frac|2\<cdot\><around*|\||h|\|>|<around*|\||x|\|>\<cdot\><around*|\||x|\|><rsup|2>>=2\<cdot\><frac|h|<around*|\||x|\|><rsup|3>>\<leqslant\>2\<cdot\><frac|\<varepsilon\>\<cdot\><around*|\||x|\|><rsup|3>|<around*|\||x<rsup|3>|\|>\<cdot\>2>=\<varepsilon\>>.
        So if <math|0\<less\>\<delta\>\<less\>min<around*|(|<frac|\<varepsilon\>\<cdot\><around*|\||x|\|><rsup|3>|2>,<frac|<around*|\||x|\|>|2>|)>>
        ...
        <item>If <math|z\<in\>S> the <math|<around*|(|\<ast\>|)><rsup|-<around*|(|z+1|)>><around*|(|x|)>=<frac|1|\<ast\><rsup|z+1><around*|(|x|)>>=<frac|1|x<rsup|z+1>>=<frac|1|x\<cdot\>x<rsup|z>>><math|=<around*|(|\<ast\><rsup|-1>|)><around*|(|x|)>\<cdot\><around*|(|\<ast\><rsup|z>|)><around*|(|x|)>>
        so that <math|<around*|(|\<ast\>|)><rsup|-<around*|(|z+1|)>>=<around*|(|\<ast\>|)><rsup|-1>\<cdot\><around*|(|\<ast\><rsup|-1>|)>>
        so using the previous corollary we have
        <math|<around*|(|<around*|(|\<ast\>|)><rsup|-<around*|(|z+1|)>>|)><rprime|'><around*|(|x|)>=<around*|(|\<ast\><rsup|-1>|)><around*|(|x|)>\<cdot\><around*|(|\<ast\><rsup|-z>|)><rprime|'><around*|(|x|)>+<around*|(|\<ast\><rsup|-z>|)><around*|(|x|)>\<cdot\><around*|(|\<ast\><rsup|-1>|)><rprime|'><around*|(|x|)>\<equallim\><rsub|<around*|(|a|)>
        and z\<in\>S>x<rsup|-1>\<cdot\><around*|(|-z|)>\<cdot\><around*|(|\<ast\><rsup|-z-1>|)><around*|(|x|)>+x<rsup|-z>\<cdot\><around*|(|-1|)>\<cdot\><around*|(|\<ast\><rsup|-2>|)><around*|(|x|)>=x<rsup|-1>\<cdot\><around*|(|-z|)>\<cdot\>x<rsup|-z-1>-x<rsup|-z>\<cdot\>x<rsup|-2>=-z\<cdot\>x<rsup|-z-2>-x<rsup|-z-2>=<around*|(|-z-1|)>\<cdot\>x<rsup|-z-2>=<around*|(|-<around*|(|z+1|)>|)>\<ast\>x<rsup|-<around*|(|z+1|)>-1>=<around*|(|-<around*|(|z+1|)>|)>\<cdot\><around*|(|\<ast\><rsup|-<around*|(|z+1|)>-1>|)><around*|(|x|)>>
        proving that <math|<around*|(|\<ast\><rsup|-<around*|(|z+1|)>>|)><rprime|'>=<around*|(|-<around*|(|z+1|)>|)>\<cdot\>\<ast\><rsup|-<around*|(|z+1|)>-1>>
        or <math|z+1\<in\>S>
      </enumerate>
  ...
  We define higher order differentiability as follows

  <\definition>
    <index|<math|D<rsup|n>f>>Let <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, a open set
    ...
    <math|D<rsup|n>f:U\<rightarrow\>L<rsup|n><around*|(|X;Y|)>> if one of the
    ...
    <\enumerate>
      ...
      <math|x\<rightarrow\>D<rsup|1>f<around*|(|x|)>=Df<around*|(|x|)>>

      <item>If <math|1\<less\>n> then <math|f> must be
      <math|<around*|(|n-1|)>>-times differentiable on <math|U> with
      <math|D<rsup|n-1>f:U\<rightarrow\>L<rsup|n-1><around*|(|X;Y|)>>
      differentiable at every <math|x\<in\>U> and
      <math|D<rsup|n>f:U\<rightarrow\>L<rsup|n><around*|(|X;Y|)>> is defined
      by <math|x\<rightarrow\>D<rsup|n>f<around*|(|x|)>=D<around*|(|D<rsup|n-1>f|)><around*|(|x|)>\<in\>L<around*|(|X,L<around*|(|X<rsup|n-1>;Y|)>|)>=L<around*|(|X<rsup|n>;Y|)>>
  ...
  <\definition>
    ...
    <math|C<rsup|n>> if either

    <\enumerate>
      <item>If <math|n=0> then <math|f> is continuous on <math|U>

      <item>If <math|1\<less\>n> then <math|f> is <math|n>-times
      differentiable on <math|U> and <math|D<rsup|n>f:U\<rightarrow\>L<rsup|n><around*|(|X;Y|)>>
      is continuous on <math|U>
    </enumerate>
  </definition>

  <\definition>
    <index|<math|C<rsup|\<infty\>>>>Let <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, a open set <math|V>
    and <math|f:U\<rightarrow\>V> a function then <math|f> is of class
    <math|C<rsup|\<infty\>>> if <math|\<forall\>n\<in\>\<bbb-N\>> we have
    that <math|f> is of class <math|C<rsup|n>>
  </definition>

  As for derivatives we use the following definition\ 
  ...
  <\definition>
    ...
    <math|U\<subseteq\>\<bbb-K\>> a open set, <math|V\<subseteq\>\<bbb-K\>> a
    open set, <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>V> a
    function then <math|f> has a <math|n>-the derivative
    <math|f<rsup|<around*|(|n|)>>> on <math|U> if either

    <\enumerate>
      <item>if <math|n=1> then <math|\<forall\>x\<in\>U> <math|f> has a 1-the
      derivative at <math|x> and we define
      <math|f<rsup|<around*|(|1|)>>:U\<rightarrow\>Y> by
      <math|x\<rightarrow\>f<rsup|<around*|(|1|)>><around*|(|x|)>=f<rprime|'><around*|(|x|)>>

      <item>if <math|n\<gtr\>1> then <math|f> has a
      <math|<around*|(|n-1|)>>-the derivative on <math|U> and
      <math|\<forall\>x\<in\>U> we have that
      <math|f<rsup|<around*|(|n-1|)>>:U\<rightarrow\>Y> has a derivative at
      <math|x> and we define <math|f<rsup|<around*|(|n|)>>:U\<rightarrow\>Y>
      by <math|x\<rightarrow\>f<rsup|n><around*|(|x|)>=f<rprime|'><around*|(|f<rsup|<around*|(|n-1|)>><around*|(|x|)>|)>>
    </enumerate>
  </definition>
  ...
  <\lemma>
    ...
    then if we define <math|f<rsub|<around*|(|1|)>>:U\<rightarrow\>L<around*|(|\<bbb-K\>,Y|)>>
    by <math|t\<rightarrow\>f<rsub|<around*|(|1|)>><around*|(|t|)>=f<around*|(|t|)><around*|(|1|)>>
    then we have that <math|f> is continuous iff
    <math|f<rsub|<around*|(|1|)>>> is continous
  </lemma>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|\<Rightarrow\>>>Let <math|x\<in\>U> then as <math|f>
      is continuous on <math|U>, <math|f> is continuous at <math|x>, so
      <math|\<forall\>\<varepsilon\>\<gtr\>0> there exists a
      <math|\<delta\>\<gtr\>0> such that if
      <math|<around*|\||x-y|\|>\<less\>\<delta\>\<Rightarrow\><around*|\<\|\|\>|f<around*|(|x|)>-f<around*|(|y|)>|\<\|\|\>><rsub|L<around*|(|\<bbb-K\>,Y|)>>\<less\>\<varepsilon\>\<Rightarrow\><around*|\<\|\|\>|f<rsub|<around*|(|1|)>><around*|(|x|)>-f<rsub|<around*|(|1|)>><around*|(|y|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|f<around*|(|x|)><around*|(|1|)>-f<around*|(|y|)><around*|(|1|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|<around*|(|f<around*|(|x|)>-f<around*|(|y|)>|)><around*|(|1|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|f<around*|(|x|)>-f<around*|(|y|)>|\<\|\|\>><rsub|L<around*|(|\<bbb-K\>,Y|)>>\<cdot\><around*|\||1|\|>=<around*|\<\|\|\>|f<around*|(|x|)>-f<around*|(|y|)>|\<\|\|\>><rsub|L<around*|(|\<bbb-K\>,Y|)>>\<less\>\<varepsilon\>>
      proving continuity of <math|f<rsub|<around*|(|1|)>>> at <math|x>. As
      <math|x> was chosen arbitrary we have that
      <math|f<rsub|<around*|(|1|)>>> is continuous on <math|U>.

      <item><dueto|<math|\<Leftarrow\>>>Let <math|x\<in\>U> then as
      <math|f<rsub|<around*|(|1|)>>> is continuous on <math|U> we have that
      <math|f<rsub|<around*|(|1|)>>> is continuous at <math|x>, so
      <math|\<forall\>\<varepsilon\>\<gtr\>0> there exists a
      <math|\<delta\>\<gtr\>0> such that if
      <math|<around*|\||x-y|\|>\<less\>\<delta\>\<Rightarrow\><around*|\<\|\|\>|f<rsub|<around*|(|1|)>><around*|(|x|)>-f<rsub|<around*|(|1|)>><around*|(|y|)>|\<\|\|\>><rsub|Y>\<less\><frac|\<varepsilon\>|2>>,
      then as <math|<around*|\<\|\|\>|<around*|(|f<around*|(|x|)>-f<around*|(|y|)>|)><around*|(|r|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|<around*|(|f<around*|(|x|)>-f<around*|(|y|)>|)><around*|(|r\<cdot\>1|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|r\<cdot\><around*|(|f<around*|(|x|)>-f<around*|(|y|)>|)><around*|(|1|)>|\<\|\|\>><rsub|Y>=<around*|\||r|\|>\<cdot\><around*|\<\|\|\>|<around*|(|f<around*|(|x|)>-f<around*|(|y|)>|)><around*|(|1|)>|\<\|\|\>><rsub|Y>=<around*|\||r|\|><around*|\<\|\|\>|f<around*|(|x|)><around*|(|1|)>-f<around*|(|y|)><around*|(|1|)>|\<\|\|\>><rsub|Y>=<around*|\||r|\|><around*|\<\|\|\>|f<rsub|<around*|(|1|)>><around*|(|x|)>-f<rsub|<around*|(|1|)>><around*|(|y|)>|\<\|\|\>><rsub|Y>\<less\><around*|\||r|\|>\<cdot\><frac|\<varepsilon\>|2>\<Rightarrow\><around*|\<\|\|\>|f<around*|(|x|)>-f<around*|(|y|)>|\<\|\|\>><rsub|L<around*|(|\<bbb-K\>,Y|)>>\<leqslant\><frac|\<varepsilon\>|2>\<less\>\<varepsilon\>>
      proving that <math|f> is continuous at <math|x>. As <math|x> was chosen
      arbitrary we have that <math|f> is continuous on <math|U>.
    </enumerate>
  </proof>
  ...
  <\theorem>
    ...
    <math|V\<subseteq\>Y> a open set and <math|f:U\<subseteq\>\<bbb-K\>\<rightarrow\>V>
    ...
    <\enumerate>
      ...
      <math|U> [or <math|f> has a 1-derivative that is continuous).
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|1\<Rightarrow\>2>> As <math|f> is <math|C<rsup|1>>
      we have that <math|f> is differentiable on <math|U> and <math|D
      ...
      f<around|(|x|)><around|(|1|)>=D<rsup|1>f<around*|(|x|)><around*|(|1|)>>.
      We can use now the previous lemma to find that <math|f<rprime|'>> is
      continuous on <math|U> because continuity of <math|D f>.

      <item><dueto|<math|2\<Rightarrow\>1>>As <math|\<forall\>x\<in\>U>
      ...
      and using the previous lemma and the continuity of <math|f<rprime|'>
      >we find that <math|D f:x\<rightarrow\>D f<around|(|x|)>> is
      continuous.
    </enumerate>
  </proof>
  ...
  <\remark>
    ...
    we actually means <math|\<cal-P\><rsub|n><around*|(|D<rsup|n>f<around*|(||)>|)><around*|(|h<rsub|1>,\<ldots\>,h<rsub|n>|)>=D<rsup|n>f<around*|(|x|)><around*|(|h<rsub|1>:\<ldots\>:h<rsub|n>|)>>.
  </remark>

  We next define the concept of differentiable classes

  <\convention>
    If we say that a function is smooth we mean that the function is of class
    <math|C<rsup|\<infty\>>>. If we say that a function is <math|C<rsup|r>>,
    <math|\<forall\>r\<geqslant\>0> then we mean a specific number that can
    include <math|\<infty\>>. Also we say that a function is <math|\<infty\>>
    times differentiable if <math|\<forall\>r\<gtr\>0> we have that <math|f>
    is <math|r>-times differentiable.
  </convention>

  The next theorem proves that the above two definitions are equivalent
  ...
  <\theorem>
    ...
    a open sets and <math|f:U\<rightarrow\>V> a function then <math|f> is of
    class <math|C<rsup|\<infty\>>> iff <math|f> is <math|\<infty\>>-times
    differentiable.
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|\<Rightarrow\>>>If <math|\<forall\>n\<in\>\<bbb-N\>>
      ...
      <item><dueto|<math|\<Leftarrow\>>>If <math|n=0> then as <math|f> is
      ...
      and thus <math|C<rsup|0>>. If <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>>
      we have that <math|f> is <math|n>-times differentiable then <math|f> is
      <math|<around*|(|n+1|)>>-times differentiable which as
      <math|\<forall\>x\<in\>U> we have <math|D<rsup|n+1>f<around*|(|x|)>=D<around*|(|D<rsup|n>f|)><around*|(|x|)>>
      ...
      <math|D<rsup|n>f> is continuous proving that <math|f> is of class
      <math|C<rsup|n>>. So we have that <math|f> is of class
      <math|C<rsup|\<infty\>>>.
    </enumerate>
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|V\<subseteq\>\<bbb-R\>> a open set, <math|n\<in\>\<bbb-N\><rsub|0>>
    and <math|f:U\<rightarrow\>V> a function that is <math|>n-times
    differentiable we have that <math|\<forall\>m\<in\><around*|{|1,\<ldots\>,n|}>>
    <math|f> is m-times differentiable
  </theorem>

  <\proof>
    We proceed by induction so let <math|S<rsub|n>=<around*|{|i\<in\>\<bbb-N\>\|if
    0\<leqslant\>i\<less\>n then f is <around*|(|n-i|)>-times
    differentiable|}>> then\ 

    <\enumerate>
      <item>If <math|i=0\<Rightarrow\>n-i=n> and as by the hypothesis
      <math|f> is n-times differentiable we have <math|0\<in\>S<rsub|n>>

      <item>If <math|i\<in\>S<rsub|n>> then if
      <math|0\<leqslant\>i+1\<less\>n> (so that
      <math|1\<less\><around*|(|n-i|)>>) then as
      <math|0\<leqslant\>i\<less\>n> and <math|n\<in\>S> we have that
      <math|f> is <math|<around*|(|n-i|)>>-times differentiable on <math|U>
      so that by definition we have that <math|f> is
      <math|<around*|(|<around*|(|n-i|)>-1|)>>-times differentiable so that
      as <math|<around*|(|<around*|(|n-i|)>-1|)>=<around*|(|n-<around*|(|i+1|)>|)>>
      we have that <math|i+1\<in\>S<rsub|n>>
    </enumerate>

    By mathematical induction we have then that <math|S<rsub|n>=\<bbb-N\>> so
    if <math|m\<in\><around*|{|1,\<ldots\>,n|}>> then
    <math|i=n-m\<in\><around*|{|0,\<ldots\>,n-1|}>> we have that
    <math|i\<in\>S<rsub|n>> and as <math|0\<leqslant\>i\<less\>n> we have
    that <math|f> is <math|<around*|(|n-i|)>>-times differentiable which
    proves our theorem as <math|m=n-i>
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
    a open set <math|n\<in\>\<bbb-N\>> and <math|f:U\<rightarrow\>V> a
    function of class <math|C<rsup|n>> then
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|n=0>>Then <math|<around*|{|0,\<ldots\>,n|}>=<around*|{|0|}>>
      which makes the theorem trivial

      <item><dueto|<math|n=1>>Then <math|f> is of class <math|C<rsup|1>> and
      thus <math|f> is differentiable everywhere on <math|U> so that by
      <reference|differentiability at x implies continuity at x> <math|f> is
      continuous on <math|U> and thus <math|C<rsup|0>>

      <item><dueto|<math|1\<less\>n>>Two cases must be considered:

      <\enumerate>
        <item><dueto|m=n>then by the hypothesis we have that <math|f> is of
        class <math|C<rsup|m>>

        <item><dueto|<math|m\<less\>n>>Then by the previous theorem <math|f>
        is <math|m>-times and <math|<around*|(|m+1|)>>-times differentiable
        on <math|U>, so that <math|D<rsup|m>f:U\<rightarrow\>L<rsup|m><around*|(|X;Y|)>>
        is differentiable at every <math|x\<in\>U> which by
        <reference|differentiability at x implies continuity at x> means that
        <math|D<rsup|m>f> is continuous on <math|U> and thus <math|f> is
        <math|C<rsup|m>>
      </enumerate>
    </enumerate>
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
    a open set, <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>> and
    <math|f:U\<rightarrow\>V> a function then <math|f> is <math|n>-times
    differentiable if and only if <math|D<rsup|1>f> is
    <math|<around*|(|n-1|)>>-times differentiable, also
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|\<Rightarrow\>>>This is proved by induction so let
      <math|S=<around*|{|n\<in\><around*|{|2,\<ldots\>|}>\|if a function
      h:U\<rightarrow\>V is n-times differentiable <around*|(|or C<rsup|n>|)>
      then D h is <around*|(|n-1|)> times differentiable and
      D<rsup|n-1><around*|(|D h|)>=D<rsup|n>h|}>> then we have:

      <\enumerate>
        <item>If <math|n=2> then as <math|f> is 2-times differentiable we
        have that <math|f> is 1-times differentiable and
        <math|D<rsup|1>f:U\<rightarrow\>L<around*|(|X,Y|)>> is differentiable
        at every <math|x\<in\>U> proving that <math|D<rsup|1>f> is 1-times
        differentiable, \ also <math|D<rsup|2>f:U\<rightarrow\>L<rsup|2><around*|(|X;Y|)>>
        is defined by <math|D<rsup|2>f<around*|(|x|)>=D<rsup|><around*|(|D<rsup|1>f|)><around*|(|x|)>=D<rsup|1><around*|(|D<rsup|1>f|)><around*|(|x|)>\<Rightarrow\>D<rsup|2>f=D<rsup|1><around*|(|D<rsup|1>f|)>>
        so <math|2\<in\>S>

        <item>If <math|n\<in\>S> and let <math|f> be
        <math|<around*|(|n+1|)>>-times differentiable then as
        <math|2\<leqslant\>n+1> <math|f> is by definition <math|n>-times
        differentiable on <math|U>, so as <math|n\<in\>S> we have
        <math|D<rsup|1>f> is <math|<around*|(|n-1|)>>-times differentiable
        and <math|D<rsup|n>f=D<rsup|n-1><around*|(|D<rsup|1>f|)>>. From the
        <math|<around*|(|n+1|)>>-differentiability of <math|f> we have
        <math|\<forall\>x\<in\>U> that <math|D<rsup|n>f> is differentiable at
        <math|x> and <math|D<rsup|n+1>f<around*|(|x|)>=D<around*|(|D<rsup|n>f|)><around*|(|x|)>=D<around*|(|D<rsup|n-1><around*|(|D<rsup|1>f|)><around*|(|x|)>|)>=D<rsup|n><around*|(|D<rsup|1>f|)><around*|(|x|)>\<Rightarrow\>D<rsup|n+1>f=D<rsup|n><around*|(|D<rsup|1>f|)>>
        proving that <math|n+1\<in\>S>
      </enumerate>

      By induction we have then <math|S=\<bbb-N\><rsub|0>\\<around*|{|1|}>>

      <item><dueto|<math|\<Leftarrow\>>>Again we use induction so let
      <math|S=<around*|{|n\<in\><around*|{|2,\<ldots\>|}>\| if a function
      h:U\<rightarrow\>V is such that D<rsup|1>h is n-1 times differentiable
      then h is n-times differentiable and
      D<rsup|n-1><around*|(|D<rsup|1>h|)>=D<rsup|n>h|}>> then:

      <\enumerate>
        <item>if n=2 then as <math|D<rsup|1>f> is <math|2-1=1>-times
        differentiable we have that <math|\<forall\>x\<in\>U> we have that
        <math|Df<around*|(|x|)>> exists and
        <math|D<rsup|1>f:U\<rightarrow\>L<around*|(|X,Y|)>> is differentiable
        at every <math|x\<in\>U> so that by definition <math|f> is 2 times
        differentiable and <math|D<rsup|2>f:U\<rightarrow\>L<around*|(|X<rsup|2>;Y|)>>
        is defined by <math|x\<rightarrow\>D<rsup|2>f<around*|(|x|)>=D<around*|(|D<rsup|1>f|)><around*|(|x|)>>
        proving that <math|D<rsup|2>f=D<rsup|1><around*|(|D<rsup|1>f|)>> and
        thus that <math|2\<in\>S>

        <item>if <math|n\<in\>S> then if <math|D<rsup|1>f> is
        <math|<around*|(|n+1|)>-1=n> times differentiable, by definition we
        have then that <math|D<rsup|1>f> is <math|<around*|(|n-1|)>>-times
        differentiable and that <math|D<rsup|n-1><around*|(|D<rsup|1>f|)>:U\<rightarrow\>L<rsup|n-1><around*|(|X;L<around*|(|X,Y|)>|)>\<equallim\><rsub|<text|<reference|L^n(X;L(X,Y))=L^n(X;Y)>>>L<rsup|n><around*|(|X;Y|)>>
        defined by <math|x\<rightarrow\>D<rsup|n-1><around*|(|D<rsup|1>f|)><around*|(|x|)>>
        is differentiable everywhere on <math|U> and
        <math|D<rsup|n><around*|(|D<rsup|1>f|)>:U\<rightarrow\>L<around*|(|X,L<rsup|n><around*|(|X;Y|)>|)>=L<rsup|n+1><around*|(|X;Y|)>>
        is defined by <math|x\<rightarrow\>D<rsup|n><around*|(|D<rsup|1>f|)><around*|(|x|)>=D<rsup|><around*|(|D<rsup|n-1><around*|(|D<rsup|1>f|)>|)><around*|(|x|)>>
        proving that

        <\equation>
          <label|eq 12.13>D<rsup|n-1><around*|(|D<rsup|1>f|)> is
          differentiable
        </equation>

        <\equation>
          <label|eq 12.15.0>D<rsup|n><around*|(|D<rsup|1>f|)>=D<rsup|1><around*|(|D<rsup|n-1><around*|(|D<rsup|1>f|)>|)>
        </equation>

        As <math|n\<in\>S> we have that <math|f> is <math|n>-times
        differentiable with <math|D<rsup|n>f=D<rsup|n-1><around*|(|D<rsup|1>f|)>>
        which by <reference|eq 12.13> \ means that <math|D<rsup|n>f> is
        differentiable, proving that <math|f> is
        <math|<around*|(|n+1|)>>-times differentiable and
        <math|D<rsup|n+1>f:U\<rightarrow\>L<rsup|n+1><around*|(|X;Y|)>> is
        defined by <math|x\<rightarrow\>D<rsup|n+1>f<around*|(|x|)>=D<around*|(|D<rsup|n>f|)><around*|(|x|)>=D<around*|(|D<rsup|n-1><around*|(|D<rsup|1>f|)>|)><around*|(|x|)>\<equallim\>D<rsup|1><around*|(|D<rsup|n-1><around*|(|D<rsup|1>f|)>|)><around*|(|x|)>\<equallim\><rsub|<text|<reference|eq
        12.15.0>>>D<rsup|n><around*|(|D<rsup|1>f|)><around*|(|x|)>> so that
        <math|D<rsup|n+1>f=D<rsup|n><around*|(|D<rsup|1>f|)>>. This proves
        that <math|n+1\<in\>S>.
      </enumerate>

      By induction we have then that <math|S=\<bbb-N\><rsub|0>\\<around*|{|1|}>>
    </enumerate>
  </proof>

  Next we extend the above to show that it also works for classes
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
    a open set, <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>Y>
    a function then <math|f> is of class <math|C<rsup|n>> if and only if
    <math|D<rsup|1>f> exists and is of class <math|C<rsup|n-1>>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><math|<dueto|n=1> >If <math|f> is of class <math|C<rsup|1>> then
      by definition <math|D f> is continuous and thus of class
      ...
      <item><dueto|<math|n\<gtr\>1>>\ 

      <\enumerate>
        <item><math|<dueto|\<Rightarrow\>>>If <math|f> is of class
        <math|C<rsup|n>> then <math|f> is <math|n>-times differentiable and
        <math|D<rsup|n>f> is continuous, using the previous theorem we have
        then that <math|D<rsup|1>f> is <math|<around*|(|n-1|)>> times
        differentiable and <math|D<rsup|n-1><around*|(|D<rsup|1>f|)>=D<rsup|n>f>
        which is continuous so that <math|D<rsup|1>> is of class
        <math|C<rsup|n-1>>

        <item><dueto|<math|\<Leftarrow\>>>If <math|D<rsup|1>f> is of class
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|W\<subseteq\>Y>
    a open set, <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>W>
    a function then
    ...
    <\enumerate>
      ...
      <math|x\<subseteq\>V\<subseteq\>U> for which
      <math|f<rsub|\|V>:V\<rightarrow\>W> is n-times differentiable on
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|S=<around*|{|i\<in\>\<bbb-N\><rsub|0>\|if i\<leqslant\>n\|if
      V\<subseteq\>U,V open then f<rsub|\|V>:V\<rightarrow\>W is n-times
      differentiable on V and D<rsup|i><around*|(|f<rsub|\|V>|)>=<around*|(|D<rsup|i>f|)><rsub|\|V>|}>>
      then we have

      <\enumerate>
        <item>If <math|i=1> then as <math|f:U\<rightarrow\>W> is 1-times
        differentiable we have by definition that <math|\<forall\>x\<in\>U>
        we have that <math|f:U\<rightarrow\>W> is differentiable and
        <math|D<rsup|1>f> is defined by <math|D<rsup|1>f<around*|(|x|)>=D
        f<around*|(|x|)>>. Using <reference|differentiability and restricted
        mapping> we have then that <math|\<forall\>x\<in\>V> that
        <math|f<rsub|\|V>:U\<rightarrow\>W> is differentiable at <math|x>
        with <math|D<around*|(|f<rsub|\|V>|)><around*|(|x|)>=D
        f<around*|(|x|)>> or in other words
        <math|f<rsub|\|V>:U\<rightarrow\>W> is 1-times differentiable and
        <math|D<rsup|1><around*|(|f<rsub|\|V>|)>:V\<rightarrow\>L<around*|(|X,Y|)>>
        is defined by <math|D<rsup|1><around*|(|f<rsub|\|V>|)><around*|(|x|)>=D<around*|(|f<rsub|\|V>|)><around*|(|x|)>=D
        f<around*|(|x|)>> or <math|D<rsup|1><around*|(|f<rsub|\|V>|)>=<around*|(|D<rsup|1>f|)><rsub|\|V>>.
        So <math|1\<in\>S>

        <item>If <math|i\<in\>S> then if <math|i+1\<leqslant\>n> we have that
        <math|D<rsup|i>f:U\<rightarrow\>L<around*|(|X<rsup|i>;Y|)>> is
        differentiable <math|\<forall\>x\<in\>U>. So using
        <reference|differentiability and restricted mapping> we have that
        <math|\<forall\>x\<in\>V> that <math|<around*|(|D<rsup|i>f|)><rsub|\|V>>
        is differentiable at <math|x> which, as from <math|i\<in\>S> we have
        that <math|f<rsub|\|V>> is i-times differentiable, means that
        <math|f<rsub|\|V>> is <math|i+1>-times differentiable on <math|V>.
        Also <math|\<forall\>x\<in\>V> we have that
        <math|<around*|(|D<rsup|i+1><around*|(|f<rsub|\|V>|)>|)><around*|(|x|)>=D<around*|(|D<rsup|i><around*|(|f<rsub|\|V>|)>|)><around*|(|x|)>\<equallim\><rsub|i\<in\>S>D<around*|(|<around*|(|D<rsup|i>f|)><rsub|\|V>|)><around*|(|x|)>\<equallim\><rsub|<text|<reference|differentiability
        and restricted mapping>>><around*|(|D<around*|(|D<rsup|i>f|)>|)><rsub|\|V><around*|(|x|)>=<around*|(|D<rsup|i+1>f|)><rsub|\|V><around*|(|x|)>>
        proving that <math|D<rsup|i+1><around*|(|f<rsub|\|V>|)>=<around*|(|D<rsup|i+1>f|)><rsub|\|V>>.
        So we <math|i+1\<in\>S>
      </enumerate>
      ...
      <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|if \<forall\>x\<in\>u
      \<vDash\>\<exists\>V open with x\<in\>V\<subseteq\>U such that
      f<rsub|\|V> is n-times differentiable then f is n-times differentiable
      and <around*|(|D<rsup|n>f|)><rsub|\|V>=D<rsup|n><around*|(|f<rsub|\|V>|)>|}>>,
      we have then\ 

      <\enumerate>
        <item>If <math|n=1> By assumption <math|\<forall\>x\<in\>U> there
        exists a <math|V> open with <math|x\<in\>V\<subseteq\>U> such that
        <math|f<rsub|\|V>> is differentiable at <math|x>, using
        <reference|differentiability and restricted mapping> we have then
        that also <math|f> is differentiable at <math|x> and
        <math|Df<around*|(|x|)>=Df<rsub|\|V><around*|(|x|)>>
        <math|\<forall\>x\<in\>V\<Rightarrow\><around*|(|D<rsup|1>f|)><rsub|\|V>=D<rsup|1><around*|(|f<rsub|\|V>|)>>
        proving that <math|1\<in\>V>

        <item>If <math|n\<in\>S> assume now that <math|\<forall\>x\<in\>U>
        there exists a <math|V> open with <math|x\<in\>V\<subseteq\>U> and
        <math|f<rsub|\|V>> be <math|<around*|(|n+1|)>>-times differentiable.
        By definition we have then that <math|f<rsub|<mid|\|>V>> is
        <math|n>-times differentiable and thus as <math|n\<in\>S> we have
        that <math|f> is n-times differentiable with
        <math|<around*|(|D<rsup|n>f|)><rsub|\|V>=D<rsup|n><around*|(|f<rsub|<mid|\|>V>|)>>.
        Also by definition and the fact that <math|f<rsub|\|V>> is
        <math|<around*|(|n+1|)>>-times differentiable we have that
        <math|D<rsup|n><around*|(|f<rsub|\|V>|)>=<around*|(|D<rsup|n>f|)><rsub|\|V>>
        is differentiable at every <math|y\<in\>V> (and also using
        <reference|differentiability and restricted mapping>
        <math|D<rsup|n>f> is differentiable at every <math|y\<in\>Y>) with
        <math|D<rsup|n+1><around*|(|f<rsub|\|V>|)><around*|(|y|)>=D<rsup|><around*|(|D<rsup|n><around*|(|f<rsub|\|V>|)>|)><around*|(|y|)>=D<around*|(|<around*|(|D<rsup|n>f|)><rsub|\|V>|)><around*|(|y|)>\<equallim\><rsub|<text|<reference|differentiability
        and restricted mapping>>><around*|(|D<rsup|><around*|(|D<rsup|n>f|)>|)><rsub|\|V><around*|(|y|)>=<around*|(|D<rsup|n+1>f|)><rsub|\|V><around*|(|y|)>>
        proving that <math|<around*|(|D<rsup|n+1>f|)><rsub|\|V>=D<rsup|n+1><around*|(|f<rsub|\|V>|)>>
        and as <math|x\<in\>U> also that <math|f> is
        <math|<around*|(|n+1|)>>-times differentiable at <math|x\<in\>U>. So
        we conclude that <math|n+1\<in\>S>\ 
      </enumerate>

      induction proves then that <math|S=\<bbb-N\><rsub|0>> finishing the
      proof.
    </enumerate>
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|n\<in\>\<bbb-N\>> , <math|W\<subset\>Y> a open set and
    <math|f:U\<rightarrow\>W> a function then:

    <\enumerate>
      <item>If <math|f:U\<rightarrow\>W> is n-times differentiable on
      <math|U> then if <math|V> is open with <math|V\<subseteq\>U> then
      <math|f<rsub|\|V>> is of class <math|C<rsup|r>>.

      <item>If <math|\<forall\>x\<in\>U> there exists a <math|V> open with
      <math|x\<in\>V\<subseteq\>U> for which
      <math|f<rsub|\|V>:V\<rightarrow\>W> is of class <math|C<rsup|n>> then
  ...
  <\proof>
    ...
    <\itemize>
      ...
      <\enumerate>
        <item>This follows from at once from <reference|continuity of
        restricted maps>.

        <item>This follows from at once from <reference|continuity is local>.
      </enumerate>

      <item><dueto|<math|n\<gtr\>0>>\ 
      ...
      <\enumerate>
        ...
        which is continous on <math|V> by <reference|continuity of restricted
        maps>.
        ...
        differentiable we have by the previous theorem proved that <math|f>
        is <math|n>-times differentiable on <math|U> with
        <math|<around*|(|D<rsup|n>f|)><rsub|\|V>=D<rsup|n><around*|(|f<rsub|\|V>|)>>.
  ...
  <\theorem>
    ...
    <math|W<rsub|f>,W<rsub|g>\<subseteq\>Y> open sets,
    <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>W<rsub|f>>,
    <math|g:U\<rightarrow\>W<rsub|f>> n-times differentiable functions then
    <math|f+g:U\<rightarrow\>W<rsub|f>+W<rsub|g>> is n-times differentiable
    and <math|D<rsup|n><around*|(|f+g|)>=D<rsup|n>f+D<rsup|n>g>. Also if
    <math|\<alpha\>\<in\>\<bbb-K\>> then <math|\<alpha\>\<cdot\>f:U\<rightarrow\>\<alpha\>\<cdot\>W<rsub|f>>
    is n-times differentiable and <math|D<rsup|n><around*|(|\<alpha\>\<cdot\>f|)>=\<alpha\>\<cdot\>D<rsup|n>f>.
    Note that by <reference|normed space properties> we have that
    <math|\<alpha\>\<cdot\>W<rsub|f>> and <math|W<rsub|f>+W<rsub|g>> are open
    sets.
  </theorem>

  <\proof>
    This is proved by induction so let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|if
    f,g:U\<rightarrow\>Y are n-times differentiable then
    f+g,\<alpha\>\<cdot\>f is n-times differentiable with
    D<rsup|n><around*|(|f+g|)>=D<rsup|n>f+D<rsup|n>g,D<rsup|n><around*|(|\<alpha\>\<cdot\>f|)>=\<alpha\>\<cdot\>D<rsup|n>f|}>>
    then

    <\enumerate>
      <item>If <math|n=1> then by <reference|sum of differentiable functions>
      we have that <math|1\<in\>S>

      <item>Assume that <math|n\<in\>S> and that <math|f,g> are
      <math|<around*|(|n+1|)>> times differentiable functions. Then
      <math|f,g> are n-times differentiable and thus
      <math|f+g,\<alpha\>\<cdot\>f> are n-times differentiable with
      <math|D<rsup|n><around*|(|f+g|)>=D<rsup|n>f+D<rsup|n>g>,
      <math|D<rsup|n><around*|(|\<alpha\>\<cdot\>f|)>=\<alpha\>\<cdot\>D<rsup|n>f>.
      As by definition we have that <math|D<rsup|n>f>, <math|D<rsup|n>g> are
      differentiable on <math|U> we can use <reference|sum of differentiable
      functions> again to proof that <math|D<rsup|n>f+D<rsup|n>g=D<rsup|n><around*|(|f+g|)>>
      and <math|\<alpha\>\<cdot\>D<rsup|n>f=D<rsup|n><around*|(|\<alpha\>\<cdot\>f|)>>
      are differentiable on <math|U> with
      <math|D<rsup|n+1><around*|(|f+g|)><around*|(|x|)>=D<around*|(|D<rsup|n><around*|(|f+g|)>|)><around*|(|x|)>=D<around*|(|D<rsup|n>f+D<rsup|n>g|)><around*|(|x|)>=D<around*|(|D<rsup|n>f|)><around*|(|x|)>+D<around*|(|D<rsup|n>f|)><around*|(|x|)>=D<rsup|n+1>f<around*|(|x|)>+D<rsup|n+1>g<around*|(|x|)>>
      and <math|D<rsup|n+1><around*|(|\<alpha\>\<cdot\>f|)>=D<around*|(|D<rsup|n><around*|(|\<alpha\>\<cdot\>f|)>|)><around*|(|x|)>=D<around*|(|\<alpha\>\<cdot\>D<rsup|n>f|)><around*|(|x|)>=\<alpha\>\<cdot\>D<around*|(|D<rsup|n>f|)><around*|(|x|)>=\<alpha\>\<cdot\>D<rsup|n+1>f<around*|(|x|)>>
      proving that <math|<around*|(|n+1|)>\<in\>S>
    </enumerate>
  </proof>
  ...
  <\theorem>
    ...
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|W<rsub|f>,W<rsub|g>\<subseteq\>Y> open sets.
    <math|n\<in\>\<bbb-N\>> and <math|f:U\<rightarrow\>W<rsub|f>,g:U\<rightarrow\>W<rsub|g>>
    are of class <math|C<rsup|n>> then <math|f+g:U\<rightarrow\>W<rsub|f>+W<rsub|g>>
    and <math|\<alpha\>\<cdot\>f:U\<rightarrow\>\<alpha\>\<cdot\>U<rsub|f>>
    are of class <math|C<rsup|n>>.
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|n=0>>First using <reference|continuity to a
      subspace> and the fact that for <math|f:U\<rightarrow\>Y> and
      <math|g:U\<rightarrow\>Y> we have <math|f<around*|(|U|)>\<subseteq\>W<rsub|f>>,
      <math|g<around*|(|U|)>\<subseteq\>W<rsub|g>> we have
      <math|f:U\<rightarrow\>Y,g:U\<rightarrow\>Y> are continuous. As the the
      sum of continuous functions is continuous and the product of a
      continuous function with a scalar is continuous (see <reference|in a
      normed space the sum,product with scalar is ontinuous>) we have that
      <math|f+g:U\<rightarrow\>Y> and <math|\<alpha\>\<cdot\>f:U\<rightarrow\>Y>
      is continuous. Using <reference|continuity to a subspace> again and the
      fact that <math|<around*|(|f+g|)><around*|(|U|)>\<subseteq\>W<rsub|f>+W<rsub|g>,\<alpha\>\<cdot\>f\<subseteq\>\<alpha\>\<cdot\>U<rsub|f>>
      we have that <math|f+g:U\<rightarrow\>W<rsub|f>+W<rsub|g>> and
      <math|\<alpha\>\<cdot\>f:U\<rightarrow\>\<alpha\>\<cdot\>W<rsub|f>> are
      continuous.

      <item><dueto|<math|n\<gtr\>0>>Using the previous theorem we have
      already that <math|f+g> and <math|\<alpha\>\<cdot\>f> are n-times
      differentiable. As <math|D<rsup|n>f>, <math|D<rsup|n>g> are also
      continuous we can use (1) to prove that
      <math|D<rsup|n><around*|(|f+g|)>=D<rsup|n>f+D<rsup|n>g> and
      <math|D<rsup|n><around*|(|\<alpha\>\<cdot\>f|)>=\<alpha\>\<cdot\>D<rsup|n>f>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces <math|U\<subseteq\>X> a open set,
    <math|k\<in\>\<bbb-N\><rsub|0>>, <math|n\<in\>\<bbb-N\>>
    <math|<around*|{|f<rsub|i>:U\<rightarrow\>W<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,k|}>>>
    a finite set of functions from which are <math|n>-times differentiable
    (<math|n\<gtr\>0>) [or <math|C<rsup|n>>] then
    <math|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,k|}>>f<rsub|i>:U\<rightarrow\><big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,k|}>>W<rsub|i>>
    is n-times differentiable [or <math|C<rsup|n>>]. Here given sets
    <math|<around*|{|W<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,k|}>>>
    we recursively define <math|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,k|}>>W<rsub|i>=<choice|<tformat|<table|<row|<cell|W<rsub|1>
    if k=1>>|<row|<cell|<around*|(|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,k-1|}>>W<rsub|i>|)>+W<rsub|k>
    if k\<gtr\>1>>>>>>.
  </theorem>

  <\proof>
    Let <math|S=<around*|{|k\<in\>\<bbb-N\><rsub|0>\|if
    <around*|{|f<rsub|i>:U\<rightarrow\>W<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>
    is a finite set of functions from U to Y which are n-times differentiable
    <around*|(|n\<gtr\>0|)> <around*|[|or C<rsup|n>|]> then
    <big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,k|}>>f<rsub|i>:<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,k|}>>W<rsub|i>
    is n-times differentiable <around*|[|or C<rsup|n>|]>|}>> then we have:

    <\enumerate>
      <item>If <math|k=1> then <math|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,1|}>>f<rsub|i>=f<rsub|1>:U\<rightarrow\>W<rsub|1>=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,1|}>>W<rsub|1>>
      which is 1-times differentiable [or <math|C<rsup|1>>] so that
      <math|1\<in\>S>

      <item>If <math|k\<in\>S> then if <math|<around*|{|f<rsub|i>:U\<rightarrow\>W<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,k+1|}>>>
      are n-times differentiable functions [or <math|C<rsup|n>>] then we have
      <math|<big|sum><rsub|i=1><rsup|k+1>f<rsub|i>=<around*|(|<big|sum><rsub|i=1><rsup|k>f<rsub|i>|)>+f<rsub|n>:U\<rightarrow\><around*|(|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,k|}>>W<rsub|i>|)>+W<rsub|k+1>>
      which is n-times differentiale (by <reference|sum of n-times
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces <math|U\<subseteq\>X> open, <math|y\<in\>Y> then
    <math|C<rsub|U,y>:U\<rightarrow\>Y> defined by
    <math|x\<rightarrow\>C<rsub|U,y><around*|(|x|)>=y> then
    <math|C<rsub|U,y>> is <math|C<rsup|\<infty\>>> and
    <math|D<rsup|n>C<rsub|U,y>=C<rsub|U,0<rsub|L<rsup|n-1><around*|(|X,Y|)>>>
    where<around*|[| 0<rsub|L<rsup|n><around*|(|X,Y|)>>=<choice|<tformat|<table|<row|<cell|neutral
    element in Y if n=0>>|<row|<cell|neutral element in
    L<rsup|n><around*|(|X;Y|)> if n\<gtr\>0>>>>>|]>>.
  </theorem>

  <\proof>
    Let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|D<rsup|n>C<rsub|U,y>
    exists and D<rsup|n>C<rsub|U,y>=C<rsub|X,0<rsub|L<rsup|n-1><around*|(|X;Y|)>>>|}>>
    then we have

    <\enumerate>
      <item>If <math|n=1> then <math|\<forall\>x\<in\>U> we have
      <math|D<rsup|1>C<rsub|U,y><around*|(|x|)>=D<around*|(|C<rsub|U,y>|)>\<equallim\><rsub|<text|<reference|differential
      of the constant function>>>C<rsub|X,0>=C<rsub|X,0<rsub|L<rsup|1-1><around*|(|X;Y|)>>>>
      so that <math|1\<in\>S>

      <item>If <math|n\<in\>S> then <math|\<forall\>x\<in\>U> we have
      <math|D<rsup|n>C<rsub|U,y>=C<rsub|X,0<rsub|L<rsup|n-1><around*|(|X;Y|)>>>>
      so by <reference|differential of the constant function> we have that
      <math|D<rsup|n>C<rsub|U,y>> is differentiable at every <math|x\<in\>U>
      with <math|D<rsup|n+1>C<rsub|U,y><around*|(|x|)>=D<around*|(|D<rsup|n>C<rsub|U,y>|)><around*|(|x|)>=D<around*|(|C<rsub|X,0<rsub|L<rsup|n-1><around*|(|X;Y|)>>>|)><around*|(|x|)>=0<rsub|L<rsup|<around*|(|n+1|)>-1><around*|(|X;U|)>>\<nocomma\>>
      so that <math|D<rsup|n+1>C<rsub|U,y>=C<rsub|U,0<rsub|L<rsup|<around*|(|n+1|)>-1><around*|(|X;Y|)>>>>
      proving that <math|n+1\<in\>S>.
    </enumerate>

    By induction we have <math|S=\<bbb-N\><rsub|0>> proving our theorem.
  </proof>
  ...
  <\theorem>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>,n\<gtr\>1> then
    <math|D<rsup|n>L=C<rsub|X,0<rsub|L<rsup|<rsup|n-1>><around*|(|X;Y|)>>>\<in\>L<rsup|n><around*|(|X;Y|)>>
  </theorem>

  <\proof>
    Using <reference|C^@@=@@-times differentiable> we only have to prove
    <math|\<infty\>>-times differentiability so let
    <math|n\<in\>\<bbb-N\><rsub|0>> then we have the following cases to
    consider:

    <\enumerate>
      <item><dueto|<math|n=1>>Then <math|\<forall\>x\<in\>X> we have by
      <reference|differential of a linear function> that
      <math|DL<around*|(|x|)>=L> exists so that <math|D<rsup|1>L=C<rsub|X,L>>
  ...
  <\theorem>
    ...
    continuous bilinear mapping from <math|X<rsub|1>\<times\>X<rsub|2>\<rightarrow\>Y>
  ...
  <\proof>
    We prove this by induction so let <math|S=<around*|{|r\<in\>\<bbb-N\><rsub|0>\|
    ...
    <\enumerate>
      ...
      Using mathematical induction we have that <math|S=\<bbb-N\><rsub|0>>
      proving the theorem.
    </enumerate>
  </proof>
  ...
  <\theorem>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>>, <math|f:U\<rightarrow\>Y> a n-times
  ...
  <\proof>
    ...
    <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\| if f:U\<rightarrow\>Y is
    n-times differentiable <around*|[|or C<rsup|n>|]>\<nocomma\>\<nocomma\>,
  ...
  <\definition>
    Let <math|n\<in\>\<bbb-N\><rsub|0>> <math|<around*|{|X<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n+1|}>>>
  ...
  <\proof>
    Let <math|S=<around*|{|k\<in\>\<bbb-N\><rsub|0>\|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n+1|}>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      proving that <math|ev> is multilinear with
  ...
  <\lemma>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>,n\<gtr\>1> \ and <math|f:U\<rightarrow\>Y>
    a n-times differentiable function [or <math|f> is <math|C<rsup|n>>] then
  ...
  <\lemma>
    ...
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>be
    normed space, <math|n\<in\>\<bbb-N\><rsub|0>>, <math|f:U\<rightarrow\>Y>
    a n-times differentiable function [or <math|C<rsup|n>> function] then
  ...
  <\theorem>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>> [or <math|n\<in\>\<bbb-N\>>] and
  ...
  <\theorem>
    ...
    <math|U\<subseteq\>X> and <math|n\<in\>\<bbb-N\><rsub|0>> [or
    <math|n\<in\>\<bbb-N\>>] and <math|f,g:U\<rightarrow\>\<bbb-K\>> are
    functions <math|n>-times differentiable [or of class <math|C<rsup|n>>]
    then <math|f\<cdot\>g:U\<rightarrow\>\<bbb-K\>> is n-times differentiable
    [or of class <math|C<rsup|r>>]
  </theorem>
  ...
  <\theorem>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>>, <math|<around*|\<langle\>|\<bbb-R\><rsup|n>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    be the set of real tupple's together with the maximum norm defined on
    ...
    A easier way to note this is by the classic notation of the integral as
    <math|D<rsup|r>F<around*|(|x|)>=<big|int><rsub|a><rsup|b>D<rsup|r>f<around*|(|\<ast\>,t|)><around*|(|x|)>\<cdot\>dt>.
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|S=<around*|{|r\<in\>\<bbb-N\><rsub|0>\|if f is function
      satisfying <around*|(|1|)>,<around*|(|2|)>,<around*|(|3|)> of the
      theorem then\<forall\>x\<in\>U F<around*|(|x|)> is defined\<nocomma\>,
      of class C<rsup|r> and D<rsup|r>F<around*|(|x|)>=<big|int><rsub|a><rsup|b>D<rsup|r>f<around*|(|\<ast\>,\<ast\>|)><around*|(|x|)>|}>>
      ...
      by induction we have then that <math|S=\<bbb-N\><rsub|0>> which proves
      our little theorem.
    </enumerate>
  </proof>
  ...
  <\proof>
    ...
    so take <math|S=<around*|{|r\<in\>\<bbb-N\><rsub|0>\|if r\<leqslant\>n
    and x\<in\>U then D<rsup|r><around*|(|L\<circ\>f|)><around*|(|x|)>=L\<bullet\><rsub|r>D<rsup|n>f<around*|(|x|)>|}>>
    then we have:
  ...
  <\theorem>
    ...
    <math|r\<in\>\<bbb-N\>> and <math|f:S\<rightarrow\>Y>,
  ...
  <\definition>
    ...
    right,left derivative by\ 

    <\enumerate>
      <item>If <math|x\<in\><around*|[|a,b|[> then
      f<rprime|'><rsub|+><around*|(|x|)>> is the right derivative of <math|f>
      ...
      <item>If <math|x\<in\><around*|]|a,b|]>> then
      <math|f<rprime|'><rsub|-><around|(|x|)>> is the left derivative of
  ...
  <\proof>
    ...
    <\enumerate>
      <item>Assume that there exists two different right derivatives
      ...
      <item>Assume that there exists two different left derivatives
      <math|d,d<rprime|'>> at <math|x> define then
      <math|\<varepsilon\>=<around*|\<\|\|\>|d<rprime|'>-d|\<\|\|\>><rsub|Y>\<gtr\>0>,
      then there exists <math|\<delta\>,\<delta\><rprime|'>\<gtr\>0> such
      that if <math|0\<less\>h\<less\>\<delta\>> and
  ...
  <\definition>
    ...
    <math|x\<in\><around*|[|a,b|]>> then <math|f> has a derivative
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        of the derivative <math|<around*|(|f<rsub|\|<around*|]|a,b|[>>|)><rprime|'><around*|(|t|)>>

        <item>There exists a right,left derivative
        <math|f<rprime|'><rsub|+><around*|(|a|)>,f<rprime|'><rsub|-><around*|(|b|)>>
        at <math|a,b>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <reference|C1 of real or complex function> we have that the derivative
      ...
      <\enumerate>
        ...
        <\enumerate>
          ...
          proving that <math|f<rprime|'><rsub|+><around*|(|a|)>> exists and
          <math|f<rprime|'><rsub|+><around*|(|a|)>=<around*|(|f<rsup|U>|)><rprime|'><around*|(|a|)>>
          (as uniqueness is garanteed by the previous lemma)
      ...
      derivative at every <math|x\<in\><around*|]|a-\<xi\>,b+\<xi\>|[>>. The
      ...
      <\enumerate>
        ...
        existsts and <math|<around*|(|f<rsup|<around*|]|a-\<xi\>,b+\<xi\>|[>>|)><rprime|'><around*|(|a|)>=f<rsub|+><rprime|'><around*|(|a|)>>
  ...
  <\proof>
    ...
    applying Rolle's theorem we have then the existance of a
    <math|\<zeta\>\<in\><around*|[|a,b|]>> such that
  ...
  <\theorem>
    ...
    <math|\<varphi\>> have derivatives <math|f<rprime|'><around*|(|x|)>> and
  ...
  <\proof>
    ...
    <math|\<sigma\>:\<bbb-N\>\<rightarrow\>E> \ Take now
    <math|\<varepsilon\>\<gtr\>0> and define\ 

    <\equation>
      \<forall\>\<beta\>\<in\><around*|[|a,b|]> we define
      \<cal-E\><around*|(|\<beta\>|)>=<choice|<tformat|<table|<row|<cell|0 if
      <around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<beta\>|}>=\<emptyset\>>>|<row|<cell|<big|sum><rsub|n\<in\><around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<beta\>|}>><frac|1|2<rsup|n>>>>>>>
    </equation>
    ...
    proving as we have choosen <math|\<xi\>\<in\><around*|[|a,\<sigma\>|[>>
    ...
    \ <math|n\<in\><around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<alpha\>|}>>
    we have that <math|\<rho\><around*|(|n|)>\<less\>\<alpha\>\<less\>\<beta\>\<Rightarrow\>n\<in\><around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<beta\>|}>>
    ...
    Now given <math|\<xi\>\<gtr\>0>, choosen arbitrary, then by the
    continuity of <math|\<varphi\>> there exists a
    <math|\<delta\><rsub|\<varphi\>>\<gtr\>0> such that if
    <math|\<beta\>\<in\><around*|[|a,\<sigma\>|[><big|cap><around*|]|\<sigma\>-\<delta\><rsub|\<varphi\>>,\<delta\>|[>>
    ...
    As <math|\<xi\>\<gtr\>0> was choosen arbitrary we have using
    ...
    <\description>
      ...
      wich is a contradiction as <math|sup<around*|(|A|)>=\<sigma\>\<less\>min<around*|(|\<lambda\><rsub|\<varphi\>>,\<lambda\><rsub|f>|)>>.
      ...
      then by the continuity of <math|f,\<varphi\>> at <math|\<sigma\>>
      together with <math|\<sigma\>\<less\>b> means that there exists
    ...
    choosen that by <reference|eq 13.56.317>
  ...
  <\corollary>
    ...
    a Banach space, <math|f:<around*|[|a,b|]>\<rightarrow\>Y> a coninuous
    function such that there exists a denumberable set
  ...
  <\proof>
    ...
    has <math|\<forall\>x\<in\><around*|[|a,b|]>> the derivative
  ...
  <\proof>
    As <math|\<forall\>n\<in\>\<bbb-N\><rsub|>> we have that
    ...
    we have that <math|E=<around*|{|a+<around*|(|b-a|)>\<cdot\><frac|1|n+1>\|n\<in\>\<bbb-N\>|}>\<subseteq\><around*|[|a,b|]>>
  ...
  <\proof>
    ...
    then we can as <math|\<varepsilon\>> in <reference|eq 12.51> was choosen
  ...
  To prove that the <math|n>-th differential is symmetric we must first prove
  the following lemma and corollary.

  <\lemma>
    Let <math|n\<in\>\<bbb-N\><rsub|0>>, <math|X> a set, <math|Y> a set and
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        definied by <math|j\<rightarrow\>\<rho\><around*|(|j|)>=<choice|<tformat|<table|<row|<cell|\<sigma\><around*|(|\<tau\><around*|(|j|)>|)>
  ...
  <\lemma>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>\<vdash\>n\<gtr\>2>,
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> open,
  ...
  <\lemma>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>\<vdash\>n\<gtr\>1>,
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> open,
  ...
  <\theorem>
    <label|the n-th differential is symmetric>Let
    <math|n\<in\>\<bbb-N\><rsub|0>>, <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>
    be a normed space, <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
  ...
  <\theorem>
    ...
    (complex space) equiped with the canonical norm,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    a Banach space, <math|U\<subseteq\>\<bbb-K\>> open,
    <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>Y> a function
    then <math|f> is <math|C<rsup|n>> if and only if the <math|n>-th derivate
  ...
  <\proof>
    We prove this by induction so let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|f
    ...
    By mathematical induction we have then <math|S=\<bbb-N\><rsub|0>> proving
    our theorem.
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>,
    <math|n\<in\>\<bbb-N\><rsub|0>> of normed vector spaces then given
    <math|i\<in\><around*|{|1,\<ldots\>,n|}>> and
  ...
  <\definition>
    <label|partial differential on U>Let <math|n\<in\>\<bbb-N\><rsub|0>>,
    <math|m\<in\>\<bbb-N\><rsub|0>> <math|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
  ...
  <\theorem>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>>, <math|m\<in\>\<bbb-N\><rsub|0>>
    <math|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    a finite family of normed spaces, <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    a normed space, <math|<around*|\<langle\>|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    be the normed space <math|X=<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>
  ...
  <\theorem>
    Let <math|n\<in\>\<bbb-N\><rsub|0>>, <math|m\<in\>\<bbb-N\><rsub|0>>
    <math|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
  ...
  <\proof>
    ...
    <math|D<rsup|1>f<rsub|i>> is continous on <math|U> we have\ 
    ...
    giving togehter with <reference|eq 12.70-0> that\ 
  ...
  <\theorem>
    Let <math|n\<in\>\<bbb-N\><rsub|0>> <math|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    a finite family of normed spaces, <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    a normed space, <math|<around*|\<langle\>|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    be the normed space <math|X=<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>
    with the maximum norm <math|<around*|\<\|\|\>||\<\|\|\>>> (see
  ...
  <\proof>
    We prove this by induction so let <math|S=<around*|{|s\<in\>\<bbb-N\><rsub|0>\|if
  ...
  Let's now define paritial derivates of higher order.
  ...
  <\definition>
    ...
    <\enumerate>
      ...
      <math|\<forall\>x\<in\>U> we have that <math|f> has a partial
      derivative at x (see <reference|partial derivative definition>). We
      define then <math|\<partial\><rsup|1><rsub|i>f:U\<rightarrow\>Y> by
      ...
      we say that <math|f> has a partial derivative
      <math|\<partial\><rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f> on
      <math|U> if <math|\<partial\><rsup|m-1><rsub|i<rsub|2>,\<ldots\>,i<rsub|m>>f>
      exists on <math|U> and that <math|\<forall\>x\<in\>U> the partial
      derivative \ <math|\<partial\><rsub|i<rsub|1>><around*|(|\<partial\><rsub|i<rsub|2>,\<ldots\>,i<rsub|n>><rsup|m-1>f|)><around*|(|x|)>>
  ...
  <\proof>
    We proof this by induction so let <math|S=<around*|{|s\<in\>\<bbb-N\><rsub|0>\|if
    ...
    <\enumerate>
      ...
      have that <math|\<forall\>x\<in\>U> the partial derivative exists
      proving that <math|\<partial\><rsub|i>f> exists on <math|U> and
      ...
      12.80-1>,<reference|eq 12.81-1> gives then finaly that
      <math|s+1\<in\>S>.
    </enumerate>
  ...
  <\theorem>
    ...
    <math|L:X\<rightarrow\>Y> is a toplinear isormorphism (see
  ...
  <\definition>
    ...
    and <math|n\<in\>\<bbb-N\><rsub|0>> then we define
  ...
  <\proof>
    ...
    H\<in\>L<around*|(|X,X|)> then <around*|(|-H|)><rsup|n>=<around*|(|-1|)><rsup|n>\<cdot\>H|}>>
    then:
  ...
  <\lemma>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>> then <math|H<rsup|n>:X\<rightarrow\>X> is
    linear and continuous with <math|\<forall\>x\<in\>X\<vDash\><around*|\<\|\|\>|H<rsup|n><around*|(|x|)>|\<\|\|\>><rsub|X>\<leqslant\><around*|\<\|\|\>|H|\<\|\|\>><rsup|n><around*|\<\|\|\>|x|\<\|\|\>><rsub|X>>
    (or <math|<around*|\<\|\|\>|H<rsup|n>|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|H|\<\|\|\>><rsup|n>>).
    In addition we have that <math|<big|sum><rsub|i=1><rsup|n>H<rsup|i>> is
    continous with <math|\<forall\>x\<in\>X\<vDash\><around*|\<\|\|\>|<big|sum><rsub|i=1><rsup|n>H<rsup|i><around*|(|x|)>|\<\|\|\>><rsub|X>\<leqslant\><around*|(|<big|sum><rsub|i=1><rsup|n><around*|\<\|\|\>|H|\<\|\|\>><rsup|i>|)>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|H<rsup|n> is linear|}>>
      then we have
      ...
      let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|H<rsup|n> is
      continuous and \<forall\>x\<in\>X we have
      ...
      <\enumerate>
        ...
        <math|H<rsup|1>> is continous and if <math|x\<in\>X> we have
      ...
      use induction again so let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|<big|sum><rsub|i=1><rsup|n>H<rsup|i>
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 12.64>\<forall\>x\<in\>X,n\<in\>\<bbb-N\><rsub|0> we have
      <around*|\<\|\|\>|H<rsup|n><around*|(|x|)>|\<\|\|\>><rsub|X>\<leqslant\><around*|\<\|\|\>|H|\<\|\|\>><rsup|n>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X>
    </equation>
    ...
    <\proof>
      So let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|<around*|(|1<rsub|X>-H|)>\<circ\><around*|(|1<rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)>=<around*|(|1<rsub|X>-H<rsup|n+1>|)>|}>>
      then we have:
      ...
      Using induction we have that <math|S=\<bbb-N\><rsub|0>> so that
      <reference|eq 12.68> is valid.
    </proof>
    ...
    <\proof>
      So let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|<around*|(|1<rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)>\<circ\><around*|(|1<rsub|X>-H|)>=1<rsub|X>-H<rsup|n+1>|}>>
      then we have :
      ...
      Using induction we have that <math|S=\<bbb-N\><rsub|0>> so that
      <reference|eq 12.70> is indeed valid.
    </proof>

    Now if <math|\<varepsilon\>\<gtr\>0> , <math|x\<in\>X> then by
    <reference|eq 12.66> there exists a <math|N\<in\>\<bbb-N\><rsub|0>> such
    that if <math|n\<geqslant\>N> then <math|<around*|\<\|\|\>|H<rsup|n+1><around*|(|x|)>|\<\|\|\>><rsub|X>\<less\>\<varepsilon\>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        then as <math|\<forall\>i\<in\>\<bbb-N\><rsub|0>> we have that
      ...
      <\enumerate>
        ...
        proceed now by induction so let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|\<tau\>
        ...
        By mathematical induction we have that <math|S=\<bbb-N\><rsub|0>> and
        thus <math|\<tau\>=C<rsup|\<infty\>>>
      </enumerate>
    </enumerate>
  </proof>
  ...
  <\definition>
    ...
    diffeomorphism (of class <math|C<rsup|r>>, <math|r\<in\>\<bbb-N\>>) if
    and only if <math|f:U\<rightarrow\>V,f<rsup|-1>:V\<rightarrow\>U> are
    differentiable on <math|U,V> [of class
    <math|C<rsup|r>\<nocomma\>\<nocomma\>>, <math|r\<in\>\<bbb-N\>>]
  </definition>
  ...
  <\theorem>
    ...
    that <math|Df<around*|(|x|)>> and <math|Dg<around*|(|y|)>> are toplinear
    isomorphisms.
  </theorem>
  ...
  <\theorem>
    ...
    <math|C<rsup|r>>, <math|r\<in\>\<bbb-N\><rsub|0>>. Assume that for a
  ...
  <\proof>
    ...
    <\proposition>
      ...
      class <math|C<rsup|r>,r\<in\>\<bbb-N\><rsub|0>> such that
    ...
    <\proof>
      ...
      <\proof>
        ...
        <math|Df<around*|(|g<around*|(|y|)>|)>> is a toplinear isomorphism so
        that <math|Df<around*|(|g<around*|(|y|)>|)><rsup|-1>> is continuous
        and linear. Take now <math|h\<in\><around*|(|B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,<frac|\<chi\>|2>|)>|)><rsub|y>\<Rightarrow\>y+h\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,<frac|\<chi\>|2>|)>>
        let\ 
      ...
      <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|if n\<leqslant\>r then g
      is C<rsup|n>|}>> then we have\ 
      ...
      Using induction we have then that <math|S=\<bbb-N\><rsub|0>> so as
      <math|r\<in\>\<bbb-N\><rsub|0>=S> and <math|r\<leqslant\>r> we have
      <math|g> is <math|C<rsup|r>>. This proves that <math|f> is a local
      <math|C<rsup|r>> diffeomorphism at <math|0> and thus proves this
      proposition (see <reference|inverse theorem for Df(0)=1X>).
    ...
    <\proposition>
      ...
      set, <math|f:U\<rightarrow\>Y> a differentiable function of class
      <math|C<rsup|r>>, <math|r\<in\>\<bbb-N\><rsub|0>>. Assume that for a
      <math|0\<in\>U> we have that <math|f<around*|(|0|)>=0> and that
      <math|Df<around*|(|0|)>:X\<rightarrow\>Y> is a isomorphism then
    ...
    <\proof>
      ...
      mappings are toplinear> that <math|Df<around*|(|0|)>> is toplinear so
      ...
      is <math|C<rsup|\<infty\>>> and is isomorphic thus toplinear. as
      ...
      toplinear (and thus open) we have that <math|0\<in\>V<around*|(|0|)>>
    ...
    <math|f<around*|(|0|)>> so lets repeat the Inverse Function Theorem
    ...
    <\proposition>
      ...
      set, <math|f:U\<rightarrow\>Y> a differentiable function of class
      <math|C<rsup|r>>, <math|r\<in\>\<bbb-N\><rsub|0>>. Assume that for a
      <math|x<rsub|0>\<in\>U> we have that
      <math|Df<around*|(|x<rsub|0>|)>:X\<rightarrow\>Y> is a isomorphism then
      <math|f> is a local diffeomorphism of class <math|C<rsup|r>> at
      <math|x<rsub|0>>.
    </proposition>
  ...
  <\lemma>
    ...
    so that <math|T> is a bijection and thus a isomorphism.
  </lemma>
  ...
  <\theorem>
    ...
    function of class <math|C<rsup|r>,r\<in\>\<bbb-N\><rsub|0>>. Assume that
    ...
    A trivial corrolation of the implicit theorem is\ 
    ...
    <\theorem>
      ...
      be Banach spaces, <math|U\<subseteq\>X>, <math|V\<subseteq\>Y> be open
      sets and let <math|f:U\<times\>V\<rightarrow\>Z> be a differentiable
      function of class <math|C<rsup|r>,r\<in\>\<bbb-N\><rsub|0>>. Assume
      that <math|\<exists\>x<rsub|0>\<in\>U>,
      <math|\<exists\>y<rsub|0>\<in\>V> such that
      <math|D<rsub|2>f<around*|(|x<rsub|0>,y<rsub|0>|)>:Y\<rightarrow\>Z> is
      a isomorphism. Then there exists a open set <math|W> with
...
<\initial>
  <\collection>
    ...
    <associate|section-nr|13<uninit>>
...
<\references>
  <\collection>
    <associate|(01,..,*,..,On) is C@@|<tuple|13.107|452>>
    <associate|(x,h)-\<gtr\>Df(x)(h) differentiability|<tuple|13.68|432>>
    <associate|(x1,..,xi-1,*,xi+1,..,xn)|<tuple|13.18|417>>
    <associate|(x1,..,xi-1,*,xi+1,..,xn)^-1(U)|<tuple|13.22|?>>
    <associate|(x1,...,*,...) is differentiable|<tuple|13.21|417>>
    <associate|C1 of real or complex function|<tuple|13.41|423>>
    <associate|C^2 differential is symmetric|<tuple|13.99|447>>
    <associate|C^@@=@@-times differentiable|<tuple|13.44|424>>
    <associate|C^n implies C^m|<tuple|13.46|424>>
    <associate|C^n is a local property|<tuple|13.50|427>>
    <associate|C^n of multivalued functions|<tuple|13.60|430>>
    <associate|D^2g(x)(u)(v)=D^nf(x)(v:u:v1..vn-2)|<tuple|13.103|450>>
    <associate|D^nf(x)(h1:..hn)=D^(n-1)f(x)(h1:..hn-1)(hn)|<tuple|13.67|431>>
    <associate|Dh(x)(u)=D^nf(x)(u:v1:..:vn-1)|<tuple|13.104|450>>
    <associate|GL(X) is a group|<tuple|13.119|458>>
    <associate|I+H has inverse if norm of H is less then
    1|<tuple|13.126|461>>
    <associate|Jacobian Matrix|<tuple|13.31|421>>
    <associate|Mean Value Theorem 3|<tuple|13.93|447>>
    <associate|Mean value theorem 1|<tuple|13.86|445>>
    <associate|Mean value theorem 2|<tuple|13.89|446>>
    <associate|Ux is open|<tuple|13.2|413>>
    <associate|alternative definition of Ux|<tuple|13.3|413>>
    <associate|alternative definition of differentiability
    (2)|<tuple|13.13|416>>
    <associate|alternative definitions of differentiability|<tuple|13.8|414>>
    <associate|auto-1|<tuple|13|7>>
    <associate|auto-10|<tuple|13.16|12>>
    <associate|auto-11|<tuple|13.18|12>>
    <associate|auto-12|<tuple|13.24|12>>
    <associate|auto-13|<tuple|13.1.2|12>>
    <associate|auto-14|<tuple|13.28|12>>
    <associate|auto-15|<tuple|13.31|13>>
    <associate|auto-16|<tuple|13.2|13>>
    <associate|auto-17|<tuple|13.36|13>>
    <associate|auto-18|<tuple|13.37|14>>
    <associate|auto-19|<tuple|13.38|18>>
    <associate|auto-2|<tuple|13.1|11>>
    <associate|auto-20|<tuple|13.39|18>>
    <associate|auto-21|<tuple|13.3|19>>
    <associate|auto-22|<tuple|13.75|21>>
    <associate|auto-23|<tuple|13.75|21>>
    <associate|auto-24|<tuple|13.75|21>>
    <associate|auto-25|<tuple|13.75|23>>
    <associate|auto-26|<tuple|13.4|23>>
    <associate|auto-27|<tuple|13.80|23>>
    <associate|auto-28|<tuple|13.80|26>>
    <associate|auto-29|<tuple|13.80|28>>
    <associate|auto-3|<tuple|13.1.1|11>>
    <associate|auto-30|<tuple|13.82|28>>
    <associate|auto-31|<tuple|13.83|28>>
    <associate|auto-32|<tuple|13.85|29>>
    <associate|auto-33|<tuple|13.86|29>>
    <associate|auto-34|<tuple|13.87|29>>
    <associate|auto-35|<tuple|13.90|29>>
    <associate|auto-36|<tuple|13.90|29>>
    <associate|auto-37|<tuple|13.5|29>>
    <associate|auto-38|<tuple|13.6|31>>
    <associate|auto-39|<tuple|13.7|31>>
    <associate|auto-4|<tuple|13.1|11>>
    <associate|auto-40|<tuple|13.116|31>>
    <associate|auto-41|<tuple|13.118|31>>
    <associate|auto-42|<tuple|13.120|31>>
    <associate|auto-43|<tuple|13.134|?>>
    <associate|auto-5|<tuple|13.6|11>>
    <associate|auto-6|<tuple|13.7|11>>
    <associate|auto-7|<tuple|13.14|11>>
    <associate|auto-8|<tuple|13.15|11>>
    <associate|auto-9|<tuple|13.16|11>>
    <associate|balls are convex|<tuple|13.88|445>>
    <associate|chain rule|<tuple|13.24|418>>
    <associate|chain rule (1)|<tuple|13.25|?>>
    <associate|chain rules of partial differentiable
    functions|<tuple|13.111|453>>
    <associate|composition of diffeomorphism is a
    diffeomorphism|<tuple|13.132|465>>
    <associate|composition of differentials on arbitrary
    sets|<tuple|13.74|438>>
    <associate|consequence of Mean value theorem|<tuple|13.98|?>>
    <associate|constant functions are C^infinite|<tuple|13.54|428>>
    <associate|continuous billinear functions are
    C^infinity|<tuple|13.57|429>>
    <associate|derivative|<tuple|13.16|416>>
    <associate|derivative on a closed interval|<tuple|13.77|?>>
    <associate|differentiability and restricted mapping|<tuple|13.12|415>>
    <associate|differentiability at x implies continuity at
    x|<tuple|13.10|415>>
    <associate|differentiability at x is independent of
    norms|<tuple|13.11|415>>
    <associate|differentiability based on sequences|<tuple|13.9|?>>
    <associate|differentiability definition one|<tuple|13.4|413>>
    <associate|differentiability implies partial
    differentiability|<tuple|13.110|453>>
    <associate|differentiability of K^n|<tuple|13.29|420>>
    <associate|differentiability of finite sum|<tuple|13.53|428>>
    <associate|differentiability of map to product of
    spaces|<tuple|13.30|420>>
    <associate|differentiability of product of functions|<tuple|13.33|421>>
    <associate|differentiability on [a,b]|<tuple|13.75|438>>
    <associate|differentiability on [a,b] equivalences|<tuple|13.78|439>>
    <associate|differentiability on products of metric
    spaces|<tuple|13.27|419>>
    <associate|differential of a billinear mapping|<tuple|13.32|421>>
    <associate|differential of a function|<tuple|13.6|414>>
    <associate|differential of a linear function|<tuple|13.15|416>>
    <associate|differential of the constant function|<tuple|13.14|416>>
    <associate|differentias and derivates|<tuple|13.17|416>>
    <associate|differentiation under the integral sign|<tuple|13.71|432>>
    <associate|e-mappings|<tuple|13.7|414>>
    <associate|eq 0.12.1|<tuple|13.2|?>>
    <associate|eq 0.12.2|<tuple|13.3|?>>
    <associate|eq 0.12.3|<tuple|13.4|?>>
    <associate|eq 0.12.4|<tuple|13.5|?>>
    <associate|eq 0.12.5|<tuple|13.13|?>>
    <associate|eq 0.12.6|<tuple|13.7|?>>
    <associate|eq 0.12.7|<tuple|13.8|?>>
    <associate|eq 1.12.5|<tuple|13.6|?>>
    <associate|eq 12.1|<tuple|13.9|416>>
    <associate|eq 12.10|<tuple|13.19|419>>
    <associate|eq 12.100|<tuple|13.137|467>>
    <associate|eq 12.101|<tuple|13.138|468>>
    <associate|eq 12.102|<tuple|13.139|468>>
    <associate|eq 12.103|<tuple|13.140|468>>
    <associate|eq 12.104|<tuple|13.141|468>>
    <associate|eq 12.105|<tuple|13.142|468>>
    <associate|eq 12.106|<tuple|13.143|468>>
    <associate|eq 12.107|<tuple|13.144|468>>
    <associate|eq 12.108|<tuple|13.145|468>>
    <associate|eq 12.109|<tuple|13.146|468>>
    <associate|eq 12.11|<tuple|13.20|419>>
    <associate|eq 12.12|<tuple|13.21|422>>
    <associate|eq 12.128|<tuple|13.147|470>>
    <associate|eq 12.129|<tuple|13.148|?>>
    <associate|eq 12.13|<tuple|13.22|425>>
    <associate|eq 12.130|<tuple|13.149|470>>
    <associate|eq 12.131|<tuple|13.153|471>>
    <associate|eq 12.132|<tuple|13.154|471>>
    <associate|eq 12.133|<tuple|13.155|471>>
    <associate|eq 12.134|<tuple|13.156|471>>
    <associate|eq 12.135|<tuple|13.157|471>>
    <associate|eq 12.136|<tuple|13.158|471>>
    <associate|eq 12.137|<tuple|13.159|471>>
    <associate|eq 12.138|<tuple|13.160|471>>
    <associate|eq 12.139|<tuple|13.161|471>>
    <associate|eq 12.140|<tuple|13.162|471>>
    <associate|eq 12.141|<tuple|13.162|471>>
    <associate|eq 12.15|<tuple|13.24|433>>
    <associate|eq 12.15.0|<tuple|13.23|?>>
    <associate|eq 12.16|<tuple|13.25|433>>
    <associate|eq 12.17|<tuple|13.26|433>>
    <associate|eq 12.18|<tuple|13.27|434>>
    <associate|eq 12.19|<tuple|13.28|434>>
    <associate|eq 12.2|<tuple|13.10|416>>
    <associate|eq 12.20|<tuple|13.29|434>>
    <associate|eq 12.21|<tuple|13.30|434>>
    <associate|eq 12.22|<tuple|13.31|434>>
    <associate|eq 12.23|<tuple|13.32|434>>
    <associate|eq 12.24|<tuple|13.33|435>>
    <associate|eq 12.25|<tuple|13.34|435>>
    <associate|eq 12.26|<tuple|13.35|436>>
    <associate|eq 12.27|<tuple|13.36|437>>
    <associate|eq 12.28|<tuple|13.37|437>>
    <associate|eq 12.29|<tuple|13.38|437>>
    <associate|eq 12.3|<tuple|13.11|418>>
    <associate|eq 12.30|<tuple|13.39|437>>
    <associate|eq 12.31|<tuple|13.40|437>>
    <associate|eq 12.32|<tuple|13.41|437>>
    <associate|eq 12.33|<tuple|13.42|437>>
    <associate|eq 12.34|<tuple|13.43|437>>
    <associate|eq 12.35|<tuple|13.44|437>>
    <associate|eq 12.36|<tuple|13.45|440>>
    <associate|eq 12.37|<tuple|13.46|444>>
    <associate|eq 12.38|<tuple|13.47|444>>
    <associate|eq 12.39|<tuple|13.48|445>>
    <associate|eq 12.4|<tuple|13.12|418>>
    <associate|eq 12.40|<tuple|13.49|445>>
    <associate|eq 12.41|<tuple|13.60|447>>
    <associate|eq 12.42|<tuple|13.61|447>>
    <associate|eq 12.43|<tuple|13.62|447>>
    <associate|eq 12.44|<tuple|13.63|447>>
    <associate|eq 12.45|<tuple|13.64|447>>
    <associate|eq 12.46|<tuple|13.65|448>>
    <associate|eq 12.47|<tuple|13.66|448>>
    <associate|eq 12.48|<tuple|13.67|448>>
    <associate|eq 12.49|<tuple|13.68|448>>
    <associate|eq 12.5|<tuple|13.14|418>>
    <associate|eq 12.50|<tuple|13.69|448>>
    <associate|eq 12.51|<tuple|13.70|448>>
    <associate|eq 12.52|<tuple|13.71|449>>
    <associate|eq 12.53|<tuple|13.72|450>>
    <associate|eq 12.54|<tuple|13.73|450>>
    <associate|eq 12.55|<tuple|13.74|450>>
    <associate|eq 12.56|<tuple|13.75|451>>
    <associate|eq 12.57|<tuple|13.76|451>>
    <associate|eq 12.58|<tuple|13.77|451>>
    <associate|eq 12.59|<tuple|13.78|452>>
    <associate|eq 12.6|<tuple|13.15|418>>
    <associate|eq 12.60|<tuple|13.79|452>>
    <associate|eq 12.61|<tuple|13.80|452>>
    <associate|eq 12.62|<tuple|13.81|452>>
    <associate|eq 12.63|<tuple|13.82|452>>
    <associate|eq 12.64|<tuple|13.101|459>>
    <associate|eq 12.64-0|<tuple|13.83|454>>
    <associate|eq 12.65|<tuple|13.102|459>>
    <associate|eq 12.65-0|<tuple|13.84|454>>
    <associate|eq 12.66|<tuple|13.103|459>>
    <associate|eq 12.66-0|<tuple|13.85|454>>
    <associate|eq 12.67|<tuple|13.104|459>>
    <associate|eq 12.67-0|<tuple|13.86|454>>
    <associate|eq 12.68|<tuple|13.105|460>>
    <associate|eq 12.68-0|<tuple|13.87|454>>
    <associate|eq 12.69|<tuple|13.106|460>>
    <associate|eq 12.69-0|<tuple|13.88|454>>
    <associate|eq 12.7|<tuple|13.16|418>>
    <associate|eq 12.70|<tuple|13.107|460>>
    <associate|eq 12.70-0|<tuple|13.89|454>>
    <associate|eq 12.71|<tuple|13.108|461>>
    <associate|eq 12.71-0|<tuple|13.90|454>>
    <associate|eq 12.72|<tuple|13.109|461>>
    <associate|eq 12.72-0|<tuple|13.91|454>>
    <associate|eq 12.72-1|<tuple|13.92|455>>
    <associate|eq 12.73|<tuple|13.110|461>>
    <associate|eq 12.74|<tuple|13.111|461>>
    <associate|eq 12.74-1|<tuple|13.93|456>>
    <associate|eq 12.75|<tuple|13.112|462>>
    <associate|eq 12.75-1|<tuple|13.94|456>>
    <associate|eq 12.76|<tuple|13.113|462>>
    <associate|eq 12.76-1|<tuple|13.95|456>>
    <associate|eq 12.77|<tuple|13.114|462>>
    <associate|eq 12.77-1|<tuple|13.96|456>>
    <associate|eq 12.78|<tuple|13.115|462>>
    <associate|eq 12.78-1|<tuple|13.97|456>>
    <associate|eq 12.79|<tuple|13.116|462>>
    <associate|eq 12.79-1|<tuple|13.98|456>>
    <associate|eq 12.8|<tuple|13.17|418>>
    <associate|eq 12.80|<tuple|13.117|463>>
    <associate|eq 12.80-1|<tuple|13.99|457>>
    <associate|eq 12.81|<tuple|13.118|463>>
    <associate|eq 12.81-1|<tuple|13.100|457>>
    <associate|eq 12.82|<tuple|13.119|463>>
    <associate|eq 12.83|<tuple|13.120|463>>
    <associate|eq 12.84|<tuple|13.121|463>>
    <associate|eq 12.85|<tuple|13.122|463>>
    <associate|eq 12.86|<tuple|13.123|464>>
    <associate|eq 12.87|<tuple|13.124|465>>
    <associate|eq 12.88|<tuple|13.125|466>>
    <associate|eq 12.89|<tuple|13.126|466>>
    <associate|eq 12.9|<tuple|13.128|466>>
    <associate|eq 12.90|<tuple|13.127|466>>
    <associate|eq 12.92|<tuple|13.129|466>>
    <associate|eq 12.93|<tuple|13.130|466>>
    <associate|eq 12.94|<tuple|13.131|466>>
    <associate|eq 12.95|<tuple|13.132|466>>
    <associate|eq 12.96|<tuple|13.133|467>>
    <associate|eq 12.97|<tuple|13.134|467>>
    <associate|eq 12.98|<tuple|13.135|467>>
    <associate|eq 12.99|<tuple|13.136|467>>
    <associate|eq 12.9\<longminus\>1|<tuple|13.18|419>>
    <associate|eq 13.1.318|<tuple|13.1|?>>
    <associate|eq 13.50.317|<tuple|13.51|?>>
    <associate|eq 13.51.317|<tuple|13.52|?>>
    <associate|eq 13.52.317|<tuple|13.53|?>>
    <associate|eq 13.53.317|<tuple|13.54|?>>
    <associate|eq 13.54.317|<tuple|13.55|?>>
    <associate|eq 13.55.317|<tuple|13.56|?>>
    <associate|eq 13.56.317|<tuple|13.57|?>>
    <associate|eq 13.57.317|<tuple|13.58|?>>
    <associate|eq 13.58.317|<tuple|13.59|?>>
    <associate|extremum and derivate|<tuple|13.81|442>>
    <associate|f_v is differentiable|<tuple|13.66|431>>
    <associate|fundamental theorem of calculus|<tuple|13.85|444>>
    <associate|generalized chain rule|<tuple|13.62|430>>
    <associate|i-H has inverse if norm of H is lower then
    1|<tuple|13.125|459>>
    <associate|if f is C^n then D^1f is C^n-1|<tuple|13.48|426>>
    <associate|implicit function theorem|<tuple|13.143|470>>
    <associate|in Banach spaces linear continuous mappings are
    toplinear|<tuple|13.117|458>>
    <associate|inverse function theorem|<tuple|13.134|465>>
    <associate|inverse mapping is c-infinite|<tuple|13.127|461>>
    <associate|inverse theorem for Df(0)=1X|<tuple|13.135|465>>
    <associate|lagranges theorem|<tuple|13.83|443>>
    <associate|left,right derivatives|<tuple|13.76|?>>
    <associate|linear continuous mappings are C^infinity|<tuple|13.55|428>>
    <associate|linearity of (01,...*,...0n)|<tuple|13.19|417>>
    <associate|mean value theorem (3)|<tuple|13.95|?>>
    <associate|n-th derivative|<tuple|13.39|423>>
    <associate|n-times differentiability and partial
    derivatives|<tuple|13.69|432>>
    <associate|n-times differentiability implies m-times
    differentiability|<tuple|13.45|424>>
    <associate|n-times differentiability is local|<tuple|13.49|426>>
    <associate|n-times differentiability is same as n-1 times
    differentiability of DF|<tuple|13.47|425>>
    <associate|n-times differentiability of multi valued
    function|<tuple|13.59|429>>
    <associate|partial derivative definition|<tuple|13.28|420>>
    <associate|partial differential definition|<tuple|13.26|419>>
    <associate|partial differential on U|<tuple|13.108|453>>
    <associate|power of a continuous linear mapping is linear and
    continuous|<tuple|13.122|458>>
    <associate|product of n-times differentiable functions is n-times
    differentiable|<tuple|13.70|432>>
    <associate|projection map is infinite times dimensions|<tuple|13.58|429>>
    <associate|proposition 12.116|<tuple|13.136|466>>
    <associate|proposition 12.118|<tuple|13.138|467>>
    <associate|proposition 12.120|<tuple|13.140|469>>
    <associate|rolles theorem|<tuple|13.82|443>>
    <associate|second mean value theorem|<tuple|13.94|447>>
    <associate|sum of (01,...,*,...0n)|<tuple|13.20|417>>
    <associate|sum of C^n functions is C^n|<tuple|13.52|427>>
    <associate|sum of differentiable functions|<tuple|13.23|417>>
    <associate|sum of linear function and infinite sum|<tuple|13.124|459>>
    <associate|sum of n-times differentiable functions is n-times
    differentiable|<tuple|13.51|427>>
    <associate|symmetry of L^n+t(X;Y) based on permutations and
    transposition|<tuple|13.101|449>>
    <associate|the n-th differential is symmetric|<tuple|13.105|450>>
    <associate|toplinear in normed space|<tuple|13.116|457>>
    <associate|translations are C-infinity|<tuple|13.56|428>>
    <associate|uniqueness of differential|<tuple|13.5|413>>
  </collection>
</references>
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      ...
      <tuple|<tuple|derivative>|<pageref|auto-9>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'>>>|<pageref|auto-10>>

      <tuple|<tuple|<with|mode|<quote|math>|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>>>|<pageref|auto-11>>

      <tuple|<tuple|chain rule>|<pageref|auto-12>>

      <tuple|<tuple|<with|mode|<quote|math>|\<partial\><rsub|i>f<around*|(|x|)>>>|<pageref|auto-14>>

      <tuple|<tuple|Jacobian>|<pageref|auto-15>>

      <tuple|<tuple|<with|mode|<quote|math>|D<rsup|n>f>>|<pageref|auto-17>>

      <tuple|<tuple|<with|mode|<quote|math>|C<rsup|n>>>|<pageref|auto-18>>

      <tuple|<tuple|<with|mode|<quote|math>|C<rsup|\<infty\>>>>|<pageref|auto-19>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rsup|<around*|(|n|)>>>>|<pageref|auto-20>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|+><around*|(|x|)>>>|<pageref|auto-22>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|-><around*|(|x|)>>>|<pageref|auto-23>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|+>>>|<pageref|auto-24>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|->>>|<pageref|auto-25>>

      <tuple|<tuple|local weak minimum>|<pageref|auto-27>>

      <tuple|<tuple|local weak maximum>|<pageref|auto-28>>

      <tuple|<tuple|extremum>|<pageref|auto-29>>

      <tuple|<tuple|Rolle's theorem>|<pageref|auto-30>>

      <tuple|<tuple|Lagrange's theorem>|<pageref|auto-31>>

      <tuple|<tuple|Fundamental Theorem of Calculus (Classical
      version)>|<pageref|auto-32>>

      <tuple|<tuple|Fundamental Theorem of Calculus>|<pageref|auto-33>>

      <tuple|<tuple|convex sets>|<pageref|auto-34>>

      <tuple|<tuple|line segment>|<pageref|auto-35>>

      <tuple|<tuple|<with|mode|<quote|math>|L<rsub|a,b>>>|<pageref|auto-36>>

      <tuple|<tuple|toplinear isomorphism>|<pageref|auto-40>>

      <tuple|<tuple|<with|mode|<quote|math>|\<cal-G\>L<around*|(|X|)>>>|<pageref|auto-41>>

      <tuple|<tuple|<with|mode|<quote|math>|H<rsup|n>>>|<pageref|auto-42>>

      <tuple|<tuple|inverse function theorem>|<pageref|auto-43>>
    </associate>
    <\associate|toc>
      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|13<space|2spc>Differentiability
      ...
      13.1<space|2spc>Differentiability <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-2>

      <with|par-left|<quote|1tab>|13.1.1<space|2spc>Differential
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-3>>

      <with|par-left|<quote|1tab>|13.1.2<space|2spc>Partial differential
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-13>>

      13.2<space|2spc>Higher order differentiability
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-16>

      13.3<space|2spc>Differentiability on general sets
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-21>

      13.4<space|2spc>Intermediate value and mean value theorems
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-26>

      13.5<space|2spc>Symmetry of Higher Order Differentials
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-37>

      13.6<space|2spc>Partial Differentiation
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-38>

      13.7<space|2spc>Inverse function theory
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
