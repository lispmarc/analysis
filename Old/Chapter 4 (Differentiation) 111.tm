...
<\body>
  ...
  <\definition>
    ...
    converges in <math|L<around*|(|X,X|)>> and define
    <math|<around*|(|<big|sum><rsub|i=1><rsup|\<infty\>>H<rsup|i>|)><around*|(|x|)>=<big|sum><rsub|i=1><rsup|\<infty\>>H<rsup|i><around*|(|x|)>>
  ...
  <\proof>
    ...
    <\proof>
      ...
      <\description>
        ...
        <\eqnarray*>
          <tformat|<table|<row|<cell|<around*|(|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n+1>H<rsup|i>|)>\<circ\><around*|(|\<bbb-1\><rsub|X>-H|)>|)><around*|(|x|)>>|<cell|=>|<cell|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n+1>H<rsup|i>|)><around*|(|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n+1>H<rsup|i>|)><around*|(|x-H<around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>+H<rsup|n+1>|)><around*|(|x-H<around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)><around*|(|x-H<around*|(|x|)>|)>+H<rsup|n+1><around*|(|x-H<around*|(|x|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|n\<in\>S>>|<cell|<around*|(|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)>\<circ\><around*|(|\<bbb-1\><rsub|X>-H|)>|)><around*|(|x|)>+H<rsup|n+1><around*|(|x-H<around*|(|x|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|n\<in\>S>>|<cell|<around*|(|\<bbb-1\><rsub|X>-H<rsup|n+1>|)><around*|(|x|)>+H<rsup|n+1><around*|(|x|)>-H<rsup|<around*|(|n+1|)>+1><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|x-H<rsup|n+1><around*|(|x|)>+H<rsup|n+1><around*|(|x|)>-H<rsup|<around*|(|n+1|)>+1><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|x-H<rsup|<around*|(|n+1|)>+1><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<bbb-1\><rsub|X>-H<rsup|<around*|(|n+1|)>+1>|)><around*|(|x|)>>>>>
        </eqnarray*>
      </description>
    ...
    are toplinear> \ top-linear. This together with <reference|eq
    14.156.110.1> proves that
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\equation>
        <label|eq 14.165.109>\<varepsilon\>:B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|\<bbb-1\><rsub|X>,1|)><rsub|\<bbb-1\><rsub|X>>\<rightarrow\>L<around*|(|X,X|)>
      ...
      <\equation>
        <label|eq 14.170.108>\<forall\>H\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|\<bbb-1\><rsub|X>,1|)><rsub|\<bbb-1\><rsub|X>>
      ...
      <\description>
        ...
        H=0>>|<row|<cell|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>
        if H\<neq\>0>>>>>=<choice|<tformat|<table|<row|<cell|<around*|\<\|\|\>|H|\<\|\|\>>\<cdot\>C<rsub|X,X,0>>>|<row|<cell|<around*|\<\|\|\>|H|\<\|\|\>>\<cdot\><frac|1|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>
        ...
        <math|H\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|L,\<delta\>|)><rsub|L>\<equallim\><rsub|<text|<reference|B(0,d)=B(x,d)_x>>>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|0,\<delta\>|)>>
        then\ 
        ...
        <math|><math|L<rsup|-1>\<circ\>\<varepsilon\><around*|(|H\<circ\>L<rsup|-1>|)>\<cdot\><frac|<around*|\<\|\|\>|H\<circ\>L<rsup|-1>|\<\|\|\>>|<around*|\<\|\|\>|H|\<\|\|\>>>\<in\>L<around*|(|X,X|)>>
      ...
      <\eqnarray*>
        ...
        of sums>>>>|<cell|\<alpha\>\<cdot\><around*|(|-L\<circ\>H\<circ\>L<rsub|1>|)>+\<beta\>\<cdot\><around*|(|-L\<circ\>H\<circ\>L<rsub|2>|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>\<Phi\><rsub|L,L<rsub|1><around*|(|H|)>><around*|(|H|)>+\<beta\>\<cdot\>\<Phi\><rsub|L,L<rsub|2>><around*|(|H|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>\<rho\><around*|(|L,L<rsub|1>|)><around*|(|H|)>+\<beta\>\<cdot\>\<rho\><around*|(|L,L<rsub|2>|)><around*|(|H|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\>\<rho\><around*|(|L,L<rsub|1>|)>+\<beta\>\<cdot\>\<rho\><around*|(|L,L<rsub|2>|)>|)><around*|(|H|)>>>>>
      </eqnarray*>
  ...
  <\definition>
    ...
    <math|V\<subseteq\>Y> a open set and <math|f:U\<rightarrow\>Y> a
  ...
  <\proposition>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces <math|U\<subseteq\>X> a open set in <math|X>,
    <math|V\<subseteq\>Y> a open set and <math|f:U\<rightarrow\>Y> a function
    then <math|f> is a diffeomorphism\ 
  </proposition>
...
<\references>
  <\collection>
    ...
    diffeomorphism|<tuple|14.159|465>>
    ...
    <associate|diffeomorphism are toplinear|<tuple|14.158|?>>
    ...
    <associate|eq 12.100|<tuple|14.208|467>>
    <associate|eq 12.101|<tuple|14.209|468>>
    <associate|eq 12.102|<tuple|14.210|468>>
    <associate|eq 12.103|<tuple|14.211|468>>
    <associate|eq 12.104|<tuple|14.212|468>>
    <associate|eq 12.105|<tuple|14.213|468>>
    <associate|eq 12.106|<tuple|14.214|468>>
    <associate|eq 12.107|<tuple|14.215|468>>
    <associate|eq 12.108|<tuple|14.216|468>>
    <associate|eq 12.109|<tuple|14.217|468>>
    <associate|eq 12.12|<tuple|14.26|422>>
    <associate|eq 12.128|<tuple|14.220|470>>
    <associate|eq 12.129|<tuple|14.221|?>>
    <associate|eq 12.130|<tuple|14.222|470>>
    <associate|eq 12.131|<tuple|14.226|471>>
    <associate|eq 12.132|<tuple|14.227|471>>
    <associate|eq 12.133|<tuple|14.228|471>>
    <associate|eq 12.134|<tuple|14.229|471>>
    <associate|eq 12.135|<tuple|14.230|471>>
    <associate|eq 12.136|<tuple|14.231|471>>
    <associate|eq 12.137|<tuple|14.232|471>>
    <associate|eq 12.138|<tuple|14.233|471>>
    <associate|eq 12.139|<tuple|14.234|471>>
    <associate|eq 12.140|<tuple|14.235|471>>
    <associate|eq 12.141|<tuple|14.235|471>>
    ...
    <associate|eq 12.53|<tuple|14.122|450>>
    <associate|eq 12.64|<tuple|14.154|459>>
    <associate|eq 12.65|<tuple|14.155|459>>
    <associate|eq 12.66|<tuple|14.156|459>>
    <associate|eq 12.67|<tuple|14.157|459>>
    <associate|eq 12.68|<tuple|14.158|460>>
    <associate|eq 12.69|<tuple|14.160|460>>
    <associate|eq 12.70|<tuple|14.161|460>>
    <associate|eq 12.71|<tuple|14.163|461>>
    <associate|eq 12.73|<tuple|14.162|461>>
    <associate|eq 12.74|<tuple|14.165|461>>
    <associate|eq 12.75|<tuple|14.166|462>>
    <associate|eq 12.87|<tuple|14.195|465>>
    <associate|eq 12.88|<tuple|14.196|466>>
    <associate|eq 12.89|<tuple|14.197|466>>
    <associate|eq 12.9|<tuple|14.199|466>>
    <associate|eq 12.90|<tuple|14.198|466>>
    <associate|eq 12.92|<tuple|14.200|466>>
    <associate|eq 12.93|<tuple|14.201|466>>
    <associate|eq 12.94|<tuple|14.202|466>>
    <associate|eq 12.95|<tuple|14.203|466>>
    <associate|eq 12.96|<tuple|14.204|467>>
    <associate|eq 12.97|<tuple|14.205|467>>
    <associate|eq 12.98|<tuple|14.206|467>>
    <associate|eq 12.99|<tuple|14.207|467>>
    <associate|eq 14.164.107|<tuple|14.173|?>>
    <associate|eq 14.164.109|<tuple|14.169|?>>
    <associate|eq 14.165.109|<tuple|14.170|?>>
    <associate|eq 14.166.109|<tuple|14.171|?>>
    <associate|eq 14.167.107|<tuple|14.174|?>>
    <associate|eq 14.17.100|<tuple|14.17|?>>
    <associate|eq 14.170.108|<tuple|14.172|?>>
    <associate|eq 14.171.108|<tuple|14.176|?>>
    <associate|eq 14.171.110.2|<tuple|14.175|?>>
    <associate|eq 14.172.108|<tuple|14.177|?>>
    <associate|eq 14.173.108|<tuple|14.178|?>>
    <associate|eq 14.174.108|<tuple|14.178|?>>
    <associate|eq 14.174.109|<tuple|14.180|?>>
    <associate|eq 14.175.109|<tuple|14.181|?>>
    <associate|eq 14.176.109|<tuple|14.182|?>>
    <associate|eq 14.177.109|<tuple|14.183|?>>
    <associate|eq 14.178.109|<tuple|14.184|?>>
    <associate|eq 14.179.109|<tuple|14.185|?>>
    <associate|eq 14.18.100|<tuple|14.18|?>>
    <associate|eq 14.180.109|<tuple|14.186|?>>
    <associate|eq 14.181.109|<tuple|14.187|?>>
    <associate|eq 14.182.109|<tuple|14.188|?>>
    <associate|eq 14.183.109|<tuple|14.190|?>>
    <associate|eq 14.183.109.1|<tuple|14.189|?>>
    <associate|eq 14.184.109|<tuple|14.191|?>>
    <associate|eq 14.185.109|<tuple|14.192|?>>
    <associate|eq 14.186.109|<tuple|14.193|?>>
    <associate|eq 14.188.109|<tuple|14.194|?>>
    ...
    <associate|eq 14.74.103|<tuple|14.89|?>>
    <associate|eq 14.75.103|<tuple|14.90|?>>
    <associate|eq 14.8.100|<tuple|14.2|?>>
    <associate|eq 14.80.103|<tuple|14.95|?>>
    <associate|eq 14.84.103|<tuple|14.99|?>>
    <associate|eq 14.85.103|<tuple|14.100|?>>
    <associate|eq 14.88.103|<tuple|14.103|?>>
    <associate|eq 14.89.103|<tuple|14.104|?>>
    <associate|eq 14.9.100|<tuple|14.3|?>>
    <associate|eq 14.90.103|<tuple|14.105|?>>
    <associate|eq 14.91.103|<tuple|14.106|?>>
    <associate|eq 14.92.103|<tuple|14.107|?>>
    <associate|eq 14.93.103|<tuple|14.108|?>>
    <associate|eq 14.94.103|<tuple|14.109|?>>
    <associate|eq 14.95.103|<tuple|14.110|?>>
    <associate|eq 14.96.103|<tuple|14.111|?>>
    <associate|eq 14.97.103|<tuple|14.112|?>>
    <associate|eq 14.98.103|<tuple|14.113|?>>
    <associate|eq 14.99.103.1|<tuple|14.114|?>>
    ...
    <associate|implicit function theorem|<tuple|14.171|470>>
    <associate|in Banach spaces linear continuous mappings are
    toplinear|<tuple|14.143|458>>
    <associate|inverse function theorem|<tuple|14.161|465>>
    <associate|inverse mapping is c-infinite|<tuple|14.153|461>>
    <associate|inverse of derivative|<tuple|14.169|?>>
    <associate|inverse theorem for Df(0)=1X|<tuple|14.162|465>>
    ...
    <associate|proposition 12.116|<tuple|14.163|466>>
    <associate|proposition 12.118|<tuple|14.165|467>>
    <associate|proposition 12.120|<tuple|14.167|469>>
