...
<\body>
  ...
  <\proof>
    ...
    <\equation>
      ...
      f<around*|(|x|)>\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|Y>><around*|(|f<around*|(|x|)>,\<delta\><rsub|1>|)>\<subseteq\>H,W=V<big|cap>H,H
      open in Y
    </equation>
  ...
  <\definition>
    ...
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
    <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>V> a function
    then <math|f> is <math|\<infty\>>-differentiableif
    <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> we have that <math|f> is
  ...
  <\definition>
    ...
    <math|f> is of class <math|C<rsup|n>> if one of the following is
    satisfied
  ...
  <\definition>
    ...
    <math|U\<subseteq\>\<bbb-K\>> a open set, <math|V\<subseteq\>\<bbb-K\>>,
    <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>V> a function
    then <math|f> has a <math|n>-the derivative
    <math|f<rsup|<around*|(|n|)>>> on <math|U> if one of the following is
    satisfied.

    <\enumerate>
      <item>If <math|n=1> we must have <math|\<forall\>x\<in\>U> that
      \ <math|f> has a derivative at <math|x> and we define
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      at <math|x>, so <math|\<forall\>\<varepsilon\>\<gtr\>0> there exists a
      <math|\<delta\>\<gtr\>0> such that if
      <math|<around*|\||x-y|\|>\<less\>\<delta\>\<Rightarrow\><around*|\<\|\|\>|<around*|(|f<around*|(|\<ast\>|)><around*|(|1|)>|)><around*|(|x|)>-<around*|(|f<around*|(|\<ast\>|)><around*|(|1|)>|)><around*|(|y|)>|\<\|\|\>><rsub|Y>\<less\><frac|\<varepsilon\>|2>>,
      then as <math|<around*|\<\|\|\>|<around*|(|f<around*|(|x|)>-f<around*|(|y|)>|)><around*|(|r|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|<around*|(|f<around*|(|x|)>-f<around*|(|y|)>|)><around*|(|r\<cdot\>1|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|r\<cdot\><around*|(|f<around*|(|x|)>-f<around*|(|y|)>|)><around*|(|1|)>|\<\|\|\>><rsub|Y>=<around*|\||r|\|>\<cdot\><around*|\<\|\|\>|<around*|(|f<around*|(|x|)>-f<around*|(|y|)>|)><around*|(|1|)>|\<\|\|\>><rsub|Y>=<around*|\||r|\|><around*|\<\|\|\>|f<around*|(|x|)><around*|(|1|)>-f<around*|(|y|)><around*|(|1|)>|\<\|\|\>><rsub|Y>=<around*|\||r|\|><around*|\<\|\|\>|<around*|(|f<around*|(|\<ast\>|)><around*|(|1|)>|)><around*|(|x|)>-<around*|(|f<around*|(|\<ast\>|)><around*|(|1|)>|)><around*|(|y|)>|\<\|\|\>><rsub|Y>\<less\><around*|\||r|\|>\<cdot\><frac|\<varepsilon\>|2>\<Rightarrow\><around*|\<\|\|\>|<around*|(|f<around*|(|x|)>-f<around*|(|y|)>|)><around*|(|r|)>|\<\|\|\>><rsub|L<around*|(|\<bbb-K\>,Y|)>>\<leqslant\><frac|\<varepsilon\>|2><around*|\||r|\|>\<less\>\<varepsilon\>\<cdot\><around*|\||r|\|>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      and thus <math|C<rsup|0>>. If <math|n\<in\>\<bbb-N\><rsub|0>> we have
      that <math|f> is <math|n>-times differentiable then <math|f> is
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
    , <math|n\<in\>\<bbb-N\>> and <math|f:U\<rightarrow\>V> a function that
    is <math|>n-times differentiable then we have that
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|0\<in\>S<rsub|n>>>f <math|i=0\<Rightarrow\>n-i=n> and as
    ...
    <math|i=n-m\<in\><around*|{|0,\<ldots\>,n-1|}>>. As we have that
    <math|i\<in\>S<rsub|n>=\<bbb-N\>> and <math|0\<leqslant\>i\<less\>n> we
    have that <math|f> is <math|<around*|(|n-i|)>>-times differentiable which
...
<\references>
  <\collection>
    ...
    <associate|C1 of real or complex function|<tuple|13.43|423>>
    ...
    <associate|auto-18|<tuple|13.38|14>>
    <associate|auto-19|<tuple|13.39|18>>
    <associate|auto-2|<tuple|13.1|11>>
    <associate|auto-20|<tuple|13.40|18>>
    <associate|auto-21|<tuple|13.40|19>>
    <associate|auto-22|<tuple|13.41|21>>
    <associate|auto-23|<tuple|13.3|21>>
    <associate|auto-24|<tuple|13.75|21>>
    <associate|auto-25|<tuple|13.75|23>>
    <associate|auto-26|<tuple|13.75|23>>
    <associate|auto-27|<tuple|13.75|23>>
    <associate|auto-28|<tuple|13.4|26>>
    <associate|auto-29|<tuple|13.80|28>>
    <associate|auto-3|<tuple|13.1.1|11>>
    <associate|auto-30|<tuple|13.80|28>>
    <associate|auto-31|<tuple|13.80|28>>
    <associate|auto-32|<tuple|13.82|29>>
    <associate|auto-33|<tuple|13.83|29>>
    <associate|auto-34|<tuple|13.85|29>>
    <associate|auto-35|<tuple|13.86|29>>
    <associate|auto-36|<tuple|13.87|29>>
    <associate|auto-37|<tuple|13.90|29>>
    <associate|auto-38|<tuple|13.90|31>>
    <associate|auto-39|<tuple|13.5|31>>
    <associate|auto-4|<tuple|13.1|11>>
    <associate|auto-40|<tuple|13.6|31>>
    <associate|auto-41|<tuple|13.7|31>>
    <associate|auto-42|<tuple|13.116|31>>
    <associate|auto-43|<tuple|13.118|?>>
    <associate|auto-44|<tuple|13.120|?>>
    <associate|auto-45|<tuple|13.134|?>>
    ...
    <associate|n-th derivative|<tuple|13.41|423>>
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      ...
      <tuple|<tuple|smooth functions>|<pageref|auto-20>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rsup|<around*|(|n|)>>>>|<pageref|auto-21>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|+><around*|(|x|)>>>|<pageref|auto-23>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|-><around*|(|x|)>>>|<pageref|auto-24>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|+>>>|<pageref|auto-25>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|->>>|<pageref|auto-26>>

      <tuple|<tuple|local weak minimum>|<pageref|auto-28>>

      <tuple|<tuple|local weak maximum>|<pageref|auto-29>>

      <tuple|<tuple|extremum>|<pageref|auto-30>>

      <tuple|<tuple|Rolle's theorem>|<pageref|auto-31>>

      <tuple|<tuple|Lagrange's theorem>|<pageref|auto-32>>

      <tuple|<tuple|Fundamental Theorem of Calculus (Classical
      version)>|<pageref|auto-33>>

      <tuple|<tuple|Fundamental Theorem of Calculus>|<pageref|auto-34>>

      <tuple|<tuple|convex sets>|<pageref|auto-35>>

      <tuple|<tuple|line segment>|<pageref|auto-36>>

      <tuple|<tuple|<with|mode|<quote|math>|L<rsub|a,b>>>|<pageref|auto-37>>

      <tuple|<tuple|toplinear isomorphism>|<pageref|auto-41>>

      <tuple|<tuple|<with|mode|<quote|math>|\<cal-G\>L<around*|(|X|)>>>|<pageref|auto-42>>

      <tuple|<tuple|<with|mode|<quote|math>|H<rsup|n>>>|<pageref|auto-43>>

      <tuple|<tuple|inverse function theorem>|<pageref|auto-44>>
    </associate>
    <\associate|toc>
