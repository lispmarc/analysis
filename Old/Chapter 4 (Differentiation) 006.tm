...
<\body>
  ...
  <\proof>
    \ If <math|h\<in\>U<rsub|x>\<Rightarrow\>x+h\<in\>U\<Rightarrow\>h=<around*|(|x+h|)>-x=-x+<around*|(|x+h|)>\<Rightarrow\>\<exists\>y\<in\>U\<vDash\>h=<around*|(|-x|)>+y=y-x\<Rightarrow\>h\<in\><around*|(|-x|)>+U
    and h\<in\>U-x>. If <math|h\<in\><around*|(|-x|)>+U\<Rightarrow\>\<exists\>y\<in\>U\<vdash\>h=<around*|(|-x|)>+y\<Rightarrow\>x+h=y\<in\>U\<Rightarrow\>h\<in\>U<rsub|x>>.
    Also <math|h\<in\>U-x\<Rightarrow\>\<exists\>y\<in\>U\<vdash\>h=y-x\<Rightarrow\>x+h=y\<in\>U\<Rightarrow\>h\<in\>U<rsub|x>>.
  </proof>
  ...
  differentiability for functions <math|f:U\<rightarrow\>V>. Later it will be
  proved that differentiability is a local property so that the choice of
  <math|U> or <math|V> is not unique.
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      so that <math|<around*|\<\|\|\>|f<around*|(|x+h<rprime|'>|)>-f<around*|(|x|)>-L<rsub|i><around*|(|h<rprime|'>|)>|\<\|\|\>><rsub|Y>\<leqslant\><frac|\<varepsilon\>|2>\<cdot\><around*|\<\|\|\>|h<rprime|'>|\<\|\|\>>\<Rightarrow\><around*|\<\|\|\>|L<rsub|2><around*|(|h<rprime|'>|)>-L<rsub|1><around*|(|h<rprime|'>|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|f<around*|(|x+h<rprime|'>|)>-f<around*|(|x|)>-L<rsub|1><around*|(|h<rprime|'>|)>-<around*|(|f<around*|(|x+h<rprime|'>|)>-f<around*|(|x|)>-L<rsub|2><around*|(|h<rprime|'>|)>|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|f<around*|(|x+h<rprime|'>|)>-f<around*|(|x|)>-L<rsub|1><around*|(|h<rprime|'>|)>|\<\|\|\>><rsub|Y>+<around*|\<\|\|\>|f<around*|(|x+h<rprime|'>|)>-f<around*|(|x|)>-L<rsub|2><around*|(|h<rprime|'>|)>|\<\|\|\>><rsub|Y>\<leqslant\><frac|\<varepsilon\>|2>\<cdot\><around*|\<\|\|\>|h<rprime|'>|\<\|\|\>><rsub|X>+<frac|\<varepsilon\>|2>\<cdot\><around*|\<\|\|\>|h<rprime|'>|\<\|\|\>><rsub|X>=\<varepsilon\>\<cdot\><around*|\<\|\|\>|h<rprime|'>|\<\|\|\>><rsub|X>>
      proving\ 

      <\equation>
        <label|eq 13.1.313><around*|\<\|\|\>|L<rsub|2><around*|(|h<rprime|'>|)>-L<rsub|2><around*|(|h<rprime|'>|)>|\<\|\|\>><rsub|Y>\<leqslant\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>
      </equation>

      Further <math|<frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>><around*|\<\|\|\>|L<rsub|2><around*|(|h|)>-L<rsub|1><around*|(|h|)>|\<\|\|\>><rsub|Y>\<equallim\><rsub|<frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>\<gtr\>0\<wedge\>L<rsub|1>,L<rsub|2>
      are linear><around*|\<\|\|\>|L<rsub|2><around*|(|<frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>h|)>-L<rsub|1><around*|(|<frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>h|)>|\<\|\|\>><rsub|Y>=<around*|\<\|\|\>|L<rsub|2><around*|(|h<rprime|'>|)>-L<rsub|1><around*|(|h<rprime|'>|)>|\<\|\|\>>\<leqslant\><rsub|<text|<reference|eq
      13.1.313>>>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h<rprime|'>|\<\|\|\>><rsub|X>=\<varepsilon\><around*|\<\|\|\>|<frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>h|\<\|\|\>><rsub|X>=<frac|\<delta\>|2\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<Rightarrowlim\><around*|\<\|\|\>|L<rsub|1><around*|(|h|)>-L<rsub|2><around*|(|h|)>|\<\|\|\>><rsub|1>\<leqslant\>\<varepsilon\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>this
      proves that given a <math|\<varepsilon\>\<gtr\>0> and <math|h\<in\>X>
      we have <math|<around*|\<\|\|\>|<around*|(|L<rsub|2>-L<rsub|1>|)><around*|(|h|)>|\<\|\|\>>=<around*|\<\|\|\>|L<rsub|2><around*|(|h|)>-L<rsub|1><around*|(|h|)>|\<\|\|\>><rsub|Y>\<leqslant\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>
      which means by linearity of <math|L<rsub|2>-L<rsub|1>> and
      <reference|the alternative definition of the norm of a continuous
      linear function> that given a <math|\<varepsilon\>\<gtr\>0> we have
      <math|<around*|\<\|\|\>|L<rsub|2>-L<rsub|1>|\<\|\|\>>\<leqslant\>\<varepsilon\>>.
      Using then a consequence of the Arhimedean property of the reals (see
      <reference|consequence of the Archimedean property (2)>) we have then
      that <math|<around*|\<\|\|\>|L<rsub|2>-L<rsub|1>|\<\|\|\>>=0> proving
      that <math|L<rsub|1>=L<rsub|2>>.
    </enumerate>
  </proof>

  Note that in the above proof we have used the continuity and linearity of
  <math|L<rsub|1>> and <math|L<rsub|2>>. The unique continuous linear
  aproximation of a function at a point is called the differential of the
  ...
  <math|x> is a essential a local property and is not dependend on <math|U>
  or <math|V> but just on the value of <math|f> near <math|x>.
...
<\references>
  <\collection>
    ...
    <associate|Ux is open|<tuple|13.3|413>>
    <associate|alternative definition of Ux|<tuple|13.2|413>>
    ...
    <associate|eq 13.1.313|<tuple|13.1|?>>
