...
<\body>
  ...
  <\proof>
    ...
    <math|x\<in\>U> with <math|D L<rsub|\|U><around*|(|x|)>=L> (where we have
    used the fact that <math|L> is continuous as
  ...
  <\theorem>
    ...
    open, <math|x\<in\>U>, a set <math|V\<subseteq\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>Y<rsub|i>>
    and <math|f:U\<rightarrow\>V> a function
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      that <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<leqslant\>\<delta\><rsub|i>\<Rightarrow\><around*|\<\|\|\>|f<rsub|i><around*|(|x+h|)>-f<rsub|i><around*|(|x|)>-D
  ...
  <\theorem>
    ...
    be two vector spaces based on <math|<around*|\<langle\>|\<bbb-K\>,<around*|\|||\|>|\<rangle\>>>
    (with the<space|1em>maximum norm), a open set
    <math|U\<subseteq\>\<bbb-K\><rsup|n>>, <math|x\<in\>U>, a open set
    <math|V\<subseteq\>\<bbb-K\><rsup|m>> and <math|f:U\<rightarrow\>V> a
  ...
  <\proof>
    ...
    As <math|f<rsub|j>:U\<subseteq\>\<bbb-K\><rsup|n>\<rightarrow\>\<pi\><rsub|j><around*|(|V|)>>
  ...
  <\theorem>
    ...
    and <math|L\<in\>L<around*|(|X<rsub|1>,X<rsub|2>;Y|)>> (a bilinear
  ...
  <\proof>
    ...
    <math|<around*|\<\|\|\>|h<rsub|2>|\<\|\|\>><rsub|2>\<leqslant\>1>, then
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|\<\|\|\>|L<around*|(|<around*|(|x<rsub|1>,x<rsub|2>|)>+<around*|(|h<rsub|1>,h<rsub|2>|)>|)>-L<around*|(|<around*|(|x,y|)>|)>-<around*|(|L<around*|(|x<rsub|1>,\<ast\>|)>+L<around*|(|*\<ast\>,x<rsub|2>|)>|)><around*|(|h<rsub|1>,h<rsub|2>|)>|\<\|\|\>><rsub|Y>>|<cell|=>|<cell|<around*|\<\|\|\>|L<around*|(|x<rsub|1>+h<rsub|1>,x<rsub|2>+h|)>-L<around*|(|x,y|)>-L<around*|(|x<rsub|1>,h<rsub|2>|)>-L<around*|(|h<rsub|1>,x<rsub|2>|)>|\<\|\|\>><rsub|Y>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|L<around*|(|x<rsub|1>,x<rsub|2>+h<rsub|2>|)>+L<around*|(|h<rsub|1>,x<rsub|2>+h<rsub|2>|)>-L<around*|(|x,y|)>-L<around*|(|x<rsub|1>,h<rsub|2>|)>-L<around*|(|h<rsub|1>,x<rsub|2>|)>|\<\|\|\>><rsub|Y>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|L<around*|(|x<rsub|1>,x<rsub|2>|)>+L<around*|(|x<rsub|1>,h<rsub|2>|)>+L<around*|(|h<rsub|1>,x<rsub|2>|)>+L<around*|(|h<rsub|1>,h<rsub|2>|)>-L<around*|(|x<rsub|1>,x<rsub|2>|)>-L<around*|(|x<rsub|1>,h<rsub|2>|)>-L<around*|(|h<rsub|1>,x<rsub|2>|)>|\<\|\|\>><rsub|Y>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|L<around*|(|h<rsub|1>,h<rsub|2>|)>|\<\|\|\>><rsub|Y>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|<around*|\<\|\|\>|L|\<\|\|\>>\<cdot\><around*|\<\|\|\>|h<rsub|1>|\<\|\|\>><rsub|1>\<cdot\><around*|\<\|\|\>|h<rsub|2>|\<\|\|\>><rsub|2>>>|<row|<cell|>|<cell|\<less\>>|<cell|<around*|\<\|\|\>|L|\<\|\|\>>\<cdot\><frac|\<varepsilon\>|<around*|\<\|\|\>|L|\<\|\|\>>+1>\<cdot\><around*|\<\|\|\>|h<rsub|2>|\<\|\|\>><rsub|2>>>|<row|<cell|>|<cell|\<less\>>|<cell|\<varepsilon\>\<cdot\><around*|\<\|\|\>|h<rsub|2>|\<\|\|\>><rsub|2>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|\<varepsilon\>\<cdot\><around*|\<\|\|\>|<around*|(|h<rsub|1>,h<rsub|2>|)>|\<\|\|\>>>>>>
    </eqnarray*>
