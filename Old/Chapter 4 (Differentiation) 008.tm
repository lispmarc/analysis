...
<\body>
  ...
  <\proof>
    ...
    then for <math|y\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\>|)>\<subseteq\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\><rsub|4>|)>\<Rightarrow\>y\<in\>U>,
  ...
  The next theorem shows that differentiation is independent of the choosen
  ...
  <\proof>
    ...
    with differential <math|D f<around*|(|x|)>> (using the norms
    <math|<around*|\<\|\|\>||\<\|\|\>><rsub|X<rsub|1>>,<around*|\<\|\|\>||\<\|\|\>><rsub|Y<rsub|1>>>)
    then given <math|\<varepsilon\>\<gtr\>0> there exists a
    <math|\<delta\><rprime|'>\<gtr\>0> such that
    <math|\<forall\>h\<in\>U<rsub|x>> with
    <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|1>>\<less\>\<delta\><rprime|'>>
    we have <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
    f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y<rsub|1>>\<leqslant\><around*|(|<frac|1|\<beta\><rsub|Y>\<cdot\>\<beta\><rsub|X>>\<cdot\>\<varepsilon\>|)>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X<rsub|1>>>.
    ...
    giving by the above that <math|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
  ...
  <\definition>
    ...
    by <math|t\<rightarrow\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><around*|(|t|)>=<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,t,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>\<equallim\><rsub|definition><choice|<tformat|<table|<row|<cell|x<rsub|j>
  ...
  <\proof>
    First using <reference|linearity of (01,...*,...0n)> we have that
    ...
    with <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|i>\<less\>1> we have
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        <math|\<alpha\>\<cdot\>f=C<rsub|U,0>> is differentiable with
  ...
  <\proof>
    ...
    <math|x\<in\>T\<subseteq\>U> open with
    <math|f<around*|(|T|)>\<subseteq\>W\<Rightarrow\>f<rsup|-1><around*|(|W|)>\<Rightarrow\>x\<in\>T\<subseteq\>U<big|cap>f<rsup|-1><around*|(|W|)>>,
    ...
    Thus by the above and <reference|eq 12.4> we have if
    <math|h\<in\>T<rsub|x>> that\ 
    ...
    <\eqnarray*>
      ...
      12.3>>>>|<cell|g<around*|(|f<around*|(|x+h|)>|)>-g<around*|(|f<around*|(|x|)>|)>-D
      g<around*|(|f<around*|(|x|)>|)><around*|(|\<varepsilon\><rsub|f><around*|(|h|)>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>+D
      f<around*|(|x|)><around*|(|h|)>|)>>>|<row|<cell|>|<cell|\<Rightarrow\>>|<cell|>>>>
    </eqnarray*>

    <\eqnarray*>
      <tformat|<table|<row|<cell|g<around*|(|f<around*|(|x+h|)>|)>-g<around*|(|f<around*|(|x|)>|)>-D
      g<around*|(|f<around*|(|x|)>|)><around*|(|D
      f<around*|(|x|)><around*|(|h|)>|)>>|<cell|=>|<cell|\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>\<cdot\><around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>+D
      g<around*|(|f<around*|(|x|)>|)><around*|(|\<varepsilon\><rsub|f><around*|(|h|)>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>|)>>>|<row|<cell|>|<cell|\<Rightarrow\>>|<cell|>>>>
    </eqnarray*>
    ...
    <\equation>
      ...
      then <around*|\<\|\|\>|\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>|\<\|\|\>><rsub|Z>\<cdot\><frac|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>\<leqslant\><around*|\<\|\|\>|\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>|\<\|\|\>><rsub|Z>\<cdot\><around*|(|1+<around*|\<\|\|\>|D
      f<around*|(|x|)>|\<\|\|\>>|)>
    </equation>
    ...
    12.9\<longminus\>1>>><around*|\<\|\|\>|\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>|\<\|\|\>><rsub|Z>\<less\><frac|\<varepsilon\>|2\<cdot\><around*|(|1+<around*|\<\|\|\>|D
    f<around*|(|x|)>|\<\|\|\>>|)>>> and thus using <reference|eq 12.8> we
    have
  ...
  <\proof>
    ...
    theorem with <math|W=V>, <math|V=X,S=T> \ we have then that
    <math|g\<circ\>f:U\<rightarrow\>Z> is differentiable at <math|x\<in\>U>
  ...
  <\theorem>
    ...
    [so that <math|D f<rsup|><around*|(|x|)><around*|(|t|)>=D
  ...
  <\definition>
    ...
    <math|h\<in\><around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)><rsup|-1><around*|(|U|)>>
