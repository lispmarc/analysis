...
<\body>
  ...
  <\proposition>
    ...
    <\enumerate>
      ...
      <item>Let <math|A,B\<in\>\<cal-A\>> such that
      <math|\<mu\><around*|(|B|)>\<less\>\<mu\><around*|(|A|)>> then
      <math|0\<less\>\<mu\><around*|(|A\\B|)>>
    </enumerate>
  </proposition>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <item>As <math|\<mu\><around*|(|B|)>\<less\>\<mu\><around*|(|A|)>> we
      have that <math|\<mu\><around*|(|A<big|cap>B|)>\<less\>\<mu\><around*|(|A|)>\<leqslant\>\<infty\>>
      so that also <math|\<mu\><around*|(|A<big|cap>B|)>\<less\>\<infty\>>.
      Further as <math|A=<around*|(|A\\B|)><big|sqcup><around*|(|A<big|cap>B|)>>
      we have <math|\<mu\><around*|(|A\\B|)>+\<mu\><around*|(|A<big|cap>B|)>=\<mu\><around*|(|A|)>\<gtr\>\<mu\><around*|(|A<big|cap>B|)>>
      and as <math|\<mu\><around*|(|A<big|cap>B|)>\<less\>\<infty\>> it
      follows that <math|0\<less\>\<mu\><around*|(|A\\B|)>>
    </enumerate>
  </proof>
  ...
  <\proposition>
    ...
    <\enumerate>
      ...
      <item>Let <math|A,B\<subseteq\>X> such that <math|A<big|cup>B> is
      <math|\<mu\>>-conegligible and <math|B> is <math|\<mu\>>-negligible
      then <math|A> is <math|\<mu\>>-conegligible.
    </enumerate>
  </proposition>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <item>If <math|x\<in\><around*|(|A<big|cup>B|)>\\<around*|(|B\\A|)>>
      then <math|x\<nin\>B\\A> and either (not exclusive)\ 

      <\description>
        <item*|<math|x\<in\>A>>so that trivially \ <math|x\<in\>A>

        <item*|<math|x\<in\>B>>then if <math|x\<nin\>A> we have
        <math|x\<in\>B\\A> contradicting <math|x\<nin\>B\\A> so we must have
        that <math|x\<in\>A>
      </description>
      ...
      <\equation*>
        <around*|(|A<big|cup>B|)>\\<around*|(|B\\A|)>\<subseteq\>A
      </equation*>

      Further if <math|x\<in\>A> then <math|x\<in\>A<big|cup>B> and
      <math|x\<nin\>B\\A> so that <math|x\<in\><around*|(|A<big|cup>B|)>\\<around*|(|B\\A|)>>
      which by the above proves that\ 

      <\equation*>
        A=<around*|(|A<big|cup>B|)>\\<around*|(|B\\A|)>
      </equation*>

      As <math|B> is <math|\<mu\>>-negligible we have as
      <math|B\\A\<subseteq\>B> that by <smart-ref|negligible sets properties>
      (2) <math|B\\A> is <math|\<mu\>>-negligible so using (6) it follows
      that <math|A> is <math|\<mu\>>-conegligible.
    </enumerate>
  ...
  <\notation>
    ...
    To avoid extra notation we omit the <math|\<mu\>> if it is clear from the
    context what the measure involved is. So then we say that
  ...
  <\proposition>
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        <\enumerate>
          <item>If <math|a\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f> then
          <math|<around*|(|-f|)>\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>-a>

          <item>If <math|f\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>a> then
          <math|-a\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>><around*|(|-f|)>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        <\enumerate>
          <item>As <math|a\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f> we
          have that <math|E=<around*|{|x\<in\>dom<around*|(|f|)>\|a\<leqslant\>f<around*|(|x|)>|}>>
          is conegligible. Now as\ 

          <\eqnarray*>
            <tformat|<table|<row|<cell|x\<in\>E>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|f|)>\<wedge\>a\<leqslant\>f<around*|(|x|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|f|)>\<wedge\>-f<around*|(|x|)>\<leqslant\>-a>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|{|dom<around*|(|f|)>\|-f<around*|(|x|)>\<leqslant\>-a|}>>>>>
          </eqnarray*>

          proving that <math|<around*|{|dom<around*|(|f|)>\|-f<around*|(|x|)>\<leqslant\>-a|}>>
          is <math|\<mu\>>-conegligible and thus that
          <math|-f\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>-a>

          <item>If <math|f\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>a> then
          <math|-<around*|(|-f|)>\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>-<around*|(|-a|)>>
          so by (3.b.i) we have <math|-a\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>-f>

          <item>As <math|a=<rsub|a.e.<around*|[|\<mu\>|]>>f> we have that
          <math|E=<around*|{|x\<in\>dom<around*|(|f|)>\|a=f<around*|(|x|)>|}>>
  ...
  <subsubsection|Borel algebra on <math|<wide|\<bbb-R\>|\<bar\>>>>
  ...
  <\theorem>
    <label|outer measure and volume>Let <math|n\<in\>\<bbb-N\>> then
    <math|\<varphi\><rsup|n>:\<cal-P\><around*|(|\<bbb-R\><rsup|n>|)>\<rightarrow\><around*|[|0,\<infty\>|]>>
    ...
    <\proof>
      ...
      <\enumerate>
        ...
        Take <math|n<rsub|x>=max<around*|(|<around*|{|n<rsub|i>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)>\<in\>\<bbb-N\>>
        then <math|x\<in\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|-n<rsub|x>,n<rsub|x>|[>>.
        Hence if we take <math|<around*|{|R<rsub|j>|}><rsub|j\<in\>\<bbb-N\>>>
        by <math|R<rsub|j>=<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|-j,j|[>\<subseteq\>\<cal-R\><rsup|n>>
        we have\ 

        <\equation*>
          \<bbb-R\><rsup|n>\<subseteq\><big|cup><rsub|j\<in\>\<bbb-N\>>R<rsub|j>
        </equation*>
  ...
  <\definition>
    ...
    <math|\<varphi\><rsup|n><around*|(|A|)>=inf<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|R<rsub|i>|)>\|<around*|{|R<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-R\><rsup|n>
    ...
    defined by <math|\<lambda\><rsup|n>=<around*|(|\<varphi\><rsup|n>|)><rsub|\|\<cal-L\><rsup|n>>>
  ...
  <\definition>
    ...
    <\enumerate>
      <item>Let <math|f:X\<rightarrow\>\<bbb-R\>> a partial function and
      <math|C\<subseteq\>X> then <math|f<rsub|\|C>:X\<rightarrow\>\<bbb-R\>>
      is the partial function with <math|dom<around*|(|f<rsub|\|C>|)>=dom<around*|(|f|)><big|cap>C>
      and <math|\<forall\>x\<in\>dom<around*|(|f<rsub|\|C>|)>> we have
      <math|<around*|(|f<rsub|\|C>|)><around*|(|x|)>=f<around*|(|x|)>> [see
      <smart-ref|restricted partial function>]

      <item>Let <math|f:X\<rightarrow\>\<bbb-R\>> be a partial function then
      <math|<around*|\||f|\|>:X\<rightarrow\>\<bbb-R\>> is the partial
      function with <math|dom<around*|(|<around*|\||f|\|>|)>=dom<around*|(|f|)>>
      and <math|\<forall\>x\<in\>dom<around*|(|<around*|\||f|\|>|)>>
  ...
  <\proposition>
    <label|absolute value of a restriction>Let <math|X> be a set,
    <math|C\<subseteq\>X> and <math|f:X\<rightarrow\>\<bbb-R\>> a partial
    function then <math|<around*|\||f<rsub|\|C>|\|>=<around*|\||f|\|><rsub|\|C>>
  </proposition>

  <\proof>
    First <math|dom<around*|(|<around*|\||f<rsub|\|C>|\|>|)>=dom<around*|(|f<rsub|\|C>|)>=C<big|cap>dom<around*|(|f|)>=C<big|cap>dom<around*|(|<around*|\||f|\|>|)>=dom<around*|(|<around*|\||f|\|><rsub|\|C>|)>>
    and <math|\<forall\>x\<in\>dom<around*|(|f<rsub|\|C>|)>> we have
    <math|<around*|(|<around*|\||f|\|><rsub|\|C>|)><around*|(|x|)>=<around*|\||f|\|><around*|(|x|)>=<around*|\||f<around*|(|x|)>|\|>=<around*|\||<around*|(|f<rsub|\|C>|)><around*|(|x|)>|\|>=<around*|\||f<rsub|\|C>|\|><around*|(|x|)>>
  </proof>
  ...
  <\lemma>
    ...
    be a measurable space and <math|<around*|{|f<rsub|n>:X\<rightarrow\>\<bbb-R\>|}><rsub|n\<in\>\<bbb-N\>>\<subseteq\>\<cal-S\><around*|[|X,\<cal-A\>|]>>
  ...
  <\proposition>
    ...
    sequence of non negative simple functions] and
    <math|f=<rsub|a.e.><below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>> we have
  ...
  <\proposition>
    ...
    <\enumerate>
      ...
      <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> and
      <math|<big|int>f d\<mu\>=<big|int><rsup|S>f d\<mu\>>
    </enumerate>
  </proposition>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>. Further

      <\eqnarray*>
        <tformat|<table|<row|<cell|<big|int>f
        d\<mu\>>|<cell|=>|<cell|<big|int><rsup|+>f<rsub|1>d\<mu\>-<big|int><rsup|+>f<rsub|2>
        d\<mu\>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<smart-ref|integral
        of simple function extension>>>>|<cell|<big|int><rsup|S>f<rsub|1>d\<mu\>-<big|int><rsup|S>f<rsub|2>d\<mu\>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|n>\<beta\><rsub|i>\<cdot\>\<mu\><around*|(|A<rsub|i>|)>-<big|sum><rsub|i=1><rsup|n>\<gamma\><rsub|i>\<cdot\>\<mu\><around*|(|A<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|n><around*|(|\<beta\><rsub|i>-\<gamma\><rsub|i>|)>\<cdot\>\<mu\><around*|(|A<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<mu\><around*|(|A<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|int><rsup|S>f
        d\<mu\>>>>>
      </eqnarray*>
    </enumerate>
  </proof>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <math|c\<cdot\>f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> and
      ...
      <item><math|\<forall\>f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
      with <math|f\<leqslant\><rsub|a.e.>0> we have <math|<big|int>f
      d\<mu\>\<leqslant\>0>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <item>As <math|f\<leqslant\><rsub|a.e.>0> we have that
      <math|<around*|{|x\<in\>dom<around*|(|f|)>\|f<around*|(|x|)>\<leqslant\>0|}>>
      is <math|\<mu\>>-conegligible. Now as
      <math|f<around*|(|x|)>\<leqslant\>0\<Leftrightarrow\>0\<leqslant\><around*|(|-f<around*|(|x|)>|)>>
      we have that <math|<around*|{|x\<in\>dom<around*|(|f|)>\|0\<leqslant\><around*|(|-f|)><around*|(|x|)>|}>=<around*|{|x\<in\>dom<around*|(|f|)>\|f<around*|(|x|)>\<leqslant\>0|}>>
      proving that <math|0\<leqslant\><big|int><around*|(|-f|)>d\<mu\>\<equallim\><rsub|<around*|(|2|)>>-<big|int>f
      d\<mu\>> from which it follows that <math|<big|int>f
      d\<mu\>\<leqslant\>0>.<space|1em>\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\><around*|{|f|}>>|<cell|>|<cell|>>>>
      </eqnarray*>
  ...
  <\corollary>
    ...
    <\enumerate>
      ...
      <item>If <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>,
      \ <math|0\<leqslant\><rsub|a.e.>f> and <math|<big|int>f
      d\<mu\>\<leqslant\>0> then <math|f=<rsub|a.e.>0>

      <item>If <math|f\<in\><around*|[|X,\<cal-A\>,\<mu\>|]>>,
      <math|f\<leqslant\><rsub|a.e.>0> and <math|0\<leqslant\><big|int>f
      d\<mu\>> then <math|f=<rsub|a.e.>0>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <item>Given <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> we
      have using <smart-ref|measure integral properties (1)> (2) that
      <math|-f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>. Further as
      <math|f\<leqslant\><rsub|a.e.>0> we have that
      <math|<around*|{|x\<in\>dom<around*|(|f|)>\|f<around*|(|x|)>\<leqslant\>0|}>>
      is <math|\<mu\>>-conegligible. Now we have\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\><around*|{|x\<in\>dom<around*|(|f|)>\|f<around*|(|x|)>\<leqslant\>0|}>>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|f|)>\<wedge\>f*<around*|(|x|)>\<leqslant\>0>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|dom<around*|(|f|)>=dom<around*|(|-f|)>>>|<cell|x\<in\>dom<around*|(|-f|)>\<wedge\>0\<leqslant\><around*|(|-f|)><around*|(|x|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|{|x\<in\>dom<around*|(|-f|)>\|0\<leqslant\><around*|(|-f|)><around*|(|x|)>|}>>>>>
      </eqnarray*>

      proving that <math|><math|<around*|{|x\<in\>dom<around*|(|-f|)>\|0\<leqslant\><around*|(|-f|)><around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible. Hence

      <\equation>
        <label|eq 18.282.012><around*|(|-f|)>\<leqslant\><rsub|a.e.>0
      </equation>

      Further <math|<big|int><around*|(|-f|)>d\<mu\>\<equallim\><rsub|<text|<smart-ref|measure
      integral properties (1)> (2)>>-<big|int>f d\<mu\>\<leqslant\>0> [as by
      assumption <math|0\<leqslant\><big|int>f d\<mu\>>]. We can now use (3)
      proving that <math|<around*|(|-f|)>=<rsub|a.e.>0> so that
      <math|<around*|{|x\<in\>dom<around*|(|-f|)>\|<around*|(|-f|)><around*|(|x|)>=0|}>>
      is <math|\<mu\>>-conegligible. As we have\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\><around*|{|x\<in\>dom<around*|(|-f|)>\|<around*|(|-f|)><around*|(|x|)>=0|}>>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|-f|)>\<wedge\>-f<around*|(|x|)>=0>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|dom<around*|(|f|)>=dom<around*|(|-f|)>>>|<cell|x\<in\>dom<around*|(|f|)>\<wedge\>f<around*|(|x|)>=0>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|{|x\<in\>dom<around*|(|f|)>\|f<around*|(|x|)>=0|}>>>>>
      </eqnarray*>

      it follows that <math|><math|<around*|{|x\<in\>dom<around*|(|f|)>\|f<around*|(|x|)>=0|}>>
      is <math|\<mu\>>-conegligible. So\ 
  ...
  Up to now we have assumed that <math|f<around*|(|X|)>\<subseteq\>\<bbb-R\>>
  [or <math|f> is finite] we can easely extend our definition of the measure
  integral to the inifinite case as follows.

  <\definition>
    Let <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a
    measure space and <math|f:X\<rightarrow\><wide|\<bbb-R\>|\<bar\>>> then
    <math|f\<in\><wide|\<cal-L\>|\<bar\>><around*|[|X,\<cal-A\>,\<mu\>|]>> if
    and only if <math|<wide|f|\<bar\>>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
    where <math|<wide|f|\<bar\>>:X\<rightarrow\>\<bbb-R\>> is the partial
    defined by <math|<wide|f|\<bar\>>=f<rsub|\|<around*|{|x\<in\>dom<around*|(|f|)>\|f<around*|(|x|)>\<in\>Rr|}>>>
    do <math|dom<around*|(|<wide|f|\<bar\>>|)>=<around*|{|x\<in\>dom<around*|(|f|)>\|f<around*|(|x|)>\<in\>\<bbb-R\>|}>>.
    If <math|<wide|f|\<bar\>>\<in\><wide|\<cal-L\>|\<bar\>><around*|[|X,\<cal-A\>,\<mu\>|]>>
    then <math|<wide|<big|int>|\<bar\>>f d\<mu\>=<big|int><wide|f|\<bar\>>d\<mu\>>
  </definition>

  <\remark>
    <label|integrable infinite functions have a conegligible domain>Let
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> and
    <math|f\<in\><wide|\<cal-L\>|\<bar\>><around*|[|X,\<cal-A\>,\<mu\>|]>>
    then <math|dom<around*|(|f|)>> is <math|\<mu\>>-conegligible\ 
  </remark>

  <\proof>
    By definition we have <math|<wide|f|\<bar\>>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
    so that by <smart-ref|domain of integrable functions are conegligible>
    <math|dom<around*|(|<wide|f|\<bar\>>|)>> is <math|\<mu\>>-conegligible
    which as <math|dom<around*|(|<wide|f|\<bar\>>|)>\<subseteq\>dom<around*|(|f|)>>
    proves by <smart-ref|conegligible sets properties> that
    <math|dom<around*|(|f|)>> is <math|\<mu\>>-conegligible.\ 
  </proof>

  <section|Integration over sub-spaces>
  ...
  As we have to deal with negligible sets, conegligible sets and measurable
  ...
  <\lemma>
    ...
    <\enumerate>
      ...
      <item>If <math|H\<subseteq\>X> is <math|\<mu\>>-conegligible then
  ...
  <\lemma>
    <label|a\<less\>=a.e.f=\<gtr\>a\<less\>=a.e.f\|E>Let
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
    space, <math|E\<in\>\<cal-A\>> then we have\ 

    <\enumerate>
      <item>If <math|f:X\<rightarrow\>\<bbb-R\>> is a partial function then
      <math|\<forall\>a\<in\>\<bbb-R\>> we have if
      <math|a\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f> then
      <math|a\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f<rsub|\|E>>

      <item><math|>If <math|f,g:X\<rightarrow\>\<bbb-R\>> are partial
      functions such that <math|f\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>g>
      then <math|f<rsub|\|E>\<leqslant\>g<rsub|\|E>>

      <item>If <math|f,g:X\<rightarrow\>\<bbb-R\>> are partial functions such
      that <math|f=<rsub|a.e.<around*|[|\<mu\>|]>>g> then
      <math|f<rsub|\|E>=g<rsub|\|E>>
    </enumerate>
  </lemma>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>As <math|a\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f> we have
      that <math|<around*|{|a\<leqslant\>f|}>> is <math|\<mu\>>-conegligible,
      hence <math|<around*|{|a\<leqslant\>f|}><big|cap>E> is by the previous
      lemma [see <smart-ref|conegligible of subspace>]
      <math|\<mu\><rsub|E>>-conegligible. Further we have\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\><around*|{|a\<leqslant\>f|}><big|cap>E>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|f|)><big|cap>E\<wedge\>a\<leqslant\>f<around*|(|x|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|f|)><big|cap>E\<wedge\>a\<leqslant\>f<rsub|<around*|\||E|\<nobracket\>>><around*|(|x|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|f<rsub|<around*|\||E|\<nobracket\>>>|)>\<wedge\>a\<leqslant\>f<rsub|\|E><around*|(|x|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|{|a\<leqslant\>f<rsub|\|E>|}>>>>>
      </eqnarray*>

      proving that <math|<around*|{|a\<leqslant\>f<rsub|\|E>|}>> is
      <math|\<mu\><rsub|E>>-conegligible. Hence
      <math|a\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f>

      <item>As <math|f\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>g> we have
      that <math|<around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|f<around*|(|x|)>\<leqslant\>g<around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible. Using the previous lemma [see
      <smart-ref|conegligible of subspace>] it follows then that
      <math|<around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|f<around*|(|x|)>\<leqslant\>g<around*|(|x|)>|}><big|cap>E>
      is <math|\<mu\><rsub|E>>-conegligible. Further we have\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\><around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|f<around*|(|x|)>\<leqslant\>g<around*|(|x|)>|}><big|cap>E>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)><big|cap>E\<wedge\>f<around*|(|x|)>\<leqslant\>g<around*|(|x|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)><big|cap>E\<wedge\>f<rsub|\|E><around*|(|x|)>\<leqslant\>g<rsub|\|E><around*|(|x|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|f<rsub|\|E>|)><big|cap>dom<around*|(|g<rsub|\|E>|)>\<wedge\>f<rsub|\|E><around*|(|x|)>\<leqslant\>g<rsub|\|E><around*|(|x|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|{|x\<in\>dom<around*|(|f<rsub|\|E>|)><big|cap>dom<around*|(|g<rsub|\|E>|)>\|f<rsub|\|E><around*|(|x|)>\<leqslant\>g<rsub|\|E><around*|(|x|)>|}>>>>>
      </eqnarray*>

      proving that <math|><math|<around*|{|x\<in\>dom<around*|(|f<rsub|\|E>|)><big|cap>dom<around*|(|g<rsub|\|E>|)>\|f<rsub|\|E><around*|(|x|)>\<leqslant\>g<rsub|\|E><around*|(|x|)>|}>>
      is <math|\<mu\><rsub|E>>-conegligible. Hence
      <math|f<rsub|\|E>\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>g<rsub|\|E>>.

      <item>As <math|f=<rsub|a.e.<around*|[|\<mu\>|]>>g> we have by
      <smart-ref|operations on a.e.> that
      <math|f\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>g> and
      <math|g\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f> hence using (2) we
      have <math|f<rsub|\|E>\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>g<rsub|\|E>>
      and <math|g<rsub|\|E>\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f<rsub|\|E>>.
      Applying <smart-ref|operations on a.e.> again proves
      <math|f<rsub|\|E>=<rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>g<rsub|\|E>>
    </enumerate>
  </proof>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|<around*|(|X\\E|)><big|cup>F> is <math|\<mu\>>-conegligible it
      follows that\ 
      ...
      Using <smart-ref|operations on a.e.> again proves that
      <math|g=<rsub|a.e.<around*|[|\<mu\>|]>>f>.
    </enumerate>
  </proof>

  In this section we are dealing with partial functions on a subset of a
  given set, this apply also to characteristics functions [see
  <smart-ref|characteristics function>]. So we need a notation to specify the
  set where the characteristics function is defined on.

  <\notation>
    <label|characteristics function on a subset>Let <math|X> be a set and
    <math|E\<subseteq\>X> then for every <math|A\<subseteq\>A> we note the
    characteristics <with|font-series|bold|function> defined by <math|A> on
    <math|E> by <math|\<cal-X\><rsub|E,A>>. So
    <math|\<cal-X\><rsub|E,A>:X\<rightarrow\>\<bbb-R\>> is defined by
    <math|\<cal-X\><rsub|E,A>=<choice|<tformat|<table|<row|<cell|1 if
    x\<in\>A>>|<row|<cell|0 if x\<in\>E\\A>>>>>>
  </notation>

  <\lemma>
    <label|characteristics function on a set>Let <math|X> be a set,
    <math|E\<subseteq\>X> and <math|f:E\<rightarrow\>\<bbb-R\>> the
    <with|font-series|bold|function> defined by
    <math|f=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|E,A<rsub|i>>>
    where <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
    <math|A<rsub|i>\<subseteq\>E> then <math|f<rsup|E>:X\<rightarrow\>\<bbb-R\>>
    is the <with|font-series|bold|function> defined by
    <math|f<rsup|E>=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>>>
  </lemma>

  <\proof>
    First take <math|A\<subseteq\>E> then <math|\<forall\>x\<in\>E> we have
    either\ 

    <\description>
      <item*|<math|x\<in\>E\\A>>then <math|\<cal-X\><rsub|E,A><around*|(|x|)>=0=\<cal-X\><rsub|A><around*|(|x|)>>

      <item*|<math|x\<in\>A>>then <math|\<cal-X\><rsub|E,A><around*|(|x|)>=1=\<cal-X\><rsub|A><around*|(|x|)>>
    </description>

    proving that\ 

    <\equation>
      <label|eq 18.339.010>\<forall\>A\<subseteq\>E we have
      \<forall\>x\<in\>E that \<cal-X\><rsub|E,A><around*|(|x|)>=\<cal-X\><rsub|A><around*|(|x|)>
    </equation>

    Second as <math|dom<around*|(|f|)>=E> we have that
    <math|dom<around*|(|f<rsup|E>|)>=dom<around*|(|f|)><big|cup><around*|(|X\\E|)>=E<big|cup><around*|(|X\\E|)>=X>
    so that <math|f<rsup|E>:X\<rightarrow\>\<bbb-R\>> is a function. Further
    if <math|x\<in\>X> then we have either\ 

    <\description>
      <item*|<math|x\<in\>X\\E>>then <math|f<rsup|E><around*|(|x|)>=0> and as
      <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
      <math|A<rsub|i>\<subseteq\>E> it follows that
      <math|x\<in\>X\\A<rsub|i>>. Hence <math|<around*|(|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>>|)><around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>=0=f<rsup|E><around*|(|x|)>>

      <item*|<math|x\<in\>E=dom<around*|(|f|)>>>the we have
      <math|<around*|(|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>>|)><around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>\<equallim\><rsub|<text|<smart-ref|eq
      18.339.010>>><big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|E,A<rsub|i>><around*|(|x|)>=f<around*|(|x|)>=f<rsup|E><rsub|><around*|(|x|)>>
    </description>

    proving that\ 

    <\equation*>
      f<rsup|E>=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>>
    </equation*>
  </proof>
  ...
  <\lemma>
    ...
    [see <smart-ref|measure integral extension>] we have <math|<big|int>f
  ...
  <\proof>
    ...
    Let <math|i\<in\><around*|{|1,\<ldots\>,n|}>> then by <smart-ref|subspace
    ...
    <\eqnarray*>
      ...
      based on a measurable set>>>>|<cell|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<mu\><rsub|\|\<cal-A\><rsub|E>><around*|(|A<rsub|i>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>A<rsub|i>\<in\>\<cal-A\><rsub|E>>>|<cell|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<mu\><around*|(|A<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|int><rsup|S>f<rsup|E>
      d\<mu\>>>>>
    </eqnarray*>
  </proof>
  ...
  <\lemma>
    ...
    [so using <smart-ref|measure integral extension> we have <math|<big|int>f
    d\<mu\><rsub|E>=<big|int>f<rsup|E>d\<mu\>>]
  </lemma>
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 18.339.009.1>\<forall\>n\<in\>\<bbb-N\>\<vDash\>0\<leqslant\>f<rsub|n>\<leqslant\>f<rsub|n+1>,f=<rsub|a.e.<around*|[|\<mu\><rsub|E>|]>><below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><infix-and>sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\><rsub|E>\|n\<in\>\<bbb-N\>|}>|)>\<less\>\<infty\>
    </equation>
    ...
    <\equation>
      <label|eq 18.340.009>sup<around*|(|<around*|{|<big|int><rsup|S><around*|(|f<rsub|n>|)><rsup|E>d\<mu\><rsub|E>\|n\<in\>\<bbb-N\>|}>|)>=sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)>\<less\>\<infty\>
    </equation>

    Further as <math|\<forall\>n\<in\>\<bbb-N\>>,<math|\<forall\>x\<in\>X> we
    have <math|0\<leqslant\><choice|<tformat|<table|<row|<cell|0 if
    ...
    <\description>
      ...
      have <math|<around*|(|f<rsub|n>|)><rsup|E><around*|(|x|)>=0> such that
      <math|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsup|E><around*|(|x|)>>
      exists and is equal to <math|0>. So
      <math|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsup|E><around*|(|x|)>=0=<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><rsup|E><around*|(|x|)>>
    ...
    <\description>
      ...
      exists proving that <math|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)>\<subseteq\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><big|cup><around*|(|X\\E|)>>
    </description>

    which proves that <math|><math|dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsup|E>|)>\<subseteq\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><big|cup><around*|(|X\\E|)>>.
    ...
    finally applying <smart-ref|eq 18.343.009> proves
    ...
    As <math|f=<rsub|a.e.<around*|[|\<mu\><rsub|E>|]>><below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>>
    ...
    alternative> giving <math|<big|int><rsup|+>f<rsup|E>d\<mu\>=sup<around*|(|<around*|{|<big|int><rsup|S><around*|(|f<rsub|n>|)><rsup|E>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)>\<equallim\><rsub|<smart-ref|eq
    18.340.009>><rsub|>sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\><rsub|E>\|n\<in\>\<bbb-N\>|}>|)>\<equallim\><rsub|<text|<smart-ref|integral
    of positive integrable function alternative>>><big|int><rsup|+>f
    d\<mu\><rsub|E>> proving that\ 
  ...
  <\proposition>
    <label|extension of integrable functions>Let
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
  ...
  <\proof>
    ...
    Then by definition we have as <math|<around*|(|f<rsub|1>|)><rsup|E>,<around*|(|f<rsub|2>|)><rsup|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
    that
    ...
    For the opposite implication. Let <math|f<rsup|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>.
    ...
    <\equation>
      ...
      \<mu\><text|-conegligible>,G\<subseteq\>dom<around*|(|f<rsup|E>|)><infix-and><around*|(|f<rsup|E>|)><rsub|\|G>
      is \<cal-A\><text|-measurable>
    </equation>

    Using <smart-ref|conegligible of subspace>(2) we have that
    <math|G<big|cap>E> is <math|\<mu\><rsub|E>>-conegligible. Further
    <math|G<big|cap>E\<subseteq\>dom<around*|(|f<rsup|E>|)><big|cap>E=<around*|(|dom<around*|(|f|)><big|cup><around*|(|X\\E|)>|)><big|cap>E=dom<around*|(|f|)><big|cap>E\<equallim\><rsub|dom<around*|(|f|)>\<subseteq\>E>dom<around*|(|f|)>=dom<around*|(|<around*|\||f|\|>|)>>.
    So we have\ 

    <\equation>
      <label|eq 18.352.009>E<big|cap>G is
      \<mu\><rsub|E><text|-conegligible>,E<big|cap>G\<subseteq\>dom<around*|(|f|)>=dom<around*|(|<around*|\||f|\|>|)><infix-and>as
    ...
    and <math|a\<leqslant\><around*|(|f<rsup|E>|)><rsub|\|G><around*|(|x|)>=<around*|(|f<rsup|E>|)><around*|(|x|)>\<equallim\><rsub|x\<in\>dom<around*|(|f|)>>f<around*|(|x|)>\<equallim\><rsub|x\<in\>dom<around*|(|E<big|cap>G|)>>f<rsub|\|E<big|cap>G><around*|(|x|)>><space|1em>proving
    ...
    Hence <math|f<rsub|\|E<big|cap>G>> is <math|\<cal-A\><rsub|E>>-measurable
    and applying then <smart-ref|measurable function operations> (8) proves
    that <math|<around*|\||f<rsub|\|E<big|cap>G>|\|>> is
    <math|\<cal-A\><rsub|E>>-measurable. As
    <math|<around*|\||f<rsub|\|E<big|cap>G>|\|>\<equallim\><rsub|<text|<smart-ref|absolute
    value of a restriction>>><around*|\||f|\|><rsub|\|E<big|cap>G>> \ we have

    <\equation>
      <label|eq 18.353.009><around*|\||f|\|><rsub|\|E<big|cap>G> is
      \<cal-A\><rsub|E><text|-measurable>
    </equation>

    If <math|x\<in\><around*|{|a\<leqslant\><around*|\||f|\|><rsub|\|E<big|cap>G>|}>>
    then <math|x\<in\>dom<around*|(|<around*|\||f|\|><rsub|\|E<big|cap>G>|)>=dom<around*|(|<around*|\||f|\|>|)><big|cap>E<big|cap>G=dom<around*|(|f|)><big|cap>E<big|cap>G>
    and <math|a\<leqslant\><around*|(|<around*|\||f|\|><rsub|\|E<big|cap>G>|)><around*|(|x|)>=<around*|\||f<around*|(|x|)>|\|>\<equallim\><rsub|x\<in\>dom<around*|(|f|)>><around*|\||f<rsup|E><around*|(|x|)>|\|>>
    ...
    <math|\<forall\>a\<in\>\<bbb-R\>> <math|<around*|{|a\<leqslant\><around*|\||f|\|><rsub|\|E<big|cap>G>|}>\<in\>\<cal-A\><rsub|E>\<subseteq\>\<cal-A\>>
    ...
    <\equation>
      ...
      \<mu\><rsub|E><around*|(|<around*|{|\<varepsilon\>\<leqslant\><around*|\||f|\|><rsub|\|E<big|cap>G>|}>|)>=\<mu\><around*|(|<around*|{|\<varepsilon\>\<leqslant\><around*|\||f|\|><rsub|\|E<big|cap>G>|}>|)>\<leqslant\><rsub|<text|<smart-ref|eq
    ...
    So we have that <math|<big|int><rsup|S>g
    d\<mu\><rsub|E>\<equallim\><rsub|<text|<smart-ref|extension of simple
    function>>><big|int>g<rsup|E>d\<mu\>\<leqslant\><rsub|<text|<smart-ref|measure
    integral properties (1)> (4)>><big|int><around*|\||f<rsup|E>|\|>d\<mu\>>,
    as <math|g\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>> was chosen
    arbitrary we have then

    <\equation>
      <label|eq 18.356.009>sup<around*|(|<around*|{|<big|int><rsup|S>g
      d\<mu\><rsub|E>\|g\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>\<wedge\>g\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>><around*|\||f|\|>|}>|)>\<leqslant\><big|int><around*|\||f<rsup|E>|\|>d\<mu\>\<less\>\<infty\>
    </equation>
    ...
    with <smart-ref|eq 18.353.009> and <smart-ref|eq 18.352.009> \ proves
    that <math|f\<in\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>> so we
    have

    <\equation>
      <label|eq 18.357.009>If f<rsup|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>
      then f\<in\>\<cal-L\><around*|[|E,\<cal-A\>,\<mu\><rsub|E>|]>
    </equation>
  ...
  <\corollary>
    <label|integrability of integrable function restricted to a measurable
    set>Let <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a
    measure space, <math|E\<in\>\<cal-A\>> and
    <math|f:X\<rightarrow\>\<bbb-R\>> a partial function such that
    <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> then
    <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|\<cal-A\>,\<cal-A\><rsub|E>,\<mu\>|]>>.
  </corollary>

  <\proof>
    Then <math|dom<around*|(|f|)>> is <math|\<mu\>>-conegligible
    {<math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> together with
    <smart-ref|domain of integrable functions are conegligible>]. Consider
    <math|<around*|(|f<rsub|\|E>|)><rsup|E>> then
    <math|dom<around*|(|<around*|(|f<rsub|\|E>|)><rsup|E>|)>=<around*|(|X\\E|)><big|cup>dom<around*|(|f<rsub|\|E>|)>=<around*|(|X\\E|)><big|cup><around*|(|dom<around*|(|f|)><big|cap>E|)>=<around*|(|<around*|(|X\\E|)><big|cup>dom<around*|(|f|)>|)><big|cap><around*|(|<around*|(|X\\E|)><big|cup>E|)>=<around*|(|<around*|(|X\\E|)><big|cup>dom<around*|(|f|)>|)><big|cap>X=<around*|(|X\\E|)><big|cup>dom<around*|(|f|)>>
    which \ by <smart-ref|conegligible sets properties> (2) proves that
    <math|dom<around*|(|<around*|(|f<rsub|\|E>|)><rsup|E>|)>> is
    <math|\<mu\>>-conegligible. Further <math|\<forall\>x\<in\>dom<around*|(|f|)>>
    we have either\ 

    <\description>
      <item*|<math|x\<in\>dom<around*|(|f|)>\\E>>then <math|x\<in\>X\\E> so
      that <math|<around*|\||<around*|(|f<rsub|\|E>|)><rsup|E>|\|><around*|(|x|)>=0\<leqslant\><around*|\||f<around*|(|x|)>|\|>=<around*|\||f|\|><around*|(|x|)>>

      <item*|<math|x\<in\>dom<around*|(|f|)><big|cap>E=dom<around*|(|f<rsub|\|E>|)>>>then
      <math|<around*|\||<around*|(|f<rsub|\|E>|)><rsup|E>|\|><around*|(|x|)>=<around*|\||<around*|(|f<rsub|\|E>|)><rsup|E><around*|(|x|)>|\|>=<around*|\||f<rsub|\|E><around*|(|x|)>|\|>=<around*|\||f<around*|(|x|)>|\|>=<around*|\||f|\|><around*|(|x|)>>
    </description>

    so <math|\<forall\>x\<in\>dom<around*|(|f|)>> we have
    <math|<around*|\||<around*|(|f<rsub|\|E>|)><rsup|E>|\|><around*|(|x|)>\<leqslant\><around*|\||f|\|><around*|(|x|)>>
    so that <math|<around*|\||<around*|(|f<rsub|\|E>|)><rsup|E>|\|>\<leqslant\>a.e.<around*|[|\<mu\>|]><around*|\||f|\|>>.
    As <math|<around*|(|f<rsub|\|E>|)><rsub|\|>>
  </proof>

  We proceed now to prove that every integrable function is integrable in a
  subspace. First we prove this by positive integrable functions. We prove
  this in phases, first for simple functions, then positive integrable
  functions and finally integrable functions.

  <\lemma>
    <label|restriction of simple function to a a measurable set>Let
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
    space, <math|E\<in\>\<cal-A\>> and <math|f\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>>
    with representation <math|f=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>>>
    then <math|f<rsub|\|E>\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>>
    and has representation <math|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|E,A<rsub|i><big|cap>E>>.
    Further <math|<big|int><rsup|S>f<rsub|\|E>d\<mu\><rsub|E>\<leqslant\><big|int><rsup|S>f
    d\<mu\>>.
  </lemma>

  <\proof>
    Let <math|A\<in\>\<cal-A\>> then we have for <math|x\<in\>E> either\ 

    <\description>
      <item*|<math|x\<in\>E\\A>>then <math|<around*|(|\<cal-X\><rsub|A>|)><rsub|\|E><around*|(|x|)>\<equallim\><rsub|x\<in\>E>\<cal-X\><rsub|A><around*|(|x|)>\<equallim\><rsub|x\<nin\>A>0\<equallim\><rsub|x\<nin\>A<big|cap>E>\<cal-X\><rsub|E,A<big|cap>E><around*|(|x|)>>

      <item*|<math|x\<in\>A>>then <math|<around*|(|\<cal-X\><rsub|A>|)><rsub|\|E><around*|(|x|)>\<equallim\><rsub|x\<in\>E>\<cal-X\><rsub|A><around*|(|x|)>\<equallim\><rsub|x\<in\>A>1\<equallim\><rsub|x\<in\>A<big|cap>E>\<cal-X\><rsub|E,\<cal-A\><big|cap>E><around*|(|x|)><rsub|>>
    </description>

    proving that\ 

    <\equation>
      <label|eq 18.359.011>\<forall\>A\<in\>\<cal-A\> we have
      <around*|(|\<cal-X\><rsub|A>|)><rsub|\|E>=\<cal-X\><rsub|E,A<big|cap>E>
    </equation>

    Take now <math|f\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>> with
    representation <math|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>>>
    then <math|<around*|{|A<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\>\<cal-A\>>
    and <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
    <math|\<mu\><around*|(|A<rsub|i>|)>\<less\>\<infty\>>. So using
    <smart-ref|conegligible of subspace> we have that
    <math|<around*|{|A<rsub|i><big|cap>E|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\>\<cal-A\><rsub|E>>,
    also <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>> we have
    <math|\<mu\><rsub|E><around*|(|A<big|cap>E<rsub|i>|)>\<equallim\><rsub|<text|<smart-ref|subspace
    based on a measurable set>>>\<mu\><rsub|\|\<cal-A\><rsub|E>><around*|(|A<rsub|i>|)>=\<mu\><around*|(|A<rsub|i><big|cap>E|)>\<leqslant\>\<mu\><around*|(|A<rsub|i>|)>\<less\>\<infty\>>.
    Further for <math|x\<in\>E> we have <math|f<rsub|\|E><around*|(|x|)>=f<around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>\<equallim\><rsub|<text|<smart-ref|eq
    18.359.011>>><big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|E,A<rsub|i><big|cap>E><around*|(|x|)>>,
    proving that <math|f<rsub|\|E>> has the representation
    <math|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|E,A<rsub|i><big|cap>E>>
    which means that <math|f<rsub|\|E>\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>>.

    Finally we have that\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|<big|int><rsup|S>f<rsub|\|E>d\<mu\><rsub|E>>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<mu\><rsub|E><around*|(|A<rsub|i><big|cap>E|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<smart-ref|subspace
      based on a measurable set>>>>|<cell|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<mu\><around*|(|A<rsub|i><big|cap>E|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<smart-ref|measure
      space properties> (2)>>>|<cell|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<mu\><around*|(|A<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|int><rsup|S>f
      d\<mu\>>>>>
    </eqnarray*>
    ...
    <\equation*>
      <big|int><rsup|S>f<rsub|\|E>d\<mu\><rsub|E>\<leqslant\><big|int><rsup|S>f
      d\<mu\>
    </equation*>
  ...
  <\lemma>
    <label|restriction of a positive integrable function to a measurable
    subset>Let <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a
    measure space, <math|E\<in\>\<cal-A\>> and
    <math|f\<in\>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>> then
    <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
  </lemma>
  ...
  <\proof>
    Using the definition <math|\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>>
    [see <smart-ref|positive integrable functions definition>] we have\ 

    <\equation>
      <label|eq 18.360.011>0\<leqslant\>f\<wedge\>\<exists\><around*|{|f<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-S\><around*|[|X,\<cal-A\>|]>
      such that \<forall\>n\<in\>\<bbb-N\><space|1em>0\<leqslant\>f<rsub|n>\<leqslant\>f<rsub|n+1>,sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)>\<less\>\<infty\><infix-and>
      <below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>=<rsub|a.e.<around*|[|\<mu\>|]>>f
    </equation>

    Further <math|\<forall\>x\<in\>dom<around*|(|f<rsub|\|E>|)>=dom<around*|(|f|)><big|cap>E>
    we have <math|f<rsub|\|E><around*|(|x|)>=f<around*|(|x|)>\<in\><around*|[|0,\<infty\>|[>>
    proving that\ 

    <\equation>
      <label|eq 18.361.011>0\<leqslant\>f<rsub|\|E>
    </equation>

    Let <math|x\<in\>E> then <math|\<forall\>n\<in\>\<bbb-N\>> we have
    <math|0\<leqslant\>f<rsub|n><around*|(|x|)>=<around*|(|f<rsub|n>|)><rsub|\|E><around*|(|x|)>>
    and <math|<around*|(|f<rsub|n>|)><rsub|\|E><around*|(|x|)>=f<rsub|n><around*|(|x|)>\<leqslant\>f<rsub|n+1><around*|(|x|)>=<around*|(|f<rsub|n+1>|)><rsub|\|E><around*|(|x|)>>
    proving that\ 

    <\equation>
      <label|eq 18.362.011>\<forall\>n\<in\>\<bbb-N\> we have
      0\<leqslant\><around*|(|f<rsub|n>|)><rsub|\|E>\<leqslant\><around*|(|f<rsub|n+1>|)><rsub|\|E>
    </equation>

    Using the previous lemma (see <smart-ref|restriction of simple function
    to a a measurable set>) we have then\ 

    <\equation>
      <label|eq 18.363.011><around*|{|<around*|(|f<rsub|n>|)><rsub|\|E>|}><rsub|n\<in\>\<bbb-N\>>\<subseteq\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>
    </equation>

    Using <smart-ref|limit of simple functions> we have that
    <math|dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)>=<around*|{|x\<in\>X\|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>
    exists|}>>, further as <math|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>=<rsub|a.e.<around*|[|\<mu\>|]>>f>
    we have that <math|A=<around*|{|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><big|cap>dom<around*|(|f|)>\|f<around*|(|x|)>=<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>|}>>
    is <math|\<mu\>>-conegligible. Further\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><big|cap>E>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>X<big|cap>E\<wedge\><below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>
      exists >>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|x\<in\>E,E\<subseteq\>X>>|<cell|x\<in\>E\<wedge\><below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E><around*|(|x|)>
      exists>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|<text|<smart-ref|eq
      18.363.011> and <smart-ref|limit of simple functions>
      (1)>>>|<cell|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E>|)>>>>>
    </eqnarray*>

    proving that\ 

    <\equation>
      <label|eq 18.364.011>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><big|cap>E=dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E>|)>
    </equation>

    So\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|x\<in\>A<big|cap>E>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><big|cap>dom<around*|(|f|)><big|cap>E\<wedge\><below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>
      exists>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|<text|<smart-ref|eq
      18.364.011>>>>|<cell|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E>|)><big|cap>dom<around*|(|f<rsub|\|E>|)><big|cap>E\<wedge\><below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>
      exists>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|x\<in\>E>>|<cell|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E>|)><big|cap>dom<around*|(|f<rsub|\|E>|)>\<wedge\><below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E><around*|(|x|)>
      exists>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|{|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E>|)><big|cap>dom<around*|(|f<rsub|\|E>|)><below||>\|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E><around*|(|x|)>
      exists|\<nobracket\>>>>>>
    </eqnarray*>

    which proves that <math|<around*|{|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E>|)><big|cap>dom<around*|(|f<rsub|\|E>|)><below||>\|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E><around*|(|x|)>
    exists|}>=A<big|cap>E><math|> which is <math|\<mu\><rsub|E>>-conegligible
    [see <smart-ref|conegligible of subspace>] proving that\ 

    <\equation>
      <label|eq 18.365.011><below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E>=<rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f<rsub|\|E>
    </equation>

    Further as <math|\<forall\>I\<in\><around*|{|<big|int><rsup|S><around*|(|f<rsub|n>|)><rsub|\|E>d\<mu\><rsub|E>\|n\<in\>\<bbb-N\>|}>>
    we have <math|\<exists\>n\<in\>\<bbb-N\>> such that
    <math|I=<big|int><rsup|S><around*|(|f<rsub|n>|)><rsub|\|E>d\<mu\><rsub|E>\<leqslant\><rsub|<text|<smart-ref|restriction
    of simple function to a a measurable set>>><big|int><rsup|S>f<rsub|n>d\<mu\>\<in\><around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>>
    proving by <smart-ref|sup of set of bigger elements> that\ 

    <\equation>
      <label|eq 18.366.011>sup<around*|(|<around*|{|<big|int><rsup|S><around*|(|f<rsub|n>|)><rsub|\|E>d\<mu\><rsub|E>\|n\<in\>\<bbb-N\>|}>|)>\<leqslant\>sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)>\<less\>\<infty\>
    </equation>

    Using <smart-ref|eq 18.361.011>,<smart-ref|eq 18.362.011>,<smart-ref|eq
    18.363.011>,<smart-ref|eq 18.366.011> and <smart-ref|eq 18.365.011>
    allows to apply the definition of positive integrable functions proving
    that\ 

    <\equation*>
      f<rsub|\|E>\<in\>\<cal-L\><rsub|+><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>
    </equation*>
  </proof>

  <\lemma>
    <label|restriction of integrable functions to a measurable subset>Let
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
    space, <math|E\<in\>\<cal-A\>> and <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
    then <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
  </lemma>

  <\proof>
    As <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> there exists
    <math|f<rsub|1>,f<rsub|2>\<in\>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>>
    such that <math|f=f<rsub|1>-f<rsub|2>>. Using the previous lemma [see
    <smart-ref|restriction of a positive integrable function to a measurable
    subset>] we have that <math|<around*|(|f<rsub|1>|)><rsub|\|E>,<around*|(|f<rsub|2>|)><rsub|\|E>\<in\>\<cal-L\><rsub|+><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>.
    Further <math|\<forall\>x\<in\>dom<around*|(|f<rsub|\|E>|)>=dom<around*|(|f|)><big|cap>E>
    we have <math|f<rsub|\|E><around*|(|x|)>=f<around*|(|x|)>=f<rsub|1><around*|(|x|)>-f<rsub|2><around*|(|x|)>=<around*|(|f<rsub|1>|)><rsub|\|E><around*|(|x|)>-<around*|(|f<rsub|2>|)><rsub|\|E><around*|(|x|)>>
    proving that <math|f<rsub|\|E>=<around*|(|f<rsub|1>|)><rsub|\|E>-<around*|(|f<rsub|2>|)><rsub|\|E>>.
    So by the definition of integrable functions [see <smart-ref|integral>]
    we have that <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>.
  </proof>

  <\proposition>
    <label|measure integral on subspace>Let
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
    space <math|f:X\<rightarrow\>\<bbb-R\>> a partial function then\ 

    <\enumerate>
      <item>If <math|E\<in\>\<cal-A\>> and <math|dom<around*|(|f|)>> is
      <math|\<mu\>>-conegligible then <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
      if and only if <math|f\<cdot\>\<cal-X\><rsub|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>.
      Further if <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
      [or equivalent <math|f\<cdot\>\<cal-X\><rsub|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>]
      we have <math|<big|int><rsub|E>f d\<mu\>=<big|int>f\<cdot\>\<cal-X\><rsub|E>d\<mu\>>

      <item>Let <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> and
      <math|E\<in\>\<cal-A\>> then <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>,f\<cdot\>\<cal-X\><rsub|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
      and <math|<big|int><rsub|E>f d\<mu\>=<big|int>f\<cdot\>\<cal-X\><rsub|E>d\<mu\>>

      <item>If <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> then
      <math|0\<leqslant\><rsub|a.e.>f> if and only if
      <math|0\<leqslant\><big|int><rsub|E>f d\<mu\>>
      <math|\<forall\>E\<in\>\<cal-A\>> [note that because of
      <math|<around*|(|2|)>> <math|<big|int><rsub|E>f d\<mu\>> is defined]

      <item>If <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> then
      <math|f=<rsub|a.e.>0> if and only if <math|<big|int><rsub|E>f
      d\<mu\>=0> <math|\<forall\>E\<in\>\<cal-A\>> [note that because of
      <math|<around*|(|2|)>> <math|<big|int><rsub|E>f d\<mu\>> is defined]
    </enumerate>
  </proposition>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>Let <math|x\<in\>dom<around*|(|f|)>> then we have either\ 

      <\description>
        <item*|<math|x\<nin\>E>>then <math|x\<in\>X\\E> and
        <math|<around*|(|f<rsub|\|E>|)><rsup|E><around*|(|x|)>=0=f<around*|(|x|)>\<cdot\>0=f<around*|(|x|)>\<cdot\>\<cal-X\><rsub|E><around*|(|x|)>=<around*|(|f\<cdot\>\<cal-X\><rsub|E>|)><around*|(|x|)>>

        <item*|<math|x\<in\>E>>then <math|x\<in\>dom<around*|(|f<rsub|\|E>|)>>
        so that <math|<around*|(|f<rsub|\|E>|)><rsup|E><around*|(|x|)>=f<rsub|\|E><around*|(|x|)>=f<around*|(|x|)>\<equallim\><rsub|x\<in\>E>f<around*|(|x|)>\<cdot\>\<cal-X\><rsub|E><around*|(|x|)>=<around*|(|f\<cdot\>\<cal-X\><rsub|E>|)><around*|(|x|)>>
      </description>

      which as <math|dom<around*|(|f|)>> is <math|\<mu\>>-conegligible means
      that\ 

      <\equation>
        <label|eq 18.359.010><around*|(|f<rsub|\|E>|)><rsup|E>=<rsub|a.e.<around*|[|\<mu\>|]>>f\<cdot\>\<cal-X\><rsub|E>
      </equation>

      If now <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
      we have by the previous corollary [see <smart-ref|extension of
      integrable functions>] that <math|<around*|(|f<rsub|\|E>|)><rsup|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
      and applying <smart-ref|eq 18.359.010> on <smart-ref|measure integral
      properties (2)> (2) proves then that
      <math|f\<cdot\>\<cal-X\><rsub|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>.\<mu\>|]>>.
      On the other hand if <math|f\<cdot\>\<cal-X\><rsub|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
      we have applying <smart-ref|eq 18.359.010> on <smart-ref|measure
      integral properties (2)> (2) that <math|<around*|(|f<rsub|\|E>|)><rsup|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
      which by \ the previous corollary <smart-ref|extension of integrable
      functions> proves that <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\>|]>>.
      So we have\ 

      <\equation*>
        f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|\<mu\>>|]>\<Leftrightarrow\>f\<cdot\>\<cal-X\><rsub|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>
      </equation*>

      Further if <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|\<mu\>>|]>>
      then <math|<big|int><rsub|E>f d\<mu\>\<equallim\><rsub|def><big|int>f<rsub|\|E>d\<mu\><rsub|E>\<equallim\><rsub|<text|<smart-ref|extension
      of integrable functions>>><big|int><around*|(|f<rsub|\|E>|)><rsup|E>d\<mu\>\<equallim\><rsub|<text|<smart-ref|measure
      integral properties (2)>> <around*|(|2|)><infix-and><text|<smart-ref|eq
      18.359.010>>><big|int>f\<cdot\>\<cal-X\><rsub|E>d\<mu\>> proving\ 

      <\equation*>
        <big|int><rsub|E>f d\<mu\>=<big|int>f\<cdot\>\<cal-X\><rsub|E>d\<mu\>
      </equation*>

      <item>Let <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> and
      <math|E\<in\>\<cal-A\>> then by <smart-ref|restriction of integrable
      functions to a measurable subset> <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\>|]>>
      so that by (1) <math|f\<cdot\>\<cal-X\><rsub|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
      and <math|<big|int><rsub|E>f d\<mu\>=<big|int>f\<cdot\>\<cal-X\><rsub|E>d\<mu\>>

      <item>First as <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
      we have by (2) that <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>.
      If <math|0\<leqslant\><rsub|a.e.>f> then by
      <smart-ref|a\<less\>=a.e.f=\<gtr\>a\<less\>=a.e.f\|E> we have
      <math|\<forall\>E\<in\>\<cal-A\>> that
      <math|0\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f<rsub|\|E>>,
      so that by <smart-ref|measure integral properties (1)> <math|>
      <math|0\<leqslant\><big|int>f<rsub|\|E>d\<mu\><rsub|E>\<equallim\><rsub|def><big|int><rsub|E>f
      d\<mu\>>, proving\ 

      <\equation>
        <label|eq 18.369.012>0\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f\<Rightarrow\>\<forall\>E\<in\>\<cal-A\>
        we have 0\<leqslant\><big|int><rsub|E>f d\<mu\>
      </equation>

      \;

      For the opposite implication, assume that
      <math|\<forall\>E\<in\>\<cal-A\>> <math|0\<leqslant\><big|int><rsub|E>f
      d\<mu\>>. As <math|f\<in\>\<cal-L\><around*|[|X.\<cal-A\>.\<mu\>|]>>
      there exists by <smart-ref|measure integral and absolute value> a
      <math|\<mu\>>-conegligible set <math|D> such that <math|f<rsub|\|D>> is
      <math|\<cal-A\>>-measurable. As by <smart-ref|domain of integrable
      functions are conegligible> <math|dom<around*|(|f|)>> is
      <math|\<mu\>>-conegligible there exists by <smart-ref|conegligible sets
      properties> a <math|\<mu\>>-conegligible set <math|E\<in\>\<cal-A\>>
      such that <math|E\<subseteq\>dom<around*|(|f|)><big|cap>D>. Further as
      <math|f<rsub|\|E>\<equallim\><rsub|E\<subseteq\>D<infix-and><text|<smart-ref|restriction
      of restricted function>>><around*|(|f<rsub|\|D><rsub|>|)><rsub|\|E>> we
      have by <reference|measurable function operations> (7) that
      <math|f<rsub|\|E>> is <math|\<cal-A\>>-measurable. Summarizing we have\ 

      <\equation>
        <label|eq 18.370.012>\<exists\>E\<in\>\<cal-A\><space|1em>such that E
        is \<mu\><text|-conegligible, >E\<subseteq\>dom<around*|(|f|)><infix-and>f<rsub|\|E>
        is \<cal-A\><text|-measurable>
      </equation>

      \;

      As <math|f<rsub|\|E>> is <math|\<cal-A\>>-measurable we have that
      <math|F=<around*|{|f<rsub|\|E>\<less\>0|}>\<in\>\<cal-A\>> where
      <math|<around*|{|f<rsub|\|E>\<less\>0|}>> Also using
      <smart-ref|conegligible sets properties> (1) <math|F> is
      <math|\<mu\><rsub|F>>-conegligible. Further if <math|x\<in\>F> then
      <math|f<rsub|\|F><around*|(|x|)>=f<around*|(|x|)>\<equallim\><rsub|F\<subseteq\>E>f<rsub|\|E><around*|(|x|)>\<less\>0\<Rightarrow\>f<rsub|\|F><around*|(|x|)>\<leqslant\>0>
      proving that <math|F\<subseteq\><around*|{|x\<in\>dom<around*|(|f<rsub|\|F>|)>\|f<rsub|\|F><around*|(|x|)>\<leqslant\>0|}>>.
      Using <smart-ref|conegligible sets properties> (2) it follows that
      <math|<around*|{|x\<in\>dom<around*|(|f<rsub|\|F>|)>\|f<rsub|\|F><around*|(|x|)>\<leqslant\>0|}>>
      is <math|\<mu\><rsub|F>>-conegligible, so that
      <math|f<rsub|\|F>\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|F>|]>>0.>
      Further we have by assumption that <math|0\<leqslant\><big|int><rsub|F>f
      d\<mu\>=<big|int>f<rsub|\|F>d\<mu\><rsub|F>>, hence we can apply
      <smart-ref|measure integral properties (2)> (4) giving
      <math|f<rsub|\|F>=<rsub|a.e.<around*|[|\<mu\><rsub|F>|]>>0>. So by
      definition <math|G=<around*|{|x\<in\>dom<around*|(|f<rsub|\|F>|)>\|f<around*|(|x|)>=0|}>>
      is <math|\<mu\><rsub|F>>-conegligible. As <math|\<forall\>x\<in\>F> we
      have <math|f<around*|(|x|)>\<less\>0> we must have that
      <math|G=\<emptyset\>>. Using the <math|\<mu\><rsub|F>>-Conegligible of
      <math|G> it follows that <math|\<mu\><around*|(|F|)>\<equallim\><rsub|G=\<emptyset\>>\<mu\><around*|(|F\\G|)>=\<mu\><rsub|F><around*|(|F\\G|)>=0>,
      so we have

      <\equation>
        <label|eq 18.371.012>F\<in\>\<cal-A\><infix-and>\<mu\><around*|(|F|)>=0
        so that F is \<mu\><text|-negligible>
      </equation>

      Take now <math|x\<in\>X\\<around*|{|0\<leqslant\>f|}>=X\\<around*|{|x\<in\>dom<around*|(|f|)>\|0\<leqslant\>f<around*|(|x|)>|}>>
      then we must consider the following possible cases\ 

      <\description>
        <item*|<math|x\<in\>X\\dom<around*|(|f|)>>>then
        <math|x\<in\><around*|(|X\\E|)><big|cup><around*|(|X\\dom<around*|(|f|)>|)><big|cup>F>

        <item*|<math|x\<in\>dom<around*|(|f|)>>>then
        <math|f<around*|(|x|)>\<less\>0> and we have either\ 

        <\description>
          <item*|<math|x\<in\>E>>then <math|x\<in\>dom<around*|(|f|)><big|cap>E=dom<around*|(|f<rsub|\|E>|)>>

          <\description>
            <item*|<math|x\<in\>F>>then <math|x\<in\><around*|(|X\\E|)><big|cup><around*|(|X\\dom<around*|(|f|)>|)><big|cup>F>

            <item*|<math|x\<nin\>F>>then <math|0\<leqslant\>f<around*|(|x|)>>
            [for if <math|f<around*|(|x|)>\<less\>0> then
            <math|f<rsub|\|E><around*|(|x|)>\<less\>0\<Rightarrow\>x\<in\><around*|{|f<rsub|\|E>\<less\>0|}>=F>]
            contradicting <math|f<around*|(|x|)>\<less\>0> so this case will
            never occur.
          </description>

          <item*|<math|x\<nin\>E>>then <math|x\<in\><around*|(|X\\E|)><big|cup><around*|(|X\\dom<around*|(|f|)>|)><big|cup>F>
        </description>
      </description>
      ...
      <\equation>
        <label|eq 18.372.012>X\\<around*|{|0\<leqslant\>f|}>=X\\<around*|{|x\<in\>dom<around*|(|f|)>\|0\<leqslant\>f<around*|(|x|)>|}>\<subseteq\><around*|(|X\\E|)><big|cup><around*|(|X\\dom<around*|(|f|)>|)><big|cup>F
      </equation>

      Now as <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> we have
      by <smart-ref|domain of integrable functions are conegligible> that
      <math|dom<around*|(|f|)>> is <math|\<mu\>>-conegligible so that by
      definition <math|X\\dom<around*|(|f|)>> is <math|\<mu\>>-negligible,
      further as <math|E> is <math|\<mu\>>-conegligible we have by definition
      that <math|X\\E> is <math|\<mu\>>-negligible. Using this \ and
      <smart-ref|eq 18.371.012> together with <smart-ref|negligible sets
      properties> (3) proves that <math|<around*|(|X\\E|)><big|cup><around*|(|X\\dom<around*|(|f|)>|)><big|cup>F>
      is <math|\<mu\>>-negligible. Applying then <smart-ref|negligible sets
      properties> (2) proves that <math|X\\<around*|{|x\<in\>dom<around*|(|f|)>\|0\<leqslant\>f<around*|(|x|)>|}>>
      is <math|\<mu\>>-negligible hence <math|><math|<around*|{|x\<in\>dom<around*|(|f|)>\|0\<leqslant\>f<around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible proving that
      <math|0\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f>. As
      <math|E\<in\>\<cal-A\>> was chosen arbitrary we have\ 

      <\equation*>
        If \<forall\>E\<in\>\<cal-A\> we have
        \ 0\<leqslant\><big|int><rsub|E>f d\<mu\> then
        0\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f
      </equation*>

      \ which together with <smart-ref|eq 18.369.012> proves that

      <\equation>
        <label|eq 18.373.012>0\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f\<Leftrightarrow\>\<forall\>E\<in\>\<cal-A\>
        we have 0\<geqslant\><big|int><rsub|E>f d\<mu\>
      </equation>

      <item>If <math|f=<rsub|a.e.<around*|[|\<mu\>|]>>0> then by
      <smart-ref|operations on a.e.> <math|0\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>0>
      and <math|f\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>0\<Rightarrowlim\><rsub|<text|<smart-ref|operations
      on a.e.>>>0\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>-f> so that by
      (3) we have that <math|\<forall\>E\<in\>\<cal-A\>>
      <math|0\<leqslant\><big|int><rsub|E>f
      d\<mu\>\<wedge\><big|int><rsub|E>f d\<mu\>\<leqslant\>0\<Rightarrow\>0\<leqslant\>-<big|int><rsub|E>f
      d\<mu\>=<big|int><rsub|E>-f d\<mu\>> proving that
      <math|0=<big|int><rsub|E>f d\<mu\>>. For the opposite implication
      assume that <math|0=<big|int><rsub|E>f d\<mu\>> then
      <math|0\<leqslant\><big|int><rsub|E>f d\<mu\>> and
      <math|<big|int><rsub|E>f d\<mu\>\<leqslant\>0\<Rightarrow\>0\<leqslant\>-<big|int><rsub|E>f
      d\<mu\>=<big|int><rsub|E>-f d\<mu\>> so that by (3) we have
      <math|0\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f> and
      <math|0\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>-f\<Rightarrowlim\><rsub|<text|<smart-ref|operations
      on a.e.>>>f\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>0>. Using then
      <smart-ref|operations on a.e.> it follows that
      <math|f=<rsub|a,e,<around*|[|\<mu\>|]>>0>.
    </enumerate>
  </proof>

  <\corollary>
    Let <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a
    measure space and <math|f,g\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
    then we have\ 

    <\enumerate>
      <item>If <math|\<forall\>E\<in\>\<cal-A\>> <math|<big|int><rsub|E>f
      d\<mu\>\<geqslant\><big|int><rsub|E>g d\<mu\>> then
      <math|f\<geqslant\><rsub|a.e.>g>

      <item>If <math|\<forall\>E\<in\>\<cal-A\>> <math|<big|int><rsub|E>f
      d\<mu\>=<big|int><rsub|E>g d\<mu\>> then <math|f=<rsub|a.e.>g>
    </enumerate>

    <\proof>
      Take <math|h=f-g> then we have if <math|E\<in\>\<cal-A\>> by
      <smart-ref|measure integral properties (1)> that
      <math|h<rsub|\|E>=f<rsub|\|E>-g<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
      and <math|<big|int><rsub|E>h d\<mu\>=<big|int>h<rsub|\|E>d\<mu\><rsub|E>=<big|int>f<rsub|\|E>d\<mu\><rsub|E>-<big|int>g<rsub|\|E>d\<mu\><rsub|E>=<big|int><rsub|E>f
      d\<mu\>-<big|int>g d\<mu\>>. So\ 

      <\enumerate>
        <item>If <math|\<forall\>E\<in\>\<cal-A\>> we have that
        <math|<big|int><rsub|E>f d\<mu\>\<geqslant\><big|int><rsub|E>g
        d\<mu\>> then <math|0\<leqslant\><big|int><rsub|E>h d\<mu\>> so by
        <smart-ref|measure integral on subspace> we have that
        <math|0\<leqslant\><rsub|a.e.>h> so
        <math|H=<around*|{|x\<in\>dom<around*|(|h|)>=dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|0\<leqslant\>h<around*|(|x|)>|}>>
        is <math|\<mu\>>-conegligible. If <math|x\<in\>H> then
        <math|0\<leqslant\>h<around*|(|x|)>\<Rightarrow\>0\<leqslant\>f<around*|(|x|)>-g<around*|(|x|)>\<Rightarrow\>g<around*|(|x|)>\<leqslant\>f<around*|(|x|)>>
        proving that <math|f\<leqslant\><rsub|a.e.>g>

        <item>If <math|\<forall\>E\<in\>\<cal-A\>> we have that
        <math|<big|int><rsub|E>f d\<mu\>=<big|int><rsub|E>g d\<mu\>> then
        <math|0=<big|int><rsub|E>h d\<mu\>> so by <smart-ref|measure integral
        on subspace> we have that <math|0=<rsub|a.e.>h> so
        <math|H=<around*|{|x\<in\>dom<around*|(|h|)>=dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|0=h<around*|(|x|)>|}>>
        is <math|\<mu\>>-conegligible. If <math|x\<in\>H> then
        <math|0=h<around*|(|x|)>\<Rightarrow\>0=f<around*|(|x|)>-g<around*|(|x|)>\<Rightarrow\>g<around*|(|x|)>=f<around*|(|x|)>>
        proving that <math|f\<leqslant\><rsub|a.e.>g>
      </enumerate>
    </proof>
  </corollary>
  ...
  <\proposition>
    Let <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a
    measure space, <math|E\<in\>\<cal-A\>> such that <math|E> is
    <math|\<mu\>>-conegligible then we have
    <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> if and only if
    <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> and if
    <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> [or equivalently
    <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>] then
    <math|<big|int><rsub|E>f d\<mu\>=<big|int>f d\<mu\>>.\ 
  </proposition>

  <\proof>
    \ First note that \ by <smart-ref|restriction of integrable functions to
    a measurable subset> we have\ 

    <\equation>
      <label|eq 18.374.012>\<forall\>E\<in\>\<cal-A\> we have
      f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>\<Rightarrow\>f<rsub|\|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>
    </equation>

    Further take <math|E> and assume that
    <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> then by
    <smart-ref|extension of integrable functions> we have that\ 

    <\equation>
      <label|eq 18.375.012><around*|(|f<rsub|\|E>|)><rsup|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]><infix-and><big|int>f<rsub|\|E>d\<mu\><rsub|E>=<big|int><around*|(|f<rsub|\|E>|)><rsup|E>d\<mu\>
    </equation>

    Now <math|dom<around*|(|f<rsub|\|E>|)><rsup|E>=dom<around*|(|f<rsub|\|E>|)><big|cup><around*|(|X\\E|)>=<around*|(|dom<around*|(|f|)><big|cap>E|)><big|cup><around*|(|X\\E|)>>
    and as <math|<around*|(|f<rsub|\|E>|)><rsup|E>\<in\>\<cal-L\><around*|[|X\<cal-A\>,\<mu\>|]>>
    we have by <smart-ref|domain of integrable functions are conegligible>
    that <math|><math|<around*|(|dom<around*|(|f|)><big|cap>E|)><big|cup><around*|(|X\\E|)>>
    is <math|\<mu\>>-conegligible. As <math|E> is <math|\<mu\>>-conegligible
    we have that <math|X\\E> is <math|\<mu\>>-negligible and we can then use
    <smart-ref|conegligible sets properties> (7) giving that\ 

    <\equation>
      <label|eq 18.376.012>dom<around*|(|f<rsub|\|E>|)> is
      \<mu\><text|-conegligible>
    </equation>

    Further if <math|x\<in\>dom<around*|(|f<rsub|\|E>|)>=dom<around*|(|f|)><big|cap>E>
    then <math|<around*|(|f<rsub|\|E>|)><rsup|E><around*|(|x|)>\<equallim\><rsub|x\<in\>dom<around*|(|f<rsub|\|E>|)>>f<rsub|\|E><around*|(|x|)>\<equallim\>f<around*|(|x|)>>
    proving by <smart-ref|eq 18.376.012> that\ 

    <\equation>
      <label|eq 18.377.012>f<rsub|\|E>=<rsub|a.e.<around*|[|\<mu\>|]>>f
    </equation>

    Using <smart-ref|measure integral properties (2)> together with
    <smart-ref|eq 18.375.012> and the above proves then that
    <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> and
    <math|<big|int>f d\<mu\>=<big|int><around*|(|f<rsub|\|E>|)><rsup|E>d\<mu\>\<equallim\><rsub|<text|<smart-ref|eq
    18.375.012>>><big|int>f<rsub|\|E>d\<mu\>\<equallim\><rsub|def><big|int><rsub|E>f
    d\<mu\>>. Using this result together with <smart-ref|eq 18.374.012>
    proves that if <math|E\<in\>\<cal-A\>> such that <math|E> is
    <math|\<mu\>>-conegligible then

    <\equation*>
      f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>\<Leftrightarrow\>f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<b-A\><rsub|E>,\<mu\><rsub|E>|]><infix-and>in
      both cases <big|int><rsub|E>f d\<mu\>=<big|int>f d\<mu\>
    </equation*>
  </proof>

  <section|Outer measure induced by a \ measure>

  Given a measure space we can use lemma <smart-ref|outer measure induced by
  a measure> to define a outer measure based on a measure space, to formalize
  this we state the following definition.

  <\definition>
    <label|outer measure induced><index|outer measure induced by a
    measure><index|<math|\<mu\><rsup|\<ast\>>>>Let
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
    space then <math|\<mu\><rsup|\<ast\>>:\<cal-P\><around*|(|x|)>\<rightarrow\><around*|[|0,\<infty\>|]>>
    is defined by <math|\<mu\><rsup|\<ast\>><around*|(|A|)>=inf<around*|(|<around*|{|\<mu\><around*|(|E|)>\|E\<in\>\<cal-A\>\<wedge\>A\<subseteq\>E|}>|)>>.
    <math|\<mu\><rsup|\<ast\>>> is called the <with|font-series|bold|outer
    measure induced by> <math|\<mu\>>.
  </definition>

  In lemma <smart-ref|outer measure induced by a measure> we have already
  proved that <math|\<mu\><rsup|\<ast\>>> is indeed a outer measure on
  <math|X>, in the next proposition we sum up the other properties of the
  induced outer measure,

  <\proposition>
    <label|induced outer measures>Let <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>>
    be a measure space then we have the following properties for
    <math|\<mu\><rsup|\<ast\>>:\<cal-P\><around*|(|X|)>\<rightarrow\><around*|[|0,\<infty\>|]>>\ 

    <\enumerate>
      <item><math|\<forall\>A\<subseteq\>X> there exists a
      <math|E\<in\>\<cal-A\>> such that <math|A\<subseteq\>E> and
      <math|\<mu\><rsup|\<ast\>><around*|(|A|)>=\<mu\><around*|(|E|)>>

      <item><math|\<mu\><rsup|\<ast\>>> is a outer measure (see
      <smart-ref|outer measure>)

      <item><math|\<forall\>E\<in\>\<cal-A\>> we have
      <math|\<mu\><rsup|\<ast\>><around*|(|E|)>=\<mu\><around*|(|E|)>>

      <item><math|A\<subseteq\>X> is <math|\<mu\>>-negligible if and only if
      <math|\<mu\><rsup|\<ast\>><around*|(|A|)>=0>

      <item>If <math|<around*|{|A<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>> such
      that <math|A<rsub|i>\<subseteq\>A<rsub|i+1>> we have
      <math|\<mu\><rsup|\<ast\>><around*|(|<big|cup><rsub|i\<in\>\<bbb-N\>>A<rsub|i>|)>=sup<around*|(|<around*|{|\<mu\><rsup|\<ast\>><around*|(|A<rsub|i>|)>\|i\<in\>\<bbb-N\>|}>|)>=<below|lim|n\<rightarrow\>\<infty\>>\<mu\><rsup|\<ast\>><around*|(|A<rsub|n>|)>>

      <item><math|\<forall\>A\<subseteq\>X> and
      <math|\<forall\>E\<in\>\<cal-A\>> we have
      <math|\<mu\><rsup|\<ast\>><around*|(|A|)>=\<mu\><rsup|\<ast\>><around*|(|A<big|cap>E|)>+\<mu\><rsup|\<ast\>><around*|(|A\\E|)>>
    </enumerate>
  </proposition>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>This follows from <smart-ref|outer measure induced by a measure>
      (1)
      ...
      <item>Assume that <math|A> is <math|\<mu\>>-negligible then there
      exists a <math|E\<in\>\<cal-A\>> with <math|\<mu\><around*|(|E|)>=0> so
      that <math|\<mu\><rsup|\<ast\>><around*|(|A|)>=inf<around*|(|<around*|{|\<mu\><around*|(|E|)>\|E\<in\>\<cal-A\>\<wedge\>E\<subseteq\>E|}>|)>\<leqslant\>\<mu\><around*|(|E|)>=0>
      proving that <math|\<mu\><rsup|\<ast\>><around*|(|A|)>=0>. On the other
      hand if <math|\<mu\><rsup|\<ast\>><around*|(|A|)>=0> then by (1) there
      exists a <math|E\<in\>\<cal-A\>> such that <math|A\<subseteq\>E> and
      <math|\<mu\><around*|(|E|)>=\<mu\><rsup|\<ast\>><around*|(|A|)>=0>
      proving that <math|A> is <math|\<mu\>>-negligible.

      <item>As a outer measure is increasing we have by definition [see
      <smart-ref|outer measure> (2)] that <math|\<forall\>i\<in\>\<bbb-N\>>
      <math|\<mu\><rsup|\<ast\>><around*|(|A<rsub|i>|)>\<leqslant\>\<mu\><rsup|\<ast\>><around*|(|A<rsub|i+1>|)>>.
      Now <math|\<forall\>i\<in\>\<bbb-N\>> there exists a
      <math|E<rsub|i>\<in\>\<cal-A\>> such that
      <math|A<rsub|i>\<subseteq\>E<rsub|i>> and
      <math|\<mu\><rsup|\<ast\>><around*|(|A|)>=\<mu\><around*|(|E|)>>. For
      <math|n\<in\>\<bbb-N\>> define <math|F<rsub|n>=<big|cap><rsub|i\<in\><around*|{|n,\<ldots\>,\<infty\>|}>>E<rsub|i>>
      then <math|F<rsub|n>=<big|cap><rsub|i\<in\><around*|{|n,\<ldots\>,\<infty\>|}>>E<rsub|i>\<subseteq\><big|cap><rsub|i\<in\><around*|{|n+1,\<ldots\>,\<infty\>|}>>E<rsub|i>>.
      Using <smart-ref|sigma algebra properties> it follows that
      <math|<around*|{|F<rsub|n>|}><rsub|n\<in\>\<bbb-N\>>\<subseteq\>\<cal-A\>>
      hence we can use <smart-ref|measure space properties> (5) we have that

      <\equation>
        <label|eq 18.378.013>\<mu\><around*|(|<big|cup><rsub|n\<in\>\<bbb-N\>>F<rsub|n>|)>=<below|lim|n\<rightarrow\>\<infty\>>\<mu\><around*|(|F<rsub|n>|)>=sup<around*|(|<around*|{|\<mu\><around*|(|F<rsub|n>|)>\|n\<in\>\<bbb-N\>|}>|)>
      </equation>

      Let <math|n\<in\>\<bbb-N\>> and assume that <math|x\<in\>A<rsub|n>>
      then <math|\<forall\>i\<in\><around*|{|n,\<ldots\>,\<infty\>|}>> we
      have <math|x\<in\>A<rsub|n>\<subseteq\>A<rsub|i>\<subseteq\>E<rsub|i>>
      so that <math|x\<in\><big|cap><rsub|i\<in\><around*|{|n,\<ldots\>,\<infty\>|}>>E<rsub|i>=F<rsub|n>\<subseteq\>E<rsub|n>>
      so that <math|A<rsub|n>\<subseteq\>F<rsub|n>\<subseteq\>E<rsub|n>> so
      that <math|\<mu\><rsup|\<ast\>><around*|(|A<rsub|n>|)>\<leqslant\><rsub|<text|<smart-ref|outer
      measure> (2)>>\<mu\><rsup|\<ast\>><around*|(|F<rsub|n>|)>\<equallim\><rsub|<around*|(|3|)>>\<mu\><around*|(|F<rsub|n>|)>\<leqslant\>\<mu\><around*|(|E<rsub|n>|)>=\<mu\><rsup|\<ast\>><around*|(|E<rsub|n>|)>>
      proving that\ 

      <\equation>
        <label|eq 18.379.013>\<forall\>n\<in\>\<bbb-N\>
        \<mu\><rsup|\<ast\>><around*|(|A<rsub|n>|)>=\<mu\><around*|(|F<rsub|n>|)>
      </equation>

      Using this on <smart-ref|eq 18.378.013> proves\ 

      <\equation>
        <label|eq 18.380.013>\<mu\><around*|(|<big|cup><rsub|n\<in\>\<bbb-N\>>F<rsub|n>|)>=<below|lim|n\<rightarrow\>\<infty\>>\<mu\><rsup|\<ast\>><around*|(|A<rsub|n>|)>=sup<around*|(|<around*|{|\<mu\><rsup|\<ast\>><around*|(|A<rsub|n>|)>\|n\<in\>\<bbb-N\>|}>|)>
      </equation>

      Also from <math|A<rsub|n>\<subseteq\>F<rsub|n>> we have that
      <math|<big|cup><rsub|n\<in\>\<bbb-N\>>A<rsub|n>\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\>>F<rsub|n>\<in\>\<cal-A\>>
      hence <math|\<mu\><rsup|\<ast\>><around*|(|<big|cup><rsub|n\<in\>\<bbb-N\>>A<rsub|n>|)>\<leqslant\>\<mu\><rsup|\<ast\>><around*|(|<big|cup><rsub|n\<in\>\<bbb-N\>>F<rsub|n>|)>\<equallim\><rsub|<around*|(|3|)>>\<mu\><around*|(|<big|cup><rsub|n\<in\>\<bbb-N\>>F<rsub|n>|)>\<equallim\><rsub|<text|<smart-ref|eq
      18.380.013>>><below|lim|n\<rightarrow\>\<infty\>>\<mu\><around*|(|F<rsub|n>|)>\<equallim\><rsub|<text|<smart-ref|eq
      18.379.013>>><below|lim|n\<rightarrow\>\<infty\>>\<mu\><rsup|\<ast\>><around*|(|A<rsub|n>|)>=sup<around*|(|<around*|{|\<mu\><rsup|\<ast\>><around*|(|A<rsub|n>|)>\|n\<in\>\<bbb-N\>|}>|)>.>
      As also <math|\<forall\>n\<in\>\<bbb-N\>>
      <math|A<rsub|n>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>A<rsub|i>>
      we have that <math|sup<around*|(|<around*|{|\<mu\><rsup|\<ast\>><around*|(|A<rsub|n>|)>\|n\<in\>\<bbb-N\>|}>|)>\<leqslant\><rsub|<text|<smart-ref|outer
      measure> (2)>>\<mu\><rsup|\<ast\>><around*|(|<big|cup><rsub|n\<in\>\<bbb-N\>>A<rsub|n>|)>>
      so that we have

      <\equation*>
        \<mu\><rsup|\<ast\>><around*|(|<big|cup><rsub|in\<in\>\<bbb-N\>>A<rsub|n>|)>=<below|lim|n\<rightarrow\>\<infty\>>\<mu\><rsup|\<ast\>><around*|(|A<rsub|n>|)>=sup<around*|(|<around*|{|\<mu\><rsup|\<ast\>><around*|(|A<rsub|n>|)>\|n\<in\>\<bbb-N\>|}>|)>
      </equation*>

      <item>As by (3) <math|\<mu\><rsup|\<ast\>>> is a outer measure we have
      as <math|A=<around*|(|A<big|cap>E|)><big|cup><around*|(|A\\E|)>> by
      <smart-ref|outer measure> (3) that <math|\<mu\><rsup|\<ast\>><around*|(|A|)>\<leqslant\>\<mu\><rsup|\<ast\>><around*|(|A<big|cap>E|)>+\<mu\><rsup|\<ast\>><around*|(|A\\E|)>>.
      For the opposite inclusion note that by (1) there exists a
      <math|F\<in\>\<cal-A\>> such that <math|A\<subseteq\>F> and
      <math|\<mu\><rsup|\<ast\>><around*|(|A|)>=\<mu\><around*|(|F|)>>. Hence
      <math|A<big|cap>E\<subseteq\>F<big|cap>E\<in\>\<cal-A\>> and
      <math|A\\E\<subseteq\>F\\E\<in\>\<cal-A\>> [see <smart-ref|sigma
      algebra properties>] so that <math|\<mu\><rsup|\<ast\>><around*|(|A<big|cap>E|)>+\<mu\><rsup|\<ast\>><around*|(|E\\F|)>\<leqslant\><rsub|<text|<smart-ref|outer
      measure> (2)>>\<mu\><rsup|\<ast\>><around*|(|F<big|cap>E|)>+\<mu\><rsup|\<ast\>><around*|(|F\\E|)>\<equallim\><rsub|<around*|(|3|)>>\<mu\><around*|(|F<big|cap>E|)>+\<mu\><around*|(|F\\E|)>=\<mu\><around*|(|F|)>=\<mu\><rsup|\<ast\>><around*|(|A|)>>.
      So we have that\ 

      <\equation*>
        \<forall\>E\<in\>\<cal-A\> we have
        \<mu\><rsup|\<ast\>><around*|(|A|)>=\<mu\><rsup|\<ast\>><around*|(|A<big|cap>E|)>+\<mu\><rsup|\<ast\>><around*|(|A\\E|)>
      </equation*>
    </enumerate>
  </proof>

  We have seen how given a outer measure, we can use the Carathéodory's
  method to generate a measure based on the outer measure. It is in general
  however not true that the outer measure induced by this measure is the
  original outer measure. However in case of the Lebesgue measure on
  <math|\<bbb-R\><rsup|n>> this is true.\ 

  <\proposition>
    Let <math|n\<in\>\<bbb-N\>> then <math|<around*|(|\<lambda\><rsup|n>|)><rsup|\<ast\>>=\<varphi\><rsup|n>>
    [see <smart-ref|Lebesgue R^n>] where <math|\<varphi\><rsup|n><around*|(|A|)>=inf<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|R<rsub|i>|)>\|<around*|{|R<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-R\><rsup|n>
    where A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i>|}>|)>> is
    the outer measure on <math|\<bbb-R\><rsup|n>> and
    <math|\<lambda\><rsup|n>=<around*|(|\<varphi\><rsup|n>|)><rsub|\|\<cal-L\><rsup|n>>>
    is the Lebesgue measure in the measurable space
    <math|<around*|\<langle\>|\<bbb-R\><rsup|n>,\<cal-L\><rsup|n>|\<rangle\>>>
  </proposition>

  <\proof>
    Let <math|A\<subseteq\>\<bbb-R\><rsup|n>>. If
    <math|E\<in\>\<cal-L\><rsup|n>> such that <math|A\<subseteq\>E> then as
    <math|\<varphi\><rsup|n>> is a outer measure [see <smart-ref|Lebesgue
    R^n>] we have that <math|\<varphi\><rsup|n><around*|(|A|)>\<leqslant\>\<varphi\><rsup|n><around*|(|E|)>=<around*|(|\<varphi\><rsup|n>|)><rsub|\|\<cal-L\><rsup|n>><around*|(|E|)>=\<lambda\><rsup|n><around*|(|E|)>>.
    So <math|\<varphi\><rsup|n><around*|(|A|)>\<leqslant\>inf<around*|(|<around*|{|\<lambda\><rsup|n><around*|(|E|)>\|E\<in\>\<cal-L\><rsup|n>\<wedge\>A\<subseteq\>E|}>|)>\<equallim\><rsub|def><around*|(|\<lambda\><rsup|n>|)><rsup|\<ast\>><around*|(|A|)>>
    proving that\ 

    <\equation>
      <label|eq 18.381.013>\<varphi\><rsup|n><around*|(|A|)>\<leqslant\><around*|(|\<lambda\><rsup|n>|)><rsup|\<ast\>><around*|(|A|)>
    </equation>

    For the opposite inequality let <math|\<varepsilon\>\<gtr\>0> then as
    ...
    where A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i>|}>|)>> we
    have that there exists a <math|<around*|{|R<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-R\><rsup|n>>
    with <math|A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i>> such
    that <math|<big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|R<rsub|i>|)>\<less\>\<varphi\><rsup|n><around*|(|A|)>+\<varepsilon\>>.
    As <math|A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i>\<in\>\<cal-L\><rsup|n>>
    we have that <math|<around*|(|\<lambda\><rsup|n>|)><rsup|\<ast\>><around*|(|A|)>\<leqslant\><around*|(|\<lambda\><rsup|n>|)><rsup|\<ast\>><around*|(|<big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i>|)>\<equallim\><rsub|<text|<smart-ref|induced
    outer measures> (3)>>\<lambda\><rsup|n><around*|(|<big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i>|)>\<leqslant\><rsub|<text|<smart-ref|measure
    space properties>>><big|sum><rsub|i=1><rsup|\<infty\>>\<lambda\><rsup|n><around*|(|R<rsub|i>|)>\<equallim\><rsub|<text|<smart-ref|outer
    measure and volume>>><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|R<rsub|i>|)>\<less\>\<varphi\><rsup|n><around*|(|A|)>+\<varepsilon\>>.
    As <math|\<varepsilon\>> is chosen arbitrary we can use
    <smart-ref|consequence of the Archimedean property (2)> giving
    <math|<around*|(|\<lambda\><rsup|n>|)><rsup|\<ast\>><around*|(|A|)>\<leqslant\>\<varphi\><rsup|n><around*|(|A|)>>
    which together with <smart-ref|eq 18.381.013> proves
    <math|<around*|(|\<lambda\><rsup|n>|)><rsup|\<ast\>><around*|(|A|)>=\<varphi\><rsup|n><around*|(|A|)>>.
    Hence

    <\equation*>
      <around*|(|\<lambda\><rsup|n>|)><rsup|\<ast\>>=\<varphi\><rsup|n>
    </equation*>
  </proof>

  <\definition>
    <label|measurable envelop><index|measurable envelop>Let
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
    and <math|A\<subseteq\>X> then a <with|font-series|bold|measurable
    envelop of> <math|A> is a set <math|E\<in\>\<cal-A\>> such that
    <math|A\<subseteq\>E> and <math|\<forall\>F\<in\>\<cal-A\>>
    <math|\<mu\><around*|(|E<big|cap>F|)>=\<mu\><rsup|\<ast\>><around*|(|F<big|cap>A|)>>
  </definition>

  <\theorem>
    <label|measurable envelop properties>Let
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
    and <math|A\<subseteq\>\<cal-A\>> then we have\ 

    <\enumerate>
      <item>If <math|E\<in\>\<cal-A\>> such that <math|A\<subseteq\>E> then
      <math|E> is a measurable envelop of <math|A> if and only if
      <math|\<forall\>F\<in\>\<cal-A\>> with <math|F\<subseteq\>E\\A> we have
      <math|\<mu\><around*|(|F|)>=0>

      <item>If <math|E\<in\>\<cal-A\>> such that <math|A\<subseteq\>E> and
      <math|\<mu\><around*|(|E|)>\<less\>\<infty\>> then <math|E> is a
      measurable envelop of <math|A> if and only if
      <math|\<mu\><around*|(|E|)>=\<mu\><rsup|\<ast\>><around*|(|A|)>>

      <item>If <math|E> is a measurable envelop of <math|A> and
      <math|H\<in\>\<cal-A\>> then <math|E<big|cap>H> is a measurable envelop
      of <math|A<big|cap>H>

      <item>Let <math|<around*|{|A<rsub|n>|}><rsub|n\<in\>\<bbb-N\>>> be a
      sequence of subsets of <math|X> such that
      <math|\<forall\>n\<in\>\<bbb-N\>> <math|A<rsub|n>> has a measurable
      envelop <math|E<rsub|n>> then <math|<big|cup><rsub|n\<in\>\<bbb-N\>>A<rsub|n>>
      is a measurable envelop of <math|<big|cup><rsub|n\<in\>\<bbb-N\>>A<rsub|n>>

      <item>Let <math|A\<subseteq\>X> such that there exists a
      <math|<around*|{|F<rsub|n>|}><rsub|n\<in\>\<bbb-N\>>\<subseteq\>\<cal-A\>>
      with <math|\<mu\><around*|(|F<rsub|n>|)>\<less\>\<infty\>>
      <math|\<forall\>n\<in\>\<bbb-N\>> such that
      <math|A\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\>>F<rsub|n>> then
      <math|A> has a measurable envelop.
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>Let <math|E> be a measurable envelop of <math|A> then if
      <math|F\<in\>\<cal-A\>> such that <math|F\<subseteq\>E\\A> then by
      definition we have <math|\<mu\><around*|(|E<big|cap>F|)>=\<mu\><rsup|\<ast\>><around*|(|A<big|cap>F|)>>.
      As <math|F\<subseteq\>E\\A\<subseteq\>E> we have <math|F=F<big|cap>E>,
      further <math|A<big|cap>F=\<emptyset\>> so that
      <math|\<mu\><rsup|\<ast\>><around*|(|A<big|cap>F|)>=\<mu\><rsup|\<ast\>><around*|(|\<emptyset\>|)>\<equallim\><rsub|<text|<smart-ref|outer
      measure>>>0> so we have <math|\<mu\><around*|(|F|)>=0>. Hence we have\ 

      <\equation*>
        If E is a measurable envelop of A then \<forall\>F\<in\>\<cal-A\>
        with F\<subseteq\>E\\A we have \<mu\><around*|(|F|)>=0
      </equation*>

      For the opposite implication let

      <\equation>
        <label|eq 18.382.013>\<forall\>F\<in\>\<cal-A\> with
        F\<subseteq\>E\\A we have \<mu\><around*|(|F|)>=\<emptyset\>
      </equation>

      and assume that <math|E> is not a measurable envelop of <math|A>. As
      <math|E> is not a measurable envelop of <math|A> there exists a
      <math|H\<in\>\<cal-A\>> such that <math|A\<subseteq\>H>
      <math|\<mu\><around*|(|E<big|cap>H|)>\<neq\>\<mu\><rsup|\<ast\>><around*|(|A<big|cap>H|)>>.
      As <math|\<mu\><rsup|\<ast\>><around*|(|A<big|cap>H|)>\<leqslant\><rsub|A\<subseteq\>E>\<mu\><rsup|*\<ast\>><around*|(|E<big|cap>H|)>\<equallim\><rsub|<text|<smart-ref|sigma
      algebra properties> and<smart-ref|induced outer measures>
      >>\<mu\><around*|(|E<big|cap>H|)>> it follows that

      <\equation>
        <label|eq 18.383.013>\<mu\><rsup|\<ast\>><around*|(|A<big|cap>H|)>\<less\>\<mu\><around*|(|E<big|cap>H|)>
      </equation>

      Using <smart-ref|induced outer measures> (1) there exists a
      <math|G\<in\>\<cal-A\>> such that <math|A<big|cap>H\<subseteq\>G> and
      <math|\<mu\><rsup|\<ast\>><around*|(|A<big|cap>H|)>=\<mu\><around*|(|G|)>>,
      by <smart-ref|eq 18.383.013> it follows then that

      <\equation>
        <label|eq 18.384.013>\<mu\><around*|(|G|)>\<less\>\<mu\><around*|(|E<big|cap>H|)>
      </equation>

      Take <math|F=<around*|(|E<big|cap>H|)>\\G\<in\><rsub|<text|<smart-ref|sigma
      algebra properties>>>\<cal-A\>> then <math|F\<subseteq\>E> and using
      <smart-ref|eq 18.384.013> and <smart-ref|measure space properties> (7)
      we have that <math|0\<less\>\<mu\><around*|(|F|)>>. To summarize we
      have\ 

      <\equation>
        <label|eq 18.385.013>F\<in\>\<cal-A\>,
        F\<subseteq\>E<infix-and>0\<less\>\<mu\><around*|(|F|)>
      </equation>

      Further <math|F<big|cap>A=<around*|(|<around*|(|E<big|cap>H|)>\\G|)><big|cap>A\<equallim\><rsub|<text|<smart-ref|distributivity
      of union or intersection>>><around*|(|A<big|cap>E<big|cap>H|)>\\G\<equallim\><rsub|A\<subseteq\>E><around*|(|A<big|cap>H|)>\\G\<equallim\><rsub|A<big|cap>H\<subseteq\>G>\<emptyset\>>
      so that

      <\equation>
        <label|eq 18.386.013>F\<subseteq\>E\\A
      </equation>

      Finally \ <smart-ref|eq 18.385.013> and <smart-ref|eq 18.386.013>
      contradicts with <smart-ref|eq 18.382.013> so the assumption that
      <math|E> is not a measurable envelop of <math|A> is false proving that\ 

      <\equation*>
        If \<forall\>F\<in\>\<cal-A\> with F\<subseteq\>E\\A we have
        \<mu\><around*|(|F|)>=0 then E is a measurable envelop of A
      </equation*>

      <item>Let <math|E> be a measurable envelop of <math|A> then as
      <math|E\<in\>\<cal-A\>> we have that
      <math|\<mu\><rsup|\<ast\>><around*|(|A|)>\<equallim\><rsub|A\<subseteq\>E>\<mu\><rsup|\<ast\>><around*|(|A<big|cap>E|)>=\<mu\><around*|(|E<big|cap>E|)>=\<mu\><around*|(|E|)>>
      so that we have\ 

      <\equation*>
        If E is a measurable envelop of A then
        \<mu\><rsup|\<ast\>><around*|(|A|)>=\<mu\><around*|(|E|)>
      </equation*>

      Fort the opposite implication assume that
      <math|\<mu\><rsup|\<ast\>><around*|(|A|)>=\<mu\><around*|(|E|)>> and
      take a <math|F\<in\>\<cal-A\>> such that <math|F\<subseteq\>E\\A>. If
      <math|x\<in\>A> then as <math|A\<subseteq\>E> we have that
      <math|x\<in\>E> and <math|x\<nin\>F> [otherwise
      <math|x\<in\>E\\A\<Rightarrow\>x\<nin\>A> a contradicting
      <math|x\<in\>A>] proving that <math|A\<subseteq\>E\\F\<in\><rsub|<text|<smart-ref|sigma
      algebra properties>>>\<cal-A\>>. Hence
      <math|\<mu\><around*|(|E|)>=\<mu\><rsup|\<ast\>><around*|(|A|)>\<leqslant\>\<mu\><rsup|\<ast\>><around*|(|E\\F|)>\<equallim\><rsub|<text|<smart-ref|induced
      outer measures>> <around*|(|3|)>>\<mu\><around*|(|E\\F|)>> and as
      <math|\<mu\><around*|(|E\\F|)>\<leqslant\>\<mu\><around*|(|E|)>> [as
      <math|E\\F\<subseteq\>E>] we have that
      <math|\<mu\><around*|(|E|)>=\<mu\><around*|(|E\\F|)>>. Now as
      <math|E=<around*|(|E\\F|)><big|sqcup><around*|(|E<big|cap>F|)>\<equallim\><rsub|F\<subseteq\>E><around*|(|E\\F|)><big|sqcup>F>
      we have <math|\<mu\><around*|(|E|)>=\<mu\><around*|(|E\\F|)>+\<mu\><around*|(|F|)>=\<mu\><around*|(|E|)>+\<mu\><around*|(|F|)>>
      which as <math|\<mu\><around*|(|E|)>\<less\>\<infty\>> proves that
      <math|\<mu\><around*|(|F|)>=0>. Using (1) it follows then that <math|E>
      is a measurable envelop of <math|A>. Hence\ 

      <\equation*>
        If \<mu\><rsup|\<ast\>><around*|(|A|)>=\<mu\><around*|(|E|)> then E
        is a measurable envelop of A
      </equation*>

      <item>Let <math|F\<in\>\<cal-A\>> such that
      <math|F\<subseteq\><around*|(|E<big|cap>H|)>\\A> then
      <math|F\<subseteq\>E\\A> so by (1) we have
      <math|\<mu\><around*|(|F|)>=0>. As <math|F> was chosen arbitrary it
      follows by (1) again that <math|E> is a measurable envelop of <math|A>.

      <item>Take <math|A=<big|cup><rsub|n\<in\>\<bbb-N\>>A<rsub|n>> and take
      <math|E=<big|cup><rsub|n\<in\>\<bbb-N\>>E<rsub|n>> then as
      <math|\<forall\>n\<in\>\<bbb-N\> A<rsub|n>\<subseteq\>E<rsub|n>> it
      follows that <math|A<rsub|n>\<subseteq\>A\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\>>E<rsub|n>>.
      Let <math|F\<in\>\<cal-A\>> such that
      <math|F\<subseteq\><around*|(|E\\A|)>> then
      <math|\<forall\>n\<in\>\<bbb-N\>> if <math|x\<in\>F<big|cap>E<rsub|n>>
      we have <math|x\<in\>E<rsub|n>> and
      <math|x\<nin\>A\<Rightarrow\>x\<nin\>A<rsub|n>> [as
      <math|A<rsub|n>\<subseteq\>A>] so that
      <math|F<big|cap>E<rsub|n>\<subseteq\>E<rsub|n>\\A<rsub|n>>, as by
      <smart-ref|sigma algebra properties>
      <math|F<big|cap>E<rsub|n>\<in\>\<cal-A\>> we have by (1) that
      <math|\<mu\><around*|(|F<big|cap>E<rsub|n>|)>=0>. Hence
      <math|\<mu\><around*|(|F|)>\<equallim\><rsub|F\<subseteq\>E>\<mu\><around*|(|E<big|cap>F|)>=\<mu\><around*|(|<big|cup><rsub|n\<in\>\<bbb-N\>><around*|(|F<big|cap>E<rsub|n>|)>|)>\<leqslant\><rsub|<text|<smart-ref|measure
      space properties>>><big|sum>\<mu\><around*|(|F<big|cap>E<rsub|n>|)>=0>.
      Applying then (1) again proves that <math|E> is a measurable envelop of
      <math|A>.

      <item>Let <math|<around*|{|F<rsub|n>|}><rsub|n\<in\>\<bbb-N\>>\<subseteq\>\<cal-A\>>
      with <math|\<forall\>n\<in\>\<bbb-N\>>
      <math|\<mu\><around*|(|F<rsub|n>|)>\<less\>\<infty\>> be such that
      <math|A\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\>>F<rsub|n>>. Given
      <math|n\<in\>\<bbb-N\>> use <smart-ref|induced outer measures> (1) to
      find a <math|E<rsub|n>\<in\>\<cal-A\>> such that
      <math|A<big|cap>F<rsub|n>\<subseteq\>E<rsub|n>> and
      <math|\<mu\><around*|(|E<rsub|n>|)>=\<mu\><rsup|\<ast\>><around*|(|A<big|cap>F<rsub|n>|)>\<leqslant\>\<mu\><rsup|\<ast\>><around*|(|F<rsub|n>|)>\<equallim\><rsub|<smart-ref|induced
      outer measures><text|>>\<mu\><around*|(|F<rsub|n>|)>\<less\>\<infty\>>,
      hence using (2) <math|E<rsub|n>> is a measurable envelop of
      <math|A<big|cap>F<rsub|n>>. Using <math|<around*|(|4|)>> we have that
      <math|<big|cup><rsub|n\<in\>\<bbb-N\>>E<rsub|n>> is a measurable
      envelop of <math|<big|cup><rsub|n\<in\>\<bbb-N\>><around*|(|A<big|cap>F<rsub|n>|)>=A<big|cap>*<around*|(|<big|cup><rsub|n\<in\>\<bbb-N\>>F<rsub|n>|)>=A>
      proving that <math|A> has a measurable envelop.
    </enumerate>
  </proof>

  <\corollary>
    <label|Lebesgue measure space and measurable envelop>Let
    <math|n\<in\>\<bbb-N\>> and <math|<around*|\<langle\>|\<bbb-R\><rsup|n>,\<cal-L\><rsup|n>,\<lambda\><rsup|n>|\<rangle\>>>
    be the Lebesgue measure space defined in <smart-ref|Lebesgue R^n> then
    every <math|A\<subseteq\>\<bbb-R\><rsup|n>> has a measurable envelop.
  </corollary>

  <\proof>
    Let <math|x\<in\>\<bbb-R\><rsup|n>> then using a consequence of the
    Archimedean property of the real numbers (see <reference|consequence of
    the archimedean property for the reals>) there exists
    <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>> a
    <math|n<rsub|i>\<in\>\<bbb-N\>>, such that
    <math|<around*|\||x<rsub|i>|\|>\<less\>n<rsub|i>\<Rightarrow\>x<rsub|i>,-x<rsub|i>\<less\>n<rsub|i>\<Rightarrow\>x<rsub|i>\<in\><around*|[|-n<rsub|i>,n<rsub|i>|[>>,
    proving that <math|x\<in\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|-n<rsub|i>,n<rsub|i>|[>>.
    Take <math|n<rsub|x>=max<around*|(|<around*|{|n<rsub|i>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)>\<in\>\<bbb-N\>>
    then <math|x\<in\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|-n<rsub|x>,n<rsub|x>|[>>.
    Hence if we take <math|<around*|{|R<rsub|j>|}><rsub|j\<in\>\<bbb-N\>>> by
    <math|R<rsub|j>=<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|-j,j|[>\<subseteq\>\<cal-R\><rsup|n>>
    we have <math|\<bbb-R\><rsup|n>\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\>><around*|[|-j,j|[>>.
    So if <math|A\<subseteq\>\<bbb-R\><rsup|n>> then
    <math|A\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\>>R<rsub|n>> and as
    <math|\<lambda\><rsup|n><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|-j,j|[>|)>=\<varphi\><rsup|n><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|-j,j|[>|)>\<equallim\><rsub|<text|<smart-ref|outer
    measure and volume>>>v<rsup|n><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|-j,j|[>|)>=<around*|(|2\<cdot\>j|)><rsup|n>\<less\>\<infty\>>
    we have by the previous theorem (see <smart-ref|measurable envelop
    properties> (5)) that <math|A> has a measurable envelop.
  </proof>

  <\definition>
    <label|full outer measure><index|full outer measure>Let
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
    space then <math|A\<subseteq\>X> is of <with|font-series|bold|full outer
    measure> or <with|font-series|bold|thick> if <math|X> is a measurable
    envelop of <math|A>.\ 
  </definition>

  Using <smart-ref|measurable envelop properties> together with the above
  definition we have\ 

  <\proposition>
    Let <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a
    measure space then for <math|A\<subseteq\>X> we have\ 

    <\enumerate>
      <item><math|A> is of full outer measure if and only if
      <math|\<forall\>F\<in\>\<cal-A\>> we have
      <math|\<mu\><rsup|\<ast\>><around*|(|F<big|cap>A|)>=\<mu\><around*|(|f|)>>

      <item><math|A> is of full outer measure if and only if
      <math|\<forall\>F\<in\>\<cal-A\>> with <math|F\<subseteq\>X\\E> we have
      <math|\<mu\><around*|(|F|)>=0>

      <item>If <math|\<mu\><around*|(|X|)>\<less\>\<infty\>> then \ <math|A>
      is af full outer measure if and only if
      <math|\<forall\>F\<in\>\<cal-A\>> we have
      <math|\<mu\><rsup|\<ast\>><around*|(|F<big|cap>A|)>=\<mu\><around*|(|F|)>>
    </enumerate>
  </proposition>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>As <math|\<forall\>F\<in\>\<cal-A\>> we have
      <math|F\<subseteq\>X> so that <math|\<mu\><around*|(|F<big|cap>X|)>=\<mu\><around*|(|F|)>>
      we have by definition that <math|A> is of full outer measure if and
      only if <math|\<forall\>\<in\>\<cal-A\>> we have
      <math|\<mu\><rsup|\<ast\>><around*|(|A<big|cap>F|)>=\<mu\><around*|(|F|)>>

      <item>This follows from the fact that <math|A\<subseteq\>X> and
      <smart-ref|measurable envelop properties>\ 
  ...
  Further we have from the fact that <math|\<bbb-R\><rsup|n>\<in\>\<cal-L\><rsup|n>>
  and <smart-ref|Lebesgue measure space and measurable envelop>that

  <\proposition>
    Let <math|n\<in\>\<bbb-N\>> and <math|<around*|\<langle\>|\<bbb-R\><rsup|n>,\<cal-L\><rsup|n>,\<lambda\><rsup|n>|\<rangle\>>>
    be the Lebesgue measure space defined in <smart-ref|Lebesgue R^n> then
    every <math|A\<subseteq\>\<bbb-R\><rsup|n>> is of full measure.
  </proposition>
...
<\references>
  <\collection>
    <associate|18.98.001|<tuple|18.100|750>>
    <associate|Beppo Levi|<tuple|18.147|809>>
    <associate|Beppo Levi positive numbers|<tuple|18.146|805>>
    <associate|Borel algebras|<tuple|18.13|722>>
    <associate|Borel algebras and generator|<tuple|18.11|722>>
    <associate|Borel functions and intersection|<tuple|18.100|769>>
    <associate|Borel sets and closed sets|<tuple|18.14|723>>
    <associate|Borel sets and half spaces|<tuple|18.86|764>>
    <associate|Borel sets on R and Lebesgue sets|<tuple|18.62|751>>
    <associate|Borel sigma-algebra|<tuple|18.12|722>>
    <associate|Caratheodory|<tuple|18.34|735>>
    <associate|Dyadic cube|<tuple|18.76|760>>
    <associate|Dyadic cubes and open sets|<tuple|18.80|761>>
    <associate|Dyadic cubes properties|<tuple|18.78|760>>
    <associate|Dyadic intervals|<tuple|18.50|746>>
    <associate|Dyadic intervals and open sets|<tuple|18.55|748>>
    <associate|Dyadic properties|<tuple|18.54|747>>
    <associate|Fatou|<tuple|18.148|810>>
    <associate|Lebesgue|<tuple|18.45|744>>
    <associate|Lebesgue R^n|<tuple|18.72|757>>
    <associate|Lebesgue measure|<tuple|Lebesgue measurable set|744>>
    <associate|Lebesgue measure space and measurable
    envelop|<tuple|18.177|?>>
    <associate|Lebesgue's dominant convergence theorem|<tuple|18.149|811>>
    <associate|[a,@@[|<tuple|18.61|751>>
    <associate|]-@@,a]|<tuple|18.59|750>>
    <associate|]a,@@[|<tuple|18.60|751>>
    <associate|a.e. condition|<tuple|18.28|730>>
    <associate|a.e. relations|<tuple|18.29|730>>
    <associate|a\<less\>=a.e.f=\<gtr\>a\<less\>=a.e.f\|E|<tuple|18.154|814>>
    <associate|absolute function is Borel measurable|<tuple|18.99|769>>
    <associate|absolute value of a restriction|<tuple|18.90|766>>
    <associate|alternate definition of a sigma algebra|<tuple|18.6|720>>
    <associate|auto-1|<tuple|18|719>>
    <associate|auto-10|<tuple|measure space|723>>
    <associate|auto-11|<tuple|<with|mode|<quote|math>|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>>|723>>
    <associate|auto-12|<tuple|image measure|729>>
    <associate|auto-13|<tuple|18.1.3|729>>
    <associate|auto-14|<tuple|<with|mode|<quote|math>|\<mu\>>-negligible
    set|729>>
    <associate|auto-15|<tuple|<with|mode|<quote|math>|\<mu\>>-conegligible
    set|729>>
    <associate|auto-16|<tuple|18.1.4|733>>
    <associate|auto-17|<tuple|outer measure|734>>
    <associate|auto-18|<tuple|sub-algebra|740>>
    <associate|auto-19|<tuple|18.1.4.1|742>>
    <associate|auto-2|<tuple|18.1|719>>
    <associate|auto-20|<tuple|half open interval|742>>
    <associate|auto-21|<tuple|<with|mode|<quote|math>|<around*|[|a,b|[>>|742>>
    <associate|auto-22|<tuple|Lebesgue measurable set|744>>
    <associate|auto-23|<tuple|<with|mode|<quote|math>|\<cal-L\>>|744>>
    <associate|auto-24|<tuple|<with|mode|<quote|math>|\<lambda\>>|744>>
    <associate|auto-25|<tuple|<with|mode|<quote|math>|\<cal-D\><rsub|n>>|746>>
    <associate|auto-26|<tuple|18.1.4.2|752>>
    <associate|auto-27|<tuple|18.1.4.3|757>>
    <associate|auto-28|<tuple|Lebesgue measurable set|757>>
    <associate|auto-29|<tuple|<with|mode|<quote|math>|\<cal-L\>>|757>>
    <associate|auto-3|<tuple|18.1.1|719>>
    <associate|auto-30|<tuple|<with|mode|<quote|math>|\<lambda\><rsup|n>>|760>>
    <associate|auto-31|<tuple|dyadic cube|760>>
    <associate|auto-32|<tuple|<with|mode|<quote|math>|\<cal-D\><rsup|n><rsub|m>>|760>>
    <associate|auto-33|<tuple|<with|mode|<quote|math>|\<cal-D\><rsup|n>>|765>>
    <associate|auto-34|<tuple|18.2|765>>
    <associate|auto-35|<tuple|18.2.1|781>>
    <associate|auto-36|<tuple|18.2.2|781>>
    <associate|auto-37|<tuple|18.2.2.1|781>>
    <associate|auto-38|<tuple|<with|mode|<quote|math>|\<cal-X\><rsub|A>>|781>>
    <associate|auto-39|<tuple|characteristics function recap|789>>
    <associate|auto-4|<tuple|<with|mode|<quote|math>|\<sigma\>>-algebra|719>>
    <associate|auto-40|<tuple|18.2.2.2|796>>
    <associate|auto-41|<tuple|integral of positive integrable function|796>>
    <associate|auto-42|<tuple|<big|int>f d\<mu\>|799>>
    <associate|auto-43|<tuple|18.2.2.3|799>>
    <associate|auto-44|<tuple|<with|mode|<quote|math>|<big|int>f
    d\<mu\>>|799>>
    <associate|auto-45|<tuple|integral|805>>
    <associate|auto-46|<tuple|18.3|810>>
    <associate|auto-47|<tuple|Fatou's lemma|811>>
    <associate|auto-48|<tuple|Lebesgue dominant convergence|813>>
    <associate|auto-49|<tuple|18.4|815>>
    <associate|auto-5|<tuple|sub-algebra|721>>
    <associate|auto-50|<tuple|<with|mode|<quote|math>|f<rsup|E>>|?>>
    <associate|auto-51|<tuple|18.5|?>>
    <associate|auto-52|<tuple|outer measure induced by a measure|?>>
    <associate|auto-53|<tuple|<with|mode|<quote|math>|\<mu\><rsup|\<ast\>>>|?>>
    <associate|auto-54|<tuple|measurable envelop|?>>
    <associate|auto-55|<tuple|full outer measure|?>>
    <associate|auto-56|<tuple|18.6|?>>
    <associate|auto-6|<tuple|trace algebra|721>>
    <associate|auto-7|<tuple|<with|mode|<quote|math>|\<sigma\><around*|[|\<cal-A\>|]>>|722>>
    <associate|auto-8|<tuple|Borel sets|722>>
    <associate|auto-9|<tuple|18.1.2|723>>
    <associate|boundary of a interval|<tuple|18.40|742>>
    <associate|bounds of a half open interval|<tuple|18.39|742>>
    <associate|characteristics function on a set|<tuple|18.161|816>>
    <associate|characteristics function on a subset|<tuple|18.160|816>>
    <associate|characteristics function properties|<tuple|18.110|782>>
    <associate|characteristics function recapitulation|<tuple|18.107|781>>
    <associate|charcteristics function is measurable|<tuple|18.109|781>>
    <associate|closed intervals and Borel Sets|<tuple|18.58|750>>
    <associate|conegligible of subspace|<tuple|18.153|814>>
    <associate|conegligible sets|<tuple|18.25|729>>
    <associate|conegligible sets properties|<tuple|18.27|730>>
    <associate|constructing a outer measure|<tuple|18.33|734>>
    <associate|constructing pairwise disjoint sequences|<tuple|18.19|725>>
    <associate|decomposition of a function in two positive
    functions|<tuple|18.142|801>>
    <associate|domain of integrable functions are
    conegligible|<tuple|18.137|799>>
    <associate|endpoints are unique for halfopen intervals in
    R^n|<tuple|18.66|752>>
    <associate|eq 12.288.008|<tuple|18.290|806>>
    <associate|eq 18.003|<tuple|18.3|722>>
    <associate|eq 18.1.001.1|<tuple|18.1|721>>
    <associate|eq 18.1.1.001|<tuple|18.5|722>>
    <associate|eq 18.1.2.001|<tuple|18.6|722>>
    <associate|eq 18.10.001|<tuple|18.14|727>>
    <associate|eq 18.100.001|<tuple|18.106|753>>
    <associate|eq 18.100.001.2|<tuple|18.105|753>>
    <associate|eq 18.101.001|<tuple|18.107|753>>
    <associate|eq 18.102.001|<tuple|18.109|753>>
    <associate|eq 18.102.001.1|<tuple|18.108|753>>
    <associate|eq 18.102.003|<tuple|18.102|750>>
    <associate|eq 18.103.001|<tuple|18.110|753>>
    <associate|eq 18.103.003|<tuple|18.103|751>>
    <associate|eq 18.104.001|<tuple|18.111|754>>
    <associate|eq 18.104.003|<tuple|18.104|751>>
    <associate|eq 18.105.001|<tuple|18.112|754>>
    <associate|eq 18.106.001|<tuple|18.113|754>>
    <associate|eq 18.107.001|<tuple|18.114|754>>
    <associate|eq 18.108.001|<tuple|18.115|754>>
    <associate|eq 18.11.001|<tuple|18.15|727>>
    <associate|eq 18.110.001|<tuple|18.117|754>>
    <associate|eq 18.111.001|<tuple|18.118|754>>
    <associate|eq 18.112.001|<tuple|18.119|755>>
    <associate|eq 18.113.001|<tuple|18.120|755>>
    <associate|eq 18.114.001|<tuple|18.121|755>>
    <associate|eq 18.115.001|<tuple|18.122|755>>
    <associate|eq 18.116.001|<tuple|18.123|755>>
    <associate|eq 18.117.001|<tuple|18.124|756>>
    <associate|eq 18.119.001.1|<tuple|18.125|756>>
    <associate|eq 18.12.001|<tuple|18.16|728>>
    <associate|eq 18.123.002|<tuple|18.126|757>>
    <associate|eq 18.124.002|<tuple|18.127|758>>
    <associate|eq 18.125.002|<tuple|18.128|758>>
    <associate|eq 18.125.005|<tuple|18.215|788>>
    <associate|eq 18.126.002|<tuple|18.129|758>>
    <associate|eq 18.127.002|<tuple|18.130|759>>
    <associate|eq 18.128.002|<tuple|18.131|759>>
    <associate|eq 18.129.002|<tuple|18.132|759>>
    <associate|eq 18.13.001|<tuple|18.17|728>>
    <associate|eq 18.130.002|<tuple|18.133|760>>
    <associate|eq 18.131.002|<tuple|18.134|760>>
    <associate|eq 18.132.002|<tuple|18.135|761>>
    <associate|eq 18.133.002|<tuple|18.136|761>>
    <associate|eq 18.134.002|<tuple|18.137|761>>
    <associate|eq 18.136.002|<tuple|18.138|761>>
    <associate|eq 18.136.003|<tuple|18.139|762>>
    <associate|eq 18.137.003|<tuple|18.140|762>>
    <associate|eq 18.138.003|<tuple|18.141|762>>
    <associate|eq 18.139.003|<tuple|18.146|763>>
    <associate|eq 18.14.001|<tuple|18.18|728>>
    <associate|eq 18.140.003|<tuple|18.147|763>>
    <associate|eq 18.141.003|<tuple|18.150|767>>
    <associate|eq 18.142.003|<tuple|18.151|767>>
    <associate|eq 18.142.005|<tuple|18.142|762>>
    <associate|eq 18.143.003|<tuple|18.152|767>>
    <associate|eq 18.143.005|<tuple|18.143|762>>
    <associate|eq 18.144.003|<tuple|18.153|767>>
    <associate|eq 18.144.005|<tuple|18.144|762>>
    <associate|eq 18.145.003|<tuple|18.154|768>>
    <associate|eq 18.145.005|<tuple|18.145|763>>
    <associate|eq 18.148.005|<tuple|18.148|764>>
    <associate|eq 18.149.003|<tuple|18.155|770>>
    <associate|eq 18.149.005|<tuple|18.149|764>>
    <associate|eq 18.15.001|<tuple|18.19|728>>
    <associate|eq 18.150.003|<tuple|18.156|770>>
    <associate|eq 18.151.003|<tuple|18.157|771>>
    <associate|eq 18.152.003|<tuple|18.158|771>>
    <associate|eq 18.153.003|<tuple|18.159|772>>
    <associate|eq 18.154.003|<tuple|18.160|772>>
    <associate|eq 18.155.003|<tuple|18.161|772>>
    <associate|eq 18.156.003|<tuple|18.162|772>>
    <associate|eq 18.157.003|<tuple|18.163|772>>
    <associate|eq 18.158.003|<tuple|18.164|772>>
    <associate|eq 18.159.003|<tuple|18.165|772>>
    <associate|eq 18.16.001|<tuple|18.27|735>>
    <associate|eq 18.160.003|<tuple|18.166|773>>
    <associate|eq 18.161.003|<tuple|18.167|773>>
    <associate|eq 18.162.003|<tuple|18.168|773>>
    <associate|eq 18.163.003|<tuple|18.169|773>>
    <associate|eq 18.164.003|<tuple|18.170|774>>
    <associate|eq 18.165.003|<tuple|18.171|774>>
    <associate|eq 18.166.003|<tuple|18.172|774>>
    <associate|eq 18.167.003|<tuple|18.173|774>>
    <associate|eq 18.168.003|<tuple|18.174|774>>
    <associate|eq 18.169.003|<tuple|18.175|775>>
    <associate|eq 18.17.001|<tuple|18.28|736>>
    <associate|eq 18.17.002|<tuple|18.20|734>>
    <associate|eq 18.170.003|<tuple|18.176|775>>
    <associate|eq 18.171.003|<tuple|18.177|777>>
    <associate|eq 18.172.003|<tuple|18.178|777>>
    <associate|eq 18.173.003|<tuple|18.179|777>>
    <associate|eq 18.174.003|<tuple|18.180|777>>
    <associate|eq 18.175.003|<tuple|18.181|777>>
    <associate|eq 18.176.003|<tuple|18.182|778>>
    <associate|eq 18.177.003|<tuple|18.183|779>>
    <associate|eq 18.178.003|<tuple|18.184|779>>
    <associate|eq 18.179.003|<tuple|18.185|779>>
    <associate|eq 18.18.001|<tuple|18.29|736>>
    <associate|eq 18.18.002|<tuple|18.21|734>>
    <associate|eq 18.180.003|<tuple|18.186|779>>
    <associate|eq 18.181.003|<tuple|18.187|779>>
    <associate|eq 18.182.003|<tuple|18.188|779>>
    <associate|eq 18.183.003|<tuple|18.189|779>>
    <associate|eq 18.184.003|<tuple|18.190|779>>
    <associate|eq 18.186.003|<tuple|18.192|780>>
    <associate|eq 18.186.003.1|<tuple|18.191|780>>
    <associate|eq 18.187.003|<tuple|18.194|780>>
    <associate|eq 18.187.003.1|<tuple|18.193|780>>
    <associate|eq 18.188.003|<tuple|18.195|780>>
    <associate|eq 18.189.003|<tuple|18.196|780>>
    <associate|eq 18.19.001|<tuple|18.30|736>>
    <associate|eq 18.19.002|<tuple|18.22|734>>
    <associate|eq 18.191.003|<tuple|18.197|780>>
    <associate|eq 18.198.005|<tuple|18.198|781>>
    <associate|eq 18.199.005|<tuple|18.199|781>>
    <associate|eq 18.2.003|<tuple|18.2|721>>
    <associate|eq 18.20.001|<tuple|18.31|736>>
    <associate|eq 18.20.002|<tuple|18.23|734>>
    <associate|eq 18.200.005|<tuple|18.200|781>>
    <associate|eq 18.201.005|<tuple|18.201|781>>
    <associate|eq 18.202.005|<tuple|18.202|781>>
    <associate|eq 18.203.005|<tuple|18.203|781>>
    <associate|eq 18.204.005.1|<tuple|18.204|783>>
    <associate|eq 18.205.005|<tuple|18.205|783>>
    <associate|eq 18.206.005|<tuple|18.206|783>>
    <associate|eq 18.207.005|<tuple|18.207|783>>
    <associate|eq 18.208.005|<tuple|18.208|784>>
    <associate|eq 18.209.005|<tuple|18.209|784>>
    <associate|eq 18.21.001|<tuple|18.32|736>>
    <associate|eq 18.21.002|<tuple|18.24|734>>
    <associate|eq 18.210.005|<tuple|18.210|784>>
    <associate|eq 18.211.005|<tuple|18.211|785>>
    <associate|eq 18.212.005|<tuple|18.212|786>>
    <associate|eq 18.213.005|<tuple|18.213|787>>
    <associate|eq 18.214.005|<tuple|18.214|788>>
    <associate|eq 18.216.005|<tuple|18.217|788>>
    <associate|eq 18.216.005.1|<tuple|18.216|788>>
    <associate|eq 18.217.005|<tuple|18.218|788>>
    <associate|eq 18.218.005|<tuple|18.219|788>>
    <associate|eq 18.219.005|<tuple|18.220|789>>
    <associate|eq 18.22.001|<tuple|18.33|737>>
    <associate|eq 18.22.002|<tuple|18.25|735>>
    <associate|eq 18.220.005|<tuple|18.221|789>>
    <associate|eq 18.221.005|<tuple|18.222|789>>
    <associate|eq 18.223.005|<tuple|18.223|790>>
    <associate|eq 18.224.005|<tuple|18.224|790>>
    <associate|eq 18.225.005|<tuple|18.225|790>>
    <associate|eq 18.226.005|<tuple|18.226|790>>
    <associate|eq 18.227.005|<tuple|18.237|794>>
    <associate|eq 18.227.006|<tuple|18.227|791>>
    <associate|eq 18.228.005|<tuple|18.238|795>>
    <associate|eq 18.228.006|<tuple|18.228|791>>
    <associate|eq 18.229.005|<tuple|18.239|795>>
    <associate|eq 18.229.006|<tuple|18.229|791>>
    <associate|eq 18.23.001|<tuple|18.34|737>>
    <associate|eq 18.230.005|<tuple|18.240|795>>
    <associate|eq 18.230.006|<tuple|18.230|791>>
    <associate|eq 18.231.005|<tuple|18.241|795>>
    <associate|eq 18.231.006|<tuple|18.231|791>>
    <associate|eq 18.232.006|<tuple|18.232|792>>
    <associate|eq 18.233.006|<tuple|18.233|792>>
    <associate|eq 18.234.006|<tuple|18.234|793>>
    <associate|eq 18.235.006|<tuple|18.235|793>>
    <associate|eq 18.236.006|<tuple|18.236|793>>
    <associate|eq 18.24.001|<tuple|18.35|737>>
    <associate|eq 18.242.006|<tuple|18.242|795>>
    <associate|eq 18.243.006|<tuple|18.243|795>>
    <associate|eq 18.244.006|<tuple|18.244|795>>
    <associate|eq 18.245.006|<tuple|18.245|795>>
    <associate|eq 18.246.006|<tuple|18.246|795>>
    <associate|eq 18.247.006|<tuple|18.247|796>>
    <associate|eq 18.248.006|<tuple|18.248|796>>
    <associate|eq 18.249.006|<tuple|18.249|796>>
    <associate|eq 18.25.001|<tuple|18.36|737>>
    <associate|eq 18.250.006|<tuple|18.250|797>>
    <associate|eq 18.252.006|<tuple|18.251|797>>
    <associate|eq 18.253.006|<tuple|18.252|797>>
    <associate|eq 18.254.006|<tuple|18.253|797>>
    <associate|eq 18.255.006|<tuple|18.254|798>>
    <associate|eq 18.256.006|<tuple|18.255|798>>
    <associate|eq 18.257.006|<tuple|18.256|798>>
    <associate|eq 18.258.006|<tuple|18.257|798>>
    <associate|eq 18.259.006|<tuple|18.258|798>>
    <associate|eq 18.26.001|<tuple|18.37|737>>
    <associate|eq 18.260.007|<tuple|18.260|800>>
    <associate|eq 18.261.006|<tuple|18.259|798>>
    <associate|eq 18.261.007|<tuple|18.261|801>>
    <associate|eq 18.262.007|<tuple|18.262|801>>
    <associate|eq 18.263.007|<tuple|18.263|802>>
    <associate|eq 18.264.007|<tuple|18.264|802>>
    <associate|eq 18.265.007|<tuple|18.265|802>>
    <associate|eq 18.266.007|<tuple|18.266|802>>
    <associate|eq 18.267.007|<tuple|18.267|802>>
    <associate|eq 18.268.008|<tuple|18.268|802>>
    <associate|eq 18.269.008|<tuple|18.269|802>>
    <associate|eq 18.27.001|<tuple|18.38|738>>
    <associate|eq 18.270.008|<tuple|18.270|802>>
    <associate|eq 18.271.008|<tuple|18.271|802>>
    <associate|eq 18.273.008|<tuple|18.273|803>>
    <associate|eq 18.274.008|<tuple|18.274|803>>
    <associate|eq 18.275.008|<tuple|18.275|803>>
    <associate|eq 18.276.008|<tuple|18.276|803>>
    <associate|eq 18.277.008|<tuple|18.277|803>>
    <associate|eq 18.278.008|<tuple|18.278|803>>
    <associate|eq 18.279.008|<tuple|18.279|803>>
    <associate|eq 18.28.001|<tuple|18.39|738>>
    <associate|eq 18.280.008|<tuple|18.280|804>>
    <associate|eq 18.281.008|<tuple|18.281|804>>
    <associate|eq 18.282.012|<tuple|18.282|804>>
    <associate|eq 18.283.008|<tuple|18.284|805>>
    <associate|eq 18.285.008|<tuple|18.286|805>>
    <associate|eq 18.286.008|<tuple|18.287|806>>
    <associate|eq 18.287.008|<tuple|18.288|806>>
    <associate|eq 18.288.008.1|<tuple|18.289|806>>
    <associate|eq 18.289.008|<tuple|18.291|806>>
    <associate|eq 18.29.001|<tuple|18.40|738>>
    <associate|eq 18.290.008|<tuple|18.292|806>>
    <associate|eq 18.291.008|<tuple|18.293|806>>
    <associate|eq 18.292.008|<tuple|18.294|806>>
    <associate|eq 18.293.008|<tuple|18.295|806>>
    <associate|eq 18.294.008|<tuple|18.296|806>>
    <associate|eq 18.295.008|<tuple|18.297|807>>
    <associate|eq 18.296.008|<tuple|18.298|807>>
    <associate|eq 18.297.008|<tuple|18.300|807>>
    <associate|eq 18.297.008.1|<tuple|18.299|807>>
    <associate|eq 18.298.008|<tuple|18.301|807>>
    <associate|eq 18.299.008|<tuple|18.302|807>>
    <associate|eq 18.3.001|<tuple|18.8|724>>
    <associate|eq 18.30.001|<tuple|18.41|738>>
    <associate|eq 18.300.008|<tuple|18.303|807>>
    <associate|eq 18.301.008|<tuple|18.304|807>>
    <associate|eq 18.302.008|<tuple|18.305|807>>
    <associate|eq 18.303.008|<tuple|18.306|808>>
    <associate|eq 18.304.008|<tuple|18.307|808>>
    <associate|eq 18.305.008|<tuple|18.308|809>>
    <associate|eq 18.306.008|<tuple|18.310|809>>
    <associate|eq 18.308.008|<tuple|18.311|809>>
    <associate|eq 18.308.008.2|<tuple|18.309|809>>
    <associate|eq 18.309.008|<tuple|18.313|809>>
    <associate|eq 18.31.001|<tuple|18.42|738>>
    <associate|eq 18.310.008|<tuple|18.314|809>>
    <associate|eq 18.311.008|<tuple|18.315|810>>
    <associate|eq 18.311.008.3|<tuple|18.312|809>>
    <associate|eq 18.312.008|<tuple|18.316|810>>
    <associate|eq 18.313.008|<tuple|18.317|810>>
    <associate|eq 18.314.008|<tuple|18.318|810>>
    <associate|eq 18.315.008|<tuple|18.319|810>>
    <associate|eq 18.316.008|<tuple|18.320|811>>
    <associate|eq 18.317.008|<tuple|18.321|811>>
    <associate|eq 18.318.008|<tuple|18.322|811>>
    <associate|eq 18.319.008|<tuple|18.323|811>>
    <associate|eq 18.32.001|<tuple|18.43|738>>
    <associate|eq 18.320.008|<tuple|18.324|811>>
    <associate|eq 18.321.008|<tuple|18.325|811>>
    <associate|eq 18.322.008|<tuple|18.326|811>>
    <associate|eq 18.323.008|<tuple|18.327|812>>
    <associate|eq 18.324.008|<tuple|18.328|812>>
    <associate|eq 18.325.008|<tuple|18.329|812>>
    <associate|eq 18.326.008|<tuple|18.330|812>>
    <associate|eq 18.327.008|<tuple|18.331|812>>
    <associate|eq 18.328.008|<tuple|18.332|812>>
    <associate|eq 18.329.008|<tuple|18.333|812>>
    <associate|eq 18.33.001|<tuple|18.44|738>>
    <associate|eq 18.330.008|<tuple|18.334|812>>
    <associate|eq 18.331.008|<tuple|18.335|812>>
    <associate|eq 18.332.008|<tuple|18.336|813>>
    <associate|eq 18.333.008|<tuple|18.337|813>>
    <associate|eq 18.334|<tuple|18.338|813>>
    <associate|eq 18.338.008|<tuple|18.339|813>>
    <associate|eq 18.339.009|<tuple|18.342|817>>
    <associate|eq 18.339.009.1|<tuple|18.341|817>>
    <associate|eq 18.339.010|<tuple|18.340|816>>
    <associate|eq 18.34.001|<tuple|18.45|738>>
    <associate|eq 18.340.009|<tuple|18.343|817>>
    <associate|eq 18.341.009|<tuple|18.344|817>>
    <associate|eq 18.342.009|<tuple|18.345|817>>
    <associate|eq 18.343.009|<tuple|18.346|817>>
    <associate|eq 18.344.009|<tuple|18.347|817>>
    <associate|eq 18.345.009|<tuple|18.348|817>>
    <associate|eq 18.346.009|<tuple|18.349|818>>
    <associate|eq 18.349.009|<tuple|18.351|818>>
    <associate|eq 18.35.001|<tuple|18.46|738>>
    <associate|eq 18.350.009|<tuple|18.352|818>>
    <associate|eq 18.351.009|<tuple|18.353|818>>
    <associate|eq 18.352.009|<tuple|18.354|818>>
    <associate|eq 18.353.009|<tuple|18.355|818>>
    <associate|eq 18.354.009|<tuple|18.356|819>>
    <associate|eq 18.355.009|<tuple|18.357|819>>
    <associate|eq 18.356.009|<tuple|18.358|819>>
    <associate|eq 18.357.009|<tuple|18.359|819>>
    <associate|eq 18.359.010|<tuple|18.368|821>>
    <associate|eq 18.359.011|<tuple|18.360|819>>
    <associate|eq 18.36.001|<tuple|18.47|739>>
    <associate|eq 18.360.011|<tuple|18.361|820>>
    <associate|eq 18.361.011|<tuple|18.362|820>>
    <associate|eq 18.362.011|<tuple|18.363|820>>
    <associate|eq 18.363.011|<tuple|18.364|820>>
    <associate|eq 18.364.011|<tuple|18.365|820>>
    <associate|eq 18.365.011|<tuple|18.366|821>>
    <associate|eq 18.366.011|<tuple|18.367|821>>
    <associate|eq 18.369.012|<tuple|18.369|822>>
    <associate|eq 18.37.001|<tuple|18.48|739>>
    <associate|eq 18.370.012|<tuple|18.370|822>>
    <associate|eq 18.371.012|<tuple|18.371|822>>
    <associate|eq 18.372.012|<tuple|18.372|822>>
    <associate|eq 18.373.012|<tuple|18.373|822>>
    <associate|eq 18.374.012|<tuple|18.374|?>>
    <associate|eq 18.375.012|<tuple|18.375|?>>
    <associate|eq 18.376.012|<tuple|18.376|?>>
    <associate|eq 18.377.012|<tuple|18.377|?>>
    <associate|eq 18.378.013|<tuple|18.378|?>>
    <associate|eq 18.379.013|<tuple|18.379|?>>
    <associate|eq 18.38.001|<tuple|18.49|739>>
    <associate|eq 18.380.013|<tuple|18.380|?>>
    <associate|eq 18.381.013|<tuple|18.381|?>>
    <associate|eq 18.382.013|<tuple|18.382|?>>
    <associate|eq 18.383.013|<tuple|18.383|?>>
    <associate|eq 18.384.013|<tuple|18.384|?>>
    <associate|eq 18.385.013|<tuple|18.385|?>>
    <associate|eq 18.386.013|<tuple|18.386|?>>
    <associate|eq 18.39.001|<tuple|18.50|740>>
    <associate|eq 18.4.001|<tuple|18.9|724>>
    <associate|eq 18.4.001.1|<tuple|18.7|723>>
    <associate|eq 18.4.003|<tuple|18.4|722>>
    <associate|eq 18.40.001|<tuple|18.51|740>>
    <associate|eq 18.41.001|<tuple|18.52|740>>
    <associate|eq 18.42.001|<tuple|18.53|740>>
    <associate|eq 18.43.001|<tuple|18.54|740>>
    <associate|eq 18.44.001|<tuple|18.55|740>>
    <associate|eq 18.45.001|<tuple|18.56|740>>
    <associate|eq 18.49.001|<tuple|18.57|741>>
    <associate|eq 18.5.001|<tuple|18.10|725>>
    <associate|eq 18.50.001|<tuple|18.58|741>>
    <associate|eq 18.51.001|<tuple|18.59|741>>
    <associate|eq 18.52.001|<tuple|18.60|741>>
    <associate|eq 18.53.001|<tuple|18.61|741>>
    <associate|eq 18.54.001|<tuple|18.62|742>>
    <associate|eq 18.55.001|<tuple|18.63|742>>
    <associate|eq 18.56.001|<tuple|18.64|742>>
    <associate|eq 18.57.001|<tuple|18.65|742>>
    <associate|eq 18.58.001|<tuple|18.66|743>>
    <associate|eq 18.59.001|<tuple|18.67|743>>
    <associate|eq 18.6.001|<tuple|18.11|726>>
    <associate|eq 18.60.001|<tuple|18.68|743>>
    <associate|eq 18.61.001|<tuple|18.69|743>>
    <associate|eq 18.62.001|<tuple|18.70|743>>
    <associate|eq 18.62.001.1|<tuple|18.71|743>>
    <associate|eq 18.63.001|<tuple|18.72|743>>
    <associate|eq 18.64.001|<tuple|18.73|743>>
    <associate|eq 18.65.001|<tuple|18.74|743>>
    <associate|eq 18.66.001|<tuple|18.75|743>>
    <associate|eq 18.67.001|<tuple|18.76|743>>
    <associate|eq 18.69.001|<tuple|18.77|744>>
    <associate|eq 18.7.001|<tuple|18.12|727>>
    <associate|eq 18.74.001|<tuple|18.26|735>>
    <associate|eq 18.75.001|<tuple|18.80|745>>
    <associate|eq 18.76.001|<tuple|18.78|745>>
    <associate|eq 18.77.001|<tuple|18.79|745>>
    <associate|eq 18.78.001|<tuple|18.81|745>>
    <associate|eq 18.79.001|<tuple|18.82|746>>
    <associate|eq 18.8.001|<tuple|18.13|727>>
    <associate|eq 18.80.001|<tuple|18.83|747>>
    <associate|eq 18.81.001|<tuple|18.84|747>>
    <associate|eq 18.82.001|<tuple|18.85|747>>
    <associate|eq 18.83.001|<tuple|18.86|747>>
    <associate|eq 18.84.001|<tuple|18.87|748>>
    <associate|eq 18.85.001|<tuple|18.88|748>>
    <associate|eq 18.86.001|<tuple|18.89|748>>
    <associate|eq 18.87.001|<tuple|18.90|748>>
    <associate|eq 18.88.001|<tuple|18.91|748>>
    <associate|eq 18.89.001|<tuple|18.92|748>>
    <associate|eq 18.90.001|<tuple|18.93|748>>
    <associate|eq 18.91.001|<tuple|18.94|748>>
    <associate|eq 18.92.001|<tuple|18.95|749>>
    <associate|eq 18.93.001|<tuple|18.96|749>>
    <associate|eq 18.94.001|<tuple|18.97|749>>
    <associate|eq 18.95.001|<tuple|18.98|749>>
    <associate|eq 18.96.001|<tuple|18.99|749>>
    <associate|eq 18.99.001|<tuple|18.101|750>>
    <associate|extension of integrable functions|<tuple|18.164|818>>
    <associate|extension of positive integrable function|<tuple|18.163|817>>
    <associate|extension of simple function|<tuple|18.162|816>>
    <associate|full outer measure|<tuple|18.178|?>>
    <associate|g\<less\>=f=\<gtr\>g^E\<less\>f^E|<tuple|18.159|815>>
    <associate|half open interval|<tuple|18.37|742>>
    <associate|half open interval and Borel Sets|<tuple|18.57|749>>
    <associate|half open interval as union of open sets|<tuple|18.56|749>>
    <associate|half open interval in R^n and a intersection of open
    sets|<tuple|18.82|763>>
    <associate|half open intervals and Borel sets in R^n|<tuple|18.83|763>>
    <associate|half spaces are Lebesgue|<tuple|18.73|757>>
    <associate|half spaces is closed|<tuple|18.85|764>>
    <associate|image measure|<tuple|18.21|729>>
    <associate|induced outer measures|<tuple|18.173|?>>
    <associate|integrability of integrable function restricted to a
    measurable set|<tuple|18.165|819>>
    <associate|integrable function and {a\<less\>=f}|<tuple|18.144|802>>
    <associate|integrable infinite functions have a conegligible
    domain|<tuple|18.151|?>>
    <associate|integral|<tuple|18.136|799>>
    <associate|integral of increasing simple functions|<tuple|18.123|789>>
    <associate|integral of positive integrable function|<tuple|18.131|796>>
    <associate|integral of positive integrable function
    alternative|<tuple|18.132|796>>
    <associate|integral of positive integrable functions
    properties|<tuple|18.135|797>>
    <associate|integral of simple function extension|<tuple|18.133|797>>
    <associate|integral of simple function properties|<tuple|18.120|787>>
    <associate|integral of te zero function|<tuple|18.134|797>>
    <associate|intersection of interval and segments|<tuple|18.46|744>>
    <associate|intervals in R^1|<tuple|18.69|752>>
    <associate|length is semi-additive|<tuple|18.43|743>>
    <associate|limit of functions|<tuple|18.89|766>>
    <associate|limit of simple functions|<tuple|18.124|789>>
    <associate|make measurable sets pairwise disjoint|<tuple|18.116|783>>
    <associate|measurable envelop|<tuple|18.175|?>>
    <associate|measurable envelop properties|<tuple|18.176|?>>
    <associate|measurable function extension|<tuple|18.105|779>>
    <associate|measurable function operations|<tuple|18.103|771>>
    <associate|measurable function restriction property|<tuple|18.129|793>>
    <associate|measurable functions|<tuple|18.91|766>>
    <associate|measurable functions and continuity|<tuple|18.95|767>>
    <associate|measurable functions and generators|<tuple|18.94|767>>
    <associate|measurable functions and limits|<tuple|18.104|776>>
    <associate|measurable functions conditions|<tuple|18.98|768>>
    <associate|measurable maps composition|<tuple|18.96|768>>
    <associate|measurable space|<tuple|18.4|719>>
    <associate|measure integral and absolute value|<tuple|18.143|801>>
    <associate|measure integral extension|<tuple|18.140|799>>
    <associate|measure integral on subspace|<tuple|18.169|?>>
    <associate|measure integral properties (1)|<tuple|18.141|800>>
    <associate|measure integral properties (2)|<tuple|18.145|803>>
    <associate|measure space|<tuple|18.15|723>>
    <associate|measure space alternative definition|<tuple|18.17|724>>
    <associate|measure space properties|<tuple|18.20|726>>
    <associate|negligible set|<tuple|18.22|729>>
    <associate|negligible sets properties|<tuple|18.24|729>>
    <associate|open set as union of ]a,b]|<tuple|18.81|762>>
    <associate|operations on a.e.|<tuple|18.30|731>>
    <associate|outer measure|<tuple|18.32|734>>
    <associate|outer measure and volume|<tuple|18.71|?>>
    <associate|outer measure induced|<tuple|18.172|?>>
    <associate|outer measure induced by a measure|<tuple|18.35|739>>
    <associate|outer measure on the real numbers|<tuple|18.44|744>>
    <associate|partial function construction|<tuple|18.88|765>>
    <associate|positive integrable function alternative|<tuple|18.130|794>>
    <associate|positive integrable function properties|<tuple|18.125|790>>
    <associate|positive integrable functions definition|<tuple|18.126|790>>
    <associate|positive integrable functions dom is
    conegligible|<tuple|18.127|790>>
    <associate|property of Dyadic interval of order n|<tuple|18.53|746>>
    <associate|reindex union of sets|<tuple|18.16|723>>
    <associate|representation of a simple function|<tuple|18.113|782>>
    <associate|restriction of a positive integrable function to a measurable
    subset|<tuple|18.167|820>>
    <associate|restriction of integrable functions to a measurable
    subset|<tuple|18.168|821>>
    <associate|restriction of simple function to a a measurable
    set|<tuple|18.166|819>>
    <associate|segments are lebesgue measurable|<tuple|18.47|745>>
    <associate|set of Dyadic intervals is denumerable|<tuple|18.52|746>>
    <associate|set of dyadic cubes is denumerable|<tuple|18.79|761>>
    <associate|set of segments is a sigma algebra|<tuple|18.48|746>>
    <associate|sigma algebra generated|<tuple|18.10|722>>
    <associate|sigma algebra of half open intervals|<tuple|18.49|746>>
    <associate|sigma algebra of half open intervals in R^n|<tuple|18.75|759>>
    <associate|sigma algebra of half spaces|<tuple|18.74|759>>
    <associate|sigma algebra properties|<tuple|18.8|721>>
    <associate|sigma-algebra|<tuple|18.3|719>>
    <associate|simple function null set|<tuple|18.121|787>>
    <associate|simple function standard representation|<tuple|18.117|785>>
    <associate|simple functions increasing and sup|<tuple|18.122|788>>
    <associate|simple functions properties (basic)|<tuple|18.115|782>>
    <associate|sub-algebra|<tuple|18.9|721>>
    <associate|subspace based on a measurable set|<tuple|18.152|813>>
    <associate|subspace measure|<tuple|18.36|740>>
    <associate|trivial measurable space|<tuple|18.5|719>>
    <associate|trivial sigma algebra|<tuple|18.7|720>>
    <associate|union of two sets to finite union of two
    sets|<tuple|18.31|733>>
    <associate|volume is semi-additive|<tuple|18.70|753>>
    <associate|writing a partial function as a limit|<tuple|18.128|791>>
    <associate|\|f^E\|=\|f\|^E|<tuple|18.158|815>>
  </collection>
</references>
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      ...
      <tuple|<tuple|outer measure induced by a measure>|<pageref|auto-51>>

      <tuple|<tuple|<with|mode|<quote|math>|\<mu\><rsup|\<ast\>>>>|<pageref|auto-52>>

      <tuple|<tuple|measurable envelop>|<pageref|auto-53>>

      <tuple|<tuple|full outer measure>|<pageref|auto-54>>
    </associate>
    <\associate|toc>
      ...
      18.4<space|2spc>Integration over sub-spaces
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-48>

      18.5<space|2spc>Outer measure induced by a \ measure
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-50>

      18.6<space|2spc>d <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
