...
<\body>
  ...
  <\theorem>
    ...
    <math|\<cal-B\>\<subseteq\>\<cal-P\><around*|(|X|)>> and
  ...
  <\proposition>
    ...
    function such that <math|f<around*|(|A|)>\<subseteq\>B> then
    <math|g\<circ\>f:A\<rightarrow\>Z> is
    <math|\<cal-A\>/\<cal-C\>>-measurable function. <math|>
  </proposition>
  ...
  <\proof>
    ...
    (preimage) of union , intersections>>>f<rsup|-1><around*|(|B<rprime|'>|)><big|cap>f<rsup|-1><around*|(|B|)>=f<rsup|-1><around*|(|B<rprime|'>|)><big|cap>A>
    proving that\ 

    <\equation>
      <label|eq 18.145.003>f<rsup|-1><around*|(|g<rsup|-1><around*|(|C|)>|)>=f<rsup|-1><around*|(|B<rprime|'>|)><big|cap>A
    </equation>
    ...
    18.145.003>>><around*|(|A<rprime|'><big|cap>A|)><big|cap>=A<rprime|'><big|cap>A\<in\>\<cal-A\><rsub|\|A>>
    which proves that <math|<around*|(|g\<circ\>f|)><rsup|-1><around*|(|C|)>=f<rsup|-1><around*|(|g<rsup|-1><around*|(|C|)>|)>\<in\>\<cal-A\><rsub|\|A>>.
  ...
  <\proof>
    ...
    <\description>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\>f<rsup|-1><around*|(|<around*|]|-\<infty\>,a|[>|)>>|<cell|\<Leftrightarrow\>>|<cell|f<around*|(|x|)>\<in\><around*|]|-\<infty\>,a|[>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|f<around*|(|x|)>\<less\>a>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|{|f\<less\>a|}>>>>>
      </eqnarray*>
      ...
      <\description>
        ...
        <\description>
          ...
          <\description>
            ...
            <\equation>
              <label|eq 18.150.003><around*|{|f\<less\>a|}>\<subset\>-<around*|]|-\<infty\>,s|[><big|cap>D
            </equation>

            If <math|x\<in\><around*|]|-\<infty\>,s|[><big|cap>D> then
            <math|x\<less\>s> so by the definition of a supremum there exists
            a <math|y\<in\><around*|{|f\<less\>a|}>\<Rightarrow\>f<around*|(|x|)>\<less\>a>
        ...
        <\description>
          ...
          <\description>
            ...
            that <math|x\<in\><around*|]|-\<infty\>,s|[><big|cap>D>. Using
            this together with <smart-ref|eq 18.152.003> proves that
            <math|<around*|{|a\<less\>f|}>=<around*|]|-\<infty\>,s|[><big|cap>D\<in\>\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|[>\|a\<in\>\<bbb-R\>|}>|]><rsub|\|D>\<equallim\><rsub|<text|<smart-ref|Borel
  ...
  <\theorem>
    ...
    set, <math|D,E\<subseteq\>X> and <math|f:D\<rightarrow\>\<bbb-R\>>,
    <math|g:E\<rightarrow\>\<bbb-R\>> functions
    ...
    <\enumerate>
      ...
      <item>If <math|f,g> are Borel measurable functions then
      <math|f/g:D<big|cap>G<big|cap><around*|{|x\<in\>\<bbb-R\>\|g<around*|(|x|)>\<neq\>0|}>\<rightarrow\>\<bbb-R\>>
