...
<\body>
  ...
  <\proof>
    ...
    <\equation*>
      g=e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n-1>>\<circ\>D<rsup|n-1>f
    </equation*>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|D g<around*|(|x|)>>|<cell|=>|<cell|D<around*|(|e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n-1>>\<circ\>D<rsup|n-1>f|)><around*|(|x|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|chain
  ...
  <\proof>
    ...
    <math|\<cal-S\>=<around*|{|n\<in\><around*|{|2,\<ldots\>,\<infty\>|}>\|if
    f:U\<rightarrow\>Y is of class C<rsup|n> then \<forall\>x\<in\>U
    ...
    <\description>
      ...
      <\eqnarray*>
        ...
        differential is symmetric>>>>|<cell|D<rsup|2>f<around*|(|x|)><around*|(|u<rsub|2>|)><around*|(|u<rsub|1>|)>>>|<row|<cell|>|<cell|=>|<cell|D<rsup|2>f<around*|(|x|)><around*|(|u<rsub|2>:u<rsub|1>|)>>>|<row|<cell|>|<cell|=>|<cell|D<rsup|2>f<around*|(|x|)><around*|(|u<rsub|<around*|(|1\<leftrightarrow\><rsub|2>2|)><around*|(|1|)>>:\<ldots\>:u<rsub|<around*|(|1\<leftrightarrow\><rsub|2>2|)><around*|(|2|)>>|)>>>>>
      </eqnarray*>
      ...
      <\description>
        ...
        [see <reference|D^2g(x)(u)(v)=D^nf(x)(v:u:v1..vn-2)>] then we have
        that <math|g> is <math|C<rsup|2>>
        ...
        if k+1=i+1>>|<row|<cell|i+1 if k+1=i>>|<row|<cell|k+1 uf
        ...
        Using <reference|C^n=\<gtr\>C^n is C^1> it follows that <math|f> is
        of class <math|C<rsup|n>>, further if we define
...
<\references>
  <\collection>
    <associate|(01,..,*,..,On) is C@@|<tuple|14.124|452>>
    <associate|(f1,..fn)|<tuple|14.38|?>>
    <associate|(i-\<gtr\>x)-1(A)|<tuple|14.21|?>>
    <associate|(x,h)-\<gtr\>Df(x)(h) differentiability|<tuple|14.79|432>>
    ...
    <associate|C1 of real or complex function|<tuple|14.53|423>>
    <associate|C^2 differential is symmetric|<tuple|14.116|447>>
    <associate|C^@@=@@-times differentiable|<tuple|14.55|424>>
    <associate|C^n implies C^m|<tuple|14.57|424>>
    <associate|C^n is a local property|<tuple|14.63|427>>
    <associate|C^n of multivalued functions|<tuple|14.74|430>>
    <associate|C^n+m=\<gtr\>c^n is C^m|<tuple|14.58|?>>
    <associate|C^n=\<gtr\>C^n is C^1|<tuple|14.59|?>>
    <associate|D1 and composition|<tuple|14.75|?>>
    <associate|D^2g(x)(u)(v)=D^nf(x)(v:u:v1..vn-2)|<tuple|14.120|450>>
    <associate|D^nf(x)(h1:..hn)=D^(n-1)f(x)(h1:..hn-1)(hn)|<tuple|14.78|431>>
    <associate|GL(X) is a group|<tuple|14.136|458>>
    ...
    <associate|L0,1=[0,1]|<tuple|14.107|?>>
    <associate|Mean Value Theorem 3|<tuple|14.109|447>>
    <associate|Mean value theorem 1|<tuple|14.102|445>>
    <associate|Mean value theorem 2|<tuple|14.105|446>>
    ...
    <associate|auto-50|<tuple|inverse function theorem|?>>
    ...
    <associate|balls are convex|<tuple|14.104|445>>
    <associate|chain rule|<tuple|14.29|418>>
    <associate|chain rule (1)|<tuple|14.30|?>>
    <associate|chain rules of partial differentiable
    functions|<tuple|14.128|453>>
    <associate|composition of diffeomorphism is a
    diffeomorphism|<tuple|14.149|465>>
    <associate|composition of differentials on arbitrary
    sets|<tuple|14.83|438>>
    <associate|condition for concavity (convexitivity)|<tuple|14.97|?>>
    <associate|conditions for minimum,maximum of a function|<tuple|14.99|?>>
    <associate|consequence of Mean value theorem|<tuple|14.115|?>>
    <associate|consequence of mean value theorem (2)|<tuple|14.114|?>>
    <associate|constant functions are C^infinite|<tuple|14.68|428>>
    <associate|continuous billinear functions are
    C^infinity|<tuple|14.71|429>>
    <associate|derivative|<tuple|14.16|416>>
    <associate|derivative and composition|<tuple|14.31|?>>
    <associate|derivative and local minimum (maximum)|<tuple|14.98|?>>
    <associate|derivative is local|<tuple|14.18|?>>
    <associate|derivative on a closed interval|<tuple|14.86|?>>
    <associate|diffeomorphism are toplinear|<tuple|14.148|?>>
    ...
    differentiability|<tuple|14.127|453>>
    <associate|differentiability of K^n|<tuple|14.36|420>>
    <associate|differentiability of finite sum|<tuple|14.66|428>>
    ...
    <associate|differentiability on [a,b] equivalences|<tuple|14.87|439>>
    ...
    <associate|eq 12.100|<tuple|14.174|467>>
    <associate|eq 12.101|<tuple|14.175|468>>
    <associate|eq 12.102|<tuple|14.176|468>>
    <associate|eq 12.103|<tuple|14.177|468>>
    <associate|eq 12.104|<tuple|14.178|468>>
    <associate|eq 12.105|<tuple|14.179|468>>
    <associate|eq 12.106|<tuple|14.180|468>>
    <associate|eq 12.107|<tuple|14.181|468>>
    <associate|eq 12.108|<tuple|14.182|468>>
    <associate|eq 12.109|<tuple|14.183|468>>
    <associate|eq 12.12|<tuple|14.23|422>>
    <associate|eq 12.128|<tuple|14.186|470>>
    <associate|eq 12.129|<tuple|14.187|?>>
    <associate|eq 12.130|<tuple|14.188|470>>
    <associate|eq 12.131|<tuple|14.192|471>>
    <associate|eq 12.132|<tuple|14.193|471>>
    <associate|eq 12.133|<tuple|14.194|471>>
    <associate|eq 12.134|<tuple|14.195|471>>
    <associate|eq 12.135|<tuple|14.196|471>>
    <associate|eq 12.136|<tuple|14.197|471>>
    <associate|eq 12.137|<tuple|14.198|471>>
    <associate|eq 12.138|<tuple|14.199|471>>
    <associate|eq 12.139|<tuple|14.200|471>>
    <associate|eq 12.140|<tuple|14.201|471>>
    <associate|eq 12.141|<tuple|14.201|471>>
    <associate|eq 12.2|<tuple|14.11|416>>
    <associate|eq 12.37|<tuple|14.69|444>>
    <associate|eq 12.38|<tuple|14.70|444>>
    <associate|eq 12.39|<tuple|14.71|445>>
    <associate|eq 12.40|<tuple|14.72|445>>
    <associate|eq 12.53|<tuple|14.107|450>>
    <associate|eq 12.58|<tuple|14.114|451>>
    <associate|eq 12.59|<tuple|14.115|452>>
    <associate|eq 12.60|<tuple|14.116|452>>
    <associate|eq 12.61|<tuple|14.117|452>>
    <associate|eq 12.62|<tuple|14.118|452>>
    <associate|eq 12.63|<tuple|14.119|452>>
    <associate|eq 12.64|<tuple|14.138|459>>
    <associate|eq 12.64-0|<tuple|14.120|454>>
    <associate|eq 12.65|<tuple|14.139|459>>
    <associate|eq 12.65-0|<tuple|14.121|454>>
    <associate|eq 12.66|<tuple|14.140|459>>
    <associate|eq 12.66-0|<tuple|14.122|454>>
    <associate|eq 12.67|<tuple|14.141|459>>
    <associate|eq 12.67-0|<tuple|14.123|454>>
    <associate|eq 12.68|<tuple|14.142|460>>
    <associate|eq 12.68-0|<tuple|14.124|454>>
    <associate|eq 12.69|<tuple|14.143|460>>
    <associate|eq 12.69-0|<tuple|14.125|454>>
    <associate|eq 12.70|<tuple|14.144|460>>
    <associate|eq 12.70-0|<tuple|14.126|454>>
    <associate|eq 12.71|<tuple|14.145|461>>
    <associate|eq 12.71-0|<tuple|14.127|454>>
    <associate|eq 12.72|<tuple|14.146|461>>
    <associate|eq 12.72-0|<tuple|14.128|454>>
    <associate|eq 12.72-1|<tuple|14.129|455>>
    <associate|eq 12.73|<tuple|14.147|461>>
    <associate|eq 12.74|<tuple|14.148|461>>
    <associate|eq 12.74-1|<tuple|14.130|456>>
    <associate|eq 12.75|<tuple|14.149|462>>
    <associate|eq 12.75-1|<tuple|14.131|456>>
    <associate|eq 12.76|<tuple|14.150|462>>
    <associate|eq 12.76-1|<tuple|14.132|456>>
    <associate|eq 12.77|<tuple|14.151|462>>
    <associate|eq 12.77-1|<tuple|14.133|456>>
    <associate|eq 12.78|<tuple|14.152|462>>
    <associate|eq 12.78-1|<tuple|14.134|456>>
    <associate|eq 12.79|<tuple|14.153|462>>
    <associate|eq 12.79-1|<tuple|14.135|456>>
    <associate|eq 12.80|<tuple|14.154|463>>
    <associate|eq 12.80-1|<tuple|14.136|457>>
    <associate|eq 12.81|<tuple|14.155|463>>
    <associate|eq 12.81-1|<tuple|14.137|457>>
    <associate|eq 12.82|<tuple|14.156|463>>
    <associate|eq 12.83|<tuple|14.157|463>>
    <associate|eq 12.84|<tuple|14.158|463>>
    <associate|eq 12.85|<tuple|14.159|463>>
    <associate|eq 12.86|<tuple|14.160|464>>
    <associate|eq 12.87|<tuple|14.161|465>>
    <associate|eq 12.88|<tuple|14.162|466>>
    <associate|eq 12.89|<tuple|14.163|466>>
    <associate|eq 12.9|<tuple|14.165|466>>
    <associate|eq 12.90|<tuple|14.164|466>>
    <associate|eq 12.92|<tuple|14.166|466>>
    <associate|eq 12.93|<tuple|14.167|466>>
    <associate|eq 12.94|<tuple|14.168|466>>
    <associate|eq 12.95|<tuple|14.169|466>>
    <associate|eq 12.96|<tuple|14.170|467>>
    <associate|eq 12.97|<tuple|14.171|467>>
    <associate|eq 12.98|<tuple|14.172|467>>
    <associate|eq 12.99|<tuple|14.173|467>>
    <associate|eq 13.50.317|<tuple|14.78|?>>
    <associate|eq 13.51.317|<tuple|14.79|?>>
    <associate|eq 13.52.317|<tuple|14.80|?>>
    <associate|eq 13.53.317|<tuple|14.82|?>>
    <associate|eq 13.54.317|<tuple|14.83|?>>
    <associate|eq 13.55.317|<tuple|14.84|?>>
    <associate|eq 13.56.317|<tuple|14.87|?>>
    <associate|eq 13.57.317|<tuple|14.88|?>>
    <associate|eq 14.1.100|<tuple|14.1|?>>
    <associate|eq 14.100.103|<tuple|14.101|?>>
    <associate|eq 14.101.103|<tuple|14.102|?>>
    <associate|eq 14.102.103|<tuple|14.103|?>>
    <associate|eq 14.103.103|<tuple|14.104|?>>
    <associate|eq 14.104.104|<tuple|14.105|?>>
    <associate|eq 14.105.104|<tuple|14.106|?>>
    <associate|eq 14.108.104|<tuple|14.108|?>>
    <associate|eq 14.109.104|<tuple|14.109|?>>
    <associate|eq 14.110.104|<tuple|14.109|?>>
    <associate|eq 14.111.104|<tuple|14.111|?>>
    <associate|eq 14.112.104|<tuple|14.112|?>>
    <associate|eq 14.113.104|<tuple|14.113|?>>
    ...
    <associate|eq 14.149.020|<tuple|14.184|?>>
    <associate|eq 14.15.100|<tuple|14.16|?>>
    <associate|eq 14.150.020|<tuple|14.185|?>>
    ...
    <associate|eq 14.23.014|<tuple|14.25|?>>
    <associate|eq 14.24.101|<tuple|14.26|?>>
    <associate|eq 14.24.104|<tuple|14.24|?>>
    <associate|eq 14.25.101|<tuple|14.27|?>>
    <associate|eq 14.26.101|<tuple|14.28|?>>
    <associate|eq 14.27.101|<tuple|14.29|?>>
    <associate|eq 14.28.101|<tuple|14.30|?>>
    <associate|eq 14.29.101|<tuple|14.31|?>>
    <associate|eq 14.3.100|<tuple|14.3|?>>
    <associate|eq 14.30.101|<tuple|14.32|?>>
    <associate|eq 14.31.101|<tuple|14.33|?>>
    <associate|eq 14.32.101|<tuple|14.34|?>>
    <associate|eq 14.33.101|<tuple|14.35|?>>
    <associate|eq 14.34.101|<tuple|14.36|?>>
    <associate|eq 14.35.101|<tuple|14.37|?>>
    <associate|eq 14.36.101|<tuple|14.38|?>>
    <associate|eq 14.37.101|<tuple|14.39|?>>
    <associate|eq 14.39.102.3|<tuple|14.40|?>>
    <associate|eq 14.4.100|<tuple|14.4|?>>
    <associate|eq 14.40.102|<tuple|14.42|?>>
    <associate|eq 14.40.102.1|<tuple|14.41|?>>
    <associate|eq 14.41.102|<tuple|14.43|?>>
    <associate|eq 14.43.102|<tuple|14.44|?>>
    <associate|eq 14.44.102.1|<tuple|14.45|?>>
    <associate|eq 14.45.102|<tuple|14.46|?>>
    <associate|eq 14.46.004|<tuple|14.50|?>>
    <associate|eq 14.46.1.004|<tuple|14.48|?>>
    <associate|eq 14.46.102|<tuple|14.47|?>>
    <associate|eq 14.48.103|<tuple|14.49|?>>
    <associate|eq 14.5.100|<tuple|14.5|?>>
    <associate|eq 14.50.103|<tuple|14.51|?>>
    <associate|eq 14.51.103|<tuple|14.52|?>>
    <associate|eq 14.52.103|<tuple|14.53|?>>
    <associate|eq 14.53.103|<tuple|14.54|?>>
    <associate|eq 14.54.103.2|<tuple|14.55|?>>
    <associate|eq 14.55.103|<tuple|14.56|?>>
    <associate|eq 14.56.103.1|<tuple|14.57|?>>
    <associate|eq 14.57.103|<tuple|14.58|?>>
    <associate|eq 14.58.103|<tuple|14.59|?>>
    <associate|eq 14.59.103|<tuple|14.60|?>>
    <associate|eq 14.6.100|<tuple|14.6|?>>
    <associate|eq 14.60.103|<tuple|14.61|?>>
    <associate|eq 14.61.103|<tuple|14.62|?>>
    <associate|eq 14.62.103|<tuple|14.63|?>>
    <associate|eq 14.63.103|<tuple|14.64|?>>
    <associate|eq 14.64.103|<tuple|14.65|?>>
    <associate|eq 14.65.103|<tuple|14.66|?>>
    <associate|eq 14.66.103|<tuple|14.67|?>>
    <associate|eq 14.67.103|<tuple|14.68|?>>
    <associate|eq 14.7.100|<tuple|14.7|?>>
    <associate|eq 14.72.103|<tuple|14.73|?>>
    <associate|eq 14.73.103|<tuple|14.74|?>>
    <associate|eq 14.74.103|<tuple|14.75|?>>
    <associate|eq 14.75.103|<tuple|14.76|?>>
    <associate|eq 14.8.100|<tuple|14.8|?>>
    <associate|eq 14.80.103|<tuple|14.81|?>>
    <associate|eq 14.84.103|<tuple|14.85|?>>
    <associate|eq 14.85.103|<tuple|14.86|?>>
    <associate|eq 14.88.103|<tuple|14.89|?>>
    <associate|eq 14.89.103|<tuple|14.90|?>>
    <associate|eq 14.9.100|<tuple|14.9|?>>
    <associate|eq 14.90.103|<tuple|14.91|?>>
    <associate|eq 14.91.103|<tuple|14.92|?>>
    <associate|eq 14.92.103|<tuple|14.93|?>>
    <associate|eq 14.93.103|<tuple|14.94|?>>
    <associate|eq 14.94.103|<tuple|14.95|?>>
    <associate|eq 14.95.103|<tuple|14.96|?>>
    <associate|eq 14.96.103|<tuple|14.97|?>>
    <associate|eq 14.97.103|<tuple|14.98|?>>
    <associate|eq 14.98.103|<tuple|14.99|?>>
    <associate|eq 14.99.103.1|<tuple|14.100|?>>
    <associate|equivalences of convexitivity (concavity)|<tuple|14.96|?>>
    <associate|evaluation operator (1)|<tuple|14.118|?>>
    <associate|extremum and derivate|<tuple|14.90|442>>
    <associate|f_v is differentiable|<tuple|14.77|431>>
    <associate|fundamental theorem of calculus|<tuple|14.101|444>>
    <associate|generalized chain rule|<tuple|14.76|430>>
    <associate|i the substitution|<tuple|14.22|?>>
    <associate|i-H has inverse if norm of H is lower then
    1|<tuple|14.142|459>>
    <associate|if f is C^n then D^1f is C^n-1|<tuple|14.61|426>>
    <associate|implicit function theorem|<tuple|14.161|470>>
    <associate|in Banach spaces linear continuous mappings are
    toplinear|<tuple|14.134|458>>
    <associate|inverse function theorem|<tuple|14.151|465>>
    <associate|inverse mapping is c-infinite|<tuple|14.144|461>>
    <associate|inverse of derivative|<tuple|14.159|?>>
    <associate|inverse theorem for Df(0)=1X|<tuple|14.152|465>>
    <associate|lagranges theorem|<tuple|14.92|443>>
    <associate|left,right derivatives|<tuple|14.85|?>>
    <associate|lemma 14.119|<tuple|14.119|?>>
    <associate|lemma 14.121|<tuple|14.121|?>>
    <associate|lemma for diedonne main value|<tuple|14.111|?>>
    <associate|linear continuous mappings are C^infinity|<tuple|14.69|428>>
    <associate|linearity of (01,...*,...0n)|<tuple|14.23|417>>
    <associate|mean value theorem (3)|<tuple|14.112|?>>
    <associate|n-th derivative|<tuple|<with|mode|<quote|math>|f<rsup|<around*|(|n|)>>>|423>>
    <associate|n-times differentiability and partial
    derivatives|<tuple|14.80|432>>
    <associate|n-times differentiability implies m-times
    differentiability|<tuple|14.56|424>>
    <associate|n-times differentiability is local|<tuple|14.62|426>>
    <associate|n-times differentiability is same as n-1 times
    differentiability of DF|<tuple|14.60|425>>
    <associate|n-times differentiability of multi valued
    function|<tuple|14.73|429>>
    ...
    <associate|partial differential on U|<tuple|14.125|453>>
    <associate|power of a continuous linear mapping is linear and
    continuous|<tuple|14.139|458>>
    <associate|product of n-times differentiable functions is n-times
    differentiable|<tuple|14.81|432>>
    <associate|projection map is infinite times dimensions|<tuple|14.72|429>>
    <associate|proposition 12.116|<tuple|14.153|466>>
    <associate|proposition 12.118|<tuple|14.155|467>>
    <associate|proposition 12.120|<tuple|14.157|469>>
    <associate|rolles theorem|<tuple|14.91|443>>
    <associate|second mean value theorem|<tuple|14.110|447>>
    <associate|strictly increasing function and derivative|<tuple|14.93|?>>
    <associate|sum of (01,...,*,...0n)|<tuple|14.24|417>>
    <associate|sum of C^n functions is C^n|<tuple|14.65|427>>
    <associate|sum of differentiable functions|<tuple|14.28|417>>
    <associate|sum of linear function and infinite sum|<tuple|14.141|459>>
    <associate|sum of n-times differentiable functions is n-times
    differentiable|<tuple|14.64|427>>
    <associate|symmetry of L^n+t(X;Y) based on permutations and
    transposition|<tuple|14.117|449>>
    <associate|the n-th differential is symmetric|<tuple|14.122|450>>
    <associate|toplinear in normed space|<tuple|14.133|457>>
    <associate|translations are C-infinity|<tuple|14.70|428>>
    <associate|uniqueness of differential|<tuple|14.5|413>>
    <associate|x+t.y is C infinite|<tuple|14.88|?>>
    <associate|x+t.y is C1 (1)|<tuple|14.54|?>>
  </collection>
</references>
