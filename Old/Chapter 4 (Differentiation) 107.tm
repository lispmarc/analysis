...
<\body>
  ...
  <\definition>
    ...
    \ <math|D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f:U\<rightarrow\>L<rsup|m><around*|(|X<rsub|i<rsub|m>>,\<ldots\>,X<rsub|i<rsub|1>>;Y|)>>
    ...
    <\description>
      ...
      differential <math|D<rsup|m-1><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f:X\<rightarrow\>L<rsup|m-1><around*|(|X<rsub|i<rsub|m-1>>,\<ldots\>,X<rsub|1>;Y|)>>
      of order <math|m> on <math|U> such that <math|\<forall\>x\<in\>U>
      <math|D<rsup|m-1><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f> has a partial
      differential <math|D<rsub|i<rsub|m>><around*|(|D<rsup|m-1><rsub|i<rsub|1>,\<ldots\>,i<rsub|m-1>>f|)><around*|(|x|)>\<in\>L<around*|(|X<rsub|m>,L<rsup|m-1><around*|(|X<rsub|m-1>,\<ldots\>,X<rsub|1>;Y|)>|)>\<equallim\><rsub|<text|<reference|L^n(X1,...,Xn;Y)>>>L<rsup|m><around*|(|X<rsub|m>,\<ldots\>,X<rsub|1>;Y|)>>
      and <math|D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f:X\<rightarrow\>L<around*|(|X<rsub|i<rsub|m>>|)>:X\<rightarrow\>L<rsup|m><around*|(|X<rsub|m>,\<ldots\>,X<rsub|1>;Y|)>>
      is defined by <math|D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f<around*|(|x|)>=D<rsub|i<rsub|m>><around*|(|D<rsup|m-1><rsub|i<rsub|1>,\<ldots\>,i<rsub|m-1>>f|)><around*|(|x|)>>
    </description>
  </definition>
  ...
  <\theorem>
    ...
    <math|D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f> exists and
    <math|\<forall\>x\<in\>U> we have <math|\<forall\>h\<in\><big|prod><rsub|j\<in\><around*|{|1,\<ldots\>,m|}>>X<rsub|i<rsub|j>>>
    that <math|D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f<around*|(|x|)><around*|(|h<rsub|m>:\<ldots\>:h<rsub|1>|)>=D<rsup|m>f<around*|(|x|)><around*|(|<around*|(|i<rsub|m>\<rightarrow\>0|)><around*|(|h<rsub|m>|)>:\<ldots\>:<around*|(|i<rsub|1>\<rightarrow\>0|)><around*|(|h<rsub|1>|)>|)>>.
    Further <math|D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f> is
  ...
  <\proof>
    ...
    D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f
    exists<infix-and>\<forall\>x\<in\>U we have
    \<forall\>h\<in\><big|prod><rsub|j\<in\><around*|{|1,\<ldots\>,m|}>>X<rsub|i<rsub|j>>
    that D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f<around*|(|x|)><around*|(|h<rsub|m>:\<ldots\>:h<rsub|1>|)>=D<rsup|m>f<around*|(|x|)><around*|(|<around*|(|i<rsub|m>\<rightarrow\>0|)><around*|(|h<rsub|m>|)>:\<ldots\>:<around*|(|i<rsub|1>\<rightarrow\>0|)><around*|(|h<rsub|1>|)>|)>.
    Further if f is of class C<rsup|m> then
    D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f is continuous|}>> then we
    have:\ 
    ...
    <\description>
      ...
      <math|D<around*|(|<around*|(|D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f|)>\<circ\><around*|(|i<rsub|m+1>\<rightarrow\>x|)>|)><around*|(|x<rsub|i<rsub|m+1>>|)>>
      exists which proves that <math|D<rsub|i<rsub|m>><around*|(|D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f|)><around*|(|x|)>>
      exists. Hence

      <\equation>
        <label|eq 14.131.106>\<forall\>x\<in\>U we have that
        D<rsup|m+1><rsub|i<rsub|1>,\<ldots\>,i<rsub|m+1>>f<around*|(|x|)>
        exists\ 
      </equation>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|D<rsup|m+1><rsub|i<rsub|1>,\<ldots\>,i<rsub|m+1>>f<around*|(|x|)>>|<cell|=>|<cell|D<around*|(|<around*|(|\<Phi\>\<circ\>D<rsup|m>f|)>\<circ\><around*|(|i<rsub|m+1>\<rightarrow\>x|)>|)><around*|(|x<rsub|i<rsub|m+1>>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|chain
      ...
      <\equation>
        <label|eq 14.133.106>D<rsup|m+1><rsub|i<rsub|1>,\<ldots\>,i<rsub|m+1>>f<around*|(|x|)>=\<Phi\>\<circ\>D<rsup|m+1>f<around*|(|x|)>\<circ\><around*|(|i<rsub|m+1>\<rightarrow\>0|)>
      </equation>
      ...
      <\equation>
        <label|eq 14.134.106>D<rsup|m+1><rsub|i<rsub|1>,\<ldots\>,i<rsub|m+1>>f<around*|(|x|)><around*|(|h<rsub|m+1>:\<ldots\>:h<rsub|1>|)>=D<rsup|m+1>f<around*|(|x|)><around*|(|<around*|(|i<rsub|m+1>\<rightarrow\>0|)><around*|(|h<rsub|m+1>|)>:\<ldots\>:<around*|(|i<rsub|1>\<rightarrow\>0|)><around*|(|h<rsub|1>|)>|)>
      </equation>
      ...
      14.133.106>>D<rsup|m+1><rsub|i<rsub|1>,\<ldots\>,i<rsub|m+1>>f<around*|(|x|)>>
      it follows that <math|><math|\<Phi\>\<circ\>D<rsup|<around*|(|m+1|)>>f<around*|(|\<ast\>|)>\<circ\><around*|(|i<rsub|m+1>\<rightarrow\>0|)>=D<rsup|m+1><rsub|i<rsub|1>,\<ldots\>,i<rsub|m+1>>f>.
      So\ 

      <\equation>
        <label|eq 14.135.106.1>if f is C<rsup|m+1> then
        D<rsup|m+1><rsub|i<rsub|1>...i<rsub|m+1>>f is continuous
      </equation>
  ...
  <\corollary>
    ...
    <math|D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f<around*|(|x|)><around*|(|h<rsub|1>:\<ldots\>:h<rsub|m>|)>=D<rsup|m><rsub|i<rsub|\<sigma\><around*|(|1|)>>,\<ldots\>,i<rsub|\<sigma\><around*|(|m|)>>>f<around*|(|x|)><around*|(|h<rsub|\<sigma\><around*|(|1|)>>:\<ldots\>:h<rsub|\<sigma\><around*|(|m|)>>|)>>
  ...
  <\proof>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|D<rsup|m><rsub|i<rsub|\<sigma\><around*|(|1|)>>,\<ldots\>,i<rsub|\<sigma\><around*|(|m|)>>>f<around*|(|x|)>|)><around*|(|h<rsub|\<sigma\><around*|(|m|)>>:\<ldots\>:h<rsub|\<sigma\><around*|(|1|)>>|)>>|<cell|\<equallim\><rsub|<text|<reference|differential
      ...
      n-th differential is symmetric>>>>|<cell|>>|<row|<cell|D<rsup|m>f<around*|(|x|)><around*|(|<around*|(|i<rsub|m>\<rightarrow\>0|)><around*|(|h<rsub|\<sigma\><rsup|-1><around*|(|m|)>>|)>:\<ldots\>:<around*|(|i<rsub|1>\<rightarrow\>0|)><around*|(|h<rsub|\<sigma\><rsup|-1><around*|(|1|)>>|)>|)>>|<cell|>|<cell|>>|<row|<cell|D<rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f<around*|(|h<rsub|m>:\<ldots\>:h<rsub|1>|)>>|<cell|=>|<cell|>>>>
    </eqnarray*>
  </proof>
  ...
  TODO Prove it in the general case\ 
  ...
  <\definition>
    ...
    <\enumerate>
      ...
      exists on <math|U> if <math|\<partial\><rsup|m-1><rsub|i<rsub|2>,\<ldots\>,i<rsub|m>>f>
      exists on <math|U> and <math|\<forall\>x\<in\>U> the
      <math|i<rsub|1>>-partial derivate \ <math|\<partial\><rsub|i<rsub|1>><around*|(|\<partial\><rsub|i<rsub|2>,\<ldots\>,i<rsub|n>><rsup|m-1>f|)><around*|(|x|)>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|L\<in\>\<cal-G\>L<around*|(|X|)>> TODO
...
<\references>
  <\collection>
    ...
    diffeomorphism|<tuple|14.154|465>>
    ...
    <associate|diffeomorphism are toplinear|<tuple|14.153|?>>
    ...
    <associate|eq 12.100|<tuple|14.185|467>>
    <associate|eq 12.101|<tuple|14.186|468>>
    <associate|eq 12.102|<tuple|14.187|468>>
    <associate|eq 12.103|<tuple|14.188|468>>
    <associate|eq 12.104|<tuple|14.189|468>>
    <associate|eq 12.105|<tuple|14.190|468>>
    <associate|eq 12.106|<tuple|14.191|468>>
    <associate|eq 12.107|<tuple|14.192|468>>
    <associate|eq 12.108|<tuple|14.193|468>>
    <associate|eq 12.109|<tuple|14.194|468>>
    <associate|eq 12.12|<tuple|14.23|422>>
    <associate|eq 12.128|<tuple|14.197|470>>
    <associate|eq 12.129|<tuple|14.198|?>>
    <associate|eq 12.130|<tuple|14.199|470>>
    <associate|eq 12.131|<tuple|14.203|471>>
    <associate|eq 12.132|<tuple|14.204|471>>
    <associate|eq 12.133|<tuple|14.205|471>>
    <associate|eq 12.134|<tuple|14.206|471>>
    <associate|eq 12.135|<tuple|14.207|471>>
    <associate|eq 12.136|<tuple|14.208|471>>
    <associate|eq 12.137|<tuple|14.209|471>>
    <associate|eq 12.138|<tuple|14.210|471>>
    <associate|eq 12.139|<tuple|14.211|471>>
    <associate|eq 12.140|<tuple|14.212|471>>
    <associate|eq 12.141|<tuple|14.212|471>>
    ...
    <associate|eq 12.64|<tuple|14.149|459>>
    <associate|eq 12.65|<tuple|14.150|459>>
    <associate|eq 12.66|<tuple|14.151|459>>
    <associate|eq 12.67|<tuple|14.152|459>>
    <associate|eq 12.68|<tuple|14.153|460>>
    <associate|eq 12.69|<tuple|14.154|460>>
    <associate|eq 12.70|<tuple|14.155|460>>
    <associate|eq 12.71|<tuple|14.156|461>>
    <associate|eq 12.72|<tuple|14.157|461>>
    <associate|eq 12.73|<tuple|14.158|461>>
    <associate|eq 12.74|<tuple|14.159|461>>
    <associate|eq 12.75|<tuple|14.160|462>>
    <associate|eq 12.76|<tuple|14.161|462>>
    <associate|eq 12.77|<tuple|14.162|462>>
    <associate|eq 12.78|<tuple|14.163|462>>
    <associate|eq 12.79|<tuple|14.164|462>>
    <associate|eq 12.80|<tuple|14.165|463>>
    <associate|eq 12.80-1|<tuple|14.147|457>>
    <associate|eq 12.81|<tuple|14.166|463>>
    <associate|eq 12.81-1|<tuple|14.148|457>>
    <associate|eq 12.82|<tuple|14.167|463>>
    <associate|eq 12.83|<tuple|14.168|463>>
    <associate|eq 12.84|<tuple|14.169|463>>
    <associate|eq 12.85|<tuple|14.170|463>>
    <associate|eq 12.86|<tuple|14.171|464>>
    <associate|eq 12.87|<tuple|14.172|465>>
    <associate|eq 12.88|<tuple|14.173|466>>
    <associate|eq 12.89|<tuple|14.174|466>>
    <associate|eq 12.9|<tuple|14.176|466>>
    <associate|eq 12.90|<tuple|14.175|466>>
    <associate|eq 12.92|<tuple|14.177|466>>
    <associate|eq 12.93|<tuple|14.178|466>>
    <associate|eq 12.94|<tuple|14.179|466>>
    <associate|eq 12.95|<tuple|14.180|466>>
    <associate|eq 12.96|<tuple|14.181|467>>
    <associate|eq 12.97|<tuple|14.182|467>>
    <associate|eq 12.98|<tuple|14.183|467>>
    <associate|eq 12.99|<tuple|14.184|467>>
    ...
    <associate|eq 14.149.020|<tuple|14.195|?>>
    <associate|eq 14.15.100|<tuple|14.16|?>>
    <associate|eq 14.150.020|<tuple|14.196|?>>
    ...
    <associate|implicit function theorem|<tuple|14.166|470>>
    <associate|in Banach spaces linear continuous mappings are
    toplinear|<tuple|14.139|458>>
    <associate|inverse function theorem|<tuple|14.156|465>>
    <associate|inverse mapping is c-infinite|<tuple|14.149|461>>
    <associate|inverse of derivative|<tuple|14.164|?>>
    <associate|inverse theorem for Df(0)=1X|<tuple|14.157|465>>
    ...
    <associate|proposition 12.116|<tuple|14.158|466>>
    <associate|proposition 12.118|<tuple|14.160|467>>
    <associate|proposition 12.120|<tuple|14.162|469>>
