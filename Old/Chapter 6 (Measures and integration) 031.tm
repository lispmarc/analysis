...
<\body>
  ...
  <\proof>
    ...
    is compact|)>>, then there exists a compact set <math|K<rsub|m>> such
    that
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|x\<in\>U<rsub|m>\\K<rsub|m>>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>U<rsub|m>\<wedge\>x\<nin\>K<rsub|m>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|<around*|(|x\<in\>A\<vee\>x\<nin\>A|)>\<wedge\><around*|(|x\<in\>U<rsub|m>\<wedge\>x\<nin\>K<rsub|m>|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|<around*|(|x\<in\>A\<wedge\>x\<in\>U<rsub|m>\<wedge\>x\<nin\>K<rsub|m>|)>\<vee\><around*|(|x\<nin\>A\<wedge\>x\<in\>U<rsub|m>\<wedge\>x\<nin\>K<rsub|m>|)>>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|A\<subseteq\>U<rsub|m>>>|<cell|<around*|(|x\<in\>A\<wedge\>x\<nin\>K<rsub|m>|)>\<vee\><around*|(|x\<nin\>A\<wedge\>x\<in\>U<rsub|m>\<wedge\>x\<nin\>K<rsub|m>|)>>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|K<rsub|m>\<subseteq\>A>>|<cell|<around*|(|x\<in\>A\<wedge\>x\<nin\>K<rsub|m>|)>\<vee\><around*|(|x\<nin\>A\<wedge\>x\<in\>U<rsub|m>|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|(|A\\K<rsub|m>|)>\<vee\>x\<in\><around*|(|U<rsub|m>\\A|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|(|<around*|(|A\\K<rsub|m>|)><big|cup><around*|(|U<rsub|m>\\A|)>|)>>>>>
    </eqnarray*>

    proving that\ 

    <\equation>
      <label|eq 18.221.030>U<rsub|m>\\K<rsub|m>=<around*|(|A\\K<rsub|m>|)><big|cup><around*|(|U<rsub|m>\\A|)>
    </equation>

    Also

    <\eqnarray*>
      <tformat|<table|<row|<cell|\<lambda\><rsup|n><around*|(|F\\E|)>>|<cell|\<leqslant\><rsub|F\<subseteq\>U<rsub|m>>>|<cell|\<lambda\><rsup|n><around*|(|U<rsub|m>\\E|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|K<rsub|m>\<subseteq\>E>>|<cell|\<lambda\><rsup|n><around*|(|U<rsub|m>\\K<rsub|m>|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|eq
      18.221.030>>>>|<cell|\<lambda\><rsup|n><around*|(|U<rsub|m>\\A|)>+\<lambda\><rsup|n><around*|(|A\\K<rsub|m>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|\<lambda\><rsup|n><around*|(|K<rsub|m>|)>\<leqslant\>\<lambda\><rsup|n><around*|(|A|)>\<less\>\<infty\><text|
      and <reference|measure properties (1)>>>>|<cell|\<lambda\><rsup|n><around*|(|U<rsub|m>|)>-\<lambda\><rsup|n><around*|(|A|)>+\<lambda\><rsup|n><around*|(|A|)>-\<lambda\><rsup|n><around*|(|K<rsub|m>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
  ...
  <\theorem>
    ...
    <math|\<mu\><rsup|\<ast\>><around*|(|A|)>=\<mu\><rsup|\<ast\>><around*|(|A|)>>
  </theorem>
  ...
  <\proof>
    ...
    <\description>
      ...
      hence <math|sup<around*|(|<around*|{|\<mu\><around*|(|E|)>\|E\<subseteq\>A*\<wedge\>E\<in\>\<cal-A\>|}>|)>=inf<around*|(|<around*|{|\<mu\><around*|(|F|)>\|A\<subseteq\>F\<wedge\>F\<in\>\<cal-A\>|}>|)>\<less\>\<infty\>>
      so. Take <math|n\<in\>\<bbb-N\><rsub|0>> then
      <math|sup<around*|(|<around*|{|\<mu\><around*|(|E|)>\|E\<subseteq\>A*\<wedge\>E\<in\>\<cal-A\>|}>|)>-<frac|1|2\<cdot\>n>\<less\>sup<around*|(|<around*|{|\<mu\><around*|(|E|)>\|E\<subseteq\>A*\<wedge\>E\<in\>\<cal-A\>|}>|)>>
      and <math|inf<around*|(|<around*|{|\<mu\><around*|(|F|)>\|A\<subseteq\>F\<wedge\>F\<in\>\<cal-A\>|}>|)>\<less\>inf<around*|(|<around*|{|\<mu\><around*|(|F|)>\|A\<subseteq\>F\<wedge\>F\<in\>\<cal-A\>|}>|)>+<frac|1|2\<cdot\>n>>.
      So there exists <math|E<rsub|n>,F<rsub|n>\<in\>\<cal-A\>> such that\ 

      <\equation>
        E<rsub|n>\<subseteq\>A\<wedge\>sup<around*|(|<around*|{|\<mu\><around*|(|E|)>\|E\<subseteq\>A*\<wedge\>E\<in\>\<cal-A\>|}>|)>-<frac|1|2\<cdot\>n>\<less\>\<mu\><around*|(|E<rsub|n>|)>
      </equation>

      <\equation>
        A\<subseteq\>F<rsub|n>\<wedge\>\<mu\><around*|(|F<rsub|n>|)>\<less\>inf<around*|(|<around*|{|\<mu\><around*|(|F|)>\|A\<subseteq\>F\<wedge\>F\<in\>\<cal-A\>|}>|)>+<frac|1|2\<cdot\>n>
      </equation>
    </description>

    Take <math|E=<big|cup><rsub|n\<in\>\<bbb-N\>>E<rsub|n>\<in\>\<cal-A\>>
    and <math|F=<big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>>F<rsub|n>\<in\>\<cal-A\>>
    then\ 
    ...
    <math|x\<in\>F<rsub|i>> and <math|x\<nin\><big|cup><rsub|j\<in\>\<bbb-N\><rsub|0>>E<rsub|j>\<Rightarrow\>x\<nin\>E<rsub|i>>
    so that <math|x\<in\>F<rsub|i>\\E<rsub|i>>, proving that
    <math|F\\E=<around*|(|<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>>F<rsub|i>|)>\\<around*|(|<big|cup><rsub|j\<in\>\<bbb-N\><rsub|0>>E<rsub|i>|)>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|(|F<rsub|i>\\E<rsub|i>|)>>.
    Hence\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|\<mu\><around*|(|F\\E|)>>|<cell|\<subseteq\>>|<cell|\<mu\><around*|(|<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|(|F<rsub|i>\\E<rsub|i>|)>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|<big|sum><rsub|i\<in\>\<bbb-N\><rsub|0>>\<mu\><around*|(|F<rsub|i>\\E<rsub|i>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|>>>>
    </eqnarray*>
...
<\references>
  <\collection>
    ...
    <associate|Lebesgue measure is translation invariant|<tuple|18.89|?>>
    ...
    <associate|Lebesgue space and compact sets|<tuple|18.82|?>>
    ...
    <associate|completion of Borelset label|<tuple|18.103|?>>
    <associate|completion of a measure|<tuple|18.101|?>>
    ...
    <associate|eq 18.136.030|<tuple|18.236|?>>
    ...
    <associate|eq 18.173list|<tuple|18.173|?>>
    ...
    <associate|eq 18.186.030.1|<tuple|18.186|?>>
    <associate|eq 18.187.030.1|<tuple|18.187|?>>
    ...
    <associate|eq 18.219.030|<tuple|18.219|?>>
    <associate|eq 18.22.021|<tuple|18.22|?>>
    <associate|eq 18.220.030|<tuple|18.220|?>>
    <associate|eq 18.221.030|<tuple|18.222|?>>
    <associate|eq 18.221.030.1|<tuple|18.221|?>>
    ...
    <associate|induced outer inner measure|<tuple|18.105|?>>
    <associate|induced outer measure is a outer measure|<tuple|18.107|?>>
