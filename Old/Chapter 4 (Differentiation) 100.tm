...
<\body>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|<around*|{|h<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>> be a sequence of
      strict positive real numbers with limit <math|0>. Take now
      ...
      then as we have assumed that <math|\<forall\>n\<in\>\<bbb-N\>> that
  ...
  <\example>
    ...
    (with the maximum norm), <math|<around*|{|e<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>,<around*|{|f<rsub|i>|}>+i\<in\><around*|{|1,\<ldots\>,m|}>>
    the canonical bases (see <reference|canonical basis>), a open set
    <math|U\<subseteq\>\<bbb-K\><rsup|n>>, <math|x\<in\>U>, a open set
    <math|V\<subseteq\>\<bbb-K\><rsup|m>> and <math|L:U\<rightarrow\>V> a
    linear mapping with a matrix (see <reference|matrix of a linear
    mapping>)<space|1em><verbatim|><math|\<cal-M\><around*|(|L,<around*|{|e<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>,<around*|{|f<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,m|}>>|)>=<around*|{|L<rsub|i,j>|}><rsub|<around*|(|i,j|)>\<in\><around*|{|1\<ldots\>.m|}>\<times\><around*|{|1,\<ldots\>,n|}>>>
    in the canonical bassis . Then <math|<frac|\<partial\><rsub|><around*|(|L<rsub|1>,\<ldots\>,L<rsub|m>|)><around*|(|x|)>|\<partial\><around*|(|1,\<ldots\>,n|)>>=<around*|{|L<rsub|i,j>|}><rsub|<around*|(|i,j|)>\<in\><around*|{|1\<ldots\>.m|}>\<times\><around*|{|1,\<ldots\>,n|}>>>
  </example>

  <\proof>
    As <math|L> is linear and <math|\<forall\>j\<in\><around*|{|1,\<ldots\>,m|}>>
    <math|\<pi\><rsub|j>> is linear we have that
    <math|\<pi\><rsub|j>\<circ\>L> is linear. Hence given
    <math|i\<in\><around*|{|1,\<ldots\>,n|}>,j\<in\><around*|{|1,\<ldots\>,m|}>>
    we have that\ 
    ...
    <\eqnarray*>
      ...
      of a linear mapping>>>>|<cell|L<rsub|i,j>>>>>
    </eqnarray*>

    proving that <math|<frac|\<partial\><around*|(|L<rsub|1>,\<ldots\>,L<rsub|m>|)><around*|(|x|)>|\<partial\><around*|(|1,\<ldots\>,n|)>>=<around*|{|L<rsub|i,j>|}><rsub|<around*|(|i,j|)>\<in\><around*|{|1\<ldots\>.m|}>\<times\><around*|{|1,\<ldots\>,n|}>>>.
  </proof>
  ...
  <\definition>
    ...
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
    <math|n\<in\>\<bbb-N\>> and <math|f:U\<rightarrow\>V> a function then
    <math|f> is <math|\<infty\>>-differentiableif
  ...
  <\definition>
    ...
    <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> we have that <math|f> is of
    class <math|C<rsup|n>>. Functions of class <math|C<rsup|\<infty\>>> are
    also called <with|font-series|bold|smooth> functions.
  </definition>
  ...
  <\definition>
    ...
    <math|n\<in\>\<bbb-N\>> and <math|f:U\<rightarrow\>V> a function then
    <math|f> has a <math|n>-the derivative <math|f<rsup|<around*|(|n|)>>> on
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> we have that <math|f> is of
      class <math|C<rsup|n>> then by definition we have that <math|f> is
      <math|n>-times differentiable proving that <math|f> is
      <math|\<infty\>>-times differentiable.
      ...
      and thus <math|C<rsup|0>>. If <math|n\<in\>\<bbb-N\>> we have that
      <math|f> is <math|n>-times differentiable then <math|f> is
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
    , <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>V> a
    function that is <math|>n-times differentiable then we have that
  ...
  <\proof>
    ...
    <\description>
      ...
      By induction we have then <math|S=\<bbb-N\>\\<around*|{|1|}>> porving
      the theorem.
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
    a open set, <math|n\<in\>\<bbb-N\>> and <math|f:U\<rightarrow\>Y> a
    function then <math|f> is of class <math|C<rsup|n>> if and only if
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      Using mathematical induction we have then <math|S=\<bbb-N\>> proving
      (1)
      ...
      induction proves then that <math|S=\<bbb-N\>> finishing the proof.
    </enumerate>
  </proof>
  ...
  <\proof>
    Let <math|S=<around*|{|n\<in\>\<bbb-N\>\|D<rsup|n>C<rsub|U,y> exists and
    D<rsup|n>C<rsub|U,y>=C<rsub|X,0<rsub|L<rsup|n-1><around*|(|X;Y|)>>>|}>>
    then we have
  ...
  <\theorem>
    ...
    <math|f> is <math|C<rsup|n>> if and only if the <math|n>-th derivate
...
<\references>
  <\collection>
    <associate|(01,..,*,..,On) is C@@|<tuple|14.117|452>>
    <associate|(x,h)-\<gtr\>Df(x)(h) differentiability|<tuple|14.71|432>>
    ...
    <associate|C1 of real or complex function|<tuple|14.46|423>>
    <associate|C^2 differential is symmetric|<tuple|14.109|447>>
    <associate|C^@@=@@-times differentiable|<tuple|14.47|424>>
    <associate|C^n implies C^m|<tuple|14.49|424>>
    <associate|C^n is a local property|<tuple|14.53|427>>
    <associate|C^n of multivalued functions|<tuple|14.63|430>>
    <associate|D^2g(x)(u)(v)=D^nf(x)(v:u:v1..vn-2)|<tuple|14.113|450>>
    <associate|D^nf(x)(h1:..hn)=D^(n-1)f(x)(h1:..hn-1)(hn)|<tuple|14.70|431>>
    <associate|Dh(x)(u)=D^nf(x)(u:v1:..:vn-1)|<tuple|14.114|450>>
    <associate|GL(X) is a group|<tuple|14.129|458>>
    <associate|I+H has inverse if norm of H is less then
    1|<tuple|14.136|461>>
    <associate|Jacobian Matrix|<tuple|14.33|421>>
    <associate|Jacobian of linear map|<tuple|14.34|?>>
    <associate|Mean Value Theorem 3|<tuple|14.103|447>>
    <associate|Mean value theorem 1|<tuple|14.96|445>>
    <associate|Mean value theorem 2|<tuple|14.99|446>>
    ...
    <associate|auto-10|<tuple|<with|mode|<quote|math>|f<rprime|'>>|12>>
    <associate|auto-11|<tuple|<with|mode|<quote|math>|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|i-1>,\<ast\>,x<rsub|i+1>,\<ldots\>,x<rsub|n>|)>>|12>>
    <associate|auto-12|<tuple|chain rule|12>>
    <associate|auto-13|<tuple|14.1.2|12>>
    <associate|auto-14|<tuple|<with|mode|<quote|math>|\<partial\><rsub|i>f<around*|(|x|)>>|12>>
    <associate|auto-15|<tuple|Jacobian|13>>
    <associate|auto-16|<tuple|14.2|13>>
    <associate|auto-17|<tuple|<with|mode|<quote|math>|D<rsup|n>f>|13>>
    <associate|auto-18|<tuple|<with|mode|<quote|math>|\<infty\>>-differentiability|14>>
    <associate|auto-19|<tuple|<with|mode|<quote|math>|C<rsup|n>>|18>>
    <associate|auto-2|<tuple|14.1|11>>
    <associate|auto-20|<tuple|<with|mode|<quote|math>|C<rsup|\<infty\>>>|18>>
    <associate|auto-21|<tuple|smooth functions|19>>
    <associate|auto-22|<tuple|<with|mode|<quote|math>|f<rsup|<around*|(|n|)>>>|21>>
    <associate|auto-23|<tuple|14.3|21>>
    <associate|auto-24|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|+><around*|(|x|)>>|21>>
    <associate|auto-25|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|-><around*|(|x|)>>|23>>
    <associate|auto-26|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|+>>|23>>
    <associate|auto-27|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|->>|23>>
    <associate|auto-28|<tuple|14.4|26>>
    <associate|auto-29|<tuple|local weak minimum|28>>
    <associate|auto-3|<tuple|14.1.1|11>>
    <associate|auto-30|<tuple|local weak maximum|28>>
    <associate|auto-31|<tuple|extremum|28>>
    <associate|auto-32|<tuple|Rolle's theorem|29>>
    <associate|auto-33|<tuple|Lagrange's theorem|29>>
    <associate|auto-34|<tuple|concave function|29>>
    <associate|auto-35|<tuple|convex function|29>>
    <associate|auto-36|<tuple|Fundamental Theorem of Calculus (Classical
    version)|29>>
    <associate|auto-37|<tuple|Fundamental Theorem of Calculus|29>>
    <associate|auto-38|<tuple|convex sets|31>>
    <associate|auto-39|<tuple|line segment|31>>
    <associate|auto-4|<tuple|<with|mode|<quote|math>|U<rsub|x>>|11>>
    <associate|auto-40|<tuple|<with|mode|<quote|math>|L<rsub|a,b>>|31>>
    <associate|auto-41|<tuple|14.5|31>>
    <associate|auto-42|<tuple|14.6|31>>
    <associate|auto-43|<tuple|14.7|?>>
    <associate|auto-44|<tuple|toplinear isomorphism|?>>
    <associate|auto-45|<tuple|<with|mode|<quote|math>|\<cal-G\>L<around*|(|X|)>>|?>>
    <associate|auto-46|<tuple|<with|mode|<quote|math>|H<rsup|n>>|?>>
    <associate|auto-47|<tuple|inverse function theorem|?>>
    ...
    <associate|auto-9|<tuple|derivative|11>>
    <associate|balls are convex|<tuple|14.98|445>>
    <associate|chain rule|<tuple|14.25|418>>
    <associate|chain rule (1)|<tuple|14.26|?>>
    <associate|chain rules of partial differentiable
    functions|<tuple|14.121|453>>
    <associate|composition of diffeomorphism is a
    diffeomorphism|<tuple|14.142|465>>
    <associate|composition of differentials on arbitrary
    sets|<tuple|14.77|438>>
    <associate|condition for concavity (convexitivity)|<tuple|14.91|?>>
    <associate|conditions for minimum,maximum of a function|<tuple|14.93|?>>
    <associate|consequence of Mean value theorem|<tuple|14.108|?>>
    <associate|constant functions are C^infinite|<tuple|14.57|428>>
    <associate|continuous billinear functions are
    C^infinity|<tuple|14.60|429>>
    <associate|derivative|<tuple|14.16|416>>
    <associate|derivative and composition|<tuple|14.27|?>>
    <associate|derivative and local minimum (maximum)|<tuple|14.92|?>>
    <associate|derivative is local|<tuple|14.17|?>>
    <associate|derivative on a closed interval|<tuple|14.80|?>>
    <associate|diffeomorphism are toplinear|<tuple|14.141|?>>
    ...
    differentiability|<tuple|14.120|453>>
    <associate|differentiability of K^n|<tuple|14.31|420>>
    <associate|differentiability of finite sum|<tuple|14.56|428>>
    <associate|differentiability of map to product of
    spaces|<tuple|14.32|420>>
    <associate|differentiability of product of functions|<tuple|14.36|421>>
    <associate|differentiability on [a,b]|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|-><around*|(|x|)>>|438>>
    <associate|differentiability on [a,b] equivalences|<tuple|14.81|439>>
    <associate|differentiability on products of metric
    spaces|<tuple|14.29|419>>
    <associate|differential of a billinear mapping|<tuple|14.35|421>>
    ...
    <associate|differentiation under the integral sign|<tuple|14.74|432>>
    ...
    <associate|equivalences of convexitivity (concavity)|<tuple|14.90|?>>
    <associate|extremum and derivate|<tuple|14.84|442>>
    <associate|f_v is differentiable|<tuple|14.69|431>>
    <associate|fundamental theorem of calculus|<tuple|14.95|444>>
    <associate|generalized chain rule|<tuple|14.65|430>>
    <associate|i-H has inverse if norm of H is lower then
    1|<tuple|14.135|459>>
    <associate|if f is C^n then D^1f is C^n-1|<tuple|14.51|426>>
    <associate|implicit function theorem|<tuple|14.154|470>>
    <associate|in Banach spaces linear continuous mappings are
    toplinear|<tuple|14.127|458>>
    <associate|inverse function theorem|<tuple|14.144|465>>
    <associate|inverse mapping is c-infinite|<tuple|14.137|461>>
    <associate|inverse of derivative|<tuple|14.152|?>>
    <associate|inverse theorem for Df(0)=1X|<tuple|14.145|465>>
    <associate|lagranges theorem|<tuple|14.86|443>>
    <associate|left,right derivatives|<tuple|14.79|?>>
    <associate|linear continuous mappings are C^infinity|<tuple|14.58|428>>
    <associate|linearity of (01,...*,...0n)|<tuple|14.20|417>>
    <associate|mean value theorem (3)|<tuple|14.105|?>>
    <associate|n-th derivative|<tuple|<with|mode|<quote|math>|f<rsup|<around*|(|n|)>>>|423>>
    <associate|n-times differentiability and partial
    derivatives|<tuple|14.72|432>>
    <associate|n-times differentiability implies m-times
    differentiability|<tuple|14.48|424>>
    <associate|n-times differentiability is local|<tuple|14.52|426>>
    <associate|n-times differentiability is same as n-1 times
    differentiability of DF|<tuple|14.50|425>>
    <associate|n-times differentiability of multi valued
    function|<tuple|14.62|429>>
    <associate|partial derivative definition|<tuple|14.30|420>>
    <associate|partial differential definition|<tuple|14.28|419>>
    <associate|partial differential on U|<tuple|14.118|453>>
    <associate|power of a continuous linear mapping is linear and
    continuous|<tuple|14.132|458>>
    <associate|product of n-times differentiable functions is n-times
    differentiable|<tuple|14.73|432>>
    <associate|projection map is infinite times dimensions|<tuple|14.61|429>>
    <associate|proposition 12.116|<tuple|14.146|466>>
    <associate|proposition 12.118|<tuple|14.148|467>>
    <associate|proposition 12.120|<tuple|14.150|469>>
    <associate|rolles theorem|<tuple|14.85|443>>
    <associate|second mean value theorem|<tuple|14.104|447>>
    <associate|strictly increasing function and derivative|<tuple|14.87|?>>
    <associate|sum of (01,...,*,...0n)|<tuple|14.21|417>>
    <associate|sum of C^n functions is C^n|<tuple|14.55|427>>
    <associate|sum of differentiable functions|<tuple|14.24|417>>
    <associate|sum of linear function and infinite sum|<tuple|14.134|459>>
    <associate|sum of n-times differentiable functions is n-times
    differentiable|<tuple|14.54|427>>
    <associate|symmetry of L^n+t(X;Y) based on permutations and
    transposition|<tuple|14.111|449>>
    <associate|the n-th differential is symmetric|<tuple|14.115|450>>
    <associate|toplinear in normed space|<tuple|14.126|457>>
    <associate|translations are C-infinity|<tuple|14.59|428>>
