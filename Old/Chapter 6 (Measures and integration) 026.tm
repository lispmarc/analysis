...
<\body>
  ...
  <\lemma>
    ...
    then <math|\<bbb-R\><rsup|n>=<big|cup><rsub|i\<in\>\<bbb-N\>><around*|[|<around*|(|-i|)>,<around*|(|i|)>|[>>
  </lemma>
  ...
  We can noo define a outer measure based on the volume of half open
  intervals

  <\definition>
    <index|<math|\<varphi\><rsup|n>>>Let <math|n\<in\>\<bbb-N\><rsub|0>> then
    <math|\<varphi\><rsup|n>:\<cal-P\><around*|(|\<bbb-R\><rsup|n>|)>\<rightarrow\><around*|[|0,\<infty\>|]>>
    is defined by\ 

    <\equation*>
      \<varphi\><around*|(|R|)>=inf<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|R<rsub|i>|)>\|<around*|{|R<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-R\><rsup|n><text|
      such that >R\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i>|}>|)>
    </equation*>
  </definition>
  ...
  <math|\<sigma\>>-algebra and measur on <math|\<bbb-R\><rsup|n>>
  ...
  <\definition>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|\<cal-L\><rsup|n>>|<cell|=>|<cell|<around*|{|B\<in\>\<cal-P\><around*|(|\<bbb-R\><rsup|n>|)>\|\<forall\>A\<in\>\<cal-P\><rsup|n><around*|(|\<bbb-R\><rsup|n>|)><text|
...
<\references>
  <\collection>
    ...
    <associate|Lebesgue measure space on R^n|<tuple|18.71|?>>
    <associate|Lower half spaces|<tuple|18.43|?>>
    <associate|R can be covered by open intervals|<tuple|18.62|?>>
    <associate|R^n is a unin of rectangles|<tuple|18.67|?>>
    ...
    sets|<tuple|18.39|?>>
    <associate|half spaces are Lebesgue measurable in R^n|<tuple|18.72|?>>
    ...
    <associate|outer measure on rectangles|<tuple|18.70|?>>
    ...
    <associate|volume is subadditive|<tuple|18.68|?>>
