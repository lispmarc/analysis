...
<\body>
  ...
  <\corollary>
    <label|length of a interval is increasing>Let <math|I,J\<in\>\<cal-I\>>
    with <math|I\<subseteq\>J> then <math|l<around*|(|I|)>\<leqslant\>l<around*|(|J|)>>
  </corollary>

  <\proof>
    If <math|I\<subseteq\>J> then if we define
    <math|<around*|{|J<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,|}>>> by
    <math|J<rsub|i>=J> we have using <smart-ref|length is semi-additive>
    <math|l<around*|(|I|)>\<leqslant\><big|sum><rsub|i=1><rsup|1>l<around*|(|J<rsub|i>|)>=l<around*|(|J<rsub|1>|)>=l<around*|(|J|)>>
  </proof>
  ...
  <\lemma>
    ...
    is well defined and a outer measure on <math|\<bbb-R\>>. Further
  ...
  <\proof>
    ...
    <math|A\<in\>\<cal-P\><around*|(|X|)>>. Note that as
    <math|\<forall\>n\<in\>\<bbb-N\>> we have
    <math|<around*|[|-n,n|[>\<subseteq\>\<bbb-R\>> it follows that
    <math|<big|cup><rsub|n\<in\>\<bbb-N\>><around*|[|-n,n|[>\<subseteq\>\<bbb-R\>>,
    further if <math|x\<in\>\<bbb-R\>> then using <reference|consequence of
    the archimedean property for the reals> there exists a
    <math|n\<in\>\<bbb-N\>> such that <math|x,-x\<less\>n\<Rightarrow\>-n\<less\>x\<less\>n>
    and thus <math|x\<in\><around*|[|-n,n|[>> hence
    <math|\<bbb-R\>\<subseteq\><around*|[|-n,n|[>>. So
    <math|\<bbb-R\>=<big|cup><rsub|n\<in\>\<bbb-N\>><around*|[|-n,n|[>> which
    proves that <math|\<forall\>A\<in\>\<cal-P\><around*|(|X|)>> we have
    <math|> <math|><math|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-I\>
    such that A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>|}>\<neq\>\<emptyset\>>
    hence <math|\<varphi\><around*|(|A|)>> is defined [as <math|0> is a lower
    bound for <math|inf<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-I\>
    such that A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>|}>|)>>
    and <math|\<bbb-R\>> is conditional complete (see <smart-ref|the reals
    are conditional complete>)]. As <math|0\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>>
    we also have that <math|\<varphi\><around*|(|A|)>\<in\><around*|[|0,\<infty\>|]>>.

    Next we must check the conditions for a outer measure.\ 

    <\enumerate>
      <item>Define <math|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>> by
      <math|I<rsub|i>=\<emptyset\>> then <math|\<emptyset\>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>>
      and as <math|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>=0>
      we have that <math|0\<leqslant\><around*|\<nobracket\>|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-I\>
      such that A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>|}>0>.
      Hence

      <\equation>
        <label|eq 18.70.001>\<varphi\><around*|(|\<emptyset\>|)>=0
      </equation>

      <item>Let <math|A,B\<in\>\<cal-P\><around*|(|X|)>> with
      <math|A\<subseteq\>B> then if <math|B\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>>
      we have that <math|A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>>
      hence <math|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-I\>
      with B\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>|}>\<subseteq\><around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-I\>
      with A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>|}>>. So
      using <reference|inclusion and sup and inf> we have that
      <math|inf<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-I\>
      with A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>|}>|)>\<leqslant\>inf<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-I\>
      with B\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>|}>|)>> or\ 

      <\equation>
        <label|eq 18.71.001>\<forall\>A,B\<in\>\<cal-P\><around*|(|X|)> with
        A\<subseteq\>B we have \<varphi\><around*|(|A|)>\<leqslant\>\<varphi\><around*|(|B|)>
      </equation>
      ...
      <math|\<varphi\>> and the infinum there exists
      <math|\<forall\>n\<in\>\<bbb-N\>> a sequence
      <math|<around*|{|I<rsub|n,i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-I\>>
      such that

      <\equation>
        <label|eq 18.72.001>\<varphi\><around*|(|A<rsub|n>|)>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|n,i>|)>\<less\>\<varphi\><around*|(|A<rsub|n>|)>+<frac|\<varepsilon\>|2<rsup|n>>
      </equation>

      and <math|A<rsub|n>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|n,i>>.
      As <math|\<bbb-N\>\<times\>\<bbb-N\>> is denumerable (infinite
      ...
      <\equation>
        <label|eq 18.73.001>A\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\>>I<rsub|\<varphi\><around*|(|n|)><rsub|1>\<varphi\><around*|(|n|)><rsub|2>>
      </equation>

      <\proof>
        If <math|x\<in\>A> then <math|\<exists\>n\<in\>\<bbb-N\>> such that
        <math|x\<in\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|n,i>> so that
        <math|\<exists\>i\<in\>\<bbb-N\>> such that
        <math|x\<in\>I<rsub|n,i>>. As <math|\<varphi\>> is a bijection, hence
        surjective, there exists a <math|m\<in\>\<bbb-N\>> such that
        <math|\<varphi\><around*|(|m|)>=<around*|(|n,i|)>> so that
        <math|x\<in\>I<rsub|\<varphi\><around*|(|m|)><rsub|1>,\<varphi\><around*|(|m|)><rsub|2>>\<subseteq\><big|cup><rsub|m\<in\>\<bbb-N\>>I<rsub|\<varphi\><around*|(|m|)><rsub|1>,\<varphi\><around*|(|m|)><rsub|2>>>
      </proof>

      Now\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|\<varphi\><around*|(|A|)>>|<cell|=>|<cell|inf<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-I\>
        where A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>|}>|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|eq
        18.73.001>>>>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|\<varphi\><around*|(|i|)><rsub|1>,\<varphi\><around*|(|i|)><rsub|2>>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|countable
        sum of countable sums is a countable
        sum>>>>|<cell|<big|sum><rsup|\<infty\>><rsub|i=1><around*|(|<big|sum><rsub|j=1><rsup|\<infty\>>l<around*|(|I<rsub|i,j>|)>|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|eq
        18.72.001>>>>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>><around*|(|\<varphi\><around*|(|A<rsub|i>|)>+<frac|\<varepsilon\>|2<rsup|i>>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|sum
        ...
        of a convergent serie>>>>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>\<varphi\><around*|(|A<rsub|i>|)>+\<varepsilon\>\<cdot\><frac|<frac|1|2>|1-<frac|1|2>>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>\<varphi\><around*|(|A<rsub|i>|)>>>>>
      </eqnarray*>
      ...
      Using <reference|eq 18.70.001>,<reference|eq 18.71.001> and the above
      proves that\ 

      <\equation*>
        \<varphi\> is a outer measure on \<bbb-R\>
      </equation*>

      For the last part of the theorem let <math|\<cal-I\>> define then
      <math|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>> by
      <math|I<rsub|i>=<choice|<tformat|<table|<row|<cell|I if
      i=1>>|<row|<cell|\<emptyset\> if i\<in\>\<bbb-N\>\\<around*|{|1|}>>>>>>>
      then clearly <math|I\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>>
      and <math|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>=l<around*|(|I|)>>
      so that <math|\<varphi\><around*|(|I|)>\<leqslant\>l<around*|(|I|)>>.
      Further if <math|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-P\><around*|(|\<bbb-R\>|)>>
      is such that <math|I\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>>
      then using <reference|length is semi-additive> we have that
      <math|\<lambda\><around*|(|I|)>\<leqslant\><big|sum><rsub|i\<in\>\<bbb-N\>>I<rsub|i>>
      so that <math|\<lambda\><around*|(|I|)>\<leqslant\>\<varphi\><around*|(|I|)>>.
      Hence we have \ <math|<text|>>

      <\equation*>
        \<forall\>I\<in\>\<cal-I\> we have
        \<varphi\><around*|(|I|)>=l<around*|(|i|)>
      </equation*>
    </enumerate>
  </proof>
  ...
  <\definition>
    ...
    <math|\<varphi\>=<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>
    where A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>|}>> be the
    outer measure from the previous lemma then the <math|\<sigma\>>-algebra
    defined by the Carathéodory method <math|<around*|{|E\<in\>\<cal-P\><around*|(|X|)>\|\<forall\>A\<in\>\<cal-P\><around*|(|X|)>
  ...
  <\lemma>
    Let <math|n\<in\>\<bbb-N\>>, <math|R\<in\>\<cal-R\><rsup|n>> and
...
<\references>
  <\collection>
    <associate|18.98.001|<tuple|18.98|?>>
    ...
    <associate|Caratheodory|<tuple|18.29|?>>
    ...
    <associate|boundary of a interval|<tuple|18.35|?>>
    <associate|bounds of a half open interval|<tuple|18.34|?>>
    ...
    <associate|eq 18.100.001|<tuple|18.101|?>>
    <associate|eq 18.100.001.2|<tuple|18.100|?>>
    <associate|eq 18.101.001|<tuple|18.102|?>>
    <associate|eq 18.102.001|<tuple|18.104|?>>
    <associate|eq 18.102.001.1|<tuple|18.103|?>>
    <associate|eq 18.103.001|<tuple|18.105|?>>
    <associate|eq 18.104.001|<tuple|18.106|?>>
    <associate|eq 18.105.001|<tuple|18.107|?>>
    <associate|eq 18.106.001|<tuple|18.108|?>>
    <associate|eq 18.107.001|<tuple|18.109|?>>
    <associate|eq 18.108.001|<tuple|18.110|?>>
    <associate|eq 18.11.001|<tuple|18.12|?>>
    <associate|eq 18.110.001|<tuple|18.112|?>>
    <associate|eq 18.111.001|<tuple|18.113|?>>
    <associate|eq 18.112.001|<tuple|18.114|?>>
    <associate|eq 18.113.001|<tuple|18.115|?>>
    <associate|eq 18.114.001|<tuple|18.116|?>>
    <associate|eq 18.115.001|<tuple|18.117|?>>
    <associate|eq 18.116.001|<tuple|18.118|?>>
    <associate|eq 18.117.001|<tuple|18.119|?>>
    <associate|eq 18.119.001.1|<tuple|18.120|?>>
    ...
    <associate|eq 18.16.001|<tuple|18.17|?>>
    <associate|eq 18.17.001|<tuple|18.18|?>>
    <associate|eq 18.18.001|<tuple|18.19|?>>
    <associate|eq 18.19.001|<tuple|18.20|?>>
    <associate|eq 18.20.001|<tuple|18.21|?>>
    <associate|eq 18.21.001|<tuple|18.22|?>>
    <associate|eq 18.22.001|<tuple|18.23|?>>
    <associate|eq 18.23.001|<tuple|18.24|?>>
    <associate|eq 18.24.001|<tuple|18.25|?>>
    <associate|eq 18.25.001|<tuple|18.26|?>>
    <associate|eq 18.26.001|<tuple|18.27|?>>
    <associate|eq 18.27.001|<tuple|18.28|?>>
    <associate|eq 18.28.001|<tuple|18.29|?>>
    <associate|eq 18.29.001|<tuple|18.30|?>>
    <associate|eq 18.3.001|<tuple|18.5|?>>
    <associate|eq 18.30.001|<tuple|18.31|?>>
    <associate|eq 18.31.001|<tuple|18.32|?>>
    <associate|eq 18.32.001|<tuple|18.33|?>>
    <associate|eq 18.33.001|<tuple|18.34|?>>
    <associate|eq 18.34.001|<tuple|18.35|?>>
    <associate|eq 18.35.001|<tuple|18.36|?>>
    <associate|eq 18.36.001|<tuple|18.37|?>>
    <associate|eq 18.37.001|<tuple|18.38|?>>
    <associate|eq 18.38.001|<tuple|18.39|?>>
    <associate|eq 18.39.001|<tuple|18.40|?>>
    <associate|eq 18.4.001|<tuple|18.6|?>>
    <associate|eq 18.4.001.1|<tuple|18.4|?>>
    <associate|eq 18.40.001|<tuple|18.41|?>>
    <associate|eq 18.41.001|<tuple|18.42|?>>
    <associate|eq 18.42.001|<tuple|18.43|?>>
    <associate|eq 18.43.001|<tuple|18.44|?>>
    <associate|eq 18.44.001|<tuple|18.45|?>>
    <associate|eq 18.45.001|<tuple|18.46|?>>
    <associate|eq 18.46.001|<tuple|18.47|?>>
    <associate|eq 18.47.001|<tuple|18.48|?>>
    <associate|eq 18.48.001|<tuple|18.49|?>>
    <associate|eq 18.49.001|<tuple|18.50|?>>
    <associate|eq 18.5.001|<tuple|18.7|?>>
    <associate|eq 18.50.001|<tuple|18.51|?>>
    <associate|eq 18.51.001|<tuple|18.52|?>>
    <associate|eq 18.52.001|<tuple|18.53|?>>
    <associate|eq 18.53.001|<tuple|18.54|?>>
    <associate|eq 18.54.001|<tuple|18.55|?>>
    <associate|eq 18.55.001|<tuple|18.56|?>>
    <associate|eq 18.56.001|<tuple|18.57|?>>
    <associate|eq 18.57.001|<tuple|18.58|?>>
    <associate|eq 18.58.001|<tuple|18.59|?>>
    <associate|eq 18.59.001|<tuple|18.60|?>>
    <associate|eq 18.6.001|<tuple|18.8|?>>
    <associate|eq 18.60.001|<tuple|18.61|?>>
    <associate|eq 18.61.001|<tuple|18.62|?>>
    <associate|eq 18.62.001|<tuple|18.63|?>>
    <associate|eq 18.62.001.1|<tuple|18.64|?>>
    <associate|eq 18.63.001|<tuple|18.65|?>>
    <associate|eq 18.64.001|<tuple|18.66|?>>
    <associate|eq 18.65.001|<tuple|18.67|?>>
    <associate|eq 18.66.001|<tuple|18.68|?>>
    <associate|eq 18.67.001|<tuple|18.69|?>>
    <associate|eq 18.69.001|<tuple|18.70|?>>
    <associate|eq 18.7.001|<tuple|18.9|?>>
    <associate|eq 18.70.001|<tuple|18.71|?>>
    <associate|eq 18.71.001|<tuple|18.72|?>>
    <associate|eq 18.72.001|<tuple|18.73|?>>
    <associate|eq 18.73.001|<tuple|18.74|?>>
    <associate|eq 18.74.001|<tuple|18.75|?>>
    <associate|eq 18.75.001|<tuple|18.78|?>>
    <associate|eq 18.76.001|<tuple|18.76|?>>
    <associate|eq 18.77.001|<tuple|18.77|?>>
    <associate|eq 18.78.001|<tuple|18.79|?>>
    <associate|eq 18.79.001|<tuple|18.80|?>>
    <associate|eq 18.8.001|<tuple|18.10|?>>
    <associate|eq 18.80.001|<tuple|18.81|?>>
    <associate|eq 18.81.001|<tuple|18.82|?>>
    <associate|eq 18.82.001|<tuple|18.83|?>>
    <associate|eq 18.83.001|<tuple|18.84|?>>
    <associate|eq 18.84.001|<tuple|18.85|?>>
    <associate|eq 18.85.001|<tuple|18.86|?>>
    <associate|eq 18.86.001|<tuple|18.87|?>>
    <associate|eq 18.87.001|<tuple|18.88|?>>
    <associate|eq 18.88.001|<tuple|18.89|?>>
    <associate|eq 18.89.001|<tuple|18.90|?>>
    <associate|eq 18.90.001|<tuple|18.91|?>>
    <associate|eq 18.91.001|<tuple|18.92|?>>
    <associate|eq 18.92.001|<tuple|18.93|?>>
    <associate|eq 18.93.001|<tuple|18.94|?>>
    <associate|eq 18.94.001|<tuple|18.95|?>>
    <associate|eq 18.95.001|<tuple|18.96|?>>
    <associate|eq 18.96.001|<tuple|18.97|?>>
    <associate|eq 18.99.001|<tuple|18.99|?>>
    <associate|functions and a.e.|<tuple|18.26|?>>
    <associate|half open interval|<tuple|18.32|?>>
    ...
    <associate|length is semi-additive|<tuple|18.38|?>>
    <associate|length of a interval is increasing|<tuple|18.39|?>>
    ...
    <associate|outer measure induced by a measure|<tuple|18.30|?>>
    ...
    <associate|subspace measure|<tuple|18.31|?>>
