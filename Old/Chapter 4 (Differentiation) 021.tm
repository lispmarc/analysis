...
<\body>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <item>There exists a linear function <math|D
      f<around*|(|x|)>:X\<rightarrow\>Y> such that
      <math|\<forall\><around*|{|h<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|<around*|{|h<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>> be a
  ...
  <\definition>
    ...
    normed space, <math|U\<subseteq\>\<bbb-K\>> a open set, <math|x\<in\>U>,
    <math|V\<subseteq\>Y> and a function <math|f:U\<rightarrow\>V> then
    <math|f> has a <with|font-series|bold|derivative> at <math|x> noted by
  ...
  Just like the differential we can prove that the derivative is a local
  property.
  ...
  <\theorem>
    ...
    set, <math|V\<subseteq\>Y>, a function <math|f:U\<rightarrow\>V> and
    <math|W\<subseteq\>U> a open set with <math|x\<in\>W> then <math|f> has a
    derivative at <math|x> if and only of <math|f<rsub|\|W>> has a derivative
    at <math|x> and <math|<around*|(|f<rsub|\|W>|)><rprime|'><around*|(|x|)>=f<rprime|'><around*|(|x|)>>
  </theorem>

  <\proof>
    \ First assume that <math|f> has a derivative
    <math|f<rprime|'><around*|(|x|)>> then given
    <math|\<varepsilon\>\<gtr\>0> there exists a <math|\<delta\>\<gtr\>0>
    such that <math|\<forall\>h\<in\>U<rsub|x>> with
    <math|0\<less\><around*|\||h|\|>\<less\>\<delta\>> we have
    <math|<around*|\<\|\|\>|<frac|f<around*|(|x+h|)>-f<around*|(|x|)>|h>-f<rprime|'><around*|(|x|)>|\<\|\|\>>\<leqslant\>\<varepsilon\>>.
    If then <math|h\<in\>W<rsub|x>\<subseteq\>U<rsub|x>> with
    <math|0\<less\><around*|\||h|\|>\<less\>\<delta\>> we have
    <math|><math|<around*|\<\|\|\>|<frac|f<rsub|\|W><around*|(|x+h|)>-f<rsub|\|W><around*|(|x|)>|h>-f<rprime|'><around*|(|x|)>|\<\|\|\>>=<around*|\<\|\|\>|<frac|f<around*|(|x+h|)>-f<around*|(|x|)>|h>-f<rprime|'><around*|(|x|)>|\<\|\|\>>\<leqslant\>\<varepsilon\>>
    proving that <math|f<rsub|\|W>> has the derivative
    <math|f<rprime|'><around*|(|x|)>>. Second assume that <math|f<rsub|\|W>>
    has a derivative \ <math|> <math|f<rsub|\|W><rprime|'><around*|(|x|)>>
    then given <math|\<varepsilon\>\<gtr\>0> there exists a
    <math|\<delta\><rsub|1>\<gtr\>0> such that
    <math|\<forall\>h\<in\>W<rsub|x>> with
    <math|0\<less\><around*|\||h|\|>\<less\>\<delta\><rsub|1>> we have
    <math|<around*|\<\|\|\>|<frac|f<rsub|\|W><around*|(|x+h|)>-f<rsub|\|W><around*|(|x|)>|h>-f<rprime|'><around*|(|x|)>|\<\|\|\>>\<leqslant\>\<varepsilon\>>.
    As <math|x\<in\>W\<subseteq\>U> a open set there exists a
    <math|\<delta\><rsub|2>\<gtr\>0> such that
    <math|x\<in\>B<rsub|<around*|\|||\|>><around*|(|x,\<delta\><rsub|2>|)>\<subseteq\>W>,
    so if <math|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<leqslant\>\<delta\><rsub|2>
    then <around*|\<\|\|\>|x+h-x|\<\|\|\>><rsub|X>=<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|2>\<Rightarrow\>x+h\<in\>B<rsub|<around*|\|||\|>><around*|(|x,\<delta\><rsub|2>|)>\<subseteq\>W>
    or in other words if <math|<around*|\||h|\|>\<less\>\<delta\><rsub|2>>
    then <math|h\<in\>W<rsub|x>>. Take <math|\<delta\>=min<around*|(|\<delta\><rsub|1>,\<delta\><rsub|2>|)>>
    then if <math|h\<in\>U<rsub|x>> and <math|0\<less\><around*|\||h|\|>\<less\>\<delta\>>
    we have <math|x\<in\>W<rsub|x>> and <math|0\<less\><around*|\||h|\|>\<less\>\<delta\><rsub|1>>
    so that <math|<around*|\<\|\|\>|<frac|f<around*|(|x+h|)>-f<around*|(|x|)>|h>-f<rprime|'><around*|(|x|)>|\<\|\|\>>=<around*|\<\|\|\>|<frac|f<rsub|\|W><around*|(|x+h|)>-f<rsub|\|W><around*|(|x|)>|h>-f<rsub|\|W><rprime|'><around*|(|x|)>|\<\|\|\>>\<leqslant\>\<varepsilon\>>
    proving that <math|f> has the derivative <math|f<rsub|\|W><rprime|'>> at
    <math|x>.
  </proof>
  ...
  <\corollary>
    ...
    functions such that <math|f<around*|(|U|)>\<subseteq\>V>, <math|f> has a
    derivate on every point in <math|U> and <math|g> has a derivative on
    every point of <math|V> then <math|g\<circ\>f> has a derivate on every
    point of <math|U> such that <math|\<forall\>x\<in\>U> we have
    <math|<around*|(|g\<circ\>f|)><rprime|'><around*|(|x|)>=g<rprime|'><around*|(|f<around*|(|x|)>|)>\<cdot\>f<rprime|'><around*|(|x|)>>
  </corollary>

  <\proof>
    Using <reference|differentias and derivates> we have that <math|f,g> are
    differentiable on <math|U>,<math|V> such that <math|\<forall\>x\<in\>D
    f<around*|(|x|)>> is defined by <math|<around*|(|D
    f<around*|(|x|)>|)><around*|(|t|)>=f<rprime|'><around*|(|x|)>\<cdot\>t>
    and <math|<around*|(|D g<around*|(|x|)>|)><around*|(|t|)>=g<rprime|'><around*|(|x|)>\<cdot\>t>.
    Using the above corollary we have then that <math|g\<circ\>f> is
    differentiable on <math|U> and <math|D
    <around*|(|g\<circ\>f|)><around*|(|x|)>=D
    g<around*|(|f<around*|(|x|)>|)>\<circ\>D f<around*|(|x|)>>. Proving using
    <reference|differentias and derivates> that <math|g\<circ\>f> has a
    derivate on every point in <math|U> and
    <math|<around*|(|g\<circ\>f|)><rprime|'><around*|(|x|)>=<around*|(|D
    g<around*|(|f<around*|(|x|)>|)>\<circ\>D
    f<around*|(|x|)>|)><around*|(|1|)>=<around*|(|D
    g<around*|(|f<around*|(|x|)>|)>|)><around*|(|<around*|(|D
    f<around*|(|x|)>|)><around*|(|1|)>|)>=<around*|(|D
    g<around*|(|f<around*|(|x|)>|)>|)><around*|(|1\<cdot\>f<rprime|'><around*|(|x|)>|)>=<around*|(|D
    g<around*|(|f<around*|(|x|)>|)>|)><around*|(|f<rprime|'><around*|(|x|)>|)>=g<rprime|'><around*|(|f<around*|(|x|)>|)>\<cdot\>f<rprime|'><around*|(|x|)>>
  </proof>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|z\<in\>\<bbb-N\>>>We proceed here by
      induction so let <math|S=<around*|{|z\<in\>\<bbb-N\>\|\<ast\><rsup|z>
      ...
      <item><dueto|<math|z\<in\><around*|{|-z\|z\<in\>\<bbb-N\>|}>>>again
      we prove this by induction so let <math|S=<around*|{|z\<in\>\<bbb-N\>\|\<ast\><rsup|-z>
  ...
  <\definition>
    ...
    <math|n\<in\>\<bbb-N\>> and <math|f:U\<rightarrow\>V> a function
  ...
  <\definition>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
    <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>V> a function then
  ...
  <\definition>
    ...
    <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> we have that <math|f> is of class
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|\<Rightarrow\>>>If <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>>
      ...
      and thus <math|C<rsup|0>>. If <math|n\<in\>\<bbb-N\>> we have
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
    , <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>V> a function that
  ...
  <\proof>
    ...
    By mathematical induction we have then that <math|S<rsub|n>=\<bbb-N\><rsub|0>>.
    So if <math|m\<in\><around*|{|1,\<ldots\>,n|}>> then
    <math|i=n-m\<in\><around*|{|0,\<ldots\>,n-1|}>> proving as
    <math|i\<in\>\<bbb-N\><rsub|0>=S<rsub|n>> and <math|0\<leqslant\>i\<less\>n> that
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|V\<subseteq\>Y>, <math|n\<in\>\<bbb-N\>\\<around*|{|1|}>>
  ...
  <\proof>
    ...
    <\description>
      ...
      By induction we have then <math|S=\<bbb-N\>\\<around*|{|1|}>>
      porving the theorem.
      ...
      Induction prove then that <math|S=\<bbb-N\>\\<around*|{|1|}>>
    </description>
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
    a open set, <math|n\<in\>\<bbb-N\>> and <math|f:U\<rightarrow\>Y>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|W\<subseteq\>Y>, <math|n\<in\>\<bbb-N\>> and
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|S=<around*|{|i\<in\>\<bbb-N\>\|if i\<leqslant\>n\|if
      ...
      <math|S=<around*|{|n\<in\>\<bbb-N\>\|if \<forall\>x\<in\>u
      ...
      induction proves then that <math|S=\<bbb-N\>> finishing the
      proof.
    </enumerate>
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|n\<in\>\<bbb-N\><rsub|0>> , <math|W\<subset\>Y> and
    <math|f:U\<rightarrow\>W> a function then:
  ...
  <\theorem>
    ...
    <math|n\<in\>\<bbb-N\>> and <math|f:U\<rightarrow\>W<rsub|f>>,
  ...
  <\proof>
    This is proved by induction so let <math|S=<around*|{|n\<in\>\<bbb-N\>\|if
  ...
  <\theorem>
    ...
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|W<rsub|f>,W<rsub|g>\<subseteq\>Y> open sets.
    <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>W<rsub|f>,g:U\<rightarrow\>W<rsub|g>>
  ...
  <\proof>
    Let <math|S=<around*|{|k\<in\>\<bbb-N\>\|if
  ...
  <\proof>
    Let <math|S=<around*|{|n\<in\>\<bbb-N\>\|D<rsup|n>C<rsub|U,y>
    ...
    By induction we have <math|S=\<bbb-N\>> proving our theorem.
  </proof>
  ...
  <\proof>
    ...
    <math|n\<in\>\<bbb-N\>> then we have the following cases to
    consider:
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      Using mathematical induction we have that <math|S=\<bbb-N\>>
      proving the theorem.
    </enumerate>
  </proof>
  ...
  <\proof>
    ...
    <math|S=<around*|{|n\<in\>\<bbb-N\>\| if f:U\<rightarrow\>Y is
  ...
  <\lemma>
    ...
    <math|n\<in\>\<bbb-N\>,n\<gtr\>1> \ and <math|f:U\<rightarrow\>Y>
  ...
  <\lemma>
    ...
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>be
    normed space, <math|n\<in\>\<bbb-N\>>, <math|f:U\<rightarrow\>Y>
  ...
  <\theorem>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>>] and <math|f,g:U\<rightarrow\>\<bbb-K\>> are
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|S=<around*|{|r\<in\>\<bbb-N\>\|if f is function
      ...
      by induction we have then that <math|S=\<bbb-N\>> which proves
      our little theorem.
    </enumerate>
  </proof>
  ...
  <\proof>
    ...
    so take <math|S=<around*|{|r\<in\>\<bbb-N\>\|if r\<leqslant\>n
  ...
  <\proof>
    ...
    <\description>
      ...
      hypothese we have that <math|f> is convex [or concave] on
  ...
  <\proof>
    ...
    <\description>
      ...
      <math|m\<in\>\<bbb-N\><rsub|0>> such that <math|\<sigma\>=\<rho\><around*|(|m|)>>
  ...
  <\theorem>
    ...
    <math|n\<in\>\<bbb-N\>> and <math|f:U\<rightarrow\>Y> a function
  ...
  <\proof>
    ...
    By mathematical induction we have then <math|S=\<bbb-N\>> proving
    our theorem.
  </proof>
  ...
  <\proof>
    ...
    Mathematical induction proves then that <math|S=\<bbb-N\>> and
    our theorem
  </proof>
  ...
  <\proof>
    Let <math|S=<around*|{|n\<in\>\<bbb-N\>\|if
  ...
  <\lemma>
    ...
    <math|n\<in\>\<bbb-N\>> then <math|H<rsup|n>:X\<rightarrow\>X> is
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|S=<around*|{|n\<in\>\<bbb-N\>\|H<rsup|n> is linear|}>>
      then we have
      ...
      let <math|S=<around*|{|n\<in\>\<bbb-N\>\|H<rsup|n> is
  ...
  <\proof>
    ...
    <\proof>
      ...
      Using induction we have that <math|S=\<bbb-N\>> so that
    ...
    <reference|eq 12.66> there exists a <math|N\<in\>\<bbb-N\>> such
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        By mathematical induction we have that <math|S=\<bbb-N\>> and
  ...
  <\definition>
    ...
    diffeomorphism (of class <math|C<rsup|r>>, <math|r\<in\>\<bbb-N\><rsub|0>>) if
    and only if <math|f:U\<rightarrow\>V,f<rsup|-1>:V\<rightarrow\>U> are
    differentiable on <math|U,V> [of class
    <math|C<rsup|r>\<nocomma\>\<nocomma\>>, <math|r\<in\>\<bbb-N\><rsub|0>>]
  </definition>
  ...
  <\proof>
    ...
    <\proof>
      ...
      <math|S=<around*|{|n\<in\>\<bbb-N\>\|if n\<leqslant\>r then g
      is C<rsup|n>|}>> then we have\ 
      ...
      <math|r\<in\>\<bbb-N\>=S> and <math|r\<leqslant\>r> we have
  ...
  <\corollary>
    ...
    has a derivative <math|<around*|(|f<rsub|\|U<rprime|'>><rsup|-1>|)><rprime|'><rsub|><around*|(|x|)>>
  ...
  <\proof>
    As the existance of a derivative at a point implies differentiability at
    ...
    <math|<around*|(|f<rsup|-1>|)><rsub|\|V<rprime|'>>> has a derivative at
  ...
  <\theorem>
    ...
    <\theorem>
      ...
      be Banach spaces, <math|U\<subseteq\>X>, <math|V\<subseteq\>Y> be open
      sets and let <math|f:U\<times\>V\<rightarrow\>Z> be a differentiable
      function of class <math|C<rsup|r>,r\<in\>\<bbb-N\>>. Assume
...
<\references>
  <\collection>
    <associate|(01,..,*,..,On) is C@@|<tuple|14.116|452>>
    <associate|(x,h)-\<gtr\>Df(x)(h) differentiability|<tuple|14.70|432>>
    <associate|(x1,..,xi-1,*,xi+1,..,xn)|<tuple|14.19|417>>
    <associate|(x1,..,xi-1,*,xi+1,..,xn)^-1(U)|<tuple|14.23|?>>
    <associate|(x1,...,*,...) is differentiable|<tuple|14.22|417>>
    <associate|C1 of real or complex function|<tuple|14.45|423>>
    <associate|C^2 differential is symmetric|<tuple|14.108|447>>
    <associate|C^@@=@@-times differentiable|<tuple|14.46|424>>
    <associate|C^n implies C^m|<tuple|14.48|424>>
    <associate|C^n is a local property|<tuple|14.52|427>>
    <associate|C^n of multivalued functions|<tuple|14.62|430>>
    <associate|D^2g(x)(u)(v)=D^nf(x)(v:u:v1..vn-2)|<tuple|14.112|450>>
    <associate|D^nf(x)(h1:..hn)=D^(n-1)f(x)(h1:..hn-1)(hn)|<tuple|14.69|431>>
    <associate|Dh(x)(u)=D^nf(x)(u:v1:..:vn-1)|<tuple|14.113|450>>
    <associate|GL(X) is a group|<tuple|14.128|458>>
    <associate|I+H has inverse if norm of H is less then
    1|<tuple|14.135|461>>
    <associate|Jacobian Matrix|<tuple|14.33|421>>
    <associate|Mean Value Theorem 3|<tuple|14.102|447>>
    <associate|Mean value theorem 1|<tuple|14.95|445>>
    <associate|Mean value theorem 2|<tuple|14.98|446>>
    ...
    <associate|auto-11|<tuple|14.19|12>>
    <associate|auto-12|<tuple|14.25|12>>
    <associate|auto-13|<tuple|14.1.2|12>>
    <associate|auto-14|<tuple|14.30|12>>
    <associate|auto-15|<tuple|14.33|13>>
    <associate|auto-16|<tuple|14.2|13>>
    <associate|auto-17|<tuple|14.38|13>>
    <associate|auto-18|<tuple|14.40|14>>
    <associate|auto-19|<tuple|14.41|18>>
    <associate|auto-2|<tuple|14.1|11>>
    <associate|auto-20|<tuple|14.42|18>>
    <associate|auto-21|<tuple|14.42|19>>
    <associate|auto-22|<tuple|14.43|21>>
    <associate|auto-23|<tuple|14.3|21>>
    <associate|auto-24|<tuple|14.77|21>>
    <associate|auto-25|<tuple|14.77|23>>
    <associate|auto-26|<tuple|14.77|23>>
    <associate|auto-27|<tuple|14.77|23>>
    <associate|auto-28|<tuple|14.4|26>>
    <associate|auto-29|<tuple|14.82|28>>
    <associate|auto-3|<tuple|14.1.1|11>>
    <associate|auto-30|<tuple|14.82|28>>
    <associate|auto-31|<tuple|14.82|28>>
    <associate|auto-32|<tuple|14.84|29>>
    <associate|auto-33|<tuple|14.85|29>>
    <associate|auto-34|<tuple|14.87|29>>
    <associate|auto-35|<tuple|14.87|29>>
    <associate|auto-36|<tuple|14.94|29>>
    <associate|auto-37|<tuple|14.95|29>>
    <associate|auto-38|<tuple|14.96|31>>
    <associate|auto-39|<tuple|14.99|31>>
    <associate|auto-4|<tuple|14.1|11>>
    <associate|auto-40|<tuple|14.99|31>>
    <associate|auto-41|<tuple|14.5|31>>
    <associate|auto-42|<tuple|14.6|31>>
    <associate|auto-43|<tuple|14.7|?>>
    <associate|auto-44|<tuple|14.125|?>>
    <associate|auto-45|<tuple|14.127|?>>
    <associate|auto-46|<tuple|14.129|?>>
    <associate|auto-47|<tuple|14.143|?>>
    ...
    <associate|balls are convex|<tuple|14.97|445>>
    <associate|chain rule|<tuple|14.25|418>>
    <associate|chain rule (1)|<tuple|14.26|?>>
    <associate|chain rules of partial differentiable
    functions|<tuple|14.120|453>>
    <associate|composition of diffeomorphism is a
    diffeomorphism|<tuple|14.141|465>>
    <associate|composition of differentials on arbitrary
    sets|<tuple|14.76|438>>
    <associate|condition for concavity (convexitivity)|<tuple|14.90|?>>
    <associate|conditions for minimum,maximum of a function|<tuple|14.92|?>>
    <associate|consequence of Mean value theorem|<tuple|14.107|?>>
    <associate|constant functions are C^infinite|<tuple|14.56|428>>
    <associate|continuous billinear functions are
    C^infinity|<tuple|14.59|429>>
    <associate|derivative|<tuple|14.16|416>>
    <associate|derivative and composition|<tuple|14.27|?>>
    <associate|derivative and local minimum (maximum)|<tuple|14.91|?>>
    <associate|derivative is local|<tuple|14.17|?>>
    <associate|derivative on a closed interval|<tuple|14.79|?>>
    <associate|diffeomorphism are toplinear|<tuple|14.140|?>>
    ...
    differentiability|<tuple|14.119|453>>
    <associate|differentiability of K^n|<tuple|14.31|420>>
    <associate|differentiability of finite sum|<tuple|14.55|428>>
    <associate|differentiability of map to product of
    spaces|<tuple|14.32|420>>
    <associate|differentiability of product of functions|<tuple|14.35|421>>
    <associate|differentiability on [a,b]|<tuple|14.77|438>>
    <associate|differentiability on [a,b] equivalences|<tuple|14.80|439>>
    <associate|differentiability on products of metric
    spaces|<tuple|14.29|419>>
    <associate|differential of a billinear mapping|<tuple|14.34|421>>
    ...
    <associate|differentias and derivates|<tuple|14.18|416>>
    <associate|differentiation under the integral sign|<tuple|14.73|432>>
    ...
    <associate|equivalences of convexitivity (concavity)|<tuple|14.89|?>>
    <associate|extremum and derivate|<tuple|14.83|442>>
    <associate|f_v is differentiable|<tuple|14.68|431>>
    <associate|fundamental theorem of calculus|<tuple|14.94|444>>
    <associate|generalized chain rule|<tuple|14.64|430>>
    <associate|i-H has inverse if norm of H is lower then
    1|<tuple|14.134|459>>
    <associate|if f is C^n then D^1f is C^n-1|<tuple|14.50|426>>
    <associate|implicit function theorem|<tuple|14.153|470>>
    <associate|in Banach spaces linear continuous mappings are
    toplinear|<tuple|14.126|458>>
    <associate|inverse function theorem|<tuple|14.143|465>>
    <associate|inverse mapping is c-infinite|<tuple|14.136|461>>
    <associate|inverse of derivative|<tuple|14.151|?>>
    <associate|inverse theorem for Df(0)=1X|<tuple|14.144|465>>
    <associate|lagranges theorem|<tuple|14.85|443>>
    <associate|left,right derivatives|<tuple|14.78|?>>
    <associate|linear continuous mappings are C^infinity|<tuple|14.57|428>>
    <associate|linearity of (01,...*,...0n)|<tuple|14.20|417>>
    <associate|mean value theorem (3)|<tuple|14.104|?>>
    <associate|n-th derivative|<tuple|14.43|423>>
    <associate|n-times differentiability and partial
    derivatives|<tuple|14.71|432>>
    <associate|n-times differentiability implies m-times
    differentiability|<tuple|14.47|424>>
    <associate|n-times differentiability is local|<tuple|14.51|426>>
    <associate|n-times differentiability is same as n-1 times
    differentiability of DF|<tuple|14.49|425>>
    <associate|n-times differentiability of multi valued
    function|<tuple|14.61|429>>
    <associate|partial derivative definition|<tuple|14.30|420>>
    <associate|partial differential definition|<tuple|14.28|419>>
    <associate|partial differential on U|<tuple|14.117|453>>
    <associate|power of a continuous linear mapping is linear and
    continuous|<tuple|14.131|458>>
    <associate|product of n-times differentiable functions is n-times
    differentiable|<tuple|14.72|432>>
    <associate|projection map is infinite times dimensions|<tuple|14.60|429>>
    <associate|proposition 12.116|<tuple|14.145|466>>
    <associate|proposition 12.118|<tuple|14.147|467>>
    <associate|proposition 12.120|<tuple|14.149|469>>
    <associate|rolles theorem|<tuple|14.84|443>>
    <associate|second mean value theorem|<tuple|14.103|447>>
    <associate|strictly increasing function and derivative|<tuple|14.86|?>>
    <associate|sum of (01,...,*,...0n)|<tuple|14.21|417>>
    <associate|sum of C^n functions is C^n|<tuple|14.54|427>>
    <associate|sum of differentiable functions|<tuple|14.24|417>>
    <associate|sum of linear function and infinite sum|<tuple|14.133|459>>
    <associate|sum of n-times differentiable functions is n-times
    differentiable|<tuple|14.53|427>>
    <associate|symmetry of L^n+t(X;Y) based on permutations and
    transposition|<tuple|14.110|449>>
    <associate|the n-th differential is symmetric|<tuple|14.114|450>>
    <associate|toplinear in normed space|<tuple|14.125|457>>
    <associate|translations are C-infinity|<tuple|14.58|428>>
