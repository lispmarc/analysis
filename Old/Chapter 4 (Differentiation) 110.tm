...
<\body>
  ...
  <\theorem>
    ...
    open, <math|i\<in\><around*|{|1,\<ldots\>,n|}>> and
    <math|f:U\<rightarrow\>Y> a function with a <math|i>-partial differential
    on <math|U>, <math|f<around*|(|U|)>\<subseteq\>V> a open set in <math|Y>,
    <math|g:V\<rightarrow\>Z> a differentiable function on <math|V> then
  ...
  <\proof>
    As <math|<around*|(|g\<circ\>f|)>\<circ\><around*|(|i\<rightarrow\>x|)>=g\<circ\><around*|(|f\<circ\><around*|(|i\<rightarrow\>x|)>|)>>
    and <math|g> and <math|<around*|(|f\<circ\><around*|(|i\<rightarrow\>x|)>|)>>
    are differentiable it follows from the chain rule <reference|generalized
    chain rule> that <math|<around*|(|g\<circ\>f|)>\<circ\><around*|(|i\<rightarrow\>x|)>>.
    Further\ 
  ...
  <\corollary>
    ...
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|n\<in\>\<bbb-N\>> and <math|f:U\<rightarrow\>Y> a function then
    <math|f> is of class <math|C<rsup|\<infty\>>> if and only if
    <math|D<rsup|1>f> exists and is of class <math|C<rsup|\<infty\>>>
  </corollary>
  ...
  <\corollary>
    ...
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be Banach spaces, a open set <math|U\<subseteq\>X>, a open ball
    ...
    <\proof>
      ...
      <math|L=<around*|{|y+t\<cdot\><around*|(|z-y|)>\|t\<in\><around*|[|0,1|]>|}>\<subseteq\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,\<delta\>|)>\<subseteq\>U>
      so that using <math|><reference|consequence of Mean value theorem> we
      have that <math|sup<around*|(|<around*|{|<around*|\<\|\|\>|D
      f<around*|(|y+t\<cdot\><around*|(|z-y|)>|)>|\<\|\|\>>\|t\<in\><around*|[|0,1|]>|}>|)>>
      exists and <math|<around*|\<\|\|\>|f<around*|(|z|)>-f<around*|(|y|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|z-y|\<\|\|\>><rsub|X>\<cdot\>sup<around*|(|<around*|{|<around*|\<\|\|\>|D
      f<around*|(|y+t\<cdot\><around*|(|z-y|)>|)>|\<\|\|\>>\|t\<in\><around*|[|0,1|]>|}>|)>>.
    </proof>
  </corollary>
  ...
  <\definition>
    ...
    and <math|<around*|{|i<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,m|}>>\<subseteq\><around*|{|1,\<ldots\>,n|}>>
    then we say that <math|f> has a higher order partial differential
    \ <math|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f:U\<rightarrow\>L<rsup|m><around*|(|X<rsub|i<rsub|m>>,\<ldots\>,X<rsub|i<rsub|1>>;Y|)>>
    of order <math|m> on <math|U> if either

    <\description>
      <item*|<math|m=1>><math|\<forall\>x\<in\>U> <math|f> has a partial
      differential <math|D<rsub|i<rsub|1>>f<around*|(|x|)>\<in\>L<around*|(|X<rsub|1>,\<ldots\>,X<rsub|i<rsub|1>>;Y|)>>
      [see <reference|partial differential definition>] and
      <math|D<rsub|i<rsub|1>,\<ldots\>,i<rsub|i<rsub|1>>><rsup|1>f:X\<rightarrow\>L<around*|(|X<rsub|i<rsub|1>>;Y|)>\<equallim\><rsub|<text|<reference|L^n(X1,..,Xn;),L(Xn+1,Y))=L^n+1(X1,..,Xn+1;Y)>>>L<around*|(|X<rsub|i<rsub|1>>,Y|)>>
      is defined by <math|D<rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>=D<rsub|i<rsub|1>>f<around*|(|x|)>>

      <item*|<math|m\<gtr\>1>><math|f> has a higher order partial
      differential <math|D<rsup|m-1><rsub|i<rsub|m-1>,\<ldots\>,i<rsub|1>>f:X\<rightarrow\>L<rsup|m-1><around*|(|X<rsub|i<rsub|m-1>>,\<ldots\>,X<rsub|1>;Y|)>>
      of order <math|m-1> on <math|U> such that <math|\<forall\>x\<in\>U>
      <math|D<rsup|m-1><rsub|i<rsub|m-1>,\<ldots\>,i<rsub|1>>f> has a partial
      differential <math|D<rsub|i<rsub|m>><around*|(|D<rsup|m-1><rsub|i<rsub|m-1>,\<ldots\>,i<rsub|1>>f|)><around*|(|x|)>\<in\>L<around*|(|X<rsub|m>,L<rsup|m-1><around*|(|X<rsub|m-1>,\<ldots\>,X<rsub|1>;Y|)>|)>\<equallim\><rsub|<text|<reference|L^n(X1,...,Xn;Y)>>>L<rsup|m><around*|(|X<rsub|m>,\<ldots\>,X<rsub|1>;Y|)>>
      and <math|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f:X\<rightarrow\>L<rsup|m><around*|(|X<rsub|m>,\<ldots\>,X<rsub|1>;Y|)>>
      is defined by <math|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>=D<rsub|i<rsub|m>><around*|(|D<rsup|m-1><rsub|i<rsub|m-1>,\<ldots\>,i<rsub|1>>f|)><around*|(|x|)>>
    </description>
  </definition>
  ...
  <\notation>
    ...
    as <math|D<rsup|1><rsub|i<rsub|1>>f>. Further if
    <math|\<forall\>j\<in\><around*|{|1,\<ldots\>,m|}>>
    <math|i<rsub|j>=k\<in\><around*|{|1,\<ldots\>,n|}>> then we write
    <math|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f> as
    <math|D<rsup|m><rsub|k>f>.
  </notation>

  If a function is <math|m>-times differentiable then higher order partial
  differentials of order <math|m> exist, further if the function is of class
  <math|C<rsup|m>> then the the higher order partial differentials of order
  <math|m> are also continuous.\ 

  First we need a lemma to prove continuity of partial derivates.
  ...
  <\proof>
    Let <math|x\<in\>U> and take <math|\<varepsilon\>\<gtr\>0> then as
    <math|f> is continuous there exists a <math|\<delta\>\<gtr\>0> such that
    <math|\<forall\>y\<in\>X> with <math|<around*|\<\|\|\>|x-y|\<\|\|\>>\<less\>\<delta\>>
    we have that <math|<around*|\<\|\|\>|f<around*|(|x|)>-f<around*|(|y|)>|\<\|\|\>><rsub|L<around*|(|X,Y|)>>\<less\>\<varepsilon\>>.
  ...
  <\proof>
    ...
    f<around*|(|x|)>\<circ\><around*|(|i\<rightarrow\>0|)>> and <math|D
    f<around*|(|x|)>=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|(|D<rsub|i>f<around*|(|x|)>\<circ\>\<pi\><rsub|i>|)>>.
    Hence by definition we have that <math|D<rsup|1><rsub|i>f:U\<rightarrow\>L<rsup|1><around*|(|X<rsub|i>;Y|)>>
    exists with <math|D<rsup|1><rsub|i>f<around*|(|x|)>=D<rsup|1>f<around*|(|x|)>\<circ\><around*|(|i\<rightarrow\>0|)>=<around*|(|D
    ...
    that <math|D<rsup|1><rsub|i<rsub|1>>f=D
  ...
  <\theorem>
    ...
    <math|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    a finite family of normed spaces, <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    a normed spaces, <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    the normed space <math|X=<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>
    with the maximum norm <math|<around*|\<\|\|\>||\<\|\|\>>> [see
    <reference|norm of finite product of normed spaces>], a open set
    <math|U\<subseteq\>X> and <math|f:U\<rightarrow\>Y> a <math|m>-times
    ...
    Further <math|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f> is
    continuous if <math|f> is of class <math|C<rsup|m>>.
  </theorem>

  <\proof>
    We prove this by induction so let <math|\<cal-S\>=<around*|{|m\<in\>\<bbb-N\>\|if
    f:X\<rightarrow\>Y is m<text|-time >differentiable then
    ...
    <\description>
      ...
      <math|D<rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f=D<rsup|1><rsub|i<rsub|1>>f>
      ...
      we have <math|D<rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)><around*|(|h<rsub|1>:\<ldots\>:h<rsub|1>|)>=<around*|(|D<rsup|1>f<around*|(|x|)>\<circ\><around*|(|i<rsub|1>\<rightarrow\>0|)>|)>=D<rsup|1>f<around*|(|x|)><around*|(|<around*|(|i<rsub|1>-0|)><around*|(|h<rsub|1>|)>:\<ldots\>:<around*|(|i<rsub|1>-0|)><around*|(|h<rsub|1>|)>|)>>
      proving that <math|1\<in\>\<cal-S\>>.
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|\<Psi\><around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<cdot\>L<rsub|2>|)><around*|(|h<rsub|m>,\<ldots\>,h<rsub|1>|)>>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<ast\>L<rsub|2>|)><around*|(|h<rsub|m>:\<ldots\>:h<rsub|1>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|sum,product
        on (x1:..:xn)>>>>|<cell|\<alpha\>\<cdot\>L<rsub|1><around*|(|h<rsub|m>:\<ldots\>:h<rsub|1>|)>+\<beta\>\<cdot\>L<rsub|2><around*|(|h<rsub|m>:\<ldots\>:h<rsub|1>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\>\<Psi\><around*|(|L<rsub|1>|)>+\<beta\>\<cdot\>\<Psi\><around*|(|L<rsub|2>|)>|)><around*|(|h<rsub|m>:\<ldots\>:h<rsub|1>|)>>>>>
      </eqnarray*>
      ...
      <math|\<Phi\>> is linear. Further if
      <math|L\<in\>L<rsup|m><around*|(|X;Y|)>> we have
      ...
      <\equation>
        <label|eq 14.129.106>\<Phi\>\<in\>L<around*|(|L<rsup|m><around*|(|X;Y|)>\<rightarrow\>L<rsup|m><around*|(|X<rsub|m>,\<ldots\>,X<rsub|1>;Y|)>|)>
      </equation>
      ...
      <math|\<Phi\>\<circ\>D<rsup|m>f\<circ\><around*|(|i<rsub|m>\<rightarrow\>x|)>>
      is differentiable at <math|x<rsub|m+1>>.So by <reference|eq 14.130.106>
      <math|D<around*|(|<around*|(|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f|)>\<circ\><around*|(|i<rsub|m+1>\<rightarrow\>x|)>|)><around*|(|x<rsub|i<rsub|m+1>>|)>>
      exists which proves that <math|D<rsub|i<rsub|m>><around*|(|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f|)><around*|(|x|)>>
      exists. Hence
      ...
      <math|D<rsup|<around*|(|m+1|)>>f:U\<rightarrow\>L<rsup|m+1><around*|(|X;Y|)>=L<around*|(|X,L<rsup|m><around*|(|X,Y|)>|)>>
  ...
  <\proof>
    ...
    <\eqnarray*>
      ...
      n-th differential is symmetric>>>>|<cell|>>|<row|<cell|D<rsup|m>f<around*|(|x|)><around*|(|<around*|(|i<rsub|m>\<rightarrow\>0|)><around*|(|h<rsub|\<sigma\><rsup|-1><around*|(|m|)>>|)>:\<ldots\>:<around*|(|i<rsub|1>\<rightarrow\>0|)><around*|(|h<rsub|\<sigma\><rsup|-1><around*|(|1|)>>|)>|)>>|<cell|>|<cell|>>|<row|<cell|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f<around*|(|h<rsub|m>:\<ldots\>:h<rsub|1>|)>>|<cell|=>|<cell|>>>>
    </eqnarray*>
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    a finite family of Banach spaces, <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    a Banach space, <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    the Banach space <math|X=<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>
    with the maximum norm <math|<around*|\<\|\|\>||\<\|\|\>>> [see
    <reference|norm of finite product of normed spaces> and
    <reference|product of Banach spaces is Banach>], a open set
    <math|U\<subseteq\>X> and <math|f:U\<rightarrow\>Y> such that
    <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
    <math|D<rsub|i><rsup|1>f> exists on <math|U> and is continuous then
    <math|f> is of class <math|C<rsup|1>> with <math|D
  ...
  <\proof>
    ...
    <math|k\<in\><around*|{|1,\<ldots\>,n|}>> the following cases to consider
    :\ 
    ...
    Now define <math|L:B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|x,\<delta\>|)>\<rightarrow\>Y>
    by <math|L<around*|(|y|)>=<big|sum><rsub|i=1><rsup|n>D<rsub|i>f<around*|(|x|)><around*|(|y<rsub|i>|)>>
    so that\ 
    ...
    hence <math|L> is <math|C<rsup|\<infty\>>> with <math|D
    L<around*|(|y|)>=L> [see <reference|differential of a linear function>]
    and thus by <reference|differentiability on products of metric spaces>
    that\ 
    ...
    <\eqnarray*>
      ...
      of (01,...*,...0n)>>>>|<cell|<big|sum><rsub|j=1><rsup|n>D<rsub|j>f<around*|(|x|)>\<cdot\>\<delta\><rsub|i,j><around*|(|k|)>>>|<row|<cell|>|<cell|=>|<cell|D<rsub|i>f<around*|(|x|)>>>>>
    </eqnarray*>

    The above together with <reference|eq 14.139.106> and <reference|partial
    differential of sum and scalar product> \ proves that\ 
    ...
    is continuous \ there exists a <math|\<delta\><rsub|2<rsub|,i>>\<gtr\>0>
    such that if <math|y\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|x,\<delta\><rsub|2>|)>\<subseteq\>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|x,\<delta\><rsub|1>|)>>
    ...
    <\equation>
      ...
      <around*|\<\|\|\>|D<rsub|i>g<around*|(|x+h|)>|\<\|\|\>>=<around*|\<\|\|\>|D<rsub|i>f<around*|(|y|)>-D<rsub|i>f<around*|(|x|)>|\<\|\|\>>\<less\><frac|\<varepsilon\>|n>
    </equation>
    ...
    <\eqnarray*>
      ...
      g<around*|(|<around*|(|x+h<rsup|i>|)>+t\<cdot\><around*|(|<around*|(|x+h<rsup|i-1>|)>-<around*|(|x+h<rsup|i>|)>|)>|)>|\<\|\|\>><rsub|L<around*|(|X,Y|)>>\|t\<in\><around*|[|0,1|]>|}>|)>>|<cell|=>|<cell|>>|<row|<cell|<around*|\<\|\|\>|h<rsup|i>-h<rsup|i-1>|\<\|\|\>>\<cdot\>sup<around*|(|<around*|{|<around*|\<\|\|\>|D
      g<around*|(|x+<around*|(|h<rsup|i>+t\<cdot\><around*|(|h<rsup|i-1>-h<rsup|i>|)>|)>|)>|\<\|\|\>><rsub|L<around*|(|X,Y|)>>\|t\<in\><around*|[|0,1|]>|}>|)>>|<cell|=>|<cell|<eq-number><label|eq
      14.144.106>>>>>
    </eqnarray*>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|\<\|\|\>|h<rsup|i>+t\<cdot\><around*|(|h<rsup|i-1>-h<rsup|i>|)>|\<\|\|\>>>|<cell|=>|<cell|<around*|\<\|\|\>|<around*|(|1-t|)>\<cdot\>h<rsup|i>+t\<cdot\>h<rsup|i-1>|\<\|\|\>>>>|<row|<cell|>|<cell|\<leqslant\><rsub|t\<in\><around*|[|0,1|]>>>|<cell|<around*|(|1-t|)>\<cdot\><around*|\<\|\|\>|h<rsup|i>|\<\|\|\>>+t\<cdot\><around*|\<\|\|\>|h<rsup|i-1>|\<\|\|\>>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|eq
    ...
    <math|<around*|\<\|\|\>|D g<around*|(|a+<around*|(|h<rsup|i>+t\<cdot\><around*|(|h<rsup|i-1>-h<rsup|i>|)>|)>|)>|\<\|\|\>><rsub|L<around*|(|X,Y|)>>\<less\><frac|\<varepsilon\>|n>>
    ...
    Which proves as <math|L<around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>D<rsub|i>f<around*|(|x|)>\<in\>L<around*|(|X,Y|)>>
    [see <reference|eq 14.140.2>] that\ 

    <\equation>
      <label|eq 14.146.106>D f<around*|(|x|)> exists<infix-and>D
      f<around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>D<rsub|i>f<around*|(|x|)><around*|(|h<rsub|i>|)>
    </equation>
  ...
  with the eabove theorem gives the following result
  ...
  <\theorem>
    ...
    <reference|norm of finite product of normed spaces> and
    <reference|product of Banach spaces is Banach>], a open set
    <math|U\<subseteq\>X> and <math|f:U\<rightarrow\>Y> a function then the
    following are equivalent
    ...
    <math|D f<around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>D<rsub|i>f<around*|(|x|)>\<circ\>\<pi\><rsub|i>=<big|sum><rsub|i=1><rsup|n>D<rsub|i><rsup|1>f<around*|(|x|)>\<circ\>\<pi\><rsub|i>>
  </theorem>
  ...
  <\definition>
    ...
    <math|f:U\<rightarrow\>Y> then given <math|<around*|{|i<rsub|j>|}><rsub|j\<in\><around*|{|1,\<ldots\>,m|}>>\<subseteq\><around*|{|1,\<ldots\>,n|}>>
    ...
    <\enumerate>
      ...
      derivative definition>] and <math|\<partial\><rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f:U\<rightarrow\>U>
      by <math|\<partial\><rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>=\<partial\><rsub|i>f<around*|(|x|)>>.

      <item>If <math|m\<gtr\>1> then <math|\<partial\><rsup|m><rsub|i<rsub|1>,\<ldots\>,i<rsub|m>>f>
      ...
      by <math|x\<rightarrow\>\<partial\><rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>=\<partial\><rsub|i<rsub|1m>><around*|(|\<partial\><rsub|i<rsub|m-1>,\<ldots\>,i<rsub|1>><rsup|m-1>f|)><around*|(|x|)>>
    </enumerate>
  </definition>

  <\lemma>
    <label|evaluation function of L^m(X;Y)>Let
    <math|n\<in\>\<bbb-N\>\\<around*|{|1|}>,m\<in\>\<bbb-N\>>,
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces and <math|<around*|{|h<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,m|}>>\<subseteq\>X>
    then <math|\<Lambda\><rsub|h<rsub|1>,\<ldots\>,h<rsub|m>>:L<rsup|m><around*|(|X;Y|)>\<rightarrow\>Y>
    is linear and continuous [or equivalent
    <math|\<Lambda\><rsub|h<rsub|1>,\<ldots\>,h<rsub|m>>\<in\>L<around*|(|L<rsup|m><around*|(|X;Y|)>,Y|)>>
  </lemma>
  ...
  <\proof>
    ...
    <\description>
      <item*|linearity>Let <math|L<rsub|1>,L<rsub|2>\<in\>L<rsup|m><around*|(|X;Y|)>>,
      <math|\<alpha\>,\<beta\>\<in\>\<bbb-K\>> then\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|\<Lambda\><rsub|h<rsub|1>,\<ldots\>,h<rsub|m>><around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<cdot\>L<rsub|2>|)>>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<cdot\>L<rsub|2>|)><around*|(|h<rsub|1>:\<ldots\>:h<rsub|m>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|sum,product
        on (x1:..:xn)>>>>|<cell|\<alpha\>\<cdot\>L<rsub|1><around*|(|h<rsub|1>:\<ldots\>:h<rsub|m>|)>+\<beta\>\<cdot\>L<rsub|2><around*|(|h<rsub|1>:\<ldots\>:h<rsub|m>|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>\<Lambda\><rsub|h<rsub|1>,\<ldots\>,h<rsub|m>><around*|(|L<rsub|1>|)>+\<beta\>\<cdot\>\<Lambda\><rsub|h<rsub|1>,\<ldots\>,h<rsub|m>><around*|(|L<rsub|2>|)>>>>>
      </eqnarray*>

      <item*|continuity>Let <math|L\<in\>L<rsup|m><around*|(|X;Y|)>> then we
      have\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|\<\|\|\>|\<Lambda\><rsub|h<rsub|1>,\<ldots\>,h<rsub|m>><around*|(|L|)>|\<\|\|\>><rsub|Y>>|<cell|=>|<cell|<around*|\<\|\|\>|L<around*|(|h<rsub|1>,\<ldots\>,h<rsub|m>|)>|\<\|\|\>><rsub|Y>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|norm
        of L(x1:..:xn}>>>>|<cell|<around*|\<\|\|\>|L|\<\|\|\>><rsub|L<rsup|m><around*|(|X;Y|)>>\<cdot\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,m|}>><around*|\<\|\|\>|h<rsub|i>|\<\|\|\>><rsub|X>>>>>
      </eqnarray*>

      proving by <reference|continuous linear maps in a normed space> that
      <math|\<Lambda\><rsub|h<rsub|1>,\<ldots\>,h<rsub|m>>> is continuous.
    </description>
  </proof>
  ...
  <\theorem>
    ...
    be the vector space <math|\<bbb-K\><rsup|n>> with the maximum norm,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    a normed space, a open set <math|U\<subseteq\>\<bbb-K\><rsup|n>>,
    <math|f:U\<rightarrow\>Y> a function such that
  ...
  <\proof>
    We prove this by induction so let <math|\<cal-S\>=<around*|{|m\<in\>\<bbb-N\>\|<around*|{|i<rsub|j>|}><rsub|j\<in\><around*|{|1,\<ldots\>,n|}>>,f:U\<rightarrow\>Y
    ...
    <\description>
      ...
      let <math|f:U\<rightarrow\>Y> be such that
      <math|D<rsup|1><rsub|i<rsub|1>>f=D<rsub|i<rsub|1>>f> exists on
      <math|R>. Using <reference|partial derivative and partial differential>
      ...
      exists and <math|\<partial\><rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>=D<rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)><around*|(|<wide*|1:\<ldots\>:1|\<wide-underbrace\>><rsub|1>|)>>.
      \ Further as <math|\<Lambda\><rsub|<wide*|1,\<ldots\>,1|\<wide-underbrace\>><rsub|1>><around*|(|D<rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>|)>=D<rsub|i<rsub|1>>f<around*|(|x|)><around*|(|<wide*|1:\<ldots\>:1|\<wide-underbrace\>><rsub|1>|)>=\<partial\><rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>>
      we have that <math|\<Lambda\><rsub|<wide*|1,\<ldots\>,1|\<wide-underbrace\>><rsub|1>>\<circ\>D<rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f=\<partial\><rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f>,
      hence if <math|D<rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f> is
      continuous we have by <reference|evaluation function of L^m(X;Y)>.

      <item*|<math|n\<in\>\<cal-S\>\<Rightarrow\>n+1\<in\>\<cal-S\>>>Take
      <math|<around*|{|i<rsub|j>|}><rsub|j\<in\><around*|{|1,\<ldots\>,m+1|}>>>
      and <math|f:U\<rightarrow\>Y> such that
      ...
      From <math|\<Lambda\><rsup|m><rsub|<around*|(|<wide*|1:\<ldots\>:1|\<wide-underbrace\>><rsub|m>|)>><around*|(|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>|)>=D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f<around*|(|x|)><around*|(|<wide*|1:\<ldots\>:1|\<wide-underbrace\>><rsub|m>|)>\<equallim\><rsub|<text|<reference|eq
      14.147.107>>>\<partial\><rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>>
      it follows that <math|\<partial\><rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f=\<Lambda\><rsup|m><rsub|<around*|(|<wide*|1:\<ldots\>:1|\<wide-underbrace\>><rsub|m>|)>>\<circ\>D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f>.
      As <math|\<Lambda\><rsup|m><rsub|<around*|(|<wide*|1:\<ldots\>:1|\<wide-underbrace\>><rsub|m>|)>>>
      is <math|C<rsup|\<infty\>>> [see <reference|evaluation function of
      L^m(X;Y)> and <reference|linear continuous mappings are C^infinity>] we
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|D<rsub|i<rsub|m>><around*|(|\<partial\><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f|)><around*|(|x|)>>|<cell|=>|<cell|D<rsub|i<rsub|m>><around*|(|\<Lambda\><rsup|m><rsub|<around*|(|<wide*|1:\<ldots\>:1|\<wide-underbrace\>><rsub|m>|)>>\<circ\>D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f|)><around*|(|x|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|chain
        rules of partial differentiable functions>>>>|<cell|D<around*|(|\<Lambda\><rsup|m><rsub|<around*|(|<wide*|1:\<ldots\>:1|\<wide-underbrace\>><rsub|m>|)>><around*|(|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>|)>|)>\<circ\>D<rsub|i<rsub|m+1>><around*|(|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f|)><around*|(|x|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|linear
        continuous mappings are C^infinity>>>>|<cell|\<Lambda\><rsup|m><rsub|<around*|(|<wide*|1:\<ldots\>:1|\<wide-underbrace\>><rsub|m>|)>>\<circ\>D<rsub|i<rsub|m+1>><around*|(|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f|)><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|\<Lambda\><rsup|m><rsub|<around*|(|<wide*|1:\<ldots\>:1|\<wide-underbrace\>><rsub|m>|)>>\<circ\>D<rsup|m+1><rsub|i<rsub|m+1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|D<rsup|m+1><rsub|i<rsub|m+1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)><around*|(|<wide*|1:\<ldots\>:1|\<wide-underbrace\>><rsub|m>|)><eq-number><label|eq
        14.148.107>>>>>
      </eqnarray*>
      ...
      <\eqnarray*>
        ...
        derivative and partial differential>>>>|<cell|D<rsub|i<rsub|m>><around*|(|\<partial\><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f|)><around*|(|x|)><around*|(|1|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
      ...
      Further as <math|\<Lambda\><rsub|i<rsub|m+1>,\<ldots\>,i<rsub|1>><around*|(|D<rsup|m+1><rsub|i<rsub|m+1>,\<ldots\>,i<rsub|1>>f|)><around*|(|x|)>=D<rsup|m+1><rsub|i<rsub|m+1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)><around*|(|<wide*|1:\<ldots\>1|\<wide-underbrace\>><rsub|m+1>|)>\<equallim\><rsub|<text|<reference|eq
      14.149.020>>>\<partial\><rsup|m+1><rsub|i<rsub|m+1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>>
      it follows that <math|\<Lambda\><rsub|i<rsub|m+1>,\<ldots\>,i<rsub|1>>\<circ\>D<rsup|m+1><rsub|i<rsub|m+1>,\<ldots\>,i<rsub|1>>f=\<partial\><rsup|m+1><rsub|i<rsub|m+1>,\<ldots\>,i<rsub|1>>f>
      we have that\ 
      ...
      Using <reference|eq 14.149.107> and <reference|eq 14.150.020> we have
      that <math|m+1\<in\>\<cal-S\>>
    </description>
  </proof>
  ...
  <\corollary>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    a normed space, a open set <math|U\<subseteq\>\<bbb-K\><rsup|n>>,
    <math|f:U\<rightarrow\>Y> a function that is <math|m>-differentiable then
  ...
  <\proof>
    ...
    <math|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f> exists on <math|U>
    and <math|D<rsup|m><rsub|i<rsub|m>,\<ldots\>,i<rsub|1>>f<around*|(|x|)><around*|(|h<rsub|m>:\<ldots\>:h<rsub|1>|)>=D<rsup|m>f<around*|(|x|)><around*|(|<around*|(|i<rsub|m>\<rightarrow\>0|)><around*|(|h<rsub|m>|)>:\<ldots\>:<around*|(|i<rsub|1>\<rightarrow\>0|)><around*|(|h<rsub|1>|)>|)>>
  ...
  <\theorem>
    <label|composition of sums>Let <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    be a normed space <math|\<sigma\>,\<beta\>\<in\>\<bbb-K\>>
    <math|L,L<rsub|1>,L<rsub|2>\<in\>L<around*|(|X,X|)>> then\ 

    <\enumerate>
      <item><math|L\<circ\><around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<cdot\>L<rsub|2>|)>=\<alpha\>\<cdot\>L\<circ\>L<rsub|1>+\<beta\>\<cdot\>L\<circ\>L<rsub|2>>

      <item><math|<around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<cdot\>L<rsub|2>|)>\<circ\>L=\<alpha\>\<cdot\><around*|(|L<rsub|1>\<circ\>L|)>+\<beta\>\<cdot\><around*|(|L<rsub|2>\<circ\>L|)>>
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|L\<circ\><around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<cdot\>L<rsub|2>|)>|)><around*|(|x|)>>|<cell|=>|<cell|L<around*|(|<around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<cdot\>L<rsub|2>|)><around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|L<around*|(|\<alpha\>\<cdot\>L<rsub|1><around*|(|x|)>+\<beta\>\<cdot\>L<rsub|2><around*|(|x|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|L
        is linear>>|<cell|\<alpha\>\<cdot\>L<around*|(|L<rsub|1><around*|(|x|)>|)>+\<beta\>\<cdot\>L<around*|(|L<rsub|2><around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\><around*|(|L\<circ\>L<rsub|1>|)><around*|(|x|)>+\<beta\>\<cdot\><around*|(|L\<circ\>L<rsub|2>|)><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\><around*|(|L\<circ\>L<rsub|1>|)>+\<beta\>\<cdot\><around*|(|L\<circ\>L<rsub|2>|)>|)><around*|(|x|)>>>>>
      </eqnarray*>

      which proves that\ 

      <\equation*>
        L\<circ\><around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<cdot\>L<rsub|2>|)>=\<alpha\>\<cdot\><around*|(|L\<circ\>L<rsub|1>|)>+\<beta\>\<cdot\><around*|(|L\<circ\>L<rsub|2>|)>
      </equation*>

      <item>Let <math|x\<in\>X> then\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|<around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<cdot\>L<rsub|2>|)>\<circ\>L|)><around*|(|x|)>>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<cdot\>L<rsub|2>|)><around*|(|L<around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>L<rsub|1><around*|(|L<around*|(|x|)>|)>+\<beta\>\<cdot\>L<rsub|2><around*|(|L<around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\><around*|(|L<rsub|1>\<circ\>L|)><around*|(|x|)>+\<beta\>\<cdot\><around*|(|L<rsub|2>\<circ\>L|)><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\><around*|(|L<rsub|1>\<circ\>L|)>+\<beta\>\<cdot\><around*|(|L<rsub|2>\<circ\>L|)>|)><around*|(|x|)>>>>>
      </eqnarray*>

      proving

      <\equation*>
        <around*|(|\<alpha\>\<cdot\>L<rsub|1>+\<beta\>\<cdot\>L<rsub|2>|)>\<circ\>L=\<alpha\>\<cdot\><around*|(|L<rsub|1>\<circ\>L|)>+\<beta\>\<cdot\><around*|(|L<rsub|2>\<circ\>L|)>
      </equation*>
    </enumerate>
  ...
  <\proof>
    ...
    continuous> that <math|<around*|(|L<rsub|1>\<circ\>L<rsub|2>|)> >is
    continuous. So <math|L<rsub|1>\<circ\>L<rsub|2>\<in\>\<cal-G\>L<around*|(|X|)>>
  ...
  <\theorem>
    ...
    <math|\<bbb-1\><rsub|X>-H\<in\>\<cal-G\>L<around*|(|X|)>>. Further
  ...
  <\proof>
    ...
    <\equation>
      ...
      is convergent<infix-and><around*|\<\|\|\>|<big|sum><rsub|i=1><rsup|\<infty\>>H<rsup|i><around*|(|x|)>|\<\|\|\>><rsub|X>\<leqslant\><frac|<around*|\<\|\|\>|H|\<\|\|\>>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>>|1-<around*|\<\|\|\>|H|\<\|\|\>>>
    </equation>

    Using <reference|terms of a convergent series goes to 0> we have further
    ...
    proving continuity of <math|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|\<infty\>>H<rsup|i>|)>>
    and that\ 

    <\equation>
      <label|eq 12.68><around*|\<\|\|\>|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|\<infty\>>H<rsup|i>|)>|\<\|\|\>>\<leqslant\><frac|1|1-<around*|\<\|\|\>|H|\<\|\|\>>>
    </equation>
    ...
    <\proof>
      So let <math|S=<around*|{|n\<in\>\<bbb-N\>\|<around*|(|\<bbb-1\><rsub|X>-H|)>\<circ\><around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)>=<around*|(|\<bbb-1\><rsub|X>-H<rsup|n+1>|)>|}>>
      then we have:

      <\description>
        <item*|<math|1\<in\>\<cal-S\>>>Then <math|\<forall\>x\<in\>X> we have
        ...
        <\eqnarray*>
          <tformat|<table|<row|<cell|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n+1>H<rsup|i>|)><around*|(|x|)>|)>>|<cell|=>|<cell|>>|<row|<cell|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)><around*|(|x|)>+H<rsup|n+1><around*|(|x|)>|)>>|<cell|=>|<cell|>>|<row|<cell|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)><around*|(|x|)>|)>+<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|H<rsup|n+1><around*|(|x|)>|)>>|<cell|\<equallim\><rsub|n\<in\>S>>|<cell|>>|<row|<cell|<around*|(|\<bbb-1\><rsub|X>-H<rsup|n+1>|)><around*|(|x|)>+H<rsup|n+1><around*|(|x|)>-H<rsup|<around*|(|n+1|)>+1><around*|(|x|)>>|<cell|=>|<cell|>>|<row|<cell|<around*|(|\<bbb-1\><rsub|X>-H<rsup|<around*|(|n+1|)>+1>|)><around*|(|x|)>>|<cell|=>|<cell|>>>>
        </eqnarray*>
    ...
    <\proof>
      So let <math|S=<around*|{|n\<in\>\<bbb-N\>\|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)>\<circ\><around*|(|\<bbb-1\><rsub|X>-H|)>=\<bbb-1\><rsub|X>-H<rsup|n+1>|}>>
      then we have :

      <\description>
        <item*|<math|1\<in\>\<cal-S\>>>Then <math|\<forall\>x\<in\>X>\ 

        <\eqnarray*>
          <tformat|<table|<row|<cell|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|1>H<rsup|i>|)><around*|(|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|x|)>|)>>|<cell|=>|<cell|<around*|(|x-H<around*|(|x|)>+H<around*|(|x-H<around*|(|x|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|x-H<rsup|2><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|1<rsub|X>-H<rsup|2>|)><around*|(|x|)>>>>>
        </eqnarray*>
        ...
        <\eqnarray*>
          <tformat|<table|<row|<cell|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n+1>H<rsup|i>|)><around*|(|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|x|)>|)>>|<cell|=>|<cell|\<bbb-1\><rsub|X><around*|(|x-H<around*|(|x|)>|)>+<big|sum><rsub|i=1><rsup|n>H<rsup|i><around*|(|x-H<around*|(|x|)>|)>+H<rsup|n+1><around*|(|x-H<around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>|)><around*|(|<around*|\<nobracket\>|x-H<around*|(|x|)>|)>|\<nobracket\>>+H<rsup|n+1><around*|(|x|)>-H<rsup|<around*|(|n+1|)>+1><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>|)><around*|(|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|x|)>|)>+H<rsup|n+1><around*|(|x|)>-H<rsup|<around*|(|n+1|)>+1><around*|(|x|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|n\<in\>S>>|<cell|<around*|(|\<bbb-1\><rsub|X>-H<rsup|n+1>|)><around*|(|x|)>+H<rsup|n+1><around*|(|x|)>-H<rsup|<around*|(|n+1|)>+1><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|x-H<rsup|<around*|(|n+1|)>+1><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<bbb-1\><rsub|X>-H<rsup|<around*|(|n+1|)>+1>|)><around*|(|x|)>>>>>
        </eqnarray*>
      </description>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|\<\|\|\>|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)><around*|(|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|x|)>|)>-\<bbb-1\><rsub|X>|\<\|\|\>><rsub|X>>|<cell|\<equallim\><rsub|<text|<reference|eq
    ...
    <\eqnarray*>
      ...
      and continuity>>>>|<cell|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|<below|lim|n\<rightarrow\>\<infty\>><around*|(|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)><around*|(|x|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|<below|lim|n\<rightarrow\>\<infty\>><around*|(|\<bbb-1\><rsub|X><around*|(|x|)>+<big|sum><rsub|i=1><rsup|n>H<rsup|i><around*|(|x|)>|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|sum
      of linear function and infinite sum>>>>|<cell|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|\<bbb-1\><rsub|X><around*|(|x|)>+<below|lim|n\<rightarrow\>\<infty\>><big|sum><rsub|i=1><rsup|n>H<rsup|i><around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|<around*|(|\<bbb-1\><rsub|X><around*|(|x|)>+<big|sum><rsub|i=1><rsup|\<infty\>>H<rsup|i><around*|(|x|)>|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|def>>|<cell|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|\<infty\>>H<rsup|i>|)><around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<around*|(|\<bbb-1\><rsub|X>-H|)>\<circ\><around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|\<infty\>>H<rsup|i>|)>|)><around*|(|x|)>>>>>
    </eqnarray*>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|\<bbb-1\><rsub|X><around*|(|x|)>>|<cell|=>|<cell|lim<rsub|n\<rightarrow\>\<infty\>><around*|[|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)><around*|(|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|x|)>|)>|]>>>|<row|<cell|>|<cell|=>|<cell|<below|lim|n\<rightarrow\>\<infty\>><around*|[|<around*|(|\<bbb-1\><rsub|X><around*|(|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|x|)>|)>|)>+<big|sum><rsub|i=1><rsup|n>H<rsup|i><around*|(|<around*|(|\<bbb-1\><rsub|X>-H|)><around*|(|x|)>|)>|]>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|sum
    ...
    <math|<around*|(|\<bbb-1\><rsub|X>-H|)><rsup|-1>=\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|\<infty\>>H<rsup|1>>.
    Further as <math|\<bbb-1\><rsub|X>,H\<in\>L<around*|(|X,X|)>> we have
    that <math|\<bbb-1\><rsub|X>-H> is linear and continuous thus a
    isomorphism and by <reference|in Banach spaces linear continuous mappings
    are toplinear> \ top-linear. So <math|\<bbb-1\><rsub|X>-H\<in\>GL<around*|(|X|)>>.
  </proof>
  ...
  <\corollary>
    ...
    <math|<around*|\<\|\|\>|H|\<\|\|\>>\<less\>1> then
    <math|\<bbb-1\><rsub|X>+H\<in\>\<cal-G\>L<around*|(|X|)>>,
  ...
  <\proof>
    This follows from the previous theorem by using <math|-H> and
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\eqnarray*>
        ...
        of sums>>>>|<cell|L\<circ\><around*|(|\<bbb-1\><rsub|X>+L<rsup|-1>\<circ\><around*|(|H-L|)>|)>>>>>
      </eqnarray*>

      giving\ 

      <\equation>
        <label|eq 12.75>H=L\<circ\><around*|(|\<bbb-1\><rsub|X>+L<rsup|-1>\<circ\><around*|(|H-L|)>|)>
      </equation>
      ...
      <item>Let <math|H\<in\>L<around*|(|X,X|)>> with
      <math|<around*|\<\|\|\>|H|\<\|\|\>>\<less\>1> then using <reference|I+H
      has inverse if norm of H is less then 1> we have that
      <math|<big|sum><rsup|\<infty\>><rsub|i=1><around*|(|-1|)><rsup|i>\<cdot\><around*|\<\|\|\>|H|\<\|\|\>><rsup|i>>
      ...
      <\equation>
        ...
        converges in L<around*|(|X,X|)>
      </equation>

      Define now <math|\<varepsilon\><around*|(|H|)>=<choice|<tformat|<table|<row|<cell|C<rsub|X,X,0>
      if H=0>>|<row|<cell|<frac|1|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>
      H\<neq\>0>>>>>>. Given <math|x,y\<in\>X> and
      <math|\<alpha\>,\<beta\>\<in\>\<bbb-K\>> we have
      ...
      <\eqnarray*>
        ...
        H=0>>|<row|<cell|<frac|1|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><around*|(|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|)><around*|(|\<alpha\>\<cdot\>x+\<beta\>\<cdot\>y|)>
        h\<neq\>0>>>>>>|<cell|\<equallim\><rsub|C<rsub|X,0>\<in\>L<around*|(|X,X|)>>>|<cell|>>|<row|<cell|<choice|<tformat|<table|<row|<cell|\<alpha\>\<cdot\>C<rsub|X,X,0><around*|(|x|)>+\<beta\>\<cdot\>C<rsub|X,X,0><around*|(|y|)>
        H=0>>|<row|<cell|<frac|1|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><around*|(|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|)><around*|(|\<alpha\>\<cdot\>x+\<beta\>\<cdot\>y|)>
        H\<neq\>0>>>>>>|<cell|\<equallim\><rsub|<text|<reference|eq
        14.163.109>>>>|<cell|>>|<row|<cell|<choice|<tformat|<table|<row|<cell|\<alpha\>\<cdot\>C<rsub|X,X,0><around*|(|x|)>+\<beta\>\<cdot\>C<rsub|X,X,0><around*|(|y|)>
        H=0>>|<row|<cell|<frac|\<alpha\>|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><around*|(|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|)><around*|(|x|)>+<frac|\<beta\>|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><around*|(|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|)><around*|(|y|)>
        H\<neq\>0>>>>>>|<cell|=>|<cell|>>|<row|<cell|\<alpha\>\<cdot\>\<varepsilon\><around*|(|H|)><around*|(|x|)>+\<beta\>\<cdot\>\<varepsilon\><around*|(|H|)><around*|(|y|)>>|<cell|>|<cell|>>>>
      </eqnarray*>
      ...
      <\eqnarray*>
        ...
        H=0>>|<row|<cell|<around*|\<\|\|\>|<frac|1|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><around*|(|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|)><around*|(|x|)>|\<\|\|\>><rsub|X>
        H\<neq\>0>>>>>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|<around*|\<\|\|\>|x|\<\|\|\>><rsub|X>\<cdot\><choice|<tformat|<table|<row|<cell|0
      ...
      <\equation>
        <label|eq 14.164.109>\<forall\>H\<in\>L<around*|(|X,X|)> with
        <around*|\<\|\|\>|H|\<\|\|\>>\<less\>1 we have
        \ \<varepsilon\><around*|(|H|)>\<in\>L<around*|(|X,X|)><infix-and><around*|\<\|\|\>|\<varepsilon\><around*|(|H|)>|\<\|\|\>>\<leqslant\><choice|<tformat|<table|<row|<cell|0
        if H=0>>|<row|<cell|<frac|1|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><around*|\<\|\|\>|<big|sum><rsup|\<infty\>><rsub|i=2><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|\<\|\|\>>>>>>>
      </equation>

      hence we can define the function <math|\<varepsilon\>> \ 

      <\equation>
        <label|eq 14.165.109>\<varepsilon\>:B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|0,1|)>\<rightarrow\>L<around*|(|X,X|)>
        defined by \<varepsilon\><around*|(|H|)>=<choice|<tformat|<table|<row|<cell|C<rsub|X,X,0>
        if H=0>>|<row|<cell|<frac|1|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>
        \ if H\<neq\>0>>>>>
      </equation>
      ...
      of a serie in a Banach space>] on <reference|eq 14.166.109> that
      <math|<around*|\<\|\|\>|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|\<\|\|\>>\<leqslant\><frac|<around*|\<\|\|\>|H|\<\|\|\>><rsup|2>|1-<around*|\<\|\|\>|H|\<\|\|\>>>>.
      So using <reference|eq 14.164.109> we have\ 

      <\equation>
        <label|eq 14.170.108>\<forall\>H\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|0,1|)>
      ...
      <\description>
        ...
        <math|H\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|\<bbb-1\><rsub|X>,1|)>>
        then if <math|H\<in\>L<around*|(|X,X|)>> with
        <math|<around*|\<\|\|\>|H|\<\|\|\>>\<less\>1> have\ 
        ...
        Now as <math|\<tau\><around*|(|\<bbb-1\><rsub|X>+H|)>-\<tau\><around*|(|\<bbb-1\><rsub|X>|)>-<around*|(|-H|)>\<equallim\><rsub|<text|<reference|eq
        14.164.107>>><choice|<tformat|<table|<row|<cell|C<rsub|X,X,0> if
        H=0>>|<row|<cell|<around*|\<\|\|\>|<big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>|\<\|\|\>>>>>>>=<choice|<tformat|<table|<row|<cell|<around*|\<\|\|\>|H|\<\|\|\>>\<cdot\>C<rsub|X,X,0>>>|<row|<cell|<around*|\<\|\|\>|H|\<\|\|\>>\<cdot\><frac|1|<around*|\<\|\|\>|H|\<\|\|\>>>\<cdot\><big|sum><rsub|i=2><rsup|\<infty\>><around*|(|-1|)><rsup|i>\<cdot\>H<rsup|i>
        >>>>>>and <math|-H=-\<bbb-1\><rsub|X>\<circ\>H\<circ\>\<bbb-1\><rsub|X>>
        we have that\ 
        ...
        <\eqnarray*>
          ...
          14.170.108>>>>|<cell|<frac|<around*|\<\|\|\>|H|\<\|\|\>>|1-<around*|\<\|\|\>|H|\<\|\|\>>>>>|<row|<cell|>|<cell|\<less\>>|<cell|<frac|<around*|\<\|\|\>|H|\<\|\|\>>|1-<frac|1|2>>>>|<row|<cell|>|<cell|=>|<cell|2\<cdot\><around*|\<\|\|\>|H|\<\|\|\>>>>|<row|<cell|>|<cell|\<less\>>|<cell|\<xi\>>>>>
        </eqnarray*>

        which proves that <math|\<varepsilon\>> is continuous at
        <math|0\<in\>L<around*|(|X,X|)>> and thus that <math|\<varepsilon\>>
        is a <math|\<varepsilon\>>-mapping [see <reference|e-mappings>].
        Define <math|\<Psi\>:L<around*|(|X,X|)>\<rightarrow\>L<around*|(|X,X|)>>
        by <math|\<Psi\><around*|(|H|)>=-H=\<bbb-1\><rsub|X>\<circ\>H\<circ\>\<bbb-1\><rsub|X>>
        ...
        <math|\<delta\>=min<around*|(|<frac|1|1+<around*|\<\|\|\>|L<rsub|-1>|\<\|\|\>>>,1|)>>
        ...
        of sums>>>\<bbb-1\><rsub|X>\<circ\>L+H\<circ\>L\<circ\>L<rsup|-1>=L+H>
        it follows that\ 
        ...
        As also <math|\<delta\>\<less\>1> we have if
        <math|H\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|L,\<delta\>|)>\<equallim\><rsub|<text|<reference|Ux
        definition>>>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|0,\<delta\>|)><rsub|L>>
        then\ 
        ...
        <\equation>
          ...
          \<varepsilon\><around*|(|H\<circ\>L<rsup|-1>|)> is defined
        </equation>
        ...
        <\eqnarray*>
          ...
          of composition of functions>>>>|<cell|L<rsup|-1>\<circ\><around*|(|\<bbb-1\><rsub|X>+H\<circ\>L<rsup|-1>|)><rsup|-1>-L<rsup|-1>>>|<row|<cell|>|<cell|=>|<cell|L<rsup|-1>\<circ\><around*|(|<around*|(|\<bbb-1\><rsub|X>+H\<circ\>L<rsup|-1>|)><rsup|-1>-\<bbb-1\><rsub|X>|)>>>|<row|<cell|>|<cell|=>|<cell|L<rsup|-1>\<circ\><around*|(|\<tau\><around*|(|\<bbb-1\><rsub|X>+H\<circ\>L<rsup|-1>|)>-\<tau\><around*|(|\<bbb-1\><rsub|X>|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
          ...
          of sums>>>>|<cell|-L<rsup|-1>\<circ\>H\<circ\>L<rsup|-1>+L<rsup|-1>\<circ\>\<varepsilon\><around*|(|H\<circ\>L<rsup|-1>|)>\<cdot\><around*|\<\|\|\>|H\<circ\>L<rsup|-1>|\<\|\|\>>>>>>
        </eqnarray*>
        ...
        Define now given <math|H\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|0,\<delta\>|)><rsub|L>>
        <math|\<varepsilon\><rprime|'><around*|(|H|)>=<choice|<tformat|<table|<row|<cell|C<rsub|X,X,0
        > if H=0>>|<row|<cell|L<rsup|-1>\<circ\>\<varepsilon\><around*|(|H\<circ\>L|)>\<cdot\><frac|<around*|\<\|\|\>|H\<circ\>L<rsup|-1>|\<\|\|\>>|<around*|\<\|\|\>|H|\<\|\|\>>>
        if H\<neq\>0>>>>>>. Given <math|x,y\<in\>X>,
        <math|\<alpha\>,\<beta\>\<in\>\<bbb-K\>> we have as
        <math|><math|L<rsup|-1>\<circ\>\<varepsilon\><around*|(|H\<circ\>L|)>\<cdot\><frac|<around*|\<\|\|\>|H\<circ\>L<rsup|-1>|\<\|\|\>>|<around*|\<\|\|\>|H|\<\|\|\>>>\<in\>L<around*|(|X,X|)>>
        ...
        <\eqnarray*>
          ...
          H=0>>|<row|<cell|<around*|(|L<rsup|-1>\<circ\>\<varepsilon\><around*|(|H\<circ\>L|)>\<cdot\><frac|<around*|\<\|\|\>|H\<circ\>L<rsup|-1>|\<\|\|\>>|<around*|\<\|\|\>|H|\<\|\|\>>>|)><around*|(|\<alpha\>\<cdot\>x+\<beta\>\<cdot\>y|)>
          ...
          H=0>>|<row|<cell|\<alpha\>\<cdot\><around*|(|L<rsup|-1>\<circ\>\<varepsilon\><around*|(|H\<circ\>L|)>\<cdot\><frac|<around*|\<\|\|\>|H\<circ\>L<rsup|-1>|\<\|\|\>>|<around*|\<\|\|\>|H|\<\|\|\>>>|)><around*|(|x|)>+\<beta\>\<cdot\><around*|(|L<rsup|-1>\<circ\>\<varepsilon\><around*|(|H\<circ\>L|)>\<cdot\><frac|<around*|\<\|\|\>|H\<circ\>L<rsup|-1>|\<\|\|\>>|<around*|\<\|\|\>|H|\<\|\|\>>>|)><around*|(|y|)>
        ...
        <\equation>
          <label|eq 14.178.109>\<varepsilon\><rprime|'>:B<rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|0,\<delta\>|)>\<rightarrow\>L<around*|(|X,X|)>
        ...
        <\equation>
          ...
          <around*|\<\|\|\>|\<varepsilon\><rprime|'><around*|(|H|)>|\<\|\|\>>\<leqslant\><choice|<tformat|<table|<row|<cell|0
          if H=0>>|<row|<cell|<around*|\<\|\|\>|L<rsup|-1>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|\<varepsilon\><around*|(|H\<circ\>L<rsup|-1>|)>|\<\|\|\>>\<cdot\><frac|<around*|\<\|\|\>|H\<circ\>L<rsup|-1>|\<\|\|\>>|<around*|\<\|\|\>|H|\<\|\|\>>>
          if H\<neq\>0>>>>>
        </equation>

        Let <math|\<xi\>\<gtr\>0> then as <math|\<varepsilon\>> is continuous
        at <math|0> there exists a <math|\<delta\><rsub|1>\<gtr\>0> such that
        if <math|<around*|\<\|\|\>|H|\<\|\|\>>\<less\>\<delta\><rsub|1>> then
        ...
        which proves as <math|\<varepsilon\><rprime|'><around*|(|0|)>\<equallim\><rsub|<text|<reference|eq
        14.179.109>>>0> that\ 
        ...
        <\eqnarray*>
          ...
          of sums>>>>|<cell|-L<rsup|-1>\<circ\><around*|(|\<alpha\>\<cdot\>H<rsub|1>\<circ\>L<rsup|-1>+\<beta\>\<cdot\>H<rsub|2>\<circ\>L<rsup|-1>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|composition
          of sums>>>>|<cell|\<alpha\>\<cdot\><around*|(|-L<rsup|-1>\<circ\>H<rsub|1>\<circ\>L<rsup|-1>|)>+\<beta\>\<cdot\><around*|(|-L<rsup|-1>\<circ\>H<rsub|2>\<circ\>L<rsup|-1>|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>\<Phi\><around*|(|H<rsub|1>|)>+\<beta\>\<cdot\>\<Phi\><around*|(|H<rsub|2>|)>>>>>
        </eqnarray*>
      ...
      Define <math|\<chi\>:\<cal-G\>L<around*|(|X|)>\<rightarrow\>\<cal-G\>L<around*|(|X|)>\<times\>\<cal-G\>L<around*|(|X|)>>
      ...
      <\eqnarray*>
        ...
        of sums>>>>|<cell|<around*|(|-L|)>\<circ\><around*|(|\<alpha\>\<cdot\><around*|(|H<rsub|1>\<circ\>L<rprime|'>|)>+\<beta\>\<cdot\><around*|(|H<rsub|2>\<circ\>L<rprime|'>|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|composition
        of sums>>>>|<cell|\<alpha\>\<cdot\><around*|(|<around*|(|-L|)>\<circ\>H<rsub|1>\<circ\>L<rprime|'>|)>+\<beta\>\<cdot\><around*|(|<around*|(|-L|)>\<circ\>H<rsub|2>\<circ\>L<rprime|'>|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>\<Phi\><rsub|L,L<rprime|'>><around*|(|H<rsub|1>|)>+\<beta\>\<cdot\>\<Phi\><rsub|L,L<rprime|'>><around*|(|H<rsub|2>|)>>>>>
      </eqnarray*>
      ...
      <reference|norm of continuous linear mapping (inf)>
      ...
      <\eqnarray*>
        ...
        of sums>>>>|<cell|<around*|(|-\<alpha\>\<cdot\><around*|(|L<rsub|1>\<circ\>H\<circ\>L|)>+<around*|(|-\<beta\>|)>\<cdot\><around*|(|L<rsub|2>\<circ\>H\<circ\>L|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|composition
        of sums>>>>|<cell|\<alpha\>\<cdot\><around*|(|-L<rsub|1>\<circ\>H\<circ\>L|)>+\<beta\>\<cdot\><around*|(|-L<rsub|2>\<circ\>H\<circ\>L|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>\<Phi\><rsub|L<rsub|1>,L><around*|(|H|)>+\<beta\>\<cdot\>\<Phi\><rsub|L<rsub|2>,L><around*|(|H|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>\<rho\><around*|(|L<rsub|1>,L|)><around*|(|H|)>+\<beta\>\<cdot\>\<rho\><around*|(|L<rsub|2>,L|)><around*|(|H|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\>\<rho\><around*|(|L<rsub|1>,L|)>+\<beta\>\<cdot\>\<rho\><around*|(|L<rsub|2>,L|)>|)><around*|(|H|)>>>>>
      </eqnarray*>
      ...
      <\eqnarray*>
        ...
        of sums>>>>|<cell|<around*|(|-L\<circ\>H|)>\<circ\><around*|(|\<alpha\>\<cdot\>L<rsub|1>|)>+<around*|(|-L\<circ\>H|)>\<circ\><around*|(|\<beta\>\<cdot\>L<rsub|2>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|composition
        of sums>>>>|<cell|\<alpha\>\<cdot\><around*|(|-L\<circ\>H\<circ\>L<rsub|1>|)>+\<beta\>\<cdot\><around*|(|-L\<circ\>H\<circ\>L<rsub|2>|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>\<Phi\><rsub|L,L<rsub|1><around*|(|H|)>>+\<beta\>\<cdot\>\<Phi\><rsub|L,L<rsub|2>><around*|(|H|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>\<rho\><around*|(|L,L<rsub|1>|)>+\<beta\>\<cdot\>\<rho\><around*|(|L,L<rsub|2>|)><around*|(|H|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\>\<rho\><around*|(|L,L<rsub|1>|)>+\<beta\>\<cdot\>\<rho\><around*|(|L,L<rsub|2>|)>|)><around*|(|H|)>>>>>
      </eqnarray*>
...
<\references>
  <\collection>
    ...
    <associate|C^n is a local property|<tuple|14.68|427>>
    ...
    <associate|GL(X) is a group|<tuple|14.145|458>>
    ...
    <associate|Mean value theorem for balls|<tuple|14.121|?>>
    <associate|Ux definition|<tuple|14.1|?>>
    ...
    diffeomorphism|<tuple|14.158|465>>
    <associate|composition of differentials on arbitrary
    sets|<tuple|14.88|438>>
    <associate|composition of sums|<tuple|14.141|?>>
    ...
    <associate|consequence of Mean value theorem|<tuple|14.120|?>>
    <associate|consequence of mean value theorem (2)|<tuple|14.119|?>>
    <associate|constant functions are C^infinite|<tuple|14.73|428>>
    <associate|continuity of partial derivates|<tuple|14.131|?>>
    ...
    <associate|diffeomorphism are toplinear|<tuple|14.157|?>>
    ...
    differentiability|<tuple|14.132|453>>
    <associate|differentiability of K^n|<tuple|14.39|420>>
    <associate|differentiability of finite sum|<tuple|14.71|428>>
    ...
    <associate|differential and partial differentials|<tuple|14.133|?>>
    ...
    <associate|eq 12.100|<tuple|14.202|467>>
    <associate|eq 12.101|<tuple|14.203|468>>
    <associate|eq 12.102|<tuple|14.204|468>>
    <associate|eq 12.103|<tuple|14.205|468>>
    <associate|eq 12.104|<tuple|14.206|468>>
    <associate|eq 12.105|<tuple|14.207|468>>
    <associate|eq 12.106|<tuple|14.208|468>>
    <associate|eq 12.107|<tuple|14.209|468>>
    <associate|eq 12.108|<tuple|14.210|468>>
    <associate|eq 12.109|<tuple|14.211|468>>
    <associate|eq 12.12|<tuple|14.23|422>>
    <associate|eq 12.128|<tuple|14.214|470>>
    <associate|eq 12.129|<tuple|14.215|?>>
    <associate|eq 12.130|<tuple|14.216|470>>
    <associate|eq 12.131|<tuple|14.220|471>>
    <associate|eq 12.132|<tuple|14.221|471>>
    <associate|eq 12.133|<tuple|14.222|471>>
    <associate|eq 12.134|<tuple|14.223|471>>
    <associate|eq 12.135|<tuple|14.224|471>>
    <associate|eq 12.136|<tuple|14.225|471>>
    <associate|eq 12.137|<tuple|14.226|471>>
    <associate|eq 12.138|<tuple|14.227|471>>
    <associate|eq 12.139|<tuple|14.228|471>>
    <associate|eq 12.140|<tuple|14.229|471>>
    <associate|eq 12.141|<tuple|14.229|471>>
    ...
    <associate|eq 12.64|<tuple|14.151|459>>
    <associate|eq 12.65|<tuple|14.152|459>>
    <associate|eq 12.66|<tuple|14.153|459>>
    <associate|eq 12.67|<tuple|14.154|459>>
    <associate|eq 12.68|<tuple|14.155|460>>
    <associate|eq 12.69|<tuple|14.156|460>>
    <associate|eq 12.70|<tuple|14.157|460>>
    <associate|eq 12.71|<tuple|14.159|461>>
    <associate|eq 12.73|<tuple|14.158|461>>
    <associate|eq 12.74|<tuple|14.161|461>>
    <associate|eq 12.75|<tuple|14.162|462>>
    <associate|eq 12.87|<tuple|14.189|465>>
    <associate|eq 12.88|<tuple|14.190|466>>
    <associate|eq 12.89|<tuple|14.191|466>>
    <associate|eq 12.9|<tuple|14.193|466>>
    <associate|eq 12.90|<tuple|14.192|466>>
    <associate|eq 12.92|<tuple|14.194|466>>
    <associate|eq 12.93|<tuple|14.195|466>>
    <associate|eq 12.94|<tuple|14.196|466>>
    <associate|eq 12.95|<tuple|14.197|466>>
    <associate|eq 12.96|<tuple|14.198|467>>
    <associate|eq 12.97|<tuple|14.199|467>>
    <associate|eq 12.98|<tuple|14.200|467>>
    <associate|eq 12.99|<tuple|14.201|467>>
    ...
    <associate|eq 14.126.106|<tuple|14.126|?>>
    <associate|eq 14.127.106|<tuple|14.127|?>>
    <associate|eq 14.128.106|<tuple|14.128|?>>
    <associate|eq 14.129.106|<tuple|14.129|?>>
    <associate|eq 14.13.100|<tuple|14.14|?>>
    <associate|eq 14.130.106|<tuple|14.130|?>>
    <associate|eq 14.131.106|<tuple|14.131|?>>
    <associate|eq 14.133.106|<tuple|14.132|?>>
    <associate|eq 14.134.106|<tuple|14.133|?>>
    <associate|eq 14.135.106|<tuple|14.135|?>>
    <associate|eq 14.135.106.1|<tuple|14.134|?>>
    <associate|eq 14.136.106|<tuple|14.136|?>>
    <associate|eq 14.137.106|<tuple|14.137|?>>
    <associate|eq 14.138.106|<tuple|14.138|?>>
    <associate|eq 14.139.106|<tuple|14.139|?>>
    <associate|eq 14.14.100|<tuple|14.15|?>>
    <associate|eq 14.140.106|<tuple|14.141|?>>
    <associate|eq 14.140.2|<tuple|14.140|?>>
    <associate|eq 14.141.106|<tuple|14.142|?>>
    <associate|eq 14.142.106|<tuple|14.143|?>>
    <associate|eq 14.143.106|<tuple|14.144|?>>
    <associate|eq 14.144.106|<tuple|14.145|?>>
    <associate|eq 14.146.106|<tuple|14.146|?>>
    <associate|eq 14.147.107|<tuple|14.147|?>>
    <associate|eq 14.148.107|<tuple|14.148|?>>
    <associate|eq 14.149.020|<tuple|14.212|?>>
    <associate|eq 14.149.107|<tuple|14.149|?>>
    <associate|eq 14.15.100|<tuple|14.16|?>>
    <associate|eq 14.150.020|<tuple|14.213|?>>
    <associate|eq 14.150.107|<tuple|14.150|?>>
    <associate|eq 14.16.100|<tuple|14.17|?>>
    <associate|eq 14.160.107|<tuple|14.160|?>>
    <associate|eq 14.163.109|<tuple|14.163|?>>
    <associate|eq 14.164.107|<tuple|14.168|?>>
    <associate|eq 14.164.109|<tuple|14.164|?>>
    <associate|eq 14.165.109|<tuple|14.165|?>>
    <associate|eq 14.166.109|<tuple|14.166|?>>
    <associate|eq 14.167.107|<tuple|14.169|?>>
    <associate|eq 14.17.100|<tuple|14.18|?>>
    <associate|eq 14.170.108|<tuple|14.167|?>>
    <associate|eq 14.171.108|<tuple|14.170|?>>
    <associate|eq 14.172.108|<tuple|14.171|?>>
    <associate|eq 14.173.108|<tuple|14.172|?>>
    <associate|eq 14.174.108|<tuple|14.172|?>>
    <associate|eq 14.174.109|<tuple|14.174|?>>
    <associate|eq 14.175.109|<tuple|14.175|?>>
    <associate|eq 14.176.109|<tuple|14.176|?>>
    <associate|eq 14.177.109|<tuple|14.177|?>>
    <associate|eq 14.178.109|<tuple|14.178|?>>
    <associate|eq 14.179.109|<tuple|14.179|?>>
    <associate|eq 14.18.100|<tuple|14.19|?>>
    <associate|eq 14.180.109|<tuple|14.180|?>>
    <associate|eq 14.181.109|<tuple|14.181|?>>
    <associate|eq 14.182.109|<tuple|14.182|?>>
    <associate|eq 14.183.109|<tuple|14.184|?>>
    <associate|eq 14.183.109.1|<tuple|14.183|?>>
    <associate|eq 14.184.109|<tuple|14.185|?>>
    <associate|eq 14.185.109|<tuple|14.186|?>>
    <associate|eq 14.186.109|<tuple|14.187|?>>
    <associate|eq 14.188.109|<tuple|14.188|?>>
    ...
    <associate|evaluation function of L^m(X;Y)|<tuple|14.138|?>>
    <associate|evaluation operator (1)|<tuple|14.124|?>>
    <associate|extremum and derivate|<tuple|14.95|442>>
    <associate|f is C infinite if D1f is c infinite|<tuple|14.66|?>>
    ...
    <associate|implicit function theorem|<tuple|14.170|470>>
    <associate|in Banach spaces linear continuous mappings are
    toplinear|<tuple|14.143|458>>
    <associate|inverse function theorem|<tuple|14.160|465>>
    <associate|inverse mapping is c-infinite|<tuple|14.153|461>>
    <associate|inverse of derivative|<tuple|14.168|?>>
    <associate|inverse theorem for Df(0)=1X|<tuple|14.161|465>>
    ...
    <associate|proposition 12.116|<tuple|14.162|466>>
    <associate|proposition 12.118|<tuple|14.164|467>>
    <associate|proposition 12.120|<tuple|14.166|469>>
    <associate|rolles theorem|<tuple|14.96|443>>
    <associate|second mean value theorem|<tuple|14.115|447>>
    <associate|strictly increasing function and derivative|<tuple|14.98|?>>
    <associate|sum of (01,...,*,...0n)|<tuple|14.25|417>>
    <associate|sum of C^n functions is C^n|<tuple|14.70|427>>
    <associate|sum of differentiable functions|<tuple|14.29|417>>
    <associate|sum of linear function and infinite sum|<tuple|14.150|459>>
    <associate|sum of n-times differentiable functions is n-times
    differentiable|<tuple|14.69|427>>
    <associate|symmetry of L^n+t(X;Y) based on permutations and
    transposition|<tuple|14.123|449>>
    <associate|symmetry of partial differentials|<tuple|14.134|?>>
    <associate|the n-th differential is symmetric|<tuple|14.128|450>>
    <associate|toplinear in normed space|<tuple|14.142|457>>
