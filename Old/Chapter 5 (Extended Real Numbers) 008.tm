...
<\body>
  ...
  <\theorem>
    Let <math|A\<subseteq\><wide|\<bbb-R\>|\<bar\>>> then\ 

    <\enumerate>
      <item>If <math|A\<subseteq\><around*|]|-\<infty\>,\<infty\>|]>> and
      <math|sup<around*|(|A|)>\<less\>\<infty\>> then
      <math|A\<subseteq\>\<bbb-R\>> and <math|sup<around*|(|A|)>=sup<rsub|\<bbb-R\>><around*|(|A|)>>

      <item>If <math|A\<subset\>-<around*|[|-\<infty\>,\<infty\>|[>>
      <math|-\<infty\>\<less\>inf<around*|(|A|)>> then
      <math|A\<subseteq\>\<bbb-R\>> and <math|inf<around*|(|A|)>=inf<rsub|\<bbb-R\>><around*|(|A|)>>
    </enumerate>
    ...
    <\proof>
      ...
      <\enumerate>
        ...
        proving that <math|sup<rsub|\<bbb-R\>><around*|(|A|)>\<leqslant\><rsub|\<bbb-R\>>sup<around*|(|A|)>>.
        ...
        proving that <math|inf<around*|(|A|)>\<leqslant\><rsub|\<bbb-R\>>inf<rsub|\<bbb-R\>><around*|(|A|)>>.
  ...
  <\note>
    To simplify notations we adopt the notation <math|a-b> to mean
  ...
  <\proof>
    Let <math|x\<in\>X> and <math|U\<in\>f<around*|(|x|)>> then as
  ...
  <\notation>
    Given <math|k\<in\>\<bbb-N\>> we note
    <math|<around*|{|i\<in\>\<bbb-N\>\|k\<leqslant\>i|}>> as
  ...
  <\proof>
    ...
    <math|S<rsub|n>=<around*|{|m\<in\>\<bbb-N\><rsub|0>\|x<rsub|n>\<leqslant\>x<rsub|n+m>
  ...
  <\lemma>
    ...
    sequences of extended <with|font-series|bold|reals> then\ 
    ...
    <\enumerate>
      ...
      <math|sup<around*|(|<around*|{|x<rsub|i>\|i\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>+sup<around*|(|<around*|{|y<rsub|i>\|i\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>=sup<around*|(|<around*|{|x<rsub|i>+y<rsub|i>\|i\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>>
      ...
      <math|inf<around*|(|<around*|{|x<rsub|i>\|i\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>+inf<around*|(|<around*|{|y<rsub|i>\|i\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>=inf<around*|(|<around*|{|x<rsub|i>+y<rsub|i>\|i\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>>
    </enumerate>
    ...
    <\proof>
      ...
      <\enumerate>
        ...
        we have <math|x<rsub|i>\<leqslant\>sup<around*|(|<around*|{|x<rsub|j>\|j\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>>
        and <math|y<rsub|i>\<leqslant\>sup<around*|(|<around*|{|y<rsub|j>\|j\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>>
        so that <math|\<forall\>i\<in\><around*|{|k,\<ldots\>,\<infty\>|}>>
        ...
        as in all cases we have that <math|y<rsub|i>\<leqslant\>y<rsub|i>\<leqslant\>sup<around*|(|<around*|{|x<rsub|j>+y<rsub|j>\|j\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>-x<rsub|l>>
        it follows that\ 
        ...
        Consider now the fo;llowing cases for
  ...
  <\theorem>
    <label|liminf and limsup properties for sum product><math|<below|lim
    ...
    <\enumerate>
      ...
      be sequences of reals such that <math|<around*|(|<below|lim
      inf|i\<rightarrow\>\<infty\>> x<rsub|i>|)>+<around*|(|<below|lim
      inf|i\<rightarrow\>\<infty\>> y<rsub|i>|)>> is well defined
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        Now as <math|\<forall\>l\<in\>inf<around*|(|<around*|{|x<rsub|j>\|j\<in\><around*|{|l,\<ldots\>,\<infty\>|}>|}>|)>\<leqslant\>inf<around*|(|<around*|{|x<rsub|j>\|j\<in\><around*|{|l+1,\<ldots\>,\<infty\>|}>|}>|)>>
        ...
        so using <reference|lim inf -xn> we have <math|-<below|lim
  ...
  <\remark>
    ...
    autimatical assume that the limit exists.
  </remark>
  ...
  <\theorem>
    ...
    <math|<around*|{|x<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>> be such that
    <math|\<forall\>i\<in\>\<bbb-N\>> we have that <math|x+x<rsub|i>> is well
    defined and <math|<below|lim|i\<rightarrow\>\<infty\>>x<rsub|i>> exists
  ...
  <\proof>
    ...
    <\description>
      ...
      <math|y=f<around*|(|x|)>>, so there exists a
      <math|m\<in\>\<bbb-N\><rsub|0>> such that <math|m\<geqslant\>x> and
      then <math|f<rsub|m>=f<around*|(|m|)>\<geqslant\>f<around*|(|x|)>=y>
      proving by <reference|sup of set of bigger elements> that
      ...
      <math|y=f<around*|(|x|)>>, so there exists a
      <math|m\<in\>\<bbb-N\><rsub|0>> such that <math|m\<geqslant\>x> and
      then <math|f<rsub|m>=f<around*|(|m|)>\<leqslant\>f<around*|(|x|)>=y>
      proving by <reference|sup of set of bigger elements> that
  ...
  <\example>
    ...
    <math|k,l\<in\>\<bbb-N\>> with <math|k\<leqslant\>l> and let
    <math|<around*|{|x<rsub|i>|}><rsub|i\<in\><around*|{|k,\<ldots\>.,\<infty\>|}>>>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      as <math|x,\<varepsilon\>\<in\>\<bbb-N\>> we have that
  ...
  <\note>
    ...
    <\note>
      ...
      <math|<around*|{|x<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>> defined by
      <math|x<rsub|i>=<frac|1|i>> and <math|<around*|{|y<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>
  ...
  <\proof>
    ...
    <\description>
      ...
      reals>) \ there exists a <math|C\<in\>\<bbb-N\>> such that
  ...
  <\proof>
    As <math|<around*|{|n|}><rsub|n\<in\>\<bbb-N\>>> is increasing
    <math|<below|lim|n\<rightarrow\>\<infty\>>n=sup<around*|(|<around*|{|n\|n\<in\>\<bbb-N\>|}>|)>=sup<around*|(|\<bbb-N\>|)>>
    which exists. Assume that <math|sup<around*|(|\<bbb-N\>|)>\<less\>\<infty\>>
    then there exists a <math|n\<in\>\<bbb-N\>> such that
    <math|sup<around*|(|\<bbb-N\><rsub|0><rsub|n>|)>\<less\>n\<leqslant\>sup<around*|(|\<bbb-N\>|)>\<less\>n>
  ...
  <\proof>
    ...
    <math|\<forall\>i\<in\>\<bbb-N\>> <math|x-x<rsub|i>> is well defined.
    Also by <reference|alternative definition of limit in the extented reals>
    we have that <math|\<forall\>\<varepsilon\>\<in\>\<bbb-R\><rsub|+>> there
    exists a <math|N\<in\><around*|{|k,\<ldots\>,\<infty\>|}>> such that
    <math|\<forall\>n\<geqslant\>N> we have
  ...
  <\note>
    ...
    needed. For example take <math|<around*|{|x<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>
  ...
  <\theorem>
    ...
    sequences of extented reals> we have <math|<big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>=sup<around*|(|<big|sum><rsub|i=k><rsup|n>x<rsub|i>\|n\<in\>\<bbb-N\>|)>>
  </theorem>
  ...
  <\theorem>
    ...
    be a family of extended reals then we have for
    <math|S=<around*|{|i\<in\><around*|{|k,\<ldots\>,\<infty\>|}>\|x<rsub|i>\<neq\>0|}>\<subseteq\><around*|{|k,\<ldots\>,\<infty\>|}>>
    either

    <\enumerate>
      <item><math|S=\<emptyset\>> then <math|<big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>=0>

      <item><math|S> finite non empty, so that there exists a bijection
      <math|\<beta\>:<around*|{|1,\<ldots\>,n|}>\<rightarrow\>S>, then we
      have <math|<big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>=<big|sum><rsub|i=1><rsup|n>x<rsub|\<beta\><around*|(|i|)>>>

      <item><math|S> is infinite, so using <reference|every subset of N is
      finite or denumerable> there exists a bijection
      <math|\<beta\>:\<bbb-N\>\<rightarrow\>\<cal-S\>>, then we have
      <math|<big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>=<big|sum><rsub|i=1><rsup|n>x<rsub|\<beta\><around*|(|i|)>>>
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>As <math|S=\<emptyset\>> we have
      <math|\<forall\>i\<in\><around*|{|k,\<ldots\>,\<infty\>|}>>
      <math|x<rsub|i>> so that <math|sup<around*|(|<around*|{|<big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>\|i\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>=sup<around*|(|<around*|{|0|}>|)>=0>

      <item>Take <math|m=max<around*|(|\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>|)>>
      then <math|\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>\<subseteq\><around*|{|k,\<ldots\>,m|}>>
      hence\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<big|sum><rsub|i=k><rsup|m>x<rsub|i>>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|k,\<ldots\>,m|}>>x<rsub|i>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|generalized
        sum and union>>>>|<cell|<big|sum><rsub|i\<in\><around*|{|k,\<ldots\>,m|}>\\\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>>x<rsub|i>+<big|sum><rsub|i\<in\>\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>>x<rsub|i>>>|<row|<cell|>|<cell|=>|<cell|0+<big|sum><rsub|i\<in\>\<beta\><around*|(|<around*|{|k,\<ldots\>,n|}>|)>>x<rsub|i>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|generalized
      ...
      If <math|l\<gtr\>m> then we have\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<big|sum><rsub|i=k><rsup|k>x<rsub|i>>|<cell|=>|<cell|<big|sum><rsub|i=k><rsup|m>x<rsub|i>+<big|sum><rsub|i=m+1><rsup|l>x<rsub|i>>>|<row|<cell|>|<cell|\<equallim\><rsub|i\<gtr\>m\<Rightarrow\>i\<in\>\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>>>|<cell|<big|sum><rsub|i=k><rsup|m>x<rsub|i><eq-number><label|eq
        17.26.01>>>>>
      </eqnarray*>

      As <math|\<forall\>l\<in\><around*|{|k,\<ldots\>,m-1|}>> we have
      <math|<big|sum><rsub|i=k><rsup|l>x<rsub|i>\<leqslant\><rsub|<text|<reference|series
      are increasing>>><big|sum><rsub|i=k><rsup|m>x<rsub|i>> we have by
      <reference|eq 17.25.01>,<reference|eq 17.26.01> that
      <math|\<forall\>i\<in\><around*|{|k,\<ldots\>,\<infty\>|}>>
      <math|<big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>\<leqslant\><big|sum><rsub|i=1><rsup|n>x<rsub|\<beta\><around*|(|i|)>>>
      so that\ 

      <\equation*>
        <big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>=sup<around*|(|<around*|{|<big|sum><rsub|i=k><rsup|l>x<rsub|i>\|l\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>\<leqslant\><big|sum><rsub|i=1><rsup|n>x<rsub|\<beta\><around*|(|i|)>>
      </equation*>

      and as <math|<big|sum><rsub|i=1><rsup|n>x<rsub|\<beta\><around*|(|i|)>>\<equallim\><rsub|<text|<reference|eq
      17.25.01>>><big|sum><rsub|i=k><rsup|m>x<rsub|i>\<in\><around*|{|<big|sum><rsub|i=k><rsup|l>x<rsub|i>\|l\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>>
      so that <math|><math|<big|sum><rsub|i=1><rsup|n>x<rsub|\<beta\><around*|(|i|)>>\<leqslant\>sup<around*|(|<around*|{|<big|sum><rsub|i=k><rsup|l>x<rsub|i>\|l\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>|)>=<big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>>
      proving that\ 

      <\equation>
        <big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>=<big|sum><rsub|i=1><rsup|n>x<rsub|\<beta\><around*|(|i|)>>
      </equation>

      proving (2)

      <item>Take <math|A=<around*|{|<big|sum><rsub|i=k><rsup|n>x<rsub|i>\|n\<in\><around*|{|k,\<ldots\>,\<infty\>|}>|}>>
      and <math|B=<around*|{|<big|sum><rsub|i=1><rsup|n>x<rsub|\<beta\><around*|(|i|)>>\|n\<in\><around*|{|1,\<ldots\>,n|}>|}>>.
      Given <math|<big|sum><rsub|i=k><rsup|n>x<rsub|i>\<in\>A> we have two
      cases to consider:

      <\description>
        <item*|<math|\<forall\>i\<in\><around*|{|k,\<ldots\>,n|}>\<vDash\>x<rsub|i>=0>>then
        <math|<big|sum><rsub|i=k><rsup|n>x<rsub|i>=0\<less\><big|sum><rsub|i=1><rsup|1>x<rsub|\<beta\><around*|(|i|)>>\<in\>B>

        <item*|<math|\<exists\>i\<in\><around*|{|k,\<ldots\>,n|}>\<vdash\>x<rsub|i>\<neq\>\<emptyset\>>>then
        <math|\<emptyset\>\<neq\><around*|{|i\<in\><around*|{|k,\<ldots\>,n|}>\|x<rsub|i>\<neq\>0|}>>
        so that <math|m=max<around*|(|\<beta\><rsup|-1><around*|(|<around*|{|i\<in\><around*|{|k,\<ldots\>,n|}>\|x<rsub|i>\<neq\>0|}>|)>|)>>
        exists and as <math|\<beta\><rsup|-1><around*|(|<around*|{|i\<in\><around*|{|k,\<ldots\>,n|}>\|x<rsub|i>\<neq\>0|}>|)>\<subseteq\><around*|{|1,\<ldots\>,,m|}>\<Rightarrow\><around*|{|k,\<ldots\>,n|}>\<subseteq\>\<beta\><around*|(|<around*|{|1,\<ldots\>,m|}>|)>>.
        Further\ 

        <\eqnarray*>
          <tformat|<table|<row|<cell|B\<ni\><big|sum><rsub|i=1><rsup|m>x<rsub|\<beta\><around*|(|i|)>>>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,m|}>>x<rsub|\<beta\><around*|(|i|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|generalized
          sums and bijections>>>>|<cell|<big|sum><rsub|i\<in\>\<beta\><around*|(|<around*|{|1,\<ldots\>,m|}>|)>>x<rsub|i>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\>\<beta\><around*|(|<around*|{|1,\<ldots\>,m|}>|)>\\<around*|{|k,\<ldots\>,n|}>>x<rsub|i>+<big|sum><rsub|i\<in\><around*|{|k,\<ldots\>,n|}>>x<rsub|i>>>|<row|<cell|>|<cell|\<geqslant\>>|<cell|<big|sum><rsub|i\<in\><around*|{|k,\<ldots\>,n|}>>x<rsub|i>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=k><rsup|n>x<rsub|i>>>>>
        </eqnarray*>
      </description>

      Hence <math|\<forall\>x\<in\>A> there exists a <math|y\<in\>B> such
      that <math|x\<leqslant\>y>, so using <reference|sup of set of bigger
      elements> we have that\ 

      <\equation>
        <big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>=sup<around*|(|A|)>\<leqslant\>sup<around*|(|B|)>=<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<beta\><around*|(|i|)>>
      </equation>

      <label|eq 17.28.01>Take <math|<big|sum><rsub|i=1><rsup|n>x<rsub|\<beta\><around*|(|i|)>>\<in\>B>
      take then <math|m=max<around*|(|\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>|)>>
      then <math|\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>\<subseteq\><around*|{|k,\<ldots\>,m|}>>
      so that\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<big|sum><rsub|i=k><rsup|m>x<rsub|i>>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|k,\<ldots\>,m|}>>x<rsub|i>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|k,\<ldots\>,m|}>\\\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>>x<rsub|i>+<big|sum><rsub|i\<in\>\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>>x<rsub|i>>>|<row|<cell|>|<cell|=>|<cell|0+<big|sum><rsub|i\<in\>\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>>x<rsub|i>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|generalized
        sums and bijections>>>>|<cell|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>x<rsub|\<beta\><around*|(|i|)>>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|n>x<rsub|\<beta\><around*|(|i|)>>>>>>
      </eqnarray*>

      Hence <math|\<forall\>x\<in\>B> there exists a <math|y\<in\>A> such
      that <math|x\<leqslant\>y>, so using <reference|sup of set of bigger
      elements> we have that\ 

      <\equation>
        <big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<beta\><around*|(|i|)>>=sup<around*|(|B|)>\<leqslant\>sup<around*|(|A|)>=<big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>
      </equation>

      which together with <reference|eq 17.28.01> proves that\ 

      <\equation*>
        <big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i>=<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<beta\><around*|(|i|)>>
      </equation*>
  ...
  <\theorem>
    ...
    <math|<around*|{|x<rsub|<around*|(|i,j|)>>|}><rsub|<around*|(|i,j|)>\<in\><around*|{|k,\<ldots\>,\<infty\>|}>\<times\><around*|{|l,\<ldots\>,\<infty\>|}>>>
    ...
    sum> we have for <math|<around*|{|x<rsub|<around*|(|i,j|)>>|}><rsub|<around*|(|i,j|)>\<in\><around*|{|k,\<ldots\>,n|}>\<times\><around*|{|l,\<ldots\>,m|}>>>
  ...
  <\proof>
    ...
    <\eqnarray*>
      ...
      and inequalities of family>>>>|<cell|<big|sum><rsub|i=k><rsup|n>sup<around*|(|<around*|{|<big|sum><rsub|j=l><rsup|m>x<rsub|<around*|(|i,j|)>>\|m\<in\>\<bbb-N\>|}>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=k><rsup|n><around*|(|<big|sum><rsub|j=l><rsup|\<infty\>>x<rsub|<around*|(|i,j|)>>|)>>>>>
    </eqnarray*>

    From the above it follows that <math|<big|sum><rsub|i=p><rsup|\<infty\>>x<rsub|\<sigma\><around*|(|i|)>>=sup<around*|(|<around*|{|<big|sum><rsub|i=p><rsup|m>x<rsub|\<sigma\><around*|(|i|)>>\|m\<in\>\<bbb-N\>|}>|)>\<leqslant\><big|sum><rsub|i=k><rsup|n><around*|(|<big|sum><rsub|j=l><rsup|\<infty\>>x<rsub|<around*|(|i,j|)>>|)>>
    so we have\ 
    ...
    <\eqnarray*>
      ...
      infinite and finite sum>>>>|<cell|<big|sum><rsub|j=l><rsup|\<infty\>><around*|(|<big|sum><rsub|i=k><rsup|n>x<rsub|<around*|(|i,j|)>>|)>>>|<row|<cell|>|<cell|=>|<cell|sup<around*|{|<around*|(|<big|sum><rsub|j=l><rsup|m><around*|(|<big|sum><rsub|i=k><rsup|n>x<rsub|<around*|(|i,j|)>>|)>|)>\|m\<in\>\<bbb-N\>|}>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|interchange
      infinite and finite sum>>>>|<cell|sup<around*|{|<around*|(|<big|sum><rsub|i=k><rsup|n><around*|(|<big|sum><rsub|j=l><rsup|m>x<rsub|<around*|(|i,j|)>>|)>|)>\|m\<in\>\<bbb-N\>|}>>>|<row|<cell|>|<cell|\<leqslant\><rsub|>>|<cell|<big|sum><rsub|i=p><rsup|\<infty\>>x<rsub|\<sigma\><around*|(|i|)>>>>>>
    </eqnarray*>
  ...
  <\proof>
    ...
    Now <math|\<forall\>m\<in\>\<bbb-N\>> we have
    <math|<big|sum><rsub|r=k><rsup|N<rsub|m>><around*|(|<big|sum><rsub|j=m<rsub|r>><rsup|n<rsub|r>>x<rsub|<around*|(|r,j|)>>|)>\<leqslant\>sup<around*|(|<around*|{|<big|sum><rsub|r=k><rsup|n><around*|(|<big|sum><rsub|j=m<rsub|r>><rsup|n<rsub|r>>x<rsub|<around*|(|r,j|)>>|)>\|n\<in\>\<bbb-N\>|}>|)>=<big|sum><rsub|r=1><rsup|\<infty\>><around*|(|<big|sum><rsub|j=m<rsub|r>><rsup|n<rsub|r>>x<rsub|<around*|(|r,j|)>>|)>>
    ...
    <\eqnarray*>
      ...
      sums and bijections>>>>|<cell|<big|sum><rsub|i\<in\><around*|{|l,\<ldots\>,N<rsub|m>|}>><rsup|>x<rsub|\<sigma\><around*|(|i|)>>=<big|sum><rsub|i=l><rsup|N<rsub|m>>x<rsub|\<sigma\><around*|(|i|)>>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|sup<around*|(|<around*|{|<big|sum><rsub|i=l><rsup|n>x<rsub|\<sigma\><around*|(|i|)>>\|n\<in\>\<bbb-N\>|}>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=l><rsup|\<infty\>>x<rsub|\<sigma\><around*|(|i|)>>>>>>
    </eqnarray*>

    Using the definition of a supremum we have then
    <math|<big|sum><rsub|i=k><rsup|\<infty\>><around*|(|<big|sum><rsub|j=m<rsub|i>><rsup|n<rsub|i>>x<rsub|<around*|(|i,j|)>>|)>=sup<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|m><around*|(|<big|sum><rsub|j=m<rsub|i>><rsup|n<rsub|i>>x<rsub|<around*|(|i,j|)>>|)>\|m\<in\>\<bbb-N\>|}>|)>\<leqslant\><big|sum><rsub|i=l><rsup|\<infty\>>x<rsub|\<sigma\><around*|(|i|)>>>,
  ...
  <\theorem>
    ...
    <math|<around*|{|<around*|{|x<rsub|i,j>|}><rsub|i\<in\>\<bbb-N\>>|}><rsub|j\<in\>\<bbb-N\>>>
    a sequence of sequences of extended positive reals and
    <math|\<sigma\>:\<bbb-N\>\<rightarrow\>\<bbb-N\>\<times\>\<bbb-N\>> a
    bijection (which exists as by <reference|product of enumerable sets is
    enumerable> <math|\<bbb-N\>\<times\>\<bbb-N\>> is denumerable) then
    <math|<big|sum><rsub|i\<in\>\<bbb-N\>>x<rsub|\<sigma\><around*|(|i|)><rsub|1>,\<sigma\><around*|(|i|)><rsub|2>>=<big|sum><rsub|i=1><rsup|\<infty\>><around*|(|<big|sum><rsub|j=1><rsup|\<infty\>>x<rsub|i,j>|)>\<equallim\><rsub|<text|<reference|interchange
    infinite and finite sum>>><big|sum><rsub|j=1><rsup|\<infty\>><around*|(|<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|i,j>|)>>
  </theorem>

  <\proof>
    Let <math|n\<in\>\<bbb-N\>> take then
    ...
    over product of sets>>><big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,N<rsub|n>|}>><around*|(|<big|sum><rsub|j\<in\><around*|{|1,\<ldots\>,M<rsub|n>|}>>x<rsub|i,j>|)>=<big|sum><rsub|i=1><rsup|N<rsub|n>><around*|(|<big|sum><rsub|j=1><rsup|M<rsub|n>>x<rsub|i,j>|)>\<leqslant\><big|sum><rsub|i=1><rsup|N<rsub|n>>sup<around*|(|<around*|{|<big|sum><rsub|j=1><rsup|m>x<rsub|i,j>\|m\<in\>\<bbb-N\>|}>|)>=<big|sum><rsub|i=><rsup|N<rsub|n>><around*|(|<big|sum><rsub|j=1><rsup|\<infty\>>x<rsub|i,j>|)>\<leqslant\>sup<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|m><around*|(|<big|sum><rsub|j=1><rsup|\<infty\>>x<rsub|i,j>|)>\|m\<in\>\<bbb-N\>|}>|)>=<big|sum><rsub|i=1><rsup|\<infty\>><around*|(|<big|sum><rsub|j=1><rsup|\<infty\>>x<rsub|i,j>|)>\<Rightarrow\><big|sum><rsub|i=1><rsup|n>x<rsub|\<sigma\><around*|(|i|)><rsub|1>,\<sigma\><around*|(|i|)><rsub|2>>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>><around*|(|<big|sum><rsub|j=1><rsup|\<infty\>>x<rsub|i,j>|)>>.
    ...
    Let now take <math|n,m\<in\>\<bbb-N\>> and take
    ...
    are increasing>>><big|sum><rsub|<around*|(|i,j|)>\<in\>\<sigma\><around*|(|<around*|{|1,\<ldots\>,N|}>|)>>x<rsub|i,j>=<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,N|}>>x<rsub|\<sigma\><around*|(|i|)><rsub|1>,\<sigma\><around*|(|i|)><rsub|2>>=<big|sum><rsub|i=1><rsup|N>x<rsub|\<sigma\><around*|(|i|)><rsub|1>,\<sigma\><around*|(|i|)><rsub|2>>\<leqslant\>sup<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|k>x<rsub|\<sigma\><around*|(|i|)><rsub|1>,\<sigma\><around*|(|i|)><rsub|2>>\|k\<in\>\<bbb-N\>|}>|)>=<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<sigma\><around*|(|i|)><rsub|1>,\<sigma\><around*|(|i|)><rsub|2>>>
    proving that <math|<big|sum><rsub|i=1><rsup|n><around*|(|<big|sum><rsub|j=1><rsup|m>x<rsub|i,j>|)>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<sigma\><around*|(|i|)><rsub|1>,\<sigma\><around*|(|j|)><rsub|2>>\<Rightarrow\><big|sum><rsub|i=1><rsup|\<infty\>><around*|(|<big|sum><rsub|j=1><rsup|m>x<rsub|i,j>|)>=sup<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|k><around*|(|<big|sum><rsub|j=1><rsup|m>x<rsub|i,j>|)>\|k\<in\>\<bbb-N\>|}>|)>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<sigma\><around*|(|i|)><rsub|1>,\<sigma\><around*|(|i|)><rsub|2>>\<Rightarrowlim\><rsub|<text|<reference|interchange
    infinite and finite sum>>><big|sum><rsub|j=1><rsup|m><around*|(|<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|i,j>|)>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<sigma\><around*|(|i|)><rsub|1>,\<sigma\><around*|(|i|)><rsub|2>>\<Rightarrow\><big|sum><rsub|j=1><rsup|\<infty\>><around*|(|<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|i,j>|)>=sup<around*|(|<around*|{|<big|sum><rsub|j=1><rsup|k><around*|(|<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|i,j>|)>\|k\<in\>\<bbb-N\>|}>|)>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<sigma\><around*|(|i|)><rsub|1>,\<sigma\><around*|(|i|)><rsub|2>>\<Rightarrowlim\><rsub|<text|<reference|interchange
  ...
  <\theorem>
    <label|associativity of inifinite series>Let <math|n\<in\>\<bbb-N\>>,
    <math|<around*|{|\<sigma\><rsub|i>:\<bbb-N\>\<rightarrow\>\<sigma\><around*|(|\<bbb-N\>|)>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    a set of bijections so that <math|<big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<sigma\><rsub|i><around*|(|\<bbb-N\>|)>=\<bbb-N\>>
    and <math|\<forall\>i,j\<in\><around*|{|1,\<ldots\>,n|}>> with
    <math|i\<neq\>j> we have <math|\<sigma\><rsub|i><around*|(|\<bbb-N\>|)><big|cap>\<sigma\><rsub|j><around*|(|\<bbb-N\>|)>=\<emptyset\>>
    and <math|<around*|{|x<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>> a sequence of
    non-negative extended reals then <math|<big|sum><rsub|i=1><rsup|n><around*|(|<big|sum><rsub|j=1><rsup|\<infty\>>x<rsub|\<sigma\><rsub|i><around*|(|j|)>>|)>=<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|i>>
  </theorem>
  ...
  <\proof>
    ...
    Given <math|m\<in\>\<bbb-N\>> we have
    <math|\<forall\>i,j\<in\><around*|{|1,\<ldots\>,n|}>\<vdash\>i\<neq\>j>
    that <math|\<sigma\><rsub|i><around*|(|<around*|{|1,\<ldots\>,m|}>|)><big|cap>\<sigma\><rsub|j><around*|(|<around*|{|1,\<ldots\>,m|}>|)>\<subseteq\>\<sigma\><rsub|i><around*|(|\<bbb-N\>|)><big|cap>\<sigma\><rsub|j><around*|(|\<bbb-N\>|)>=\<emptyset\>>
    ...
    <\equation>
      <label|eq 14.23.409>\<forall\>m\<in\>\<bbb-N\><text| we have
    ...
    <math|<big|sum><rsub|i=1><rsup|n><around*|(|<big|sum><rsub|j=1><rsup|m>x<rsub|\<sigma\><rsub|i><around*|(|j|)>>|)>\<leqslant\><big|sum><rsub|i=1><rsup|N<rsub|m>>x<rsub|i>\<leqslant\>sup<around*|(|<big|sum><rsub|i=1><rsup|m>x<rsub|i>\|m\<in\>\<bbb-N\>|)>\<equallim\><rsub|<text|<reference|series
    ...
    <math|<big|sum><rsub|j=1><rsup|\<infty\>><around*|(|<big|sum><rsub|i=1><rsup|n>x<rsub|\<sigma\><rsub|i><around*|(|j|)>>|)>=sup<around*|(|<around*|{|<big|sum><rsub|j=1><rsup|m><around*|(|<big|sum><rsub|i=1><rsup|n>x<rsub|\<sigma\><rsub|i><around*|(|j|)>>|)>\|m\<in\>\<bbb-N\>|}>|)>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|i>>
    giving\ 
    ...
    For the opposite inequality let <math|m\<in\>\<bbb-N\>> then
    <math|\<forall\>k\<in\><around*|{|1,\<ldots\>,m|}>> we have, as
    <math|\<bbb-N\>=<big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<sigma\><rsub|i><around*|(|\<bbb-N\>|)>>,
    that there exists a <math|i<rsub|k>\<in\><around*|{|1,\<ldots\>,n|}>>
    such that <math|k\<in\>\<sigma\><rsub|i<rsub|k>><around*|(|\<bbb-N\>|)>>
    and thus a <math|l<rsub|k>\<in\>\<bbb-N\>> such that
  ...
  <\definition>
    <label|generalized sum of the extended reals>Let
    <math|I\<subseteq\>\<bbb-N\>> and let
    <math|<around*|{|x<rsub|i>|}><rsub|i\<in\>I>\<subseteq\><around*|[|0,\<infty\>|]>>
    then we define <math|<big|sum><rsub|i\<in\>I>x<rsub|i>> as follows (using
    the possible cases for <math|I> (see <reference|subsets of denumerable
    sets are finite or denumerable>)\ 

    <\description>
      <item*|<math|I=\<emptyset\>>><math|<big|sum><rsub|i\<in\>I>x<rsub|i>=0>

      <item*|<math|I<text| is finite>>>then there exists a bijection
      <math|\<beta\>:<around*|{|1,\<ldots\>,#<around*|(|I|)>|}>\<rightarrow\>I>
      and we define <math|<big|sum><rsub|i\<in\>I>x<rsub|i>> by
      <math|<big|sum><rsub|i\<in\>I>x<rsub|i>=<big|sum><rsub|i=1><rsup|#<around*|(|I|)>>x<rsub|\<beta\><around*|(|i|)>>>

      <item*|<math|I is denumerable>>then there exists a bijection
      <math|\<beta\>:\<bbb-N\>\<rightarrow\>I> and we
      <math|<big|sum><rsub|i\<in\>I>x<rsub|i>> by
      <math|<big|sum><rsub|i\<in\>I>x<rsub|i>=<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<beta\><around*|(|i|)>>>
    </description>
  </definition>

  We must of course prove that the above definition is independent of the
  choosen bijection.
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|\<emptyset\>\<neq\>I<text| is finite>>>If
      <math|\<alpha\>,\<beta\>:<around*|{|1,\<ldots\>,#<around*|(|I|)>|}>\<rightarrow\>I>
      are two bijections then <math|\<tau\>=\<alpha\>\<circ\>\<beta\><rsup|-1>>
      is a bijection and <math|<big|sum><rsub|i=1><rsup|#<around*|(|I|)>>x<rsub|\<beta\><around*|(|i|)>>\<equallim\><rsub|<text|<reference|sum
      of extented reals is indepenent of order the
      reals>>><big|sum><rsub|i=1><rsup|#<around*|(|I|)>>x<rsub|\<tau\><around*|(|\<beta\><around*|(|i|)>|)>>=<big|sum><rsub|i=1><rsup|#<around*|(|I|)>>x<rsub|\<alpha\><around*|(|i|)>>>
      showing that the definition is independent of the choosing definition.

      <item*|<math|I<text| is denumberable>>><item*|<math|\<emptyset\>\<neq\>I<text|
      is finite>>>If <math|\<alpha\>,\<beta\>:\<bbb-N\>\<rightarrow\>I> are
      two bijections then <math|\<tau\>=\<alpha\>\<circ\>\<beta\><rsup|-1>>
      is a bijection and <math|<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<beta\><around*|(|i|)>>\<equallim\><rsub|<text|<reference|sum
      of extented reals is indepenent of order the
      reals>>><big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<tau\><around*|(|\<beta\><around*|(|i|)>|)>>=<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<alpha\><around*|(|i|)>>>
      showing that the definition is independent of the choosing definition.\ 
    </description>
  </proof>

  <\note>
    As <math|\<bbb-1\><rsub|<around*|{|1,\<ldots\>,n|}>>:<around*|{|1,\<ldots\>,n|}>\<rightarrow\><around*|{|1,\<ldots\>,n|}>>
    is a bijection we have using the above definition that
    <math|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>x<rsub|i>=<big|sum><rsub|i=1><rsup|n>x<rsub|i>>
    for <math|<around*|{|x<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\><around*|[|0,\<infty\>|]>>.
    Also as <math|\<bbb-1\><rsub|\<bbb-N\>>:\<bbb-N\>\<rightarrow\>\<bbb-N\>>
    is a bijection then using the definition we have
    <math|<big|sum><rsub|i\<in\>\<bbb-N\>>x<rsub|i>=<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|i>>
    for <math|<around*|{|x<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\><around*|[|0,\<infty\>|]>>.
  </note>

  We can now reformulate many of the theorems and lemmas of the previous
  section

  <\theorem>
    <label|series of extended reals and zeroes (1)>Let
    <math|I\<subseteq\>\<bbb-N\>> and <math|<around*|{|x<rsub|i>|}><rsub|i\<in\>I>\<subseteq\><around*|[|0,\<infty\>|]>>
    then <math|<big|sum><rsub|i\<in\>I>x<rsub|i>=<big|sum><rsub|i\<in\><around*|{|j\<in\>I\|x<rsub|j>\<neq\>0|}>>x<rsub|i>>
  </theorem>

  <\proof>
    Let <math|J=<around*|{|i\<in\>I\|x<rsub|i>\<neq\>0|}>>. For <math|I> we
    must consider the following three cases:

    <\description>
      <item*|<math|I=\<emptyset\>>>then <math|J=\<emptyset\>> and
      <math|<big|sum><rsub|i\<in\>I>x<rsub|i>=0=<big|sum><rsub|i\<in\>J>x<rsub|i>>

      <item*|<math|\<emptyset\>\<neq\>I<text| finite>>>then there exists a
      bijection <math|\<alpha\>:<around*|{|1,\<ldots\>,#<around*|(|I|)>|}>\<rightarrow\>I>.
      Further as <math|J\<subseteq\>I> we have the following possible case
      for <math|J>:\ 

      <\description>
        <item*|<math|J=\<emptyset\>>>then
        <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,#<around*|(|I|)>|}>>
        <math|x<rsub|\<alpha\><around*|(|i|)>>=0> we have
        <math|<big|sum><rsub|i\<in\>I>x<rsub|i>=<big|sum><rsub|i=1><rsup|#<around*|(|I|)>>x<rsub|\<beta\><around*|(|i|)>>=0=<big|sum><rsub|i\<in\>\<emptyset\>>x<rsub|j>=<big|sum><rsub|i\<in\>J>x<rsub|i>>

        <item*|<math|\<emptyset\>\<neq\>J<text| finite>>>then there exists a
        bijection <math|\<beta\>:<around*|{|1,\<ldots\>,n|}>\<rightarrow\>\<alpha\><rsup|-1><around*|(|J|)>>
        so that <math|\<alpha\><rsub|\|\<alpha\><rsup|-1><around*|(|J|)>>\<circ\>\<beta\>:<around*|{|1,\<ldots\>,n|}>\<rightarrow\>J>
        is a bijection

        <\eqnarray*>
          <tformat|<table|<row|<cell|<big|sum><rsub|i\<in\>I>x<rsub|i>>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|#<around*|(|I|)>>x<rsub|\<alpha\><around*|(|i|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|series
          of extended reals and zeroes>>>>|<cell|<big|sum><rsub|i=1><rsup|n>x<rsub|\<alpha\><around*|(|\<beta\><around*|(|i|)>|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>=\<alpha\><rsup|-1><around*|(|J|)>>>|<cell|<big|sum><rsub|i=1><rsup|n>x<rsub|\<alpha\><rsub|\|\<alpha\><rsup|-1><around*|(|J|)>><around*|(|\<beta\><around*|(|i|)>|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|definition>>|<cell|<big|sum><rsub|i\<in\>J>x<rsub|i>>>>>
        </eqnarray*>
      </description>

      <item*|<math|I<text| infinite>>>then there exists a bijection
      <math|\<alpha\>:\<bbb-N\>\<rightarrow\>I> take then
      <math|K=\<alpha\><rsup|-1><around*|(|J|)>\<subseteq\>\<bbb-N\>> and
      define <math|L=<around*|{|i\<in\>\<bbb-N\>\|x<rsub|\<alpha\><around*|(|i|)>>\<neq\>0|}>>
      then we have if <math|i\<in\>K\<Rightarrow\>\<alpha\><around*|(|i|)>\<in\>J\<Rightarrow\>x<rsub|\<alpha\><around*|(|i|)>>=0\<Rightarrow\>i\<in\>L>
      and if <math|i\<in\>L\<Rightarrow\>x<rsub|\<alpha\><around*|(|i|)>>=0\<Rightarrow\>\<alpha\><around*|(|i|)>\<in\>J\<Rightarrow\>i\<in\>K>,
      so <math|K=L>. We have then the following cases for <math|L=K> to
      consider

      <\description>
        <item*|<math|L=\<emptyset\>>>then as <math|\<alpha\>> is a bijection
        we have that <math|J=\<emptyset\>> and
        <math|<big|sum><rsub|i\<in\>I>x<rsub|i>\<equallim\><rsub|definition><big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<alpha\><around*|(|i|)>>\<equallim\><rsub|<text|<reference|series
        of extended reals and zeroes>>>0=<big|sum><rsub|i\<in\>\<emptyset\>>x<rsub|i>=<big|sum><rsub|i\<in\>J>x>

        <item*|<math|\<emptyset\>\<neq\>L<text| finite>>>then there exists a
        bijection <math|\<beta\>:<around*|{|1,\<ldots\>,n|}>\<rightarrow\>\<alpha\><rsup|-1><around*|(|J|)>>
        so that <math|\<alpha\><rsub|\|\<alpha\><rsup|-1><around*|(|J|)>>\<circ\>\<beta\>:<around*|{|1,\<ldots\>,n|}>\<rightarrow\>J>
        is a bijection

        <\eqnarray*>
          <tformat|<table|<row|<cell|<big|sum><rsub|i\<in\>I>x<rsub|i>>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<alpha\><around*|(|i|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|series
          of extended reals and zeroes>>>>|<cell|<big|sum><rsub|i=1><rsup|n>x<rsub|\<alpha\><around*|(|\<beta\><around*|(|i|)>|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|\<beta\><around*|(|<around*|{|1,\<ldots\>,n|}>|)>=\<alpha\><rsup|-1><around*|(|J|)>>>|<cell|<big|sum><rsub|i=1><rsup|n>x<rsub|\<alpha\><rsub|\|\<alpha\><rsup|-1><around*|(|J|)>><around*|(|\<beta\><around*|(|i|)>|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|definition>>|<cell|<big|sum><rsub|i\<in\>J>x<rsub|i>>>>>
        </eqnarray*>

        <item*|<math|L<text| is inifinite>>>then there exists a bijection
        <math|\<beta\>:\<bbb-N\>\<rightarrow\>\<alpha\><rsup|-1><around*|(|J|)>>
        so that <math|\<alpha\><rsub|\|\<alpha\><rsup|-1><around*|(|J|)>>\<circ\>\<beta\>:\<bbb-N\>\<rightarrow\>J>
        is a bijection

        <\eqnarray*>
          <tformat|<table|<row|<cell|<big|sum><rsub|i\<in\>I>x<rsub|i>>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<alpha\><around*|(|i|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|series
          of extended reals and zeroes>>>>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<alpha\><around*|(|\<beta\><around*|(|i|)>|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|\<beta\><around*|(|\<bbb-N\>|)>=\<alpha\><rsup|-1><around*|(|J|)>>>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>x<rsub|\<alpha\><rsub|\|\<alpha\><rsup|-1><around*|(|J|)>><around*|(|\<beta\><around*|(|i|)>|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|definition>>|<cell|<big|sum><rsub|i\<in\>J>x<rsub|i>>>>>
        </eqnarray*>
      </description>
    </description>
    ...
    <\equation*>
      <big|sum><rsub|i\<in\>I>x<rsub|i>=<big|sum><rsub|i\<in\>J>x<rsub|i>=<big|sum><rsub|i\<in\><around*|{|j\<in\>I\|x<rsub|i>\<neq\>0|}>>
    </equation*>

    \;
  </proof>

  TODO rewrite the rest of the theorems in the previous sections
  ...
  <\definition>
    ...
    <math|<around*|{|a<rsub|n>|}><rsub|n\<in\>\<bbb-N\><rsub|0>>\<subseteq\>\<bbb-C\>>
    then <math|<big|sum><rsub|i=0><rsup|\<infty\>>a<rsub|i>\<cdot\>z<rsup|i>>
    <math|> is called a power serie.
  </definition>

  <\theorem>
    <label|power series 0>Let <math|<around*|{|a<rsub|n>|}><rsub|n\<in\>\<bbb-N\><rsub|0>>\<subseteq\>\<bbb-C\>>
  ...
  <\proof>
    Let <math|n\<in\>\<bbb-N\><rsub|0>> then
    <math|<big|sum><rsub|i=1><rsup|n>a<rsub|i>\<cdot\>0<rsup|i>=a<rsub|0>\<cdot\>0<rsup|0>+<big|sum><rsub|i=1><rsup|\<infty\>>a<rsub|i>\<cdot\>o<rsup|i>=a<rsub|0>+<big|sum><rsub|i=1><rsup|\<infty\>>a<rsub|i>\<cdot\>0\<cdot\>0<rsup|i-1>=a<rsub|0>+0\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>a<rsub|i>\<cdot\>0<rsup|i-1>=a<rsub|0>>.
  </proof>
  ...
  <\proof>
    ...
    <\description>
      ...
      <item*|<math|0\<less\>\<rho\>>>As <math|z<rsub|0>\<in\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>><rsub|>>
      ...
      <\equation>
        ...
        >\<forall\>i\<in\>\<bbb-N\><rsub|0>\<vDash\><around*|\||a<rsub|n>\<cdot\>z<rsup|n>|\|>\<leqslant\>K
      </equation>

      Now <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> we have
      ...
      <\equation>
        <label|eq 17.2.515>\<forall\>n\<in\>\<bbb-N\><rsub|0>\<vDash\><around*|\||a<rsub|n>|\|>\<cdot\>\<rho\><rsup|n>\<leqslant\>K\<cdot\>q<rsup|n>
        where q\<less\>1
      </equation>
  ...
  <\proof>
    ...
    <\description>
      ...
      <math|<big|sum><rsub|i=0><rsup|\<infty\>><around*|\||a<rsub|n>|\|>\<cdot\>\<rho\><rsup|n>>
      is convergent. Finally as <math|\<forall\>i\<in\>\<bbb-N\><rsub|0>> we
      have <math|<around*|\||a<rsub|i>\<cdot\>z<rsup|i>|\|>=<around*|\||a<rsub|i>|\|>\<cdot\><around*|\||z|\|><rsup|i>\<less\><around*|\||a<rsub|i>|\|>\<cdot\>\<rho\><rsup|i>>
  ...
  <\corollary>
    Let<math|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>\<subseteq\>\<bbb-C\>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\description>
        ...
        so in all cases we have <math|z\<in\>B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>|)>>
        proving that\ 

        <\equation>
          <label|eq 17.3.515>B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>|)>\<subseteq\><wide|\<cal-D\><rsub|<big|sum><rsub|i=0><rsup|\<infty\>>a<rsub|i>\<cdot\>z<rsup|i>><rsub|>|\<bar\>>\<subseteq\>\<cal-D\><rsub|<big|sum><rsub|i=0><rsup|\<infty\>>a<rsub|i>\<cdot\>z<rsup|i>><rsub|>
        </equation>
  ...
  <\lemma>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>> <math|<around*|{|z<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>\<subseteq\>\<bbb-C\>>,
  ...
  <\theorem>
    ...
    <math|<around*|{|z<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>\<subseteq\>\<bbb-C\>>,
    <math|<around*|{|s<rsub|n><rsub|>|}><rsub|n\<in\>\<bbb-N\><rsub|0>>>
    defined by <math|s<rsub|n>=<big|sum><rsub|i=0><rsup|n>z<rsub|i>>,
    <math|<around*|{|\<varepsilon\><rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>\<subseteq\><around*|[|0,\<infty\>|[>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      \ <math|<around*|{|\<varepsilon\><rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>
      is a decreasing sequence, so using <reference|increasing (decreasing)
  ...
  <\definition>
    ...
    sequence and <math|D<rsub|<big|sum><rsub|i=0><rsup|\<infty\>>a<rsub|i>\<cdot\>z<rsup|i>>>
    its convergence domain then we can define
    <math|<big|sum><rsub|n=0><rsup|\<infty\>>a<rsub|n><around*|(|.|)><rsup|n>:D<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>\<rightarrow\>\<bbb-C\>>
  ...
  If <math|0\<less\>R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>>
  then <math|0\<in\>B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<big|sum><rsub|i=0><rsup|\<infty\>>a<rsub|i>\<cdot\>z<rsup|i>>|)>\<subseteq\>D<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>>
  so that it makes sense to talk about the derivative of
  <math|<big|sum><rsub|n=0><rsup|\<infty\>>a<rsub|n><around*|(|.|)><rsup|n>>
  at 0 on <math|B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>|)>>.
  ...
  <\lemma>
    ...
    <\proof>
      ...
      <\enumerate>
        ...
        <math|<around*|{|<frac|1|i+1>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>> we
        have that <math|\<forall\>i\<in\>\<bbb-N\><rsub|0>> that
        ...
        <\equation>
          <label|eq 17.10.515>\<forall\>n\<in\>\<bbb-N\><rsub|0>\<vDash\><around*|\||a<rsub|n>|\|>\<cdot\>\<rho\><rsup|n>=<around*|\||a<rsub|n>\<cdot\>\<rho\><rsup|n>|\|>\<less\>K
        </equation>
        ...
        <\equation>
          <label|eq 17.11.515>\<forall\>n\<in\>\<bbb-N\><rsub|0>\<vDash\><around*|\||<around*|(|n+1|)>\<cdot\>a<rsub|n+1>\<cdot\>z<rsup|n>|\|>\<leqslant\>K\<cdot\><frac|n+1|\<rho\>>\<cdot\>q<rsup|n>
  ...
  <\proof>
    ...
    <\eqnarray*>
      ...
      convergent family>>>>|<cell|<around*|(|<big|sum><rsub|n\<in\>\<bbb-N\><rsub|0>><frac|x<rsup|n>|n!>|)>\<cdot\><around*|(|<big|sum><rsub|n\<in\>\<bbb-N\><rsub|0>><frac|y<rsup|n>|n!>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|distributivity
      of absolute convergetn series>>>>|<cell|<big|sum><rsub|<around*|(|i,j|)>\<in\>\<bbb-N\><rsub|0>\<times\>\<bbb-N\><rsub|0>><around*|(|<frac|x<rsup|i>|i!>\<cdot\><frac|y<rsup|j>|j!>|)>
    ...
    <\equation>
      <label|eq 17.15.073>exp<around*|(|x|)>\<cdot\>exp<around*|(|y|)>=<big|sum><rsub|<around*|(|i,j|)>\<in\>\<bbb-N\><rsub|0>\<times\>\<bbb-N\><rsub|0>><around*|(|<frac|x<rsup|i>|i!>\<cdot\><frac|y<rsup|j>|j!>|)>
      a absolute convergent serie
    </equation>

    Let <math|n\<in\>\<bbb-N\><rsub|0>> define then
    <math|N<rsub|n>=<around*|{|<around*|(|i,j|)>\<in\>\<bbb-N\><rsub|0>\<times\>\<bbb-N\><rsub|0>\|i+j=n|}>>,
    as <math|N<rsub|n>\<subseteq\>\<bbb-N\><rsub|0>\<times\>\<bbb-N\><rsub|0>>
    we have <math|<big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>>N<rsub|n>\<subseteq\>\<bbb-N\><rsub|0>*\<times\>\<bbb-N\><rsub|0>>
    and if <math|<around*|(|i,j|)>\<in\>\<bbb-N\><rsub|0>\<times\>\<bbb-N\><rsub|0>>
    then either <math|<around*|(|i,j|)>\<in\>N<rsub|i+j>> proving that
    <math|\<bbb-N\><rsub|0>\<times\>\<bbb-N\><rsub|0>\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>>N<rsub|n>>.
    Further we have that if <math|n.n<rprime|'>\<in\>\<bbb-N\><rsub|0>> with
    ...
    <\equation>
      <label|eq 17.16.002>\<bbb-N\><rsub|0>\<times\>\<bbb-N\><rsub|0>=<big|sqcup><rsub|i\<in\>\<bbb-N\><rsub|0>>N<rsub|n>
    </equation>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|<big|sum><rsub|<around*|(|i,j|)>\<in\>\<bbb-N\><rsub|0>\<times\>\<bbb-N\><rsub|0>><around*|(|<frac|x<rsup|i>|i!>\<cdot\><frac|y<rsup|j>|j!>|)>>|<cell|\<equallim\><rsub|<text|<reference|associativity
      of absolute convergent families>>>>|<cell|<big|sum><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|(|<big|sum><rsub|<around*|(|i,j|)>\<in\>N<rsub|n>><around*|(|<frac|x<rsup|i>|i!>\<cdot\><frac|y<rsup|j>|j!>|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|absolute
      convergent series and nijections>>>>|<cell|<big|sum><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|(|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|(|<frac|x<rsup|\<beta\><around*|(|i|)><rsub|1>>\<cdot\>y<rsup|\<beta\><around*|(|i|)><rsub|2>>|\<beta\><around*|(|i|)><rsub|1>!\<cdot\>\<beta\><around*|(|j|)><rsub|2>!>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|(|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|(|<frac|x<rsup|i>\<cdot\>y<rsup|<around*|(|n-i|)>>|i!\<cdot\>j!>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|n\<in\>\<bbb-N\><rsub|0>><frac|1|n!><around*|(|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|(|<frac|n!\<cdot\>x<rsup|i>\<cdot\>y<rsup|<around*|(|n-i|)>>|i!\<cdot\>n-i!>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|n\<in\>\<bbb-N\><rsub|0>><frac|1|n!><around*|(|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|(|<matrix|<tformat|<table|<row|<cell|n>>|<row|<cell|i>>>>>\<cdot\>x<rsup|i>\<cdot\>y<rsup|<around*|(|n-i|)>>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|n\<in\>\<bbb-N\><rsub|0>><frac|<around*|(|x+y|)><rsup|i>|n!>>>|<row|<cell|>|<cell|=>|<cell|exp<around*|(|x+y|)>>>>>
    </eqnarray*>
  ...
  <\theorem>
    ...
    <\proof>
      ...
      <\enumerate>
        ...
        <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|exp<around*|(|n|)>=e<rsup|n>|}>>
        then we have\ 
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|a<rsup|<around*|[|n|]>>=<wide*|a*\<ldots\>a|\<wide-underbrace\>><rsub|n
      times>|}>> then we have\ 
      ...
      <\description>
        ...
        \ times>> proving that <math|n\<in\>\<bbb-N\><rsub|0>>
...
<\references>
  <\collection>
    <associate|(a-b)+(c-d)=(a+c)-(b+d)|<tuple|17.22|616>>
    <associate|-sup A=inf -A|<tuple|17.28|619>>
    <associate|0\<less\>=y then z=x+y=\<gtr\>z\<less\>=y|<tuple|17.20|616>>
    <associate|0\<less\>cos(x),sin(x)|<tuple|18.49|699>>
    <associate|Abel-Dirichlet|<tuple|18.15|679>>
    <associate|Balls and convergence domains|<tuple|18.12|677>>
    <associate|Euler's number|<tuple|18.29|686>>
    <associate|Napierian|<tuple|18.33|687>>
    <associate|Power series|<tuple|18.2|675>>
    <associate|Young's inequality|<tuple|18.42|692>>
    <associate|a serie of extented positive reals converges always and is
    independent of the order|<tuple|17.114|666>>
    <associate|a-b=c-d=\<gtr\>a+d=c+b|<tuple|17.23|616>>
    <associate|absolute value in the extended reals|<tuple|17.29|620>>
    <associate|absolute value on the extended real
    properties|<tuple|17.31|620>>
    <associate|adding of positive extented reals|<tuple|17.25|617>>
    <associate|alternative definition of limit in the extented
    reals|<tuple|17.83|654>>
    <associate|alternative graph of sum of functions|<tuple|17.101|662>>
    <associate|associativity of inifinite series|<tuple|17.120|672>>
    <associate|associativity of series of extended reals|<tuple|17.118|670>>
    <associate|auto-1|<tuple|17|607>>
    <associate|auto-10|<tuple|17.33|621>>
    <associate|auto-11|<tuple|17.33|621>>
    <associate|auto-12|<tuple|17.33|621>>
    <associate|auto-13|<tuple|17.34|621>>
    <associate|auto-14|<tuple|17.34|621>>
    <associate|auto-15|<tuple|17.2.1|625>>
    <associate|auto-16|<tuple|17.41|625>>
    <associate|auto-17|<tuple|17.41|625>>
    <associate|auto-18|<tuple|17.41|625>>
    <associate|auto-19|<tuple|17.44|625>>
    <associate|auto-2|<tuple|17.1|607>>
    <associate|auto-20|<tuple|17.45|625>>
    <associate|auto-21|<tuple|17.46|626>>
    <associate|auto-22|<tuple|17.54|633>>
    <associate|auto-23|<tuple|17.54|633>>
    <associate|auto-24|<tuple|17.2.2|646>>
    <associate|auto-25|<tuple|17.62|646>>
    <associate|auto-26|<tuple|17.62|646>>
    <associate|auto-27|<tuple|17.66|648>>
    <associate|auto-28|<tuple|17.66|648>>
    <associate|auto-29|<tuple|17.2.3|661>>
    <associate|auto-3|<tuple|17.2|607>>
    <associate|auto-30|<tuple|17.121|673>>
    <associate|auto-31|<tuple|17.2.4|673>>
    <associate|auto-32|<tuple|18|675>>
    <associate|auto-33|<tuple|18.1|675>>
    <associate|auto-34|<tuple|18.1.1|675>>
    <associate|auto-35|<tuple|18.4|675>>
    <associate|auto-36|<tuple|18.4|675>>
    <associate|auto-37|<tuple|18.8|676>>
    <associate|auto-38|<tuple|18.8|676>>
    <associate|auto-39|<tuple|18.1.2|677>>
    <associate|auto-4|<tuple|17.8|609>>
    <associate|auto-40|<tuple|18.19|680>>
    <associate|auto-41|<tuple|18.1.3|680>>
    <associate|auto-42|<tuple|18.29|686>>
    <associate|auto-43|<tuple|18.33|687>>
    <associate|auto-44|<tuple|18.33|687>>
    <associate|auto-45|<tuple|18.44|695>>
    <associate|auto-46|<tuple|18.44|695>>
    <associate|auto-47|<tuple|18.48|699>>
    <associate|auto-5|<tuple|17.8|609>>
    <associate|auto-6|<tuple|17.9|609>>
    <associate|auto-7|<tuple|17.9|609>>
    <associate|auto-8|<tuple|17.2|620>>
    <associate|auto-9|<tuple|17.33|621>>
    <associate|ball inclusion|<tuple|18.11|677>>
    <associate|closed sets in the extended reals|<tuple|17.35|622>>
    ...
    reals|<tuple|17.37|623>>
    <associate|convergence domain and balls|<tuple|18.7|676>>
    <associate|convergence domain of exponential function|<tuple|18.18|680>>
    <associate|convergence in real implies that lim inferior = lim
    superior|<tuple|17.73|651>>
    <associate|convergence of derived powerseries|<tuple|18.22|681>>
    <associate|convergence of powerseries (1)|<tuple|18.6|675>>
    <associate|convergence radius|<tuple|18.8|676>>
    <associate|countable sum of countable sums is a countable
    sum|<tuple|17.119|671>>
    <associate|d'Alembert|<tuple|18.17|679>>
    <associate|definition of limit in the extented reals|<tuple|17.74|651>>
    <associate|density of the extented reals|<tuple|17.7|609>>
    <associate|derivative of the exponential function|<tuple|18.24|684>>
    <associate|difference in extented reals|<tuple|17.19|615>>
    <associate|distributivity in the extented reals|<tuple|17.26|617>>
    <associate|eq 13.1.123|<tuple|17.6|622>>
    <associate|eq 13.1.300|<tuple|17.1|618>>
    <associate|eq 13.11.40|<tuple|17.21|655>>
    <associate|eq 13.12.40|<tuple|17.22|655>>
    <associate|eq 13.13.40|<tuple|17.23|655>>
    <associate|eq 13.14.41|<tuple|17.24|666>>
    <associate|eq 13.15.41|<tuple|17.30|668>>
    <associate|eq 13.16.41|<tuple|17.31|668>>
    <associate|eq 13.17.50|<tuple|17.38|671>>
    <associate|eq 13.2.123|<tuple|17.7|622>>
    <associate|eq 13.2.300|<tuple|17.2|618>>
    <associate|eq 13.3|<tuple|17.17|651>>
    <associate|eq 13.3.301|<tuple|17.3|619>>
    <associate|eq 13.4|<tuple|17.18|651>>
    <associate|eq 13.4.39|<tuple|17.10|647>>
    <associate|eq 13.5|<tuple|17.19|651>>
    <associate|eq 13.5.39|<tuple|17.11|647>>
    <associate|eq 13.6|<tuple|17.20|651>>
    <associate|eq 13.6.39|<tuple|17.12|647>>
    <associate|eq 13.7.39|<tuple|17.13|648>>
    <associate|eq 14.22.423|<tuple|17.32|669>>
    <associate|eq 14.23.409|<tuple|17.39|672>>
    <associate|eq 14.23.424|<tuple|17.34|670>>
    <associate|eq 14.23.425|<tuple|17.33|670>>
    <associate|eq 14.24.409|<tuple|17.40|672>>
    <associate|eq 14.24.424|<tuple|17.35|670>>
    <associate|eq 14.25.411|<tuple|17.41|672>>
    <associate|eq 14.25.424|<tuple|17.36|670>>
    <associate|eq 14.26.424|<tuple|17.37|670>>
    <associate|eq 14.4.472|<tuple|17.4|619>>
    <associate|eq 14.5.472|<tuple|17.5|620>>
    <associate|eq 17.1.514|<tuple|18.7|680>>
    <associate|eq 17.1.515|<tuple|18.1|675>>
    <associate|eq 17.10.515|<tuple|18.10|681>>
    <associate|eq 17.11.515|<tuple|18.11|681>>
    <associate|eq 17.12.073|<tuple|18.12|683>>
    <associate|eq 17.13.073|<tuple|18.13|684>>
    <associate|eq 17.14.006|<tuple|17.14|649>>
    <associate|eq 17.14.073|<tuple|18.14|684>>
    <associate|eq 17.15.006|<tuple|17.15|649>>
    <associate|eq 17.15.073|<tuple|18.15|685>>
    <associate|eq 17.16.002|<tuple|18.16|685>>
    <associate|eq 17.16.006|<tuple|17.16|650>>
    <associate|eq 17.17.002.1|<tuple|18.17|686>>
    <associate|eq 17.18.002|<tuple|18.18|687>>
    <associate|eq 17.19.002|<tuple|18.19|687>>
    <associate|eq 17.2.514|<tuple|18.8|680>>
    <associate|eq 17.2.515|<tuple|18.2|675>>
    <associate|eq 17.20.003|<tuple|18.25|698>>
    <associate|eq 17.20.020|<tuple|18.20|691>>
    <associate|eq 17.21.003|<tuple|18.26|698>>
    <associate|eq 17.21.020|<tuple|18.21|692>>
    <associate|eq 17.22.003|<tuple|18.27|698>>
    <associate|eq 17.22.020|<tuple|18.22|692>>
    <associate|eq 17.23.003|<tuple|18.28|699>>
    <associate|eq 17.23.020|<tuple|18.23|692>>
    <associate|eq 17.24.004|<tuple|18.29|699>>
    <associate|eq 17.24.020|<tuple|18.24|693>>
    <associate|eq 17.25.01|<tuple|17.25|666>>
    <associate|eq 17.26.01|<tuple|17.26|666>>
    <associate|eq 17.28.01|<tuple|17.28|667>>
    <associate|eq 17.3.515|<tuple|18.3|676>>
    <associate|eq 17.4.515.1|<tuple|18.4|679>>
    <associate|eq 17.5.515|<tuple|18.5|679>>
    <associate|eq 17.6.515|<tuple|18.6|679>>
    <associate|eq 17.9.515|<tuple|18.9|681>>
    <associate|equivalence of limits on increasing (decreasing) sequences of
    extented reals|<tuple|17.79|652>>
    <associate|every non empty set in the extented reals has a
    limit|<tuple|17.10|609>>
    <associate|existance of lim inf and lim sup|<tuple|17.65|647>>
    <associate|exp exceeds every number|<tuple|18.31|687>>
    <associate|exp is a bijection|<tuple|18.32|687>>
    <associate|exp is convex|<tuple|18.28|686>>
    <associate|exp(x) is continuous|<tuple|18.25|684>>
    <associate|exp(x+y)=exp(x)exp(y)|<tuple|18.26|684>>
    <associate|exp(z)|<tuple|18.19|680>>
    <associate|exponential as power|<tuple|18.30|686>>
    <associate|extented reals|<tuple|17.2|607>>
    <associate|finite infinite sum means finite terms|<tuple|17.111|665>>
    <associate|finite sum of constants in the extented
    reals|<tuple|17.106|664>>
    <associate|finite sum of denumerable sums|<tuple|17.117|668>>
    <associate|finite sum of extented reals|<tuple|17.93|661>>
    <associate|finite sum of extented reals properties|<tuple|17.105|664>>
    <associate|finite sum of extented reals starting at n|<tuple|17.94|661>>
    <associate|finite sum of extented reals written as infinite
    sum|<tuple|17.112|665>>
    <associate|finite sum of limits of functions|<tuple|17.102|663>>
    <associate|finite sum of limits of scalar product with
    functions|<tuple|17.104|664>>
    <associate|finite sum of non negative extented reals is non
    negative|<tuple|17.95|661>>
    <associate|general strict positive powers|<tuple|18.38|690>>
    <associate|generalized power|<tuple|18.35|688>>
    <associate|generalized sum of the extended reals|<tuple|17.122|673>>
    <associate|graph of sum of functions|<tuple|17.100|662>>
    <associate|increasing (decreasing) sequence|<tuple|17.62|646>>
    <associate|increasing (decreasing) sequence converges|<tuple|17.64|646>>
    <associate|independence of limit inf and limit sup of start
    index|<tuple|17.67|648>>
    <associate|inequality of Abel|<tuple|18.14|678>>
    <associate|infinity can not be a right limit|<tuple|17.43|625>>
    <associate|interchange infinite and finite sum|<tuple|17.116|668>>
    <associate|left (right) continuity|<tuple|17.54|633>>
    <associate|left and right limit implies limit|<tuple|17.50|632>>
    <associate|left limit of a function|<tuple|17.44|625>>
    <associate|left, right limit of sum and scalar product|<tuple|17.49|627>>
    <associate|lemma 15.75|<tuple|17.88|660>>
    <associate|lemma 17.2|<tuple|18.16|679>>
    <associate|lemma 17.38|<tuple|18.41|691>>
    <associate|lim inf -xn|<tuple|17.69|648>>
    <associate|lim inf and lim sup|<tuple|17.66|648>>
    <associate|lim sup xn+x|<tuple|17.68|648>>
    <associate|liminf and limsup properties for sum
    product|<tuple|17.71|649>>
    <associate|limit and absolut value|<tuple|17.84|655>>
    <associate|limit and continuity in the extented reals|<tuple|17.53|633>>
    <associate|limit at infinity of ascending (descending)
    functions|<tuple|17.58|642>>
    <associate|limit for f\<less\>=L or L\<less\>=f|<tuple|17.60|645>>
    <associate|limit for f\<less\>=g|<tuple|17.59|643>>
    <associate|limit n|<tuple|17.90|660>>
    <associate|limit of 1/f|<tuple|17.89|660>>
    <associate|limit of a constant function|<tuple|17.47|626>>
    <associate|limit of a function|<tuple|17.46|626>>
    <associate|limit of constant extented real|<tuple|17.76|652>>
    <associate|limit of constants|<tuple|17.82|653>>
    <associate|limit of finite sums in the extented reals|<tuple|17.98|662>>
    <associate|limit of functions and sequences|<tuple|17.81|653>>
    <associate|limit of monotone functions|<tuple|17.57|640>>
    <associate|limit points|<tuple|17.41|625>>
    <associate|limit points and plus or min infinity|<tuple|17.42|625>>
    <associate|limit xi+x|<tuple|17.77|652>>
    <associate|limits at infinity|<tuple|17.52|632>>
    <associate|limxi=x=\<gtr\>\|x-xi\|-\<gtr\>0|<tuple|17.91|661>>
    <associate|notation for limit of increasing/decreasing
    sequences|<tuple|17.80|653>>
    <associate|open sets and addition scalar
    multiplication|<tuple|17.38|623>>
    <associate|pi|<tuple|18.48|699>>
    <associate|power series 0|<tuple|18.3|675>>
    <associate|properties of exp (1)|<tuple|18.27|686>>
    <associate|properties of exp (2)|<tuple|18.43|694>>
    <associate|properties of general power|<tuple|18.39|690>>
    <associate|properties of general strict power|<tuple|18.37|688>>
    <associate|properties of log|<tuple|18.34|687>>
    <associate|properties of the limit in the extented
    reals|<tuple|17.85|655>>
    <associate|right limit|<tuple|17.45|625>>
    <associate|series and product with a scalar|<tuple|17.108|665>>
    <associate|series are increasing|<tuple|17.96|662>>
    <associate|series of extended reals and zeroes|<tuple|17.115|666>>
    <associate|series of extended reals and zeroes (1)|<tuple|17.124|673>>
    <associate|series of positive extented reals is
    increasing|<tuple|17.109|665>>
    <associate|sets for basis of topology on the extented
    reals|<tuple|17.33|621>>
    <associate|special cases of limits|<tuple|17.55|633>>
    <associate|sum and order relation in the extented
    reals|<tuple|17.110|665>>
    <associate|sum from -infinity to infinity|<tuple|17.121|673>>
    <associate|sum of extented reals and product|<tuple|17.97|662>>
    <associate|sum of extented reals is indepenent of order the
    reals|<tuple|17.113|665>>
    <associate|sup of set and sum|<tuple|17.27|618>>
    <associate|sup,inf sum of monotone sequences|<tuple|17.70|649>>
    <associate|supremum (infinum) of increasing (decreasing) sequence is
    indpendent of start|<tuple|17.78|652>>
    ...
    superior|<tuple|17.72|650>>
    <associate|the positive extented reals form a abelian
    semi-group|<tuple|17.24|617>>
    <associate|the topology on the extented reals is
    Hausdorff|<tuple|17.40|624>>
    <associate|topology on extented reals|<tuple|17.34|621>>
    <associate|trigoniometic properties|<tuple|18.45|695>>
    <associate|trigoniometric functions|<tuple|18.44|695>>
    <associate|uniqueness of limits in extented reals|<tuple|17.48|626>>
    <associate|usefull properties of open sets in the extented reals
    |<tuple|17.56|640>>
    <associate|x+z=y+z=\<gtr\>x=y|<tuple|17.17|612>>
    <associate|x\<less\>=y=\<gtr\>-y\<less\>=-x|<tuple|17.15|611>>
    <associate|x\<less\>=y=\<gtr\>lx\<less\>=ly|<tuple|17.16|612>>
    <associate|x\<less\>=y=\<gtr\>x+z\<less\>=y+z|<tuple|17.18|614>>
    <associate|x^p is continuous|<tuple|18.40|691>>
    <associate|zero and convergentie domain|<tuple|18.5|675>>
    <associate|zeroes of cos has a minimum|<tuple|18.47|699>>
  </collection>
</references>
