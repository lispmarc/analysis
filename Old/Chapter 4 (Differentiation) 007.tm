...
<\body>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <math|<around*|\<\|\|\>|h<rsub|i>|\<\|\|\>><rsub|X>\<gtr\>0> and
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      continuous at <math|0> and <math|\<varepsilon\><around*|(|0|)>=0>,
      there exists given a <math|\<zeta\>\<gtr\>0> a <math|\<delta\>\<gtr\>0>
      ...
      <math|<around*|\<\|\|\>|h<rsub|n>|\<\|\|\>>\<less\>\<delta\><rsub|\<varepsilon\>>>,
      then as we have assumed that <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>>
      that <math|0\<less\>h<rsub|n>\<in\>U<rsub|x>>, we have if
      ...
      So for every <math|n\<in\>\<bbb-N\><rsub|0>> there exists a
      ...
      Then by the hypothese (4) we must have that
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|x\<in\>U>,
    <math|V\<subseteq\>Y> and <math|f:U\<rightarrow\>V> a function that is
    differentiable at <math|x> then <math|f> is continuous at <math|x>.
  </theorem>

  <\proof>
    Let <math|x\<in\>U> and <math|W> open in the subspace topology of
    <math|V> with <math|f<around*|(|x|)>\<in\>W>. As <math|W> is open in
    <math|V> there exists a <math|H> open in <math|Y> such that
    <math|f<around*|(|x|)>\<in\>W=H<big|cap>V>, but then as <math|H> is open
    in <math|Y> we have
    ...
    Define now <math|\<delta\>=min<around*|(|\<delta\><rsub|2>,\<delta\><rsub|3>,\<delta\><rsub|4>,1<rsub|>|)>>
    ...
    take now <math|h=y-x\<Rightarrow\>x+h=y\<in\>U\<Rightarrow\>h\<in\>U<rsub|x>>
    ...
    0.12.2>>>f<around*|(|y|)>-f<around*|(|x|)>=D
