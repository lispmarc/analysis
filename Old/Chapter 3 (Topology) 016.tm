...
<\body>
  ...
  <\note>
    <label|norm of sum>Let <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    be a normed space then <math|\<forall\>x,y> we have
    <math|<around*|\||<around*|\<\|\|\>|x|\<\|\|\>>-<around*|\<\|\|\>|y|\<\|\|\>>|\|>\<leqslant\><around*|\<\|\|\>|x+y|\<\|\|\>>>
  </note>

  <\proof>
    <math|<around*|\<\|\|\>|x|\<\|\|\>>=<around*|\<\|\|\>|x+y-y|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|x+y|\<\|\|\>>+<around*|\<\|\|\>|-y|\<\|\|\>>=<around*|\<\|\|\>|x+y|\<\|\|\>>+<around*|\<\|\|\>|y|\<\|\|\>>\<Rightarrow\><around*|\<\|\|\>|x|\<\|\|\>>-<around*|\<\|\|\>|y|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|x+y|\<\|\|\>>>
  ...
  <\lemma>
    Let <math|n\<in\>\<bbb-N\><rsub|0>>, <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>\<subseteq\>\<bbb-R\>>
    then\ 
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|\<\|\|\>|z\<cdot\>w|\<\|\|\>>>|<cell|=>|<cell|<around*|\||a\<cdot\>c-b\<cdot\>d|\|>+<around*|\||a\<cdot\>d+b\<cdot\>c|\|>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|<around*|\||a|\|>\<cdot\><around*|\||c|\|>+<around*|\||b|\|>\<cdot\><around*|\||d|\|>+<around*|\||a|\|>\<cdot\><around*|\||d|\|>+<around*|\||b|\|>\<cdot\><around*|\||c|\|>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|<around*|\||a|\|>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)>+<around*|\||b|\|>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<around*|\||a|\|>+<around*|\||b|\|>|)>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|w|\<\|\|\>>>>>>
      </eqnarray*>

      <\equation>
        <label|eq 12.55.015><around*|\<\|\|\>|z\<cdot\>w|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|w|\<\|\|\>>
      </equation>

      \ (4) is thus proved by <reference|eq 12.54.015> and <reference|eq
      12.55.015>.
    </enumerate>
  </proof>
  ...
  <\proof>
    ...
    <math|<frac|1|<around*|(|2\<cdot\>k-2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j|)>>-<frac|1|<around*|(|2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>j|)>\<cdot\>k<rsup|2>>>
    ...
    <\equation>
      <label|eq 12.61.476>Img<around*|(|<around*|(|1+<frac|i|k>|)><rsup|2\<cdot\>k>|)>
    </equation>
...
<\references>
  <\collection>
    <associate|@ product|<tuple|12.182|382>>
    <associate|@ prouct property|<tuple|12.183|382>>
    <associate|B(X,Y) is a Banach space if Y is|<tuple|12.289|404>>
    <associate|Baire Category Theorem|<tuple|12.324|413>>
    <associate|Baire space|<tuple|12.42|349>>
    <associate|Cauchy includes bounded|<tuple|12.312|409>>
    <associate|Cauchy sequences in metric spaces|<tuple|12.272|401>>
    <associate|Complete matric space|<tuple|12.283|403>>
    <associate|Continuity of function on a topological
    product|<tuple|12.119|364>>
    <associate|Hausdorff spaces|<tuple|12.186|383>>
    <associate|L(X,Y)|<tuple|12.152|372>>
    <associate|L(X^n;Y)|<tuple|12.163|377>>
    <associate|L(x1)(x2:..:xn)|<tuple|12.174|379>>
    <associate|L(x1,..,xm) is in Ln-m(X;Y)|<tuple|12.172|378>>
    <associate|L^(X;Y) is equivalent with L(X^n;Y)|<tuple|12.181|381>>
    <associate|L^n(X1,..,Xn;),L(Xn+1,Y))=L^n+1(X1,..,Xn+1;Y)|<tuple|12.169|378>>
    <associate|L^n(X1,...,Xn;Y)|<tuple|12.165|377>>
    <associate|L^n(X;L(X,Y))=L^n(X;Y)|<tuple|12.170|378>>
    <associate|L^n(X;Y)|<tuple|12.167|377>>
    <associate|L^n(X;Y) is a Banach space if Y is a Banach
    space|<tuple|12.316|410>>
    <associate|Lipschitz continuous functions are uniform
    continuous|<tuple|12.125|365>>
    <associate|Lischitz continuity|<tuple|12.124|365>>
    <associate|Pn(L) definition|<tuple|12.178|380>>
    <associate|Pn(L)(x1,..,xn)=Pn-1(L)(x1,..,xn-1)(xn)|<tuple|12.179|380>>
    <associate|Rieman Integral|<tuple|12.341|420>>
    <associate|Riemann Integral (general)|<tuple|12.346|421>>
    <associate|Tychonoff|<tuple|12.255|398>>
    <associate|[a,@@[ is closed|<tuple|12.71|354>>
    <associate|[a,b] is compact|<tuple|12.225|390>>
    <associate|a closed set is equal to its closurer|<tuple|12.17|344>>
    <associate|a contraction mapping is continuous|<tuple|12.318|411>>
    <associate|a isometry is a homeomorphism|<tuple|12.138|368>>
    <associate|a second countable basis is first
    countable|<tuple|12.199|384>>
    <associate|accumulation and closure|<tuple|12.235|392>>
    <associate|alternate definition of a compact subset|<tuple|12.206|385>>
    <associate|alternate definition of closed set|<tuple|12.21|344>>
    <associate|alternative definition of Baire sets|<tuple|12.44|349>>
    <associate|alternative definition of Riemann Integral|<tuple|12.344|421>>
    <associate|alternative definition of a bounded
    function|<tuple|12.285|403>>
    <associate|another characterization of Cauchy|<tuple|12.273|401>>
    <associate|auto-1|<tuple|12|341>>
    <associate|auto-10|<tuple|12.11|342>>
    <associate|auto-100|<tuple|12.11.1|400>>
    <associate|auto-101|<tuple|12.265|400>>
    <associate|auto-102|<tuple|12.268|400>>
    <associate|auto-103|<tuple|12.271|401>>
    <associate|auto-104|<tuple|12.272|401>>
    <associate|auto-105|<tuple|12.283|403>>
    <associate|auto-106|<tuple|12.283|403>>
    <associate|auto-107|<tuple|12.284|403>>
    <associate|auto-108|<tuple|12.284|403>>
    <associate|auto-109|<tuple|12.290|404>>
    <associate|auto-11|<tuple|12.11|342>>
    <associate|auto-110|<tuple|12.317|411>>
    <associate|auto-111|<tuple|12.321|411>>
    <associate|auto-112|<tuple|12.324|413>>
    <associate|auto-113|<tuple|12.325|414>>
    <associate|auto-114|<tuple|12.12|416>>
    <associate|auto-115|<tuple|12.329|417>>
    <associate|auto-116|<tuple|12.332|417>>
    <associate|auto-117|<tuple|12.335|419>>
    <associate|auto-118|<tuple|12.335|419>>
    <associate|auto-119|<tuple|12.336|419>>
    <associate|auto-12|<tuple|12.18|344>>
    <associate|auto-120|<tuple|12.336|419>>
    <associate|auto-121|<tuple|12.337|419>>
    <associate|auto-122|<tuple|12.337|419>>
    <associate|auto-123|<tuple|12.341|420>>
    <associate|auto-124|<tuple|12.341|420>>
    <associate|auto-125|<tuple|12.346|421>>
    <associate|auto-126|<tuple|12.346|421>>
    <associate|auto-127|<tuple|12.13|425>>
    <associate|auto-128|<tuple|12.352|425>>
    <associate|auto-129|<tuple|12.354|425>>
    <associate|auto-13|<tuple|12.18|344>>
    <associate|auto-130|<tuple|12.14|426>>
    <associate|auto-131|<tuple|12.359|426>>
    <associate|auto-132|<tuple|12.365|427>>
    <associate|auto-133|<tuple|12.365|427>>
    <associate|auto-14|<tuple|12.18|344>>
    <associate|auto-15|<tuple|12.1.2|344>>
    <associate|auto-16|<tuple|12.23|344>>
    <associate|auto-17|<tuple|12.23|344>>
    <associate|auto-82|<tuple|12.200|384>>
    <associate|auto-83|<tuple|12.202|385>>
    <associate|auto-84|<tuple|12.10|385>>
    <associate|auto-85|<tuple|12.204|385>>
    <associate|auto-86|<tuple|12.205|385>>
    <associate|auto-87|<tuple|12.215|387>>
    <associate|auto-88|<tuple|12.218|388>>
    <associate|auto-89|<tuple|12.222|389>>
    <associate|auto-9|<tuple|12.1.1|342>>
    <associate|auto-90|<tuple|12.10.1|391>>
    <associate|auto-91|<tuple|12.229|392>>
    <associate|auto-92|<tuple|12.234|392>>
    <associate|auto-93|<tuple|12.234|392>>
    <associate|auto-94|<tuple|12.243|394>>
    <associate|auto-95|<tuple|12.249|395>>
    <associate|auto-96|<tuple|12.10.2|398>>
    <associate|auto-97|<tuple|12.255|398>>
    <associate|auto-98|<tuple|12.258|398>>
    <associate|auto-99|<tuple|12.11|400>>
    <associate|ball cover of a metric space|<tuple|12.220|388>>
    <associate|ball in balls|<tuple|12.53|350>>
    <associate|basic binomial property|<tuple|12.367|427>>
    <associate|basis for the product topology|<tuple|12.37|347>>
    <associate|basis of a topology|<tuple|12.23|344>>
    <associate|basis of product topology|<tuple|12.38|348>>
    <associate|basis of the subspace topology|<tuple|12.25|345>>
    <associate|binomial constant|<tuple|12.365|427>>
    <associate|binomial formula|<tuple|12.368|427>>
    <associate|bounded function|<tuple|12.284|403>>
    <associate|box topology|<tuple|12.34|347>>
    <associate|box topology and base|<tuple|12.35|347>>
    <associate|cauchy and uniqueness|<tuple|12.309|408>>
    <associate|characterization of a basis in a topology|<tuple|12.26|345>>
    <associate|characterization of closure|<tuple|12.19|344>>
    <associate|characterization of closure (another)|<tuple|12.30|346>>
    <associate|characterization of closure of a set|<tuple|12.20|344>>
    <associate|characterization of closure of a set 2|<tuple|12.31|346>>
    <associate|closed ball|<tuple|12.50|350>>
    <associate|closed balls are closed|<tuple|12.56|351>>
    <associate|closed rectangles are compact in the norm
    topology|<tuple|12.257|398>>
    <associate|closed sets|<tuple|12.11|342>>
    <associate|closed subset of a complete space is
    complete|<tuple|12.293|405>>
    <associate|combined partition|<tuple|12.332|417>>
    <associate|compact Hausdorf space is regular and
    normal|<tuple|12.216|387>>
    <associate|compact space in a metric space is bounded|<tuple|12.210|386>>
    <associate|compact subsets|<tuple|12.205|385>>
    <associate|compact subsets of subsets|<tuple|12.209|386>>
    <associate|compact subsets of the reals|<tuple|12.258|398>>
    <associate|compact subspaces are closed|<tuple|12.212|386>>
    <associate|compact subspaces are sequential compact|<tuple|12.219|388>>
    <associate|compact topological space|<tuple|12.204|385>>
    <associate|compactness and base|<tuple|12.217|388>>
    <associate|compactness and closed sets|<tuple|12.213|386>>
    <associate|compactness and sequential compactness|<tuple|12.221|388>>
    <associate|complex conjugate of a sum|<tuple|12.369|428>>
    <associate|complex inner space|<tuple|12.89|357>>
    <associate|composition of a continuous linear mapping and a continuous
    multilinear mapping is a continuous linear mapping|<tuple|12.161|376>>
    <associate|composition of continuous functions is
    continuous|<tuple|12.116|363>>
    <associate|composition of continuous linear mapping is continuous and
    multilinear|<tuple|12.164|377>>
    <associate|composition of homeomorphisms is a
    homeomorphism|<tuple|12.135|367>>
    <associate|composition of isometries metric|<tuple|12.62|352>>
    <associate|composition of isometries norm|<tuple|12.85|357>>
    <associate|composition of open functions is open|<tuple|12.115|363>>
    <associate|conditions to make a basis|<tuple|12.27|345>>
    <associate|conjugate of sum|<tuple|12.95|358>>
    <associate|connected space|<tuple|12.352|425>>
    <associate|connected subset|<tuple|12.354|425>>
    <associate|constant functions are continuous|<tuple|12.109|362>>
    <associate|construction of new filterbases|<tuple|12.232|392>>
    <associate|continuity and connectness|<tuple|12.357|426>>
    <associate|continuity and multilinearity|<tuple|12.156|373>>
    <associate|continuity at a point and topological
    basis|<tuple|12.105|361>>
    <associate|continuity characterization|<tuple|12.111|362>>
    <associate|continuity in metric spaces|<tuple|12.120|364>>
    <associate|continuity is local|<tuple|12.112|362>>
    <associate|continuity of function in a normed space|<tuple|12.123|365>>
    <associate|continuity of restricted maps|<tuple|12.106|361>>
    <associate|continuity of vector space operations|<tuple|12.128|365>>
    <associate|continuity to a subspace|<tuple|12.107|361>>
    <associate|continuous function|<tuple|12.104|361>>
    <associate|continuous functions on a compact set are uniform
    continue|<tuple|12.226|391>>
    <associate|continuous functions to a product space|<tuple|12.118|363>>
    <associate|continuous image of compact set|<tuple|12.211|386>>
    <associate|continuous linear maps in a normed space|<tuple|12.143|369>>
    <associate|continuous mapping in [a,b]|<tuple|12.358|426>>
    <associate|contraction|<tuple|12.317|411>>
    <associate|convergence in a metric space|<tuple|12.268|400>>
    <associate|convergence in a normed space|<tuple|12.275|401>>
    <associate|convergence in normed space|<tuple|12.275|401>>
    <associate|convergence in topological and metric
    space|<tuple|12.269|400>>
    <associate|convergence is independent of start of
    sequence|<tuple|12.267|400>>
    <associate|convergence of powersequence|<tuple|12.281|402>>
    <associate|convergency in a topological space|<tuple|12.265|400>>
    <associate|convergent criteria of a serie in a Banach
    space|<tuple|12.304|407>>
    <associate|convergent filterbase|<tuple|12.234|392>>
    <associate|convergent sequences are Cauchy|<tuple|12.274|401>>
    <associate|converging and accumulation|<tuple|12.241|393>>
    <associate|converging of upper serie|<tuple|12.302|406>>
    <associate|countable compact class|<tuple|12.222|389>>
    <associate|definition of a serie|<tuple|12.298|406>>
    <associate|definition of the operator norm of a multilinear
    mapping|<tuple|12.158|374>>
    <associate|dense subset|<tuple|12.41|349>>
    <associate|diameter|<tuple|12.65|353>>
    <associate|difference of Riemann sums|<tuple|12.338|419>>
    <associate|differences of tagged partitions|<tuple|12.339|420>>
    <associate|distance functions|<tuple|12.126|365>>
    <associate|divergence limits|<tuple|12.359|426>>
    <associate|divergent limit and negat|<tuple|12.359|?>>
    <associate|divergent limit and negate|<tuple|12.360|?>>
    <associate|divide in even and odd numbers|<tuple|12.370|428>>
    <associate|each filterbase converges to exactly one
    point|<tuple|12.240|393>>
    <associate|eq 1.476|<tuple|12.56|432>>
    <associate|eq 11.1|<tuple|12.1|346>>
    <associate|eq 11.10|<tuple|12.10|355>>
    <associate|eq 11.11|<tuple|12.11|365>>
    <associate|eq 11.12|<tuple|12.12|366>>
    <associate|eq 11.13|<tuple|12.13|371>>
    <associate|eq 11.14|<tuple|12.14|371>>
    <associate|eq 11.15|<tuple|12.15|371>>
    <associate|eq 11.16|<tuple|12.16|375>>
    <associate|every compact metric space is complete|<tuple|12.310|408>>
    <associate|every finite dimensional space is Banach|<tuple|12.314|409>>
    <associate|every finite subset of a Hausdorff is
    closed|<tuple|12.188|383>>
    <associate|example of continuous mappings in a topological vector
    space|<tuple|12.203|385>>
    <associate|exaple of a convergent serie|<tuple|12.320|411>>
    <associate|exchange infinite sum and finite sum|<tuple|12.306|407>>
    <associate|existance of Riemann integral for continuous
    function|<tuple|12.345|421>>
    <associate|existance of converging tagged
    partititions|<tuple|12.343|421>>
    <associate|existance of isometry,isomorphism,homeomorphism|<tuple|12.139|368>>
    <associate|existance of maximal filterbase|<tuple|12.251|396>>
    <associate|existance of maximum and minimum in the image of a continuous
    function of a compact set|<tuple|12.260|399>>
    <associate|exmpty set is compact|<tuple|12.207|385>>
    <associate|extreme value theorem|<tuple|12.215|387>>
    <associate|filter base has the finite intersection
    property|<tuple|12.233|392>>
    <associate|filterbase and closure|<tuple|12.244|394>>
    <associate|filterbase and continuity 1|<tuple|12.246|395>>
    <associate|filterbase and continuity 2|<tuple|12.247|395>>
    <associate|filterbase on a set|<tuple|12.243|394>>
    <associate|filterbases and compactness|<tuple|12.254|397>>
    <associate|filterbases and products|<tuple|12.248|395>>
    <associate|finer basis|<tuple|12.32|346>>
    <associate|finer metric|<tuple|12.59|351>>
    <associate|finer norm|<tuple|12.77|356>>
    <associate|finite product topology is box topology|<tuple|12.39|348>>
    <associate|finite subset of filterbase|<tuple|12.228|391>>
    <associate|finite union of compact subsets are
    compact|<tuple|12.208|386>>
    <associate|first countable topological space|<tuple|12.196|384>>
    <associate|fundamental system of neighborhoods|<tuple|12.195|384>>
    <associate|fundamental theorem of algebra|<tuple|12.372|435>>
    <associate|generalized intervals and connectness|<tuple|12.356|425>>
    <associate|generating basis of a topology|<tuple|12.28|345>>
    <associate|homeomorphism|<tuple|12.131|366>>
    <associate|homeomorphism on subset|<tuple|12.133|366>>
    <associate|identity function is continuous|<tuple|12.110|362>>
    <associate|in a normed space the sum,product with scalar is
    ontinuous|<tuple|12.140|368>>
    <associate|induced topology|<tuple|12.136|367>>
    <associate|inner product norm of finite dimensional
    spaces|<tuple|12.102|360>>
    <associate|inner product of neutral elements|<tuple|12.92|358>>
    <associate|inner set|<tuple|12.9|342>>
    <associate|integral of function to linear operators|<tuple|12.351|424>>
    <associate|intersection of balls|<tuple|12.52|350>>
    <associate|intersection of finite open sets is open|<tuple|12.4|341>>
    <associate|introduction of the multilinear norm|<tuple|12.157|374>>
    <associate|inverse induced topology|<tuple|12.137|367>>
    <associate|inverse of a homeomorphisme|<tuple|12.134|367>>
    <associate|inverse of continuous linear mappings between Banach space is
    continuous|<tuple|12.326|416>>
    <associate|inverse of isometry metric|<tuple|12.61|352>>
    <associate|inverse of isometry norm|<tuple|12.84|357>>
    <associate|inverse of open map is continuous|<tuple|12.114|363>>
    <associate|isometry and balls|<tuple|12.63|352>>
    <associate|isometry norm|<tuple|12.83|357>>
    <associate|limit and continuity|<tuple|12.282|402>>
    <associate|limit in a Hausdorff space is unique|<tuple|12.266|400>>
    <associate|limit of a convergent sequence is unique in a metric
    space|<tuple|12.270|401>>
    <associate|limit of a partial function|<tuple|12.47|350>>
    <associate|limit of a sequence in a metric space|<tuple|12.271|401>>
    <associate|limit of a sum|<tuple|12.297|406>>
    <associate|limit point|<tuple|12.18|344>>
    <associate|limit point of sequences|<tuple|12.308|408>>
    <associate|limit preserve inequality|<tuple|12.294|405>>
    <associate|limit preserves inequality (2)|<tuple|12.296|405>>
    <associate|limit preserves inequality (3)|<tuple|12.295|405>>
    <associate|linear combination of convergent series|<tuple|12.303|407>>
    <associate|linear continuous mappings and +,.|<tuple|12.148|371>>
    <associate|linear isomorphism between R^n is a
    homeomorphism|<tuple|12.145|370>>
    <associate|linear mappins between products of the real spaces are
    continuous|<tuple|12.144|370>>
    <associate|linear maps between finite dimesnional spaces are
    continuous|<tuple|12.262|399>>
    <associate|linear open mappings|<tuple|12.155|373>>
    <associate|linearity of integral|<tuple|12.347|422>>
    <associate|local property of open sets|<tuple|12.5|341>>
    <associate|mapping of a filterbase|<tuple|12.245|394>>
    <associate|max(alfa.A)|<tuple|12.78|356>>
    <associate|maximal filterbase and mapping|<tuple|12.253|396>>
    <associate|maximal filterbase characterization|<tuple|12.250|395>>
    <associate|maximum filterbase and convergence|<tuple|12.252|396>>
    <associate|metric spaces are Hausdorff|<tuple|12.187|383>>
    <associate|metric spaces are first countable|<tuple|12.197|384>>
    <associate|metric spaces are regular|<tuple|12.190|383>>
    <associate|metric topology|<tuple|12.54|350>>
    <associate|neighborhood|<tuple|12.194|384>>
    <associate|neighborhood filter base|<tuple|12.229|392>>
    <associate|neighborhood filterbase converges|<tuple|12.236|392>>
    <associate|neighborhood filterbase is a filterbase|<tuple|12.230|392>>
    <associate|norm and absolute value|<tuple|12.73|354>>
    <associate|norm mappings are continuous in the produc tof
    reals|<tuple|12.130|366>>
    <associate|norm of L(x1:..:xn}|<tuple|12.176|379>>
    <associate|norm of a finite sum|<tuple|12.74|354>>
    <associate|norm of a multilinear mapping|<tuple|12.159|375>>
    <associate|norm of a partition|<tuple|12.335|419>>
    <associate|norm of composition of linear mapping|<tuple|12.151|372>>
    <associate|norm of continuous linear mapping (inf)|<tuple|12.146|370>>
    <associate|norm of finite product of normed spaces|<tuple|12.79|356>>
    <associate|norm of sum|<tuple|12.69|?>>
    <associate|normal space|<tuple|12.192|384>>
    <associate|normed space|<tuple|12.67|353>>
    <associate|normed space of bounded functions|<tuple|12.288|403>>
    <associate|normed space properties|<tuple|12.76|355>>
    <associate|normed topology|<tuple|12.72|354>>
    <associate|open ball|<tuple|12.49|350>>
    <associate|open functions|<tuple|12.113|363>>
    <associate|open functions in metric spaces|<tuple|12.121|364>>
    <associate|open maaping theorem|<tuple|12.325|414>>
    <associate|open sets in metric topology|<tuple|12.55|351>>
    <associate|partial sum and product is continuous|<tuple|12.129|366>>
    <associate|partition covers interval|<tuple|12.330|417>>
    <associate|partition of a interval|<tuple|12.329|417>>
    <associate|partitions and combined parititions|<tuple|12.334|418>>
    <associate|power function is continuous|<tuple|12.142|369>>
    <associate|principle of nested intervals|<tuple|12.224|390>>
    <associate|product of compact subspaces|<tuple|12.256|398>>
    <associate|product of continuous functions is
    continue|<tuple|12.141|369>>
    <associate|product of metric spaces|<tuple|12.66|353>>
    <associate|product topological of subspace topologies|<tuple|12.40|349>>
    <associate|product topology|<tuple|12.36|347>>
    <associate|projection map is continuous and linear|<tuple|12.150|372>>
    <associate|projection map is open and open|<tuple|12.117|363>>
    <associate|properties of parititions|<tuple|12.331|417>>
    <associate|properties of two filterbases|<tuple|12.239|393>>
    <associate|properties of \|\|\|\| on C|<tuple|12.363|?>>
    <associate|property of integral|<tuple|12.348|422>>
    <associate|pseudo metric space|<tuple|12.45|350>>
    <associate|real continuous mappings on a compact
    subset|<tuple|12.259|398>>
    <associate|real inner product spaces|<tuple|12.87|357>>
    <associate|real space is complete|<tuple|12.311|409>>
    <associate|regular space|<tuple|12.189|383>>
    <associate|regularity and non empty open sets|<tuple|12.191|384>>
    <associate|riemanian sum|<tuple|12.337|419>>
    <associate|schwartz inequality|<tuple|12.99|359>>
    <associate|second countable topological space|<tuple|12.198|384>>
    <associate|sequential compact space|<tuple|12.218|388>>
    <associate|set distance functions are lipschitz|<tuple|12.127|365>>
    <associate|set of compact sets is a countable compact
    class|<tuple|12.223|389>>
    <associate|space of linear continuous maps to a Banach space is
    Banach|<tuple|12.315|409>>
    <associate|special cases of the binomial constant|<tuple|12.366|427>>
    <associate|splitting of a integral|<tuple|12.350|424>>
    <associate|stitching topologies|<tuple|12.29|346>>
    <associate|sub basis topology|<tuple|12.33|347>>
    <associate|subserie property|<tuple|12.301|406>>
    <associate|subspace topology|<tuple|12.6|342>>
    <associate|subspace topology of a metric space|<tuple|12.57|351>>
    <associate|subspace topology of subspace topology|<tuple|12.8|342>>
    <associate|sum of positive numbers is positive|<tuple|12.93|358>>
    <associate|sum of powers theorem|<tuple|12.319|411>>
    <associate|sum,product on (x1:..:xn)|<tuple|12.175|379>>
    <associate|tagged partition|<tuple|12.336|419>>
    <associate|terms of a convergent series goes to 0|<tuple|12.300|406>>
    <associate|the Banach Fixed Point Theorem|<tuple|12.321|411>>
    <associate|the alternative definition of the norm of a continuous linear
    function|<tuple|12.149|371>>
    <associate|the inner product norm is a norm|<tuple|12.101|360>>
    <associate|the norm of a continuous linear mapping|<tuple|12.147|371>>
    <associate|the set of linear continuous mappings is a vector
    space|<tuple|12.153|372>>
    <associate|toplinear isomorphism|<tuple|12.202|385>>
    <associate|topologies and isometries|<tuple|12.64|352>>
    <associate|topology of R^n|<tuple|12.80|356>>
    <associate|topology of real complex numbers|<tuple|12.70|354>>
    <associate|topology of spaces which are isometric in the
    norm|<tuple|12.86|357>>
    <associate|topology of the set of real numbers|<tuple|12.75|354>>
    <associate|triangle inequality of inner product norm|<tuple|12.100|360>>
    <associate|trivial filterbase|<tuple|12.231|392>>
    <associate|ultra filter|<tuple|12.249|395>>
    <associate|uniform continuous|<tuple|12.122|364>>
    <associate|uniform convergence|<tuple|12.290|404>>
    <associate|uniform convergence in bounded functions|<tuple|12.291|404>>
    <associate|uniform convergence preserves continuity|<tuple|12.292|405>>
    <associate|union of tagged partitions|<tuple|12.349|423>>
    <associate|uniqueness and riemansums|<tuple|12.340|420>>
    <associate|upper limit of L in L^n(K;Y)|<tuple|12.177|380>>
    <associate|vector space of multilinear continuous
    mappings|<tuple|12.160|376>>
    <associate|\|\|L\|\| depends only on the topology|<tuple|12.154|372>>
  </collection>
</references>
