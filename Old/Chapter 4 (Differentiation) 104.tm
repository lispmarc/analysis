...
<\body>
  ...
  <\definition>
    ...
    we define <math|<around*|(|x\<rightarrow\>i|)>:X<rsub|i>\<rightarrow\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>
  ...
  <\definition>
    Let <math|X,<around*|{|Y<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
  ...
  <\proposition>
    ...
    <math|n\<geqslant\>1>, <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set and
    <math|f:U\<rightarrow\>Y> be of class <math|C<rsup|n>> then
    <math|D<rsup|n-1>f> is of class <math|C<rsup|1>>
  </proposition>

  <\proof>
    As <math|f> is of class <math|C<rsup|n>> we have that <math|D<rsup|n>f>
    exists and thus by definition that <math|D<rsup|n-1>f> exists and is
    differentiable <math|\<forall\>x\<in\>U> with
    <math|D<around*|(|D<rsup|n-1>f|)><around*|(|x|)>=D<rsup|n>f<around*|(|x|)>>
    so that by <reference|differentiability at x implies continuity at x> we
    have that <math|D<rsup|n-1>f> is continuous. Hence <math|D<rsup|n-1>f> is
    of class <math|C<rsup|1>>.
  </proof>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      class <math|C<rsup|n>> then <math|g\<circ\>f> is of class
      <math|C<rsup|n>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|C<rsup|n>> hence by (2) <math|g\<circ\>f> is of class
  ...
  <\theorem>
    ...
    <math|f:U\<rightarrow\>Y> a n-times differentiable [or <math|C<rsup|n>>]
    function then <math|f<rsup|<around*|(|i|)>>:\<pi\><rsub|i><around*|(|U|)>\<rightarrow\>Y>
    defined by <math|f\<circ\><around*|(|i\<rightarrow\>x|)><rsub|\|\<pi\><rsub|i><around*|(|U|)>>>
  ...
  <\proof>
    First if <math|n=0> then as <math|<around*|(|i\<rightarrow\>x|)><rsub|\<pi\><rsub|i><around*|(|x|)>>>
    is continuous [see <smart-ref|(x1,...,*,...) is differentiable> and
    <smart-ref|differentiability at x implies continuity at x>]] and <math|f>
    is <math|C<rsup|0>>, thus continuous, we have that
    <math|f<rsup|<around*|(|i|)>>> is <math|C<rsup|0>>.

    Second if <math|n\<gtr\>0> then using
    <smart-ref|(x1,..,xi-1,*,xi+1,..,xn)^-1(U)> we have that
    <math|D<around*|(|i\<rightarrow\>x|)><rsub|\|\<pi\><rsub|i><around*|(|U|)>><around*|(|t|)>=<around*|(|i\<rightarrow\>0|)>>
    so that <math|D<around*|(|i\<rightarrow\>x|)><rsub|\<pi\><rsub|i><around*|(|U|)>>=C<rsub|X,L<around*|(|X,Y|)>,<around*|(|i\<rightarrow\>0|)>>>
    which by <smart-ref|constant functions are C^infinite> is
    <math|C<rsup|\<infty\>>>. So using <reference|n-times differentiability
    is same as n-1 times differentiability of DF> we have that
    <math|<around*|(|i\<rightarrow\>x|)><rsub|\|\<pi\><rsub|i><around*|(|U|)>>>
  ...
  prove the following lemma and corollary which are needed for our induction
  steps.\ 
  ...
  <\lemma>
    ...
    <math|L<around*|(|x<rsub|1>:\<ldots\>:x<rsub|n+1>|)>=L<around*|(|x<rsub|<around*|(|i\<leftrightarrow\><rsub|n+1>i+1|)><around*|(|1|)>>:\<ldots\>:x<rsub|<around*|(|i\<leftrightarrow\><rsub|n+1>i+1|)><around*|(|n+1|)>>|)>>
    then we have that <math|\<forall\>\<sigma\>\<in\>P<rsub|n+1>> [see
    <reference|Pn>] and <math|\<forall\>x<rsub|1>,\<ldots\>,x<rsub|n+1>\<in\>X>
  ...
  <\proof>
    ...
    <math|\<cal-P\><rsub|n+1>:L<rsup|n+1><around*|(|X;Y|)>\<rightarrow\>L<around*|(|X<rsup|n+1>;Y|)>>
    defined by <math|\<cal-P\><around*|(|L|)><around*|(|x<rsub|1>,\<ldots\>,x<rsub|n+1>|)>=L<around*|(|x<rsub|1>;\<ldots\>;x<rsub|n+1>|)>>
    is a norm preserving isomorphism. Then as
    <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>> we have
    <math|><math|L<around*|(|x<rsub|1>:\<ldots\>:x<rsub|n+1>|)>=L<around*|(|x<rsub|<around*|(|i\<leftrightarrow\><rsub|n+1>i+1|)><around*|(|1|)>>:\<ldots\>:x<rsub|<around*|(|i\<leftrightarrow\><rsub|n+1>i+1|)><around*|(|n+1|)>>|)>>
    we have that <math|\<cal-P\><rsub|n+1><around*|(|L|)><around*|(|x<rsub|1>,\<ldots\>,x<rsub|n+1>|)>=L<around*|(|x<rsub|1>:\<ldots\>:x<rsub|n+1>|)>=L<around*|(|x<rsub|<around*|(|i\<leftrightarrow\><rsub|n+1>i+1|)><around*|(|1|)>>:\<ldots\>:x<rsub|<around*|(|i\<leftrightarrow\><rsub|n+1>i+1|)><around*|(|n+1|)>>|)>=\<cal-P\><rsub|n+1><around*|(|L|)><rsub|><around*|(|x<rsub|<around*|(|i\<leftrightarrow\><rsub|n+1>i+1|)><around*|(|1|)>>,\<ldots\>,x<rsub|<around*|(|i\<leftrightarrow\><rsub|n+1>i+1|)><around*|(|n+1|)>>|)>>.
    Let <math|\<sigma\>\<in\>P<rsub|n+1>> then using <reference|transposition
    and symmetry (2)> <math|we have that \<cal-P\><rsub|n+1><around*|(|L|)><around*|(|x<rsub|1>,\<ldots\>,x<rsub|n+1>|)>=\<cal-P\><rsub|n+1><around*|(|x<rsub|\<sigma\><around*|(|1|)>>,.\<ldots\>,x<rsub|\<sigma\><around*|(|n+1|)>>|)>>.
    Hence <math|L<around*|(|x<rsub|1>;\<ldots\>;x<rsub|n+1>|)>=\<cal-P\><rsub|n+1><around*|(|L|)><around*|(|x<rsub|1>,\<ldots\>,x<rsub|n+1>|)>=\<cal-P\><rsub|n+1><around*|(|x<rsub|\<sigma\><around*|(|1|)>>,.\<ldots\>,x<rsub|\<sigma\><around*|(|n+1|)>>|)>=L<around*|(|x<rsub|\<sigma\><around*|(|1|)>>;,\<ldots\>,x<rsub|\<sigma\><around*|(|n+1|)>>|)>>.
  </proof>

  TODO <reference|C^n implies C^m>
  ...
  <\lemma>
    ...
    <math|C<rsup|\<infty\>>> and <math|D e<rsub|v<rsub|1>,\<ldots\>,v<rsub|m>><around*|(|L|)>=e<rsub|v<rsub|1>,\<ldots\>,v<rsub|m>>>
    and if <math|n\<geqslant\>2 > then <math|D<rsup|n>e<rsub|v<rsub|1>,\<ldots\>,v<rsub|m>><around*|(|L|)>=X<rsub|X,Y,0>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      proving that <math|<around*|\<\|\|\>|e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n>>|\<\|\|\>><rsub|>\<leqslant\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n-2|}>><around*|\<\|\|\>|v<rsub|i>|\<\|\|\>><rsub|X>>
      and thus continuity.\ 
    </enumerate>
  ...
  <\lemma>
    Let <math|n\<in\>\<bbb-N\>> with <math|n\<geqslant\>2>,
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> open,
    ...
    g<around*|(|x|)><around*|(|v|)>=D<rsup|n>f<around*|(|x|)><around*|(|v:v<rsub|1>:\<ldots\>:v<rsub|n>|)>>
  </lemma>
  ...
  <\proof>
    ...
    <\eqnarray*>
      ...
      operator (1)>>><rsub|>>|<cell|e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n>><around*|(|D<rsup|n-1>f<around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n>>\<circ\>D<rsup|n-1>f|)><around*|(|x|)>>>>>
    </eqnarray*>

    proving that\ 

    <\equation*>
      g=e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n>>\<circ\>D<rsup|n-1>f
    </equation*>
    ...
    <\equation*>
      g is of class C<rsup|1>
    </equation*>

    further for <math|x\<in\>U> we have

    <\eqnarray*>
      <tformat|<table|<row|<cell|D g<around*|(|x|)>>|<cell|=>|<cell|D<around*|(|e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n>>\<circ\>D<rsup|n-1>f|)><around*|(|x|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|chain
      rule>>>>|<cell|D e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n>><around*|(|D<rsup|n-1>f<around*|(|x|)>|)>\<circ\>D<around*|(|D<rsup|n-1>f|)><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|D
      e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n>><around*|(|D<rsup|n-1>f<around*|(|x|)>|)>\<circ\>D<rsup|n>f<around*|(|x|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|evaluation
      operator (1)>>>>|<cell|e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n>>\<circ\>D<rsup|n>f<around*|(|x|)>>>>>
    </eqnarray*>

    hence\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|D g<around*|(|x|)><around*|(|v|)>>|<cell|=>|<cell|<around*|(|e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n>>\<circ\>D<rsup|n>f<around*|(|x|)>|)><around*|(|v|)>>>|<row|<cell|>|<cell|=>|<cell|e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n>><around*|(|D<rsup|n>f<around*|(|x|)><around*|(|v|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|D<rsup|n>f<around*|(|x|)><around*|(|v|)>|)><around*|(|v<rsub|1>:,\<ldots\>,v<rsub|n>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|L(x1)(x2:..:xn)>>>>|<cell|>>>>
    </eqnarray*>
  ...
  <\proof>
    ...
    by <math|x\<rightarrow\><around*|(|D g<around*|(|\<ast\>|)><around*|(|u|)>|)><around*|(|x|)>=Dg<around*|(|x|)><around*|(|u|)>>
    ...
    <\equation>
      <label|eq 12.55>D<around*|(|D g<around*|(|\<ast\>|)><around*|(|u|)>|)><around*|(|x|)>=e<rsub|u,v<rsub|1>,\<ldots\>,v<rsub|n-2>>\<circ\>D<rsup|n>f<around*|(|x|)>
    </equation>
  ...
  <\lemma>
    ...
    then <math|h> is <math|C<rsup|1>> and <math|D
    h<around*|(|x|)><around*|(|u|)>=D<rsup|n>f<around*|(|x|)><around*|(|u:v<rsub|1>:\<ldots\>:v<rsub|n-1>|)>>
  </lemma>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><dueto|<math|n=1>>As <math|P<rsub|1>=<around*|{|\<bbb-1\><rsub|<around*|{|1|}>>|}>>
      ...
      <\enumerate>
        ...
        we have <math|D<rsup|m+1>f<around*|(|x|)><around*|(|u:v<rsub|1>,\<ldots\>,v<rsub|m>|)>=D
        h<rsub|v<rsub|1>,\<ldots\>,v<rsub|<around*|(|m+1|)>-1>><around*|(|x|)><around*|(|u|)>=Dh<rsub|v<rsub|\<sigma\><around*|(|1|)>>,\<ldots\>,v<rsub|\<sigma\><around*|(|<around*|(|m+1|)>-1|)>>><around*|(|x|)>=D<rsup|m+1>f<around*|(|x|)><around*|(|u:v<rsub|\<sigma\><around*|(|1|)>>:\<ldots\>:v<rsub|\<sigma\><around*|(|m|)>>|)>>
        giving\ 
  ...
  <\theorem>
    ...
    have that <math|D<rsub|i><around*|(|f\<circ\>g|)><around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>=D
...
<\references>
  <\collection>
    <associate|(01,..,*,..,On) is C@@|<tuple|14.123|452>>
    <associate|(f1,..fn)|<tuple|14.38|?>>
    <associate|(i-\<gtr\>x)-1(A)|<tuple|14.21|?>>
    <associate|(x,h)-\<gtr\>Df(x)(h) differentiability|<tuple|14.78|432>>
    <associate|(x1,..,xi-1,*,xi+1,..,xn)|<tuple|14.19|417>>
    <associate|(x1,..,xi-1,*,xi+1,..,xn)^-1(U)|<tuple|14.26|?>>
    <associate|(x1,...,*,...) is differentiable|<tuple|14.25|417>>
    <associate|C1 of real or complex function|<tuple|14.54|423>>
    <associate|C^2 differential is symmetric|<tuple|14.115|447>>
    <associate|C^@@=@@-times differentiable|<tuple|14.56|424>>
    <associate|C^n implies C^m|<tuple|14.58|424>>
    <associate|C^n is a local property|<tuple|14.62|427>>
    <associate|C^n of multivalued functions|<tuple|14.73|430>>
    <associate|C^n=\<gtr\>C^n is C^1|<tuple|14.50|?>>
    <associate|D1 and composition|<tuple|14.74|?>>
    <associate|D^2g(x)(u)(v)=D^nf(x)(v:u:v1..vn-2)|<tuple|14.119|450>>
    <associate|D^nf(x)(h1:..hn)=D^(n-1)f(x)(h1:..hn-1)(hn)|<tuple|14.77|431>>
    <associate|Dh(x)(u)=D^nf(x)(u:v1:..:vn-1)|<tuple|14.120|450>>
    <associate|GL(X) is a group|<tuple|14.135|458>>
    <associate|I+H has inverse if norm of H is less then
    1|<tuple|14.142|461>>
    <associate|Jacobian Matrix|<tuple|14.40|421>>
    <associate|Jacobian of linear map|<tuple|14.41|?>>
    <associate|L0,1=[0,1]|<tuple|14.106|?>>
    <associate|Mean Value Theorem 3|<tuple|14.108|447>>
    <associate|Mean value theorem 1|<tuple|14.101|445>>
    <associate|Mean value theorem 2|<tuple|14.104|446>>
    ...
    <associate|balls are convex|<tuple|14.103|445>>
    <associate|chain rule|<tuple|14.29|418>>
    <associate|chain rule (1)|<tuple|14.30|?>>
    <associate|chain rules of partial differentiable
    functions|<tuple|14.127|453>>
    <associate|composition of diffeomorphism is a
    diffeomorphism|<tuple|14.148|465>>
    <associate|composition of differentials on arbitrary
    sets|<tuple|14.82|438>>
    <associate|condition for concavity (convexitivity)|<tuple|14.96|?>>
    <associate|conditions for minimum,maximum of a function|<tuple|14.98|?>>
    <associate|consequence of Mean value theorem|<tuple|14.114|?>>
    <associate|consequence of mean value theorem (2)|<tuple|14.113|?>>
    <associate|constant functions are C^infinite|<tuple|14.67|428>>
    <associate|continuous billinear functions are
    C^infinity|<tuple|14.70|429>>
    <associate|derivative|<tuple|14.16|416>>
    <associate|derivative and composition|<tuple|14.31|?>>
    <associate|derivative and local minimum (maximum)|<tuple|14.97|?>>
    <associate|derivative is local|<tuple|14.18|?>>
    <associate|derivative on a closed interval|<tuple|14.85|?>>
    <associate|diffeomorphism are toplinear|<tuple|14.147|?>>
    ...
    differentiability|<tuple|14.126|453>>
    <associate|differentiability of K^n|<tuple|14.36|420>>
    <associate|differentiability of finite sum|<tuple|14.65|428>>
    <associate|differentiability of map to product of
    spaces|<tuple|14.39|420>>
    <associate|differentiability of product of functions|<tuple|14.43|421>>
    <associate|differentiability on [a,b]|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|-><around*|(|x|)>>|438>>
    <associate|differentiability on [a,b] equivalences|<tuple|14.86|439>>
    <associate|differentiability on products of metric
    spaces|<tuple|14.33|419>>
    <associate|differential of a billinear mapping|<tuple|14.42|421>>
    ...
    <associate|eq 12.100|<tuple|14.169|467>>
    <associate|eq 12.101|<tuple|14.170|468>>
    <associate|eq 12.102|<tuple|14.171|468>>
    <associate|eq 12.103|<tuple|14.172|468>>
    <associate|eq 12.104|<tuple|14.173|468>>
    <associate|eq 12.105|<tuple|14.174|468>>
    <associate|eq 12.106|<tuple|14.175|468>>
    <associate|eq 12.107|<tuple|14.176|468>>
    <associate|eq 12.108|<tuple|14.177|468>>
    <associate|eq 12.109|<tuple|14.178|468>>
    <associate|eq 12.12|<tuple|14.23|422>>
    <associate|eq 12.128|<tuple|14.181|470>>
    <associate|eq 12.129|<tuple|14.182|?>>
    <associate|eq 12.130|<tuple|14.183|470>>
    <associate|eq 12.131|<tuple|14.187|471>>
    <associate|eq 12.132|<tuple|14.188|471>>
    <associate|eq 12.133|<tuple|14.189|471>>
    <associate|eq 12.134|<tuple|14.190|471>>
    <associate|eq 12.135|<tuple|14.191|471>>
    <associate|eq 12.136|<tuple|14.192|471>>
    <associate|eq 12.137|<tuple|14.193|471>>
    <associate|eq 12.138|<tuple|14.194|471>>
    <associate|eq 12.139|<tuple|14.195|471>>
    <associate|eq 12.140|<tuple|14.196|471>>
    <associate|eq 12.141|<tuple|14.196|471>>
    <associate|eq 12.2|<tuple|14.11|416>>
    <associate|eq 12.37|<tuple|14.68|444>>
    <associate|eq 12.38|<tuple|14.69|444>>
    <associate|eq 12.39|<tuple|14.70|445>>
    <associate|eq 12.40|<tuple|14.71|445>>
    <associate|eq 12.53|<tuple|14.104|450>>
    <associate|eq 12.54|<tuple|14.105|450>>
    <associate|eq 12.55|<tuple|14.106|450>>
    <associate|eq 12.56|<tuple|14.107|451>>
    <associate|eq 12.57|<tuple|14.108|451>>
    <associate|eq 12.58|<tuple|14.109|451>>
    <associate|eq 12.59|<tuple|14.110|452>>
    <associate|eq 12.60|<tuple|14.111|452>>
    <associate|eq 12.61|<tuple|14.112|452>>
    <associate|eq 12.62|<tuple|14.113|452>>
    <associate|eq 12.63|<tuple|14.114|452>>
    <associate|eq 12.64|<tuple|14.133|459>>
    <associate|eq 12.64-0|<tuple|14.115|454>>
    <associate|eq 12.65|<tuple|14.134|459>>
    <associate|eq 12.65-0|<tuple|14.116|454>>
    <associate|eq 12.66|<tuple|14.135|459>>
    <associate|eq 12.66-0|<tuple|14.117|454>>
    <associate|eq 12.67|<tuple|14.136|459>>
    <associate|eq 12.67-0|<tuple|14.118|454>>
    <associate|eq 12.68|<tuple|14.137|460>>
    <associate|eq 12.68-0|<tuple|14.119|454>>
    <associate|eq 12.69|<tuple|14.138|460>>
    <associate|eq 12.69-0|<tuple|14.120|454>>
    <associate|eq 12.70|<tuple|14.139|460>>
    <associate|eq 12.70-0|<tuple|14.121|454>>
    <associate|eq 12.71|<tuple|14.140|461>>
    <associate|eq 12.71-0|<tuple|14.122|454>>
    <associate|eq 12.72|<tuple|14.141|461>>
    <associate|eq 12.72-0|<tuple|14.123|454>>
    <associate|eq 12.72-1|<tuple|14.124|455>>
    <associate|eq 12.73|<tuple|14.142|461>>
    <associate|eq 12.74|<tuple|14.143|461>>
    <associate|eq 12.74-1|<tuple|14.125|456>>
    <associate|eq 12.75|<tuple|14.144|462>>
    <associate|eq 12.75-1|<tuple|14.126|456>>
    <associate|eq 12.76|<tuple|14.145|462>>
    <associate|eq 12.76-1|<tuple|14.127|456>>
    <associate|eq 12.77|<tuple|14.146|462>>
    <associate|eq 12.77-1|<tuple|14.128|456>>
    <associate|eq 12.78|<tuple|14.147|462>>
    <associate|eq 12.78-1|<tuple|14.129|456>>
    <associate|eq 12.79|<tuple|14.148|462>>
    <associate|eq 12.79-1|<tuple|14.130|456>>
    <associate|eq 12.80|<tuple|14.149|463>>
    <associate|eq 12.80-1|<tuple|14.131|457>>
    <associate|eq 12.81|<tuple|14.150|463>>
    <associate|eq 12.81-1|<tuple|14.132|457>>
    <associate|eq 12.82|<tuple|14.151|463>>
    <associate|eq 12.83|<tuple|14.152|463>>
    <associate|eq 12.84|<tuple|14.153|463>>
    <associate|eq 12.85|<tuple|14.154|463>>
    <associate|eq 12.86|<tuple|14.155|464>>
    <associate|eq 12.87|<tuple|14.156|465>>
    <associate|eq 12.88|<tuple|14.157|466>>
    <associate|eq 12.89|<tuple|14.158|466>>
    <associate|eq 12.9|<tuple|14.160|466>>
    <associate|eq 12.90|<tuple|14.159|466>>
    <associate|eq 12.92|<tuple|14.161|466>>
    <associate|eq 12.93|<tuple|14.162|466>>
    <associate|eq 12.94|<tuple|14.163|466>>
    <associate|eq 12.95|<tuple|14.164|466>>
    <associate|eq 12.96|<tuple|14.165|467>>
    <associate|eq 12.97|<tuple|14.166|467>>
    <associate|eq 12.98|<tuple|14.167|467>>
    <associate|eq 12.99|<tuple|14.168|467>>
    <associate|eq 13.50.317|<tuple|14.77|?>>
    <associate|eq 13.51.317|<tuple|14.78|?>>
    <associate|eq 13.52.317|<tuple|14.79|?>>
    <associate|eq 13.53.317|<tuple|14.81|?>>
    <associate|eq 13.54.317|<tuple|14.82|?>>
    <associate|eq 13.55.317|<tuple|14.83|?>>
    <associate|eq 13.56.317|<tuple|14.86|?>>
    <associate|eq 13.57.317|<tuple|14.87|?>>
    <associate|eq 14.1.100|<tuple|14.1|?>>
    <associate|eq 14.100.103|<tuple|14.100|?>>
    <associate|eq 14.101.103|<tuple|14.101|?>>
    <associate|eq 14.102.103|<tuple|14.102|?>>
    <associate|eq 14.103.103|<tuple|14.103|?>>
    ...
    <associate|eq 14.149.020|<tuple|14.179|?>>
    <associate|eq 14.15.100|<tuple|14.16|?>>
    <associate|eq 14.150.020|<tuple|14.180|?>>
    ...
    <associate|eq 14.23.014|<tuple|14.24|?>>
    <associate|eq 14.24.101|<tuple|14.25|?>>
    <associate|eq 14.25.101|<tuple|14.26|?>>
    <associate|eq 14.26.101|<tuple|14.27|?>>
    <associate|eq 14.27.101|<tuple|14.28|?>>
    <associate|eq 14.28.101|<tuple|14.29|?>>
    <associate|eq 14.29.101|<tuple|14.30|?>>
    <associate|eq 14.3.100|<tuple|14.3|?>>
    <associate|eq 14.30.101|<tuple|14.31|?>>
    <associate|eq 14.31.101|<tuple|14.32|?>>
    <associate|eq 14.32.101|<tuple|14.33|?>>
    <associate|eq 14.33.101|<tuple|14.34|?>>
    <associate|eq 14.34.101|<tuple|14.35|?>>
    <associate|eq 14.35.101|<tuple|14.36|?>>
    <associate|eq 14.36.101|<tuple|14.37|?>>
    <associate|eq 14.37.101|<tuple|14.38|?>>
    <associate|eq 14.39.102.3|<tuple|14.39|?>>
    <associate|eq 14.4.100|<tuple|14.4|?>>
    <associate|eq 14.40.102|<tuple|14.41|?>>
    <associate|eq 14.40.102.1|<tuple|14.40|?>>
    <associate|eq 14.41.102|<tuple|14.42|?>>
    <associate|eq 14.43.102|<tuple|14.43|?>>
    <associate|eq 14.44.102.1|<tuple|14.44|?>>
    <associate|eq 14.45.102|<tuple|14.45|?>>
    <associate|eq 14.46.004|<tuple|14.49|?>>
    <associate|eq 14.46.1.004|<tuple|14.47|?>>
    <associate|eq 14.46.102|<tuple|14.46|?>>
    <associate|eq 14.48.103|<tuple|14.48|?>>
    <associate|eq 14.5.100|<tuple|14.5|?>>
    <associate|eq 14.50.103|<tuple|14.50|?>>
    <associate|eq 14.51.103|<tuple|14.51|?>>
    <associate|eq 14.52.103|<tuple|14.52|?>>
    <associate|eq 14.53.103|<tuple|14.53|?>>
    <associate|eq 14.54.103.2|<tuple|14.54|?>>
    <associate|eq 14.55.103|<tuple|14.55|?>>
    <associate|eq 14.56.103.1|<tuple|14.56|?>>
    <associate|eq 14.57.103|<tuple|14.57|?>>
    <associate|eq 14.58.103|<tuple|14.58|?>>
    <associate|eq 14.59.103|<tuple|14.59|?>>
    <associate|eq 14.6.100|<tuple|14.6|?>>
    <associate|eq 14.60.103|<tuple|14.60|?>>
    <associate|eq 14.61.103|<tuple|14.61|?>>
    <associate|eq 14.62.103|<tuple|14.62|?>>
    <associate|eq 14.63.103|<tuple|14.63|?>>
    <associate|eq 14.64.103|<tuple|14.64|?>>
    <associate|eq 14.65.103|<tuple|14.65|?>>
    <associate|eq 14.66.103|<tuple|14.66|?>>
    <associate|eq 14.67.103|<tuple|14.67|?>>
    <associate|eq 14.7.100|<tuple|14.7|?>>
    <associate|eq 14.72.103|<tuple|14.72|?>>
    <associate|eq 14.73.103|<tuple|14.73|?>>
    <associate|eq 14.74.103|<tuple|14.74|?>>
    <associate|eq 14.75.103|<tuple|14.75|?>>
    <associate|eq 14.8.100|<tuple|14.8|?>>
    <associate|eq 14.80.103|<tuple|14.80|?>>
    <associate|eq 14.84.103|<tuple|14.84|?>>
    <associate|eq 14.85.103|<tuple|14.85|?>>
    <associate|eq 14.88.103|<tuple|14.88|?>>
    <associate|eq 14.89.103|<tuple|14.89|?>>
    <associate|eq 14.9.100|<tuple|14.9|?>>
    <associate|eq 14.90.103|<tuple|14.90|?>>
    <associate|eq 14.91.103|<tuple|14.91|?>>
    <associate|eq 14.92.103|<tuple|14.92|?>>
    <associate|eq 14.93.103|<tuple|14.93|?>>
    <associate|eq 14.94.103|<tuple|14.94|?>>
    <associate|eq 14.95.103|<tuple|14.95|?>>
    <associate|eq 14.96.103|<tuple|14.96|?>>
    <associate|eq 14.97.103|<tuple|14.97|?>>
    <associate|eq 14.98.103|<tuple|14.98|?>>
    <associate|eq 14.99.103.1|<tuple|14.99|?>>
    <associate|equivalences of convexitivity (concavity)|<tuple|14.95|?>>
    <associate|evaluation operator (1)|<tuple|14.117|?>>
    <associate|extremum and derivate|<tuple|14.89|442>>
    <associate|f_v is differentiable|<tuple|14.76|431>>
    <associate|fundamental theorem of calculus|<tuple|14.100|444>>
    <associate|generalized chain rule|<tuple|14.75|430>>
    <associate|i the substitution|<tuple|14.22|?>>
    <associate|i-H has inverse if norm of H is lower then
    1|<tuple|14.141|459>>
    <associate|if f is C^n then D^1f is C^n-1|<tuple|14.60|426>>
    <associate|implicit function theorem|<tuple|14.160|470>>
    <associate|in Banach spaces linear continuous mappings are
    toplinear|<tuple|14.133|458>>
    <associate|inverse function theorem|<tuple|14.150|465>>
    <associate|inverse mapping is c-infinite|<tuple|14.143|461>>
    <associate|inverse of derivative|<tuple|14.158|?>>
    <associate|inverse theorem for Df(0)=1X|<tuple|14.151|465>>
    <associate|lagranges theorem|<tuple|14.91|443>>
    <associate|left,right derivatives|<tuple|14.84|?>>
    <associate|lemma for diedonne main value|<tuple|14.110|?>>
    <associate|linear continuous mappings are C^infinity|<tuple|14.68|428>>
    <associate|linearity of (01,...*,...0n)|<tuple|14.23|417>>
    <associate|mean value theorem (3)|<tuple|14.111|?>>
    <associate|n-th derivative|<tuple|<with|mode|<quote|math>|f<rsup|<around*|(|n|)>>>|423>>
    <associate|n-times differentiability and partial
    derivatives|<tuple|14.79|432>>
    <associate|n-times differentiability implies m-times
    differentiability|<tuple|14.57|424>>
    <associate|n-times differentiability is local|<tuple|14.61|426>>
    <associate|n-times differentiability is same as n-1 times
    differentiability of DF|<tuple|14.59|425>>
    <associate|n-times differentiability of multi valued
    function|<tuple|14.72|429>>
    <associate|partial derivative and partial differential|<tuple|14.35|?>>
    <associate|partial derivative definition|<tuple|14.34|420>>
    <associate|partial differential definition|<tuple|14.32|419>>
    <associate|partial differential on U|<tuple|14.124|453>>
    <associate|power of a continuous linear mapping is linear and
    continuous|<tuple|14.138|458>>
    <associate|product of n-times differentiable functions is n-times
    differentiable|<tuple|14.80|432>>
    <associate|projection map is infinite times dimensions|<tuple|14.71|429>>
    <associate|proposition 12.116|<tuple|14.152|466>>
    <associate|proposition 12.118|<tuple|14.154|467>>
    <associate|proposition 12.120|<tuple|14.156|469>>
    <associate|rolles theorem|<tuple|14.90|443>>
    <associate|second mean value theorem|<tuple|14.109|447>>
    <associate|strictly increasing function and derivative|<tuple|14.92|?>>
    <associate|sum of (01,...,*,...0n)|<tuple|14.24|417>>
    <associate|sum of C^n functions is C^n|<tuple|14.64|427>>
    <associate|sum of differentiable functions|<tuple|14.28|417>>
    <associate|sum of linear function and infinite sum|<tuple|14.140|459>>
    <associate|sum of n-times differentiable functions is n-times
    differentiable|<tuple|14.63|427>>
    <associate|symmetry of L^n+t(X;Y) based on permutations and
    transposition|<tuple|14.116|449>>
    <associate|the n-th differential is symmetric|<tuple|14.121|450>>
    <associate|toplinear in normed space|<tuple|14.132|457>>
    <associate|translations are C-infinity|<tuple|14.69|428>>
    <associate|uniqueness of differential|<tuple|14.5|413>>
    <associate|x+t.y is C infinite|<tuple|14.87|?>>
    <associate|x+t.y is C1 (1)|<tuple|14.55|?>>
  </collection>
</references>
