...
<\body>
  ...
  Note that we have the following equivalent definitioTn of a algebra
  ...
  <\lemma>
    <label|R can be covered by open intervals><math|\<bbb-R\>=<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|]|-i,i|[>=<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|[|-i,i|[>>
  </lemma>
  ...
  <\proof>
    ...
    <\equation*>
      \<bbb-R\>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|]|-i,i|[>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|[|-i,i|[>
    </equation*>
  ...
  <\lemma>
    ...
    then <math|\<bbb-R\><rsup|n>=<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|]|-i,i|[><rsup|n>=<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|]|-i,i|[><rsup|n>>
  </lemma>
  ...
  <\proof>
    ...
    <\equation*>
      <big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|]|-i,i|[><rsup|n>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|[|-i,i|[><rsup|n>\<subseteq\>\<bbb-R\><rsup|n>.
    </equation*>
    ...
    <\equation*>
      \<bbb-R\><rsup|n>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|[|-i,i|[><rsup|n>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|]|-i,i|[><rsup|n>
    </equation*>
  </proof>
  ...
  <subsubsection|Properties of <math|<around*|\<langle\>|\<bbb-R\><rsup|n>,\<cal-L\><rsup|n>,\<lambda\><rsup|n>|\<rangle\>>>
  ...
  <\proof>
    ...
    <\description>
      ...
      and <math|<big|prod><rsub|i=1><rsup|1><around*|(|b<rprime|'><rsub|i>-a<rprime|'><rsub|i>|)>=b<rprime|'>-a<rprime|'>=b-<around*|(|a-\<varepsilon\>|)>=<around*|(|b-a|)>+\<varepsilon\>>
      ...
      The above together with <reference|eq 18.170.028> proves that
  ...
  <\proof>
    ...
    <\description>
      ...
      <\eqnarray*>
        ...
        18.172.028>>>>|<cell|\<lambda\><rsup|n><around*|(|A|)>+<frac|\<varepsilon\>|2>+<frac|\<varepsilon\>|2>>>|<row|<cell|>|<cell|\<less\>>|<cell|\<lambda\><rsup|n><around*|(|A|)>+\<varepsilon\>>>>>
      </eqnarray*>
      ...
      <\equation>
        <label|eq 18.173.028><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|<around*|[|a<rprime|'><rsub|i>,b<rprime|'><rsub|i>|[>|)>\<leqslant\>\<lambda\><rsup|n><around*|(|A|)>
      </equation>
      ...
      <\eqnarray*>
        ...
        18.173.028>>>>|<cell|\<lambda\><rsup|n><around*|(|A|)><eq-number><label|eq
        18.175.028>>>>>
      </eqnarray*>
  ...
  <\proof>
    ...
    or <math|y\<in\><big|sqcap><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|-<around*|(|M+1|)>,M+1|[><rsup|n>>.
    So <math|A\<subseteq\>C\<subseteq\><big|prod><rsub|i=1><rsup|n><around*|[|-<around*|(|M+1|)>,M+1|[>>
    or <math|\<lambda\><rsup|n><around*|(|A|)>\<leqslant\>\<lambda\><rsup|n><around*|(|C|)>\<leqslant\>\<lambda\><rsup|n><around*|(|<big|sqcap><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|-<around*|(|M+1|)>,M+1|[>|)>=v<rsup|n><around*|(|<big|sqcap><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|-<around*|(|M+1|)>,M+1|[>|)>=<big|sqcap><rsub|i=1><rsup|n><around*|(|2\<cdot\><around*|(|M+1|)>|)>\<less\>\<infty\>>
    proving that
    ...
    <\eqnarray*>
      ...
      is a unin of rectangles>>>>|<cell|A<big|cap><around*|(|<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|[|-i,i|[><rsup|2>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|(|A<big|cap><around*|[|-i,i|[><rsup|n>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>>A<rsub|i>
  ...
  As a example of a application of the above propositions we prove htat the
  ...
  <\proposition>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>> then if <math|\<mu\>> is a measure on
  ...
  <\proof>
    ...
    <math|\<exists\>a,b\<in\>\<bbb-R\><rsup|n>> with <math|a\<leqslant\>b>
    such that <math|A\<subseteq\><around*|]|a,b|[>> we have as,
    ...
    that using <reference|eq 18.191.028>

    <\eqnarray*>
      <tformat|<table|<row|<cell|\<mu\><around*|(|<around*|]|a,b|[>|)>>|<cell|\<leqslant\>>|<cell|\<lambda\><rsup|n><around*|(|<around*|]|a,b|[>|)>\<less\>\<infty\>>>|<row|<cell|\<mu\><around*|(|A|)>>|<cell|\<leqslant\>>|<cell|\<lambda\><rsup|n><around*|(|A|)>\<leqslant\>\<lambda\><rsup|n><around*|(|<around*|]|a,b|[>|)>\<less\>\<infty\>>>|<row|<cell|\<mu\><around*|(|<around*|]|a,b|[>\\A|)>>|<cell|\<leqslant\>>|<cell|\<lambda\><rsup|n><around*|(|<around*|]|a,b|[>\\A|)>\<leqslant\>\<lambda\><rsup|n><around*|(|<around*|]|a,b|[>|)>\<less\>\<infty\>>>>>
    </eqnarray*>
    ...
    contradicting <reference|eq 18.193.028>. Henve
    ...
    Using <reference|replace countable untion of sets by disjoint union of
    sets> there exissts a <math|<around*|{|B<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>\<subseteq\>\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>>
  ...
  <\proposition>
    ...
    <\enumerate>
      ...
      <item>If <math|A,B\<in\>Rr<rsup|n>> then
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\description>
        ...
        <item*|<math|\<Leftarrow\>>>If <math|A=<around*|(|A+a|)>+<around*|(|-a|)>\<subseteq\><rsub|\<Rightarrow\>><around*|(|B+a|)>+<around*|(|-a|)>=B>
      </description>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\><around*|(|A+a|)><big|cap>B>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>A+a\<wedge\>x\<in\>B>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|<around*|(|1|)>>>|<cell|<around*|(|x-a|)>\<in\>A\<wedge\><around*|(|x-a|)>+a\<in\>B>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|<around*|(|1|)>>>|<cell|<around*|(|x-a|)>\<in\>A\<wedge\><around*|(|x-a|)>\<in\>B+<around*|(|-a|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|<around*|(|x-a|)>\<in\>A<big|cap><around*|(|B+<around*|(|-a|)>|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|(|A<big|cap><around*|(|B+<around*|(|-a|)>|)>|)>+a>>>>
      </eqnarray*>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\><around*|[|a,b|[>+c>|<cell|\<Leftrightarrowlim\><rsub|<around*|(|1|)>>>|<cell|x-c\<in\><around*|[|a,b|[>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|a\<leqslant\>x-c\<less\>b>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|a+c\<leqslant\>x\<less\>b+c>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|[|a+c,b+c|[>>>>>
      </eqnarray*>
    </enumerate>
  ...
  invariant. First we prove this for <math|v<rsup|n>> and halfopen
  rectangles.
  ...
  <\proof>
    Let <math|R\<in\>\<cal-R\><rsup|n>> then
    <math|\<exists\>c,d\<in\>\<bbb-R\><rsup|n>> such that
    <math|c\<leqslant\>d> such that <math|R=<around*|[|c,d|[>>. Then we have

    <\eqnarray*>
      <tformat|<table|<row|<cell|x\<in\>R+a>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|[|c,d|[>+a>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|<text|<reference|translation
      properties>>>>|<cell|x-a\<in\><around*|[|c,d|[>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>
      c<rsub|i>\<leqslant\>x<rsub|i>-a<rsub|i>\<less\>d<rsub|i>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>
      c<rsub|i>+a<rsub|i>\<leqslant\>x<rsub|i>\<less\>d<rsub|i>+a<rsub|i>>>>>
    </eqnarray*>

    proving that <math|R+a=<around*|[|c+a,d+a|[>> hence
  ...
  Next we prove that every Lebesque measurability is translation invariant.
  ...
  <\proof>
    ...
    Take now then for <math|B\<subseteq\>\<bbb-R\><rsup|n>> we have
  ...
  <\theorem>
    Let <math|n\<in\>\<bbb-N\><rsub|0>> then given
    <math|a\<in\>\<bbb-R\><rsup|n>> we have

    <\enumerate>
      <item><math|\<forall\>A\<in\>\<cal-L\><rsup|n>> we have
      <math|A+a\<in\>\<cal-L\><rsup|n>>
      ...
      means that <math|\<forall\>A\<in\>\<cal-L\><rsup|n>> proves that
  ...
  <\proof>
    ...
    <\enumerate>
      <item>As <math|\<bbb-R\><rsup|n>+a=\<bbb-R\><rsup|n>>
      ...
      proving that <math|<around*|(|\<bbb-R\><rsup|n>\\A|)>+a=<around*|(|\<bbb-R\><rsup|n>\\<around*|(|A+a|)>|)>\<in\>\<cal-S\><rsub|a>>
    ...
    <math|x\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|max>><around*|(|x,\<alpha\>|)>\<subseteq\>U+a>
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 18.197.029><big|sqcup><rsub|i\<in\><around*|{|0,\<ldots\>,2<rsup|m>-1|}>><around*|[|<frac|i|2<rsup|m>>,<frac|i+1|2<rsup|m>>|[>\<subseteq\><around*|[|0,1|[>
    </equation>
    ...
    <math|n\<leqslant\>2<rsup|m>\<cdot\>x\<less\>n+1>. So after division by
    ...
    proving that <math|x\<in\><big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,2<rsup|m>-1|}>>>.
    So <math|<around*|[|0,1|[>\<subseteq\><big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,m|}>><around*|[|<frac|i|2<rsup|m>>,<frac|i+1|2<rsup|m>>|[>>
    which together with <reference|eq 18.197.029> givea
  ...
  <\proof>
    If <math|x\<in\><big|sqcup><rsub|\<rho\>\<in\><around*|{|0,\<ldots\>,2<rsup|m>-1|}><rsup|n>><around*|[|<frac|\<rho\>|2<rsup|m>>,<frac|\<rho\>+1|2<rsup|m>>|[>>
    ...
    <\equation>
      <label|eq 18.199.029><big|sqcup><rsub|\<rho\>\<in\><around*|{|0,\<ldots\>,2<rsup|m>-1|}><rsup|n>><around*|[|<frac|\<rho\>|2<rsup|m>>,<frac|\<rho\>+1|2<rsup|m>>|[>\<subseteq\><around*|[|0,1|[><rsup|n>
    </equation>

    If <math|x\<in\><around*|[|0,1|[><rsup|n>> then
    <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
    <math|x<rsub|i>\<in\><around*|[|0,1|[>\<equallim\><rsub|<text|<reference|[0,1[
    as a union of Dyadic intervals>>><big|cup><rsub|j\<in\><around*|{|0,\<ldots\>,2<rsup|m>-1|}>><around*|[|<frac|j|2<rsup|m>>,<frac|j+1|2<rsup|m>>|[>>
    ...
    So if we define <math|\<rho\>\<in\><around*|{|0,\<ldots\>,2<rsup|m>-1|}><rsup|n>>
    ...
    proving that <math|<around*|[|0,1|[><rsup|n>\<subseteq\><big|sqcup><rsub|\<rho\>\<in\><around*|{|0,\<ldots\>,2<rsup|m>-1|}><rsup|n>><around*|[|<frac|\<rho\>|2<rsup|m>>,<frac|\<rho\>+1|2<rsup|m>>|[>>.
    Combining this with <reference|eq 18.199.029> proves that\ 

    <\equation>
      <label|eq 18.200.029><around*|[|<frac|\<rho\><rsub|i>|2<rsup|m>>,<frac|\<rho\><rsub|i>+1|2<rsup|m>>|[><big|cap><around*|[|<frac|\<sigma\><rsub|i>|2<rsup|m>>,<frac|\<sigma\><rsub|i>+1|2<rsup|m>>|[>
    </equation>
    ...
    contradiction. So we must have that <math|<around*|[|<frac|\<rho\><rsub|i>|2<rsup|m>>,<frac|\<rho\><rsub|i>+1|2<rsup|m>>|[><big|cap><around*|[|<frac|\<sigma\><rsub|i>|2<rsup|m>>,<frac|\<sigma\><rsub|i>+1|2<rsup|m>>|[>=\<emptyset\>>
  ...
  <\lemma>
    ...
    <\enumerate>
      ...
      <math|a\<in\>\<bbb-R\><rsup|n>> then
      <math|\<mu\><around*|(|A+a|)>=\<mu\><around*|(|A|)>> [not that this
      make sense because of <reference|Borel sets in R^n are transaltion
      invariant>]\ 
    </enumerate>

    then there exists a <math|c\<gtr\>0> such that
    <math|\<mu\>=c\<cdot\><around*|(|\<lambda\><rsup|n>|)><rsub|\|\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>>>
    [or <math|\<forall\>A\<in\>\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>> we
  ...
  <\proof>
    ...
    <\eqnarray*>
      ...
      18.197.028>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<around*|(|<frac|1|2<rsup|m>>|)>\<less\><around*|(|1|)>>>|<cell|\<mu\><around*|(|<around*|[|0,1|[>|)><eq-number><label|eq
      18.198.028>>>>>
    </eqnarray*>

    As <math|\<bbb-R\><rsup|n>> is open we have by <reference|every open set
    in R^n is a countable union of dyadic cubes> that there exisrs a
    ...
    <math|\<mu\><around*|(|<around*|[|0,1|[><rsup|n>|)>=0> we have that
    <math|\<mu\><around*|(|D<rsub|i>|)>=0> so that
    ...
    <\eqnarray*>
      ...
      18.206.029>>,<reference|eq 18.207.029>>>|<cell|\<lambda\><rsup|n><around*|(|<around*|[|0,<frac|1|2<rsup|m>>|[><rsup|n>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
      18.197.028>>>>|<cell|\<lambda\><rsup|n><around*|(|<around*|[|<frac|z|2<rsup|m>>,<frac|z+1|2<rsup|m>>|[>|)>>>>>
    </eqnarray*>

    hence applying <reference|uniqueness of the Lebesgue measure> we have
    that <math|\<forall\>A\<in\>\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]> that
    \<nu\><around*|(|A|)>=\<lambda\><rsup|n><around*|(|A|)>> or

    <\equation*>
      \<forall\>A\<in\>\<cal-N\><around*|[|\<bbb-R\><rsup|n>|]><text| >
  ...
  <\proposition>
    ...
    the completion of <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>>.
  </proposition>
  ...
  <\lemma>
    Let <math|n\<in\>\<bbb-N\><rsub|0>> and <math|A\<in\>\<cal-L\><rsup|n>>
    [so <math|A> is Lebesgue measurable] then there exists
    <math|E,F\<in\>\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>> [so <math|E,F>
    are Borel sets] such that <math|A\<subseteq\>A\<subseteq\>F> and
    <math|\<mu\><around*|(|F\\E|)>=0>.
  </lemma>
...
<\references>
  <\collection>
    ...
    <associate|Borel measure space|<tuple|18.79|?>>
    <associate|Borel sets in R^n are transaltion invariant|<tuple|18.90|?>>
    <associate|Caratheodore|<tuple|18.65|?>>
    ...
    invariant|<tuple|18.88|?>>
    <associate|Lebesgue measurable sets alternatives|<tuple|18.78|?>>
    <associate|Lebesgue measure space|<tuple|18.71|?>>
    <associate|Lebesgue measure space on R^n|<tuple|18.76|?>>
    <associate|Lebesgue measure spaces are complete|<tuple|18.99|?>>
    <associate|Lower half spaces|<tuple|18.46|?>>
    <associate|R can be covered by open intervals|<tuple|18.68|?>>
    <associate|R^n is a unin of rectangles|<tuple|18.72|?>>
    <associate|[0,1[ as a union of Dyadic intervals|<tuple|18.91|?>>
    <associate|[0,1[^n as a union of half open rectangles|<tuple|18.92|?>>
    <associate|algebra equivalent definitions|<tuple|18.6|?>>
    <associate|algebra of sets|<tuple|18.5|?>>
    <associate|almost complete|<tuple|18.96|?>>
    <associate|alternative formule for lebesgue measure (1)|<tuple|18.81|?>>
    <associate|aproximate halfopen by open|<tuple|18.80|?>>
    ...
    <associate|auto-28|<tuple|18.3.4.1|?>>
    <associate|auto-29|<tuple|18.3.5|?>>
    <associate|auto-3|<tuple|18.2|?>>
    <associate|auto-30|<tuple|<with|mode|<quote|math>|\<mu\>>-negligible|?>>
    <associate|auto-31|<tuple|almost everyware|?>>
    ...
    <associate|complete measures|<tuple|18.97|?>>
    <associate|completion lemma|<tuple|18.100|?>>
    <associate|completion of a measure space|<tuple|18.102|?>>
    <associate|countable additivity implies additivity|<tuple|18.53|?>>
    ...
    <associate|eq 18.167.026|<tuple|18.208|?>>
    <associate|eq 18.167.027|<tuple|18.171|?>>
    <associate|eq 18.167.028|<tuple|18.167|?>>
    <associate|eq 18.168.026|<tuple|18.209|?>>
    <associate|eq 18.168.027|<tuple|18.176|?>>
    <associate|eq 18.168.028|<tuple|18.168|?>>
    <associate|eq 18.169.026|<tuple|18.210|?>>
    <associate|eq 18.169.027|<tuple|18.177|?>>
    <associate|eq 18.169.028|<tuple|18.169|?>>
    <associate|eq 18.17.021|<tuple|18.17|?>>
    <associate|eq 18.17.027|<tuple|18.186|?>>
    <associate|eq 18.170.026|<tuple|18.211|?>>
    <associate|eq 18.170.027|<tuple|18.178|?>>
    <associate|eq 18.170.028|<tuple|18.170|?>>
    <associate|eq 18.171.026|<tuple|18.212|?>>
    <associate|eq 18.171.027|<tuple|18.179|?>>
    <associate|eq 18.172.026|<tuple|18.213|?>>
    <associate|eq 18.172.027|<tuple|18.180|?>>
    <associate|eq 18.172.028|<tuple|18.172|?>>
    <associate|eq 18.173.026|<tuple|18.214|?>>
    <associate|eq 18.173.027|<tuple|18.181|?>>
    <associate|eq 18.173.028|<tuple|18.173|?>>
    <associate|eq 18.174.026|<tuple|18.215|?>>
    <associate|eq 18.174.027|<tuple|18.182|?>>
    <associate|eq 18.174.028|<tuple|18.174|?>>
    <associate|eq 18.175.026|<tuple|18.216|?>>
    <associate|eq 18.175.027|<tuple|18.183|?>>
    <associate|eq 18.175.028|<tuple|18.175|?>>
    <associate|eq 18.176.026|<tuple|18.217|?>>
    <associate|eq 18.176.027|<tuple|18.184|?>>
    <associate|eq 18.177.026|<tuple|18.218|?>>
    <associate|eq 18.177.027|<tuple|18.185|?>>
    <associate|eq 18.179.027|<tuple|18.187|?>>
    <associate|eq 18.18.021|<tuple|18.18|?>>
    <associate|eq 18.188.028|<tuple|18.193|?>>
    <associate|eq 18.189.028|<tuple|18.194|?>>
    <associate|eq 18.19.021|<tuple|18.19|?>>
    <associate|eq 18.190.028|<tuple|18.188|?>>
    <associate|eq 18.191.028|<tuple|18.189|?>>
    <associate|eq 18.192.028|<tuple|18.190|?>>
    <associate|eq 18.193.028|<tuple|18.191|?>>
    <associate|eq 18.194.028|<tuple|18.192|?>>
    <associate|eq 18.195.028|<tuple|18.195|?>>
    <associate|eq 18.196.028|<tuple|18.196|?>>
    <associate|eq 18.197.028|<tuple|18.202|?>>
    <associate|eq 18.197.029|<tuple|18.197|?>>
    <associate|eq 18.198.028|<tuple|18.203|?>>
    <associate|eq 18.198.029|<tuple|18.198|?>>
    <associate|eq 18.199.029|<tuple|18.199|?>>
    <associate|eq 18.2.014|<tuple|18.6|?>>
    <associate|eq 18.2.016|<tuple|18.2|?>>
    <associate|eq 18.20.021|<tuple|18.20|?>>
    <associate|eq 18.200.029|<tuple|18.200|?>>
    <associate|eq 18.201.029|<tuple|18.201|?>>
    <associate|eq 18.204.029|<tuple|18.205|?>>
    <associate|eq 18.206.029|<tuple|18.206|?>>
    <associate|eq 18.207.029|<tuple|18.207|?>>
    ...
    sets|<tuple|18.42|?>>
    <associate|half spaces are Lebesgue measurable in R^n|<tuple|18.77|?>>
    ...
    <associate|measurable set alternative definition|<tuple|18.63|?>>
    <associate|measurable sets and null sets|<tuple|18.64|?>>
    <associate|measurable space|<tuple|18.10|?>>
    <associate|measure|<tuple|18.51|?>>
    <associate|measure is subadditive|<tuple|18.56|?>>
    <associate|measure properties (1)|<tuple|18.54|?>>
    <associate|measure properties (2)|<tuple|18.57|?>>
    <associate|measureable set|<tuple|18.62|?>>
    <associate|negligibility|<tuple|18.94|?>>
    <associate|negligible set properties|<tuple|18.95|?>>
    <associate|open,half open and bounded intervals are
    different|<tuple|18.21|?>>
    <associate|outer measure|<tuple|18.59|?>>
    <associate|outer measure definition on rectangles|<tuple|18.74|?>>
    <associate|outer measure finite subadditivity|<tuple|18.60|?>>
    <associate|outer measure is translation invariant|<tuple|18.87|?>>
    <associate|outer measure on R|<tuple|18.70|?>>
    <associate|outer measure on rectangles|<tuple|18.75|?>>
    <associate|outermeasure construction|<tuple|18.61|?>>
    ...
    algebra|<tuple|18.52|?>>
    <associate|semi additivity of the length in the reals|<tuple|18.69|?>>
    ...
    <associate|translation properties|<tuple|18.85|?>>
    <associate|union intersection union of families|<tuple|18.2|?>>
    <associate|union,intersection and function between and
    indexes|<tuple|18.3|?>>
    <associate|uniqueness of the Lebesgue measure|<tuple|18.83|?>>
    <associate|volume in R^n|<tuple|18.32|?>>
    <associate|volume is increasing|<tuple|18.34|?>>
    <associate|volume is subadditive|<tuple|18.73|?>>
    <associate|volume is translation invariant|<tuple|18.86|?>>
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      ...
      <tuple|<tuple|<with|mode|<quote|math>|\<mu\>>-negligible>|<pageref|auto-30>>

      <tuple|<tuple|almost everyware>|<pageref|auto-31>>
