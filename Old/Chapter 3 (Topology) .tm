...
<\body>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <item>The function <math|<around*|\<langle\>||\<rangle\>>:\<bbb-C\>\<rightarrow\>\<bbb-C\>>
      defined by <math|<around*|\<langle\>|z|\<rangle\>>=z\<cdot\><wide|z|\<bar\>>=<around*|\||z|\|><rsup|2>
      > is continuous

      <item>Given <math|n\<in\>\<bbb-N\><rsub|0>>,
      <math|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>> the
      function <math|p\<cdot\><wide|p|\<bar\>>:\<bbb-C\>\<rightarrow\>\<bbb-C\>>
      ...
      <math|<around*|(|\<cdot\>z|)>:<around*|[|0,\<ldots\>,\<infty\>|[>\<rightarrow\>\<bbb-C\>>
      defined by <math|<around*|(|.z|)><around*|(|\<alpha\>|)>=\<alpha\>\<cdot\>z>
      is continuous

      <item>If <math|p:\<bbb-C\>\<rightarrow\>\<bbb-C\>> is a polynomial and
      <math|z\<in\>\<bbb-C\>> then <math|p<rsub|\<cdot\>z>:<around*|[|0,\<ldots\>,\<infty\>|[>\<rightarrow\>\<bbb-C\>>
  ...
  <\proof>
    ...
    <\equation>
      ...
      that >0\<leqslant\>x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\>\<delta\><rsup|k>\<cdot\><wide|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\<bar\>>+2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>
    </equation>
...
<\references>
  <\collection>
    ...
    <associate|auto-54|<tuple|12.114|377>>
    <associate|auto-55|<tuple|12.118|378>>
    ...
    <associate|constant functions are continuous|<tuple|12.114|377>>
    ...
    <associate|identity function is continuous|<tuple|12.115|377>>
    ...
    <associate|inverse of open map is continuous|<tuple|12.119|378>>
    ...
    <associate|norm and absolute value|<tuple|12.74|369>>
    ...
    <associate|open functions|<tuple|12.118|378>>
    ...
    <associate|sum of positive numbers is positive|<tuple|12.96|373>>
    ...
    <associate|triangle inequality of inner product norm|<tuple|12.103|375>>
