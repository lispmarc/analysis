...
<\body>
  ...
  <\note>
    A simple function is a function so if
  ...
  <\proposition>
    ...
    <math|\<forall\><around*|{|f<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-S\><around*|[|X|]>>
    such that <math|\<forall\>n\<in\>\<bbb-N\>>
    ...
    <math|<big|int><rsup|+>f d\<mu\>=<below|lim|n\<rightarrow\>\<infty\>><big|int><rsup|S>f<rsub|n>d\<mu\>\<equallim\><rsub|<text|>>sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\>|}>|)>>
  </proposition>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      which proves that <math|\<cal-A\><rsub|E>=<around*|{|A\<in\>\<cal-A\>\|A\<subseteq\>E|}>>

      <item>Note that by <smart-ref|subspace measure> for
      <math|A\<in\>\<cal-A\><rsub|E>> we have that
      <math|\<mu\><rsub|E><around*|(|A|)>=inf<around*|(|<around*|{|\<mu\><around*|(|B|)>\|B\<in\>\<cal-A\>\<wedge\>A\<subseteq\>B|}>|)>>.
      Now if <math|A\<in\>\<cal-A\><rsub|E>> then by (1)
      <math|A\<in\>\<cal-A\>> and <math|A\<subseteq\>E>. Now
      <math|\<forall\>B\<in\>\<cal-A\>> such that <math|A\<subseteq\>B> we
      have <math|A\<subseteq\>B>, hence <math|\<mu\><rsub|\|\<cal-A\><rsub|E>><around*|(|A|)>=\<mu\><around*|(|A|)>\<subseteq\>\<mu\><around*|(|B|)>>
      proving that <math|\<mu\><rsub|\|\<cal-A\><rsub|E>><around*|(|A|)>\<leqslant\>inf<around*|(|<around*|{|\<mu\><around*|(|B|)>\|B\<in\>\<cal-A\>\<wedge\>E\<subseteq\>B|}>|)>>.
      So we have\ 
      ...
      <math|A\<subseteq\>A> so that <math|\<mu\><around*|(|A|)>\<in\><around*|{|\<mu\><around*|(|B|)>\|B\<in\>\<cal-A\>\<wedge\>E\<subseteq\>B|}>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      set>] it follows that <math|A> is <math|\<mu\>>-negligible. Next if
      ...
      <math|F\<in\>\<cal-A\>> with <math|\<mu\><around*|(|F|)>> such that
      ...
      <\enumerate>
        ...
        <math|A\<in\>\<cal-A\><rsub|E>>, hence
        <math|A\<in\>\<cal-A\><rsub|E>> and <math|A\<subseteq\>F> proving
        that <math|A\<in\><around*|(|\<cal-A\><rsub|E>|)><rsub|F>>. So we
        have that\ 
  ...
  <\lemma>
    ...
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a set
    <math|E\<in\>\<cal-A\>> and <math|f:E\<rightarrow\>\<bbb-R\>>,
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|x\<in\><around*|(|X\\E|)><big|cup>F\<subseteq\>dom<around*|(|g<rsup|E>|)><big|cap>dom<around*|(|f<rsup|E>|)>>
  ...
  <\lemma>
    ...
    <\enumerate>
      ...
      if x\<in\>A>>|<row|<cell|0 if x\<in\>E\\A>>>>>> then
      <math|\<cal-X\><rsub|A>=<around*|(|\<cal-X\><rsub|E,A>|)><rsup|E>>
      where <math|\<cal-X\><rsub|A>:X\<rightarrow\>\<bbb-R\>> is defined by
      <math|\<cal-X\><rsub|A><around*|(|x|)>=<choice|<tformat|<table|<row|<cell|1
      if x\<in\>A>>|<row|<cell|0 if x\<in\>X\\A>>>>>>

      <item>If <math|f=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|E,A<rsub|i>>>
      then we have <math|f<rsup|E>=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>>>
    </enumerate>
  </lemma>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\description>
        ...
        <\description>
          <item*|<math|x\<in\>E\\A>>then <math|<around*|(|\<cal-X\><rsub|E,A>|)><rsup|E><around*|(|x|)>=0\<equallim\><rsub|x\<in\>X\\A>\<cal-X\><rsub|A><around*|(|x|)>>

          <item*|<math|x\<in\>A>>then <math|><math|<around*|(|\<cal-X\><rsub|E,A>|)><rsup|E><around*|(|x|)>=1=\<cal-X\><rsub|A><around*|(|x|)>>
        </description>
      </description>
      ...
      <\description>
        ...
        <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>
        A<rsub|i>\<subseteq\>E\<Rightarrow\>x\<in\>X\\A<rsub|i>> \ so that
        ...
        <math|f<rsup|E><around*|(|x|)>=f<around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|E,A<rsub|i>><around*|(|x|)>\<equallim\><rsub|<around*|(|1|)>><big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>>
      </description>

      proving that <math|f=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>>>
    </enumerate>
  </proof>
  ...
  <\lemma>
    ...
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be\ 
  </lemma>

  <\proposition>
    Let <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a
    measure space, <math|E\<in\>\<cal-A\>> and
    <math|f:E\<rightarrow\>\<bbb-R\>> a partial function then for
    <math|f<rsup|E>:X\<rightarrow\>\<bbb-R\>> we have that
    <math|f\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
  ...
  <\proof>
    We prove this in stages, first for simple functions. then non negative
    functions and finally the general case.<smart-ref|characteristics
    function>

    <\enumerate>
      <item>Let <math|f\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>> then
      there exists a representation <math|f=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|E,A<rsub|i>>>
      where <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
      <math|A<rsub|i>\<in\>\<cal-A\><rsub|E>,><math|\<mu\><rsub|E><around*|(|A<rsub|i>|)>\<less\>\<infty\>>
      and <math|\<cal-X\><rsub|E,A<rsub|i>>:E\<rightarrow\>\<bbb-R\>> is
      defined by <math|\<cal-X\><rsub|E,A<rsub|i>><around*|(|x|)>=<choice|<tformat|<table|<row|<cell|1
      ...
      To summarize we have, taking in account <smart-ref|integral of simple
      function extension> and <smart-ref|measure integral extension> that

      <\equation>
        <label|eq 18.339.008>\<forall\>f\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>
        we have f<rsup|E>\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]><infix-and><big|int>f
        d\<mu\><rsub|E>\<equallim\><big|int><rsup|S>f
        d\<mu\><rsub|E>=<big|int><rsup|S>f<rsup|E>d\<mu\>=<big|int>f<rsup|E>d\<mu\>
      </equation>

      <item>Let <math|f\<in\>\<cal-L\><rsub|+><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
      then by definition [see <smart-ref|positive integrable functions
      definition>] there exists a sequence
      <math|<around*|{|f<rsub|n>|}><rsub|n\<in\>\<bbb-N\>>\<subseteq\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
      such that <math|\<forall\>n\<in\>\<bbb-N\>>
      <math|0\<leqslant\>f<rsub|n>\<leqslant\>f<rsub|+1>>,
      <math|sup<around*|(|<big|int><rsup|S>f<rsub|n>d\<mu\><rsub|E>\|n\<in\>\<bbb-N\>|)>\<less\>\<infty\>>
      and <math|f=<rsub|a.e.><below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>>
      [meaning that <math|F=<around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)>\|<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><around*|(|x|)>=f<around*|(|x|)>|}>>
      is <math|\<mu\><rsub|E>>-conegligble [see <smart-ref|a.e. relations>]].
      Using <smart-ref|eq 18.339.008> we have that\ 

      <\equation>
        <label|eq 18.340.008><around*|{|f<rsup|E><rsub|n>|}><rsub|n\<in\>\<bbb-N\>>\<subseteq\>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>
      </equation>

      Further let <math|n\<in\>\<bbb-N\>> then if <math|x\<in\>X> we have
      that <math|f<rsub|n><rsup|E><around*|(|x|)>=<choice|<tformat|<table|<row|<cell|0
      if x\<in\>X\\E>>|<row|<cell|f<rsub|n><around*|(|x|)> if
      x\<in\>dom<around*|(|f<rsub|n>|)>=E>>>>>\<leqslant\><choice|<tformat|<table|<row|<cell|0
      if x\<in\>X\\E >>|<row|<cell|f<rsub|n+1><around*|(|x|)> if
      x\<in\>dom<around*|(|f<rsub|n+1>|)>=E>>>>>=f<rsub|n+1><rsup|E><around*|(|x|)>>
      proving that\ 

      <\equation>
        <label|eq 18.341.008>\<forall\>n\<in\>\<bbb-N\> we have
        0\<leqslant\>f<rsup|E><rsub|n>\<leqslant\>f<rsup|E><rsub|n+1>
      </equation>

      Next\ 

      <\equation>
        <label|eq 18.342.008>sup<around*|(|<around*|{|<big|int><rsup|S>f<rsup|E><rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)>\<equallim\><rsub|<text|<smart-ref|eq
        18.339.008>>>sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\><rsub|E>\|n\<in\>\<bbb-N\>|}>|)>\<less\>\<infty\>
      </equation>

      Now for <math|f<rsup|E>:X\<rightarrow\>\<bbb-R\>> we have
      <math|f<rsup|E><around*|(|x|)>=<choice|<tformat|<table|<row|<cell|0
      \ if x\<in\>X\\E>>|<row|<cell|f<around*|(|x|)> if
      x\<in\>dom<around*|(|f|)>>>>>>>with
      <math|dom<around*|(|f<rsup|E>|)>=<around*|(|X\\E|)><big|cup>dom<around*|(|f|)>>.
      ...
      <\description>
        ...
        exists and <math|0=<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n><around*|(|x|)>>

        <item*|<math|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)>>>then
        as <math|f<rsup|E><rsub|n><around*|(|x|)>=f<rsub|n><around*|(|x|)>>
        <math|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n><around*|(|x|)>>
        exists and <math|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n><around*|(|x|)>=<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>>
      </description>

      which proves that\ 

      <\equation>
        <label|eq 18.343.008>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><big|sqcup><around*|(|X\\E|)>\<subseteq\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n>|)>\<wedge\>\<forall\>x\<in\><around*|(|X\\E|)><big|cup><around*|(|X\\E|)>
        <text|we have> <around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n>|)><around*|(|x|)>=<choice|<tformat|<table|<row|<cell|0
        if x\<in\>X\\E>>|<row|<cell|<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><around*|(|x|)>
        if x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)>>>>>>
      </equation>

      Further if <math|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n>|)>\<equallim\><rsub|<text|<smart-ref|limit
      of simple functions>>><around*|{|x\<in\>X\|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n><around*|(|x|)>
      exists|}>> then either\ 
      ...
      <\description>
        ...
        <math|f<rsub|n><around*|(|x|)>=f<rsup|E><rsub|n><around*|(|x|)>>,
        hence it follows that <math|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>>
      ...
      Combining the above with <smart-ref|eq 18.343.008> proves\ 

      <\equation>
        <label|eq 18.344.008>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n>|)>=dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><big|sqcup><around*|(|X\\E|)>\<wedge\>\<forall\>x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n>|)>
        <text|we have> <around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n>|)><around*|(|x|)>=<choice|<tformat|<table|<row|<cell|0
        if x\<in\>X\\E>>|<row|<cell|<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><around*|(|x|)>
        if x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)>>>>>>
      </equation>
      ...
      the set <math|F=<around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)>\|f<around*|(|x|)>=<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><around*|(|x|)>|}>>
      is <math|\<mu\><rsub|E>>-conegligible and
      <math|F\<subseteq\>dom<around*|(|f|)><big|cap>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)>\<subseteq\>E>
      hence by <smart-ref|conegligible of subspace> (1) <math|F> is
      <math|\<mu\>>-negligible. Hence as <math|F\<subseteq\>F<big|cup><around*|(|X\\A|)>>
      we have using <smart-ref|conegligible sets properties> that
      <math|F<big|cup><around*|(|X\\A|)>> is <math|\<mu\>>-conegligble. Now
      if <math|x\<in\>F<big|cup><around*|(|X\\E|)>> we have either [as
      <math|F\<subseteq\>E>]

      <\description>
        <item*|<math|x\<in\>X\\E>><math|f<rsup|E><around*|(|x|)>=0\<equallim\><rsub|<text|<smart-ref|eq
        18.344.008>>><around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n>|)><around*|(|x|)><rsub|>>

        <item*|<math|x\<in\>F>><math|f<rsup|E><around*|(|x|)>\<equallim\><rsub|F\<subseteq\>dom<around*|(|f|)>>f<around*|(|x|)>=<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><around*|(|x|)>\<equallim\><rsub|f\<subseteq\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)>
        <infix-and><text|<smart-ref|eq 18.344.008>>><around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n>|)><around*|(|x|)>>
      </description>

      So <math|\<forall\>x\<in\><around*|(|X\\E|)><big|cup>F> we have
      <math|f<rsup|E><around*|(|x|)>=<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n>|)><around*|(|x|)>>
      which as <math|<around*|(|X\\E|)><big|cup>F> is
      <math|\<mu\>>-conegligible proves:\ 

      <\equation>
        <label|eq 18.345.008>f<rsup|E>=<rsub|a.e.<around*|[|\<mu\>|]>><around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsup|E><rsub|n>|)>
      </equation>

      The conditions for a positive integrable function [see
      <reference|positive integrable functions definition>] are now satisfied
      by the definition of <math|f<rsup|E>>, <smart-ref|eq
      18.340.008>,<smart-ref|eq 18.341.008>,<smart-ref|eq 18.342.008> and
      <smart-ref|eq 18.345.008>, so we have\ 

      <\equation>
        <label|eq 18.347.008.2>f<rsup|E>\<in\>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>
      </equation>

      Let <math|g\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>> then if
      <math|x\<in\><around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|g<around*|(|x|)>\<leqslant\>f<around*|(|x|)>|}>>
      then <math|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\<subseteq\><around*|(|dom<around*|(|f|)><big|cup><around*|(|X\\E|)>|)><big|cap><around*|(|dom<around*|(|g|)><big|cup><around*|(|X\\E|)>|)>>
      and <math|g<around*|(|x|)>\<leqslant\>f<around*|(|x|)>\<Rightarrow\>g<rsup|E><around*|(|x|)>=<choice|<tformat|<table|<row|<cell|0
      if x\<in\>X\\E>>|<row|<cell|g<around*|(|x|)> if
      x\<in\>dom<around*|(|g|)>>>>>>\<leqslant\><choice|<tformat|<table|<row|<cell|0
      if x\<in\>X\\E>>|<row|<cell|f<around*|(|x|)> if
      x\<in\>dom<around*|(|f|)>>>>>>=f<rsup|E><around*|(|x|)>> proving that
      <math|x\<in\><around*|{|x\<in\>dom<around*|(|f<rsup|E>|)><big|cap>dom<around*|(|g<rsup|E>|)>\|g<rsup|E><around*|(|x|)>\<leqslant\>f<rsup|E><around*|(|x|)>|}>>.
      Hence

      <\equation>
        <label|eq 18.347.008>\<forall\>g\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>
        that <around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|g<around*|(|x|)>\<leqslant\>f<around*|(|x|)>|}>\<subseteq\><around*|{|x\<in\>dom<rsup|E><around*|(|f|)><big|cap>dom<around*|(|g<rsup|E>|)>\|g<rsup|E><around*|(|x|)>\<leqslant\>f<rsup|E><around*|(|x|)>|}>
      </equation>

      If now <math|g\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f>
      then using <smart-ref|g\<less\>=f=\<gtr\>g^E\<less\>f^E> we have that
      <math|g<rsup|E>\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f<rsup|E>>
      where <math|g<rsup|E>\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>> by
      <smart-ref|eq 18.339.008>]. So we have\ 

      <\equation>
        <label|eq 18.348.008>\<forall\>g\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>
        with g\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f we have
        g<rsup|E>\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f<rsup|E>
      </equation>

      From this it follows that <math|<around*|{|<big|int><rsup|S>g
      d\<mu\><rsub|E>\|g\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>\<wedge\>g\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f|}>\<equallim\><rsub|<text|<smart-ref|eq
      18.339.008>>>><math|<around*|{|<big|int><rsup|S>g<rsup|E>
      d\<mu\>\|g\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>\<wedge\>g\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f|}>\<subseteq\><rsub|<text|<smart-ref|eq
      18.348.008>>><around*|{|<big|int><rsup|S>g
      d\<mu\>\|g\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>\<wedge\>g\<leqslant\><rsub|a.e.>f<rsup|E>|}>>,
      hence <math|<big|int><rsup|+>f d\<mu\><rsub|E>\<equallim\><rsub|def>sup<around*|(|<around*|{|<big|int><rsup|S>g
      d\<mu\><rsub|E>\|g\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>\<wedge\>g\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f|}>|)>\<leqslant\>sup<around*|(|<around*|{|<big|int><rsup|S>g
      d\<mu\>\|g\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>\<wedge\>g\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f<rsup|E>|}>|)>=<big|int><rsup|+>f<rsup|E>
      d\<mu\>>. This proves using the definition of <math|<big|int><rsup|+>>
      that

      <\equation>
        <label|eq 18.349.008><big|int><rsup|+>f
        d\<mu\><rsub|E>\<leqslant\><big|int><rsup|+>f<rsup|E>d\<mu\>
      </equation>

      For the opposite inequality take <math|I\<in\><around*|{|<big|int><rsup|S>g
      d\<mu\>\|g\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>\<wedge\>g\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f<rsup|E>|}>>
      then there exists a <math|g\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>>
      such that <math|g\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f<rsup|E>>
      with <math|I=<big|int><rsup|S>g d\<mu\>>. As
      <math|g\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>> there exists a
      representation <math|<big|sum><rsub|i=1><rsup|\<infty\>>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>>>
      of <math|g> where <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
      <math|A<rsub|i>\<in\>\<cal-A\>> and
      <math|\<mu\><around*|(|A<rsub|i>|)>\<less\>\<infty\>>. Define now
      <math|g<rsub|E>=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i><big|cap>E>>
      then as <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
      <math|A<rsub|i><big|cap>E\<in\>\<cal-A\><rsub|E>> and
      <math|\<mu\><rsub|<around*|\||\<Epsilon\>|\<nobracket\>>><around*|(|A<rsub|i><big|cap>E|)>=\<mu\><around*|(|A<rsub|i><big|cap>E|)>\<leqslant\>\<mu\><around*|(|A<rsub|i>|)>\<less\>\<infty\>>
      [see <smart-ref|subspace based on a measurable set>] we have that

      <\equation>
        <label|eq 18.350.008>g<rsub|E>\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>.
      </equation>

      As <math|g\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f<rsup|E>> we have
      that <math|G=<around*|{|x\<in\>dom<around*|(|f<rsup|E>|)><big|cap>dom<around*|(|g|)>\|g<around*|(|x|)>\<leqslant\>f<rsup|E><around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible. Take now <math|x\<in\>G> then we have
      either:

      <\description>
        <item*|<math|x\<in\>G\\E>>then <math|g<around*|(|x|)>\<leqslant\>f<rsup|E><around*|(|x|)>=0=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i><big|cap>E><around*|(|x|)>=g<rsub|E><around*|(|x|)>>

        <item*|<math|x\<in\>G<big|cap>E>>then
        <math|g<rsub|E><around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i><big|cap>E><around*|(|x|)>\<equallim\><rsub|<text|<smart-ref|characteristics
        function properties>>><big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>\<cdot\>\<cal-X\><rsub|E><around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>=g<around*|(|x|)>\<leqslant\>f<around*|(|x|)>>
      </description>

      which as <math|G> is <math|\<mu\>>-conegligible proves that

      <\equation>
        <label|eq 18.351.008>g<rsub|E>=<rsub|a.e.<around*|[|\<mu\>|]>>g<infix-and>\<forall\>x\<in\>G<big|cap>E
        that g<rsub|E><around*|(|x|)>=g<around*|(|x|)>\<leqslant\>f<around*|(|x|)>
      </equation>

      hence

      <\eqnarray*>
        <tformat|<table|<row|<cell|<big|int><rsup|S>g<rsub|E>d\<mu\><rsub|E>>|<cell|\<equallim\><rsub|def>>|<cell|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<mu\><rsub|E><around*|(|A<rsub|i><big|cap>E|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<smart-ref|subspace
        based on a measurable set>>>>|<cell|<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>\<mu\><around*|(|A<rsub|i><big|cap>E|)>>>|<row|<cell|>|<cell|=>|<cell|<big|int><rsup|S>g<rsub|E>d\<mu\>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<smart-ref|integral
        of simple function extension> and <smart-ref|measure integral
        extension>>>>|<cell|<big|int>g<rsub|e>d\<mu\>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<smart-ref|measure
        integral properties (2)>(4) and <smart-ref|eq
        18.351.008>>>>|<cell|<big|int>g d\<mu\>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<smart-ref|integral
        of simple function extension> and <smart-ref|measure integral
        extension>>>>|<cell|<big|int><rsup|S>g d\<mu\>=I<eq-number><label|eq
        18.352.008>>>>>
      </eqnarray*>

      Further for <math|x\<in\>G<big|cap>E> [a
      <math|\<mu\><rsub|E>>-conegligible set by <smart-ref|conegligible of
      subspace>] we have <math|g<rsub|E><around*|(|x|)>\<leqslant\>f<around*|(|x|)>>
      so that\ 

      <\equation>
        <label|eq 18.353.008>g<rsub|E>\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f
      </equation>

      Using <smart-ref|eq 18.350.008>,<smart-ref|eq 18.352.008> and
      <smart-ref|eq 18.353.008> it follows that
      <math|I\<in\><around*|{|<big|int><rsup|S>g
      d\<mu\>\|g\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>\<wedge\>g\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f|}>>
      proving that <math|<around*|{|<big|int><rsup|S>g
      d\<mu\><around*|\||g\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>\<wedge\>g\<leqslant\>f<rsup|E>|\<nobracket\>>|}>\<subseteq\><around*|{|<big|int><rsup|S>g
      d\<mu\><rsub|E>\|g\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>\<wedge\>g\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f|}>>
      so that <math|<big|int><rsup|+>f<rsup|E>d\<mu\>=sup<around*|(|<around*|{|<big|int><rsup|S>g
      d\<mu\><around*|\||g\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>\<wedge\>g\<leqslant\>f<rsup|E>|\<nobracket\>>|}>|)>\<leqslant\>sup<around*|(|<around*|{|<big|int><rsup|S>g
      d\<mu\><rsub|E>\|g\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>\<wedge\>g\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f|}>|)>=<big|int><rsup|+>f
      d\<mu\>>. This together with <smart-ref|eq 18.347.008.2> and
      <smart-ref|eq 18.349.008> proves that\ 

      <\equation>
        <label|eq 18.355.008>\<forall\>f\<in\>\<cal-L\><rsub|+><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>
        we have that f<rsup|E>\<in\>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>
        <infix-and><big|int><rsup|+>f d\<mu\><rsub|E>=<big|int><rsup|+>f<rsup|E>d\<mu\>
      </equation>

      <item>Let <math|f\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
      then <math|f=f<rsub|1>-f<rsub|2>> where
      <math|f<rsub|1>,f<rsub|2>\<in\>\<cal-L\><rsub|+><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
      and <math|<big|int>f d\<mu\><rsub|E>\<equallim\><rsub|def><big|int><rsup|+>f<rsub|1>d\<mu\><rsub|E>-<big|int><rsup|+>f<rsub|2>d\<mu\><rsub|E>>.
      Using <smart-ref|eq 18.355.008> we have then that
      <math|f<rsup|E><rsub|1>,f<rsup|E><rsub|2>\<in\>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>>
      and <math|<big|int><rsup|+>f<rsub|1>d\<mu\><rsub|E>=<big|int><rsup|+>f<rsub|1><rsup|E>d\<mu\>>,
      <math|<big|int><rsup|+>f<rsup|E><rsub|2>d\<mu\>>. Now as for
      <math|x\<in\><around*|(|dom<around*|(|f<rsub|1>|)><big|cap>dom<around*|(|f<rsub|1>|)>|)><big|cup><around*|(|X\\E|)>=dom<around*|(|f|)><big|cup><around*|(|X\\E|)>=dom<around*|(|f<rsup|E>|)>>
      we have that <math|f<rsup|E><around*|(|x|)>=<choice|<tformat|<table|<row|<cell|0
      if x\<in\>X\\A>>|<row|<cell|f<around*|(|x|)> if
      x\<in\>dom<around*|(|f|)>=dom<around*|(|f<rsub|1>|)><big|cap>dom<around*|(|f<rsub|2>|)>>>>>>=<choice|<tformat|<table|<row|<cell|0
      if x\<in\>X\\E>>|<row|<cell|f<rsub|1><around*|(|x|)> if
      x\<in\>dom<around*|(|f|)>\<subseteq\>dom<around*|(|f<rsub|1>|)>>>>>>=<choice|<tformat|<table|<row|<cell|0
      if x\<in\>X\\E>>|<row|<cell|f<rsub|2><around*|(|x|)> if
      x\<in\>dom<around*|(|f|)>\<subseteq\>dom<around*|(|f<rsub|2>|)>>>>>>=f<rsub|1><rsup|E><around*|(|x|)>-f<rsub|2><rsup|E><around*|(|x|)>>
      proving as <math|dom<around*|(|f<rsup|E><rsub|1>|)><big|cap>dom<around*|(|f<rsup|E><rsub|2>|)>=<around*|(|dom<around*|(|f<rsub|1>|)><big|cap>dom<around*|(|f<rsub|2>|)>|)><big|cup><around*|(|X\\E|)>>
      that <math|f<rsup|E>=f<rsub|1><rsup|E>-f<rsup|E><rsub|2>>. Hence we
      have by definition that

      <\equation>
        <label|eq 18.355.008.1>f<rsup|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>
      </equation>

      and <math|<big|int>f<rsup|E>d\<mu\>=<big|int><rsup|+>f<rsup|E><rsub|1>d\<mu\>-<big|int><rsup|+>f<rsub|2><rsup|E>d\<mu\>=<big|int><rsup|+>f<rsub|1>d\<mu\><rsub|E>-<big|int><rsup|+>f<rsub|2>d\<mu\><rsub|E>=<big|int>f
      d\<mu\><rsub|E>> giving

      <\equation>
        <label|eq 18.356.008.1><big|int>f<rsup|E>d\<mu\>=<big|int>f
        d\<mu\><rsub|E>
      </equation>
      ...
      <\equation>
        <label|eq 18.357.008.3>\<forall\>f\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>
        we have f<rsup|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]><infix-and><big|int>f<rsup|E>d\<mu\>=<big|int>f
        d\<mu\><rsub|E>
      </equation>

      <item>Suppose now that <math|f<rsup|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
      then using <smart-ref|measure integral and absolute value> there exists
      a <math|\<mu\>>-conegligible set <math|F\<subseteq\>X> such that
      ...
      properties> a <math|\<mu\>>-conegligible set <math|G\<in\>\<cal-A\>>
      such that <math|G\<subseteq\>F<big|cap>dom<around*|(|f<rsup|E>|)>>,
      further as <math|<around*|(|f<rsup|E>|)><rsub|\|F>> is
      <math|\<cal-A\>>-measurable we have by <smart-ref|measurable function
      operations> (7) that <math|<around*|(|<around*|(|f<rsup|E>|)><rsub|\|F>|)><rsub|G>>
      is <math|\<cal-A\>>-measurable which as
      <math|<around*|(|<around*|(|f<rsup|E>|)><rsub|\|F>|)><rsub|G>\<equallim\><rsub|G\<subseteq\>F<infix-and><text|<smart-ref|restriction
      of restricted function>>><around*|(|f<rsup|E>|)><rsub|\|G>>.\ 

      <\equation>
        <label|eq 18.357.008>\<exists\>G\<in\>\<cal-A\> such that G is
        \<mu\>-conegligible \ G\<subseteq\>dom<around*|(|f<rsup|E>|)><infix-and><around*|(|f<rsup|E>|)><rsub|\|G
        > is \<cal-A\><text|-measurable>
      </equation>

      Using <smart-ref|conegligible of subspace> we have that
      <math|E<big|cap>G is \<mu\><rsub|E><text|-conegligble>>, further as
      <math|dom<around*|(|f<rsup|E>|)>=dom<around*|(|f|)><big|cup><around*|(|X\\E|)>>
      we have that <math|E<big|cap>G\<subseteq\><around*|(|dom<around*|(|f|)><big|cup><around*|(|X\\E|)>|)><big|cap>E=dom<around*|(|f|)>>.
      To summarize we have

      <\equation>
        <label|eq 18.358.008>E<big|cap>G is
        \<mu\><rsub|E><text|-conegligble>,E<big|cap>G\<in\>\<cal-A\><rsub|E>
        <around*|[|as G\<in\>\<cal-A\>|]> and
        E<big|cap>G\<subseteq\>dom<around*|(|f|)>
      </equation>

      Next let <math|a\<in\>\<bbb-R\>> then\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\><around*|{|a\<leqslant\>f<rsub|\|E<big|cap>G>|}>>|<cell|\<Rightarrowlim\>>|<cell|x\<in\><around*|(|E<big|cap>G|)><big|cap>dom<around*|(|f|)>\<wedge\>a\<leqslant\>f<around*|(|x|)>>>|<row|<cell|>|<cell|\<Rightarrow\>>|<cell|x\<in\>E<big|cap>G\<wedge\>a\<leqslant\>f<around*|(|x|)>>>|<row|<cell|>|<cell|\<Rightarrowlim\><rsub|x\<nin\>X\\E>>|<cell|x\<in\>E<big|cap>G\<wedge\>a\<leqslant\>f<rsup|E><around*|(|x|)>>>|<row|<cell|>|<cell|\<Rightarrow\>>|<cell|x\<in\>E<big|cap>dom<around*|(|f<rsup|E>|)><rsub|\|G>\<wedge\>a\<leqslant\><around*|(|f<rsup|E>|)><rsub|\|G><around*|(|x|)>>>|<row|<cell|>|<cell|\<Rightarrow\>>|<cell|x\<in\>E<big|cap><around*|{|a\<leqslant\><around*|(|f<rsup|E>|)><rsub|\|G>|}>>>|<row|<cell|x\<in\>E<big|cap><around*|{|a\<leqslant\><around*|(|f<rsup|E>|)><rsub|\|G>|}>>|<cell|\<Rightarrow\>>|<cell|x\<in\>E<big|cap>dom<around*|(|f<rsup|E>|)><rsub|\|G>\<wedge\>a\<leqslant\><around*|(|f<rsup|E>|)><rsub|\|G><around*|(|x|)>>>|<row|<cell|>|<cell|\<Rightarrowlim\><rsub|x\<nin\>X\\E\<wedge\>x\<in\>G>>|<cell|x\<in\>E<big|cap>G\<wedge\>dom<around*|(|f|)>\<wedge\>a\<leqslant\>f<around*|(|x|)>>>|<row|<cell|>|<cell|\<Rightarrow\>>|<cell|x\<in\><around*|{|a\<leqslant\>f<rsub|\|E<big|cap>G>|}>>>>>
      </eqnarray*>

      proving that <math|<around*|{|a\<leqslant\>f<rsub|\|E<big|cap>G>|}>=E<big|cap><around*|{|a\<leqslant\><around*|(|f<rsup|E>|)><rsub|\|G>|}>\<in\>\<cal-A\><rsub|E>>
      [as <math|<around*|(|f<rsup|E>|)><rsub|\|G >> is
      <math|\<cal-A\>>-measurable so that
      <math|<around*|{|a\<leqslant\><around*|(|f<rsup|E>|)><rsub|\|G>|}>\<in\>\<cal-A\>>].
      Hence\ 

      <\equation>
        <label|eq 18.359.008>f<rsub|\|E<big|cap>G> is
        \<cal-A\><rsub|E><text|-measurable><infix-and>by
        <smart-ref|measurable function operations> <around*|(|8|)>
        <around*|\||f<rsub|\|E<big|cap>G>|\|> is
        \<cal-A\><rsub|E><text|-measurable>
      </equation>

      Further we have for <math|a\<in\>\<bbb-R\>>

      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\><around*|{|a\<leqslant\><around*|\||f<rsub|\|E<big|cap>G>|\|>|}>>|<cell|\<Rightarrow\>>|<cell|x\<in\>dom<around*|(|<around*|\||f<rsub|\|E<big|cap>G>|\|>|)>\<wedge\>a\<leqslant\><around*|\||f<rsub|\|E<big|cap>G><around*|(|x|)>|\|>>>|<row|<cell|>|<cell|\<Rightarrow\>>|<cell|x\<in\>dom<around*|(|<around*|\||f<rsub|\|E<big|cap>G>|\|>|)><big|cup><around*|(|X\\E|)>\<wedge\>a\<leqslant\><around*|\||f<rsub|\|E<big|cap>G><around*|(|x|)>|\|>>>|<row|<cell|>|<cell|\<Rightarrow\>>|<cell|x\<in\>dom<around*|(|<around*|\||f<rsub|\|E<big|cap>G>|\|>|)><big|cup><around*|(|X\\E|)>\<wedge\>a\<leqslant\><around*|\||f<around*|(|x|)>|\|>>>|<row|<cell|>|<cell|\<Rightarrowlim\><rsub|dom<around*|(|<around*|\||f<rsub|\|E<big|cap>G>|\|>|)>\<subseteq\>E<big|cap>G\<Rightarrow\>x\<nin\>X\\E>>|<cell|x\<in\>dom<around*|(|<around*|\||f<rsub|\|E<big|cap>G>|\|>|)><big|cup><around*|(|X\\E|)>\<wedge\>a\<leqslant\><around*|\||f<rsup|E><around*|(|x|)>|\|>>>|<row|<cell|>|<cell|\<Rightarrow\>>|<cell|x\<in\><around*|{|a\<leqslant\><around*|\||f<rsup|E>|\|>|}>>>>>
      </eqnarray*>

      proving that

      <\equation>
        <label|eq 18.360.008>\<forall\>a\<in\>\<bbb-R\> we have
        <around*|{|a\<leqslant\><around*|\||f<rsub|\|E<big|cap>G>|\|>|}>\<subseteq\><around*|{|a\<leqslant\><around*|\||f<rsup|E>|\|>|}>
      </equation>

      As by <smart-ref|eq 18.359.008> <math|<around*|\||f<rsub|\|E<big|cap>G>|\|>>
      is <math|\<cal-A\><rsub|E>>-measurable we have
      ...
      it follows from <smart-ref|measure integral and absolute value> (3)
      that <math|<around*|\||f<rsup|E>|\|>\<in\>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>>
      ...
      <\equation>
        <label|eq 18.361.008>\<forall\>\<varepsilon\>\<gtr\>0 that
        \<mu\><around*|(|<around*|{|\<varepsilon\>\<leqslant\><around*|\||f<rsub|\|E<big|cap>G>|\|>|}>|)>\<leqslant\><rsub|<text|<smart-ref|eq
        18.360.008> and <smart-ref|measure space
      ...
      so that <math|H=<around*|{|x\<in\>dom<around*|(|g|)><big|cap>dom<around*|(|<around*|\||f|\|>|)>\|g<around*|(|x|)>\<leqslant\><around*|\||f<around*|(|x|)>|\|>|}>>
      is <math|\<mu\><rsub|E>>-conegligible. As <math|dom<around*|(|g|)>=X>
      we have that <math|H=<around*|{|x\<in\>dom<around*|(|<around*|\||f|\|>|)>\|g<around*|(|x|)>\<leqslant\><around*|\||f<around*|(|x|)>|\|>|}>\<subseteq\>dom<around*|(|<around*|\||f|\|>|)>=dom<around*|(|f|)>\<subseteq\>E>
      so using <smart-ref|conegligible of subspace> (1) we have that <math|H>
      is <math|\<mu\>>-negligible. Now for <math|x\<in\>H> we have
      <math|g<rsup|E><around*|(|x|)>\<equallim\><rsub|x\<nin\>X\\E>g<around*|(|x|)>\<leqslant\><around*|\||f<around*|(|x|)>|\|>\<equallim\><rsub|x\<nin\>X\\E><around*|\||f<rsup|E><around*|(|x|)>|\|>>
      which proves that <math|g<rsup|E>\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>><around*|\||f<rsup|E>|\|>>.
      Further as <math|<big|int>g d\<mu\><rsub|E>\<equallim\><rsub|<text|<smart-ref|eq
      18.339.008>>><big|int>g<rsup|E>d\<mu\>\<leqslant\><rsub|<text|<smart-ref|measure
      integral properties (1)> (4)>><big|int><around*|\||f<rsup|E>|\|>d\<mu\>>
      we have that\ 

      <\equation>
        <label|eq 18.362.008>sup<around*|(|<around*|{|<big|int>g
        d\<mu\><rsub|E>\|g\<in\>S<around*|[|E,\<cal-A\><rsub|E>|]>\<wedge\>g\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>><around*|\||f|\|>|}>|)>\<leqslant\><big|int><around*|\||f<rsup|E>|\|>d\<mu\>\<less\>\<infty\>
      </equation>

      Now <smart-ref|eq 18.358.008>,<smart-ref|eq 18.359.008> and
      <smart-ref|eq 18.362.008> allows us to apply <smart-ref|positive
      integrable function alternative> (1) proving that
      <math|<around*|\||f|\|>\<in\>\<cal-L\><rsub|+><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>.
      Finally using <smart-ref|measure integral and absolute value>(3)
      togehter with <smart-ref|eq 18.359.008> proves that\ 

      <\equation>
        <label|eq 18.364.008>f\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\>|]>
      </equation>
    </enumerate>

    The theroem is now proved by <smart-ref|eq 18.357.008.3> and
    <smart-ref|eq 18.364.008>.
  </proof>
...
<\references>
  <\collection>
    ...
    <associate|characteristics function on a set|<tuple|18.155|?>>
    ...
    <associate|eq 18.339.008|<tuple|18.339|?>>
    <associate|eq 18.34.001|<tuple|18.45|732>>
    <associate|eq 18.340.008|<tuple|18.340|?>>
    <associate|eq 18.341.008|<tuple|18.341|?>>
    <associate|eq 18.342.008|<tuple|18.342|?>>
    <associate|eq 18.343.008|<tuple|18.343|?>>
    <associate|eq 18.344.008|<tuple|18.344|?>>
    <associate|eq 18.345.008|<tuple|18.345|?>>
    <associate|eq 18.347.008|<tuple|18.347|?>>
    <associate|eq 18.347.008.2|<tuple|18.346|?>>
    <associate|eq 18.348.008|<tuple|18.348|?>>
    <associate|eq 18.349.008|<tuple|18.349|?>>
    <associate|eq 18.35.001|<tuple|18.46|732>>
    <associate|eq 18.350.008|<tuple|18.350|?>>
    <associate|eq 18.351.008|<tuple|18.351|?>>
    <associate|eq 18.352.008|<tuple|18.352|?>>
    <associate|eq 18.353.008|<tuple|18.353|?>>
    <associate|eq 18.355.008|<tuple|18.354|?>>
    <associate|eq 18.355.008.1|<tuple|18.355|?>>
    <associate|eq 18.356.008.1|<tuple|18.356|?>>
    <associate|eq 18.357.008|<tuple|18.358|?>>
    <associate|eq 18.357.008.3|<tuple|18.357|?>>
    <associate|eq 18.358.008|<tuple|18.359|?>>
    <associate|eq 18.359.008|<tuple|18.360|?>>
    <associate|eq 18.36.001|<tuple|18.47|732>>
    <associate|eq 18.360.008|<tuple|18.361|?>>
    <associate|eq 18.361.008|<tuple|18.362|?>>
    <associate|eq 18.362.008|<tuple|18.363|?>>
    <associate|eq 18.364.008|<tuple|18.364|?>>
    ...
    <associate|extension of positive integrable function|<tuple|18.157|?>>
    <associate|extension of simple function|<tuple|18.156|?>>
    <associate|g\<less\>=f=\<gtr\>g^E\<less\>f^E|<tuple|18.154|?>>
