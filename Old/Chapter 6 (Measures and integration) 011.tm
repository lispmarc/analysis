...
<\body>
  ...
  <\proof>
    ...
    <\equation>
      ...
      <around*|(|\<cal-X\><rsub|A>|)><rsub|\|E>=\<frak-X\><rsub|E,A<big|cap>E>
    </equation>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <item>If <math|0\<leqslant\><rsub|a.e.>f> then by
      <smart-ref|a\<less\>=a.e.f=\<gtr\>a\<less\>=a.e.f\|E> we have that
      <math|0\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f<rsub|\|E>>
      <math|\<forall\>E\<in\>\<cal-A\>>.TODO
    </enumerate>
...
<\references>
  <\collection>
    ...
    <associate|eq 18.359.010|<tuple|18.360|?>>
