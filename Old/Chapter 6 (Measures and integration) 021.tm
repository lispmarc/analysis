...
<\body>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      we have <math|a\<less\>x\<less\>b+<frac|1|n>> it follows that
      ...
      <\equation>
        <label|eq 18.10.020><around*|[|a,b|]>\<subseteq\><big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|a-<frac|1|n>,b+<frac|1|n>|[>
      </equation>
      ...
      which together with <reference|eq 18.10.020> proves\ 
      ...
      <\equation>
        <label|eq 18.11.020><around*|]|-\<infty\>,a|]>\<subseteq\><big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|-\<infty\>,a+<frac|1|n>|[>
      </equation>
      ...
      which together with <reference|eq 18.11.020>
      ...
      <\equation>
        <label|eq 18.12.020><around*|[|a,\<infty\>|[>\<subseteq\><big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|a-<frac|1|n>,\<infty\>|[>
      </equation>
      ...
      which together with <reference|eq 18.12.020> <math|>proves that
      ...
      <\equation>
        <around*|]|a,b|[>\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|a,b-<frac|1|n>|]>
      </equation>
      ...
      that <math|a+<frac|1|m>\<leqslant\><frac|1|n<rsub|1>>\<less\>x\<less\>b-<frac|1|n<rsub|2>>\<leqslant\>b-<frac|1|m>>
      proving that <math|x\<in\><around*|[|a+<frac|1|m>,b-<frac|1|m>|]>>.
      Hence\ 

      <\equation>
        <label|eq 18.15.020><around*|]|a,b|[>\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|[|a+<frac|1|m>,b-<frac|1|m>|]>
      </equation>
      ...
      which together with <reference|eq 18.15.020> gives
      ...
      <\equation>
        <label|eq 18.16.020><around*|]|-\<infty\>,a|[>\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|-\<infty\>,a-<frac|1|n>|]>
      </equation>
      ...
      Using this together with <reference|eq 18.16.020> proves
      ...
      property for the reals> there exists a <math|n\<in\>\<bbb-N\><rsub|0>>
      such that <math|a+<frac|1|n>\<less\>x\<Rightarrow\>x\<in\><around*|[|a,\<infty\>|[>>.
      Hence\ 

      <\equation>
        <label|eq 18.17.020><around*|]|a,\<infty\>|[>\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|[|a+<frac|1|n>,\<infty\>|[>
      </equation>
      ...
      combining this with <reference|eq 18.17.020> gives\ 
  ...
  <\proposition>
    We have the following equivalent definitions for
  ...
  <\proof>
    ...
    <\equation>
      \<cal-B\><around*|[|\<bbb-R\>|]>=\<sigma\><around*|[|\<cal-T\><rsub|\<bbb-R\>>|]>\<subseteq\>\<sigma\><around*|[|\<cal-T\><rsub|<around*|]||[>>|]>
    </equation>

    If <math|<around*|]|a,b|[>\<in\>\<cal-I\><rsub|<around*|]||[>>> then
    using the previous lemma [see <reference|interval identities>]
    <math|<around*|]|a,b|[>=<big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|[|a+<frac|1|n>,b-<frac|1|n>|]>>
    and as <math|<around*|[|a+<frac|1|n>,b-<frac|1|n>|]>> is either
    <math|\<emptyset\>\<in\>\<sigma\><around*|[|\<cal-T\><rsub|<around*|[||]>>|]>>
    or <math|\<in\>\<cal-I\><rsub|<around*|[||]>>\<subseteq\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|[||]>>|]>>
    so it follows that <math|\<cal-I\><rsub|<around*|]||[>>\<subseteq\>\<cal-T\><rsub|<around*|[||]>>>.
    Hence using <reference|generated sigma algebra> we have that\ 

    <\equation>
      \<sigma\><around*|[|\<cal-T\><rsub|<around*|]||[>>|]>\<subseteq\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|[||]>>|]>
    </equation>
  ...
  TODO rewrite the next using the above
  ...
  <\proposition>
    ...
    <\eqnarray*>
      ...
      algebra is generated by closed sets>>>>|<cell|\<cal-B\><around*|[|\<bbb-R\>|]>>>|<row|<cell|>|<cell|=>|<cell|\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]>>>|<row|<cell|>|<cell|=>|<cell|\<sigma\><around*|[|\<cal-I\><rsub|<around*|[||[>>|]>>>|<row|<cell|>|<cell|=>|<cell|\<sigma\><around*|[|<around*|{|\<cal-I\><rsub|<around*|]||]>>|}>|]>>>|<row|<cell|>|<cell|=>|<cell|\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>|}>|]>>>|<row|<cell|>|<cell|=>|<cell|\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|[>\|a\<in\>\<bbb-R\>|}>|]>>>|<row|<cell|>|<cell|=>|<cell|\<sigma\><around*|[|<around*|{|<around*|]|a,\<infty\>|[>\|a\<in\>\<bbb-R\>|}>|]>>>>>
    </eqnarray*>
  </proposition>
  ...
  <\proof>
    ...
    with <math|\<forall\>i\<in\>I> <math|<around*|]|a<rsub|i>,b<rsub|i>|[>\<neq\>\<emptyset\>>
    such that <math|U=<big|cup><rsub|i\<in\>I><around*|]|a<rsub|i>,b<rsub|i>|[>\<in\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]>>
    [using the fact that <math|\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]>>
    is a <math|\<sigma\>>-algebra and <reference|sigma algebra equivalent
    definitions>]. Hence <math|\<cal-T\><rsub|\<bbb-R\>>\<subseteq\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]>>
    so that by <reference|generated sigma algebra>\ 

    <\equation>
      <label|eq 18.7.014>\<cal-B\><around*|[|\<bbb-R\>|]>=\<sigma\><around*|[|\<cal-T\><rsub|\<bbb-R\>>|]>\<subseteq\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]>
    </equation>

    Let <math|<around*|]|a,b|[>\<in\>\<cal-I\><rsub|<around*|]||[>>> then if
    ...
    there exist <math|n\<in\>\<bbb-N\><rsub|0>> such that
    <math|a\<less\>x\<less\>x+<frac|1|n>\<less\>b\<Rightarrow\>x\<less\>b-<frac|1|n>\<less\>b\<Rightarrow\>x\<in\><around*|]|a,b-<frac|1|n>|]>>
    proving that <math|<around*|]|a,b|[>\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|a,b-<frac|1|n>|]>>.
    Further as cleary <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>>
    <math|<around*|]|a,b-<frac|1|n>|]>\<subseteq\><around*|]|a,b|[>> it
    follows that\ 

    <\equation>
      <label|eq 18.8.014><around*|]|a,b|[>=<big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|a,b-<frac|1|n>|]>\<in\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]><text|
      [using <reference|sigma algebra equivalent definitions>]>
    </equation>

    So <math|\<cal-I\><rsub|<around*|]||[>>\<subseteq\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||]>>|]>>
    which using <reference|generated sigma algebra> proves that\ 

    <\equation>
      <label|eq 18.9.014>\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]>\<subseteq\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||]>>|]>
    </equation>
    ...
    So we have that <math|\<cal-I\><rsub|<around*|]||]>>\<subseteq\>\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,x|]>\|x\<in\>\<bbb-R\>|}>|]>>
    which using <reference|generated sigma algebra> proves that

    <\equation>
      <label|eq 18.11.014>\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||]>>|]>\<subseteq\>\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>|}>|]>
    </equation>
    ...
    Next using <reference|open intervals in R> we have that
    ...
    Let <math|I=<around*|[|a,b|[>\<in\>\<cal-I\><rsub|<around*|[||[>>>. If
    <math|x\<in\><big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|a-<frac|1|n>,b|[>>
    then <math|\<forall\>i\<in\>\<bbb-N\><rsub|0>> we have
    <math|a-<frac|1|n>\<less\>x\<less\>b>. Assume that <math|x\<less\>a> then
    by <reference|consequence of the archimedean property for the reals>
    there exists a <math|n\<in\>\<bbb-N\><rsub|0>> such that
    <math|x\<less\>x+<frac|1|n>\<less\>a\<Rightarrow\>x\<less\>a-<frac|1|n>>
    contradiction <math|a-<frac|1|n>\<less\>x> so that <math|a\<leqslant\>x>
    proving that <math|x\<in\><around*|[|a,b|[>>. Hence
    <math|x\<in\><around*|[|a,b|[>> proving that
    <math|<big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|a-<frac|1|n>,b|[>\<subseteq\><around*|[|a,b|[>>.
    As trivially <math|<around*|[|a,b|[>\<subseteq\><big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|a-<frac|1|n>,b|[>>
    [for <math|a\<leqslant\>x\<less\>b\<Rightarrow\>a-<frac|1|n>\<less\>a\<leqslant\>x\<less\>b>]
    it follows that <math|I=<big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|a-<frac|1|n>,b|[>\<in\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]>>.
    Hence <math|\<cal-I\><rsub|<around*|[||[>>\<subseteq\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]>>
    giving\ 

    <\equation>
      <label|eq 18.16.018>\<sigma\><around*|[|\<cal-I\><rsub|<around*|[||[>>|]>\<subseteq\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]>
    </equation>

    Further let <math|I=<around*|]|a,b|[>\<in\>\<cal-I\><rsub|<around*|]||[>>>
    then if <math|x\<in\><big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|[|a+<frac|1|n>,b|[>>
    there exist a <math|n\<in\>\<bbb-N\><rsub|0>> such that
    <math|a\<less\>a+<frac|1|n>\<leqslant\>x\<less\>b> proving that
    <math|<big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|[|a+<frac|1|n>,b|[>\<subset\><around*|]|a,b|[>>.
    On the other way if <math|x\<in\><around*|]|a,b|[>> then
    <math|a\<less\>x\<less\>b> and using <reference|consequence of the
    archimedean property for the reals> there exists a
    <math|n\<in\>\<bbb-N\><rsub|0>> such that
    <math|a\<less\>a+<frac|1|n>\<less\>x\<less\>b> hence
    <math|x\<in\><around*|[|a+<frac|1|n>,b|[>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|[|a+<frac|1|n>,b|[>>.
    So <math|I=<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|[|a+<frac|1|n>,b|[>\<in\>\<sigma\><around*|(|\<cal-I\><rsub|<around*|[||[>>|)>>
    proving that <math|\<cal-I\><rsub|<around*|]||[>>\<subseteq\>\<sigma\><around*|[|\<cal-I\><rsub|<around*|[||[>>|]>>
    or using <reference|eq 18.16.018> that\ 

    <\equation>
      <label|eq 18.17.018>\<sigma\><around*|[|\<cal-I\><rsub|<around*|[||[>>|]>=\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]>
    </equation>

    Let <math|I=<around*|]|-\<infty\>,a|[>\<in\><around*|{|<around*|]|-\<infty\>,a|[>\|a\<in\>\<bbb-R\>|}>>
    then if <math|x\<in\><big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|-\<infty\>,a-<frac|1|n>|]>>
    there exists a <math|n\<in\>\<bbb-N\><rsub|0>> such that
    <math|x\<in\><around*|]|-\<infty\>,a-<frac|1|n>|]>> hence
    <math|x\<leqslant\>a-<frac|1|n>\<Rightarrow\>x\<less\>a\<Rightarrow\>x\<in\><around*|]|-\<infty\>,a|[>>
    proving that <math|<big|cup><rsub|n\<in\>\<bbb-N\>><around*|]|-\<infty\>,a-<frac|1|n>|]>\<subseteq\><around*|]|-\<infty\>,a|[>>.
    On the other hand if <math|x\<in\><around*|]|-\<infty\>,a|[>> then
    <math|x\<less\>a>, using <reference|consequence of the archimedean
    property for the reals> there exists then a
    <math|n\<in\>\<bbb-N\><rsub|0>> such that
    <math|x\<less\>x+<frac|1|n>\<less\>a\<Rightarrow\>x\<less\>a-<frac|1|n>>
    proving that <math|x\<in\><big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|-\<infty\>,a-<frac|1|n>|]>>,
    hence <math|<around*|]|-\<infty\>,a|[>\<subseteq\><big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|-\<infty\>,a|]>>.
    So we have <math|<around*|]|-\<infty\>,a|[>=<big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|-\<infty\>,a-<frac|1|n>|]>\<in\>\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>|}>|]>>
    which proves\ 

    <\equation>
      <label|eq 18.18.019>\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|[>\|a\<in\>\<bbb-R\>|}>|]>\<subseteq\>\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>|}>|]>
    </equation>

    Next take <math|I=<around*|]|-\<infty\>,a|]>\<in\><around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>|}>>
    then if <math|x\<in\><big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|-\<infty\>,a+<frac|1|n>|[>>
    we have <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> that
    <math|x\<less\>a+<frac|1|n>> which by <reference|consequence of the
    Archimedean property (2)> proves that
    <math|x\<leqslant\>a\<Rightarrow\>x\<in\><around*|]|-\<infty\>,a|]>>,
    hence <math|<big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|-\<infty\>.a+<frac|1|n>|[>\<subseteq\><around*|]|-\<infty\>,a|]>>.
    Further if <math|x\<in\><around*|]|-\<infty\>,a|]>> then
    <math|x\<leqslant\>a\<less\>a+<frac|1|n>>
    <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> proving that
    <math|x\<in\><big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|-\<infty\>,a+<frac|1|n>|[>>
    or <math|<around*|]|-\<infty\>,a|]>\<subseteq\><big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|x,a+<frac|1|n>|[>>.
    So <math|<around*|]|-\<infty\>,a|]>=<big|cap><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|]|-\<infty\>,a+<frac|1|n>|[>\<in\>\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|[>\|a\<in\>\<bbb-R\>|}>|]>>
    proving that <math|\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>|}>|]>\<subseteq\>\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>|}>|]>>.
    Combining this with <reference|eq 18.18.019> gives\ 

    <\equation>
      <label|eq 18.19.019>\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|[>\|a\<in\>\<bbb-R\>|}>|]>=\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>|}>|]>
    </equation>

    Summarizing <reference|eq 18.7.014>,<reference|eq 18.9.014>,<reference|eq
    18.11.014>,<reference|eq 18.10.015>,<reference|eq
    18.11.015>,<reference|eq 18.17.018> \ and <reference|eq 18.19.019> we
    have that

    <\eqnarray*>
      <tformat|<table|<row|<cell|\<cal-B\><around*|[|\<bbb-R\>|]>>|<cell|\<subseteq\>>|<cell|\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||[>>|]>=\<sigma\><around*|[|\<cal-I\><rsub|<around*|[||[>>|]>>>|<row|<cell|>|<cell|\<subseteq\>>|<cell|\<sigma\><around*|[|\<cal-I\><rsub|<around*|]||]>>|]>>>|<row|<cell|>|<cell|\<subseteq\>>|<cell|\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>|}>|]>=\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|[>\|a\<in\>\<bbb-R\>|}>|]>>>|<row|<cell|>|<cell|\<subseteq\>>|<cell|\<sigma\><around*|[|<around*|{|<around*|]|a,\<infty\>|[>\|a\<in\>\<bbb-R\>|}>|]>>>|<row|<cell|>|<cell|\<subseteq\>>|<cell|\<cal-B\><around*|[|\<bbb-R\>|]>>>>>
    </eqnarray*>
  ...
  <\definition>
    ...
    <\enumerate>
      ...
      for all <math|<around*|{|A<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>\<subseteq\>\<cal-A\>>
      we have that
  ...
  <\lemma>
    ...
    <math|\<varphi\>:\<cal-P\><around*|(|X|)>\<rightarrow\><around*|[|0.\<infty\>|]>>
    a ouer measure then <math|\<forall\><around*|{|A<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>,n\<in\>\<bbb-N\><rsub|0>>
  ...
  not dependend on the boundary points.\ 
  ...
  <\proof>
    ...
    <\description>
      ...
      it follows that <math|a\<in\>A\<Rightarrow\>A\<neq\>\<emptyset\>>, as
      further <math|A\<subseteq\><around*|[|a,b|]>> and is thus bounded above
      by <math|b>, we have using <reference|the reals are conditional
      complete> that\ 
      ...
      <math|c\<in\>\<bbb-R\>> we have by <reference|x+z=y+z=\<gtr\>x=y> that
      <math|x\<leqslant\>sup<around*|(|B|)>+a>. Hence
      <math|c=sup<around*|(|A|)>\<leqslant\>sup<around*|(|B|)>+a> or using
      <reference|x+z=y+z=\<gtr\>x=y> again \ 

      <\equation>
        <label|eq 18.77.018>c-a\<leqslant\>sup<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsup|x><rsub|i>|)>\|x\<in\>A|}>|)>
      </equation>
      ...
      18.80.018>>\<Rightarrow\>c\<less\>b<rsub|k>>c-a<rsub|k>> giving\ 
      ...
      18.84.018> and the definiton of <math|A> [see <reference|eq
      18.75.018>]<space|1em>it follows that <math|m\<in\>A>. Hence
      <math|m\<leqslant\>sup<around*|(|A|)>=c> contradicting
      <math|c\<less\>m> [see <reference|eq 18.80.018>]. So the assumption
      that <math|c\<gtr\>b> is wrong so that <math|b\<leqslant\>c> which
  ...
  We are finaly able to define the outer measure on <math|\<bbb-R\>>
  ...
  <\theorem>
    ...
    <\equation*>
      ...
      \<varphi\><around*|(|A|)>=\<varphi\><around*|(|A<big|cap>L|)>+\<varphi\><around*|(|A\\L|)>|}>
    </equation*>
    ...
    is a measure space. Further we have <math|\<cal-B\><around*|[|\<bbb-R\>|]>>
  ...
  <\proof>
    Using <reference|Caratheodore> and the above corollary [see
    <reference|outer measure on R>] we have that\ 

    <\equation>
      <label|eq 18.87.018><around*|\<langle\>|\<bbb-R\>,\<cal-L\>,\<lambda\>|\<rangle\>><text|
      is a measure space>
    </equation>

    Next we must prove that <math|\<cal-B\><around*|[|\<bbb-R\>|]>\<subseteq\>\<cal-L\>>,
    to do this we make us of the fact that
    <math|\<cal-B\><around*|[|\<bbb-R\>|]>=\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|[>\|a\<in\>\<bbb-R\>|}>|]>>
    [see <reference|Borel algebras on R>]. Let <math|a\<in\>\<bbb-R\>> and
    consider <math|<around*|]|-\<infty\>,a|[>>. Take
    <math|A\<subseteq\>\<bbb-R\>> then we have for <math|\<varphi\>> the
    following cases to consider:\ 

    <\description>
      <item*|<math|\<varphi\><around*|(|A|)>=\<infty\>>>Then
      <math|\<varphi\><around*|(|A<big|cap><around*|]|-\<infty\>,a|]>|)>+\<varphi\><around*|(|A\\<around*|]|-\<infty\>,a|]>|)>\<leqslant\>\<varphi\><around*|(|A|)>>

      <item*|<math|\<varphi\><around*|(|A|)>\<in\>\<bbb-R\>>>Let
      <math|\<varepsilon\>\<gtr\>0> then by the definiton of
  ...
  <\proof>
    ...
    hence <math|<around*|{|<around*|]|-i,i|[>|}><rsub|i\<in\>\<bbb-N\>>\<in\>\<cal-C\><rsub|A>>
  </proof>
  ...
  exist and is bigger or equal to <math|0> [using <reference|every non empty
  set in the extented reals has a limit> and the fact that
  <math|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|I<rsub|i><rsub|i\<in\>\<bbb-N\>>\<in\>\<cal-C\><rsub|A>|}>>
  is bounded below by 0]. This leads to the following definition.
  ...
  <\definition>
    ...
    is defined by <math|\<lambda\><rsup|\<ast\>><around*|(|A|)>=inf<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-C\><rsub|A>|}>|)>>.
    Note that the sum in the definition can be <math|\<infty\>> [well defined
    in <math|<wide|\<bbb-R\>|\<bar\>>> see <reference|series of positive
    extented reals is increasing>]
  </definition>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>Let <math|\<varepsilon\>\<gtr\>0> \ Take
      <math|<around*|{|<around*|]|0,<frac|\<varepsilon\>|2<rsup|i>>|[>|}><rsub|i\<in\>\<bbb-N\>>>
      then <math|\<emptyset\>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>><around*|]|0,<frac|\<varepsilon\>|2<rsup|i>>|[>>,
      further <math|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|<around*|]|0,<frac|\<varepsilon\>|2<rsup|i>>|[>|)>=\<varepsilon\>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>><frac|1|2<rsup|i>>\<equallim\><rsub|<text|<reference|exaple
      of a convergent serie>>>\<varepsilon\>> hence
      <math|\<lambda\><rsup|\<ast\>><around*|(|\<emptyset\>|)>\<leqslant\>\<varepsilon\>>
      which by <reference|consequence of the Archimedean property (2)> proves
      that\ 
      ...
      [see <reference|inclusion and sup and inf>] proving that
      ...
      <\description>
        ...
        <\eqnarray*>
          <tformat|<table|<row|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|\<sigma\><around*|(|i|)><rsub|1>,\<sigma\><around*|(|i|)><rsub|2>>|)>>|<cell|\<leqslant\>>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>><around*|(|\<lambda\><rsup|\<ast\>><around*|(|A<rsub|i>|)>+<frac|\<varepsilon\>|2<rsup|i>>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|sum
        ...
        <\equation>
          <label|eq 18.65.016><big|cup><rsub|i=1><rsup|\<infty\>>A<rsub|i>\<subseteq\><big|cup><rsub|k\<in\>\<bbb-N\>>I<rsub|\<sigma\><around*|(|k|)><rsub|1>,\<sigma\><around*|(|k|)><rsub|2>>
        </equation>
  ...
  <\lemma>
    ...
    [the set of non empty bounded open intervals] then if
    <math|\<emptyset\>\<neq\><around*|[|a,b|]>\<subseteq\><big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>I<rsub|i>>
    we have <math|l<around*|(|<around*|[|a,b|]>|)>\<less\><big|sum><rsub|i=1><rsup|n>l<around*|(|I<rsub|i>|)>>
  </lemma>

  <\proof>
    First as <math|<around*|[|a,b|]>\<neq\>\<emptyset\>> we have by
    <reference|condition for interval to be empty> that <math|a\<leqslant\>b>
    proving that <math|a,b\<in\><around*|[|a,b|]>>. We proof the rest by
    induction so let <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\>\|\<forall\><around*|{|I<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\>\<cal-I\><rsub|<around*|]|a,b|[>><text|
    ...
    <\description>
      ...
      then \ <math|a,b\<in\><around*|[|a,b|]>\<subseteq\>I<rsub|1>> and
      ...
      and <math|<around*|[|a,b|]>\<subseteq\><big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n+1|}>>I<rsub|i>>
      ...
      <\description>
        ...
        Further if <math|x\<in\><around*|[|a,a<rsub|k>|]>\<subseteq\><around*|[|a,b|]>>
        then <math|\<exists\>i\<in\><around*|{|1,\<ldots\>,n+1|}>> so that
        <math|x\<in\>I<rsub|i>>,,, using <reference|eq 18.66.016> we must
        have that <math|i\<neq\>k> hence we have using <reference|eq
        18.67.016>
        ...
        <\equation>
          <label|eq 18.68.016>a<rsub|k>-a=l<around*|(|<around*|[|a,a<rsub|k>|]>|)>\<leqslant\><big|sum><rsub|i=1><rsup|n>l<around*|(|J<rsub|i>|)>\<equallim\><rsub|<text|<reference|eq
          18.67.016>>><big|sum><rsub|i=1><rsup|k-1>l<around*|(|I<rsub|i>|)>+<big|sum><rsub|i=k+1><rsup|n+1>l<around*|(|I<rsub|i>|)>
        </equation>
  ...
  <\theorem>
    <label|length of interval and the Lebesgue outer measure>If
    <math|I\<in\>\<cal-I\>> [see <reference|bounded intervals>] then
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|I=\<emptyset\>>>Then <math|l<around*|(|I|)>=0=\<lambda\><rsup|\<ast\>><around*|(|I|)>>

      <item*|<math|I\<in\>\<cal-I\><rsub|<around*|[||]>>>>Then there exists
      <math|a,b\<in\>\<bbb-R\>> with <math|I=<around*|[|a,b|]>\<neq\>\<emptyset\>>.
      Let <math|\<varepsilon\>\<gtr\>0> then if we define
      <math|<around*|{|J<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>> by
      <math|J<rsub|i>=<choice|<tformat|<table|<row|<cell|<around*|]|a-<frac|\<varepsilon\>|4>,b+<frac|\<varepsilon\>|4>|[>
      if i=1>>|<row|<cell|<around*|]|0,<frac|\<varepsilon\>|2<rsup|i>>|[>=\<emptyset\>
      if i\<in\>\<bbb-N\>\\<around*|{|1|}>>>>>>>then we have
      <math|<around*|[|a,b|]>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>J<rsub|i>>
      so that

      <\eqnarray*>
        <tformat|<table|<row|<cell|\<lambda\><rsup|\<ast\>><around*|(|I|)>>|<cell|\<leqslant\>>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|J<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|l<around*|(|J<rsub|1>|)>+<big|sum><rsub|i=2><rsup|\<infty\>>l<around*|(|J<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|b+<frac|\<varepsilon\>|4>-<around*|(|a-<frac|\<varepsilon\>|4>|)>+\<varepsilon\>\<cdot\><big|sum><rsub|i=2><rsup|\<infty\>><frac|1|2<rsup|i>>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|exaple
        of a convergent serie>>>>|<cell|b-a+<frac|\<varepsilon\>|2>+<frac|\<varepsilon\>|2>>>|<row|<cell|>|<cell|=>|<cell|b-a+\<varepsilon\>>>|<row|<cell|>|<cell|=>|<cell|l<around*|(|<around*|[|a,b|]>|)>+\<varepsilon\>>>>>
      </eqnarray*>
      ...
      must have <math|l<around*|(|<around*|[|a,b|]>|)>\<leqslant\>\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>>
      which combined with <reference|eq 18.71.016> gives

      <\equation*>
        l<around*|(|<around*|[|a,b|]>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>
      </equation*>

      <item*|<math|I\<in\>\<cal-I\><rsub|<around*|[||[>>>>Then there exists
      <math|a,b\<in\>\<bbb-R\>> with <math|I=<around*|[|a,b|[>>. As
      <math|I\<neq\>\<emptyset\>> we must have by <reference|condition for
      interval to be empty> that <math|a\<less\>b\<Rightarrow\>b-a\<gtr\>0>.
      From <math|<around*|[|a,b|[>\<subseteq\><around*|[|a.b|]>> we have as
      <math|\<lambda\><rsup|\<ast\>>> is a outer measure that\ 

      <\equation>
        <label|eq 18.72.017>\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|[>|)>\<leqslant\>\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>
      </equation>

      Take <math|\<varepsilon\>> such that
      <math|0\<less\>\<varepsilon\>\<less\>b-a> ] then
      <math|b\<gtr\>b-\<varepsilon\>\<gtr\>b-<around*|(|b-a|)>=a> so that
      <math|<around*|[|a,b|]>=<around*|[|a,b-\<varepsilon\>|[><big|cup><around*|[|b-\<varepsilon\>,b|]>>
      so that\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>>|<cell|=>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b-\<varepsilon\>|[><big|cup><around*|[|b-\<varepsilon\>,b|]>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b-\<varepsilon\>|[>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|[|b-\<varepsilon\>,b|]>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|[>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|[|b-\<varepsilon\>,b|]>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<around*|[|b-\<varepsilon\>,b|]>\<in\>\<cal-I\><rsub|<around*|[||[>>>>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|[>|)>+l<around*|(|<around*|[|b-\<varepsilon\>,b|]>|)>>>|<row|<cell|>|<cell|=>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|[>|)>+\<varepsilon\>>>>>
      </eqnarray*>

      Using <reference|consequence of the Archimedean property (2)> we have
      then that <math|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>\<leqslant\>\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|[>|)>>
      which together with <reference|eq 18.72.017> proves that
      <math|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|[>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>=l<around*|(|<around*|[|a,b|]>|)>=b-a=l<around*|(|<around*|[|a,b|[>|)>>
      proving that\ 
      ...
      <\equation>
        <label|eq 18.73.017>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|]>|)>\<leqslant\>\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>
      </equation>

      Take <math|\<varepsilon\>> such that
      <math|0\<less\>\<varepsilon\>\<less\>b-a> \ then
      <math|a\<less\>a+\<varepsilon\>\<less\>a+<around*|(|b-a|)>=b> so that
      <math|<around*|[|a,b|]>=<around*|[|a,a+\<varepsilon\>|]><big|cup><around*|]|a+\<varepsilon\>,b|]>>
      so that

      <\eqnarray*>
        <tformat|<table|<row|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>>|<cell|=>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,a+\<varepsilon\>|]><big|cup><around*|]|a+\<varepsilon\>,b|]>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,a+\<varepsilon\>|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a+\<varepsilon\>,b|]>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,a+\<varepsilon\>|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|]>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<around*|[|a,a+\<varepsilon\>|]>\<in\>\<cal-I\><rsub|<around*|[||]>>>>|<cell|l<around*|(|<around*|[|a,a+\<varepsilon\>|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|]>|)>>>|<row|<cell|>|<cell|=>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|]>|)>+\<varepsilon\>>>>>
      </eqnarray*>

      Using \ <reference|consequence of the Archimedean property (2)> we have
      then that <math|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>\<leqslant\>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|]>|)>>
      which together with <reference|eq 18.73.017> proves that
      <math|\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|]>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>=l<around*|(|<around*|[|a,b|]>|)>=b-a=l<around*|(|<around*|]|a,b|]>|)>>
      giving\ 

      <\equation*>
        \<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|]>|)>=l<around*|(|<around*|]|a,b|]>|)>
      </equation*>
      ...
      <\equation>
        <label|eq 18.74.017>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|[>|)>\<leqslant\>\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>
      </equation>

      Take now <math|\<varepsilon\>> such that
      <math|0\<less\>\<varepsilon\>\<less\>b-a> then
      <math|a+<frac|\<varepsilon\>|2>\<less\>a+<frac|b-a|2>=<frac|a+b|2>> and
      <math|b-<frac|\<varepsilon\>|2>\<gtr\>b-<frac|b-a|2>=<frac|a+b|2>>
      proving that <math|a\<less\>a+<frac|\<varepsilon\>|2>\<less\>b-<frac|\<varepsilon\>|2>\<less\>b>
      so that <math|<around*|[|a,b|]>=<around*|[|a,a+<frac|\<varepsilon\>|2>|]><big|cup><around*|]|a+<frac|\<varepsilon\>|2>,b-<frac|\<varepsilon\>|2>|[><big|cup><around*|[|b-<frac|\<varepsilon\>|2>,b|]>>
      so that\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>>|<cell|=>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,a+<frac|\<varepsilon\>|2>|]><big|cup><around*|]|a+<frac|\<varepsilon\>|2>,b-<frac|\<varepsilon\>|2>|[><big|cup><around*|[|b-<frac|\<varepsilon\>|2>,b|]>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,a+<frac|\<varepsilon\>|2>|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a+<frac|\<varepsilon\>|2>,b-<frac|\<varepsilon\>|2>|[>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|[|b-<frac|\<varepsilon\>|2>,b|]>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,a+<frac|\<varepsilon\>|2>|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|[>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|[|b-<frac|\<varepsilon\>|2>,b|]>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<around*|[|a,a+\<varepsilon\>|]>,<around*|[|b-\<varepsilon\>,b|]>\<in\>\<cal-I\><rsub|<around*|[||]>>>>|<cell|l<around*|(|<around*|[|a,a+<frac|\<varepsilon\>|2>|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|[>|)>+l<around*|(|<around*|[|b-<frac|\<varepsilon\>|2>,b|]>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|\<varepsilon\>|2>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|[>|)>+<frac|\<varepsilon\>|2>>>|<row|<cell|>|<cell|=>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|[>|)>+\<varepsilon\>>>>>
      </eqnarray*>

      Using \ <reference|consequence of the Archimedean property (2)> we have
      then that <math|\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>\<leqslant\>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|]>|)>>
      which together with <reference|eq 18.74.017> proves that
      <math|\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a,b|[>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|[|a,b|]>|)>=l<around*|(|<around*|[|a,b|]>|)>=b-a=l<around*|(|<around*|]|a,b|[>|)>>
      giving
  ...
  Next we prove that every Borel set on <math|\<bbb-R\>> is Lebesgue
  measurable.

  <\theorem>
    <label|Borel sets in the reals are Lebesgue measurable>Let
    <math|B\<in\>\<cal-B\><around*|[|\<bbb-R\>|]>> then <math|B> is
    <math|\<lambda\><rsup|\<ast\>>>-measurable.\ 
  </theorem>

  <\proof>
    Let <math|b\<in\>\<bbb-R\>> and consider
    <math|<around*|]|-\<infty\>,b|]>>, take <math|A\<subseteq\>\<bbb-R\>>
    then we have for <math|\<lambda\><rsup|\<ast\>><around*|(|A|)>> the
    following cases to consider\ 

    <\description>
      <item*|<math|\<lambda\><rsup|\<ast\>><around*|(|A|)>=\<infty\>>>Then
      <math|\<lambda\><rsup|\<ast\>><around*|(|A<big|cap><around*|]|-\<infty\>,b|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|A\\<around*|]|-\<infty\>,b|]>|)>>

      <item*|<math|\<lambda\><rsup|\<ast\>><around*|(|A|)>\<less\>\<infty\>>>Let
      <math|\<varepsilon\>\<gtr\>0> then by the definition of
      <math|\<lambda\><rsup|\<ast\>>> as a infinum there exists a
      <math|<around*|{|<around*|]|a<rsub|i>,b<rsub|i>|[>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-I\><rsub|<around*|]||[>>>
      such that <math|A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>><around*|]|a<rsub|i>,b<rsub|i>|[>>
      and

      <\equation>
        <label|eq 18.75.016><big|sum><rsub|i=1><rsup|\<infty\>><around*|(|b<rsub|i>-a<rsub|i>|)>=<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>|)>\<less\>\<lambda\><rsup|\<ast\>><around*|(|A|)>+\<varepsilon\>.
      </equation>

      Take <math|i\<in\>\<bbb-N\>> then we have either\ 

      <\description>
        <item*|<math|b<rsub|i>\<leqslant\>b>>Then if
        <math|x\<in\><around*|]|a<rsub|i>,b<rsub|i>|[>\<Rightarrow\>x\<less\>b<rsub|i>\<leqslant\>b>
        proving that <math|<around*|]|a<rsub|i>,b<rsub|i>|[>\<subseteq\><around*|]|-\<infty\>,b<rsub|i>|]>
        hence> <math|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>=<around*|]|a<rsub|i>,b<rsub|i>|[>>
        and <math|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b<rsub|i>|[>=\<emptyset\>>
        so that <math|\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>+0=\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b<rsub|i>|[>|)>>
        proving that

        <\equation>
          <label|eq 18.76.016>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>
        </equation>

        <item*|<math|b\<less\>b<rsub|i>>>Then we have for <math|a> either\ 

        <\description>
          <item*|<math|a<rsub|i>\<less\>b>>then we have\ 

          <\eqnarray*>
            <tformat|<table|<row|<cell|x\<in\><around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>>|<cell|\<Leftrightarrow\>>|<cell|a<rsub|i>\<less\>x\<wedge\>x\<less\>b<rsub|i>\<wedge\>x\<leqslant\>b>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|b\<less\>b<rsub|i>>>|<cell|a<rsub|i>\<less\>x\<wedge\>x\<leqslant\>b>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|]|a<rsub|i>,b|]>>>>>
          </eqnarray*>

          proving that <math|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>=<around*|]|a<rsub|i>,b|]>>
          or as <math|a<rsub|i>\<less\>b> we have that\ 

          <\equation>
            <label|eq 18.77.016>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b|]>|)>\<equallim\><rsub|<text|<reference|length
            of interval and the Lebesgue outer measure>>>b-a<rsub|i>
          </equation>

          Further

          <\eqnarray*>
            <tformat|<table|<row|<cell|x\<in\><around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>>|<cell|\<Leftrightarrow\>>|<cell|a<rsub|i>\<less\>x\<wedge\>x\<less\>b<rsub|i>\<wedge\>b\<less\>x>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|a<rsub|i>\<less\>b>>|<cell|b\<less\>x\<wedge\>x\<less\>b<rsub|i>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|]|b,b<rsub|i>|[>>>>>
          </eqnarray*>

          so that\ 

          <\equation>
            <label|eq 18.78.016>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|]|b,b<rsub|i>|[>|)>\<equallim\><rsub|<text|<reference|length
            of interval and the Lebesgue outer measure>>>b<rsub|i>-b
          </equation>

          Next <math|\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>|)>=b<rsub|i>-a<rsub|i>=b<rsub|i>-b+b-a<rsub|i>\<equallim\><rsub|<text|<reference|eq
          18.77.016> and <reference|eq 18.78.016>>>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>>
          proving that

          <\equation>
            <label|eq 18.79.016>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>
          </equation>

          <item*|<math|b\<leqslant\>a<rsub|i>>>Then if
          <math|x\<in\><around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>>
          we have <math|a<rsub|i>\<less\>x\<wedge\>x\<leqslant\>b\<less\>a<rsub|i>>
          giving the contradiction <math|a<rsub|i>\<less\>a<rsub|i>>. So
          <math|><math|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>=\<emptyset\>>
          and <math|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>=<around*|]|a<rsub|i>,b<rsub|i>|[>>.
          So <math|\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>|)>=0+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>>
          giving\ 

          <\equation>
            <label|eq 18.80.016>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>
          </equation>
        </description>
      </description>

      From <reference|eq 18.76.016>, <reference|eq 18.78.016> and
      <reference|eq 18.80.016> it follows that in all cases we have\ 

      <\equation>
        <label|eq 18.81.016>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>|)>=\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>
      </equation>

      Next <math|<tabular|<tformat|<table|<row|<cell|A<big|cap><around*|]|-\<infty\>,b|]>>|<cell|\<subseteq\>>|<cell|<around*|(|<big|cup><rsub|i\<in\>\<bbb-N\>><around*|]|a<rsub|i>,b<rsub|i>|[>|)><big|cap><around*|]|-\<infty\>,b|]>\<equallim\><rsub|<text|<reference|generalized
      distributive laws>>><big|cup><rsub|i\<in\>\<bbb-N\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>>>>>>>so
      that

      <\eqnarray*>
        <tformat|<table|<row|<cell|\<lambda\><rsup|\<ast\>><around*|(|A<big|cap><around*|]|-\<infty\>,b|]>|)>>|<cell|\<leqslant\>>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<big|cup><rsub|i\<in\>\<bbb-N\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)><eq-number><label|eq
        18.82.016>>>>>
      </eqnarray*>

      Further <math|A\\<around*|]|-\<infty\>,b|]>\<subseteq\><around*|(|<big|cup><rsub|i\<in\>\<bbb-N\>><around*|]|a<rsub|i>,b<rsub|i>|[>|)>\\<around*|]|-\<infty\>,b|]>\<equallim\><rsub|<text|<reference|generalized
      difference>>><big|cup><rsub|i\<in\>\<bbb-N\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>>
      so that\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|\<lambda\><rsup|\<ast\>><around*|(|A\\<around*|]|-\<infty\>,b|]>|)>>|<cell|\<leqslant\>>|<cell|\<lambda\><rsup|\<ast\>><around*|(|<big|cup><rsub|i\<in\>\<bbb-N\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)><eq-number><label|eq
        18.83.016>>>>>
      </eqnarray*>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|\<lambda\><rsup|\<ast\>><around*|(|A<big|cap><around*|]|-\<infty\>,b|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|A\\<around*|]|-\<infty\>,b|]>|)>>|<cell|\<leqslant\><rsub|<text|<reference|eq
        18.82.016>.<reference|eq 18.83.016>>>>|<cell|>>|<row|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>+<big|sum><rsub|i=1><rsup|\<infty\>>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>>|<cell|\<equallim\><rsub|<text|<reference|sum
        of series in the extended reals>>>>|<cell|>>|<row|<cell|<big|sum><rsub|i=1><rsup|\<infty\>><around*|(|\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[><big|cap><around*|]|-\<infty\>,b|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>\\<around*|]|-\<infty\>,b|]>|)>|)>>|<cell|\<equallim\><rsub|<text|<reference|eq
        18.81.016>>>>|<cell|>>|<row|<cell|<big|sum><rsub|i=1><rsup|\<infty\>>\<lambda\><rsup|\<ast\>><around*|(|<around*|]|a<rsub|i>,b<rsub|i>|[>|)>>|<cell|\<less\><rsub|<text|<reference|eq
        18.75.016>>>>|<cell|>>|<row|<cell|\<lambda\><rsup|\<ast\>><around*|(|A|)>+\<varepsilon\>>|<cell|>|<cell|>>>>
      </eqnarray*>

      Using <reference|consequence of the Archimedean property (2)> we have
      then <math|><math|\<lambda\><rsup|\<ast\>><around*|(|A<big|cap><around*|]|-\<infty\>,b|]>|)>+\<lambda\><rsup|\<ast\>><around*|(|A\\<around*|]|-\<infty\>,b|]>|)>\<leqslant\>\<lambda\><rsup|\<ast\>><around*|(|A|)>>
      which using <reference|measurable set alternative definition> proves
      that <math|<around*|]|-\<infty\>,b|]>> is
      <math|\<lambda\><rsup|\<ast\>>>-measurable. Hence
      <math|<around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>|}>\<subseteq\>\<cal-M\><rsub|\<lambda\><rsup|\<ast\>>><around*|[|\<bbb-R\>|]>>
      so that

      <\equation*>
        \<cal-B\><around*|[|\<bbb-R\>|]>\<equallim\><rsub|<text|<reference|Borel
        algebras on R>>>\<sigma\><around*|[|<around*|{|<around*|]|-\<infty\>,a|]>\|a\<in\>\<bbb-R\>|}>\<subseteq\>\<cal-M\><rsub|\<lambda\><rsup|\<ast\>>><around*|[|\<bbb-R\>|]>|]>\<cal-M\><rsub|\<lambda\><rsup|\<ast\>>><around*|[|\<bbb-R\>|]>
      </equation*>
  ...
  To summarize the above theorems we have\ 

  <\theorem>
    <label|Lebesgue measure on the set of the
    reals><math|<around*|\<langle\>|\<bbb-R\>,\<cal-M\><rsub|\<lambda\><rsup|\<ast\>>><around*|[|\<bbb-R\>|]>,\<lambda\><rsup|\<ast\>><rsub|\|\<cal-M\><rsub|\<lambda\><rsup|\<ast\>>>>|\<rangle\>>>
    is a measurable space where\ 

    <\itemize-dot>
      <item><math|\<lambda\><rsup|\<ast\>>:\<bbb-R\>\<rightarrow\><around*|[|0,\<infty\>|]>>
      is defined by <math|\<lambda\><rsup|\<ast\>><around*|(|A|)>=inf<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|\<infty\>>l<around*|(|I<rsub|i>|)>\|<around*|{|I<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-I\><rsub|<around*|]||[>>\<wedge\>A\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>I<rsub|i>|}>|)>>

      <item><math|\<cal-M\><rsub|\<lambda\><rsup|\<ast\>>><around*|[|\<bbb-R\>|]>=<around*|{|A\<subseteq\>\<bbb-R\>\|\<forall\>X\<subseteq\>\<bbb-R\><text|
      we have >\<lambda\><rsup|\<ast\>><around*|(|X<big|cap>A|)>+\<lambda\><rsup|\<ast\>><around*|(|X\\A|)>=\<lambda\><rsup|\<ast\>><around*|(|X|)>|}>>

      <item><math|\<cal-B\><around*|[|\<bbb-R\>|]>\<subseteq\>\<cal-M\><rsub|\<lambda\><rsup|\<ast\>>><around*|[|\<bbb-R\>|]>>

      <item><math|\<forall\>I\<in\>\<cal-I\>> we have
      <math|\<lambda\><rsup|\<ast\>><around*|(|I|)>=l<around*|(|I|)>>
    </itemize-dot>
  </theorem>
...
<\references>
  <\collection>
    <associate|Borel Algebra in R^n (2)|<tuple|18.34|?>>
    ...
    <associate|Borel algebra on R^n alternatives|<tuple|18.35|?>>
    <associate|Borel algebras on R|<tuple|18.24|?>>
    <associate|Borel sets in R^n|<tuple|18.32|?>>
    <associate|Borel sets in the reals are Lebesgue
    measurable|<tuple|18.61|?>>
    <associate|Caratheodore|<tuple|18.48|?>>
    <associate|Dyadic interval properties 2|<tuple|18.29|?>>
    <associate|Lebesgue measure on the set of the reals|<tuple|18.62|?>>
    <associate|Lebesgue measure space|<tuple|18.54|?>>
    <associate|Open sets in R^N are disjoint union of Dyadic
    rectang;es|<tuple|18.31|?>>
    <associate|R can be covered by open intervals|<tuple|18.51|?>>
    <associate|[a,b] coverings|<tuple|18.59|?>>
    <associate|algebra equivalent definitions|<tuple|18.6|?>>
    <associate|algebra of sets|<tuple|18.5|?>>
    <associate|auto-1|<tuple|18|?>>
    <associate|auto-10|<tuple|18.3|?>>
    <associate|auto-11|<tuple|18.3.1|?>>
    <associate|auto-12|<tuple|18.3.2|?>>
    <associate|auto-13|<tuple|Carathéodory theorem|?>>
    <associate|auto-14|<tuple|18.3.3|?>>
    <associate|auto-15|<tuple|Lebesgue measurable space|?>>
    <associate|auto-16|<tuple|Lebesgue measure|?>>
    <associate|auto-17|<tuple|Lebesgue measurable set|?>>
    <associate|auto-18|<tuple|Lebesgue outer measure|?>>
    ...
    <associate|countable additivity implies additivity|<tuple|18.38|?>>
    <associate|dyadic interval property|<tuple|18.28|?>>
    <associate|eq 18,12.014|<tuple|18.33|?>>
    <associate|eq 18.1.014|<tuple|18.5|?>>
    <associate|eq 18.1.016|<tuple|18.1|?>>
    <associate|eq 18.10.014|<tuple|18.24|?>>
    <associate|eq 18.10.015|<tuple|18.27|?>>
    <associate|eq 18.10.020|<tuple|18.10|?>>
    <associate|eq 18.11.014|<tuple|18.25|?>>
    <associate|eq 18.11.015|<tuple|18.28|?>>
    <associate|eq 18.11.020|<tuple|18.11|?>>
    <associate|eq 18.12.014|<tuple|18.26|?>>
    <associate|eq 18.12.020|<tuple|18.12|?>>
    <associate|eq 18.13.014|<tuple|18.34|?>>
    <associate|eq 18.13.020|<tuple|18.13|?>>
    <associate|eq 18.14.014|<tuple|18.35|?>>
    <associate|eq 18.14.020|<tuple|18.14|?>>
    <associate|eq 18.15.015|<tuple|18.36|?>>
    <associate|eq 18.15.020|<tuple|18.16|?>>
    <associate|eq 18.16.015|<tuple|18.37|?>>
    <associate|eq 18.16.018|<tuple|18.29|?>>
    <associate|eq 18.16.020|<tuple|18.17|?>>
    <associate|eq 18.17.015|<tuple|18.38|?>>
    <associate|eq 18.17.018|<tuple|18.30|?>>
    <associate|eq 18.17.020|<tuple|18.18|?>>
    <associate|eq 18.18.015|<tuple|18.39|?>>
    <associate|eq 18.18.019|<tuple|18.31|?>>
    <associate|eq 18.18.020|<tuple|18.19|?>>
    <associate|eq 18.19.015|<tuple|18.40|?>>
    <associate|eq 18.19.019|<tuple|18.32|?>>
    <associate|eq 18.19.020|<tuple|18.20|?>>
    <associate|eq 18.2.014|<tuple|18.6|?>>
    <associate|eq 18.2.016|<tuple|18.2|?>>
    <associate|eq 18.20.015|<tuple|18.41|?>>
    <associate|eq 18.21.015|<tuple|18.42|?>>
    <associate|eq 18.22.015|<tuple|18.43|?>>
    <associate|eq 18.23.015|<tuple|18.44|?>>
    <associate|eq 18.24.015|<tuple|18.45|?>>
    <associate|eq 18.25.015|<tuple|18.46|?>>
    <associate|eq 18.26.015|<tuple|18.47|?>>
    <associate|eq 18.27.015|<tuple|18.48|?>>
    <associate|eq 18.28.015|<tuple|18.49|?>>
    <associate|eq 18.29.015|<tuple|18.50|?>>
    <associate|eq 18.3.014|<tuple|18.7|?>>
    <associate|eq 18.3.016|<tuple|18.3|?>>
    <associate|eq 18.30.015|<tuple|18.51|?>>
    <associate|eq 18.31.015|<tuple|18.52|?>>
    <associate|eq 18.36.016|<tuple|18.53|?>>
    <associate|eq 18.37.016|<tuple|18.54|?>>
    <associate|eq 18.38.016|<tuple|18.55|?>>
    <associate|eq 18.39.016|<tuple|18.55|?>>
    <associate|eq 18.4.016|<tuple|18.4|?>>
    <associate|eq 18.40.016|<tuple|18.57|?>>
    <associate|eq 18.41.016|<tuple|18.58|?>>
    <associate|eq 18.42.016|<tuple|18.59|?>>
    <associate|eq 18.43.016|<tuple|18.60|?>>
    <associate|eq 18.44.016|<tuple|18.61|?>>
    <associate|eq 18.45.016|<tuple|18.62|?>>
    <associate|eq 18.46.016|<tuple|18.63|?>>
    <associate|eq 18.47.016|<tuple|18.64|?>>
    <associate|eq 18.48.016|<tuple|18.65|?>>
    <associate|eq 18.49.016|<tuple|18.66|?>>
    <associate|eq 18.50.016|<tuple|18.67|?>>
    <associate|eq 18.51.016|<tuple|18.68|?>>
    <associate|eq 18.52.016|<tuple|18.78|?>>
    <associate|eq 18.52.018|<tuple|18.69|?>>
    <associate|eq 18.53.016|<tuple|18.79|?>>
    <associate|eq 18.53.018|<tuple|18.70|?>>
    <associate|eq 18.54.016|<tuple|18.80|?>>
    <associate|eq 18.54.018|<tuple|18.71|?>>
    <associate|eq 18.55.016|<tuple|18.81|?>>
    <associate|eq 18.55.018|<tuple|18.72|?>>
    <associate|eq 18.56.016|<tuple|18.82|?>>
    <associate|eq 18.56.018|<tuple|18.73|?>>
    <associate|eq 18.57.016|<tuple|18.83|?>>
    <associate|eq 18.57.018|<tuple|18.74|?>>
    <associate|eq 18.58.016|<tuple|18.84|?>>
    <associate|eq 18.58.018|<tuple|18.75|?>>
    <associate|eq 18.59.016|<tuple|18.85|?>>
    <associate|eq 18.59.018|<tuple|18.76|?>>
    <associate|eq 18.60.016|<tuple|18.86|?>>
    <associate|eq 18.60.018|<tuple|18.77|?>>
    <associate|eq 18.61.016|<tuple|18.87|?>>
    <associate|eq 18.62.016|<tuple|18.88|?>>
    <associate|eq 18.63.016|<tuple|18.103|?>>
    <associate|eq 18.64.016|<tuple|18.104|?>>
    <associate|eq 18.65.016|<tuple|18.105|?>>
    <associate|eq 18.66.016|<tuple|18.107|?>>
    <associate|eq 18.66.016.1|<tuple|18.106|?>>
    <associate|eq 18.67.016|<tuple|18.108|?>>
    <associate|eq 18.68.016|<tuple|18.109|?>>
    <associate|eq 18.7.014|<tuple|18.21|?>>
    <associate|eq 18.71.016|<tuple|18.110|?>>
    <associate|eq 18.72.016|<tuple|18.111|?>>
    <associate|eq 18.72.017|<tuple|18.112|?>>
    <associate|eq 18.73.017|<tuple|18.113|?>>
    <associate|eq 18.74.017|<tuple|18.114|?>>
    <associate|eq 18.74.018|<tuple|18.89|?>>
    <associate|eq 18.75.016|<tuple|18.115|?>>
    <associate|eq 18.75.018|<tuple|18.90|?>>
    <associate|eq 18.76.016|<tuple|18.116|?>>
    <associate|eq 18.76.018|<tuple|18.91|?>>
    <associate|eq 18.77.016|<tuple|18.117|?>>
    <associate|eq 18.77.018|<tuple|18.92|?>>
    <associate|eq 18.78.016|<tuple|18.118|?>>
    <associate|eq 18.78.018|<tuple|18.93|?>>
    <associate|eq 18.79.016|<tuple|18.119|?>>
    <associate|eq 18.79.018|<tuple|18.94|?>>
    <associate|eq 18.8.014|<tuple|18.22|?>>
    <associate|eq 18.8.020|<tuple|18.8|?>>
    <associate|eq 18.80.016|<tuple|18.120|?>>
    <associate|eq 18.80.018|<tuple|18.95|?>>
    <associate|eq 18.81.016|<tuple|18.121|?>>
    <associate|eq 18.81.018|<tuple|18.96|?>>
    <associate|eq 18.82.016|<tuple|18.122|?>>
    <associate|eq 18.82.018|<tuple|18.97|?>>
    <associate|eq 18.83.016|<tuple|18.123|?>>
    <associate|eq 18.83.018|<tuple|18.98|?>>
    <associate|eq 18.84.018|<tuple|18.99|?>>
    <associate|eq 18.85.018|<tuple|18.100|?>>
    <associate|eq 18.86.018|<tuple|18.101|?>>
    <associate|eq 18.87.018|<tuple|18.102|?>>
    <associate|eq 18.9.014|<tuple|18.23|?>>
    <associate|eq 18.9.020|<tuple|18.9|?>>
    <associate|generalized rectangles and boundaries|<tuple|18.26|?>>
    ...
    <associate|length of interval and the Lebesgue outer
    measure|<tuple|18.60|?>>
    <associate|measurable set alternative definition|<tuple|18.47|?>>
    <associate|measurable space|<tuple|18.10|?>>
    <associate|measure|<tuple|18.37|?>>
    <associate|measure is subadditive|<tuple|18.40|?>>
    <associate|measure properties (1)|<tuple|18.39|?>>
    <associate|measure properties (2)|<tuple|18.41|?>>
    <associate|measureable set|<tuple|18.46|?>>
    <associate|open,half open and bounded intervals are
    different|<tuple|18.21|?>>
    <associate|outer measure|<tuple|18.43|?>>
    <associate|outer measure finite subadditivity|<tuple|18.44|?>>
    <associate|outer measure on R|<tuple|18.53|?>>
    <associate|outermeasure construction|<tuple|18.45|?>>
    <associate|properties of algebras|<tuple|18.7|?>>
    <associate|semi additivity of the length in the reals|<tuple|18.52|?>>
    <associate|set of Dyadic intervals is denumerable|<tuple|18.30|?>>
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      ...
      <tuple|<tuple|Carathéodory theorem>|<pageref|auto-13>>

      <tuple|<tuple|Lebesgue measurable space>|<pageref|auto-15>>

      <tuple|<tuple|Lebesgue measure>|<pageref|auto-16>>

      <tuple|<tuple|Lebesgue measurable set>|<pageref|auto-17>>

      <tuple|<tuple|Lebesgue outer measure>|<pageref|auto-18>>
    </associate>
    <\associate|toc>
