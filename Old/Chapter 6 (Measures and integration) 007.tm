...
<\body>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <math|f+g:dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\<rightarrow\>\<bbb-R\>>
      ...
      is <math|\<cal-A\>>-measurable. <space|255em>
      ...
      <math|\<forall\>x\<in\>dom<around*|(|f|)>> is
      <math|\<cal-A\>>-measurable.

      <item>If <math|f,g> are <math|\<cal-A\>>-measurable partial functions
      then <math|f\<cdot\>g:X\<rightarrow\>\<bbb-R\>> defined by
      <math|<around*|(|f\<cdot\>g|)><around*|(|x|)>=f<around*|(|x|)>\<cdot\>g<around*|(|x|)>>
      <math|\<forall\>x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>>
      is Borel measurable.

      <item>If <math|f,g> are <math|\<cal-A\>>-measurable partial functions
      then <math|f/g:X\<rightarrow\>\<bbb-R\>> defined by
      <math|<around*|(|f/g|)><around*|(|x|)>=f<around*|(|x|)>/g<around*|(|x|)>>
      <math|\<forall\>x\<in\>dom<around*|(|f|)><big|cap><around*|{|x\<in\>dom<around*|(|g|)>\|g<around*|(|x|)>\<neq\>0|}>>
      is <math|\<cal-A\>>-measurable.
  ...
  <\theorem>
    ...
    <\enumerate>
      <item>Let <math|D=<around*|{|x\<in\><big|cup><rsub|n\<in\>\<bbb-N\>><around*|(|<big|cap><rsub|i\<in\><around*|{|n,\<ldots\>,\<infty\>|}>>dom<around*|(|f<rsub|i>|)>|)>\|\<exists\>n\<in\>\<bbb-N\>
      ...
      <around*|[|here <below|lim|i\<rightarrow\>\<infty\>>f<rsub|i><around*|(|x|)>
      is the limit of <around*|{|f<rsub|i><around*|(|x|)>|}><rsub|i\<in\><around*|{|n,\<ldots\>,\<infty\>|}>>|]>|}>>
      then <math|<below|lim|i\<rightarrow\>\<infty\>>f<rsub|i>:X\<rightarrow\>\<bbb-R\>>
      defined by <math|<around*|(|<below|lim|i\<rightarrow\>\<infty\>>f<rsub|i>|)><around*|(|x|)>=<below|lim|i\<rightarrow\>\<infty\>>f<rsub|i><around*|(|x|)>>
      <math|\<forall\>x\<in\>D> is <math|\<cal-A\>>-measurable. [so
      <math|D=dom<around*|(|<below|lim|i\<rightarrow\>\<infty\>>f|)>>]

      <item>Let <math|D=<around*|{|x\<in\><big|cap><rsub|i\<in\>\<bbb-N\>>D<rsub|i>\|sup<around*|(|<around*|{|f<rsub|i><around*|(|x|)>\|i\<in\>\<bbb-N\>|}>|)>\<in\>\<bbb-R\>|}>>
      then <math|<below|sup|i\<in\>\<bbb-N\>>f<rsub|i>:X\<rightarrow\>\<bbb-R\>>
      ...
      then <math|<below|inf|i\<in\>\<bbb-N\>>f<rsub|i>:X\<rightarrow\>\<bbb-R\>>
      ...
      then <math|<below|lim inf|i\<rightarrow\>\<infty\>>f<rsub|i>:X\<rightarrow\>\<bbb-R\>>
      defined by <math|<around*|(|<below|lim
      inf|i\<rightarrow\>\<infty\>>f<rsub|i>|)><around*|(|x|)>=<below|lim
      inf|i\<rightarrow\>\<infty\>>f<rsub|i><around*|(|x|)>>
      <math|\<forall\>x\<in\>D> is <math|\<cal-A\>>-measurable. \ [so
      <math|D=dom<around*|(|<below|lim|i\<rightarrow\>\<infty\>>f|)>>]

      <item>Let <math|D=<around*|{|x\<in\><big|cap><rsub|i\<in\>\<bbb-N\>>D<rsub|i>\|<below|lim
      sup|i\<rightarrow\>\<infty\>>f<rsub|i><around*|(|x|)>\<in\>\<bbb-R\>|}>>
      then <math|<below|lim sup|i\<rightarrow\>\<infty\>>f<rsub|i>:X\<rightarrow\>\<bbb-R\>>
      defined by <math|<around*|(|<below|lim
      sup|i\<rightarrow\>\<infty\>>f<rsub|i>|)><around*|(|x|)>=<below|lim
      sup|i\<rightarrow\>\<infty\>>f<rsub|i><around*|(|x|)>>
      <math|\<forall\>x\<in\>D> is <math|\<cal-A\>>-measurable. \ [so
      <math|D=dom<around*|(|<below|lim|i\<rightarrow\>\<infty\>>f|)>>]
    </enumerate>
  </theorem>
  ...
  <\lemma>
    ...
    and if the limit or supremum exists then
    <math|<below|lim|n\<rightarrow\>\<infty\>><big|int><rsup|S>f<rsub|n>d\<mu\>=sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)>>
  </lemma>
  ...
  <\lemma>
    ...
    <\enumerate>
      <item><math|dom<around*|(|f|)>> is a conegligible subset of <math|X>
  ...
  <\proof>
    ...
    <math|\<forall\>x\<in\>dom<around*|(|f|)><big|cap>D<rprime|'>> we have
    <math|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=f<around*|(|x|)>>.
    Using <smart-ref|conegligible sets properties> we have that\ 

    <\equation>
      <label|eq 18.223.005>dom<around*|(|f|)><big|cap>D<rprime|'> is
      conegligible
    </equation>

    If <math|x\<in\>dom<around*|(|f|)><big|cap>D<rprime|'>> then as
    ...
    <\equation>
      <label|eq 18.224.005>\<forall\>x\<in\>dom<around*|(|f|)><big|cap>D<rprime|'>
    ...
    <math|\<forall\>x\<in\>D<rprime|''><big|cap>dom<around*|(|f|)>> we have
    <math|g<around*|(|x|)>\<leqslant\>f<around*|(|x|)>>, hence
    <math|\<forall\>x\<in\>D<rprime|''><big|cap>D<rprime|'><big|cap>dom<around*|(|f|)>>
    [a conegligible set by <smart-ref|conegligible sets properties>]we have
    ...
    that <math|<big|int><rsup|S>g d\<mu\>\<leqslant\>sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)>>.
  ...
  <\definition>
    ...
    <\enumerate>
      ...
      <item>There exists a sequence <math|<around*|{|f<rsub|n>|}><rsub|n\<in\>\<bbb-N\>>>
      of simple functions such that <math|\<forall\>n\<in\>\<bbb-N\>><space|1em><math|0\<leqslant\>f<rsub|n>\<leqslant\>f<rsub|n+1>>,
      <math|sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)>\<less\>\<infty\>>
      [or using <smart-ref|integral of increasing simple functions>
      <math|<below|lim|n\<rightarrow\>\<infty\>><big|int><rsup|S>f<rsub|n>d\<mu\>\<less\>\<infty\>>]
      and <math|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=<rsub|a.e.>f<around*|(|x|)>>
  ...
  <\note>
    If it is clear from the context what the measure space is then we use the
    notation <math|\<cal-L\><rsub|+>> for
    <math|\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>>
  </note>
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|0\<leqslant\>f<around*|(|x|)>\<less\>2<rsup|n>>>then
      <math|f<rsub|n><around*|(|x|)>=<frac|k<rsub|n><around*|(|f<around*|(|x|)>|)>|2<rsup|n>>>
      and <math|f<rsub|n><around*|(|x|)>=<frac|k<rsub|n><around*|(|f<around*|(|x|)>|)>|2<rsup|n>>\<leqslant\>f<around*|(|x|)>\<less\><frac|k<rsub|n><around*|(|f<around*|(|x|)>|)>+1|2<rsup|n>>>
    ...
    Note <math|S=sup<around*|(|<around*|{|f<rsub|n><around*|(|x|)>\|n\<in\>\<bbb-N\>|}>|)>>
    and assume that <math|S=sup<around*|(|<around*|{|f<rsub|n><around*|(|x|)>\|n\<in\>\<bbb-N\>|}>|)>\<less\>f<around*|(|x|)>>
    then <math|0\<less\>f<around*|(|x|)>-S> using
    ...
    <math|sS\<less\>2<rsup|N<rsub|3>>>. So if we take
  ...
  <\lemma>
    ...
    <math|\<forall\>a\<in\>\<bbb-R\>> <math|<around*|{|a\<leqslant\>f<rsub|\|E>|}>\<in\>\<cal-A\>>
  </lemma>

  <\proof>
    First note that <math|dom<around*|(|f<rsub|\|E>|)>=E<big|cap>dom<around*|(|f|)>\<equallim\><rsub|E\<subseteq\>dom<around*|(|f|)>>E>
    then as <math|f<rsub|\|E>> is <math|\<cal-A\>>-measurable we have by
    <smart-ref|measurable functions conditions> that
  ...
  <\lemma>
    ...
    <math|f<around*|(|X|)>\<subseteq\><around*|[|0,\<infty\>|[>> where
    <math|dom<around*|(|f|)>> is a conegligible subset of <math|X> then we
    have that
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        because <math|E\<in\>\<cal-A\>,<around*|(|a|)>,<around*|(|b|)>> and
      ...
      <math|h:X\<rightarrow\>\<bbb-R\>> be a partial function such that
      <math|dom<around*|(|h|)>> is a conegligible subset of <math|X> with
      <math|h<around*|(|X|)>\<subseteq\><around*|[|0,\<infty\>|[>> then if
      <math|h\<leqslant\><rsub|a.e.>f> and there exists conegligible <math|F>
      such that <math|h<rsub|\|F>> is <math|\<cal-A\>>-measurable then
      <math|h\<in\>\<cal-L\><rsub|+>>
    </enumerate>
  </lemma>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|<around*|{|x\<in\>dom<around*|(|f|)>\|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=f<around*|(|x|)>|}>\<subseteq\>dom<around*|(|f|)>>
      is conegligible and using <smart-ref|conegligible sets properties>
      ...
      <\equation>
        <label|eq 18.227.005>E\<in\>\<cal-A\>,E\<subseteq\>dom<around*|(|f|)><infix-and>f<rsub|\|E>=<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>
      ...
      As <math|f<rsub|\|E>> is measurable we have using
      (1.a),(1.b),<math|E\<in\>\<cal-A\>> and <smart-ref|measurable function
      restriction property> that <math|<around*|{|<frac|k|2<rsup|n>>\<leqslant\>f<rsub|\|E>|}>\<in\>\<cal-A\>>
      and using (1.c) that we have that <math|\<mu\><around*|(|<around*|{|<frac|k|2<rsup|n>>\<leqslant\>f<rsub|\|E>|}>|)>\<less\>\<infty\>>
      hence we have that <math|<around*|{|f<rsub|n>|}><rsub|n\<in\>\<bbb-N\>>\<subseteq\>\<cal-S\><around*|[|X,\<cal-A\>|]>>.
      ...
      Further as <math|\<forall\>n\<in\>\<bbb-N\>> we have that
      ...
      18.243.006>>>f<rsub|\|E><around*|(|x|)>=x> which as <math|E> is
      conegligible means that <math|f<rsub|n>\<leqslant\><rsub|a.e.>f> so
      that <math|<big|int><rsup|S>f<rsub|n>d\<mu\>\<in\><around*|{|<big|int><rsup|S>g
      ...
      <\equation>
        <label|eq 18.246.006>f\<in\>\<cal-L\><rsub|+>
      </equation>

      which proves the reverse implication.

      <item>As <math|f\<in\>\<cal-L\><rsub|+>> there exists by
      (1.a),(1.b),(1,c),(1,d) a conegligible set <math|E\<in\>\<cal-A\>> with
      <math|E\<subseteq\>dom<around*|(|f|)>>,<math|f<rsub|\|E>>
      ...
      d\<mu\>\<of\>g\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>with
      g\<leqslant\><rsub|a.e.>f|}>|)>\<less\>\<infty\>><math|>. Further as
      <math|h\<leqslant\><rsub|a.e.>f> we have that
      <math|<around*|{|x\<in\>dom<around*|(|h|)><big|cap>dom<around*|(|h|)>\|h<around*|(|x|)>\<leqslant\>f<around*|(|x|)>|}>>
      is conegligible and we have stated that <math|F> and
      <math|dom<around*|(|h|)>> are conegligible. So using
      <smart-ref|conegligible sets properties> there exist a conegligible set
      <math|E<rprime|'>\<in\>\<cal-A\>> such that
      <math|E<rprime|'>\<subseteq\>E<big|cap>F<big|cap>dom<around*|(|h|)><big|cap><around*|{|x\<in\>dom<around*|(|h|)><big|cap>dom<around*|(|f|)>\|h<around*|(|x|)>\<leqslant\>f<around*|(|x|)>|}>>.
      ...
      <smart-ref|eq 18.249.006> are equivalent wit (1.a),(1.b),(1.c) and
      (1.d) so that\ 
  ...
  <math|\<cal-L\><rsub|+>> is called the set of positive integrable functions
  so it make sense to define the integral for
  <math|f\<in\>\<cal-L\><rsub|+>>. This is done in the following definition.
  ...
  <\definition>
    ...
    <math|f\<in\>\<cal-L\><rsub|1>> then the integral of <math|f> noted by
    <math|<big|int><rsup|S>f d\<mu\>> is defined as\ 
  ...
  <\proposition>
    ...
    <math|f\<in\>\<cal-L\><rsub|+>> then <math|\<forall\><around*|{|f<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-S\><around*|[|X|]>>
    such that <math|\<forall\>n\<in\>\<bbb-N\>>
    ...
    <math|<big|int><rsup|+>f d\<mu\>=<below|lim|n\<rightarrow\>\<infty\>><big|int><rsup|S>f<rsub|n>d\<mu\>\<equallim\><rsub|<text|>><below|lim|n\<rightarrow\>\<infty\>><big|int><rsup|S><rsub|>f<rsub|n>d\<mu\>>
  </proposition>
  ...
  <\proposition>
    ...
    <math|f\<in\>\<cal-L\><rsub|+>> and <math|<big|int><rsup|+>f
    d\<mu\>=<big|int><rsup|S>f d\<mu\>>
  </proposition>

  <\proof>
    As <math|dom<around*|(|f|)>=X> which is conegligible (see
    <smart-ref|conegligible sets properties>) \ we have that
    <math|dom<around*|(|f|)>> is conegligible. Further define
    <math|<around*|{|f<rsub|n>|}><rsub|n\<in\>\<bbb-N\>>> by
    <math|f<rsub|n>=f> then we have <math|\<forall\>>
    <math|sup<around*|(|<around*|{|<big|int>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)>=sup<around*|(|<big|int>f
    d\<mu\>|)>=<big|int>f d\<mu\>\<less\>\<infty\>> and
    <math|\<forall\>x\<in\>X <below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=f<around*|(|x|)>>
    which as <math|X> is conegligible proves that
    <math|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>=f<rsub|\<varepsilon\>>>.
    So by definition of <math|\<cal-L\><rsub|+>> it follows that\ 
  ...
  <\lemma>
    ...
    <\enumerate>
      <item><math|\<forall\>f,g\<in\>\<cal-L\><rsub|+>> we have that
      <math|f+g\<in\>\<cal-L\><rsub|+>> and
      <math|<big|int><rsup|+><around*|(|f+g|)>d\<mu\>=<big|int><rsup|+>f
      d\<mu\>+<big|int><rsup|+>g d\<mu\>>

      <item><math|\<forall\>f\<in\>\<cal-L\><rsub|+>> and
      <math|c\<in\><around*|[|0,\<ldots\>,\<infty\>|[>> that
      <math|<big|int><rsup|+><around*|(|c\<cdot\>f|)>d\<mu\>=c\<cdot\><big|int><rsup|+>f
      d\<mu\>>

      <item>If <math|f,g\<in\>\<cal-L\><rsub|+>> and
      <math|f\<leqslant\><rsub|a.e.>g> then <math|<big|int><rsup|+>f
      d\<mu\>\<leqslant\><big|int><rsup|+>g d\<mu\>>

      <item>If <math|f\<in\>\<cal-L\><rsub|+>> and
      <math|g:X\<rightarrow\>\<bbb-R\>> a partial function with
      <math|dom<around*|(|g|)>> a conegligible subset of <math|X>,
      <math|g<around*|(|X|)>\<subseteq\><around*|[|0,\<infty\>|[>> and
      <math|f=<rsub|a.e.>g> then <math|g\<in\>\<cal-L\><rsub|+>> and
      <math|<big|int><rsup|+>f d\<mu\>=<big|int><rsup|+>g d\<mu\>>

      <item>If <math|f<rsub|1>,g<rsub|1>,f<rsub|2>,g<rsub|2>\<in\>\<cal-L\><rsub|+>>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>As <math|f,g\<in\>\<cal-L\><rsub|+>> then
      <math|f<around*|(|X|)>\<subseteq\><around*|[|0,\<infty\>|[>,g<around*|(|X|)>\<subseteq\><around*|[|0,\<infty\>|[>,dom<around*|(|f|)>,dom<around*|(|g|)>>
      ...
      \ As <math|dom<around*|(|f+g|)>=dom<around*|(|f|)><big|cap>dom<around*|(|g|)>>
      a intersection of conegligible sets we have by <smart-ref|conegligible
      sets properties> that

      <\equation>
        <label|eq 18.251.006>dom<around*|(|f+g|)> is conegligible
      </equation>
      ...
      Using <smart-ref|eq 18.250.006>,<smart-ref|eq 18.251.006>,<smart-ref|eq
      18.252.006>,<smart-ref|eq 18.254.006> we have by the definition of
      <math|\<cal-L\><rsub|+>> that\ 

      <\equation>
        <label|eq 18.255.006>f+g\<in\>\<cal-L\><rsub|+>
      </equation>
      ...
      <item>As <math|f\<in\>\<cal-L\><rsub|+>> we have that
      <math|f<around*|(|X|)>\<subseteq\><around*|[|0,\<infty\>|[>,dom<around*|(|f|)>>
      are conegligible and there exists <math|<around*|{|f<rsub|n>|}><rsub|n\<in\>\<bbb-N\>>\<subseteq\>\<cal-S\><around*|[|X,\<cal-A\>|]>>
      with <math|\<forall\>n\<in\>\<bbb-N\>>
      <math|0\<leqslant\>f<rsub|n>\<leqslant\>f<rsub|n+1>>,
      ...
      <\equation>
        ...
        0\<leqslant\>c\<cdot\>f<rsub|n>\<leqslant\>c\<cdot\>f<rsub|n>
      </equation>
      ...
      <\equation>
        <label|eq 18.260.006>dom<around*|(|c\<cdot\>f|)>=dom<around*|(|f|)> a
        conigligible set
      </equation>

      Using <smart-ref|eq 18.256.006>,<smart-ref|eq 18.257.006>,<smart-ref|eq
      18.259.006>,<smart-ref|eq 18.260.006> \ we have by the definition of
      <math|\<cal-L\><rsub|+>> that

      <\equation>
        <label|eq 18.261.006>c\<cdot\>f\<in\>\<cal-L\><rsub|+>
      </equation>
      ...
      <item>As <math|f,g\<in\>\<cal-L\><rsub|+>> with
      <math|f\<leqslant\><rsub|a.e.>g> <math|E=<around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|f<around*|(|x|)>\<leqslant\>g<around*|(|x|)>|}>>
      ...
      <\equation*>
        ...
        d\<mu\>\|h\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>\<wedge\>h\<leqslant\><rsub|a.e.>g|}>|)>=<big|int><rsup|+>g<space|1em>d\<mu\>
      </equation*>
      ...
      [a conegligible set we have <math|<around*|(|f<rsub|1>+g<rsub|2>|)><around*|(|x|)>=f<rsub|1><around*|(|x|)>+g<rsub|2><around*|(|x|)>=f<rsub|2><around*|(|x|)>+g<rsub|1><around*|(|x|)>=<around*|(|f<rsub|2>+g<rsub|1>|)><around*|(|x|)>>
  ...
  <\definition>
    ...
    <math|f<rsub|1>,f<rsub|2>\<in\>\<cal-L\><rsub|+>> such that
    <math|f=f<rsub|1>-f<rsub|2>> [here we assume that
  ...
  <\note>
    If from the context it is clear what the measure space is then we use the
    notation <math|\<cal-L\><rsub|1>> for
    <math|\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
  </note>

  <\notation>
    A other notation that sometimes will be used is
    <math|<big|int>f<around*|(|x|)>d\<mu\><around*|(|x|)>> which will be
    usefull in the following cases:

    <\enumerate>
      <item>To avoid execisve notation. Instead of saying: Take
      ...
      <item>Parametrized functions. Instead of saying: Let
  ...
  <\proposition>
    ...
    <\enumerate>
      <item>If <math|f\<in\>\<cal-L\><rsub|+>> then <math|f\<in\>\<cal-L\>>
      and <math|<big|int>f d\<mu\>=<big|int><rsup|+>f d\<mu\>>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>If <math|f\<in\>\<cal-L\><rsub|+>> then <math|f=f-C<rsub|0>>
      where <math|f,C<rsub|0>\<in\>\<cal-L\><rsub|+>> where
      <math|dom<around*|(|f|)>=dom<around*|(|f|)><big|cap>X=dom<around*|(|f|)><big|cap>dom<around*|(|c<rsub|0>|)>>
      ...
      are elements of <math|\<cal-L\><rsub|+>> [using <smart-ref|integral of
      simple function extension>] so that <math|f\<in\>\<cal-L\>>
    </enumerate>
  </proof>
</body>
...
<\references>
  <\collection>
    ...
    <associate|Borel functions and intersection|<tuple|18.95|?>>
    ...
    <associate|a.e. condition|<tuple|18.27|?>>
    ...
    <associate|auto-42|<tuple|<with|mode|<quote|math>|<big|int>f d\<mu\>>|?>>
    <associate|auto-43|<tuple|integral|?>>
    ...
    <associate|characteristics function properties|<tuple|18.105|?>>
    <associate|characteristics function recapitulation|<tuple|18.102|?>>
    <associate|charcteristics function is measurable|<tuple|18.104|?>>
    <associate|closed intervals and Borel Sets|<tuple|18.57|?>>
    <associate|conegligible sets|<tuple|18.24|?>>
    <associate|conegligible sets properties|<tuple|18.26|?>>
    ...
    <associate|eq 18.251.006|<tuple|18.251|?>>
    <associate|eq 18.252.006|<tuple|18.252|?>>
    <associate|eq 18.253.006|<tuple|18.253|?>>
    <associate|eq 18.254.006|<tuple|18.254|?>>
    <associate|eq 18.255.006|<tuple|18.255|?>>
    <associate|eq 18.256.006|<tuple|18.256|?>>
    <associate|eq 18.257.006|<tuple|18.257|?>>
    <associate|eq 18.258.006|<tuple|18.258|?>>
    <associate|eq 18.259.006|<tuple|18.259|?>>
    <associate|eq 18.26.001|<tuple|18.37|?>>
    <associate|eq 18.260.006|<tuple|18.260|?>>
    <associate|eq 18.261.006|<tuple|18.261|?>>
    ...
    <associate|functions and a.e.|<tuple|18.28|?>>
    ...
    <associate|integral|<tuple|18.130|?>>
    <associate|integral of increasing simple functions|<tuple|18.118|?>>
    <associate|integral of positive integrable function|<tuple|18.125|?>>
    <associate|integral of positive integrable function
    alternative|<tuple|18.126|?>>
    <associate|integral of positive integrable functions
    properties|<tuple|18.129|?>>
    <associate|integral of simple function extension|<tuple|18.127|?>>
    <associate|integral of simple function properties|<tuple|18.115|?>>
    <associate|integral of te zero function|<tuple|18.128|?>>
    ...
    <associate|make measurable sets pairwise disjoint|<tuple|18.111|?>>
    <associate|measurable function extension|<tuple|18.100|?>>
    <associate|measurable function operations|<tuple|18.98|?>>
    <associate|measurable function restriction property|<tuple|18.123|?>>
    <associate|measurable functions|<tuple|18.87|?>>
    <associate|measurable functions and continuity|<tuple|18.91|?>>
    <associate|measurable functions and generators|<tuple|18.90|?>>
    <associate|measurable functions and limits|<tuple|18.99|?>>
    <associate|measurable functions conditions|<tuple|18.94|?>>
    <associate|measurable maps composition|<tuple|18.92|?>>
    ...
    <associate|positive integrable function alternative|<tuple|18.124|?>>
    <associate|positive integrable function properties|<tuple|18.119|?>>
    <associate|property of Dyadic interval of order n|<tuple|18.52|?>>
    <associate|reindex union of sets|<tuple|18.15|?>>
    <associate|representation of a simple function|<tuple|18.108|?>>
    ...
    <associate|simple function null set|<tuple|18.116|?>>
    <associate|simple function standard representation|<tuple|18.112|?>>
    <associate|simple functions increasing and sup|<tuple|18.117|?>>
    <associate|simple functions properties (basic)|<tuple|18.110|?>>
    ...
    <associate|writing a partial function as a limit|<tuple|18.122|?>>
  </collection>
</references>
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      ...
      d\<mu\>>>|<pageref|auto-42>>

      <tuple|<tuple|integral>|<pageref|auto-43>>
    </associate>
    <\associate|toc>
