...
<\body>
  ...
  <\proof>
    ...
    [as if <math|<around*|\<\|\|\>|<around*|(|x,y|)>|\<\|\|\>>\<leqslant\>1\<Rightarrow\><around*|\||x|\|>,<around*|\||y|\|>\<leqslant\>1>
    proving <math|<around*|\||x\<cdot\>y|\|>\<leqslant\><around*|\||x|\|>\<cdot\><around*|\||y|\|>\<leqslant\>1>
    and thus that <math|p> is continuous] so that it is differentiable with
  ...
  <\corollary>
    ...
    <math|f,g:U\<rightarrow\>\<bbb-K\>> functions that have a derivative at
  ...
  <\corollary>
    ...
    derivative at <math|x\<in\>\<bbb-K\>\\<around*|{|0|}>> (a open set) given
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\description>
        ...
        that <math|<around*|(|\<ast\><rsup|1>|)><rprime|'><around*|(|x|)>=D\<ast\><rsup|1><around*|(|x|)><around*|(|1|)>=\<ast\><rsup|1><around*|(|1|)>=1<rsup|1>=1=1\<cdot\>x<rsup|0>=1\<cdot\>x<rsup|z-1>*>
        so that <math|1\<in\>S>
      ...
      <\description>
        <item*|<math|1\<in\>S>>If <math|z=1> then
        <math|\<ast\><rsup|-1>:\<bbb-K\>\\<around*|{|0|}>\<rightarrow\>\<bbb-K\>\\<around*|{|0|}>>
        is defined by <math|x\<rightarrow\><frac|1|x>> now if
        <math|x\<in\>\<bbb-K\>\\<around*|{|0|}> and h \ so that
        ...
        then if <math|0\<less\><around*|\||h|\|>\<less\>\<delta\>> such that
        <math|x+h\<in\>\<bbb-K\>\\<around*|{|0|}>> (meaning
        <math|h\<in\><around*|(|\<bbb-K\>\\<around*|{|0|}>|)><rsub|x>>) we
        have <math|<around*|\||h|\|>\<less\><frac|<around*|\||x|\|>|2>>
        ...
        and thus <math|<around*|\||<frac|h|x<rsup|2>\<cdot\><around*|(|x+h|)>>|\|>=<frac|<around*|\||h|\|>|<around*|\||x|\|><rsup|2>\<cdot\><around*|\||x+h|\|>>\<less\><frac|2\<cdot\><around*|\||h|\|>|<around*|\||x|\|>\<cdot\><around*|\||x|\|><rsup|2>>=2\<cdot\><frac|<around*|\||h|\|>|<around*|\||x|\|><rsup|3>>\<leqslant\>2\<cdot\><frac|\<varepsilon\>\<cdot\><around*|\||x|\|><rsup|3>|<around*|\||x<rsup|3>|\|>\<cdot\>2>=\<varepsilon\>>
        [as <math|<around*|\||h|\|>\<less\>\<delta\>\<less\><frac|\<varepsilon\>\<cdot\><around*|\||x|\|><rsup|3>|2>>
        ...
        <item*|<math|z\<in\>S=z+1\<in\>S>>If <math|z\<in\>S> then
        <math|<around*|(|\<ast\>|)><rsup|-<around*|(|z+1|)>><around*|(|x|)>=<frac|1|\<ast\><rsup|z+1><around*|(|x|)>>=<frac|1|x<rsup|z+1>>=<frac|1|x\<cdot\>x<rsup|z>>><math|=<around*|(|\<ast\><rsup|-1>|)><around*|(|x|)>\<cdot\><around*|(|\<ast\><rsup|-z>|)><around*|(|x|)>>
  ...
  <\definition>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>V> a function
    then <math|f> is <math|n>-times differentiable on <math|U> with
    <math|n>-the differential <math|D<rsup|n>f:U\<rightarrow\>L<rsup|n><around*|(|X;Y|)>>
    if one of the following is correct:
  ...
  <\definition>
    ...
    <math|f> is of class <math|C<rsup|n>> if either

    <\enumerate>
      <item>For <math|n=0> \ <math|f> must be continuous on <math|U>

      <item>For <math|1\<less\>n> <math|f> must be \ <math|n>-times
  ...
  <\definition>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|<math|V>\<subseteq\>Y> and <math|f:U\<rightarrow\>V> a function
    then <math|f> is of class <math|C<rsup|\<infty\>>> if
    <math|\<forall\>n\<in\>\<bbb-N\>> we have that <math|f> is of class
    <math|C<rsup|n>>. Functions of class <math|C<rsup|\<infty\>>> are also
    called <with|font-series|bold|smooth> functions.
  </definition>
...
<\references>
  <\collection>
    ...
    <associate|auto-20|<tuple|13.38|18>>
    <associate|auto-21|<tuple|13.39|19>>
    <associate|auto-22|<tuple|13.3|21>>
    <associate|auto-23|<tuple|13.75|21>>
    <associate|auto-24|<tuple|13.75|21>>
    <associate|auto-25|<tuple|13.75|23>>
    <associate|auto-26|<tuple|13.75|23>>
    <associate|auto-27|<tuple|13.4|23>>
    <associate|auto-28|<tuple|13.80|26>>
    <associate|auto-29|<tuple|13.80|28>>
    <associate|auto-3|<tuple|13.1.1|11>>
    <associate|auto-30|<tuple|13.80|28>>
    <associate|auto-31|<tuple|13.82|28>>
    <associate|auto-32|<tuple|13.83|29>>
    <associate|auto-33|<tuple|13.85|29>>
    <associate|auto-34|<tuple|13.86|29>>
    <associate|auto-35|<tuple|13.87|29>>
    <associate|auto-36|<tuple|13.90|29>>
    <associate|auto-37|<tuple|13.90|29>>
    <associate|auto-38|<tuple|13.5|31>>
    <associate|auto-39|<tuple|13.6|31>>
    <associate|auto-4|<tuple|13.1|11>>
    <associate|auto-40|<tuple|13.7|31>>
    <associate|auto-41|<tuple|13.116|31>>
    <associate|auto-42|<tuple|13.118|31>>
    <associate|auto-43|<tuple|13.120|?>>
    <associate|auto-44|<tuple|13.134|?>>
