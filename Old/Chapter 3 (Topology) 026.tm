...
<\body>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      and thus <math|<big|cup><rsub|i\<in\>I>U<rsub|i>=<big|cup><rsub|i\<in\>I><around*|(|X\\A<rsub|i>|)>\<equallim\><rsub|<with|mode|text|<reference|generalized
      difference>>>X\\<around*|(|<big|cap><rsub|i\<in\>I>A<rsub|i>|)>>
    </enumerate>

    Now if <math|A> is closed in <math|\<cal-T\>> then
    <math|X\\A\<in\>\<cal-T\>> so there exists a <math|C\<in\>\<cal-C\>> such
    that <math|X\\A=X\\C> we have then <math|A\<equallim\><rsub|A\<subseteq\>X\<wedge\><with|mode|text|<reference|distributivity
    ...
    <math|A\<in\>\<cal-C\>> then by definition <math|X\\A\<in\>\<cal-T\>> so
    <math|A> is closed in <math|\<b-cal-T\>> and thus <math|\<cal-C\>> is a
    subset of the set of closed sets in <math|\<cal-T\>>. These two last
  ...
  <\proof>
    ...
    <math|x\<nin\><wide|A|\<bar\>>> then <math|x\<in\>X\\<wide|A|\<bar\>>> a
    open set so that we have <math|\<emptyset\>\<neq\><around*|(|X\\<wide|A|\<bar\>>|)><big|cap>A=<around*|(|X<big|cap><wide|A|\<bar\>><rsup|c>|)><big|cap>A=X<big|cap><around*|(|<wide|A|\<bar\>><rsup|c><big|cap>A|)>\<equallim\><rsub|A\<subseteq\><wide|A|\<bar\>>>X<big|cap>\<emptyset\>=\<emptyset\>\<Rightarrow\>\<emptyset\>\<neq\>\<emptyset\>>
  ...
  <\proof>
    ...
    <math|A\<subseteq\>I> such that <math|\<forall\>i\<in\>A> we have
    <math|U<rsub|i>\<in\>\<cal-T\><rsub|i>>, <math|\<forall\>i\<in\>I\\A> we
    have <math|U<rsub|i>=X<rsub|i>\<in\>\<cal-T\><rsub|i>> and
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|A<rsup|\<circ\>>> is open means by the density of <math|X\\A> in
      <math|X> means that <math|A<rsup|\<circ\>><big|cap><around*|(|X\\A|)>\<neq\>\<emptyset\>>
  ...
  <\proof>
    ...
    closed ball and let <math|y\<in\>X\\<wide|B|\<bar\>><rsub|d><around|(|x,\<varepsilon\>|)>\<Rightarrow\>d<around|(|x,y|)>\<gtr\>\<varepsilon\>>
    ...
    a contradiction, so <math|d<around|(|z,x|)>\<gtr\>\<varepsilon\>\<Rightarrow\>z\<in\>X\\<wide|B|\<bar\>><rsub|d><around|(|x,\<varepsilon\>|)>\<Rightarrow\>B<rsub|d><around|(|y,\<delta\>|)>\<subseteq\>X\\<wide|B|\<bar\>><rsub|d><around|(|x,\<varepsilon\>|)>\<Rightarrowlim\><rsub|<reference|open
    sets in metric topology>>X\\<wide|B|\<bar\>><rsub|d><around|(|x,\<varepsilon\>|)>>
  ...
  <\example>
    <label|every closed, open ball is bounded>Let
    <math|<around*|\<langle\>|X,d|\<rangle\>>> be a metric space then every
    closed and open ball is bounded
  </example>

  <\proof>
    Let <math|<wide|B<rsub|d>|\<bar\>><around*|(|a,\<delta\>|)>> be a closed
    ball then if <math|M=2\<cdot\>\<delta\>> we have if
    <math|x,y\<in\><wide|B<rsub|d>|\<bar\>><around*|(|a,\<delta\>|)>> that
    <math|d<around*|(|x,y|)>\<leqslant\>d<around*|(|x,a|)>+d<around*|(|a,y|)>\<leqslant\>\<delta\>+\<delta\>=2\<cdot\>\<delta\>>.
    As <math|B<rsub|d><around*|(|a,\<delta\>|)>\<subseteq\><wide|B<rsub|d>|\<bar\>><around*|(|a,\<delta\>|)>>
    we have also that <math|<wide|B<rsub|d>|\<bar\>><around*|(|a,\<delta\>|)>>
    is bounded.
  </proof>
  ...
  <\theorem>
    <label|norm properties>Let <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    be a normed space then

    <\enumerate>
      <item><math|\<forall\>x,y> we have <math|<around*|\||<around*|\<\|\|\>|x|\<\|\|\>>-<around*|\<\|\|\>|y|\<\|\|\>>|\|>\<leqslant\><around*|\<\|\|\>|x+y|\<\|\|\>>>

      <item>If <math|I> is a non empty finite set,
      <math|<around*|{|a<rsub|i>|}><rsub|i\<in\>I>> then
      <math|<around*|\<\|\|\>|<big|sum><rsub|i\<in\>I>a<rsub|i>|\<\|\|\>>\<leqslant\><big|sum><rsub|i\<in\>I><around*|\<\|\|\>|a<rsub|i>|\<\|\|\>>>
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><math|<around*|\<\|\|\>|x|\<\|\|\>>=<around*|\<\|\|\>|x+y-y|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|x+y|\<\|\|\>>+<around*|\<\|\|\>|-y|\<\|\|\>>=<around*|\<\|\|\>|x+y|\<\|\|\>>+<around*|\<\|\|\>|y|\<\|\|\>>\<Rightarrow\><around*|\<\|\|\>|x|\<\|\|\>>-<around*|\<\|\|\>|y|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|x+y|\<\|\|\>>>
      and <math|<around*|\<\|\|\>|y|\<\|\|\>>=<around*|\<\|\|\>|x+y-x|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|x+y|\<\|\|\>>+<around*|\<\|\|\>|-x|\<\|\|\>>=<around*|\<\|\|\>|x+y|\<\|\|\>>+<around*|\<\|\|\>|x|\<\|\|\>>\<Rightarrow\><around*|\<\|\|\>|y|\<\|\|\>>-<around*|\<\|\|\>|x|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|x+y|\<\|\|\>>>.
      From this it follows that <math|<around*|\||<around*|\<\|\|\>|x|\<\|\|\>>-<around*|\<\|\|\>|y|\<\|\|\>>|\|>\<leqslant\><around*|\<\|\|\>|x+y|\<\|\|\>>>.

      <item>We first prove that <math|<around*|\<\|\|\>|<big|sum><rsub|i=1><rsup|n>a<rsub|i>|\<\|\|\>>\<leqslant\><big|sum><rsub|i=1><rsup|n><around*|\<\|\|\>|a<rsub|i>|\<\|\|\>>>
      by induction. So let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|<around*|\<\|\|\>|<text|If
      ><around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\>X<text|
      then ><big|sum><rsub|i=1><rsup|n>a<rsub|i>|\<\|\|\>>\<leqslant\><big|sum><rsub|i=1><rsup|n><around*|\<\|\|\>|a<rsub|i>|\<\|\|\>>|}>>
      then we have\ 

      <\description>
        <item*|<math|n=1>>then if <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,1|}>>\<subseteq\>X>
        then <math|<around*|\<\|\|\>|<big|sum><rsub|i=1><rsup|1>a<rsub|i>|\<\|\|\>>=<around*|\<\|\|\>|a<rsub|1>|\<\|\|\>>=<big|sum><rsub|i=1><rsup|1><around*|\<\|\|\>|a<rsub|i>|\<\|\|\>>>
        proving that <math|1\<in\>\<cal-S\>>

        <item*|<math|n\<in\>\<cal-S\>\<Rightarrow\>n+1\<in\>\<cal-S\>>>if
        <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n+1|}>>\<subseteq\>X>
        then <math|<around*|\<\|\|\>|<big|sum><rsub|i=1><rsup|n+1>a<rsub|i>|\<\|\|\>>=<around*|\<\|\|\>|a<rsub|n+1>+<big|sum><rsub|i=1><rsup|n>a<rsub|i>|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|a<rsub|n+1>|\<\|\|\>>+<around*|\<\|\|\>|<big|sum><rsub|i=1><rsup|n>a<rsub|i>|\<\|\|\>>\<leqslant\><rsub|n\<in\>\<cal-S\>><around*|\<\|\|\>|a<rsub|n+1>|\<\|\|\>>+<big|sum><rsub|i=1><rsup|n><around*|\<\|\|\>|a<rsub|i>|\<\|\|\>>=<big|sum><rsub|i=1><rsup|n+1><around*|\<\|\|\>|a<rsub|i>|\<\|\|\>>>
        proving that <math|n+1\<in\>\<cal-S\>>
      </description>

      Finally if <math|I> is a finite non empoty set then there exists a
      <math|n\<in\>\<bbb-N\><rsub|0>> and a bijection
      <math|b:<around*|{|1,\<ldots\>,n|}>\<rightarrow\>I> such that
      <math|<big|sum><rsub|i\<in\>I>a<rsub|i>=<big|sum><rsub|i=1><rsup|n>a<rsub|b<rsub|i>>>
      so that <math|<around*|\<\|\|\>|<big|sum><rsub|i\<in\>I>a<rsub|i>|\<\|\|\>>=<around*|\<\|\|\>|<big|sum><rsub|i=1><rsup|n>a<rsub|b<rsub|i>>|\<\|\|\>>\<leqslant\><big|sum><rsub|i=1><rsup|n><around*|\<\|\|\>|a<rsub|b<rsub|i>>|\<\|\|\>>=<big|sum><rsub|i\<in\>I><around*|\<\|\|\>|a<rsub|i>|\<\|\|\>>>
    </enumerate>
  </proof>
  ...
  <\example>
    <label|[a,@@[ is closed>As a application of the above example,
    <math|\<forall\>x\<in\>\<bbb-R\>> we have that
    <math|<around*|[|x,\<infty\>|[>=<around*|{|y\<in\>\<bbb-R\>\|y\<geqslant\>x|}>>
    is closed.
  </example>

  <\proof>
    <math|\<bbb-R\>\\<around*|[|x,\<infty\>|[>=<around*|]|-\<infty\>.x|[>=<around*|{|y\|y\<less\>x|}>>
    then if <math|y\<in\><around*|]|-\<infty\>,x|[>\<Rightarrow\>y\<less\>x>
    then by density of the reals there exists a
    <math|\<delta\>\<in\>\<bbb-R\>> such that
    <math|y\<less\>\<delta\>\<less\>x>, take then
    <math|\<varepsilon\>=\<delta\>-y>, if now
    <math|z\<in\>B<rsub|<around*|\|||\|>><around*|(|y,\<varepsilon\>|)>> we
    have <math|<around*|\||y-z|\|>\<less\>\<varepsilon\>>. If now
    <math|x\<leqslant\>z\<Rightarrow\>y\<less\>x\<leqslant\>z\<Rightarrow\>z-y=<around*|\||y-z|\|>\<less\>\<delta\>-y\<Rightarrow\>z\<less\>\<delta\>\<less\>x>
    giving the contradiction <math|x\<less\>x>, so we must have that
    <math|z\<less\>x> proving that <math|B<rsub|<around*|\|||\|>><around*|(|y,\<varepsilon\>|)>\<in\>\<bbb-R\>\\<around*|[|x,\<infty\>|]>>
    and thus that <math|R\\<around*|[|x,\<infty\>|[>> is open and thus that
  ...
  <\example>
    <label|topology of the set of real numbers>If
    <math|<around*|\<langle\>|\<bbb-R\>, <mid|\|\|>|\<rangle\>>> is the
  ...
  <\example>
    <label|topology of R^n>The product topology of
    <math|\<bbb-R\><rsup|n>=<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<bbb-R\>>
  ...
  Using the above it is easy to prove that all norms in <math|\<bbb-R\>> or
  <math|\<bbb-C\>> are equivalent.
  ...
  <\proof>
    Let <math|<around*|\<\|\|\>||\<\|\|\>>> be a norm on
    <math|\<bbb-R\>>(<math|\<bbb-C\>>) then <math|\<forall\>x\<in\>\<bbb-R\>>
    (<math|\<bbb-C\>>) we have <math|<around*|\<\|\|\>|x|\<\|\|\>>=<around*|\<\|\|\>|x\<cdot\>1|\<\|\|\>>=<around*|\||x|\|>\<cdot\><around*|\<\|\|\>|1|\<\|\|\>>>
    hence we have if we take <math|M=<around*|\<\|\|\>|1|\<\|\|\>>> that
    <math|M\<cdot\><around*|\||x|\|>=<around*|\<\|\|\>|x|\<\|\|\>>> or
    <math|M\<cdot\><around*|\||x|\|>\<leqslant\><around*|\<\|\|\>|x|\<\|\|\>>\<leqslant\>M\<cdot\><around*|\||x|\|>>
    proving that <math|<around*|\<\|\|\>|x|\<\|\|\>>> is equivalent with
    <math|<around*|\|||\|>>.
  </proof>
  ...
  <\example>
    <label|inner product on R^n>Let <math|n\<in\>\<bbb-N\><rsub|0>> then if
    we define <math|<around*|\<langle\>||\<rangle\>>:\<bbb-R\><rsup|n>\<rightarrow\>\<bbb-R\>>
    by <math|<around*|\<langle\>|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>,<around*|(|y<rsub|1>,\<ldots\>,y<rsub|n>|)>|\<rangle\>>=<big|sum><rsub|i=1><rsup|n>x<rsub|i>\<cdot\>y<rsub|i>>
    then <math|<around*|\<langle\>|\<bbb-R\><rsup|n>,<around*|\<langle\>||\<rangle\>>|\<rangle\>>>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><math|><math|><math|<around*|\<langle\>|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>,<around*|(|y<rsub|1>,\<ldots\>,y<rsub|n>|)>|\<rangle\>>=<big|sum><rsub|i=1><rsup|n>x<rsub|i>\<cdot\>y<rsub|i>=<big|sum><rsub|i=1><rsup|n>y<rsub|i>\<cdot\>x<rsub|i>=<around*|\<langle\>|<around*|(|y<rsub|1>,\<ldots\>,y<rsub|n>|)>,<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>|\<rangle\>>>

      <item><math|<around*|\<langle\>|\<alpha\>\<cdot\><around*|(|x,.,\<ldots\>,x<rsub|n>|)>+\<beta\>\<cdot\><around*|(|y<rsub|1>,\<ldots\>,y<rsub|n>|)>,<around*|(|z<rsub|1>,\<ldots\>,z<rsub|n>|)>|\<rangle\>>=<around*|\<langle\>|<around*|(|\<alpha\>\<cdot\>x<rsub|1>+\<beta\>\<cdot\>y<rsub|1>,\<ldots\>,\<alpha\>\<cdot\>x<rsub|n>+\<beta\>\<cdot\>y<rsub|n>|)>,<around*|(|z<rsub|1>,\<ldots\>,z<rsub|n>|)>|\<rangle\>>=<big|sum><rsub|i=1><rsup|n><around*|(|\<alpha\>\<cdot\>x<rsub|i>+\<beta\>\<cdot\>y<rsub|i>|)>\<cdot\>z<rsub|i>=<big|sum><rsub|i=1><rsup|n><around*|(|\<alpha\>\<cdot\>x<rsub|i>\<cdot\>z<rsub|i>+\<beta\>\<cdot\>y<rsub|i>\<cdot\>z<rsub|i>|)>=\<alpha\>\<cdot\><big|sum><rsub|i=1><rsup|n>x<rsub|i>\<cdot\>z<rsub|i>+\<beta\>\<cdot\><big|sum><rsub|i=1><rsup|n>y<rsub|i>\<cdot\>z<rsub|i>=\<alpha\>\<cdot\><around*|\<langle\>|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>,<around*|(|z<rsub|1>,\<ldots\>,z<rsub|n>|)>|\<rangle\>>+\<beta\>\<cdot\><around*|\<langle\>|<around*|(|y<rsub|1>,\<ldots\>,y<rsub|n>|)>,<around*|(|z<rsub|1>,\<ldots\>,z<rsub|n>|)>|\<rangle\>>>

      <item><math|<around*|\<langle\>|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>,<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>|\<rangle\>>=<big|sum><rsub|i=1><rsup|n>x<rsub|i><rsup|2>\<geqslant\>0>

      <item>If <math|0=<around*|\<langle\>|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>,<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>|\<rangle\>>=<big|sum><rsub|i=1><rsup|n>x<rsub|i><rsup|2>>
      then if there exists a <math|i\<in\><around*|{|1,\<ldots\>,n|}>> such
      that <math|x<rsub|i>\<neq\>0 >then <math|0\<less\>x<rsub|i><rsup|2>>
      hence <math|0\<less\>x<rsub|i><rsup|2>+<big|sum><rsub|j\<in\><around*|{|1,\<ldots\>,n|}>\\<around*|{|i|}>>x<rsub|j><rsup|2>=<big|sum><rsub|j\<in\><around*|{|i|}>>x<rsub|i><rsup|2>+<big|sum><rsub|j\<in\><around*|{|1,\<ldots\>,n|}>\\<around*|{|i|}>>x<rsub|j><rsup|2>=<big|sum><rsub|i=1><rsup|n>x<rsub|i><rsup|2>=0>
      a contradiction so we have <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
      that <math|x<rsub|i>=0> hence we have
      <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>=0>
    </enumerate>
  </proof>
  ...
  <\proof>
    \ <math|<around*|\<\|\|\>|0|\<\|\|\>>=<sqrt|<around*|\<langle\>|0,0|\<rangle\>>>=<sqrt|0>=0>
  </proof>
  ...
  <\example>
    <label|eucledan norm>Let <math|n\<in\>\<bbb-N\><rsub|0>> then
    <math|<around*|\<langle\>|\<bbb-R\><rsup|n>,<around*|\<\|\|\>||\<\|\|\>><rsub|e>|\<rangle\>>>
    where <math|<around*|\<\|\|\>|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>|)>|\<\|\|\>>=<sqrt|<big|sum><rsub|i=1><rsup|n>x<rsub|i><rsup|2>>>
    is a normed space
  </example>

  <\proof>
    This follows directly from te above theorem and <reference|inner product
    on R^n>.
  </proof>

  We can extend the above to general finite dimensional spaces\ 
  ...
  The following shows that <math|\<bbb-R\><rsup|2>> and <math|\<bbb-C\>> are
  isometric

  <\example>
    <label|R^2 is isometric with C>Let <math|<around*|\<langle\>|\<bbb-R\><rsup|2>,<around*|\<\|\|\>||\<\|\|\>><rsub|e>|\<rangle\>>>
    be the normed space using the euclidean norm (see <reference|eucledan
    norm>) , <math|<around*|\<langle\>|\<bbb-C\>,<around*|\|||\|>|\<rangle\>>>
    be the normed space using the canonical norm then
    <math|\<cal-C\>:\<bbb-R\><rsup|2>\<rightarrow\>\<bbb-C\>> defined by
    <math|\<cal-C\><around*|(|<around*|(|x,y|)>|)>=x+i\<cdot\>y> is a
    isometry\ 
  </example>

  <\proof>
    Using <reference|R^2 is isomorph to C> we have that <math|\<cal-C\>> is a
    isomorphims hence a bijection. Further
    <math|<around*|\||\<cal-C\><around*|(|<around*|(|x,y|)>|)>|\|>=<around*|\||x+i\<cdot\>y|\|>=<sqrt|x<rsup|2>+y<rsup|2>>=<around*|\<\|\|\>|<around*|(|x,y|)>|\<\|\|\>><rsub|e>>
  </proof>
  ...
  <\proof>
    ...
    then <math|<around*|\<\|\|\>|\<varphi\><around*|(|x|)>|\<\|\|\>>=<around*|\<\|\|\>|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>x<rsub|i>|\<\|\|\>>=<sqrt|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|\||x<rsub|i>|\|><rsup|2>>=<around*|\<\|\|\>|x|\<\|\|\>>>
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|X,\<cal-T\><rsub|X>|\<rangle\>>> and
    <math|<around*|\<langle\>|Y,\<cal-T\><rsub|Y>|\<rangle\>>> be topological
    spaces and let <math|f:X\<rightarrow\>Y> be a continuous function between
    <math|X> and Y then if <math|x\<in\>A\<subseteq\>X> we have that
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      of image and preimage>>>f<rsup|-1><around*|(|Y\\V|)>> is closed we have
      that <math|f<rsup|-1><around*|(|V|)>> is open.\ 
  ...
  <\corollary>
    <label|continuity of a function in a subspace of a metric space>Let
    <math|<around*|\<langle\>|X,d<rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,d<rsub|Y>|\<rangle\>>> be metric space,
    <math|A\<subseteq\>X> then <math|f:A\<rightarrow\>Y> is continuous (using
    the subspace topology on <math|A> based on the metric topology of
  ...
  <\proof>
    Using <reference|subspace topology of a metric space> we have that the
    sub space topology is generated by the restricted metric
    <math|d<rsub|X\|A\<times\>A>:A\<times\>A\<rightarrow\>\<bbb-R\>> defined
    by <math|d<rsub|X<rsub|\|A\<times\>A>><around*|(|x,y|)>=d<rsub|A><around*|(|x,y|)>>.
    Using the previous theorem we have then that <math|f:A\<rightarrow\>Y> is
    continuous iff <math|\<forall\>\<varepsilon\>\<in\>\<bbb-R\><rsub|+>>
    there exists a <math|\<delta\>\<in\>\<bbb-R\><rsub|+>> such that
    <math|\<forall\>y\<in\>A> with <math|d<rsub|X<rsub|\|A\<times\>A>><around*|(|x,y|)>\<less\>\<varepsilon\>>
    we have <math|d<rsub|Y><around*|(|f<around*|(|x|)>,f<around*|(|y|)>|)>\<less\>\<varepsilon\>>
    which as <math|><math|d<rsub|X<rsub|\|A\<times\>A>><around*|(|x,y|)>=d<rsub|X><around*|(|x,y|)>>
    is equivalent with \ <math|\<forall\>\<varepsilon\>\<in\>\<bbb-R\><rsub|+>>
    there exists a <math|\<delta\>\<in\>\<bbb-R\><rsub|+>> such that
    <math|\<forall\>y\<in\>A> with <math|d<rsub|X><around*|(|x,y|)>\<less\>\<varepsilon\>>
    we have <math|d<rsub|Y><around*|(|f<around*|(|x|)>,f<around*|(|y|)>|)>\<less\>\<varepsilon\>>
  </proof>

  <\theorem>
    <label|open functions in metric spaces>Let
    <math|<around*|\<langle\>|X,d<rsub|X>|\<rangle\>>> and
    <math|<around*|\<langle\>|Y,d<rsub|Y>|\<rangle\>>> be metric spaces and
    <math|f:X\<rightarrow\>Y> a function then <math|f> is open if and only if
  ...
  We can extend the above theorem to a subspace of a normed space.

  <\theorem>
    <label|continuity of a function on a normed subspace>Let
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|A\<subseteq\>X> <math|A\<subseteq\>X> then
    <math|f:A\<rightarrow\>Y> is continuous (using the subspace topology on
    <math|A> based on the normed topology of <math|X>) at <math|x\<in\>A> iff
    <math|\<forall\>\<varepsilon\>\<in\>\<bbb-R\><rsub|+>> there exists a
    <math|\<delta\>\<in\>\<bbb-R\><rsub|+>> such that
    <math|\<forall\>y\<in\>A> with <math|<around*|\<\|\|\>|x-y|\<\|\|\>><rsub|X>\<less\>\<delta\>>
    we have <math|<around*|\<\|\|\>|f<around*|(|x|)>-f<around*|(|y|)>|\<\|\|\>>\<less\>\<varepsilon\>>
  </theorem>

  <\proof>
    This follows from <reference|continuity of a function in a subspace of a
    metric space> and the fact that <math|d<rsub|X><around*|(|x,y|)>=<around*|\<\|\|\>|x-y|\<\|\|\>><rsub|X>>
    and <math|d<rsub|Y><around*|(|f<around*|(|x|)>,f<around*|(|y|)>|)>=<around*|\<\|\|\>|f<around*|(|x|)>-f<around*|(|y|)>|\<\|\|\>>>
  </proof>

  <\definition>
    <label|Lischitz continuity>Let <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>
    and <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces then a function <math|f:X\<rightarrow\>Y> is
  ...
  <\theorem>
    <label|Lipschitz continuous functions are uniform continuous>Let
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>
    and <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces then a Lipschitz continuous function
    <math|f:X\<rightarrow\>Y> is uniform continuous and thus continuous.
  </theorem>

  <\proof>
    Let <math|\<varepsilon\>\<gtr\>0> take
    <math|d<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,y|)>\<less\>\<varepsilon\>>,
    then we have <math|d<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|Y>><around*|(|f<around*|(|x|)>-f<around*|(|y|)>|)>=<around*|\<\|\|\>|f<around*|(|x|)>-f<around*|(|y|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|x-y|\<\|\|\>><rsub|X>=d<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|x,y|)>\<less\>\<varepsilon\>\<Rightarrow\>d<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|Y>><around*|(|f<around*|(|x,f<around*|(|y|)>|)>|)>>
  </proof>

  <\definition>
    <label|distance functions><index|distance function>Let
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>> be
    a normed space, <math|\<emptyset\>\<neq\>S\<subseteq\>X> a non-empty set
    then the <with|font-series|bold|set distance function
    ><math|\<delta\><rsub|S>:X\<rightarrow\>\<bbb-R\>> is defined by
    <math|x\<rightarrow\>\<delta\><rsub|S><around*|(|x|)>=inf<around*|(|<around*|{|<around*|\<\|\|\>|x-y|\<\|\|\>>\|y\<in\>S|}>|)>>.
    Note that if <math|x\<in\>S> then <math|\<delta\><rsub|S><around*|(|x|)>=0>.
  </definition>

  <\theorem>
    <label|set distance functions are lipschitz>Let
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>> be
    a normed space, <math|\<emptyset\>\<neq\>S\<subseteq\>X> a non-empty set
    then <math|\<delta\><rsub|S>:X\<rightarrow\>\<bbb-R\>> is Lispchitz
    continuous and thus continuous.
  </theorem>

  <\proof>
    Let <math|x,y\<in\>X>, <math|\<varepsilon\>\<gtr\>0> then there exists a
    <math|y<rsub|\<varepsilon\>>\<in\>S> such that
    <math|inf<around*|(|<around*|{|<around*|\<\|\|\>|x-y|\<\|\|\>>\|y\<in\>S|}>|)>\<leqslant\><around*|\<\|\|\>|x-y<rsub|\<varepsilon\>>|\<\|\|\>>\<less\>inf<around*|(|<around*|{|<around*|\<\|\|\>|x-y|\<\|\|\>>\|y\<in\>S|}>|)>+\<varepsilon\>\<Rightarrow\>\<delta\><rsub|S><around*|(|x|)>\<leqslant\><around*|\<\|\|\>|x-y<rsub|\<varepsilon\>>|\<\|\|\>>\<less\>\<delta\><rsub|S><around*|(|x|)>+\<varepsilon\>>.
    Then <math|\<delta\><rsub|S><around*|(|y|)>-\<delta\><rsub|S><around*|(|x|)>\<leqslant\><around*|\<\|\|\>|y-y<rsub|\<varepsilon\>>|\<\|\|\>>-<around*|\<\|\|\>|x-y<rsub|\<varepsilon\>>|\<\|\|\>>+\<varepsilon\>\<leqslant\><around*|\<\|\|\>|y-x|\<\|\|\>>+<around*|\<\|\|\>|x-y<rsub|\<varepsilon\>>|\<\|\|\>>-<around*|\<\|\|\>|x-y<rsub|\<varepsilon\>>|\<\|\|\>>+\<varepsilon\>=<around*|\<\|\|\>|y-x|\<\|\|\>>+\<varepsilon\>\<Rightarrow\>\<delta\><rsub|S><around*|(|y|)>-\<delta\><rsub|S><around*|(|x|)>\<leqslant\><around*|\<\|\|\>|y-x|\<\|\|\>>+\<varepsilon\>>.
    If now <math|<around*|\<\|\|\>|y-x|\<\|\|\>>\<less\>\<delta\><rsub|S><around*|(|y|)>-\<delta\><rsub|S><around*|(|x|)>>
    take then <math|\<varepsilon\>=<frac|\<delta\><rsub|S><around*|(|y|)>-\<delta\><rsub|S><around*|(|x|)>-<around*|\<\|\|\>|y-x|\<\|\|\>>|2>\<gtr\>0>
    then we have <math|\<delta\><rsub|S><around*|(|y|)>-\<delta\><rsub|S><around*|(|x|)>\<leqslant\><around*|\<\|\|\>|y-x|\<\|\|\>>+\<varepsilon\>\<leqslant\><around*|\<\|\|\>|y-x|\<\|\|\>>+<frac|\<delta\><rsub|S><around*|(|y|)>-\<delta\><rsub|S><around*|(|x|)>-<around*|\<\|\|\>|y-x|\<\|\|\>>|2>\<less\><around*|\<\|\|\>|y-x|\<\|\|\>>+\<delta\><rsub|S><around*|(|y|)>-\<delta\><rsub|S><around*|(|x|)>-<around*|\<\|\|\>|y-x|\<\|\|\>>=\<delta\><rsub|S><around*|(|y|)>-\<delta\><rsub|S><around*|(|x|)>>
    giving the contradiction <math|\<delta\><rsub|S><around*|(|y|)>-\<delta\><rsub|S><around*|(|x|)>\<less\>\<delta\><rsub|S><around*|(|y|)>=\<delta\><rsub|S><around*|(|x|)>>,
    so we must have\ 

    <\equation*>
      \<delta\><rsub|S><around*|(|y|)>-\<delta\><rsub|S><around*|(|x|)>\<leqslant\><around*|\<\|\|\>|y-x|\<\|\|\>>
    </equation*>

    Exchange <math|x,y> gives then also\ 

    <\equation*>
      \<delta\><rsub|S><around*|(|x|)>-\<delta\><rsub|S><around*|(|y|)>\<leqslant\><around*|\<\|\|\>|x-y|\<\|\|\>>=<around*|\<\|\|\>|y-x|\<\|\|\>>
    </equation*>

    proving that <math|<around*|\||\<delta\><rsub|S><around*|(|y|)>-\<delta\><rsub|S><around*|(|x|)>|\|>\<leqslant\><around*|\<\|\|\>|y-x|\<\|\|\>>>
  </proof>
  ...
  <\corollary>
    <label|partial sum and product is continuous>Let
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>> be
    a normed space then we have

    <\enumerate>
      <item><math|\<forall\>x\<in\>X> the function
      <math|\<tau\><rsub|x>:X\<rightarrow\>X> defined by
      <math|\<tau\><rsub|x><around*|(|y|)>=x+y> is continuous

      <item><math|\<forall\>\<alpha\>\<in\>\<bbb-R\><around*|(|\<bbb-C\>|)>>
      the function <math|\<mu\><rsub|\<alpha\>>:X\<rightarrow\>X> defined by
      <math|\<mu\><rsub|\<alpha\>><around*|(|y|)>=\<alpha\>\<cdot\>y> is
      continuous

      <item><math|\<forall\>x\<in\>X> the function
      <math|\<nu\><rsub|x>:\<bbb-R\><around*|(|\<bbb-C\>|)>\<rightarrow\>X>
      defined by <math|\<nu\><rsub|x><around*|(|\<alpha\>|)>=\<alpha\>\<cdot\>x>
      is continuous
    </enumerate>
  </corollary>

  <\proof>
    This follows from the continuity of <math|+:X\<times\>X\<rightarrow\>X>
    and <math|\<point\>:X\<times\>\<bbb-R\><around*|(|\<bbb-C\>|)>\<rightarrow\>X>
    aand <reference|Continuity of function on a topological product>.
  </proof>
  ...
  <\example>
    <label|R^2 is homeomorphism to C>Let <math|<around*|\<langle\>|\<bbb-R\><rsup|2>,<around*|\<\|\|\>||\<\|\|\>><rsub|e>|\<rangle\>>>
    be equiped with the euclidean norm (see <reference|eucledan norm>),
    <math|<around*|\<langle\>|\<bbb-C\>,<around*|\|||\|>|\<rangle\>>> the
    complex space with the canonical norm then
    <math|\<cal-C\>:\<bbb-R\><rsup|2>\<rightarrow\>\<bbb-C\>> is a
    homeomorphism
  </example>

  <\proof>
    Using <reference|R^2 is isomorph to C> we have that <math|\<cal-C\>> is a
    isomorphism and by <reference|R^2 is isometric with C> a isometry and
    thus a linear isometry. Applying then the above theorem (see <reference|a
    isometry is a homeomorphism> we have that <math|\<cal-C\>> is a
    homeomorphism.
  </proof>
  ...
  Using inducion we can extend the above to a finite set of functions

  <\theorem>
    <label|finite sum of continuous functions is continuous>Let
    <math|n\<in\>\<bbb-N\><rsub|0>,> <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces over <math|\<bbb-R\><around*|(|\<bbb-C\>|)>> and
    <math|<around*|{|f<rsub|i>\|X\<rightarrow\>Y|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    a finite family of continuous functions then
    <math|<big|sum><rsub|i=1><rsup|n>f<rsub|i>:X\<rightarrow\>Y> defined by
    <math|<around*|(|<big|sum><rsub|i=1><rsup|n>f<rsub|i>|)><around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>f<rsub|i><around*|(|x|)>>
    is continuous.
  </theorem>

  <\proof>
    Let <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|<text|let
    ><around*|{|f<rsub|i>:X\<rightarrow\>Y|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><text|
    be a family continuous functions then
    ><big|sum><rsub|i=1><rsup|n>f<rsub|i><text| is continuous>|}>> then we
    have :

    <\description>
      <item*|<math|1\<in\>\<cal-S\>>>As <math|<around*|(|<big|sum><rsub|i=1><rsup|1>f<rsub|i>|)><around*|(|x|)>=<big|sum><rsub|i=1><rsup|1>f<rsub|i><around*|(|x|)>=f<rsub|1><around*|(|x|)>>
      we have that <math|<big|sum><rsub|i=1><rsup|1>f<rsub|i>=f<rsub|1>>
      which is continuous hence <math|1\<in\>\<cal-S\>>

      <item*|<math|n\<in\>\<cal-S\>\<Rightarrow\>n+1\<in\>\<cal-S\>>>Let
      <math|<around*|{|f<rsub|i>:X-Y|}><rsub|i\<in\><around*|{|1,\<ldots\>,n+1|}>>>
      a family of continuous functions then we have
      <math|<around*|(|<big|sum><rsub|i=1><rsup|n>f<rsub|i>|)><around*|(|x|)>=<big|sum><rsub|i=1><rsup|n+1>f<rsub|i><around*|(|x|)>=f<rsub|n+1><around*|(|x|)>+<big|sum><rsub|i=1><rsup|n>f<rsub|i><around*|(|x|)>=<around*|(|f<rsub|n+1>+<big|sum><rsub|i=1><rsup|n>f<rsub|i>|)><around*|(|x|)>>
      proving that <math|<big|sum><rsub|i=1><rsup|n+1>f<rsub|i>=f<rsub|n+1>+<big|sum><rsub|i=1><rsup|n>f<rsub|i>>
      which as <math|f<rsub|n+1> is continuous and
      <big|sum><rsub|i=1><rsup|n>f<rsub|i>> is continuuos (because
      <math|n\<in\>\<cal-S\>>) means by the previous theorem that
      <math|<big|sum><rsub|i=1><rsup|n+1>f<rsub|i>> is continuous. Hence
      <math|n+1\<in\>\<cal-S\>>.
    </description>
  </proof>
  ...
  <\corollary>
    <label|power of a continuous function is continuous>Let
    <math|n\<in\>\<bbb-N\>>, <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>
    be a normed spaces over <math|\<bbb-R\><around*|(|\<bbb-C\>|)>> and
    <math|f:X\<rightarrow\>\<bbb-R\><around*|(|\<bbb-C\>|)>> then
    <math|f<rsup|n>:X\<rightarrow\>\<bbb-R\><around*|(|\<bbb-C\>|)>> defined
    by <math|f<rsup|n><around*|(|x|)>=<around*|(|f<around*|(|x|)>|)><rsup|n>>
    is continuous
  </corollary>

  <\proof>
    Let <math|S=<around*|{|n\<in\>\<bbb-N\>\|f<rsup|n>:X\<rightarrow\>\<bbb-R\><around*|(|\<bbb-C\>|)><text|
    is a continuous function>|}>> then we have\ 

    <\description>
      <item*|<math|0\<in\>\<cal-S\>>>If <math|n=0> then
      <math|f<rsup|0>:X\<rightarrow\>\<bbb-R\><around*|(|\<bbb-C\>|)>> is
      <math|C<rsub|1>> which is continuous by <reference|constant functions
      are continuous>.

      <item*|<math|0\<in\>\<cal-S\>\<Rightarrow\>n+1\<in\>\<cal-S\>>>As
      <math|\<forall\>x\<in\>X> we have that
      <math|f<rsup|n+1><around*|(|x|)>=<around*|(|f<around*|(|x|)>|)><rsup|n+1>=f<around*|(|x|)>\<cdot\><around*|(|f<around*|(|x|)>|)><rsup|n>=<around*|(|f\<cdot\>f<rsup|n>|)><around*|(|x|)>>
      which is continuous because <math|f<rsup|n>> is continuous as
      <math|n\<in\>\<cal-S\>>, <math|f> is continuous and the above theorem.
    </description>
  </proof>

  Using this corollary on the identity function <math|1<rsub|X>> proves the
  following corollary.
  ...
  <\corollary>
    <label|linear isomorphism between R^n is a homeomorphism>Let
    <math|<around*|\<langle\>|\<bbb-R\><rsup|n>,<around*|\<\|\|\>||\<\|\|\>><rsub|n>|\<rangle\>>>,
    <math|<around*|\<langle\>|\<bbb-R\><rsup|n>,<around*|\<\|\|\>||\<\|\|\>><rsub|n>|\<rangle\>>>
    be equipped with the maximum norm then every linear isomorphism
    <math|L:\<bbb-R\><rsup|n>\<rightarrow\>\<bbb-R\><rsup|n>> is a
    homeomorphism (see <reference|homeomorphism>)
  </corollary>

  <\proof>
    Using the previous corollary (see <reference|linear mappins between
    products of the real spaces are continuous>) we have that <math|L> is
    continuous. As <math|L<rsup|-1>:\<bbb-R\><rsup|n>\<rightarrow\>\<bbb-R\><rsup|n>>
    is also a linear isomorphism we have that <math|L<rsup|-1>> is also
    continuous.
  </proof>
  ...
  <\proof>
    ...
    <math|X\\\<emptyset\>=X> is open. Second we prove that if <math|x\<in\>X>
    then <math|<around*|{|x|}>> is closed or equivalent that
  ...
  <\proof>
    Take <math|x\<in\>U> then as <math|x\<nin\>X\\U> a closed set we have by
    regularity a <math|V,W> open with <math|x\<in\>V>,
  ...
  <\example>
    <label|exmpty set is compact>If <math|<around*|\<langle\>|X,\<cal-T\>|\<rangle\>>>is
    a topological space then <math|\<emptyset\>> is a compact subset of
    <math|X>
  </example>
  ...
  <\proof>
    ...
    <\description>
      ...
      <item*|<math|I\<neq\>\<emptyset\>>>then <math|\<exists\>i\<in\>I> if we
      take <math|J=<around*|{|i|}>\<subseteq\>I> then <math|J> is finite and
      <math|\<emptyset\>\<subseteq\>E<rsub|i>=<big|cup><rsub|j\<in\><around*|{|i|}>>U<rsub|i>>
    </description>
  </proof>

  <\theorem>
    <label|finite union of compact subsets are compact>Let
    <math|<around*|\<langle\>|X,\<cal-T\>|\<rangle\>>> be a topological space
    and <math|<around*|{|C<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    be a finite family of compact subsets of <math|X> then
    <math|<big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>C<rsub|i>> is
    compact.
  </theorem>
  ...
  <\proof>
    ...
    <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>> we have
    <math|C<rsub|i>\<subseteq\><big|cup><rsub|j\<in\>I>U<rsub|j>\<Rightarrowlim\><rsub|C<rsub|i>
    is compact>\<exists\>finite I<rsub|i>\<subseteq\>I\<vdash\>C<rsub|i>\<subseteq\><big|cup><rsub|j\<in\>I<rsub|i>>U<rsub|j>>
    so that <math|<big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>C<rsub|i>\<subseteq\><big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|(|<big|cup><rsub|j\<in\>I<rsub|i>>U<rsub|i>|)>>.
    ...
    <math|x\<in\><big|cup><rsub|j\<in\>I<rsub|i>>U<rsub|i>\<Rightarrow\>\<exists\>i\<in\><around*|{|1,\<ldots\>,n|}>>
    such that <math|\<exists\>j\<in\>I<rsub|i>> with
    <math|x\<in\>U<rsub|j>\<Rightarrow\>\<exists\>j\<in\><big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>I<rsub|i>\<subseteq\>I\<vdash\>x\<in\>U<rsub|j>>
    proving that <math|<big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|(|<big|cup><rsub|j\<in\>I<rsub|i>>U<rsub|j>|)>\<subseteq\><big|cup><rsub|j\<in\><big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>I<rsub|i>>U<rsub|j>>
    and thus we have <math|<big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>C<rsub|i>\<subseteq\><big|cup><rsub|j\<in\><big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>I<rsub|i>>U<rsub|i>>
    where <math|<big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>I<rsub|i>>
    is a finite subset of <math|I>.
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|A,\<cal-T\><rsub|A>|\<rangle\>>> iff it is
    compact in <math|<around*|\<langle\>|X,\<cal-T\>|\<rangle\>>>
  </theorem>
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|\<Rightarrow\>>>Let <math|C> be compact in
      <math|<around*|\<langle\>|X,\<cal-T\>|\<rangle\>>>. Let
      <math|<around*|{|U<rsub|i>|}><rsub|i\<in\>I>> be a set of open sets in
      <math|\<cal-T\>> with <math|C\<subseteq\><big|cup><rsub|i\<in\>I>U<rsub|i>\<Rightarrow\>C=C<big|cap>A\<subseteq\><around*|(|<big|cup><rsub|i\<in\>I>U<rsub|i>|)><big|cap>A=<big|cup><rsub|i\<in\>I><around*|(|U<rsub|i><big|cap>A|)>\<Rightarrowlim\><rsub|C
      ...
      <item*|<math|\<Leftarrow\>>>Let <math|C> be compact in
      <math|<around*|\<langle\>|A,\<cal-T\><rsub|A>|\<rangle\>>> then if
      <math|C\<subseteq\><big|cup><rsub|i\<in\>I>U<rsub|i>> (a open cover of
      <math|A> in <math|\<cal-T\>>) then <math|C=C<big|cap>A\<subseteq\><big|cup><rsub|i\<in\>I><around*|(|U<rsub|i><big|cap>A|)>>
      (a open cover of <math|A> in <math|\<cal-T\><rsub|A>>), so by
      compactness we have that there exists a finite set
      <math|J\<subseteq\>I> such that <math|C\<subseteq\><big|cup><rsub|i\<in\>J><around*|(|U<rsub|i><big|cap>A|)>\<subseteq\><big|cup><rsub|i\<in\>J>U<rsub|i>>
      proving that <math|C> is compact in <math|\<cal-T\>>.
    </description>
  </proof>
  ...
  <\proof>
    ...
    <math|a\<in\><big|cup><rsub|U\<in\>\<cal-V\>\\<around*|{|X\\A|}>>U> which
    as <math|A\<subseteq\><big|cup><rsub|U\<in\>\<cal-V\>>U> means that
    ...
    which means that because <math|\<cal-V\>\\<around*|{|X\\A|}>> is finite
    that <math|c<around*|(|\<cal-V\>\\<around*|{|X\\A|}>|)>> is finite. Now
    if <math|a\<in\>A> then as <math|A\<subseteq\><big|cup><rsub|U\<in\>\<cal-V\>\\<around*|{|X\\A|}>>U>
  ...
  <\lemma>
    Given <math|<around*|\<langle\>|\<bbb-R\>,\<\|\|\>|\<rangle\>>> the
    normed space with the canonical norm <math|<around*|\|||\|>>, <math|S> a
    none empty closedset such that <math|sup<around*|(|S|)>> [or
    <math|inf<around*|(|S|)>>] exists then <math|sup<around*|(|S|)>\<in\>S>
    [<math|inf<around*|(|S|)>\<in\>S>]
  </lemma>

  <\proof>
    First if <math|sup<around*|(|S|)>\<in\>U\<in\>\<cal-T\><rsub|<around*|\|||\|>>>
    then there exists a <math|\<varepsilon\>\<gtr\>0> such that
    <math|sup<around*|(|S|)>\<in\>B<rsub|<around*|\|||\|>><around*|(|sup<around*|(|S|)>,\<varepsilon\>|)>\<subseteq\>U>.
    As <math|sup<around*|(|S|)>-\<varepsilon\>\<less\>sup<around*|(|S|)>>
    there exists using the definition of the supremum a <math|y\<in\>S> such
    that <math|sup<around*|(|S|)>-\<varepsilon\>\<less\>y\<leqslant\>sup<around*|(|S|)>\<Rightarrow\>y\<in\>B<rsub|<around*|\|||\|>><around*|(|sup<around*|(|S|)>,\<varepsilon\>|)>\<subseteq\>U>
    proving that <math|U<big|cap>S=\<emptyset\>> hence by
    <reference|alternate definition of closed set> and the closure of
    <math|S> we have <math|sup<around*|(|S|)>\<in\>S>.\ 

    Second if <math|inf<around*|(|S|)>\<in\>U\<in\>\<cal-T\><rsub|<around*|\|||\|>>>
    then there exists a <math|\<varepsilon\>\<gtr\>0> such that
    <math|inf<around*|(|S|)>\<in\>B<rsub|<around*|\|||\|>><around*|(|inf<around*|(|S|)>,\<varepsilon\>|)>\<subseteq\>U>.
    As <math|inf<around*|(|S|)>-\<varepsilon\>\<less\>inf<around*|(|S|)>>
    there exists using the definition of the infinum a <math|y\<in\>S> such
    that <math|inf<around*|(|S|)>\<leqslant\>inf<around*|(|S|)>+\<varepsilon\>\<Rightarrow\>y\<in\>B<rsub|<around*|\|||\|>><around*|(|inf<around*|(|S|)>,\<varepsilon\>|)>\<subseteq\>U>
    proving that <math|U<big|cap>S=\<emptyset\>> hence by
    <reference|alternate definition of closed set> and the closure of
    <math|S> we have <math|inf<around*|(|S|)>\<in\>S>.
  </proof>

  <\theorem>
    <label|extreme value theorem><index|extreme value theorem><dueto|Extreme
    value Theorem>Let <math|<around*|\<langle\>|X,\<cal-T\>|\<rangle\>>> be a
    topologicval space, <math|C> a non empty compact subset and
    <math|f:X\<rightarrow\>\<bbb-R\>> a continuous function then there exists
    a <math|m,M\<in\>X> such that <math|\<forall\>x\<in\>X> we have
    <math|f<around*|(|m|)>\<leqslant\>f<around*|(|x|)>\<leqslant\>f<around*|(|M|)>>
  </theorem>

  <\proof>
    As <math|X> is compact we have by <reference|continuous image of compact
    set> that <math|f<around*|(|C|)>> is a compact set in <math|\<bbb-R\>>,
    so by <reference|compact space in a metric space is
    bounded><math|f<around*|(|C|)>> is bounded. Hence there exissts a
    <math|M> such that <math|\<forall\>x,y\<in\>f<around*|(|C|)>> we have
    <math|<around*|\||f<around*|(|x|)>-f<around*|(|y|)>|\|>\<leqslant\>M>. As
    <math|C\<neq\>\<emptyset\>> there exists a <math|x<rsub|0>\<in\>C> so
    that <math|\<forall\>x\<in\>C> we have
    <math|<around*|\||f<around*|(|x|)>-f<around*|(|x<rsub|0>|)>|\|>\<leqslant\>M\<Rightarrow\>f<around*|(|x<rsub|0>|)>-M\<leqslant\>f<around*|(|x|)>\<leqslant\>f<around*|(|x<rsub|0>|)>+M>.
    Using the conditional completeness of the reals we have that
    <math|inf<around*|(|f<around*|(|C|)>|)>> and
    <math|sup<around*|(|f<around*|(|C|)>|)>> exists. Using the previous
    theorem we have then that <math|inf<around*|(|f<around*|(|C|)>|)>,sup<around*|(|f<around*|(|C|)>|)>\<in\>f<around*|(|C|)>>
    so that <math|\<exists\>m,M\<in\>C> such that
    <math|f<around*|(|m|)>=inf<around*|(|f<around*|(|C|)>|)>\<wedge\>f<around*|(|M|)>=sup<around*|(|f<around*|(|C|)>|)>>.
    Hence if <math|x\<in\>C> then <math|f<around*|(|x|)>\<less\>f<around*|(|C|)>>
    and thus <math|f<around*|(|m|)>=inf<around*|(|f<around*|(|C|)>|)>\<leqslant\>f<around*|(|x|)>\<leqslant\>sup<around*|(|f<around*|(|C|)>|)>=f<around*|(|M|)>>.
  </proof>
  ...
  <\definition>
    <label|countable compact class><index|countable compact class>Let
    <math|X> be a set then <math|K\<subseteq\>\<cal-P\><around*|(|X|)>>, a
    set of subsets of <math|X>, is a <with|font-series|bold|compact class> if
    for any sequence <math|<around*|{|K<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>
    of elements in <math|K> with <math|<big|cap><rsub|i\<in\>\<bbb-N\><rsub|0>>K<rsub|i>=\<emptyset\>>
    we have that <math|\<exists\>N\<in\>\<bbb-N\><rsub|0>> such that
    <math|<big|cap><rsub|i\<in\><around*|{|1,\<ldots\>,N|}>>K<rsub|i>=\<emptyset\>>
  </definition>

  <\example>
    <label|set of compact sets is a countable compact class>Let
    <math|<around*|\<langle\>|X,\<cal-T\>|\<rangle\>>> be a Hausdorff
    topological space and <math|K> a set of compact sets in <math|X> then
    <math|K> is a countable compact class.
  </example>

  <\proof>
    We prove this by contradiction so let
    <math|<around*|{|K<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>> a countable
    family of elements in <math|K> with <math|<big|cap><rsub|i\<in\>\<bbb-N\><rsub|0>>K<rsub|i>=\<emptyset\>>
    such that <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> we have
    <math|<big|cap><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>K<rsub|i>\<neq\>\<emptyset\>>.
    Define then <math|<around*|{|E<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>
    by <math|E<rsub|i>=<big|cap><rsub|j=1><rsup|i>K<rsub|j>> then as
    <math|K<rsub|j>> is closed (see <reference|compact subspaces are closed>)
    we have that <math|<around*|{|X\\E<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>
    is a family of open sets. If now <math|x\<in\>K<rsub|1>> then as
    <math|<big|cap><rsub|i\<in\>\<bbb-N\><rsub|0>>K<rsub|i>=\<emptyset\>>
    there exists a <math|n\<in\>\<bbb-N\><rsub|0>> such that
    <math|x\<nin\>K<rsub|n>\<Rightarrow\>x\<in\>X\\K<rsub|n>> which proves
    that <math|K<rsub|1>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|(|K\\E<rsub|i>|)>>,
    using compactness of <math|K<rsub|1>> there exists then a finite
    <math|<around*|{|i<rsub|1>,\<ldots\>,i<rsub|n>|}>\<subseteq\>\<bbb-N\><rsub|0>>
    such that <math|K<rsub|1>\<subseteq\><big|cup><rsub|i\<in\><around*|{|i<rsub|1>,\<ldots\>,i<rsub|n>|}>><around*|(|K\\E<rsub|i>|)>>.
    Take now <math|m=max<around*|(|i<rsub|1,\<ldots\>,>i<rsub|n>|)>> then as
    <math|\<forall\>j\<in\><around*|{|i<rsub|1>,\<ldots\>,i<rsub|n>|}>> we
    have <math|E<rsub|m>\<subseteq\>E<rsub|j>\<Rightarrow\>K\\E<rsub|j>\<subseteq\>K\\E<rsub|m>>
    so that <math|K<rsub|1>\<subseteq\>K\\E<rsub|m>>. As we assume that
    <math|E<rsub|m>=<big|cap><rsub|j=1><rsup|m>K<rsub|i>\<neq\>\<emptyset\>>
    there exists a <math|y\<in\>E<rsub|m>\<subseteq\>K<rsub|1>> so that
    <math|y\<in\>K<rsub|1>\<subseteq\>K\\E<rsub|m>\<Rightarrow\>y\<in\>E<rsub|m>\<wedge\>y\<nin\>E<rsub|m>>
    a contradiction. So we must have that there exists a
    <math|N\<in\>\<bbb-N\><rsub|0>> with <math|<big|cap><rsub|i\<in\><around*|{|1,\<ldots\>,N|}>>K<rsub|i>=\<emptyset\>>.
  </proof>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      has the limit <math|0> (see <reference|convergence in a normed space>
      for a definition of a limit) then there exists a number <math|a> such
      that <math|<big|cap><rsub|i\<in\>\<bbb-N\>><around*|[|a<rsub|i>,b<rsub|i>|]>=<around*|{|a|}>>
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      would mean that <math|A<rsub|\<alpha\>><big|cap>B<rsub|\<beta\>>=\<emptyset\>>
  ...
  <\proof>
    ...
    <math|A<rsub|\<alpha\>>\<subseteq\>X\\f<rsup|-1><around*|(|A|)>> so that
    we have either <math|f<around*|(|A<rsub|a>|)>\<subseteq\>f<around*|(|f<rsup|-1><around*|(|A|)>|)>=A>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      then <math|X=X\\\<emptyset\>=X\\<around|(|<big|cap><rsub|\<alpha\>\<in\>\<cal-A\>>A<rsub|\<alpha\>>|)>=<big|cup><rsub|\<alpha\>\<in\>\<cal-A\>><around|(|X\\A<rsub|\<alpha\>>|)>>
      and because <math|X\\A<rsub|\<alpha\>>> is open
      <math|\<forall\>\<alpha\>\<in\>\<cal-A\>> we have by compactness the
      existence of a finite <math|\<cal-B\>\<subseteq\>\<cal-A\>> such that
      <math|X=<big|cup><rsub|\<beta\>\<in\>\<cal-B\>><around|(|X\\A<rsub|\<beta\>>|)>\<Rightarrow\>\<emptyset\>=X\\X=X\\<around|(|<big|cup><rsub|\<beta\>\<in\>\<cal-B\>><around|(|X\\A<rsub|\<beta\>>|)>|)>=<big|cap><rsub|\<beta\>\<in\>\<cal-B\>><around|(|X\\<around|(|X\\A<rsub|\<beta\>>|)>|)>=<big|cap><rsub|\<beta\>\<in\>\<cal-B\>>A<rsub|\<beta\>>>

      <item><dueto|<math|2\<Rightarrow\>1>>Let
      <math|<around|{|U<rsub|\<alpha\>>|}><rsub|\<alpha\>\<in\>\<cal-A\>>> be
      a family of open sets such that <math|X=<big|cup><rsub|\<alpha\>\<in\>\<cal-A\>>U<rsub|\<alpha\>>\<Rightarrow\>\<emptyset\>=X\\X=X\\<around|(|<big|cup><rsub|\<alpha\>\<in\>\<cal-A\>>U<rsub|\<alpha\>>|)>=<big|cap><rsub|\<alpha\>\<in\>A><around|(|X\\U<rsub|\<alpha\>>|)>>
      and as we have that <math|\<forall\>\<alpha\>\<in\>\<cal-A\>> that
      <math|X\\U<rsub|\<alpha\>>> is closed we have by the hypothesis that
      <math|\<exists\>\<cal-B\>\<subseteq\>\<cal-A\>>, <math|\<cal-B\>>
      finite such that <math|\<emptyset\>=<big|cap><rsub|\<beta\>><around|(|X\\U<rsub|\<beta\>>|)>\<Rightarrow\>X
      \\\<emptyset\>=X\\<around|(|<big|cap><rsub|\<beta\>\<in\>\<cal-B\>><around|(|X\\U<rsub|\<beta\>>|)>|)>=<big|cup><rsub|\<beta\>\<in\>\<cal-B\>><around|(|X\\<around|(|X\\U<rsub|\<beta\>>|)>|)>=<big|cup><rsub|\<beta\>\<in\>\<cal-B\>>U<rsub|\<beta\>>>
      proving compactness
  ...
  <\example>
    <label|closed rectangles are compact in the norm topology>Let
    <math|<around*|\<langle\>|\<bbb-R\><rsup|n>,\<cal-T\>|\<rangle\>>> be the
    set of real tupple's together with the product topology (based on the
    trivial normed topology on <math|<around*|\<langle\>|\<bbb-R\>,\|
    \||\<rangle\>>> then <math|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|a<rsub|i>,b<rsub|i>|]>>
    is compact.
  </example>

  <\proof>
    Using <reference|[a,b] is compact> we have
    <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>> that
    <math|<around*|[|a<rsub|i>,b<rsub|i>|]>> is a compact set in <math|R>
    (using the norm topology generated in <math|\<bbb-R\>>, so using the
    previous corollary to Tychonoff's theorem we have that
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      Hausdorff and using <reference|compact subspaces are closed> that
      <math|C> is closed.
      ...
      which is compact by <reference|[a,b] is compact> and the corollary to
      Tychonoff's theorem. As <math|C=C<big|cap><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>><around*|[|\<pi\><rsub|i><around*|(|c|)>-M,\<pi\><rsub|i><around*|(|c|)>+M|]>|)>>
  ...
  <\theorem>
    <label|compactness and linear isometry>Let
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>> be
    a normed space, <math|n\<in\>\<bbb-N\><rsub|0>> such that
    <math|\<varphi\>:\<bbb-R\><rsup|n>\<rightarrow\>X> a isomorphism then if
    <math|C\<subseteq\>X> that <math|C> is compact if and only if <math|C> is
    closed and bounded
  </theorem>

  <\proof>
    \ Define <math|<around*|\<\|\|\>||\<\|\|\>><rsub|n>:\<bbb-R\><rsup|n>\<rightarrow\>X>
    by <math|<around*|\<\|\|\>|x|\<\|\|\>><rsub|n>=<around*|\<\|\|\>|\<varphi\><around*|(|x|)>|\<\|\|\>>>
    then we have\ 

    <\enumerate>
      <item>If <math|x\<in\>\<bbb-R\><rsup|n>> then
      <math|<around*|\<\|\|\>|x|\<\|\|\>><rsub|n>=<around*|\<\|\|\>|\<varphi\><around*|(|x|)>|\<\|\|\>>\<geqslant\>0>

      <item>If <math|\<alpha\>\<in\>\<bbb-R\>>,
      <math|x\<in\>\<bbb-R\><rsup|n>> then
      <math|<around*|\<\|\|\>|\<alpha\>\<cdot\>x|\<\|\|\>><rsub|n>=<around*|\<\|\|\>|\<varphi\><around*|(|\<alpha\>\<cdot\>x|)>|\<\|\|\>>\<equallim\><rsub|\<varphi\><text|
      is linear>><around*|\<\|\|\>|\<alpha\>\<cdot\>\<varphi\><around*|(|x|)>|\<\|\|\>>\<equallim\><rsub|<around*|\<\|\|\>||\<\|\|\>><text|
      is a norm>><around*|\||\<alpha\>|\|>\<cdot\><around*|\<\|\|\>|\<varphi\><around*|(|x|)>|\<\|\|\>>=<around*|\||\<alpha\>|\|>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>><rsub|n>>

      <item>If <math|x,y\<in\>\<bbb-R\><rsup|n>> then
      <math|<around*|\<\|\|\>|a+y|\<\|\|\>><rsub|n>=<around*|\<\|\|\>|\<varphi\><around*|(|x+y|)>|\<\|\|\>>\<equallim\><rsub|\<varphi\><text|
      is linear>><around*|\<\|\|\>|\<varphi\><around*|(|x|)>+\<varphi\><around*|(|y|)>|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|\<varphi\><around*|(|x|)>|\<\|\|\>>+<around*|\<\|\|\>|\<varphi\><around*|(|y|)>|\<\|\|\>>=<around*|\<\|\|\>|x|\<\|\|\>><rsub|n>+<around*|\<\|\|\>|y|\<\|\|\>><rsub|n>>

      <item>If <math|<around*|\<\|\|\>|x|\<\|\|\>><rsub|n>=0> then
      <math|<around*|\<\|\|\>|\<varphi\><around*|(|x|)>|\<\|\|\>>=0\<Rightarrowlim\><rsub|<around*|\<\|\|\>||\<\|\|\>><text|
      is a norm>>\<varphi\><around*|(|x|)>\<Rightarrowlim\><rsub|\<varphi\><text|
      is a isomorphism>>x=0>
    </enumerate>

    The above proves that <math|<around*|\<\|\|\>||\<\|\|\>><rsub|n>> is a
    norm an by construction a isometry, using <reference|a isometry is a
    homeomorphism> we have then that <math|\<varphi\>> is a homeomorphism and
    isometry between the normed spaces <math|<around*|\<langle\>|\<bbb-R\><rsup|n>,<around*|\<\|\|\>||\<\|\|\>><rsub|n>|\<rangle\>>>
    and <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>.
    Let now <math|C\<subseteq\>X> be a closed set then as <math|\<varphi\>>
    is a homeomorphism we have that <math|<around*|(|\<varphi\><rsup|-1>|)><around*|(|C|)>>
    is closed. Further as <math|C> is bounded we have that there exists a
    <math|0\<less\>M> such that <math|\<forall\>x,y\<in\>C> we have
    <math|<around*|\<\|\|\>|x-y|\<\|\|\>>\<leqslant\>M>. Hence if
    <math|x<rprime|'>,y<rprime|'>\<in\><around*|(|\<varphi\><rsup|-1>|)><around*|(|C|)>>
    we have that <math|x<rprime|'>=<around*|(|\<varphi\><rsup|-1>|)><around*|(|x|)>,y<rprime|'>=<around*|(|\<varphi\><rsup|-1>|)><around*|(|y|)>>
    where <math|x,y\<in\>C> so that <math|\<cal-x\>=\<varphi\><around*|(|x<rprime|'>|)>,y=\<varphi\><around*|(|y<rprime|'>|)>>
    hence <math|<around*|\<\|\|\>|x<rprime|'>-y<rprime|'>|\<\|\|\>><rsub|2>=<around*|\<\|\|\>|\<varphi\><around*|(|x<rprime|'>-y<rprime|'>|)>|\<\|\|\>>=<around*|\<\|\|\>|\<varphi\><around*|(|x<rprime|'>|)>-\<varphi\><around*|(|y<rprime|'>|)>|\<\|\|\>>=<around*|\<\|\|\>|x-y|\<\|\|\>>\<leqslant\>M>
    proving that <math|<around*|(|\<varphi\><rsup|-1>|)><around*|(|C|)>> is
    closed and bounded in the topology generated by
    <math|<around*|\<\|\|\>||\<\|\|\>><rsub|n>> on <math|\<bbb-R\><rsup|n>>.
    Using the previous theorem (<reference|equivalence of norms on product of
    real numbers>) we have that, if <math|\<cal-T\>> is the product topology
    generated by the maximum norm (see <reference|norm of finite product of
    normed spaces>), that:

    <\equation>
      If C\<subseteq\>X<text| is closed and bounded in
      <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
      then ><around*|(|\<varphi\><rsup|-1>|)><around*|(|C|)><text| is closed
      and bounded in ><around*|\<langle\>|\<bbb-R\><rsup|n>,\<cal-T\>|\<rangle\>>
    </equation>

    \ Using the Heine Borell theorem (see <reference|compact subsets of the
    reals>) we have then that <math|<around*|(|\<varphi\><rsup|-1>|)><around*|(|C|)>>
    is compact and as <math|\<varphi\>> is a homeomorphism and thus
    continuous we have by <reference|continuous image of compact set> that
    <math|C=\<varphi\><around*|(|<around*|(|\<varphi\><rsup|-1>|)><around*|(|C|)>|)>>
    is compact. Hence we conclude that\ 

    <\equation>
      <label|eq 12.21.032><text|If >C\<subseteq\>X<text| is closed and
      bounded in ><around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>><text|
      then >C<text| is compact> in <around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>
    </equation>

    If <math|C> is compact then as <math|\<varphi\>:\<bbb-R\><rsup|n>\<rightarrow\>X>
    is a homemorphism between <math|<around*|\<langle\>|\<bbb-R\><rsub|n>,<around*|\<\|\|\>||\<\|\|\>><rsub|n>|\<rangle\>>>
    and <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    we have that <math|\<varphi\><rsup|-1>:X\<rightarrow\>\<bbb-R\><rsup|n>>
    is continuous so that by <reference|continuous image of compact set> we
    have that <math|<around*|(|\<varphi\><rsup|-1>|)><around*|(|C|)>> is
    compact. As by the previous theorem (<reference|equivalence of norms on
    product of real numbers>) we have that the topology generated by
    <math|<around*|\<\|\|\>||\<\|\|\>><rsub|n>> is the same as the product
    topology \ generated by the maximum norm (see <reference|norm of finite
    product of normed spaces>) if follows from the Heine Borel theorem (see
    <reference|compact subsets of the reals>) we have that
    <math|<around*|(|\<varphi\><rsup|-1>|)><around*|(|C|)>> is closed and
    bounded. As <math|\<varphi\><rsup|-1>> is continuous we have
    <math|C=\<varphi\><around*|(|<around*|(|\<varphi\><rsup|-1>|)><around*|(|C|)>|)>=<around*|(|\<varphi\><rsup|-1>|)><rsub|><rsup|-1><around*|(|<around*|(|\<varphi\><rsup|-1>|)><around*|(|C|)>|)>>
    is closed. Further as <math|\<varphi\><rsup|-1><around*|(|C|)>> is
    bounded there exists <math|M\<gtr\>0> such that
    <math|\<forall\>x,y\<in\>\<varphi\><rsup|-1><around*|(|C|)>> we have
    <math|<around*|\<\|\|\>|x-y|\<\|\|\>><rsub|n>\<less\>M>, hence if
    <math|x,y\<in\>C> then <math| \<varphi\><rsup|-1><around*|(|x|)>,\<varphi\><rsup|-1><around*|(|y|)>\<in\><around*|(|\<varphi\><rsup|-1>|)><around*|(|C|)>\<Rightarrow\><around*|\<\|\|\>|\<varphi\><rsup|-1><around*|(|x|)>-\<varphi\><rsup|-1><around*|(|y|)>|\<\|\|\>><rsub|n>\<leqslant\>M>.
    So <math|<around*|\<\|\|\>|x-y|\<\|\|\>>=<around*|\<\|\|\>|\<varphi\><around*|(|\<varphi\><rsup|-1><around*|(|x|)>|)>-\<varphi\><around*|(|\<varphi\><rsup|-1><around*|(|y|)>|)>|\<\|\|\>>=<around*|\<\|\|\>|\<varphi\><around*|(|\<varphi\><rsup|-1><around*|(|x|)>-\<varphi\><rsup|-1><around*|(|y|)>|)>|\<\|\|\>>=<around*|\<\|\|\>|\<varphi\><rsup|-1><around*|(|x|)>-\<varphi\><rsup|-1><around*|(|y|)>|\<\|\|\>><rsub|n>\<leqslant\>M>
    proving that\ 

    <\equation>
      <label|eq 12.22.032><text|If >C\<subseteq\>X<text| is compact in
      ><around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>><text|
      then <math|C> is closed and bounded in
      ><around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>
    </equation>
  </proof>

  We can use this to prove that closed bounded sets in <math|\<bbb-C\>> are
  compact\ 

  <\corollary>
    <label|every closed bounded set in C is compact>Let
    <math|<around*|\<langle\>|\<bbb-C\>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    be the complex space with a norm then if <math|C\<subseteq\>\<bbb-C\>> we
    have that <math|C> is compact if and only if <math|C> is closed and
    bounded
  </corollary>

  <\proof>
    Using <reference|R^2 is isomorph to C> we have that there exists a
    isomorphism <math|\<cal-C\>:\<bbb-R\><rsup|2>\<rightarrow\>\<bbb-C\>>
    between the vector spaces <math|<around*|\<langle\>|\<bbb-R\><rsup|2>,+,\<cdot\>|\<rangle\>>>
    and <math|<around*|\<langle\>|\<bbb-C\>,+,\<cdot\>|\<rangle\>>>. The
    theorem is then prove by applying the previous theorem (see
    <reference|compactness and linear isometry>).
  </proof>
  ...
  The following theorem shows that convergence is not dependent on where a
  sequence start.

  <\theorem>
    <label|convergence is independent of start of sequence>If
    <math|<around*|\<langle\>|X,\<cal-T\>|\<rangle\>>> is a topological space
    and <math|<around*|{|x<rsub|i>|}><rsub|i\<in\><around*|{|m,\<ldots\>,\<infty\>|}>>>
    ...
    <\enumerate>
      ...
      converges to <math|x> then <math|<around*|{|x<rsub|i>|}><rsub|i\<in\><around*|{|m,\<ldots\>,\<infty\>|}>>>
      converges to <math|x>
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      then <math|N\<in\><around*|{|n,\<ldots\>\<infty\>|}>> and
      <math|i\<geqslant\>N<rprime|'>> such that <math|x<rsub|i>\<in\>U>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,d<rsub|Y>|\<rangle\>>> be metric spaces,
    <math|f:X\<rightarrow\>Y> a function and <math|x\<in\>X> then we have the
    following equivalence\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|f is continuous at
      x>|<cell|\<Leftrightarrow\>>|<cell| <text|for every convergent sequence
      ><around*|{|x<rsub|n>|}><rsub|n\<in\>\<bbb-N\><rsub|0>><text| with
      limit > x <text|we have that > <around*|{|f<around*|(|x<rsub|n>|)>|}><rsub|n\<in\>\<bbb-N\><rsub|0>><text|
      converges with limit >f<around*|(|x|)>>>>>
    </eqnarray*>
  </theorem>
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|\<Rightarrow\>>>Let <math|\<varepsilon\>\<gtr\>0> then by
      continuity of <math|f> there exists a
      <math|\<delta\><around*|(|x|)>\<gtr\>0> such that if
      <math|d<rsub|X><around*|(|x,y|)>\<less\>\<lambda\><around*|(|x|)>> then
      <math|d<rsub|Y><around*|(|f<around*|(|x|)>,f<around*|(|y|)>|)>\<less\>\<varepsilon\>>.
      As <math|<below|lim|n\<rightarrow\>\<infty\>>x<rsub|n>=x> there exists
      a <math|N\<in\><around*|{|k,\<ldots\>\<infty\>|}>> such that if
      ...
      <math|x> then there exists a <math|\<varepsilon\><rsub|x>\<gtr\>0> such
      that <math|\<forall\>\<delta\>\<gtr\>0> there exists a <math|y\<in\>X>
      with <math|d<rsub|X><around*|(|x,y|)>\<less\>\<delta\>> and
      <math|d<rsub|Y><around*|(|f<around*|(|x|)>,f<around*|(|y|)>|)>\<gtr\>\<varepsilon\><rsub|x>>.
      So <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> we have
      <math|\<exists\>x<rsub|n>\<in\>X> with
      <math|d<rsub|X><around*|(|*x,x<rsub|n>|)>\<less\><frac|1|N>> and
      <math|d<rsub|Y><around*|(|f<around*|(|x|)>,f<around*|(|y<rsub|n>|)>|)>\<gtr\>\<varepsilon\><rsub|X>>.
      Take now <math|\<varepsilon\>\<gtr\>0> then by the Archimedean propety
      of the real numbers (see <reference|consequence of the archimedean
      property for the reals>) there exists a
      <math|N<rsub|\<varepsilon\>>\<in\>\<bbb-N\><rsub|0>> such that
      <math|0\<less\><frac|1|N<rsub|\<varepsilon\>>>\<less\>\<varepsilon\>>,
      if now <math|n\<geqslant\>N<rsub|\<varepsilon\>>> then we have
      <math|d<rsub|X><around*|(|x,x<rsub|n>|)>\<less\><frac|1|n>\<leqslant\><frac|1|N<rsub|\<varepsilon\>>>\<less\>\<varepsilon\>>,
      which proves that <math|<below|lim|n\<rightarrow\>\<infty\>>x<rsub|n>=x>.
      As we have however <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> that
      <math|d<rsub|Y><around*|(|f<around*|(|x|)>,f<around*|(|x<rsub|n>|)>|)>\<geqslant\>\<varepsilon\><rsub|x>>
      we do not have that <math|<below|lim|n\<rightarrow\>\<infty\>>f<around*|(|x|)>=f<around*|(|y|)>>
      contradicting our hypothese, so <math|f> must be continuous at
      <math|x>.
    </description>
  </proof>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|X=U<rsub|1><big|cup>U<rsub|2>> then <math|U<rsub|2>=X\\U<rsub|1>>
      which is closed. According to (1) we must then have that either
      <math|U<rsub|2>=\<emptyset\>> or <math|U<rsub|2>=X> and then
      <math|U<rsub|1>=X\\U<rsub|2>=X\\X=\<emptyset\>> so
      <math|U<rsub|1>=\<emptyset\>> proving that <math|X> is connected.

      <item><dueto|<math|2\<Rightarrowlim\>>3>Assume that we have two
      disjoint closed sets <math|A<rsub|1>,A<rsub|2>> with
      <math|X=A<rsub|1><big|cup>A<rsub|2>> then <math|A<rsub|1>=X\\A<rsub|2>>
      is open and <math|A<rsub|2>=X\\A<rsub|1>> is open, so by the
      connectness of <math|X> we must have either
      <math|A<rsub|1>=\<emptyset\>> or <math|A<rsub|2>=\<emptyset\>>.
  ...
  To prove the fundamental theorem of algebra which says that every non
  constant complex polynomal has a zero we need first a lot of definitions
  and lemmas.

  <\definition>
    A function <math|p:\<bbb-C\>\<rightarrow\>\<bbb-C\>> is a complex
    polynomal if there exists a <math|n\<in\>\<bbb-N\>> and a
    <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>\<subseteq\>\<bbb-C\>>
    such that <math|p<around*|(|z|)>=<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>z<rsup|i>>.
    <math|n> is called the order of the <math|p> and noted by
    <math|ord<around*|(|p|)>>. If <math|n\<in\>\<bbb-N\><rsub|0>> and
    <math|a<rsub|n>\<neq\>0> then <math|p> is called a non constant
    polynomial.
  </definition>

  We need the concept of divergent limits.

  <\definition>
    <label|divergence limits><index|divergent limit>Let
  ...
  <\note>
    <label|divergent limit and negate>Let
  ...
  <\lemma>
    <label|divergent limit of sums>Let <math|n\<in\>\<bbb-N\><rsub|0>>,
    ...
    <\enumerate>
      ...
      <item>If <math|a<rsub|n>\<less\>\<infty\>> we have
      <math|<below|lim|x\<rightarrow\>\<infty\>><around*|(|<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>x<rsup|i>|)>=-\<infty\>>
    </enumerate>
  </lemma>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|\<forall\><around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>\<subseteq\>\<bbb-R\>\<vdash\>a<rsub|n>\<gtr\>0<text|
      we have ><below|lim|x\<rightarrow\>\<infty\>><around*|(|<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>x<rsup|i>|)>=\<infty\>|}>>
      then we have\ 

      <\description>
        <item*|<math|1\<in\>\<cal-S\>>>Let <math|M\<in\>\<bbb-R\>> and take
        <math|N=<frac|M-a<rsub|0>|a<rsub|1>>> then if <math|x\<geqslant\>N>
        we have <math|M-a<rsub|0>=a<rsub|1>\<cdot\>N\<leqslant\>a<rsub|1>\<cdot\>x=a<rsub|1>\<cdot\>x<rsub|1>>
        hence <math|M\<leqslant\>a<rsub|1>\<cdot\>x<rsup|1>+a<rsub|0>=<big|sum><rsub|i=0><rsup|1>a<rsub|i>\<cdot\>x<rsup|i>>
        proving that <math|1\<in\>\<cal-S\>>

        <item*|<math|n\<in\>\<cal-S\>\<Rightarrow\>n+1\<in\>\<cal-S\>>>Let
        <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n+1|}>>\<subseteq\>\<bbb-R\>\<vdash\>a<rsub|n+1>\<gtr\>0>
        then \ <math|<big|sum><rsub|i=0><rsup|n+1>a<rsub|i>\<cdot\>x<rsup|i>=<around*|(|<big|sum><rsub|i=1><rsup|n+1>a<rsub|i>\<cdot\>x<rsup|i>|)>+a<rsub|0>=x\<cdot\><around*|(|<big|sum><rsub|i=1><rsup|n+1>a<rsub|i>\<cdot\>x<rsup|i-1>|)>+a<rsub|0>=x\<cdot\><around*|(|<big|sum><rsub|i=0><rsup|n>a<rsub|i+1>\<cdot\>x<rsup|i>|)>+a<rsub|0>,>
        hence if we define <math|<around*|{|b<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>>
        by <math|b<rsub|i>=a<rsub|i+1>>, then we have\ 

        <\equation*>
          <big|sum><rsub|i=1><rsup|n+1>a<rsub|i>\<cdot\>x<rsup|i>=x\<cdot\><around*|(|<big|sum><rsub|i=0><rsup|n>b<rsup|i>\<cdot\>x<rsup|i>|)>+a<rsub|0>\<wedge\>b<rsub|n>=a<rsub|n+1>\<gtr\>0
        </equation*>

        Take <math|M\<in\>\<bbb-R\>> then as <math|n\<in\>\<cal-S\>> there
        exists a <math|N<rprime|'>\<in\>\<bbb-R\>> such that if
        <math|N\<leqslant\>x> we have that
        <math|max<around*|(|1,M-a<rsub|0>|)>\<leqslant\><big|sum><rsub|i=0><rsup|n>b<rsup|i>\<cdot\>x<rsup|i>>.
        Take then <math|N=max<around*|(|N<rprime|'>,1|)>> then we have
        <math|1\<leqslant\>x> and as <math|0\<less\>max<around*|(|1,M-a<rsub|0>|)>>
        we have <math|max<around*|(|1,M-a<rsub|0>|)>\<leqslant\>x\<cdot\>max<around*|(|1,M-a<rsub|0>|)>>.
        As <math|0\<less\>1\<leqslant\>x> then we have
        <math|x\<cdot\>max<around*|(|1,M-a<rsub|0>|)>\<leqslant\>x\<cdot\><around*|(|<big|sum><rsub|i=0><rsup|n>b<rsup|i>\<cdot\>x<rsup|i>|)>>.
        So we conclude that <math|M-a<rsub|0>=max<around*|(|1,M-a<rsub|0>|)>\<leqslant\>x\<cdot\><around*|(|<big|sum><rsub|i=0><rsup|n>b<rsup|i>\<cdot\>x<rsup|i>|)>>
        and thus <math|M\<leqslant\>\<cdot\><around*|(|<big|sum><rsub|i=0><rsup|n>b<rsup|i>\<cdot\>x<rsup|i>|)>+a<rsub|0>=<big|sum><rsub|i=1><rsup|n+1>a<rsub|i>\<cdot\>x<rsup|i>>.
        This proves that <math|n+1\<in\>\<cal-S\>>
      </description>

      <item>If <math|a<rsub|n>\<less\>0> then
      <math|0\<less\><around*|(|-a<rsub|n>|)>> and we have by (1) that
      <math|<below|lim|x\<rightarrow\>\<infty\>><around*|(|<big|sum><rsub|i=0><rsup|n><around*|(|-a<rsub|i>|)>\<cdot\>x<rsup|i>|)>=\<infty\>>
      and thus by <reference|divergent limit and negate> we have that
      <math|<below|lim|x\<rightarrow\>\<infty\>><around*|(|<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>x<rsup|i>|)>=<below|lim|x\<rightarrow\>\<infty\>><around*|(|-<around*|(|<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>x<rsup|i>|)>|)>=-\<infty\>>
    </enumerate>
  </proof>

  We define now a norm on <math|\<bbb-C\>> that we will use instead of the
  classical norm on <math|\<bbb-C\>> that includes a square root.

  <\lemma>
    <math|<around*|\<\|\|\>||\<\|\|\>>:\<bbb-C\>\<rightarrow\>\<bbb-R\>> by
    <math|<around*|\<\|\|\>|z|\<\|\|\>>=<around*|\||Re<around*|(|z|)>|\|>+<around*|\||Img<around*|(|z|)>|\|>>
    is a norm
  </lemma>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>If <math|z\<in\>\<bbb-C\>> then trivially
      <math|0\<leqslant\><around*|\<\|\|\>|z|\<\|\|\>>>

      <item>If <math|\<alpha\>\<in\>\<bbb-R\>> then for <math|z=x+i\<cdot\>y>
      we have that <math|<around*|\<\|\|\>|\<alpha\>\<cdot\>z|\<\|\|\>>=<around*|\<\|\|\>|\<alpha\>\<cdot\>x+i\<cdot\>\<alpha\>\<cdot\>y|\<\|\|\>>=<around*|\||\<alpha\>\<cdot\>x|\|>+<around*|\||\<alpha\>\<cdot\>y|\|>=<around*|\||\<alpha\>|\|>\<cdot\><around*|(|<around*|\||x|\|>+<around*|\||y|\|>|)>=\<alpha\>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>>

      <item>If <math|z<rsub|1>=x<rsub|1>+i\<cdot\>y<rsub|1>>,
      <math|z<rsub|2>=x<rsub|2>+i\<cdot\>y<rsub|2>\<in\>\<bbb-C\>> then
      <math|<around*|\<\|\|\>|z<rsub|1>+z<rsub|2>|\<\|\|\>>=<around*|\<\|\|\>|<around*|(|x<rsub|1>+i\<cdot\>y<rsub|1>|)>+<around*|(|x<rsub|2>+i\<cdot\>y<rsub|2>|)>|\<\|\|\>>=<around*|\<\|\|\>|<around*|(|x<rsub|1>+x<rsub|2>|)>+i\<cdot\><around*|(|y<rsub|1>+y<rsub|2>|)>|\<\|\|\>>=<around*|\||x<rsub|1>+x<rsub|2>|\|>+<around*|\||y<rsub|1>+y<rsub|2>|\|>\<leqslant\><around*|\||x<rsub|1>|\|>+<around*|\||x<rsub|2>|\|>+<around*|\||y<rsub|1>|\|>+<around*|\||y<rsub|2>|\|>=<around*|\<\|\|\>|z<rsub|1>|\<\|\|\>>+<around*|\<\|\|\>|z<rsub|2>|\<\|\|\>>>

      <item>Take <math|z=z+i\<cdot\>y\<in\>\<bbb-C\>> such that
      <math|<around*|\<\|\|\>|z|\<\|\|\>>=0> then
      <math|<around*|\||x|\|>+<around*|\||y|\|>=0\<Rightarrowlim\><rsub|0\<leqslant\><around*|\||x|\|>,<around*|\||u|\|>><around*|\||x|\|>=0=<around*|\||y|\|>\<Rightarrow\>x=0\<wedge\>y=0\<Rightarrow\>z=0>
    </enumerate>
  </proof>
  ...
  <\lemma>
    <label|properties of \|\|\|\| on C>We have the following properties for
    the above norm
    ...
    <\enumerate>
      ...
      <math|z\<in\>\<bbb-C\>> then <math|<around*|\<\|\|\>|z<rsup|n>|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|z|\<\|\|\>><rsup|n>>

      <item><math|\<forall\>n\<in\>\<bbb-N\><rsub|0>>,
      <math|z\<in\>\<bbb-C\>> then <math|<around*|\<\|\|\>|Re<around*|(|z<rsup|n>|)>|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|z|\<\|\|\>><rsup|n>>\ 

      <item><math|\<forall\>n\<in\>\<bbb-N\><rsub|0>,z\<in\>\<bbb-C\>> then
  ...
  <\proof>
    ...
    <\enumerate>
      <item>If <math|z\<in\>\<bbb-R\>> then <math|Img<around*|(|z|)>=0> and
      <math|Re<around*|(|z|)>=z> thus <math|<around*|\<\|\|\>|z|\<\|\|\>>=<around*|\||Re<around*|(|z|)>|\|>+<around*|\||Img<around*|(|z|)>|\|>=<around*|\||z|\|>+0=<around*|\||z|\|>>

      <item>If <math|z=x+i\<cdot\>y> then we have
      <math|<around*|\<\|\|\>|z|\<\|\|\>>=<around*|\||x|\|>+<around*|\||y|\|>=<around*|\||x|\|>+<around*|\||-y|\|>=<around*|\<\|\|\>|x-i\<cdot\>y|\<\|\|\>>=<around*|\<\|\|\>|<wide|z|\<bar\>>|\<\|\|\>>>

      <item>First we have given <math|a,b,c,d\<in\>\<bbb-R\>> that
      <math|0\<leqslant\><around*|(|<around*|\||a|\|>-<around*|\||b|\|>|)><rsup|2>=a<rsup|2>+b<rsup|2>-2\<cdot\><around*|\||a|\|>\<cdot\><around*|\||b|\|>>
      proving that <math|2\<cdot\><around*|\||a|\|>\<cdot\><around*|\||b|\|>\<leqslant\>a<rsup|2>+b<rsup|2>>
      hence <math|<around*|(|<around*|\||a|\|>+<around*|\||b|\|>|)><rsup|2>=a<rsup|2>+b<rsup|2>+2\<cdot\><around*|\||a|\|>\<cdot\><around*|\||b|\|>\<leqslant\>2\<cdot\><around*|(|a<rsup|2>+b<rsup|2>|)>>.
      Similar we have that <math|0\<leqslant\><around*|(|<around*|\||c|\|>-<around*|\||d|\|>|)><rsup|2>=c<rsup|2>+d<rsup|2>-2\<cdot\><around*|\||c|\|>\<cdot\><around*|\||d|\|>>
      proving that <math|2\<cdot\><around*|\||c|\|>\<cdot\><around*|\||d|\|>\<leqslant\>c<rsup|2>+d<rsup|2>>
      hence <math|<around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)><rsup|2>=c<rsup|2>+d<rsup|2>+2\<cdot\><around*|\||c|\|>\<cdot\><around*|\||d|\|>\<leqslant\>2\<cdot\><around*|(|c<rsup|2>+d<rsup|2>|)>>.
      So <math|<around*|(|<around*|\||a|\|>+<around*|\||b|\|>|)><rsup|2>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)><rsup|2>\<leqslant\>2\<cdot\><around*|(|a<rsup|2>+b<rsup|2>|)>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)><rsup|2>>
      and <math|2\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)><rsup|2>\<cdot\><around*|(|a<rsup|2>+b<rsup|2>|)>\<leqslant\>4\<cdot\><around*|(|c<rsup|2>+d<rsup|2>|)>>
      proving that\ 

      <\equation>
        <label|eq 12.52.015><around*|(|<around*|\||a|\|>+<around*|\||b|\|>|)><rsup|2>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)><rsup|2>\<leqslant\>4\<cdot\><around*|(|a<rsup|2>+b<rsup|2>|)>\<cdot\><around*|(|c<rsup|2>+d<rsup|2>|)>
      </equation>

      Now\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|a\<cdot\>c-b\<cdot\>d|)><rsup|2>+<around*|(|a\<cdot\>d+b\<cdot\>c|)><rsup|2>>|<cell|=>|<cell|a<rsup|2>\<cdot\>c<rsup|2>+b<rsup|2>\<cdot\>d<rsup|2>-2\<cdot\>a\<cdot\>c\<cdot\>b\<cdot\>d+a<rsup|2>\<cdot\>d<rsup|2>+b<rsup|2>\<cdot\>c<rsup|2>+2\<cdot\>a\<cdot\>d\<cdot\>b\<cdot\>c>>|<row|<cell|>|<cell|=>|<cell|a<rsup|2>\<cdot\>c<rsup|2>+a<rsup|2>\<cdot\>d<rsup|2>+b<rsup|2>\<cdot\>d<rsup|2>+b<rsup|2>\<cdot\>c<rsup|2>>>|<row|<cell|>|<cell|=>|<cell|a<rsup|2>\<cdot\><around*|(|c<rsup|2>+d<rsup|2>|)>+b<rsup|2>\<cdot\><around*|(|c<rsup|2>+d<rsup|2>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|a<rsup|2>+b<rsup|2>|)>\<cdot\><around*|(|c<rsup|2>+d<rsup|2>|)>>>>>
      </eqnarray*>

      Using <reference|eq 12.52.015> we have then\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|<around*|\||a|\|>+<around*|\||b|\|>|)><rsup|2>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)><rsup|2>>|<cell|\<leqslant\>>|<cell|4\<cdot\><around*|(|<around*|(|a\<cdot\>c-b\<cdot\>d|)><rsup|2>+<around*|(|a\<cdot\>d+b\<cdot\>c|)><rsup|2>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|4\<cdot\><around*|(|<around*|(|a\<cdot\>c-b\<cdot\>d|)><rsup|2>+<around*|(|a\<cdot\>d+b\<cdot\>c|)><rsup|2>+2\<cdot\><around*|(|a\<cdot\>c-b\<cdot\>d|)>\<cdot\><around*|(|a\<cdot\>d+b\<cdot\>c|)>|)>>>|<row|<cell|>|<cell|=>|<cell|4\<cdot\><around*|(|<around*|(|a\<cdot\>c-b\<cdot\>d|)>+<around*|(|a\<cdot\>d+b\<cdot\>c|)>|)><rsup|2>>>|<row|<cell|>|<cell|=>|<cell|4\<cdot\><around*|\||<around*|(|a\<cdot\>c-b\<cdot\>d|)>+<around*|(|a\<cdot\>d+b\<cdot\>c|)>|\|><rsup|2>>>>>
      </eqnarray*>

      proving taking the square root (see <reference|square root is a
      strictly increasing function>) <math|<around*|(|<around*|\||a|\|>+<around*|\||b|\|>|)>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)>\<leqslant\>2\<cdot\><around*|\||<around*|(|a\<cdot\>c-b\<cdot\>d|)>+<around*|(|a\<cdot\>d+b\<cdot\>c|)>|\|>\<leqslant\><around*|\||a\<cdot\>c-b\<cdot\>d|\|>+<around*|\||a\<cdot\>d+b\<cdot\>c|\|>>

      <\equation>
        <label|eq 12.53.015><tabular|<tformat|<table|<row|<cell|<around*|(|<around*|\||a|\|>+<around*|\||b|\|>|)>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)>\<leqslant\>2\<cdot\><around*|\||a\<cdot\>c-b\<cdot\>d|\|>+<around*|\||a\<cdot\>d+b\<cdot\>c|\|>>>>>>
      </equation>

      So if <math|z=a+i\<cdot\>b> and <math|w=c+i\<cdot\>d> then
      <math|z\<cdot\>w=<around*|(|a\<cdot\>c-b\<cdot\>d|)>+i\<cdot\><around*|(|a\<cdot\>d+b\<cdot\>c|)>>
      so that <math|<around*|\<\|\|\>|z\<cdot\>w|\<\|\|\>>=<around*|\||a\<cdot\>c-b\<cdot\>d|\|>+<around*|\||a\<cdot\>d+b\<cdot\>c|\|>\<geqslant\><rsub|<text|<reference|eq
      12.53.015>>><frac|1|2>\<cdot\><around*|(|<around*|\||a|\|>+<around*|\||b|\|>|)>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)>=<frac|1|2>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|w|\<\|\|\>>>
      proving that\ 

      <\equation>
        <label|eq 12.54.015><frac|1|2>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|w|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|z\<cdot\>w|\<\|\|\>>
      </equation>

      Further we have\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|\||a\<cdot\>c-b\<cdot\>d|\|>+<around*|\||a\<cdot\>d+b\<cdot\>c|\|>>|<cell|\<leqslant\>>|<cell|<around*|\||a|\|>\<cdot\><around*|\||c|\|>+<around*|\||b|\|>\<cdot\><around*|\||d|\|>+<around*|\||a|\|>\<cdot\><around*|\||d|\|>+<around*|\||b|\|>\<cdot\><around*|\||c|\|>>>|<row|<cell|>|<cell|=>|<cell|<around*|\||a|\|>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)>+<around*|\||b|\|>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<around*|\||a|\|>+<around*|\||b|\|>|)>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)>>>>>
      </eqnarray*>

      proving

      <\equation>
        <label|eq 12.55.016><around*|\||a\<cdot\>c-b\<cdot\>d|\|>+<around*|\||a\<cdot\>d+b\<cdot\>c|\|>\<leqslant\><around*|(|<around*|\||a|\|>+<around*|\||b|\|>|)>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)>
      </equation>

      hence

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|\<\|\|\>|z\<cdot\>w|\<\|\|\>>>|<cell|=>|<cell|<around*|\||a\<cdot\>c-b\<cdot\>d|\|>+<around*|\||a\<cdot\>d+b\<cdot\>c|\|>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|eq
        12.55.016>>>>|<cell|<around*|(|<around*|\||a|\|>+<around*|\||b|\|>|)>\<cdot\><around*|(|<around*|\||c|\|>+<around*|\||d|\|>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|w|\<\|\|\>>>>>>
      </eqnarray*>

      proving

      <\equation>
        <label|eq 12.56.015><around*|\<\|\|\>|z\<cdot\>w|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|w|\<\|\|\>>
      </equation>

      \ (3) is thus proved by <reference|eq 12.54.015> and <reference|eq
      12.56.015>.

      <item>If <math|z=a+i\<cdot\>b> and <math|w=c+i\<cdot\>d> then\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|\<\|\|\>|Re<around*|(|z\<cdot\>w|)>|\<\|\|\>>>|<cell|\<equallim\><rsub|<around*|(|1|)>>>|<cell|<around*|\||Re<around*|(|<around*|(|a\<cdot\>c-b\<cdot\>d|)>+<around*|(|a\<cdot\>d+b\<cdot\>c|)>|)>|\|>>>|<row|<cell|>|<cell|=>|<cell|<around*|\||a\<cdot\>c-b\<cdot\>d|\|>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|<around*|\||a\<cdot\>c-b\<cdot\>d|\|>+<around*|\||a\<cdot\>d+b\<cdot\>c|\|>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|z\<cdot\>w|\<\|\|\>>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<around*|(|3|)>>>|<cell|<around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|w|\<\|\|\>>>>>>
      </eqnarray*>

      <item>This trivially proved by induction so let
      <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|<around*|\<\|\|\>|z<rsup|n>|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|z|\<\|\|\>><rsup|n>|}>>
      then we have\ 

      <\description>
        <item*|<math|1\<in\>\<cal-S\>>>then
        <math|<around*|\<\|\|\>|z<rsup|1>|\<\|\|\>>=<around*|\<\|\|\>|z|\<\|\|\>>=<around*|\<\|\|\>|z|\<\|\|\>><rsup|1>>
        proving that <math|1\<in\>\<cal-S\>>

        <item*|<math|n\<in\>\<cal-S\>\<Rightarrow\>n+1\<in\>\<cal-S\>>>then
        <math|<around*|\<\|\|\>|z<rsup|n+1>|\<\|\|\>>=<around*|\<\|\|\>|z\<cdot\>z<rsup|n>|\<\|\|\>>\<leqslant\><rsub|<around*|(|3|)>><around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|n>=<around*|\<\|\|\>|z|\<\|\|\>><rsup|n+1>>
        proving that <math|n+1\<in\>\<cal-S\>>
      </description>

      <item>Take <math|z=x+i\<cdot\>y> then we must consider two cases for
      <math|n>

      <\description>
        <item*|<math|n=1>>then <math|<around*|\<\|\|\>|Re<around*|(|z<rsup|1>|)>|\<\|\|\>>=<around*|\<\|\|\>|x|\<\|\|\>>\<equallim\><rsub|<around*|(|1|)>><around*|\||x|\|>\<leqslant\><around*|\||x|\|>+<around*|\||y|\|>=<around*|\<\|\|\>|z|\<\|\|\>>>\ 

        <item*|<math|n\<gtr\>1>>then <math|1\<leqslant\>n-1> and
        <math|<around*|\<\|\|\>|Re<around*|(|z<rsup|n>|)>|\<\|\|\>>=<around*|\<\|\|\>|Re<around*|(|z\<cdot\>z<rsup|n-1>|)>|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z<rsup|n-1>|\<\|\|\>>\<leqslant\><rsub|<around*|(|3|)>><around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|n-1>=<around*|\<\|\|\>|z|\<\|\|\>><rsup|n>>
      </description>

      <item>This is proved by induction so let
      <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\>\|<frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|n>|2<rsup|n>>\<leqslant\><around*|\<\|\|\>|z<rsup|n>|\<\|\|\>>|}>>
      then we have

      <\description>
        <item*|<math|1\<in\>\<cal-S\>>>then as
        <math|<frac|1|2>\<less\>1\<Rightarrow\><frac|<around*|\<\|\|\>|z|\<\|\|\>>|2<rsup|1>>=<frac|1|2>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>\<leqslant\>1\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>=<around*|\<\|\|\>|z|\<\|\|\>><rsup|1>>
        we have that <math|1\<in\>\<cal-S\>>

        <item*|<math|n\<in\>\<cal-S\>\<Rightarrow\>n+1\<in\>\<cal-S\>>>we
        have <math|<frac|<around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z<rsup|n>|\<\|\|\>>|2>\<leqslant\><rsub|<around*|(|3|)>><around*|\<\|\|\>|z\<cdot\>z<rsup|n>|\<\|\|\>>=<around*|\<\|\|\>|z<rsup|n+1>|\<\|\|\>>>
        as <math|n\<in\>\<cal-S\>> we have
        <math|<frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|n>|2<rsup|n>>\<leqslant\><around*|\<\|\|\>|z<rsup|n>|\<\|\|\>>>
        and thus <math|<frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|n+1>|2<rsup|n+1>>=<frac|<around*|\<\|\|\>|z|\<\|\|\>>|2>\<cdot\><frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|n>|2<rsup|n>>\<leqslant\><frac|<around*|\<\|\|\>|z|\<\|\|\>>|2>\<cdot\><around*|\<\|\|\>|z<rsup|n>|\<\|\|\>>\<leqslant\><around*|\<\|\|\>|z<rsup|n+1>|\<\|\|\>>>
        proving that <math|n+1\<in\>\<cal-S\>>\ 
      </description>
    </enumerate>
  </proof>

  In the proof of the fundamental theorem of algebra we use the extrem value
  theorem so we need continuity using the above norm. This is proved in the
  following theorem.

  <\theorem>
    <label|p is continuous>The following functions are continuous in the
    normed space <math|<around*|\<langle\>|\<bbb-C\>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    ...
    <\enumerate>
      ...
      <item><math|Given n\<in\>\<bbb-N\>> we have that
      <math|<around*|(|1<rsub|\<bbb-C\>>|)><rsup|n>:\<bbb-C\>\<rightarrow\>\<bbb-C\>>
      is continuous

      <item>Given <math|n\<in\>\<bbb-N\><rsub|0>>,
      <math|<around*|{|\<alpha\><rsub|i>|}><rsub|i\<in\>\<bbb-N\><around*|{|0,\<ldots\>,n|}>>>
      the function <math|p:\<bbb-C\>\<rightarrow\>\<bbb-C\>> defined by
      ...
      <item>Given <math|n\<in\>\<bbb-N\><rsub|0>>,
      <math|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>> the
      function <math|p\<cdot\><wide|p|\<bar\>>:\<bbb-C\>\<rightarrow\>\<bbb-R\>>
    ...
    <\proof>
      ...
      <\enumerate>
        <item>As <math|<around*|(|\<alpha\>\<cdot\>|)>=\<alpha\>\<cdot\>1<rsub|\<bbb-C\>>>
        this follows from the fact that <math|1<rsub|\<bbb-C\>>> is
        continuous (see <reference|identity function is continuous>) and
        <reference|in a normed space the sum,product with scalar is
        ontinuous>

        <item>As <math|1<rsub|\<bbb-C\>>> is a continuous function (see
        <reference|identity function is continuous>) this follows from
        <reference|power of a continuous function is continuous>.

        <item>If <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}><rsub|>>>
        we have that <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>> that
        <math|<around*|(|\<alpha\><rsub|i>\<cdot\>|)>\<circ\><around*|(|1<rsub|\<bbb-C\>>|)><rsup|n>>
        is continuous as the composition of two continuous functions (see (1)
        and (2). Hence usng <reference|finite sum of continuous functions is
        continuous> we have that <math|<big|sum><rsub|i=1><rsup|n><around*|(|\<alpha\>\<cdot\>|)>\<circ\><around*|(|1<rsub|\<bbb-C\>>|)><rsup|i>>
        is continuous. As <math|\<forall\>x\<in\>\<bbb-C\>> we have
        <math|<around*|(|<big|sum><rsub|i=1><rsup|n><around*|(|\<alpha\>\<cdot\>|)>\<circ\><around*|(|1<rsub|\<bbb-C\>>|)><rsup|i>|)><around*|(|x|)>=<big|sum><rsub|i=1><rsup|n><around*|(|<around*|(|\<alpha\>\<cdot\>,|)>\<circ\><around*|(|1<rsub|\<bbb-C\>>|)><rsup|i>|)>=<big|sum><rsub|i=1><rsup|n>\<alpha\><rsub|i>\<cdot\>x<rsup|i>=p<around*|(|x|)>>
        we have that <math|p=<big|sum><rsub|i=1><rsup|n><around*|(|\<alpha\>\<cdot\>|)>\<circ\><around*|(|1<rsub|\<bbb-C\>>|)><rsup|i>>
        is continuous.

        <item>First let <math|z,\<delta\>\<in\>\<bbb-C\>> then\ 

        <\eqnarray*>
          <tformat|<table|<row|<cell|<around*|\||<around*|\<langle\>|z+\<delta\>|\<rangle\>>-<around*|\<langle\>|z|\<rangle\>>|\|>>|<cell|=>|<cell|<around*|\<\|\|\>|<around*|\<langle\>|z+\<delta\>|\<rangle\>>-<around*|\<langle\>|z|\<rangle\>>|\<\|\|\>>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|<around*|(|z+\<delta\>|)>\<cdot\><wide|<around*|(|z+\<delta\>|)>|\<bar\>>-z\<cdot\><wide|z|\<bar\>>|\<\|\|\>>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|<around*|(|z+\<delta\>|)>\<cdot\><around*|(|<wide|z|\<bar\>>+<wide|\<delta\>|\<bar\>>|)>-z\<cdot\><wide|z|\<bar\>>|\<\|\|\>>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|z\<cdot\><wide|z|\<bar\>>+z\<cdot\><wide|\<delta\>|\<bar\>>+\<delta\>\<cdot\><wide|z|\<bar\>>+\<delta\>\<cdot\><wide|\<delta\>|\<bar\>>-z\<cdot\><wide|z|\<bar\>>|\<\|\|\>>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|z\<cdot\><wide|\<delta\>|\<bar\>>+\<delta\>\<cdot\><wide|z|\<bar\>>+\<delta\>\<cdot\><wide|\<delta\>|\<bar\>>|\<\|\|\>>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|<around*|\<\|\|\>|z\<cdot\><wide|\<delta\>|\<bar\>>|\<\|\|\>>+<around*|\<\|\|\>|\<delta\>\<cdot\><wide|z|\<bar\>>|\<\|\|\>>+<around*|\<\|\|\>|\<delta\>\<cdot\><wide|\<delta\>|\<bar\>>|\<\|\|\>>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|properties
          of \|\|\|\| on C> (3)>>>|<cell|<around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|<wide|\<delta\>|\<bar\>>|\<\|\|\>>+<around*|\<\|\|\>|\<delta\>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|<wide|z|\<bar\>>|\<\|\|\>>+<around*|\<\|\|\>|\<delta\>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|<wide|\<delta\>|\<bar\>>|\<\|\|\>>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|properties
          of \|\|\|\| on C> (2)>>>|<cell|<around*|\<\|\|\>|z|\<\|\|\>>\<cdot\><around*|\<\|\|\>|\<delta\>|\<\|\|\>>+<around*|\<\|\|\>|\<delta\>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>+<around*|\<\|\|\>|\<delta\>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|\<delta\>|\<\|\|\>>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|\<delta\>|\<\|\|\>>\<cdot\><around*|(|2\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>+<around*|\<\|\|\>|\<delta\>|\<\|\|\>>|)>>>>>
        </eqnarray*>

        So given <math|\<varepsilon\>\<gtr\>0> we have if we choose
        <math|\<delta\>> such that <math|<around*|\<\|\|\>|\<delta\>|\<\|\|\>>\<less\>min<around*|(|1,<frac|\<varepsilon\>|2\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>+1>|)>>
        we have that\ 

        <\eqnarray*>
          <tformat|<table|<row|<cell|<around*|\<\|\|\>|<around*|\<langle\>|z+\<delta\>|\<rangle\>>-<around*|\<langle\>|z|\<rangle\>>|\<\|\|\>>>|<cell|\<less\>>|<cell|<around*|\<\|\|\>|\<delta\>|\<\|\|\>>\<cdot\><around*|(|2\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>+1|)>>>|<row|<cell|>|<cell|\<less\>>|<cell|<frac|\<varepsilon\>|2\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>+1>\<cdot\><around*|(|2\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>+1|)>>>|<row|<cell|>|<cell|=>|<cell|\<delta\>>>>>
        </eqnarray*>

        proving continuity of <math|<around*|\<langle\>||\<rangle\>>>.

        <item>This follows as <math|p\<cdot\><wide|p|\<bar\>>=<around*|\<langle\>||\<rangle\>>\<circ\>p>
        a composition of continuous functions by (3) and (4)

        <item>Let <math|z\<in\>\<bbb-C\>> and take
        <math|\<varepsilon\>\<gtr\>0> then if
        <math|z<rprime|'>\<in\>\<bbb-C\>> is such that
        <math|<around*|\<\|\|\>|z-z<rprime|'>|\<\|\|\>>\<less\>\<varepsilon\>>
        we have that <math|<around*|\<\|\|\>|<wide||\<bar\>><around*|(|z|)>-<wide||\<bar\>><around*|(|z<rprime|'>|)>|\<\|\|\>>=<around*|\<\|\|\>|<wide|z|\<bar\>>-<wide|z<rprime|'>|\<bar\>>|\<\|\|\>>=<around*|\<\|\|\>|<wide|z-z<rprime|'>|\<bar\>>|\<\|\|\>>\<equallim\><rsub|<text|<reference|properties
        of \|\|\|\| on C>> <around*|(|2|)>><around*|\<\|\|\>|z-z<rprime|'>|\<\|\|\>>\<less\>\<varepsilon\>>

        <item>Let <math|z\<in\>\<bbb-C\>>, <math|\<alpha\>\<in\>\<bbb-R\>>,
        given \ <math|\<varepsilon\>\<gtr\>0> define
        <math|\<delta\>=<frac|\<varepsilon\>|<around*|\<\|\|\>|z|\<\|\|\>>+1>\<gtr\>0>
        then we have <math|\<forall\>\<alpha\><rprime|'>\<in\>\<bbb-R\>> with
        <math|<around*|\||\<alpha\>-\<alpha\><rprime|'>|\|>\<less\>\<delta\>>
        that <math|<around*|\<\|\|\>|<around*|(|\<cdot\>z|)><around*|(|\<alpha\>|)>-<around*|(|\<cdot\>z|)><around*|(|\<alpha\><rprime|'>|)>|\<\|\|\>>=<around*|\<\|\|\>|\<alpha\>\<cdot\>z-\<alpha\><rprime|'>\<cdot\>z|\<\|\|\>>=<around*|\<\|\|\>|<around*|(|\<alpha\>-\<alpha\><rprime|'>|)>\<cdot\>z|\<\|\|\>>=<around*|\||\<alpha\>-\<alpha\><rprime|'>|\|>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>\<less\><frac|\<varepsilon\>|<around*|\<\|\|\>|z|\<\|\|\>>+1>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>>\<less\>\<varepsilon\>>
        proving that <math|<around*|(|\<cdot\>z|)>> is continuous (see
        <reference|continuity of a function on a normed subspace>).

        <item>As <math|p<rsub|\<cdot\>z>=p\<circ\><around*|(|\<cdot\>z|)>> is
        the composition of two continuous functions (see (3) and (7) we have
        that <math|p<rsub|\<cdot\>z>> is continuous.\ 

        <item>Let <math|z\<in\>\<bbb-C\>> then given <math|\<varepsilon\>> we
        have if <math|\<delta\>=\<varepsilon\>> that
        <math|\<forall\>z<rprime|'>\<in\>\<bbb-C\>> with
        <math|<around*|\<\|\|\>|z-z<rprime|'>|\<\|\|\>>\<less\>\<delta\>>
        that <math|<around*|\||Re<around*|(|z|)>-Re<around*|(|z<rprime|'>|)>|\|>=<around*|\||Re<around*|(|z-z<rprime|'>|)>|\|>\<leqslant\><around*|\||Re<around*|(|z-z<rprime|'>|)>|\|>+<around*|\||Img<around*|(|z-z<rprime|'>|)>|\|>=<around*|\<\|\|\>|z-z<rprime|'>|\<\|\|\>>\<less\>\<delta\>=\<varepsilon\>>
        proving continuity.
      </enumerate>
    </proof>
  </theorem>

  We need in the proof also to calculate the value of
  <math|<around*|(|1+i|)><rsup|4\<cdot\>n+2>> and
  <math|<around*|(|1-i|)><rsup|4\<cdot\>n+2>>

  <\lemma>
    <label|(1+i)^2>Let <math|n\<in\>\<bbb-N\>> then
    <math|<around*|(|1+i|)><rsup|4\<cdot\>n+2>=2\<cdot\><around*|(|-4|)><rsup|n>\<cdot\>i>
    and <math|<around*|(|1-i|)><rsup|4\<cdot\>n+2>=-2\<cdot\><around*|(|-4|)><rsup|n>\<cdot\>i>
  </lemma>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>Take <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\>\|<around*|(|1+i|)><rsup|4\<cdot\>n+2>=2\<cdot\><around*|(|-4|)><rsup|n>\<cdot\>i|}>>
      then we have\ 

      <\description>
        <item*|<math|0\<in\>\<cal-S\>>><math|<around*|(|1+i|)><rsup|4\<cdot\>0+2>=<around*|(|1+i|)><rsup|2>=1+2\<cdot\>i+i<rsup|2>=2\<cdot\>i=2\<cdot\><around*|(|-4|)><rsup|0>\<cdot\>i>
        proving that <math|0\<in\>\<cal-S\>>

        <item*|<math|n\<in\>\<cal-S\>\<Rightarrow\>n+1\<in\>\<cal-S\>>>

        <\eqnarray*>
          <tformat|<table|<row|<cell|<around*|(|1+i|)><rsup|4\<cdot\><around*|(|n+1|)>+2>>|<cell|=>|<cell|<around*|(|1+i|)><rsup|4\<cdot\>n+2+4>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|1+i|)><rsup|4\<cdot\>n+2><around*|(|1+i|)><rsup|4>>>|<row|<cell|>|<cell|\<equallim\><rsub|n\<in\>\<cal-S\>>>|<cell|2\<cdot\><around*|(|-4|)><rsup|n>\<cdot\>i\<cdot\><around*|(|1+i|)><rsup|2><around*|(|1+i|)><rsup|2>>>|<row|<cell|>|<cell|=>|<cell|2\<cdot\><around*|(|-4|)><rsup|n>\<cdot\>i\<cdot\><around*|(|2\<cdot\>i|)><around*|(|2\<cdot\>i|)>>>|<row|<cell|>|<cell|=>|<cell|2\<cdot\><around*|(|-4|)><rsup|n>\<cdot\>i\<cdot\><around*|(|-4|)>>>|<row|<cell|>|<cell|=>|<cell|2\<cdot\><around*|(|-4|)><rsup|n+1>\<cdot\>i>>>>
        </eqnarray*>
      </description>

      proving that <math|n+1\<in\>\<b-S\>>

      <item>Take <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\>\|<around*|(|1-i|)><rsup|4\<cdot\>n+2>=-2\<cdot\><around*|(|-4|)><rsup|n>\<cdot\>i|}>>
      then we have\ 

      <\description>
        <item*|<math|0\<in\>\<cal-S\>>><math|<around*|(|1-i|)><rsup|4\<cdot\>0+2>=<around*|(|1-i|)><rsup|2>=1-2\<cdot\>i+<around*|(|-i|)><rsup|2>=-2\<cdot\>i=-2\<cdot\><around*|(|-4|)><rsup|0>\<cdot\>i>
        proving that <math|0\<in\>\<cal-S\>>
  ...
  The binomial expansion of the power of a sum is used in the theorem so we
  have to define the factorial and the binomial constants and prove the
  binomial formula.
  ...
  <\theorem>
    <label|binomial formula><dueto|Binomial formula>Let <math|F> be a field,
  ...
  <\corollary>
    <label|translate of a polynome>Let <math|p:\<bbb-C\>\<rightarrow\>\<bbb-C\>>
    is a non constant polynomal and <math|z<rsub|0>\<in\>\<bbb-C\>> then
    <math|p<rsub|\<rightarrow\>z<rsub|0>>:\<bbb-C\>\<rightarrow\>\<bbb-C\>>
    defined by <math|p<rsub|\<rightarrow\>z<rsub|0>><around*|(|z|)>=p<around*|(|z+z<rsub|0>|)>>
    is a non constant polynomal of order <math|n>
  </corollary>

  <\proof>
    We prove this by induction so let <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\>\|p<text|
    is a polynomal with >ord<around*|(|p|)>\<leqslant\>n<text| then
    >p<rsub|\<rightarrow\>z<rsub|0>><text| is a polynomal of order >n|}>>
    then we have\ 

    <\description>
      <item*|<math|1\<in\>\<cal-S\>>>If <math|p> is a polynomal of order
      <math|1> then <math|p<around*|(|z|)>=a<rsub|1>\<cdot\>z+a<rsub|0>>
      hence <math|p<rsub|\<rightarrow\>z<rsub|0>><around*|(|z|)>=p<around*|(|z+z<rsub|0>|)>=a<rsub|1>\<cdot\><around*|(|z+z<rsub|0>|)>+a<rsub|0>=a<rsub|1>\<cdot\>z+<around*|(|a<rsub|1>\<cdot\>z<rsub|0>+a<rsub|0>|)>>
      a polynomal of order 1 proving that <math|1\<in\>\<cal-S\>>

      <item*|<math|n\<in\>\<cal-S\>\<Rightarrow\>n+1\<in\>\<cal-S\>>>Let
      <math|p> be a polynomal with <math|ord<around*|(|p|)>\<leqslant\>n+1>
      then we have either\ 

      <\description>
        <item*|<math|ord<around*|(|p|)>\<leqslant\>n>>then as
        <math|n\<in\>\<cal-S\>> we have <math|p<rsub|\<rightarrow\>z<rsub|0>>>
        is a polynomal with order <math|n>

        <item*|<math|ord<around*|(|p|)>=n+1>>then there exists a
        <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n+1|}>>\<subseteq\>\<bbb-C\>>
        with <math|a<rsub|n+1>\<neq\>0> such that

        <\eqnarray*>
          <tformat|<table|<row|<cell|p<around*|(|z|)>>|<cell|=>|<cell|<big|sum><rsub|i=0><rsup|n+1>a<rsub|i>\<cdot\>z<rsup|i>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|n+1>a<rsub|i>\<cdot\>z<rsup|i>+a<rsub|0>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|n+1>z\<cdot\><around*|(|a<rsub|i>\<cdot\>z<rsup|i-1>|)>+a<rsub|0>>>|<row|<cell|>|<cell|=>|<cell|z\<cdot\><big|sum><rsub|i=1><rsup|n+1>a<rsub|i>\<cdot\>z<rsup|i-1>+a<rsub|0>>>|<row|<cell|>|<cell|=>|<cell|z\<cdot\><big|sum><rsub|i=0><rsup|n>a<rsub|i+1>\<cdot\>z<rsup|i>+a<rsub|0>>>|<row|<cell|>|<cell|=>|<cell|z\<cdot\><big|sum><rsub|i=0><rsup|n>b<rsub|i>\<cdot\>z<rsup|i>+a<rsub|0>
          where <around*|{|b<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>
          is defined by b<rsub|i>=a<rsub|i+1>>>|<row|<cell|>|<cell|=>|<cell|z\<cdot\>q<around*|(|z|)>+a<rsub|0><text|
          where >q<text| is a polynomal with >ord<around*|(|q|)>=n
          <around*|(|as b<rsub|n>=a<rsub|n+1>\<neq\>0|)>>>>>
        </eqnarray*>

        As <math|n\<in\>\<cal-S\>> we have that
        <math|q<rsub|\<rightarrow\>z<rsub|0>>> is a polynomal of order
        <math|n> so that there exists a <math|<around*|{|c<rsub|i>|}><rsub|i\<in\>0,\<ldots\>,n>\<subseteq\>\<bbb-C\>>
        such that <math|c<rsub|n>\<neq\>0> and
        <math|q<around*|(|z+z<rsub|0>|)>=q<rsub|\<rightarrow\>z<rsub|0>><around*|(|z|)>=<big|sum><rsub|i=0><rsup|n>c<rsub|i>\<cdot\>z<rsup|i>>
        hence we have\ 

        <\eqnarray*>
          <tformat|<table|<row|<cell|p<rsub|\<rightarrow\>z<rsub|0>><around*|(|z|)>>|<cell|=>|<cell|<around*|(|z+z<rsub|0>|)>\<cdot\>q<around*|(|z+z<rsub|0>|)>+a<rsub|0>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|z+z<rsub|0>|)>\<cdot\>q<rsub|\<rightarrow\>z<rsub|0>><around*|(|z|)>+a<rsub|0>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|z+z<rsub|0>|)>\<cdot\><big|sum><rsub|i=0><rsup|n>c<rsub|i>\<cdot\>z<rsup|i>+a<rsub|0>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=0><rsup|n>c<rsub|i>\<cdot\>z<rsup|i+1>+<big|sum><rsub|i=0><rsup|n><around*|(|z<rsub|0>\<cdot\>c<rsub|i>|)>\<cdot\>z<rsup|i>+a<rsub|0>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|n+1>c<rsub|i-1>\<cdot\>z<rsup|i>+<big|sum><rsub|i=1><rsup|n><around*|(|z<rsub|0>\<cdot\>c<rsub|i>|)>\<cdot\>z<rsup|i>+<around*|(|z<rsub|0>\<cdot\>c<rsub|0>+a<rsub|0>|)>>>|<row|<cell|>|<cell|=>|<cell|c<rsub|n>\<cdot\>z<rsup|n+1>+<big|sum><rsub|i=1><rsup|n><around*|(|c<rsub|i-1>+z<rsub|0>\<cdot\>c<rsub|i>|)>\<cdot\>z<rsup|i>+<around*|(|z<rsub|0>\<cdot\>c<rsub|0>+a<rsub|0>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=0><rsup|n+1>d<rsub|i>\<cdot\>z<rsup|i><text|
          where ><around*|{|d<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n+1|}>><text|
          is defined by >d<rsub|i>=<choice|<tformat|<table|<row|<cell|c<rsub|n>
          if i=n+1>>|<row|<cell|<around*|(|c<rsub|i-1>+z<rsub|0>\<cdot\>c<rsub|i>|)>
          if i\<in\><around*|{|1,\<ldots\>,n|}>>>|<row|<cell|z<rsub|0>\<cdot\>c<rsub|0>+a<rsub|0>>>>>>
          so that d<rsub|n+1>\<neq\>0>>>>
        </eqnarray*>

        which proved that <math|p<rsub|\<rightarrow\>z<rsub|0>>> is a
        polynomal of order <math|n+1> proving that <math|n+1\<in\>\<cal-S\>>
      </description>
    </description>
  </proof>

  <\lemma>
    <label|quotient of polynomal>Let <math|p:\<bbb-C\>\<rightarrow\>\<bbb-C\>>
    be a non constant polynomal of order <math|n\<in\>\<bbb-N\><rsub|0>> then
    there exists a <math|1\<leqslant\>k\<leqslant\>n> and a polynomal
    <math|q> of order <math|n-k> such that
    <math|p<around*|(|z|)>=p<around*|(|0|)>+z<rsup|k>\<cdot\>q<around*|(|z|)>>
    and <math|q<around*|(|0|)>\<neq\>0>
  </lemma>

  <\proof>
    As <math|p> is a polynomal of order <math|n> there exists a
    <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>\<subseteq\>\<bbb-C\>>
    with <math|a<rsub|n>\<neq\>0> so that
    <math|p<around*|(|z|)>=<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>z<rsup|i>>.
    Hence <math|p<around*|(|0|)>=<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>0<rsup|i>=a<rsub|0>>
    further let <math|k=min<around*|{|i\<in\><around*|{|1,\<ldots\>,n|}>\|a<rsub|i>\<neq\>0|}>>
    (which is defined as <math|a<rsub|n>\<neq\>0>) then
    <math|p<around*|(|z|)>=<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>z<rsup|i>=<big|sum><rsub|i=1><rsup|n>a<rsub|i>\<cdot\>z<rsup|i>+a<rsub|0>=<big|sum><rsub|i=k><rsup|n>a<rsub|i>\<cdot\>z<rsup|i>+p<around*|(|0|)>=<big|sum><rsup|n-k><rsub|i=0>a<rsub|i+k>\<cdot\>z<rsup|i+k>+p<around*|(|0|)>=z<rsup|k>\<cdot\><big|sum><rsub|i=0><rsup|n-k>a<rsub|i+k>\<cdot\>z<rsup|i>+p<around*|(|0|)>=p<around*|(|0|)>+q<around*|(|z|)>>
    where <math|q<around*|(|z|)>=<big|sum><rsub|i=0><rsup|n-k>b<rsub|i>> and
    <math|<around*|{|b<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n-k|}>>>
    is defined by <math|b<rsub|i>=a<rsub|i+k>>. Finally
    <math|q<around*|(|0|)>=b<rsub|0>=a<rsub|k>\<neq\>0>.
  </proof>

  <\lemma>
    <label|complex conjugate of a sum>Let <math|n\<in\>\<bbb-N\><rsub|0>> and
    <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\>\<bbb-C\>>
    then <math|<wide|<big|sum><rsub|i=1><rsup|n>a<rsub|i>|\<bar\>>=<big|sum><rsub|i=1><rsup|n><wide|a<rsub|i>|\<bar\>>>
  </lemma>

  <\proof>
    This is easy proved by induction so let
    <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|\<forall\><around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\>\<bbb-C\><text|
    we have ><wide|<big|sum><rsub|i=1><rsup|n>a<rsub|i>|\<bar\>>=<big|sum><rsub|i=1><rsup|n><wide|a<rsub|i>|\<bar\>>|}>>
    then we have\ 

    <\description>
      <item*|<math|1\<in\>\<cal-S\>>>this follows from
      <math|<wide|<big|sum><rsub|i=1><rsup|1>a<rsub|i>|\<bar\>>=<wide|a<rsub|1>|\<bar\>>=<big|sum><rsub|i=1><rsup|1><wide|a<rsub|i>|\<bar\>>>
      for <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,1|}>>\<subseteq\>\<bbb-C\>>

      <item*|<math|n\<in\>\<cal-S\>\<Rightarrow\>n+1\<in\>\<cal-S\>>>we have
      for <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n+1|}>>>
      that

      <\eqnarray*>
        <tformat|<table|<row|<cell|<wide|<big|sum><rsub|i=1><rsup|n+1>a+i|\<bar\>>>|<cell|=>|<cell|<wide|a<rsub|n+1>+<big|sum><rsub|i=1><rsup|n>a<rsub|i>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|<wide|a<rsub|n+1>|\<bar\>>+<wide|<big|sum><rsub|i=1><rsup|n>a<rsub|i>|\<bar\>>>>|<row|<cell|>|<cell|\<equallim\><rsub|n\<in\>\<cal-S\>>>|<cell|<wide|a<rsub|n+1>|\<bar\>>+<big|sum><rsub|i=1><rsup|n><wide|a<rsub|i>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|n+1><wide|a<rsub|i>|\<bar\>>>>>>
      </eqnarray*>
  ...
  <\lemma>
    <label|division of pair sums>Let <math|n\<in\>\<bbb-N\><rsub|0>> then if
    we define <math|A=<around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>
    and <math|\<forall\>m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>>
    <math|B<rsub|m>=<around*|{|<around*|(|k,l|)>\<in\>A\|k+l=m|}>> then
    <math|<big|sqcup><rsub|m\<in\><around*|{|1,\<ldots\>,n-1|}>>B<rsub|m>=A>
  </lemma>

  <\proof>
    As <math|\<forall\>m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>> we have
    that <math|B<rsub|m>\<subseteq\>A> (by definition) we must have that
    <math|<big|cup><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>>B<rsub|m>\<subseteq\>A>.
    If <math|<around*|(|k,l|)>\<in\>A> we have
    <math|0\<leqslant\>k,l\<leqslant\>n> and as <math|k\<less\>l> we have
    <math|> we have that <math|k+l\<less\>l+l\<leqslant\>2\<cdot\>n> so that
    <math|k+l\<leqslant\>2\<cdot\>n-1>, further from
    <math|0\<leqslant\>k\<less\>l> we have
    <math|0\<less\>l\<Rightarrow\>0\<leqslant\>k\<less\>k+l\<Rightarrow\>1\<leqslant\>k+l>
    hence <math|<around*|(|k,l|)>\<in\>B<rsub|k+l>> proving that
    <math|A\<subseteq\><big|cup><rsub|m\<in\><around*|{|1,\<ldots\>,n-1|}>>B<rsub|m>>.
    And thus taking in account the previous that\ 

    <\equation*>
      A=<big|cup><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>>B<rsub|m>
    </equation*>

    If now <math|m,m<rprime|'>\<in\><around*|{|1,\<ldots\>,n-1|}>> with
    <math|m\<neq\>m<rprime|'>> then if <math|<around*|(|k,l|)>\<in\>B<rsub|m><big|cap>B<rsub|m<rprime|'>>>
    we have that <math|m=k+l=m<rprime|'>> contradicting that
    <math|m\<neq\>m<rprime|'>> so we have that\ 
  ...
  <\lemma>
    <label|(1+i/k)^2*k>Let <math|n\<in\>\<bbb-N\><rsub|0>> we have for
    <math|k=2\<cdot\>n> and <math|\<zeta\>=<around*|(|1+<frac|i|k>|)><rsup|2>>
    that <math|Re<around*|(|\<zeta\><rsup|k>|)>\<less\>0\<less\>Img<around*|(|\<zeta\><rsup|k>|)>>
  </lemma>
  ...
  <\proof>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|<stack|<tformat|<table|<row|<cell|2\<cdot\>k>>|<row|<cell|2\<cdot\>j-1>>>>>|)>\<cdot\><frac|1|k<rsup|2\<cdot\>j-1>>-<around*|(|<stack|<tformat|<table|<row|<cell|2\<cdot\>k>>|<row|<cell|2\<cdot\>j+1>>>>>|)>\<cdot\><frac|1|k<rsup|2\<cdot\>j+1>>>|<cell|=>|<cell|<frac|1|k<rsup|2\<cdot\>j-1>>\<cdot\><around*|(|<around*|(|<stack|<tformat|<table|<row|<cell|2\<cdot\>k>>|<row|<cell|2\<cdot\>j-1>>>>>|)>-<around*|(|<stack|<tformat|<table|<row|<cell|2\<cdot\>k>>|<row|<cell|2\<cdot\>j+1>>>>>|)>\<cdot\><frac|1|k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|k<rsup|2\<cdot\>j-1>>\<cdot\><around*|(|<frac|<around*|(|2\<cdot\>k|)>!|<around*|(|2\<cdot\>j-1|)>!\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j+1|)>!>-<frac|<around*|(|2\<cdot\>k|)>!|<around*|(|2\<cdot\>j+1|)>!<around*|(|2\<cdot\>k-2\<cdot\>j-1|)>>\<cdot\><frac|1|k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|<around*|(|2\<cdot\>k|)>!|k<rsup|2\<cdot\>j-1>>\<cdot\><around*|(|<frac|1|<around*|(|2\<cdot\>j-1|)>!\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j+1|)>!>-<frac|1|<around*|(|2\<cdot\>j+1|)>!<around*|(|2\<cdot\>k-2\<cdot\>j-1|)>!\<cdot\>k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|<around*|(|2\<cdot\>k|)>!|k<rsup|2\<cdot\>j-1>>\<cdot\><around*|(|<frac|1|<around*|(|2\<cdot\>j-1|)>!\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j+1|)>!>-<frac|1|<around*|(|2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>j|)>\<cdot\><around*|(|2\<cdot\>j-1|)>!\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j-1|)>!\<cdot\>k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|<around*|(|2\<cdot\>k|)>!|k<rsup|2\<cdot\>j-1>\<cdot\><around*|(|2\<cdot\>j-1|)>!>\<cdot\><around*|(|<frac|1|<around*|(|2\<cdot\>k-2\<cdot\>j+1|)>!>-<frac|1|<around*|(|2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>j|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j-1|)>!\<cdot\>k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|<around*|(|2\<cdot\>k|)>!|k<rsup|2\<cdot\>j-1>\<cdot\><around*|(|2\<cdot\>j-1|)>!>\<cdot\><around*|(|<frac|1|<around*|(|2\<cdot\>k-2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j-1|)>!>-<frac|1|<around*|(|2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>j|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j-1|)>!\<cdot\>k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|<around*|(|2\<cdot\>k|)>!|k<rsup|2\<cdot\>j-1>\<cdot\><around*|(|2\<cdot\>j-1|)>!\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j-1|)>!>\<cdot\><around*|(|<frac|1|<around*|(|2\<cdot\>k-2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j|)>>-<frac|1|<around*|(|2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>j|)>\<cdot\>k<rsup|2>>|)>>>>>
    </eqnarray*>

    Proving that\ 

    <\equation>
      <label|eq 12.59.476><around*|(|<stack|<tformat|<table|<row|<cell|2\<cdot\>k>>|<row|<cell|2\<cdot\>j-1>>>>>|)>\<cdot\><frac|1|k<rsup|2\<cdot\>j-1>>-<around*|(|<stack|<tformat|<table|<row|<cell|2\<cdot\>k>>|<row|<cell|2\<cdot\>j+1>>>>>|)>\<cdot\><frac|1|k<rsup|2\<cdot\>j+1>>=<around*|(|<frac|1|<around*|(|2\<cdot\>k-2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j|)>>-<frac|1|<around*|(|2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>j|)>\<cdot\>k<rsup|2>>|)>
    </equation>

    Now we have using <math|1\<less\>j\<less\>k> that
    <math|2\<cdot\>k-2\<cdot\>j\<gtr\>0> hence\ 

    <\equation>
      <label|eq 12.60.476>0\<less\><around*|(|2\<cdot\>k-2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j|)>,<around*|(|2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>j|)>\<cdot\>k<rsup|2>
    </equation>

    further taking in account that form <math|0\<less\>1\<leqslant\>j> we
    have by <reference|properties of positive, negative real numbers> that
    <math|j<rsup|2>\<geqslant\>1> \ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>j|)>\<cdot\>k<rsup|2>-<around*|(|2\<cdot\>k-2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j|)>>|<cell|=>|<cell|2\<cdot\><around*|[|<around*|(|2\<cdot\>j+1|)>\<cdot\>j\<cdot\>k<rsup|2>-<around*|(|2\<cdot\>k-2\<cdot\>j+1|)>\<cdot\><around*|(|k-j|)>|]>>>|<row|<cell|>|<cell|=>|<cell|2\<cdot\><around*|[|2\<cdot\>j<rsup|2>\<cdot\>k<rsup|2>+j\<cdot\>k<rsup|2>-<around*|[|2\<cdot\>k<rsup|2>-2\<cdot\>k\<cdot\>j+k-2\<cdot\>k\<cdot\>j-2\<cdot\>j<rsup|2>-j|]>|]>>>|<row|<cell|>|<cell|=>|<cell|2\<cdot\><around*|[|2\<cdot\>j<rsup|2>\<cdot\>k<rsup|2>+j\<cdot\>k<rsup|2>-2\<cdot\>k<rsup|2>+2\<cdot\>k\<cdot\>j-k+2\<cdot\>k\<cdot\>j+2\<cdot\>j<rsup|2>+j|]>>>|<row|<cell|>|<cell|=>|<cell|2\<cdot\><around*|[|2\<cdot\>j<rsup|2>\<cdot\>k<rsup|2>+j\<cdot\>k<rsup|2>-2\<cdot\>k<rsup|2>+4\<cdot\>k\<cdot\>j-k+2\<cdot\>j<rsup|2>+j|]>>>|<row|<cell|>|<cell|\<geqslant\>>|<cell|2\<cdot\><around*|[|2\<cdot\>k<rsup|2>+j\<cdot\>k<rsup|2>-2\<cdot\>k<rsup|2>+4\<cdot\>k-k+2\<cdot\>j<rsup|2>+j|]>>>|<row|<cell|>|<cell|=>|<cell|2\<cdot\><around*|[|j\<cdot\>k<rsup|2>3\<cdot\>k+2\<cdot\>j<rsup|2>+j|]>>>|<row|<cell|>|<cell|\<gtr\>>|<cell|0>>>>
    </eqnarray*>

    Hence using the above together with <reference|eq 12.60.476> gives
    <math|<frac|1|<around*|(|2\<cdot\>k-2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j|)>>-<frac|1|<around*|(|2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>j|)>\<cdot\>k<rsup|2>>=<frac|<around*|(|2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>j|)>\<cdot\>k<rsup|2>-<around*|(|2\<cdot\>k-2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j|)>|<around*|(|2\<cdot\>k-2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>k-2\<cdot\>j|)>\<cdot\><around*|(|2\<cdot\>j+1|)>\<cdot\><around*|(|2\<cdot\>j|)>\<cdot\>k<rsup|2>>\<gtr\>0>
    which using <reference|eq 12.59.476> proves that
    <math|<around*|(|<stack|<tformat|<table|<row|<cell|2\<cdot\>k>>|<row|<cell|2\<cdot\>j-1>>>>>|)>\<cdot\><frac|1|k<rsup|2\<cdot\>j-1>>-<around*|(|<stack|<tformat|<table|<row|<cell|2\<cdot\>k>>|<row|<cell|2\<cdot\>j+1>>>>>|)>\<cdot\><frac|1|k<rsup|2\<cdot\>j+1>>\<gtr\>0>.
    Substituting this in <reference|eq 2.746> gives\ 

    <\equation>
      <label|eq 12.61.476>Img<around*|(|<around*|(|1+<frac|i|k>|)><rsup|2\<cdot\>k>|)>\<gtr\>0
    </equation>

    The theorem is then proved by <reference|eq 7.476> and <reference|eq
    12.61.476>
  </proof>

  After all this work we are ready for the fundamental of algebra.

  <\theorem>
    <label|fundamental theorem of algebra>Let
    <math|n\<in\>\<bbb-N\><rsub|0>>, <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>\<subseteq\>\<bbb-C\>>
    with <math|a<rsub|n>\<neq\>0> and <math|p:\<bbb-C\>\<rightarrow\>\<bbb-C\>>
    defined by <math|p<around*|(|z|)>=<big|sum><rsub|i=1><rsup|n>a<rsub|i>\<cdot\>z<rsup|i>>
    there exists a <math|z<rsub|0>\<in\>\<bbb-C\>> such that
    <math|p<around*|(|z<rsub|0>|)>=0> (in other words every non constant
    polynomal has a zero point)
  </theorem>

  <\proof>
    First define <math|p\<cdot\><wide|p|\<bar\>>:\<bbb-C\>\<rightarrow\>\<bbb-R\>>
    by <math|<around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>=p<around*|(|z|)>\<cdot\><wide|p<around*|(|z|)>|\<bar\>>\<geqslant\>0>
    now given <math|z\<in\>\<bbb-C\>> we have\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>>|<cell|=>|<cell|p<around*|(|z|)>\<cdot\><wide|p<around*|(|z|)>|\<bar\>>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|complex
      conjugate of a sum>>>>|<cell|<around*|(|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>|)>\<cdot\><wide|<around*|(|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>|)>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>|)>\<cdot\><around*|(|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><wide|a<rsub|i>\<cdot\>z<rsup|i>|\<bar\>>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>|)>\<cdot\><around*|(|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><wide|a<rsub|i>|\<bar\>>\<cdot\><wide|z<rsup|i>|\<bar\>>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|generalized
      product of generalized sums>>>>|<cell|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k=l|}><big|sqcup><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}><big|sqcup><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|l\<less\>k|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k=l|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|l\<less\>k|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|i>|\<bar\>>\<cdot\><wide|z<rsup|i>|\<bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>+<big|sum><rsub|<around*|(|j,i|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|l\<less\>k|}>>a<rsub|j>\<cdot\>z<rsup|j>\<cdot\><wide|a<rsub|i>|\<bar\>>\<cdot\><wide|z<rsup|i>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|i>|\<bar\>>\<cdot\><wide|z<rsup|i>|\<bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|l,k|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>a<rsub|j>\<cdot\>z<rsup|j>\<cdot\><wide|a<rsub|i>|\<bar\>>\<cdot\><wide|z<rsup|i>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|i>|\<bar\>>\<cdot\><wide|z<rsup|i>|\<bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>+a<rsub|j>\<cdot\>z<rsup|j>\<cdot\><wide|a<rsub|i>|\<bar\>>\<cdot\><wide|z<rsup|i>|\<bar\>>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|i>|\<bar\>>\<cdot\><wide|z<rsup|i>|\<bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>+a<rsub|j>\<cdot\>z<rsup|j>\<cdot\><wide|a<rsub|i>|\<bar\>>\<cdot\><wide|z<rsup|i>|\<bar\>>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|i>|\<bar\>>\<cdot\><wide|z<rsup|i>|\<bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>+<wide|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>|\<bar\>>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|i>|\<bar\>>\<cdot\><wide|z<rsup|i>|\<bar\>>+2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|\||a<rsub|i>|\|><rsup|2>\<cdot\><around*|\||z<rsup|i>|\|><rsup|2>+2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>|)>>>>>
    </eqnarray*>
    ...
    <\eqnarray*>
      ...
      12.66.016><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|\||a<rsub|i>|\|><rsup|2>\<cdot\><around*|\||z<rsup|i>|\|><rsup|2>+2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>|)><eq-number>>>>>
    </eqnarray*>

    Using the above we have

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>>|<cell|=>|<cell|p<around*|(|z|)>\<cdot\><wide|p<around*|(|z|)>|\<bar\>>>>|<row|<cell|>|<cell|\<equallim\><rsub|0\<leqslant\>p<around*|(|z|)>\<cdot\><wide|p<around*|(|z|)>|\<bar\>>\<in\>\<bbb-R\><text|>>>|<cell|<around*|\||p<around*|(|z|)>\<cdot\><wide|p<around*|(|z|)>|\<bar\>>|\|>>>|<row|<cell|>|<cell|\<equallim\><rsub|p<around*|(|z|)>\<cdot\><wide|p<around*|(|z|)>|\<bar\>>\<in\>\<bbb-R\><text|
      and <reference|properties of \|\|\|\| on
      C>>>>|<cell|<around*|\<\|\|\>|p<around*|(|z|)>\<cdot\><wide|p<around*|(|z|)>|\<bar\>>|\<\|\|\>>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|\||a<rsub|i>|\|><rsup|i>\<cdot\><around*|\||z<rsup|i>|\|><rsup|2>+2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>|)>|\<\|\|\>>>>|<row|<cell|>|<cell|\<geqslant\><rsub|<text|<reference|norm
      properties>>>>|<cell|<around*|\||<rsub|><around*|\<\|\|\>|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|\||a<rsub|i>|\|><rsup|2\<cdot\>i>\<cdot\><around*|\||z<rsup|i>|\|><rsup|2>|\<\|\|\>>-<around*|\<\|\|\>|2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>|)>|\<\|\|\>>|\|>>>|<row|<cell|>|<cell|\<geqslant\>>|<cell|<around*|\<\|\|\>|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|\||a<rsub|i>|\|><rsup|2\<cdot\>i>\<cdot\><around*|\||z<rsup|i>|\|><rsup|2>|\<\|\|\>>-2\<cdot\><around*|\<\|\|\>|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>|)>|\<\|\|\>>>>|<row|<cell|>|<cell|\<equallim\><rsub|>>|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|\||a<rsub|i>|\|><rsup|2\<cdot\>i>\<cdot\><around*|\||z<rsup|i>|\|><rsup|2>-2\<cdot\><around*|\<\|\|\>|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>|)>|\<\|\|\>><text|
      as [<math|0\<leqslant\><big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|\||a<rsub|i>|\|><rsup|i>\<cdot\><around*|\||z|\|><rsup|i>\<in\>\<bbb-R\><text|
      and <reference|properties of \|\|\|\| on C>
      (1)>>]>>>|<row|<cell|>|<cell|\<geqslant\>>|<cell|<around*|\||a<rsub|n>|\|><rsup|2\<cdot\>n>\<cdot\><around*|\||z<rsup|n>|\|><rsup|2>-2\<cdot\><around*|\<\|\|\>|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>|\<bar\>>\<cdot\><wide|z<rsup|j>|\<bar\>>|)>|\<\|\|\>><text|]>>>|<row|<cell|>|<cell|\<geqslant\><rsub|<text|<reference|properties
      of \|\|\|\| on C> (3)>>>|<cell|<around*|\||a<rsub|n>|\|><rsup|2\<cdot\>n>\<cdot\><around*|\||z<rsup|n>|\|><rsup|2>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><below|<wide|a<rsub|j>|\<bar\>>|>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z<rsup|i>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z<rsup|j>|\<\|\|\>>>>|<row|<cell|>|<cell|\<geqslant\><rsub|<text|<reference|properties
      of \|\|\|\| on C> (5)>>>|<cell|<around*|\||a<rsub|n>|\|><rsup|2\<cdot\>n>\<cdot\><around*|\||z<rsup|n>|\|><rsup|2>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><below|<wide|a<rsub|j>|\<bar\>>|>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|j>>>|<row|<cell|>|<cell|\<equallim\><rsub|0\<leqslant\><around*|\||z<rsup|n>|\|><rsup|2><text|
      and >\<in\>\<bbb-R\><text|<reference|properties of \|\|\|\| on
      C>>>>|<cell|<around*|\||a<rsub|n>|\|><rsup|2\<cdot\>n>\<cdot\><around*|\<\|\|\>|<around*|\||z<rsup|n>|\|><rsup|2>|\<\|\|\>>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><below|<wide|a<rsub|j>|\<bar\>>|>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>>>|<row|<cell|>|<cell|=>|<cell|<around*|\||a<rsub|n>|\|><rsup|2\<cdot\>n>\<cdot\><around*|\<\|\|\>|z<rsup|n>\<cdot\><wide|z<rsup|n>|\<bar\>>|\<\|\|\>>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><below|<wide|a<rsub|j>|\<bar\>>|>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>>>|<row|<cell|>|<cell|\<geqslant\><rsub|<text|<reference|properties
      of \|\|\|\| on C> (3)>>>|<cell|<around*|\||a<rsub|n>|\|><rsup|2\<cdot\>n><frac|<around*|\<\|\|\>|z<rsup|n>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|<wide|z<rsup|n>|\<bar\>>|\<\|\|\>>|2>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><below|<wide|a<rsub|j>|\<bar\>>|>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|properties
      of \|\|\|\| on C>> <around*|(|2|)>>>|<cell|<around*|\||a<rsub|n>|\|><rsup|2\<cdot\>n><frac|<around*|\<\|\|\>|z<rsup|n>|\<\|\|\>><rsup|2>|2>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><below|<wide|a<rsub|j>|\<bar\>>|>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>>>|<row|<cell|>|<cell|\<geqslant\><rsub|<text|<reference|properties
      of \|\|\|\| on C> (7)>>>|<cell|<around*|\||a<rsub|n>|\|><rsup|2\<cdot\>n><frac|1|2>\<cdot\><around*|(|<frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|n>|2<rsup|n>>|)><rsup|2>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><below|<wide|a<rsub|j>|\<bar\>>|>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>>>|<row|<cell|>|<cell|=>|<cell|<around*|\||a<rsub|i>|\|><rsup|2\<cdot\>n><frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|2\<cdot\>n>|2<rsup|2\<cdot\>n+1>>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><below|<wide|a<rsub|j>|\<bar\>>|>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>
      >>>>
    </eqnarray*>
    ...
    <\equation>
      <label|eq 12.68.016><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>\<geqslant\><around*|\||a<rsub|n>|\|><rsup|2\<cdot\>n><frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|2\<cdot\>n>|2<rsup|2\<cdot\>n+1>>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><below|<wide|a<rsub|j>|\<bar\>>|>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>
    </equation>

    Further by <reference|division of pair sums> that
    <math|><math|A=<around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>=<big|sqcup><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>>B<rsub|m>>
    where <math|B<rsub|m>=<around*|{|<around*|(|k,l|)>\<in\>A\|k+l=m|}>>
    hence

    <\eqnarray*>
      <tformat|<table|<row|<cell|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><below|<wide|a<rsub|j>|\<bar\>>|>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>>|<cell|=>|<cell|<big|sum><rsub|<around*|(|i,j|)>\<in\><big|sqcup><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>>B<rsub|m>><around*|\<\|\|\>|a<rsub|i>\<cdot\><below|<wide|a<rsub|j>|\<bar\>>|>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|general
      associativity of general sums (generals)>>>>|<cell|<big|sum><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>><around*|(|<big|sum><rsub|<around*|(|i,j|)>\<in\>B<rsub|m>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<bar\>>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>><around*|(|<big|sum><rsub|<around*|(|i,j|)>\<in\>B<rsub|m>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<bar\>>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|m>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|m=1><rsup|2\<cdot\>n-1><around*|(|<big|sum><rsub|<around*|(|i,j|)>\<in\>B<rsub|m>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<bar\>>|\<\|\|\>>|)><around*|\<\|\|\>|z|\<\|\|\>><rsup|m>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|m=1><rsup|2\<cdot\>n-1>b<rsub|m>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|m>>>>>
    </eqnarray*>

    where <math|b<rsub|m>=><math|<big|sum><rsub|<around*|(|i,j|)>\<in\>B<rsub|m>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<bar\>>|\<\|\|\>>>.
    Using the above and <reference|eq 12.68.016> gives then that
    <math|<around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>\<geqslant\><around*|\||a<rsub|n>|\|><rsup|2\<cdot\>n><frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|2\<cdot\>n>|2<rsup|2\<cdot\>n+1>>-2\<cdot\><big|sum><rsub|m=1><rsup|n-1>b<rsub|m><around*|\<\|\|\>|z|\<\|\|\>><rsup|n>>
    so if we define <math|<around*|{|c<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>>
    by <math|c<rsub|i>=<choice|<tformat|<table|<row|<cell|-2\<cdot\>b<rsub|m>
    if i\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>>>|<row|<cell|<frac|<around*|\||a<rsub|n>|\|><rsup|2\<cdot\>n>|2<rsup|2\<cdot\>n+1>>
    if i=2\<cdot\>n>>>>>>then\ 

    <\equation>
      <label|eq 12.69.016>c<rsub|n>\<gtr\>0\<wedge\><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>\<geqslant\><big|sum><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n|}>>c<rsub|i>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i>
    </equation>

    As <math|c<rsub|n>\<gtr\>0> we have by <reference|divergent limit of
    sums> that <math|<below|lim|x\<rightarrow\>\<infty\>><around*|(|<big|sum><rsub|i=1><rsup|2\<cdot\>n>c<rsub|i>\<cdot\>x<rsup|i>|)>=\<infty\>>
    hence there exists a <math|R<rprime|'>\<in\>\<bbb-R\>> such that if
    <math|x\<geqslant\>R<rprime|'>> then <math|<big|sum><rsub|i=1><rsup|2\<cdot\>n>c<rsub|i>\<cdot\>x<rsup|i>\<geqslant\><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|0|)>+1>
    so if <math|x\<geqslant\>max<around*|(|R<rprime|'>,1|)>\<gtr\>0\<Rightarrow\>x\<geqslant\>R<rprime|'>>
    we have <math|<big|sum><rsub|i=1><rsup|2\<cdot\>n>c<rsub|i>\<cdot\>x<rsup|i>\<gtr\><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|0|)>>.
    Hence by taking <math|R=max<around*|(|R<rprime|'>,1|)>> we have proved
    that\ 

    <\equation>
      <label|eq 12.70.016>\<exists\>R\<gtr\>0<text| so that if
      <math|<around*|\<\|\|\>|z|\<\|\|\>>\<geqslant\>R <text| then
      ><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>\<gtr\><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|0|)>>>
    </equation>

    Now as <math|<wide|B<rsub|<around*|\<\|\|\>||\<\|\|\>>>|\<bar\>><around*|(|0,R|)>=<around*|{|x\<in\>\<bbb-C\>\|<around*|\<\|\|\>|x|\<\|\|\>>\<leqslant\>\<bbb-R\>|}>>
    is a closed and bounded set in <math|<around*|\<langle\>|\<bbb-C\>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    (see <reference|closed balls are closed> and <reference|every closed,
    open ball is bounded>) we have by <reference|every closed bounded set in
    C is compact> that <math|<wide|B<rsub|<around*|\<\|\|\>||\<\|\|\>>>|\<bar\>><around*|(|0,R|)>>
    is compact. By the extreme value theorem (see <reference|extreme value
    theorem>) and the fact that <math|p\<cdot\><wide|p|\<bar\>>> is
    continuous (see <reference|p is continuous> (5) we have that there exists
    a <math|z<rsub|0>\<in\><wide|B<rsub|<around*|\<\|\|\>||\<\|\|\>>>|\<bar\>><around*|(|0,R|)>>
    such that <math|<around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>\<geqslant\><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z<rsub|0>|)>>
    for every <math|z\<in\><wide|B<rsub|<around*|\<\|\|\>||\<\|\|\>>>|\<bar\>><around*|(|0,R|)>>.
    As <math|0\<in\><wide|B<rsub|<around*|\<\|\|\>||\<\|\|\>>>|\<bar\>><around*|(|0,R|)>>
    we have also <math|><math|<around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|0|)>\<geqslant\><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z<rsub|0>|)>>.
    Hence if <math|z\<in\>\<bbb-C\>> then we have either
    <math|z\<leqslant\>\<bbb-R\>> and thus by the above we have
    <math|<around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>\<geqslant\><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z<rsub|0>|)>>
    or <math|R\<less\>z> and then by <reference|eq 12.70.016> we have
    <math|<around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>\<geqslant\><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|0|)>\<geqslant\><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z<rsub|0>|)>>,
    so we reach the conclusion that\ 

    <\equation>
      <label|eq 12.74.032>\<forall\>z\<in\>\<bbb-C\><text| we have
      ><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z|)>\<geqslant\><around*|(|p\<cdot\><wide|p|\<bar\>>|)><around*|(|z<rsub|0>|)>
    </equation>

    If we define now

    <\equation>
      <label|eq 12.75.032>r:\<bbb-C\>\<rightarrow\>\<bbb-C\><text| by
      >r<around*|(|z|)>=p<around*|(|z+z<rsub|0>|)>
    </equation>

    then <math|r<around*|(|0|)>=p<around*|(|0+z<rsub|0>|)>=p<around*|(|z<rsub|0>|)>>
    and <math|<around*|(|r\<cdot\><wide|r|\<bar\>>|)><around*|(|z|)>=r<around*|(|z|)>\<cdot\><wide|r<around*|(|z|)>|\<bar\>>=p<around*|(|z+z<rsub|0>|)>\<cdot\><wide|p<around*|(|z+z<rsub|0>|)>|\<bar\>>\<geqslant\><around*|(|p<around*|(|z<rsub|0>|)>\<cdot\><wide|p<around*|(|z<rsub|0>|)>|\<bar\>>|)>=r<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>=<around*|(|r\<cdot\><wide|r|\<bar\>>|)><around*|(|0|)>>
    so using <reference|eq 12.74.032> we have that\ 

    <\equation>
      <label|eq 12.76.032>\<forall\>z\<in\>\<bbb-C\><text| we have
      >r<around*|(|z|)>\<cdot\><wide|r<around*|(|z|)>|\<bar\>>-r<around*|(|0|)>\<cdot\><wide|<below|r<around*|(|0|)>|>|\<bar\>>\<geqslant\>0
    </equation>

    By <reference|translate of a polynome> we have that <math|r> is a non
    constant polynomal of order <math|n> hence using <reference|quotient of
    polynomal> we have\ 

    <\equation>
      <label|eq 12.77.032>\<exists\>k\<in\><around*|{|1,\<ldots\>,n|}><text|
      and a polynomal <math|q> of order <math|n-k> such that
      <math|q<around*|(|0|)>\<neq\>0\<wedge\>r<around*|(|z|)>=z<rsup|k>\<cdot\>q<around*|(|z|)>+r<around*|(|0|)>>>
    </equation>

    Then we have that\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|r<around*|(|z|)>\<cdot\><wide|r<around*|(|z|)>|\<bar\>>-r<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>>|<cell|=>|<cell|<around*|(|z<rsup|k>\<cdot\>q<around*|(|z|)>+r<around*|(|0|)>|)>\<cdot\><wide|z<rsup|k>\<cdot\>q<around*|(|z|)>+r<around*|(|0|)>|\<bar\>>-r<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|z<rsup|k>\<cdot\>q<around*|(|z|)>+r<around*|(|0|)>|)>\<cdot\><around*|(|<wide|z<rsup|k>\<cdot\>q<around*|(|z|)>|\<bar\>>+<wide|r<around*|(|0|)>|\<bar\>>|)>-r<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|z<rsup|k>\<cdot\>q<around*|(|z|)>\<cdot\><wide|z<rsup|k>\<cdot\>q<around*|(|z|)>|\<bar\>>+z<rsup|k>\<cdot\>q<around*|(|z|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>+r<around*|(|0|)>\<cdot\><wide|z<rsup|k>\<cdot\>q<around*|(|z|)>|\<bar\>>+r<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>-r<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|z<rsup|k>\<cdot\>q<around*|(|z|)>\<cdot\><wide|z<rsup|k>\<cdot\>q<around*|(|z|)>|\<bar\>>+z<rsup|k>\<cdot\>q<around*|(|z|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>+<wide|z<rsup|k>\<cdot\>q<around*|(|z|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|\<bar\>>>>|<row|<cell|>|<cell|=>|<cell|z<rsup|k>\<cdot\>q<around*|(|z|)>\<cdot\><wide|z<rsup|k>\<cdot\>q<around*|(|z|)>|\<bar\>>+2\<cdot\>Re<around*|(|z<rsup|k>\<cdot\>q<around*|(|z|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>>>>>
    </eqnarray*>

    Using <reference|eq 12.76.032> we have then that\ 

    <\equation>
      <label|eq 12.78.032>z<rsup|k>\<cdot\>q<around*|(|z|)>\<cdot\><wide|z<rsup|k>\<cdot\>q<around*|(|z|)>|\<bar\>>+2\<cdot\>Re<around*|(|z<rsup|k>\<cdot\>q<around*|(|z|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>\<geqslant\>0
    </equation>

    If now <math|x\<in\>\<bbb-C\>> and <math|\<delta\>\<in\>\<bbb-R\>> with
    <math|0\<less\>\<delta\>> then substituing <math|\<delta\>\<cdot\>x> for
    <math|z> in the above gives

    <\eqnarray*>
      <tformat|<table|<row|<cell|0>|<cell|\<leqslant\>>|<cell|<around*|(|\<delta\>\<cdot\>x|)><rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|<around*|(|\<delta\>\<cdot\>x|)><rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\<bar\>>+2\<cdot\>Re<around*|(|<around*|(|\<delta\>\<cdot\>x|)><rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>>>|<row|<cell|>|<cell|=>|<cell|\<delta\><rsup|k>\<cdot\>x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\>\<delta\><rsup|k>\<cdot\><wide|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\<bar\>>+\<delta\><rsup|k>\<cdot\>2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>>>|<row|<cell|>|<cell|=>|<cell|\<delta\><rsup|k>\<cdot\><around*|[|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\>\<delta\><rsup|k>\<cdot\><wide|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\<bar\>>+2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>|]>>>|<row|<cell|>|<cell|=>|<cell|\<delta\><rsup|k>\<cdot\><around*|[|\<delta\><rsup|k>\<cdot\><around*|\||x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\|><rsup|2>+2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>|]>>>>>
    </eqnarray*>

    hence dividing by <math|0\<less\>\<delta\><rsup|k>> we have then\ 

    <\equation>
      <label|eq 12.79.032>\<forall\>r\<gtr\>0,\<forall\>x\<in\>\<bbb-C\><text|
      that >0\<leqslant\>\<delta\><rsup|k>\<cdot\><around*|\||x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\|><rsup|2>+2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>
    </equation>

    If we consider the function <math|f<rsub|1>:\<bbb-R\>\<rightarrow\>\<bbb-R\>>
    defined by <math|f<rsub|1><around*|(|\<delta\>|)>=Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>>
    then using the definitions in <reference|p is continuous> we have that
    <math|f<rsub|1><around*|(|\<delta\>|)>=Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>=<around*|(|Re\<circ\><around*|(|\<cdot\><around*|(|x<rsup|k>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>|)>\<circ\>q<rsub|\<cdot\>x>|)><around*|(|\<delta\>|)>>
    \ hence <math|f<rsub|1>> is continuous as the product of continuous
    functions (see <reference|p is continuous>). Further the function
    <math|f<rsub|2>:\<bbb-R\>\<rightarrow\>\<bbb-R\>> defined by
    <math|f<rsub|2><around*|(|\<delta\>|)>=<around*|\||x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\|><rsup|2>=<around*|(|\<diamondsuit\>\<circ\><around*|(|\<cdot\><around*|(|x<rsup|k>|)>|)>\<circ\>q<rsub|\<cdot\>z>|)><around*|(|\<delta\>|)>>
    is continuous as the composition of continuous functions (see
    <reference|p is continuous>). Hence <math|f<rsub|3>:\<bbb-R\>\<rightarrow\>\<bbb-R\>>
    defined by <math|f<rsub|3><around*|(|\<delta\>|)>=\<delta\><rsup|k>\<cdot\><around*|\||x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\|><rsup|2>=\<delta\><rsup|k>\<cdot\>f<rsub|2><around*|(|\<delta\>|)>>
    is continuous as the product of continuous function and
    <math|f<rsub|4>\<of\>\<bbb-R\>\<rightarrow\>\<bbb-R\>> defined by
    <math|f<rsub|4><around*|(|\<delta\>|)>=2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>>
    is continuous as the product of a constant (thus continuous function) and
    a continuous function. So finally <math|f:\<bbb-R\>\<rightarrow\>\<bbb-R\>>
    defined by <math|f<around*|(|\<delta\>|)>=\<delta\><rsup|k>\<cdot\><around*|\||x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\|><rsup|2>+2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>=f<rsub|3><around*|(|\<delta\>|)>+f<rsub|4><around*|(|\<delta\>|)>>
    is continuous as the sum of continuous functions. To summerize

    <\equation>
      <label|eq 12.80.024>\<forall\>x\<in\>\<bbb-C\>\<vDash\>f:\<bbb-R\>\<rightarrow\>\<bbb-R\>
      defined by f<around*|(|\<delta\>|)>=\<delta\><rsup|k>\<cdot\><around*|\||x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\|><rsup|2>+2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>
      is continuous
    </equation>

    Using <reference|eq 12.79.032> we have <math|\<forall\>\<delta\>\<gtr\>0>
    that <math|0\<leqslant\>f<around*|(|\<delta\>|)>>. Asume now that
    <math|f<around*|(|0|)>\<less\>0> then if we take
    <math|\<varepsilon\>=-f<around*|(|0|)>> there exists by continuity of
    <math|f> a <math|\<zeta\>\<gtr\>0> such that for
    <math|0\<less\><frac|\<zeta\>|2>\<less\>\<zeta\>> we have
    <math|<around*|\||f<around*|(|<frac|\<zeta\>|2>|)>-f<around*|(|0|)>|\|>\<less\>-f<around*|(|0|)>>
    and as <math|f<around*|(|0|)>\<less\>0\<leqslant\>f<around*|(|<frac|\<zeta\>|2>|)>>
    we have <math|f<around*|(|<frac|\<zeta\>|2>|)>-f<around*|(|0|)>=<around*|\||f<around*|(|<frac|\<zeta\>|2>|)>-f<around*|(|0|)>|\|>\<less\>-f<around*|(|0|)>>
    proving that <math|0\<leqslant\>f<around*|(|<frac|\<zeta\>|2>|)>\<less\>0>
    a contradiction. So we must have that
    <math|0\<leqslant\>f<around*|(|0|)>> giving using the definition of
    <math|f> that

    <\equation>
      <label|eq 12.81.024>\<forall\>x\<in\>\<bbb-C\><text| we have
      >0\<leqslant\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>|)>=Re<around*|(|x<rsup|k>\<cdot\><around*|(|a+i\<cdot\>b|)>|)><text|
      where <math|q<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>=a+i\<cdot\>b>>
    </equation>

    Then for <math|k\<in\><around*|{|1,\<ldots\>,n|}>> we have the following
    cases

    <\description>
      <item*|<math|k<text| is odd>>>then if <math|x=1> we have
      <math|0\<leqslant\>Re<around*|(|1<rsup|k>\<cdot\><around*|(|a+i\<cdot\>b|)>|)>=Re<around*|(|a+i\<cdot\>b|)>=a>,
      if <math|x=-1> we have <math|0\<leqslant\>Re<around*|(|<around*|(|-1|)><rsup|k>\<cdot\><around*|(|a+i\<cdot\>b|)>|)>=Re<around*|(|-a-i\<cdot\>b|)>=-a>
      from which it follows that

      <\equation>
        <label|eq 12.82.024>a=0
      </equation>

      As <math|k> is odd then we have that <math|k=2\<cdot\>m+1> and for
      <math|m> we have again two cases\ 

      <\description>
        <item*|<math|m=even>>then <math|m=2\<cdot\>l\<Rightarrow\>><math|k=4\<cdot\>l+1>
        hence if <math|x=i> we have by <reference|power of i> that
        <math|x<rsup|k>=i<rsup|k>=i> and thus
        <math|0\<leqslant\>Re<around*|(|i\<cdot\>a-b|)>=-b> and if
        <math|x=-i> then <math|x<rsup|k>=<around*|(|-i|)><rsup|k>=<around*|(|-1|)><rsup|k>\<cdot\>i<rsup|k>=-i>
        and thus <math|0\<leqslant\>Re<around*|(|-i\<cdot\>a+b|)>=b> proving
        that <math|b=0>

        <item*|<math|m=odd>>then <math|m=2\<cdot\>l+1\<Rightarrow\>k=4\<cdot\>l+3>
        hence if <math|x=i> we have by <reference|power of i> that
        <math|x<rsup|k>=i<rsup|k>=-i> and thus
        <math|0\<leqslant\>Re<around*|(|-i\<cdot\>a+b|)>=b> and if
        <math|x=-i> then <math|x<rsup|k>=<around*|(|-i|)><rsup|k>=<around*|(|-1|)><rsup|k>\<cdot\>i<rsup|k>=<around*|(|-1|)>\<cdot\><around*|(|-i|)>=i>
        and thus <math|0\<leqslant\>Re<around*|(|i\<cdot\>a-b|)>=-b> proving
        that <math|b=0>
      </description>

      So in all cases we have that <math|b=0> which together with
      <reference|eq 12.82.024> we have that
      <math|q<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>=0> we
      have as <math|q<around*|(|0|)>\<neq\>0> (see <reference|eq 12.77.032>)
      that <math|<wide|r<around*|(|0|)>|\<bar\>>=0> hence we have\ 

      <\equation*>
        r<around*|(|0|)>=0
      </equation*>

      <item*|<math|k<text| is even>>>As <math|k> is even we have
      <math|k=2\<cdot\>m> and then we have two cases for <math|m> to consider

      <\description>
        <item*|<math|m> is odd>then <math|m=2\<cdot\>l+1> and
        <math|k=4\<cdot\>l+2>, using <reference|power of i> we have then that
        <math|i<rsup|k>=-1> so if <math|x=i\<Rightarrow\>x<rsup|k>=-1> we
        have <math|0\<leqslant\>Re<around*|(|-a-i\<cdot\>b|)>=-a>, if
        <math|x=1> then <math|x<rsup|k>=1> so that
        <math|0\<leqslant\>Re<around*|(|a+i\<cdot\>b|)>=a> which proves that
        <math|a=0>. Hence if we take <math|x=<around*|(|1\<pm\>i|)>> we have
        <math|0\<leqslant\>Re<around*|(|x<rsup|k>\<cdot\><around*|(|a+i\<cdot\>b|)>|)>=Re<around*|(|<around*|(|1\<pm\>i|)><rsup|4\<cdot\>l+2>\<cdot\>i\<cdot\>b|)>\<equallim\><rsub|<text|<reference|(1+i)^2>>>Re<around*|(|\<pm\>2\<cdot\><around*|(|-4|)><rsup|l>\<cdot\>i\<cdot\>i\<cdot\>b|)>=Re<around*|(|\<mp\>2\<cdot\><around*|(|-4|)><rsup|l>\<cdot\>b|)>=\<mp\>2\<cdot\><around*|(|-4|)><rsup|l>\<cdot\>b>
        proving <math|0\<leqslant\>b\<vee\>0\<leqslant\>-b> hence <math|b=0>.
        So we have <math|q<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>=0\<Rightarrowlim\><rsub|q<around*|(|0|)>\<neq\>0><wide|r<around*|(|0|)>|\<bar\>>=0>
        and thus
        ...
        <item*|<math|m> is even>then <math|m=2\<cdot\>l> and
        <math|k=4\<cdot\>l> if <math|x=1> we have
        <math|0\<leqslant\>Re<around*|(|1<rsup|k>\<cdot\><around*|(|a+i\<cdot\>b|)>|)>=Re<around*|(|a+i\<cdot\>b|)>=a>
        proving that\ 

        <\equation>
          <label|eq 12.83.024>0\<leqslant\>a
        </equation>

        Use now <math|x=<around*|(|1+<frac|i|2\<cdot\>l>|)>> we have then
        that <math|x<rsup|k>=<around*|(|1+<frac|i|2\<cdot\>l>|)><rsup|4\<cdot\>l>=<around*|(|<around*|(|1+<frac|i|2\<cdot\>l>|)><rsup|2>|)><rsup|k>>
        then using <reference|(1+i/k)^2*k> we have that
        <math|Re<around*|(|x<rsup|k>|)>\<less\>0\<less\>Im<around*|(|x<rsup|k>|)>>.
        As <math|x<rsup|k>\<in\>\<bbb-C\>> we have a
        <math|c,d\<in\>\<bbb-R\>> with <math|x<rsup|k>=c+i\<cdot\>d> and
        <math|c=Re<around*|(|x<rsup|k>|)>\<less\>0\<less\>Img<around*|(|x<rsup|k>|)>=d>.
        Hence using <reference|eq 12.81.024> we have
        <math|0\<leqslant\>Re<around*|(|<around*|(|c+i\<cdot\>d|)>\<cdot\><around*|(|a+i\<cdot\>b|)>|)>=Re<around*|(|<around*|(|c\<cdot\>a-d\<cdot\>b|)>+i\<cdot\><around*|(|c\<cdot\>b+d\<cdot\>a|)>|)>=c\<cdot\>a-d\<cdot\>b>
        proving\ 

        <\equation>
          <label|eq 12.84.024>0\<leqslant\>a\<cdot\>c-b\<cdot\>d\ 
        </equation>

        If we take now <math|y=<wide|x|\<bar\>>> so that
        <math|y<rsup|k>=<wide|x|\<bar\>><rsup|k>\<equallim\><rsub|<text|<reference|complex
        conjugate of power>>><wide|x<rsup|k>|\<bar\>>=c-i\<cdot\>d> by
        <reference|eq 12.81.024> we have then that
        <math|0\<leqslant\>Re<around*|(|y<rsup|k>\<cdot\><around*|(|a+i\<cdot\>b|)>|)>=Re<around*|(|<around*|(|c-i\<cdot\>d|)>\<cdot\><around*|(|a+i\<cdot\>b|)>|)>=Re<around*|(|<around*|(|c\<cdot\>a+d\<cdot\>b|)>+i\<cdot\><around*|(|c\<cdot\>b-d\<cdot\>a|)>|)>=c\<cdot\>a+d\<cdot\>b>
        proving\ 

        <\equation>
          <label|eq 12.85.024>0\<leqslant\>a\<cdot\>c+b\<cdot\>d
        </equation>

        Summing <reference|eq 12.84.024> and <reference|eq 12.85.024> gives
        that <math|0\<leqslant\>a\<cdot\>c-b\<cdot\>d+a\<cdot\>c+b\<cdot\>d=2\<cdot\>a\<cdot\>c\<Rightarrow\>0\<leqslant\>a\<cdot\>c>
        and as <math|c\<less\>0> we have <math|a\<leqslant\>0> which by
        <reference|eq 12.83.024> proves that <math|a=0>. Substituting this in
        <reference|eq 12.84.024> and <reference|eq 12.85> proves that
        <math|0\<leqslant\>-b\<cdot\>d\<Rightarrow\>b\<cdot\>d\<leqslant\>0>
        and <math|0\<leqslant\>b\<cdot\>d> hence <math|b\<cdot\>d=0> and as
        <math|0\<less\>d> we have <math|b=0>. So we concude that
        <math|q<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<bar\>>=0\<Rightarrowlim\><rsub|q<around*|(|0|)>\<neq\>0><wide|r<around*|(|0|)>|\<bar\>>=0>
        and thus\ 
    ...
    hence for all cases of <math|k> we have that <math|r<around*|(|0|)>=0>.
    As by definition (see <reference|eq 12.75.032>)
    <math|0=r<around*|(|0|)>=p<around*|(|0+z<rsub|0>|)>=p<around*|(|z<rsub|0>|)>>
    we have proved finally that <math|p<around*|(|z<rsub|0>|)>=0> and we have
    find a zero of the polyomial <math|p> proving the fundamental theorem of
    algebra.
  </proof>
...
<\initial>
  <\collection>
    ...
    <associate|section-nr|12<uninit>>
...
<\references>
  <\collection>
    <associate|(1+i)^2|<tuple|12.378|?>>
    <associate|(1+i/k)^2*k|<tuple|12.389|?>>
    <associate|@ product|<tuple|12.192|398>>
    <associate|@ prouct property|<tuple|12.193|398>>
    <associate|B(X,Y) is a Banach space if Y is|<tuple|12.301|420>>
    <associate|Baire Category Theorem|<tuple|12.336|429>>
    <associate|Baire space|<tuple|12.42|363>>
    <associate|Cauchy includes bounded|<tuple|12.324|425>>
    <associate|Cauchy sequences in metric spaces|<tuple|12.284|417>>
    <associate|Complete matric space|<tuple|12.295|419>>
    <associate|Continuity of function on a topological
    product|<tuple|12.124|378>>
    <associate|Hausdorff spaces|<tuple|12.196|399>>
    <associate|L(X,Y)|<tuple|12.162|387>>
    <associate|L(X^n;Y)|<tuple|12.173|392>>
    <associate|L(x1)(x2:..:xn)|<tuple|12.184|394>>
    <associate|L(x1,..,xm) is in Ln-m(X;Y)|<tuple|12.182|394>>
    <associate|L^(X;Y) is equivalent with L(X^n;Y)|<tuple|12.191|396>>
    <associate|L^n(X1,..,Xn;),L(Xn+1,Y))=L^n+1(X1,..,Xn+1;Y)|<tuple|12.179|393>>
    <associate|L^n(X1,...,Xn;Y)|<tuple|12.175|393>>
    <associate|L^n(X;L(X,Y))=L^n(X;Y)|<tuple|12.180|393>>
    <associate|L^n(X;Y)|<tuple|12.177|393>>
    <associate|L^n(X;Y) is a Banach space if Y is a Banach
    space|<tuple|12.328|426>>
    <associate|Lipschitz continuous functions are uniform
    continuous|<tuple|12.132|380>>
    <associate|Lischitz continuity|<tuple|12.131|380>>
    <associate|Pn(L) definition|<tuple|12.188|396>>
    <associate|Pn(L)(x1,..,xn)=Pn-1(L)(x1,..,xn-1)(xn)|<tuple|12.189|396>>
    <associate|R^2 is homeomorphism to C|<tuple|12.146|383>>
    <associate|R^2 is isometric with C|<tuple|12.107|375>>
    <associate|Rieman Integral|<tuple|12.353|436>>
    <associate|Riemann Integral (general)|<tuple|12.358|437>>
    <associate|Tychonoff|<tuple|12.265|413>>
    <associate|[a,@@[ is closed|<tuple|12.72|368>>
    <associate|[a,b] is compact|<tuple|12.235|406>>
    <associate|a closed set is equal to its closurer|<tuple|12.17|358>>
    <associate|a contraction mapping is continuous|<tuple|12.330|427>>
    <associate|a isometry is a homeomorphism|<tuple|12.145|383>>
    <associate|a second countable basis is first
    countable|<tuple|12.209|400>>
    <associate|accumulation and closure|<tuple|12.245|408>>
    <associate|alternate definition of a compact subset|<tuple|12.216|401>>
    <associate|alternate definition of closed set|<tuple|12.21|358>>
    <associate|alternative definition of Baire sets|<tuple|12.44|363>>
    <associate|alternative definition of Riemann Integral|<tuple|12.356|437>>
    <associate|alternative definition of a bounded
    function|<tuple|12.297|419>>
    <associate|another characterization of Cauchy|<tuple|12.285|417>>
    <associate|auto-1|<tuple|12|355>>
    <associate|auto-10|<tuple|12.11|356>>
    <associate|auto-100|<tuple|12.11.1|416>>
    <associate|auto-101|<tuple|12.277|416>>
    <associate|auto-102|<tuple|12.280|416>>
    <associate|auto-103|<tuple|12.283|417>>
    <associate|auto-104|<tuple|12.284|417>>
    <associate|auto-105|<tuple|12.295|419>>
    <associate|auto-106|<tuple|12.295|419>>
    <associate|auto-107|<tuple|12.296|419>>
    <associate|auto-108|<tuple|12.296|419>>
    <associate|auto-109|<tuple|12.302|420>>
    <associate|auto-11|<tuple|12.11|356>>
    <associate|auto-110|<tuple|12.329|427>>
    <associate|auto-111|<tuple|12.333|427>>
    <associate|auto-112|<tuple|12.336|429>>
    <associate|auto-113|<tuple|12.337|430>>
    <associate|auto-114|<tuple|12.12|432>>
    <associate|auto-115|<tuple|12.341|433>>
    <associate|auto-116|<tuple|12.344|433>>
    <associate|auto-117|<tuple|12.347|435>>
    <associate|auto-118|<tuple|12.347|435>>
    <associate|auto-119|<tuple|12.348|435>>
    <associate|auto-12|<tuple|12.18|358>>
    <associate|auto-120|<tuple|12.348|435>>
    <associate|auto-121|<tuple|12.349|435>>
    <associate|auto-122|<tuple|12.349|435>>
    <associate|auto-123|<tuple|12.353|436>>
    <associate|auto-124|<tuple|12.353|436>>
    <associate|auto-125|<tuple|12.358|437>>
    <associate|auto-126|<tuple|12.358|437>>
    <associate|auto-127|<tuple|12.13|440>>
    <associate|auto-128|<tuple|12.364|440>>
    <associate|auto-129|<tuple|12.366|441>>
    <associate|auto-13|<tuple|12.18|358>>
    <associate|auto-130|<tuple|12.14|442>>
    <associate|auto-131|<tuple|12.372|442>>
    <associate|auto-132|<tuple|12.380|446>>
    <associate|auto-133|<tuple|12.380|446>>
    <associate|auto-14|<tuple|12.18|358>>
    <associate|auto-15|<tuple|12.1.2|358>>
    <associate|auto-16|<tuple|12.23|358>>
    <associate|auto-17|<tuple|12.23|358>>
    <associate|auto-18|<tuple|12.28|359>>
    <associate|auto-19|<tuple|12.29|360>>
    <associate|auto-2|<tuple|12.1|355>>
    <associate|auto-20|<tuple|12.34|361>>
    <associate|auto-21|<tuple|12.1.3|363>>
    <associate|auto-22|<tuple|12.41|363>>
    <associate|auto-23|<tuple|12.42|363>>
    <associate|auto-24|<tuple|12.2|364>>
    <associate|auto-25|<tuple|12.45|364>>
    <associate|auto-26|<tuple|12.47|364>>
    <associate|auto-27|<tuple|12.49|364>>
    <associate|auto-28|<tuple|12.49|364>>
    <associate|auto-29|<tuple|12.50|364>>
    <associate|auto-3|<tuple|12.1|355>>
    <associate|auto-30|<tuple|12.50|364>>
    <associate|auto-31|<tuple|12.54|364>>
    <associate|auto-32|<tuple|12.58|365>>
    <associate|auto-33|<tuple|12.60|365>>
    <associate|auto-34|<tuple|12.65|367>>
    <associate|auto-35|<tuple|12.65|367>>
    <associate|auto-36|<tuple|12.65|367>>
    <associate|auto-37|<tuple|12.3|367>>
    <associate|auto-38|<tuple|12.68|367>>
    <associate|auto-39|<tuple|12.68|367>>
    <associate|auto-4|<tuple|12.1|355>>
    <associate|auto-40|<tuple|12.68|367>>
    <associate|auto-41|<tuple|12.73|368>>
    <associate|auto-42|<tuple|12.73|368>>
    <associate|auto-43|<tuple|12.82|371>>
    <associate|auto-44|<tuple|12.85|371>>
    <associate|auto-45|<tuple|12.4|372>>
    <associate|auto-46|<tuple|12.89|372>>
    <associate|auto-47|<tuple|12.92|372>>
    <associate|auto-48|<tuple|12.5|376>>
    <associate|auto-49|<tuple|12.109|376>>
    <associate|auto-5|<tuple|12.1|355>>
    <associate|auto-50|<tuple|12.109|376>>
    <associate|auto-51|<tuple|12.113|376>>
    <associate|auto-52|<tuple|12.113|376>>
    <associate|auto-53|<tuple|12.113|376>>
    <associate|auto-54|<tuple|12.114|376>>
    <associate|auto-55|<tuple|12.118|377>>
    <associate|auto-56|<tuple|12.128|379>>
    <associate|auto-57|<tuple|12.133|380>>
    <associate|auto-58|<tuple|12.138|381>>
    <associate|auto-59|<tuple|12.143|382>>
    <associate|auto-6|<tuple|12.6|356>>
    <associate|auto-60|<tuple|12.144|382>>
    <associate|auto-61|<tuple|12.6|385>>
    <associate|auto-62|<tuple|12.157|386>>
    <associate|auto-63|<tuple|12.157|386>>
    <associate|auto-64|<tuple|12.162|387>>
    <associate|auto-65|<tuple|12.7|389>>
    <associate|auto-66|<tuple|12.170|391>>
    <associate|auto-67|<tuple|12.173|392>>
    <associate|auto-68|<tuple|12.175|393>>
    <associate|auto-69|<tuple|12.177|393>>
    <associate|auto-7|<tuple|12.9|356>>
    <associate|auto-70|<tuple|12.188|396>>
    <associate|auto-71|<tuple|12.192|398>>
    <associate|auto-72|<tuple|12.8|399>>
    <associate|auto-73|<tuple|12.196|399>>
    <associate|auto-74|<tuple|12.199|399>>
    <associate|auto-75|<tuple|12.202|399>>
    <associate|auto-76|<tuple|12.204|399>>
    <associate|auto-77|<tuple|12.204|399>>
    <associate|auto-78|<tuple|12.205|400>>
    <associate|auto-79|<tuple|12.206|400>>
    <associate|auto-8|<tuple|12.9|356>>
    <associate|auto-80|<tuple|12.208|400>>
    <associate|auto-81|<tuple|12.9|400>>
    <associate|auto-82|<tuple|12.210|400>>
    <associate|auto-83|<tuple|12.212|400>>
    <associate|auto-84|<tuple|12.10|401>>
    <associate|auto-85|<tuple|12.214|401>>
    <associate|auto-86|<tuple|12.215|401>>
    <associate|auto-87|<tuple|12.225|403>>
    <associate|auto-88|<tuple|12.228|403>>
    <associate|auto-89|<tuple|12.232|405>>
    <associate|auto-9|<tuple|12.1.1|356>>
    <associate|auto-90|<tuple|12.10.1|407>>
    <associate|auto-91|<tuple|12.239|407>>
    <associate|auto-92|<tuple|12.244|408>>
    <associate|auto-93|<tuple|12.244|408>>
    <associate|auto-94|<tuple|12.253|410>>
    <associate|auto-95|<tuple|12.259|411>>
    <associate|auto-96|<tuple|12.10.2|413>>
    <associate|auto-97|<tuple|12.265|413>>
    <associate|auto-98|<tuple|12.268|413>>
    <associate|auto-99|<tuple|12.11|416>>
    <associate|ball cover of a metric space|<tuple|12.230|403>>
    <associate|ball in balls|<tuple|12.53|364>>
    <associate|basic binomial property|<tuple|12.382|446>>
    <associate|basis for the product topology|<tuple|12.37|361>>
    <associate|basis of a topology|<tuple|12.23|358>>
    <associate|basis of product topology|<tuple|12.38|362>>
    <associate|basis of the subspace topology|<tuple|12.25|359>>
    <associate|binomial constant|<tuple|12.380|446>>
    <associate|binomial formula|<tuple|12.383|447>>
    <associate|bounded function|<tuple|12.296|419>>
    <associate|box topology|<tuple|12.34|361>>
    <associate|box topology and base|<tuple|12.35|361>>
    <associate|cauchy and uniqueness|<tuple|12.321|424>>
    <associate|characterization of a basis in a topology|<tuple|12.26|359>>
    <associate|characterization of closure|<tuple|12.19|358>>
    <associate|characterization of closure (another)|<tuple|12.30|360>>
    <associate|characterization of closure of a set|<tuple|12.20|358>>
    <associate|characterization of closure of a set 2|<tuple|12.31|360>>
    <associate|closed ball|<tuple|12.50|364>>
    <associate|closed balls are closed|<tuple|12.56|365>>
    <associate|closed rectangles are compact in the norm
    topology|<tuple|12.267|413>>
    <associate|closed sets|<tuple|12.11|356>>
    <associate|closed subset of a complete space is
    complete|<tuple|12.305|421>>
    <associate|combined partition|<tuple|12.344|433>>
    <associate|compact Hausdorf space is regular and
    normal|<tuple|12.226|403>>
    <associate|compact space in a metric space is bounded|<tuple|12.220|402>>
    <associate|compact subsets|<tuple|12.215|401>>
    <associate|compact subsets of subsets|<tuple|12.219|401>>
    <associate|compact subsets of the reals|<tuple|12.268|413>>
    <associate|compact subspaces are closed|<tuple|12.222|402>>
    <associate|compact subspaces are sequential compact|<tuple|12.229|403>>
    <associate|compact topological space|<tuple|12.214|401>>
    <associate|compactness and base|<tuple|12.227|403>>
    <associate|compactness and closed sets|<tuple|12.223|402>>
    <associate|compactness and linear isometry|<tuple|12.272|415>>
    <associate|compactness and sequential compactness|<tuple|12.231|404>>
    <associate|complex conjugate of a sum|<tuple|12.386|449>>
    <associate|complex inner space|<tuple|12.92|372>>
    <associate|composition of a continuous linear mapping and a continuous
    multilinear mapping is a continuous linear mapping|<tuple|12.171|391>>
    <associate|composition of continuous functions is
    continuous|<tuple|12.121|378>>
    <associate|composition of continuous linear mapping is continuous and
    multilinear|<tuple|12.174|392>>
    <associate|composition of homeomorphisms is a
    homeomorphism|<tuple|12.142|382>>
    <associate|composition of isometries metric|<tuple|12.62|366>>
    <associate|composition of isometries norm|<tuple|12.87|371>>
    <associate|composition of open functions is open|<tuple|12.120|378>>
    <associate|conditions to make a basis|<tuple|12.27|359>>
    <associate|conjugate of sum|<tuple|12.98|373>>
    <associate|connected space|<tuple|12.364|440>>
    <associate|connected subset|<tuple|12.366|441>>
    <associate|constant functions are continuous|<tuple|12.114|376>>
    <associate|construction of new filterbases|<tuple|12.242|407>>
    <associate|continuity and connectness|<tuple|12.369|442>>
    <associate|continuity and multilinearity|<tuple|12.166|389>>
    <associate|continuity at a point and topological
    basis|<tuple|12.110|376>>
    <associate|continuity characterization|<tuple|12.116|377>>
    <associate|continuity in metric spaces|<tuple|12.125|379>>
    <associate|continuity is local|<tuple|12.117|377>>
    <associate|continuity of a function in a subspace of a metric
    space|<tuple|12.126|379>>
    <associate|continuity of a function on a normed
    subspace|<tuple|12.130|380>>
    <associate|continuity of function in a normed space|<tuple|12.129|379>>
    <associate|continuity of restricted maps|<tuple|12.111|376>>
    <associate|continuity of vector space operations|<tuple|12.135|380>>
    <associate|continuity to a subspace|<tuple|12.112|376>>
    <associate|continuous function|<tuple|12.109|376>>
    <associate|continuous functions on a compact set are uniform
    continue|<tuple|12.236|406>>
    <associate|continuous functions to a product space|<tuple|12.123|378>>
    <associate|continuous image of compact set|<tuple|12.221|402>>
    <associate|continuous linear maps in a normed space|<tuple|12.153|385>>
    <associate|continuous mapping in [a,b]|<tuple|12.370|442>>
    <associate|contraction|<tuple|12.329|427>>
    <associate|convergence in a metric space|<tuple|12.280|416>>
    <associate|convergence in a normed space|<tuple|12.287|417>>
    <associate|convergence in normed space|<tuple|12.287|417>>
    <associate|convergence in topological and metric
    space|<tuple|12.281|417>>
    <associate|convergence is independent of start of
    sequence|<tuple|12.279|416>>
    <associate|convergence of powersequence|<tuple|12.293|418>>
    <associate|convergency in a topological space|<tuple|12.277|416>>
    <associate|convergent criteria of a serie in a Banach
    space|<tuple|12.316|423>>
    <associate|convergent filterbase|<tuple|12.244|408>>
    <associate|convergent sequences are Cauchy|<tuple|12.286|417>>
    <associate|converging and accumulation|<tuple|12.251|409>>
    <associate|converging of upper serie|<tuple|12.314|422>>
    <associate|countable compact class|<tuple|12.232|405>>
    <associate|definition of a serie|<tuple|12.310|422>>
    <associate|definition of the operator norm of a multilinear
    mapping|<tuple|12.168|390>>
    <associate|dense subset|<tuple|12.41|363>>
    <associate|diameter|<tuple|12.65|367>>
    <associate|difference of Riemann sums|<tuple|12.350|435>>
    <associate|differences of tagged partitions|<tuple|12.351|436>>
    <associate|distance functions|<tuple|12.133|380>>
    <associate|divergence limits|<tuple|12.372|442>>
    <associate|divergent limit and negate|<tuple|12.373|442>>
    <associate|divergent limit of sums|<tuple|12.374|443>>
    <associate|divide in even and odd numbers|<tuple|12.387|449>>
    <associate|division of pair sums|<tuple|12.388|450>>
    <associate|each filterbase converges to exactly one
    point|<tuple|12.250|408>>
    <associate|eq 1.476|<tuple|12.60|453>>
    <associate|eq 11.1|<tuple|12.1|360>>
    <associate|eq 11.10|<tuple|12.10|369>>
    <associate|eq 11.11|<tuple|12.11|380>>
    <associate|eq 11.12|<tuple|12.12|381>>
    <associate|eq 11.13|<tuple|12.13|387>>
    <associate|eq 11.14|<tuple|12.14|387>>
    <associate|eq 11.15|<tuple|12.15|387>>
    <associate|eq 11.16|<tuple|12.16|391>>
    <associate|eq 11.17|<tuple|12.18|404>>
    <associate|eq 11.17 bis|<tuple|12.17|395>>
    <associate|eq 11.18|<tuple|12.19|404>>
    <associate|eq 11.19|<tuple|12.23|425>>
    <associate|eq 11.2|<tuple|12.2|360>>
    <associate|eq 11.20|<tuple|12.24|426>>
    <associate|eq 11.21|<tuple|12.25|426>>
    <associate|eq 11.22|<tuple|12.26|426>>
    <associate|eq 11.23|<tuple|12.27|428>>
    <associate|eq 11.24|<tuple|12.28|428>>
    <associate|eq 11.25|<tuple|12.29|428>>
    <associate|eq 11.26|<tuple|12.30|429>>
    <associate|eq 11.27|<tuple|12.31|429>>
    <associate|eq 11.28|<tuple|12.32|429>>
    <associate|eq 11.29|<tuple|12.33|429>>
    <associate|eq 11.3|<tuple|12.4|366>>
    <associate|eq 11.30|<tuple|12.3|366>>
    <associate|eq 11.30.|<tuple|12.34|430>>
    <associate|eq 11.31|<tuple|12.35|430>>
    <associate|eq 11.32|<tuple|12.36|430>>
    <associate|eq 11.33|<tuple|12.37|431>>
    <associate|eq 11.34|<tuple|12.38|431>>
    <associate|eq 11.35|<tuple|12.39|431>>
    <associate|eq 11.36|<tuple|12.40|431>>
    <associate|eq 11.38|<tuple|12.42|431>>
    <associate|eq 11.39|<tuple|12.43|431>>
    <associate|eq 11.4|<tuple|12.5|366>>
    <associate|eq 11.40|<tuple|12.44|432>>
    <associate|eq 11.42|<tuple|12.46|432>>
    <associate|eq 11.43|<tuple|12.47|432>>
    <associate|eq 11.44|<tuple|12.48|435>>
    <associate|eq 11.45|<tuple|12.49|436>>
    <associate|eq 11.46|<tuple|12.50|436>>
    <associate|eq 11.47|<tuple|12.51|438>>
    <associate|eq 11.48|<tuple|12.52|438>>
    <associate|eq 11.49|<tuple|12.53|439>>
    <associate|eq 11.5|<tuple|12.6|366>>
    <associate|eq 11.50|<tuple|12.54|439>>
    <associate|eq 11.7|<tuple|12.7|367>>
    <associate|eq 11.8|<tuple|12.8|367>>
    <associate|eq 11.9|<tuple|12.9|369>>
    <associate|eq 12.21.032|<tuple|12.21|415>>
    <associate|eq 12.22.032|<tuple|12.22|415>>
    <associate|eq 12.52.015|<tuple|12.55|444>>
    <associate|eq 12.53.015|<tuple|12.56|444>>
    <associate|eq 12.54.015|<tuple|12.57|444>>
    <associate|eq 12.55.016|<tuple|12.58|444>>
    <associate|eq 12.56.015|<tuple|12.59|445>>
    <associate|eq 12.59.476|<tuple|12.67|456>>
    <associate|eq 12.60.476|<tuple|12.68|456>>
    <associate|eq 12.61.476|<tuple|12.69|456>>
    <associate|eq 12.66.016|<tuple|12.390|457>>
    <associate|eq 12.68.016|<tuple|12.71|458>>
    <associate|eq 12.69.016|<tuple|12.72|459>>
    <associate|eq 12.70.016|<tuple|12.73|459>>
    <associate|eq 12.74.032|<tuple|12.74|459>>
    <associate|eq 12.75.032|<tuple|12.75|459>>
    <associate|eq 12.76.032|<tuple|12.76|459>>
    <associate|eq 12.77.032|<tuple|12.77|459>>
    <associate|eq 12.78.032|<tuple|12.78|459>>
    <associate|eq 12.79.032|<tuple|12.79|460>>
    <associate|eq 12.80.024|<tuple|12.80|460>>
    <associate|eq 12.81.024|<tuple|12.81|460>>
    <associate|eq 12.82.024|<tuple|12.82|460>>
    <associate|eq 12.83.024|<tuple|12.83|?>>
    <associate|eq 12.84|<tuple|12.84|?>>
    <associate|eq 12.84.024|<tuple|12.84|?>>
    <associate|eq 12.85.024|<tuple|12.85|?>>
    <associate|eq 2.746|<tuple|12.61|453>>
    <associate|eq 3.476|<tuple|12.62|454>>
    <associate|eq 4.476|<tuple|12.63|454>>
    <associate|eq 5.476|<tuple|12.64|455>>
    <associate|eq 6.476|<tuple|12.65|455>>
    <associate|eq 7.476|<tuple|12.66|455>>
    <associate|equiality in L^n(X;Y)|<tuple|12.183|394>>
    <associate|equivalence of norms|<tuple|12.83|371>>
    <associate|equivalence of norms on product of real
    numbers|<tuple|12.271|414>>
    <associate|equivalence of operator norm (multilinear)|<tuple|12.172|391>>
    <associate|equivalent definition of homeomorphism|<tuple|12.139|381>>
    <associate|equivalent metric|<tuple|12.58|365>>
    <associate|equivalent norms|<tuple|12.82|371>>
    <associate|eucledan norm|<tuple|12.105|375>>
    <associate|ev_L is linear and continuous|<tuple|12.194|398>>
    <associate|ev_l + @|<tuple|12.195|398>>
    <associate|every closed bounded set in C is compact|<tuple|12.273|415>>
    <associate|every closed, open ball is bounded|<tuple|12.66|367>>
    <associate|every compact metric space is complete|<tuple|12.322|424>>
    <associate|every finite dimensional space is Banach|<tuple|12.326|425>>
    <associate|every finite subset of a Hausdorff is
    closed|<tuple|12.198|399>>
    <associate|example of continuous mappings in a topological vector
    space|<tuple|12.213|400>>
    <associate|exaple of a convergent serie|<tuple|12.332|427>>
    <associate|exchange infinite sum and finite sum|<tuple|12.318|423>>
    <associate|existance of Riemann integral for continuous
    function|<tuple|12.357|437>>
    <associate|existance of converging tagged
    partititions|<tuple|12.355|437>>
    <associate|existance of isometry,isomorphism,homeomorphism|<tuple|12.147|383>>
    <associate|existance of maximal filterbase|<tuple|12.261|411>>
    <associate|existance of maximum and minimum in the image of a continuous
    function of a compact set|<tuple|12.270|414>>
    <associate|exmpty set is compact|<tuple|12.217|401>>
    <associate|extreme value theorem|<tuple|12.225|403>>
    <associate|filter base has the finite intersection
    property|<tuple|12.243|408>>
    <associate|filterbase and closure|<tuple|12.254|410>>
    <associate|filterbase and continuity 1|<tuple|12.256|410>>
    <associate|filterbase and continuity 2|<tuple|12.257|410>>
    <associate|filterbase on a set|<tuple|12.253|410>>
    <associate|filterbases and compactness|<tuple|12.264|412>>
    <associate|filterbases and products|<tuple|12.258|410>>
    <associate|finer basis|<tuple|12.32|360>>
    <associate|finer metric|<tuple|12.59|365>>
    <associate|finer norm|<tuple|12.78|370>>
    <associate|finite product topology is box topology|<tuple|12.39|362>>
    <associate|finite subset of filterbase|<tuple|12.238|407>>
    <associate|finite sum of continuous functions is
    continuous|<tuple|12.149|384>>
    <associate|finite union of compact subsets are
    compact|<tuple|12.218|401>>
    <associate|first countable topological space|<tuple|12.206|400>>
    <associate|fundamental system of neighborhoods|<tuple|12.205|400>>
    <associate|fundamental theorem of algebra|<tuple|12.390|456>>
    <associate|generalized intervals and connectness|<tuple|12.368|441>>
    <associate|generating basis of a topology|<tuple|12.28|359>>
    <associate|homeomorphism|<tuple|12.138|381>>
    <associate|homeomorphism on subset|<tuple|12.140|381>>
    <associate|identity function is continuous|<tuple|12.115|376>>
    <associate|in a normed space the sum,product with scalar is
    ontinuous|<tuple|12.148|383>>
    <associate|induced topology|<tuple|12.143|382>>
    <associate|inner product norm of finite dimensional
    spaces|<tuple|12.106|375>>
    <associate|inner product of neutral elements|<tuple|12.95|372>>
    <associate|inner product on R^n|<tuple|12.91|372>>
    <associate|inner set|<tuple|12.9|356>>
    <associate|integral of function to linear operators|<tuple|12.363|440>>
    <associate|intersection of balls|<tuple|12.52|364>>
    <associate|intersection of finite open sets is open|<tuple|12.4|355>>
    <associate|introduction of the multilinear norm|<tuple|12.167|389>>
    <associate|inverse induced topology|<tuple|12.144|382>>
    <associate|inverse of a homeomorphisme|<tuple|12.141|382>>
    <associate|inverse of continuous linear mappings between Banach space is
    continuous|<tuple|12.338|432>>
    <associate|inverse of isometry metric|<tuple|12.61|366>>
    <associate|inverse of isometry norm|<tuple|12.86|371>>
    <associate|inverse of open map is continuous|<tuple|12.119|377>>
    <associate|isometry and balls|<tuple|12.63|366>>
    <associate|isometry norm|<tuple|12.85|371>>
    <associate|limit and continuity|<tuple|12.294|418>>
    <associate|limit in a Hausdorff space is unique|<tuple|12.278|416>>
    <associate|limit of a convergent sequence is unique in a metric
    space|<tuple|12.282|417>>
    <associate|limit of a partial function|<tuple|12.47|364>>
    <associate|limit of a sequence in a metric space|<tuple|12.283|417>>
    <associate|limit of a sum|<tuple|12.309|422>>
    <associate|limit point|<tuple|12.18|358>>
    <associate|limit point of sequences|<tuple|12.320|424>>
    <associate|limit preserve inequality|<tuple|12.306|421>>
    <associate|limit preserves inequality (2)|<tuple|12.308|421>>
    <associate|limit preserves inequality (3)|<tuple|12.307|421>>
    <associate|linear combination of convergent series|<tuple|12.315|423>>
    <associate|linear continuous mappings and +,.|<tuple|12.158|386>>
    <associate|linear isomorphism between R^n is a
    homeomorphism|<tuple|12.155|385>>
    <associate|linear mappins between products of the real spaces are
    continuous|<tuple|12.154|385>>
    <associate|linear maps between finite dimesnional spaces are
    continuous|<tuple|12.274|415>>
    <associate|linear open mappings|<tuple|12.165|388>>
    <associate|linearity of integral|<tuple|12.359|438>>
    <associate|local property of open sets|<tuple|12.5|355>>
    <associate|mapping of a filterbase|<tuple|12.255|410>>
    <associate|max(alfa.A)|<tuple|12.79|370>>
    <associate|maximal filterbase and mapping|<tuple|12.263|412>>
    <associate|maximal filterbase characterization|<tuple|12.260|411>>
    <associate|maximum filterbase and convergence|<tuple|12.262|412>>
    <associate|metric spaces are Hausdorff|<tuple|12.197|399>>
    <associate|metric spaces are first countable|<tuple|12.207|400>>
    <associate|metric spaces are regular|<tuple|12.200|399>>
    <associate|metric topology|<tuple|12.54|364>>
    <associate|neighborhood|<tuple|12.204|399>>
    <associate|neighborhood filter base|<tuple|12.239|407>>
    <associate|neighborhood filterbase converges|<tuple|12.246|408>>
    <associate|neighborhood filterbase is a filterbase|<tuple|12.240|407>>
    <associate|norm and absolute value|<tuple|12.74|368>>
    <associate|norm mappings are continuous in the produc tof
    reals|<tuple|12.137|381>>
    <associate|norm of L(x1:..:xn}|<tuple|12.186|395>>
    <associate|norm of a finite sum|<tuple|12.75|369>>
    <associate|norm of a multilinear mapping|<tuple|12.169|390>>
    <associate|norm of a partition|<tuple|12.347|435>>
    <associate|norm of composition of linear mapping|<tuple|12.161|387>>
    <associate|norm of continuous linear mapping (inf)|<tuple|12.156|386>>
    <associate|norm of finite product of normed spaces|<tuple|12.80|370>>
    <associate|norm properties|<tuple|12.70|368>>
    <associate|normal space|<tuple|12.202|399>>
    <associate|normed space|<tuple|12.68|367>>
    <associate|normed space of bounded functions|<tuple|12.300|419>>
    <associate|normed space properties|<tuple|12.77|369>>
    <associate|normed topology|<tuple|12.73|368>>
    <associate|norms in R and C are equivalent|<tuple|12.84|371>>
    <associate|open ball|<tuple|12.49|364>>
    <associate|open functions|<tuple|12.118|377>>
    <associate|open functions in metric spaces|<tuple|12.127|379>>
    <associate|open maaping theorem|<tuple|12.337|430>>
    <associate|open sets in metric topology|<tuple|12.55|364>>
    <associate|p is continuous|<tuple|12.377|445>>
    <associate|partial sum and product is continuous|<tuple|12.136|381>>
    <associate|partition covers interval|<tuple|12.342|433>>
    <associate|partition of a interval|<tuple|12.341|433>>
    <associate|partitions and combined parititions|<tuple|12.346|434>>
    <associate|power function is continuous|<tuple|12.152|385>>
    <associate|power of a continuous function is
    continuous|<tuple|12.151|384>>
    <associate|principle of nested intervals|<tuple|12.234|405>>
    <associate|product of compact subspaces|<tuple|12.266|413>>
    <associate|product of continuous functions is
    continue|<tuple|12.150|384>>
    <associate|product of metric spaces|<tuple|12.67|367>>
    <associate|product topological of subspace topologies|<tuple|12.40|363>>
    <associate|product topology|<tuple|12.36|361>>
    <associate|projection map is continuous and linear|<tuple|12.160|387>>
    <associate|projection map is open and open|<tuple|12.122|378>>
    <associate|properties of parititions|<tuple|12.343|433>>
    <associate|properties of two filterbases|<tuple|12.249|408>>
    <associate|properties of \|\|\|\| on C|<tuple|12.376|443>>
    <associate|property of integral|<tuple|12.360|438>>
    <associate|pseudo metric space|<tuple|12.45|364>>
    <associate|quotient of polynomal|<tuple|12.385|449>>
    <associate|real continuous mappings on a compact
    subset|<tuple|12.269|414>>
    <associate|real inner product spaces|<tuple|12.89|372>>
    <associate|real space is complete|<tuple|12.323|425>>
    <associate|regular space|<tuple|12.199|399>>
    <associate|regularity and non empty open sets|<tuple|12.201|399>>
    <associate|riemanian sum|<tuple|12.349|435>>
    <associate|schwartz inequality|<tuple|12.102|374>>
    <associate|second countable topological space|<tuple|12.208|400>>
    <associate|sequential compact space|<tuple|12.228|403>>
    <associate|set distance functions are lipschitz|<tuple|12.134|380>>
    <associate|set of compact sets is a countable compact
    class|<tuple|12.233|405>>
    <associate|space of linear continuous maps to a Banach space is
    Banach|<tuple|12.327|425>>
    <associate|special cases of the binomial constant|<tuple|12.381|446>>
    <associate|splitting of a integral|<tuple|12.362|440>>
    <associate|stitching topologies|<tuple|12.29|360>>
    <associate|sub basis topology|<tuple|12.33|361>>
    <associate|subserie property|<tuple|12.313|422>>
    <associate|subspace topology|<tuple|12.6|356>>
    <associate|subspace topology of a metric space|<tuple|12.57|365>>
    <associate|subspace topology of subspace topology|<tuple|12.8|356>>
    <associate|sum of positive numbers is positive|<tuple|12.96|372>>
    <associate|sum of powers theorem|<tuple|12.331|427>>
    <associate|sum,product on (x1:..:xn)|<tuple|12.185|395>>
    <associate|tagged partition|<tuple|12.348|435>>
    <associate|terms of a convergent series goes to 0|<tuple|12.312|422>>
    <associate|the Banach Fixed Point Theorem|<tuple|12.333|427>>
    <associate|the alternative definition of the norm of a continuous linear
    function|<tuple|12.159|387>>
    <associate|the inner product norm is a norm|<tuple|12.104|375>>
    <associate|the norm of a continuous linear mapping|<tuple|12.157|386>>
    <associate|the set of linear continuous mappings is a vector
    space|<tuple|12.163|387>>
    <associate|toplinear isomorphism|<tuple|12.212|400>>
    <associate|topologies and isometries|<tuple|12.64|366>>
    <associate|topology of R^n|<tuple|12.81|371>>
    <associate|topology of real complex numbers|<tuple|12.71|368>>
    <associate|topology of spaces which are isometric in the
    norm|<tuple|12.88|371>>
    <associate|topology of the set of real numbers|<tuple|12.76|369>>
    <associate|translate of a polynome|<tuple|12.384|448>>
    <associate|triangle inequality of inner product norm|<tuple|12.103|374>>
    <associate|trivial filterbase|<tuple|12.241|407>>
    <associate|ultra filter|<tuple|12.259|411>>
    <associate|uniform continuous|<tuple|12.128|379>>
    <associate|uniform convergence|<tuple|12.302|420>>
    <associate|uniform convergence in bounded functions|<tuple|12.303|420>>
    <associate|uniform convergence preserves continuity|<tuple|12.304|421>>
    <associate|union of tagged partitions|<tuple|12.361|439>>
    <associate|uniqueness and riemansums|<tuple|12.352|436>>
    <associate|upper limit of L in L^n(K;Y)|<tuple|12.187|395>>
    <associate|vector space of multilinear continuous
    mappings|<tuple|12.170|391>>
    <associate|\|\|L\|\| depends only on the topology|<tuple|12.164|388>>
  </collection>
</references>
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      ...
      <tuple|<tuple|distance function>|<pageref|auto-57>>

      <tuple|<tuple|homeomorphism>|<pageref|auto-58>>

      <tuple|<tuple|induced topology>|<pageref|auto-59>>

      <tuple|<tuple|inverse induced topology>|<pageref|auto-60>>

      <tuple|<tuple|norm of a continuous linear function>|<pageref|auto-62>>

      <tuple|<tuple|<with|mode|<quote|math>|<around*|\<\|\|\>|L|\<\|\|\>>>>|<pageref|auto-63>>

      <tuple|<tuple|<with|mode|<quote|math>|L<around*|(|X,Y|)>>>|<pageref|auto-64>>

      <tuple|<tuple|<with|mode|<quote|math>|L<around*|(|X<rsub|1>,\<ldots\>,X<rsub|n>;Y|)>>>|<pageref|auto-66>>

      <tuple|<tuple|<with|mode|<quote|math>|L<around*|(|X<rsup|n>;Y|)>>>|<pageref|auto-67>>

      <tuple|<tuple|<with|mode|<quote|math>|L<rsup|n><around*|(|X<rsub|1>,\<ldots\>,X<rsub|n>;Y|)>>>|<pageref|auto-68>>

      <tuple|<tuple|<with|mode|<quote|math>|L<rsup|n><around*|(|X;Y|)>>>|<pageref|auto-69>>

      <tuple|<tuple|<with|mode|<quote|math>|\<cal-P\><rsub|n><around*|(|L|)>>>|<pageref|auto-70>>

      <tuple|<tuple|<with|mode|<quote|math>|\<bullet\><rsub|n>>>|<pageref|auto-71>>

      <tuple|<tuple|Hausdorff space>|<pageref|auto-73>>

      <tuple|<tuple|regular space>|<pageref|auto-74>>

      <tuple|<tuple|normal space>|<pageref|auto-75>>

      <tuple|<tuple|neighborhood>|<pageref|auto-76>>

      <tuple|<tuple|open neighborhood>|<pageref|auto-77>>

      <tuple|<tuple|fundamental system of neighborhoods>|<pageref|auto-78>>

      <tuple|<tuple|first countable topological space>|<pageref|auto-79>>

      <tuple|<tuple|second countable topological space>|<pageref|auto-80>>

      <tuple|<tuple|topological vector space>|<pageref|auto-82>>

      <tuple|<tuple|toplinear isomorphism>|<pageref|auto-83>>

      <tuple|<tuple|compact topological space>|<pageref|auto-85>>

      <tuple|<tuple|compact subsets>|<pageref|auto-86>>

      <tuple|<tuple|extreme value theorem>|<pageref|auto-87>>

      <tuple|<tuple|sequential compact space>|<pageref|auto-88>>

      <tuple|<tuple|countable compact class>|<pageref|auto-89>>

      <tuple|<tuple|<with|mode|<quote|math>|\<frak-U\><around*|(|x|)>>>|<pageref|auto-91>>

      <tuple|<tuple|convergent filterbase>|<pageref|auto-92>>

      <tuple|<tuple|accumulation point of a filterbase>|<pageref|auto-93>>

      <tuple|<tuple|filterbase on a set>|<pageref|auto-94>>

      <tuple|<tuple|ultra filter>|<pageref|auto-95>>

      <tuple|<tuple|Tychonoff's theorem>|<pageref|auto-97>>

      <tuple|<tuple|Heine-Borel theorem>|<pageref|auto-98>>

      <tuple|<tuple|convergency in a topological space>|<pageref|auto-101>>

      <tuple|<tuple|convergence in a metric space>|<pageref|auto-102>>

      <tuple|<tuple|<with|mode|<quote|math>|<below|lim|i\<rightarrow\>\<infty\>>x<rsub|i>>>|<pageref|auto-103>>

      <tuple|<tuple|Cauchy sequence>|<pageref|auto-104>>

      <tuple|<tuple|complete metric space>|<pageref|auto-105>>

      <tuple|<tuple|Banach space>|<pageref|auto-106>>

      <tuple|<tuple|bounded function>|<pageref|auto-107>>

      <tuple|<tuple|<with|mode|<quote|math>|\<cal-B\><around*|(|X,Y|)>>>|<pageref|auto-108>>

      <tuple|<tuple|uniform convergence>|<pageref|auto-109>>

      <tuple|<tuple|contraction>|<pageref|auto-110>>

      <tuple|<tuple|Banach fixed point theorem>|<pageref|auto-111>>

      <tuple|<tuple|Baire Category Theorem>|<pageref|auto-112>>

      <tuple|<tuple|open mapping theorem>|<pageref|auto-113>>

      <tuple|<tuple|partition of <with|mode|<quote|math>|<around*|[|a,b|]>>>|<pageref|auto-115>>

      <tuple|<tuple|<with|mode|<quote|math>|\<cal-P\><rsub|1>\<boxplus\>\<cal-P\><rsub|2>>>|<pageref|auto-116>>

      <tuple|<tuple|norm of a partition>|<pageref|auto-117>>

      <tuple|<tuple|<with|mode|<quote|math>|\<mu\><around*|(|\<cal-P\>|)>>>|<pageref|auto-118>>

      <tuple|<tuple|tagged paritition>|<pageref|auto-119>>

      <tuple|<tuple|<with|mode|<quote|math>|\<bbb-P\>>>|<pageref|auto-120>>

      <tuple|<tuple|Riemanian sum>|<pageref|auto-121>>

      <tuple|<tuple|<with|font-family|<quote|tt>|language|<quote|verbatim>|<with|mode|<quote|math>|\<cal-S\><around*|(|f,\<bbb-P\>|)>>>>|<pageref|auto-122>>

      <tuple|<tuple|Rieman Integral>|<pageref|auto-123>>

      <tuple|<tuple|<with|mode|<quote|math>|<big|int><rsub|a><rsup|b>f>>|<pageref|auto-124>>

      <tuple|<tuple|Riemann Integral>|<pageref|auto-125>>

      <tuple|<tuple|<with|mode|<quote|math>|<big|int><rsup|b><rsub|a>f>>|<pageref|auto-126>>

      <tuple|<tuple|connected space>|<pageref|auto-128>>

      <tuple|<tuple|connected subset>|<pageref|auto-129>>

      <tuple|<tuple|divergent limit>|<pageref|auto-131>>

      <tuple|<tuple|binomial constant>|<pageref|auto-132>>

      <tuple|<tuple|<with|mode|<quote|math>|<around*|(|<tformat|<twith|table-valign|C>|<cwith|1|-1|1|-1|cell-halign|c>|<cwith|1|-1|1|1|cell-lsep|0spc>|<cwith|1|-1|-1|-1|cell-rsep|0spc>|<cwith|1|-1|1|-1|cell-bsep|0.5sep>|<cwith|1|-1|1|-1|cell-tsep|0.5sep>|<cwith|1|1|1|-1|cell-tsep|0sep>|<cwith|-1|-1|1|-1|cell-bsep|0sep>|<tformat|<table|<row|<cell|n>>|<row|<cell|k>>>>>|)>>>|<pageref|auto-133>>
    </associate>
    <\associate|toc>
      ...
      12.14<space|2spc>Fundamental theorem of algebra
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
