...
<\body>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <item>As <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> we
      have by <smart-ref|measure integral properties (1)>\ 
  ...
  <\lemma>
    ...
    is a <with|font-series|bold|function> defined by
  ...
  <\proof>
    ...
    <\equation>
      ...
      \<forall\>x\<in\>X that \<cal-X\><rsub|E,A><around*|(|x|)>=\<cal-X\><rsub|A><around*|(|x|)>
    </equation>
  ...
  <\proof>
    ...
    based on a measurable set> (1) <math|A<rsub|i>\<in\>\<cal-A\>> and
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 18.339.009.1>\<forall\>n\<in\>\<bbb-N\>\<vDash\>0\<leqslant\>f<rsub|n>\<leqslant\>f<rsub|n+1><infix-and>f=<rsub|a.e.<around*|[|\<mu\><rsub|E>|]>><below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><infix-and>sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\><rsub|E>\|n\<in\>\<bbb-N\>|}>|)>\<less\>\<infty\>
    </equation>
  ...
  <\proof>
    ...
    value of a restriction>>><around*|\||f|\|><rsub|\|E<big|cap>G>> is
    <math|\<cal-A\><rsub|E>>-measurable we have
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|x\<in\>E\\A>>then <math|<around*|(|\<cal-X\><rsub|A>|)><rsub|\|E><around*|(|x|)>\<equallim\><rsub|x\<in\>E>\<cal-X\><rsub|A><around*|(|x|)>\<equallim\><rsub|x\<nin\>A<rsub|i>>0\<equallim\><rsub|x\<nin\>A<big|cap>E>\<cal-X\><rsub|E,A<big|cap>E><around*|(|x|)>>

      <item*|<math|x\<in\>E<big|cap>A>>then
      <math|<around*|(|\<cal-X\><rsub|A>|)><rsub|\|E><around*|(|x|)>\<equallim\><rsub|x\<in\>E>\<cal-X\><rsub|A><around*|(|x|)>\<equallim\><rsub|x\<in\>A<rsub|i>>1\<equallim\><rsub|x\<in\>A<big|cap>E>\<cal-X\><rsub|E,\<cal-A\><big|cap>E><around*|(|x|)><rsub|>>
    </description>
    ...
    so that <math|<around*|{|A<rsub|i><big|cap>E|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\>\<cal-A\><rsub|E>>.
    ...
    which as <math|<around*|{|A<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\>\<cal-A\>>
    means that <math|f<rsub|\|E>\<in\>\<cal-S\><around*|[|E,\<cal-A\><rsub|E>|]>>.
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 18.360.011>\<forall\>x\<in\>dom<around*|(|f|)> we have
      f<around*|(|x|)>\<in\><around*|[|0,\<infty\>|[>\<wedge\>\<exists\><around*|{|f<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-S\><around*|[|X,\<cal-A\>|]>
      such that \<forall\>n\<in\>\<bbb-N\><space|1em>0\<leqslant\>f<rsub|n>\<leqslant\>f<rsub|N+1>,sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)><infix-and>
    ...
    <\equation>
      <label|eq 18.361.011>\<forall\>x\<in\>dom<around*|(|f<rsub|\|E>|)> we
      have f<rsub|\|E><around*|(|x|)>\<in\><around*|[|0,\<infty\>|[>
    </equation>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|x\<comma\>A<big|cap>E>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><big|cap>dom<around*|(|f|)><big|cap>E\<wedge\><below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>
      exists>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|<text|<smart-ref|eq
      ...
      exists>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|<around*|{|x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E>|)><big|cap>dom<around*|(|f<rsub|\|E>|)><below||>\|<below|lim|n\<rightarrow\>\<infty\>><around*|(|f<rsub|n>|)><rsub|\|E><around*|(|x|)>
      exists|\<nobracket\>>>>>>
    </eqnarray*>
    ...
    that <math|\<exists\>n\<in\>\<bbb-N\>> such that
    <math|I=<big|int><rsup|S><around*|(|f<rsub|n>|)><rsub|\|E>d\<mu\><rsub|E>\<leqslant\><big|int><rsup|S>f<rsub|n>d\<mu\>\<in\><around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>>
  ...
  <\proposition>
    Let <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a
    measure space <math|f:X\<rightarrow\>\<bbb-R\>> a partial function then\ 
    ...
    <\enumerate>
      ...
      If <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\description>
        <item*|<math|x\<in\>dom<around*|(|f|)>\\E>>then <math|x\<in\>X\\E>
        and <math|<around*|(|f<rsub|\|E>|)><rsup|E><around*|(|x|)>=0=f<around*|(|x|)>\<cdot\>0=f<around*|(|x|)>\<cdot\>\<cal-X\><rsub|E><around*|(|x|)>=<around*|(|f\<cdot\>\<cal-X\><rsub|E>|)><around*|(|x|)>>

        <item*|<math|x\<in\>dom<around*|(|f|)><big|cap>E>>then
        <math|x\<in\>dom<around*|(|f<rsub|\|E>|)>> so that
        <math|<around*|(|f<rsub|\|E>|)><rsup|E><around*|(|x|)>=f<rsub|\|E><around*|(|x|)>=f<around*|(|x|)>\<equallim\><rsub|x\<in\>E>f<around*|(|x|)>\<cdot\>\<cal-X\><rsub|E><around*|(|x|)>=<around*|(|f\<cdot\>\<cal-X\><rsub|E>|)><around*|(|x|)>>
      </description>
      ...
      <\equation>
        <label|eq 18.359.010><around*|(|f<rsub|\|E>|)><rsup|E>=<rsub|a.e.>f\<cdot\>\<cal-X\><rsub|E>
      </equation>

      If now <math|f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
      we have by the previous corollary <smart-ref|extension of integrable
      functions> that <math|<around*|(|f<rsub|\|E>|)><rsup|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
      ...
      then applying <smart-ref|eq 18.359.010> on <smart-ref|measure integral
      properties (2)> (2) proves that <math|<around*|(|f<rsub|\|E>|)><rsup|E>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
      ...
      then <math|<big|int><rsub|E>f d\<mu\>\<equallim\><rsub|def><big|int>f<rsub|\|E>d\<mu\><rsub|\<mu\>>\<equallim\><rsub|<text|<smart-ref|extension
      of integrable functions>><infix-and><text|<smart-ref|eq
      18.359.010>>><big|int><around*|(|f<rsub|\|E>|)><rsup|E>d\<mu\>\<equallim\><rsub|<text|<smart-ref|measure
      integral properties (2)>>><big|int>f\<cdot\>\<cal-X\><rsub|E>d\<mu\>>
      proving\ 
      ...
      <math|0\<leqslant\><rsub|a.e.<around*|[|\<mu\><rsub|E>|]>>f<rsub|\|E>\<in\>\<cal-L\><around*|[|E,\<cal-A\><rsub|E>,\<mu\><rsub|E>|]>>
      <math|\<forall\>E\<in\>\<cal-A\>> so that by <smart-ref|measure
      integral properties (1)> <math|> <math|0\<leqslant\><big|int>f<rsub|\|E>d\<mu\><rsub|E>\<equallim\><rsub|def><big|int><rsub|E>f
      d\<mu\>>, proving\ 

      <\equation*>
        0\<leqslant\><rsub|a.e.<around*|[|\<mu\>|]>>f\<Rightarrow\>0\<leqslant\><big|int><rsub|E>f
        d\<mu\> \<forall\>E\<in\>\<cal-A\>
      </equation*>
...
<\references>
  <\collection>
    ...
    <associate|Beppo Levi|<tuple|18.147|801>>
    <associate|Beppo Levi positive numbers|<tuple|18.146|797>>
    <associate|Borel algebras|<tuple|18.13|716>>
    <associate|Borel algebras and generator|<tuple|18.11|716>>
    <associate|Borel functions and intersection|<tuple|18.100|762>>
    ...
    <associate|Fatou|<tuple|18.148|802>>
    ...
    <associate|Lebesgue's dominant convergence theorem|<tuple|18.149|803>>
    ...
    <associate|a\<less\>=a.e.f=\<gtr\>a\<less\>=a.e.f\|E|<tuple|18.152|?>>
    <associate|absolute function is Borel measurable|<tuple|18.99|762>>
    <associate|absolute value of a restriction|<tuple|18.90|?>>
    ...
    <associate|characteristics function on a set|<tuple|18.159|?>>
    <associate|characteristics function on a subset|<tuple|18.158|?>>
    <associate|characteristics function properties|<tuple|18.110|775>>
    <associate|characteristics function recapitulation|<tuple|18.107|774>>
    <associate|charcteristics function is measurable|<tuple|18.109|774>>
    <associate|closed intervals and Borel Sets|<tuple|18.58|743>>
    <associate|conegligible of subspace|<tuple|18.151|?>>
    ...
    functions|<tuple|18.142|793>>
    <associate|domain of integrable functions are
    conegligible|<tuple|18.137|792>>
    ...
    <associate|eq 18.339.009|<tuple|18.341|?>>
    <associate|eq 18.339.009.1|<tuple|18.340|?>>
    <associate|eq 18.339.010|<tuple|18.339|?>>
    <associate|eq 18.34.001|<tuple|18.45|732>>
    <associate|eq 18.340.009|<tuple|18.342|?>>
    <associate|eq 18.341.009|<tuple|18.343|?>>
    <associate|eq 18.342.009|<tuple|18.344|?>>
    <associate|eq 18.343.009|<tuple|18.345|?>>
    <associate|eq 18.344.009|<tuple|18.346|?>>
    <associate|eq 18.345.009|<tuple|18.347|?>>
    <associate|eq 18.346.009|<tuple|18.348|?>>
    <associate|eq 18.349.009|<tuple|18.350|?>>
    <associate|eq 18.35.001|<tuple|18.46|732>>
    <associate|eq 18.350.009|<tuple|18.351|?>>
    <associate|eq 18.351.009|<tuple|18.352|?>>
    <associate|eq 18.352.009|<tuple|18.353|?>>
    <associate|eq 18.353.009|<tuple|18.354|?>>
    <associate|eq 18.354.009|<tuple|18.355|?>>
    <associate|eq 18.355.009|<tuple|18.356|?>>
    <associate|eq 18.356.009|<tuple|18.357|?>>
    <associate|eq 18.357.009|<tuple|18.358|?>>
    <associate|eq 18.359.010|<tuple|18.367|?>>
    <associate|eq 18.359.011|<tuple|18.359|?>>
    <associate|eq 18.36.001|<tuple|18.47|732>>
    <associate|eq 18.360.011|<tuple|18.360|?>>
    <associate|eq 18.361.011|<tuple|18.361|?>>
    <associate|eq 18.362.011|<tuple|18.362|?>>
    <associate|eq 18.363.011|<tuple|18.363|?>>
    <associate|eq 18.364.011|<tuple|18.364|?>>
    <associate|eq 18.365.011|<tuple|18.365|?>>
    <associate|eq 18.366.011|<tuple|18.366|?>>
    ...
    <associate|extension of integrable functions|<tuple|18.162|?>>
    <associate|extension of positive integrable function|<tuple|18.161|?>>
    <associate|extension of simple function|<tuple|18.160|?>>
    <associate|g\<less\>=f=\<gtr\>g^E\<less\>f^E|<tuple|18.157|?>>
    ...
    measurable set|<tuple|18.163|?>>
    <associate|integrable function and {a\<less\>=f}|<tuple|18.144|795>>
    <associate|integral|<tuple|18.136|792>>
    <associate|integral of increasing simple functions|<tuple|18.123|782>>
    <associate|integral of positive integrable function|<tuple|18.131|789>>
    <associate|integral of positive integrable function
    alternative|<tuple|18.132|789>>
    <associate|integral of positive integrable functions
    properties|<tuple|18.135|790>>
    <associate|integral of simple function extension|<tuple|18.133|789>>
    <associate|integral of simple function properties|<tuple|18.120|780>>
    <associate|integral of te zero function|<tuple|18.134|790>>
    ...
    <associate|limit of simple functions|<tuple|18.124|?>>
    <associate|make measurable sets pairwise disjoint|<tuple|18.116|776>>
    <associate|measurable function extension|<tuple|18.105|772>>
    <associate|measurable function operations|<tuple|18.103|764>>
    <associate|measurable function restriction property|<tuple|18.129|786>>
    <associate|measurable functions|<tuple|18.91|760>>
    <associate|measurable functions and continuity|<tuple|18.95|760>>
    <associate|measurable functions and generators|<tuple|18.94|760>>
    <associate|measurable functions and limits|<tuple|18.104|769>>
    <associate|measurable functions conditions|<tuple|18.98|761>>
    <associate|measurable maps composition|<tuple|18.96|761>>
    <associate|measurable space|<tuple|18.4|713>>
    <associate|measure integral and absolute value|<tuple|18.143|794>>
    <associate|measure integral extension|<tuple|18.140|792>>
    <associate|measure integral properties (1)|<tuple|18.141|792>>
    <associate|measure integral properties (2)|<tuple|18.145|795>>
    ...
    <associate|positive integrable function alternative|<tuple|18.130|787>>
    <associate|positive integrable function properties|<tuple|18.125|782>>
    <associate|positive integrable functions definition|<tuple|18.126|?>>
    <associate|positive integrable functions dom is
    conegligible|<tuple|18.127|783>>
    <associate|property of Dyadic interval of order n|<tuple|18.53|740>>
    <associate|reindex union of sets|<tuple|18.16|717>>
    <associate|representation of a simple function|<tuple|18.113|775>>
    ...
    <associate|simple function null set|<tuple|18.121|780>>
    <associate|simple function standard representation|<tuple|18.117|778>>
    <associate|simple functions increasing and sup|<tuple|18.122|781>>
    <associate|simple functions properties (basic)|<tuple|18.115|775>>
    <associate|sub-algebra|<tuple|18.9|715>>
    <associate|subspace based on a measurable set|<tuple|18.150|?>>
    ...
    <associate|writing a partial function as a limit|<tuple|18.128|783>>
    <associate|\|f^E\|=\|f\|^E|<tuple|18.156|?>>
  </collection>
</references>
