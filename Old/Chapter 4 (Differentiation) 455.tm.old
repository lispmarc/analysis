...
<\body>
  ...
  differentiability for functions <math|f:U\<rightarrow\>V> where
  <math|U\<subseteq\>X> is a open set and <math|V\<subseteq\>Y>. Later it
  will be proved that differentiability is a local property so that the
  choice of <math|U> or <math|V> is not unique.
  ...
  <\proof>
    ...
    By mathematical induction we have then that <math|S<rsub|n>=\<bbb-N\>>.
    So if <math|m\<in\><around*|{|1,\<ldots\>,n|}>> then
    <math|i=n-m\<in\><around*|{|0,\<ldots\>,n-1|}>> proving as
    <math|i\<in\>\<bbb-N\>=S<rsub|n>> and <math|0\<leqslant\>i\<less\>n> that
    <math|f> is <math|<around*|(|n-i|)>>-times differentiable which proves
    our theorem as <math|m=n-i>.
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|V\<subseteq\>Y>, <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>>
    and <math|f:U\<rightarrow\>V> a function then <math|f> is <math|n>-times
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|\<Rightarrow\>>>This is proved by induction so let
      <math|S=<around*|{|n\<in\><around*|{|2,\<ldots\>|}>\|if a function
      h:U\<rightarrow\>V is n-times differentiable \ then D h is
      <around*|(|n-1|)> times differentiable and D<rsup|n-1><around*|(|D
      h|)>=D<rsup|n>h|}>> then we have:

      <\description>
        <item*|<math|2\<in\>S>>If <math|n=2> then as <math|f> is 2-times
        differentiable we have that <math|f> is 1-times differentiable and
        ...
        <item*|<math|n\<in\>S\<Rightarrow\>n+1\<in\>S>>If <math|n\<in\>S> and
        let <math|f> be <math|<around*|(|n+1|)>>-times differentiable then
        <math|f> is by definition <math|n>-times differentiable on <math|U>,
        so as <math|n\<in\>S> we have that <math|D<rsup|1>f> is
        <math|<around*|(|n-1|)>>-times differentiable and
        <math|D<rsup|n>f=D<rsup|n-1><around*|(|D<rsup|1>f|)>>. From the
      ...
      <item*|<math|\<Leftarrow\>>>Again we use induction so let
      <math|S=<around*|{|n\<in\><around*|{|2,\<ldots\>|}>\| if a function
      h:U\<rightarrow\>V is such that D<rsup|1>h is <around*|(|n-1|)>
      <text|-times> differentiable then h is n<text|-times> differentiable
      and D<rsup|n-1><around*|(|D<rsup|1>h|)>=D<rsup|n>h|}>> then:

      <\description>
        <item*|<math|2\<in\>S>>If n=2 then as <math|D<rsup|1>f> is
        <math|2-1=1>-times differentiable we have that
        <math|\<forall\>x\<in\>U> we have that <math|D
        <rsup|1>f<around*|(|x|)>> exists and
        <math|D<rsup|1>f:U\<rightarrow\>L<around*|(|X,Y|)>> is differentiable
        ...
        <item*|<math|n\<in\>S\<Rightarrow\>n+1\<in\>S>>Let <math|n\<in\>S>
        then if <math|D<rsup|1>f> is <math|<around*|(|n+1|)>-1=n> times
        differentiable, by definition we have then that <math|D<rsup|1>f> is
        <math|<around*|(|n-1|)>>-times differentiable and that
        <math|D<rsup|n-1><around*|(|D<rsup|1>f|)>:U\<rightarrow\>L<rsup|n-1><around*|(|X;L<around*|(|X,Y|)>|)>\<equallim\><rsub|<text|<reference|L^n(X;L(X,Y))=L^n(X;Y)>>>L<rsup|n><around*|(|X;Y|)>>
      ...
      Induction prove then that <math|S=\<bbb-N\><rsub|0>\\<around*|{|1|}>>
    </description>
  </proof>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|W\<subseteq\>Y>, <math|n\<in\>\<bbb-N\><rsub|0>> and
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\description>
        <item*|<math|1\<in\>S>>If <math|i=1> then as
        <math|f:U\<rightarrow\>W> is 1-times differentiable we have by
        definition that <math|\<forall\>x\<in\>U> we have that
        <math|f:U\<rightarrow\>W> is differentiable and <math|D<rsup|1>f> is
        defined by <math|D<rsup|1>f<around*|(|x|)>=D f<around*|(|x|)>>. Using
        <reference|differentiability and restricted mapping> we have then
        that <math|\<forall\>x\<in\>V> that
        ...
        f<around*|(|x|)>=D<rsup|1>f<around*|(|x|)>> or
        <math|D<rsup|1><around*|(|f<rsub|\|V>|)>=<around*|(|D<rsup|1>f|)><rsub|\|V>>.
        So <math|1\<in\>S>

        <item*|<math|i\<in\>S\<Rightarrow\>i+1\<in\>S>>If <math|i\<in\>S>
        then if <math|i+1\<leqslant\>n> we have that
      ...
      <\description>
        <item*|<math|1\<in\>S>>By assumption <math|\<forall\>x\<in\>U> there
        exists a <math|V> open with <math|x\<in\>V\<subseteq\>U> such that
        <math|f<rsub|\|V>> is differentiable at <math|x>, using
        <reference|differentiability and restricted mapping> we have then
        that also <math|f> is differentiable at <math|x> and <math|D
        ...
        <item*|<math|n\<in\>S\<Rightarrow\>n+1\<in\>S>>Let <math|n\<in\>S>,
        assume now that <math|\<forall\>x\<in\>U> there exists a <math|V>
        open with <math|x\<in\>V\<subseteq\>U> and <math|f<rsub|\|V>> be
        <math|<around*|(|n+1|)>>-times differentiable. By definition we have
        then that <math|f<rsub|<mid|\|>V>> is <math|n>-times differentiable
        and thus as <math|n\<in\>S> we have that <math|f> is n-times
        differentiable with <math|<around*|(|D<rsup|n>f|)><rsub|\|V>=D<rsup|n><around*|(|f<rsub|<mid|\|>V>|)>>.
        ...
        <math|D<rsup|n>f> is differentiable at every <math|y\<in\>U>) with
        ...
        and as <math|x\<in\>U> is choosen arbitrary also that <math|f> is
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set,
    <math|n\<in\>\<bbb-N\>> , <math|W\<subset\>Y> and
    <math|f:U\<rightarrow\>W> a function then:
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      ...
      <tuple|<tuple|<with|mode|<quote|math>|\<infty\>>-differentiability>|<pageref|auto-18>>

      <tuple|<tuple|<with|mode|<quote|math>|C<rsup|n>>>|<pageref|auto-19>>

      <tuple|<tuple|<with|mode|<quote|math>|C<rsup|\<infty\>>>>|<pageref|auto-20>>

      <tuple|<tuple|smooth functions>|<pageref|auto-21>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rsup|<around*|(|n|)>>>>|<pageref|auto-22>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|+><around*|(|x|)>>>|<pageref|auto-24>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|-><around*|(|x|)>>>|<pageref|auto-25>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|+>>>|<pageref|auto-26>>

      <tuple|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|->>>|<pageref|auto-27>>

      <tuple|<tuple|local weak minimum>|<pageref|auto-29>>

      <tuple|<tuple|local weak maximum>|<pageref|auto-30>>

      <tuple|<tuple|extremum>|<pageref|auto-31>>

      <tuple|<tuple|Rolle's theorem>|<pageref|auto-32>>

      <tuple|<tuple|Lagrange's theorem>|<pageref|auto-33>>

      <tuple|<tuple|Fundamental Theorem of Calculus (Classical
      version)>|<pageref|auto-34>>

      <tuple|<tuple|Fundamental Theorem of Calculus>|<pageref|auto-35>>

      <tuple|<tuple|convex sets>|<pageref|auto-36>>

      <tuple|<tuple|line segment>|<pageref|auto-37>>

      <tuple|<tuple|<with|mode|<quote|math>|L<rsub|a,b>>>|<pageref|auto-38>>

      <tuple|<tuple|toplinear isomorphism>|<pageref|auto-42>>

      <tuple|<tuple|<with|mode|<quote|math>|\<cal-G\>L<around*|(|X|)>>>|<pageref|auto-43>>

      <tuple|<tuple|<with|mode|<quote|math>|H<rsup|n>>>|<pageref|auto-44>>

      <tuple|<tuple|inverse function theorem>|<pageref|auto-45>>
    </associate>
    <\associate|toc>
