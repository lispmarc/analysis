...
<\body>
  ...
  <\proof>
    First as <math|a\<leqslant\>a\<less\>b> it follows that
    <math|a\<in\><around*|[|a,b|[>\<subseteq\><around*|[|c,d|[>> so that
    <math|c\<leqslant\>a\<less\>d>. Assume that
    <math|d\<less\>b\<Rightarrow\>b-d\<gtr\>0> then if we take
    <math|e=d+<frac|b-d|2>=<frac|b+d|2>> it follows that
    <math|a\<less\>d\<less\>e\<less\><frac|b+b|2>=b> so that
    <math|e\<in\><around*|[|a,b|[>\<subseteq\><around*|[|c,d|[>> proving that
    <math|e\<less\>d> contradicting <math|d\<less\>e>. This proves that the
    assumption <math|d\<less\>b> is wrong hence <math|b\<leqslant\>d>.
  </proof>
  ...
  <\lemma>
    ...
    <math|\<bbb-R\><rsup|n>=<big|cup><rsub|i\<in\>\<bbb-N\>><around*|[|<around*|(|-i|)>,<around*|(|i|)>|[>>
  </lemma>

  <\proof>
    First as <math|\<forall\>i\<in\>\<bbb-N\>>
    <math|<around*|[|<around*|(|-i|)>,<around*|(|i|)>|[>\<subseteq\>\<bbb-R\><rsup|n>>
    we have trivially that <math|<big|cup><rsub|i\<in\>\<bbb-N\>><around*|[|<around*|(|-i|)>,<around*|(|i|)>|[>\<subseteq\>\<bbb-R\><rsup|n>>.
    For the opposite inclusion let <math|x\<in\>\<bbb-R\><rsup|n>> then
    <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
    <math|x<rsub|i>\<in\>\<bbb-R\>\<equallim\><rsub|<text|<reference|R can be
    covered by open intervals>>><big|cup><rsub|j\<in\>\<bbb-N\>><around*|[|-j,j|[>>
    so there exists <math|j<rsub|i>\<in\>\<bbb-N\>> such that
    <math|-j<rsub|i>\<leqslant\>x<rsub|i>\<less\>j<rsub|i>>. Take
    <math|k=max<around*|(|<around*|{|j<rsub|i>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)>\<in\>\<bbb-N\>>
    ...
    Hence <math|\<bbb-R\><rsup|n>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>><around*|[|<around*|(|-i|)>,<around*|(|i|)>|[>>
  </proof>
  ...
  <\lemma>
    Let <math|n\<in\>\<bbb-N\><rsub|0>>, <math|R,<around*|{|R<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-R\><rsup|n>>
  ...
  <\proof>
    ...
    so we must prove only the case of <math|R\<neq\>\<emptyset\>>. We prove
    this by induction on <math|n> so let <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|\<forall\>R,<around*|{|R<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-R\><rsup|n><text|
    with >R\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i><text| then
    >v<rsup|n><around*|(|R|)>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|R<rsub|i>|)>|}>>
    then we have:

    <\description>
      <item*|<math|1\<in\>\<cal-S\>>>If <math|R,<around*|{|R<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-R\><rsup|n>>
      then there exists <math|a=<around*|(|\<alpha\><rsub|1>,\<ldots\>,\<alpha\><rsub|1>|)>,<around*|(|\<beta\><rsub|1>,\<ldots\>,\<beta\><rsub|1>|)>\<in\>\<bbb-R\><rsup|1>>
      such that <math|R=<around*|[|a,b|[>> and
      <math|<around*|{|<around*|(|\<alpha\><rsub|i,1><rsub|>,\<ldots\>,\<alpha\><rsub|i,1>|)>|}><rsub|i\<in\>\<bbb-N\>>,<around*|{|<around*|(|\<beta\><rsub|i,1>,\<ldots\>,\<beta\><rsub|i,1>|)>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<bbb-R\><rsup|1>>
      such that <math|R<rsub|i>=<around*|[|<around*|(|\<alpha\><rsub|i,1><rsub|>,\<ldots\>,\<alpha\><rsub|i,1>|)>,<around*|(|\<beta\><rsub|i,1>,\<ldots\>,\<beta\><rsub|i,1>|)>|[>>.
      Let <math|x\<in\><around*|[|\<alpha\><rsub|1>,\<beta\><rsub|1>|[>> then
      <math|<around*|(|<wide*|x,\<ldots\>,x|\<wide-underbrace\>><rsub|1>|)>\<in\>R\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i><rsub|><rsub|>
      so that \<exists\>k\<in\>\<bbb-N\><rsub|>> such that
      <math|<around*|(|<wide*|x,\<ldots\>,x|\<wide-underbrace\>><rsub|1>|)>\<in\>R<rsub|k>=<around*|[|<around*|(|\<alpha\><rsub|k,1><rsub|>,\<ldots\>,\<alpha\><rsub|k,1>|)>,<around*|(|\<beta\><rsub|k,1>,\<ldots\>,\<beta\><rsub|k,1>|)>|[>>
      hence <math|x\<in\><around*|[|\<alpha\><rsub|k,1>,\<beta\><rsub|k,1>|[>\<subset\><big|cup><rsub|k\<in\>\<bbb-N\>><around*|[|\<alpha\><rsub|k,1>,\<beta\><rsub|k,1>|[>>.
      So we have proved that

      <\equation>
        <label|eq 18.127.024><around*|[|\<alpha\><rsub|1>,\<beta\><rsub|1>|[>\<subseteq\><big|cup><rsub|k\<in\>\<bbb-N\>><around*|[|\<alpha\><rsub|k,1>,\<beta\><rsub|k,1>|[>
      </equation>

      Using <reference|semi additivity of the length in the reals> on the
      above gives then\ 

      <\equation>
        <label|eq 18.128.024>\<beta\><rsub|1>-\<alpha\><rsub|1>=l<around*|(|<around*|[|a<rsub|1>,\<beta\><rsub|1>|[>|)>\<leqslant\><big|sum><rsub|k=1><rsup|\<infty\>>l<around*|(|<around*|[|\<alpha\><rsub|k,1>,\<beta\><rsub|k,1>|[>|)>=<big|sum><rsub|k=1><rsup|\<infty\>><around*|(|\<beta\><rsub|k,1>-\<alpha\><rsub|k,1>|)>
      </equation>

      finally\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|v<rsup|1><around*|(|R|)>>|<cell|=>|<cell|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,1|}>><around*|(|\<beta\><rsub|i>-\<alpha\><rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|\<beta\><rsub|1>-\<alpha\><rsub|1>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|eq
        18.128.024>>>>|<cell|<big|sum><rsub|k=1><rsup|\<infty\>><around*|(|\<beta\><rsub|k,1>-\<alpha\><rsub|k,1>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|k=1><rsup|\<infty\>><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,1|}>><around*|(|\<beta\><rsub|k,i>-\<alpha\><rsub|k,i>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|k=1><rsup|\<infty\>>v<rsup|1><around*|(|R<rsub|i>|)>>>>>
      </eqnarray*>

      which proves that <math|1\<in\>\<cal-S\>>.

      <item*|<math|n\<in\>\<cal-S\>\<Rightarrow\>n+1\<in\>\<cal-S\>>>Let
      <math|R,<around*|{|R<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-R\><rsup|n+1>>
      such that <math|R\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i>>
      then <math|R=<around*|[|a,b|[>>, <math|a,b\<in\>\<bbb-R\><rsup|n+1>>
      with <math|a\<leqslant\>b> and <math|\<forall\>i\<in\>\<bbb-N\>>
      <math|R<rsub|i>=<around*|[|a<rsup|i>,<rsub|>b<rsup|i>|[>>,
      <math|a<rsup|i>,b<rsup|i>\<in\>\<bbb-R\><rsup|n+1>> with
      <math|a<rsup|i>\<leqslant\>b<rsup|i>>. Further as
      <math|R\<neq\>\<emptyset\>> we must have that
      <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n+|}>> that
      <math|a<rsub|i>\<less\>b<rsub|i>> so that
      <math|0\<less\>b<rsub|i>-a<rsub|i>>, hence

      <\equation>
        <label|eq 18.129.024>V=<big|prod><rsub|i=1><rsup|n><around*|(|b<rsub|i>-a<rsub|i>|)>\<gtr\>0
      </equation>

      Then

      <\eqnarray*>
        <tformat|<table|<row|<cell|v<rsup|n+1><around*|(|R|)>>|<cell|=>|<cell|v<rsup|n+1><around*|(|<around*|[|a,b|[>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|volume
        in R^n>>>>|<cell|<big|prod><rsub|i=1><rsup|n+1><around*|(|b<rsub|i>-a<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<big|prod><rsub|i=1><rsup|n><around*|(|b<rsub|i>-a<rsub|i>|)>|)>\<cdot\><around*|(|b<rsub|n+1>-a<rsub|n+1>|)>>>|<row|<cell|>|<cell|=>|<cell|V\<cdot\><around*|(|b<rsub|n+1>-a<rsub|n+1>|)>>>>>
      </eqnarray*>

      giving\ 

      <\equation>
        <label|eq 18.130.024>v<rsup|n+1><around*|(|R|)>=V\<cdot\><around*|(|b<rsub|n+1>-a<rsub|n+1>|)>
      </equation>

      Define given <math|i\<in\>\<bbb-N\>> and <math|r\<in\>\<bbb-R\>> the
      set <math|H<rsup|i,r>\<subseteq\>\<bbb-R\><rsup|n+1>>

      <\equation>
        <label|eq 18.131.024>H<rsup|i>,r=<around*|{|x\<in\>\<bbb-R\><rsup|n+1>\|x<rsub|n+1>\<less\>r|}><big|cap>R<rsup|i>
      </equation>

      Let <math|i\<in\>\<bbb-N\>> and <math|r\<in\>\<bbb-R\>> then define
      <math|a<rsup|i,r>,b<rsup|i,r>\<in\>\<bbb-R\><rsup|n+1>> by
      <math|<around*|(|a<rsup|i,r>|)><rsub|j>=<choice|<tformat|<table|<row|<cell|<around*|(|a<rsup|i>|)><rsub|j>
      if j\<in\><around*|{|1,\<ldots\>,n|}>>>|<row|<cell|min<around*|(|<around*|(|a<rsup|i>|)><rsub|n+1>,r|)>
      if j=n+1>>>>>>,<math|<around*|(|b<rsup|i>|)><rsub|j>=<choice|<tformat|<table|<row|<cell|<around*|(|b<rsup|i>|)><rsub|j>
      if j\<in\><around*|{|1,\<ldots\>,n|}>>>|<row|<cell|min<around*|(|<around*|(|b<rsup|i>|)><rsub|n+1>,r|)>
      if j=n+1>>>>>> then we have either:

      <\description>
        <item*|<math|<around*|(|a<rsup|i>|)><rsub|n+1>\<leqslant\>r>>then
        <math|<around*|(|a<rsup|i,r>|)><rsub|n+1>=min<around*|(|<around*|(|a<rsup|i>|)><rsub|n+1>,r|)>=<around*|(|a<rsup|i>|)><rsub|n+1>\<leqslant\>r\<leqslant\>min<around*|(|<around*|(|b<rsup|i>|)><rsub|n+1>,r|)>=<around*|(|b<rsup|i,r>|)><rsub|n+1>>
        Also using the fact that <math|a<rsup|i>\<leqslant\>b<rsup|i>\<Rightarrow\>\<forall\>j\<in\><around*|{|1,\<ldots\>,n|}>>
        <math|<around*|(|a<rsup|i,r>|)><rsub|j>=<around*|(|a<rsup|i>|)><rsub|j>\<leqslant\><around*|(|b<rsup|i>|)><rsub|j>=<around*|(|b<rsup|i,r>|)><rsub|j>>
        it follows that\ 

        <\equation*>
          a<rsup|i,r>\<leqslant\>b<rsup|i,r>
        </equation*>

        <\eqnarray*>
          <tformat|<table|<row|<cell|x\<in\>H<rsup|i,r>>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>R<rsub|i>\<wedge\>x<rsub|n+1>\<less\>r>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>j\<in\><around*|{|1,\<ldots\>,n+1|}>
          <around*|(|a<rsup|i>|)><rsub|j>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rsup|i>|)><rsub|j>\<wedge\>x<rsub|n+1>\<less\>r>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>j\<in\><around*|{|1,\<ldots\>,n|}>
          <around*|(|a<rsup|i>|)><rsub|j>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rsup|i>|)><rsub|j>\<wedge\><around*|(|a<rsup|i>|)><rsub|n+1>\<leqslant\>x<rsub|n+1>\<wedge\>x<rsub|n+1>\<less\>min<around*|(|<around*|(|b<rsup|i>|)><rsub|n+1>,r|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|j\<in\><around*|{|1,\<ldots\>,n|}>
          <around*|(|a<rsup|i>|)><rsub|j>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rsup|i>|)><rsub|j>\<wedge\>min<around*|(|<around*|(|a<rsup|i>|)><rsub|n+1>,r|)>\<leqslant\>x<rsub|n+1>\<less\>min<around*|(|<around*|(|b<rsup|i>|)><rsub|n+1>,r|)>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>j\<in\><around*|{|1,\<ldots\>,n+1|}>
          <around*|(|a<rsup|i,r>|)><rsub|j>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rsup|i,r>|)><rsub|j>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|[|a<rsup|i,r>,b<rsup|i,r>|[>\<in\>\<cal-R\><rsup|n+1>>>>>
        </eqnarray*>

        <item*|<math|r\<less\><around*|(|a<rsup|i>|)><rsub|n+1>>>then
        <math|<around*|(|a<rsup|i,r>|)><rsub|n+1>=min<around*|(|<around*|(|a<rsup|i>|)><rsub|n+1>,r|)>=r>
        and as <math|r\<less\><around*|(|a<rsup|i>|)><rsub|n+1>\<leqslant\><around*|(|b<rsup|i>|)><rsub|n+1>>
        we have <math|r=min<around*|(|<around*|(|b<rsup|i>|)><rsub|n+1>,r|)>=<around*|(|b<rsup|i,r>|)><rsub|n+1>>.
        So
        ...
        Further if <math|x\<in\>H<rsup|i><rsub|r>> we have
        <math|r\<less\><around*|(|a<rsup|i>|)><rsub|n+1>\<leqslant\>x<rsub|n+1>\<less\>r>
        a contradiction so that <math|H<rsub|r><rsup|i>=\<emptyset\>>. If
        <math|x\<in\><around*|[|a<rsup|i,r>,b<rsup|i,r>|[>> then
        <math|<around*|(|a<rsup|i,r>|)><rsub|n+1>\<leqslant\>x<rsub|n+1>\<less\><around*|(|b<rsup|i,r>|)><rsub|n+1>=<around*|(|a<rsup|i,r>|)><rsub|n+1>>
        a contradiction, hence <math|<around*|[|a<rsup|i,r>,b<rsup|i,r>|[>=\<emptyset\>>
        proving that <math|H<rsup|i,r>=<around*|[|a<rsup|i,r>,b<rsup|i,r>|[>\<in\>\<cal-R\><rsup|n+1>>
      </description>

      To summarize the above

      <\equation>
        <label|eq 18.132.024>\<forall\>i\<in\>\<bbb-N\> and
        \<forall\>r\<in\>\<bbb-R\><text| that
        >H<rsup|i,r>=<around*|[|a<rsup|i,r>,b<rsup|i,r>|[>\<in\>\<cal-R\><rsup|n+1>
      </equation>

      Note that if <math|r,l\<in\>\<bbb-R\>> with <math|r\<leqslant\>l> we
      have that <math|H<rsup|i,r>=<around*|{|x\<subseteq\>\<bbb-R\><rsup|n+1>\|x<rsub|n+1>\<less\>r|}>\<subseteq\><around*|{|x\<in\>\<bbb-R\><rsup|n+1>\|x<rsub|n+1>\<less\>l|}>=H<rsup|i,l>>.
      So using <reference|eq 18.132.024> we have by <reference|volume is
      increasing> that\ 

      <\equation>
        <label|eq 18.149.024>v<rsup|n+1><around*|(|H<rsup|i,r>|)>\<leqslant\>v<rsup|n+1><around*|(|H<rsup|i,l>|)>
        if r\<leqslant\>l
      </equation>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|v<rsup|n+1><around*|(|H<rsup|i,r>|)>>|<cell|=>|<cell|v<rsup|n+1><around*|(|<around*|[|a<rsup|i,r>,b<rsup|i,r>|[>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|volume
        in R^n>>>>|<cell|<big|prod><rsub|j=1><rsup|n+1><around*|(|<around*|(|b<rsup|i,r>|)><rsub|j>-<around*|(|a<rsup|i,r>|)><rsub|j>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<big|prod><rsub|j=1><rsup|n><around*|(|<around*|(|b<rsup|i,r>|)><rsub|j>-<around*|(|a<rsup|i,r>|)><rsub|j>|)>|)>\<cdot\><around*|(|<around*|(|b<rsup|i,r>|)><rsub|n+1>-<around*|(|a<rsup|i,r>|)><rsub|n+1>|)><eq-number><label|eq
        18.133.024.1>>>>>
      </eqnarray*>

      Take now <math|\<varepsilon\>\<gtr\>0>. Given <math|r\<in\>\<bbb-R\>>
      define <math|A<rsub|\<varepsilon\>>> by\ 

      <\equation>
        <label|eq 18.134.024>A<rsub|\<varepsilon\>>=<around*|{|x\<in\><around*|[|a<rsub|n+1>,b<rsub|n+1>|]>\|V\<cdot\><around*|(|x-a<rsub|n+1>|)>\<leqslant\><around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,x><rsub|>|)>|}>\<subseteq\><around*|[|a<rsub|n+1>,b<rsub|n+1>|[>
      </equation>

      As <math|a<rsub|n+1>\<in\><around*|[|a<rsub|n+1>,b<rsub|n+1>|]>> and
      <math|V\<cdot\><around*|(|a<rsub|n+1>-a<rsub|n+1>|)>=0\<leqslant\><around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,x>|)>>
      ...
      <reference|the reals are conditional complete>] we have

      <\equation>
        <label|eq 18.135.024>\<gamma\>=sup<around*|(|A<rsub|\<varepsilon\>>|)><text|
        exists and >a<rsub|n+1>\<leqslant\>\<gamma\>\<leqslant\>b<rsub|n+1>
      </equation>

      If <math|x\<in\>A<rsub|\<varepsilon\>>> then
      <math|x\<leqslant\>\<gamma\>> so that\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|V\<cdot\><around*|(|x-a<rsub|n+1>|)>>|<cell|\<leqslant\>>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,x>|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|x\<leqslant\>\<gamma\><infix-and><text|<reference|eq
        18.149.024>>>>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>>>>>
      </eqnarray*>

      giving

      <\equation>
        <label|eq 18.137.024.2>\<forall\>x\<in\>A<rsub|\<varepsilon\>> we
        have V\<cdot\><around*|(|x-a<rsub|n+1>|)>\<leqslant\><around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>
      </equation>
      ...
      <\eqnarray*>
        ...
        of set and sum>>>>|<cell|V\<cdot\>sup<around*|(|<around*|{|x-a<rsub|n+1>\|x\<in\>A<rsub|\<varepsilon\>>|}>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<smart-ref|sup
        ...
        18.137.024.2>>>>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|j=1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)><eq-number><label|eq
        18.136.024.1>>>>>
      </eqnarray*>

      which using the definition of <math|A<rsub|r,\<varepsilon\>>> proves
      that\ 

      <\equation>
        <label|eq 18.136.024>\<gamma\>\<in\>A<rsub|r,\<varepsilon\>>
      </equation>

      Assume now that <math|\<gamma\>\<less\>b<rsub|n+1>>. Then\ 

      <\equation>
        <label|eq 18.137.024>\<gamma\>\<in\><around*|[|a<rsub|n+1>,b<rsub|n+1>|[>
      </equation>

      Define now\ 

      <\equation>
        <label|eq 18.138.024>J=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R|}><text|
        and >\<forall\>i\<in\>\<bbb-N\><text|
        >J<rsub|i>=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R<rsub|i>|}>
      </equation>

      Define <math|a<rprime|'>=<around*|(|a<rsub|1>,\<ldots\>,a<rsub|n>|)>,b<rprime|'>=<around*|(|b<rsub|1>,\<ldots\>,b<rsub|n>|)>\<in\>\<bbb-R\><rsup|n>>
      ...
      we have that <math|a<rprime|'>\<leqslant\>b<rprime|'>>. Further\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\><around*|[|a<rprime|'>,b<rprime|'>|[>>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>j\<in\><around*|{|1,\<ldots\>,n|}>
        a<rsub|j>=<around*|(|a<rprime|'>|)><rsub|j>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rprime|'>|)><rsub|j><rsub|>>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|<text|<reference|eq
        18.136.024>>>>|<cell|\<forall\>j\<in\><around*|{|1,\<ldots\>,n|}>
        a<rsub|j>=<around*|(|a<rprime|'>|)><rsub|j>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rprime|'>|)><rsub|j><rsub|>\<wedge\>a<rsub|n+1>\<leqslant\>\<gamma\>\<less\>b<rsub|n+1>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\>J>>>>
      </eqnarray*>

      proving that\ 

      <\equation>
        <label|eq 18.139.024>J=<around*|[|a<rprime|'>,b<rprime|'>|[>\<in\>\<cal-R\><rsup|n>
      </equation>

      Further if <math|i\<in\>\<bbb-N\>> define
      <math|a<rprime|'><rsup|i>,b<rprime|'><rsup|i>\<in\>\<bbb-R\><rsup|n>>
      by <math|a<rprime|'><rsup|i>=<around*|(|<around*|(|a<rsup|i>|)><rsub|1>,\<ldots\>,<around*|(|a<rsup|i>|)><rsub|n+1>|)>,b<rprime|'><rsup|i>=<around*|(|<around*|(|b<rsup|i>|)><rsub|1>,\<ldots\>,<around*|(|b<rsup|i>|)><rsub|n>|)>>
      then <math|\<forall\>j\<in\><around*|{|1,\<ldots\>,n|}>>
      <math|<around*|(|a<rprime|'><rsup|i>|)><rsub|j>=<around*|(|a<rsup|i>|)><rsub|j>\<leqslant\><around*|(|b<rsup|i>|)><rsub|j>=<around*|(|b<rprime|'><rsup|i>|)><rsub|j>>
      proving that <math|a<rprime|'><rsup|i>\<leqslant\>b<rprime|'><rsup|i>>.

      <\description>
        <item*|<math|\<gamma\>\<in\><around*|[|<around*|(|a<rsup|i>|)><rsub|n+1>,<around*|(|b<rsup|i>|)><rsub|n+1>|[>>>

        <\eqnarray*>
          <tformat|<table|<row|<cell|x\<in\>J<rsub|i>>|<cell|\<Leftrightarrow\>>|<cell|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R<rsub|J>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>j\<in\><around*|{|1,\<ldots\>,n|}>
          <around*|(|a<rsup|i>|)><rsub|j>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rsup|i>|)><rsub|j><text|
          and ><around*|(|a<rsup|i>|)><rsub|n+1>\<leqslant\>\<gamma\>\<less\><around*|(|b<rsup|i>|)><rsub|n+1>>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|\<gamma\>\<in\><around*|[|<around*|(|a<rsup|j>|)><rsub|i><around*|(|b<rsup|j>|)><rsub|i>|[>>>|<cell|\<forall\>j\<in\><around*|{|1,\<ldots\>,n|}>
          ...
          <around*|(|a<rprime|'><rsup|i>|)><rsub|j>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rprime|'><rsup|i>|)><rsub|j>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|[|a<rprime|'><rsup|i>,b<rprime|'><rsup|i>|[>>>>>
        </eqnarray*>

        proving that\ 

        <\equation>
          <label|eq 18.143.024.3>J<rsub|i>=<around*|[|a<rprime|'><rsup|i>,b<rsup|<rprime|'>i>|[>\<in\>\<cal-R\><rsup|n>
        </equation>

        \ <item*|<math|\<gamma\>\<nin\><around*|[|<around*|(|a<rsup|i>|)><rsub|n+1>,<around*|(|b<rsup|i>|)><rsub|n+1>|[>>>then
        if <math|x\<in\>J<rsub|i>> we have
        <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R<rsup|i>>
        so that <math|<around*|(|a<rsup|i>|)><rsub|n+1>\<leqslant\>\<gamma\>\<less\><around*|(|b<rsup|i>|)><rsub|n+1>>
        a contradiction. So <math|J<rsub|i>=\<emptyset\>\<in\>\<cal-R\><rsup|n>>
      </description>

      So we have\ 

      <\equation>
        <label|eq 18.141.024>J<rsub|i>\<in\>\<cal-R\><rsup|n><text| and
        either >J<rsub|i>=<around*|[|a<rprime|'><rsup|i>,b<rprime|'><rsup|i>|[>\<Rightarrow\>v<rsup|n><around*|(|J<rsub|i><rsup|>|)>=<big|prod><rsub|j=1><rsup|n><around*|(|<around*|(|b<rsup|i>|)><rsub|j>-<around*|(|a<rsup|i>|)><rsub|j>|)>
        or J<rsub|i>=\<emptyset\>\<Rightarrow\>v<rsup|n><around*|(|J<rsup|i>|)>=0
      </equation>

      If <math|x\<in\>J> then <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i>>
      so that <math|\<exists\>i\<in\>\<bbb-N\>> such that
      <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R<rsub|i>>
      proving that <math|x\<in\>J<rsub|i>>. So\ 

      <\equation>
        <label|eq 18.142.024>J\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>J<rsub|i>
      </equation>

      Combining <reference|eq 18.139.024>, <reference|eq 18.143.024.3> and
      <reference|eq 18.142.024> with the fact that <math|n\<in\>\<cal-S\>>
      proves that

      <\equation>
        <label|eq 18.143.021>v<rsup|n><around*|(|J|)>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|J<rsub|i>|)>
      </equation>

      As further <math|v<rsup|n><around*|(|J|)>=v<rsup|n><around*|(|<around*|[|a<rprime|'>,b<rprime|'>|[>|)>=<big|prod><rsub|j=1><rsup|n><around*|(|<around*|(|b<rprime|'>|)><rsub|j>-<around*|(|a<rprime|'>|)><rsub|j>|)>=<big|prod><rsub|i=1><rsup|n><around*|(|b<rsub|j>-a<rsub|j>|)>\<equallim\><rsub|<text|<reference|eq
      18.129.024>>>V> we have by the above that\ 

      <\equation>
        <label|eq 18.144.024>V\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|J<rsub|i>|)>
      </equation>

      From <math|\<varepsilon\>\<gtr\>0> we have
      <math|1\<less\>1+\<varepsilon\>\<Rightarrow\><frac|V|1+\<varepsilon\>>\<less\>V\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|J<rsub|i>|)>=sup<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|m>v<rsup|n><around*|(|J<rsub|i>|)>\|m\<in\>\<bbb-N\>|}>|)>>
      so that by the definition of a supremum there exists a
      ...
      <\equation>
        <label|eq 18.145.024>\<exists\>m\<in\>\<bbb-N\> such that
        V\<less\><around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|m>v<rsup|n><around*|(|J<rsub|i>|)>
      </equation>

      Define now\ 

      <\equation>
        <label|eq 18.146.024>\<chi\>=min<around*|(|<around*|{|b<rsub|n+1>|}><big|cup><around*|{|<around*|(|b<rsup|j>|)><rsub|n+1>\|j\<in\><around*|{|1,\<ldots\>,m|}>|}>|)>
      </equation>

      If <math|J<rsub|i>\<neq\>\<emptyset\>> then
      <math|\<exists\>x\<in\>\<bbb-R\><rsup|n+1>> such that
      <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R<rsub|i>>
      giving <math|\<gamma\>\<in\><around*|[|<around*|(|a<rsup|i>|)><rsub|n+1>,<around*|(|b<rsup|i>|)><rsub|n+1>|[>>
      proving\ 

      <\equation>
        <label|eq 18.147.024><text|f <math|J<rsub|i>\<neq\>\<emptyset\>> then
        ><around*|(|a<rsup|i>|)><rsub|n+1>\<leqslant\>\<gamma\>\<less\><around*|(|b<rsup|i>|)><rsub|n+1>
      </equation>

      As we assumed that <math|\<gamma\>\<less\>b<rsub|n+1>> we have using
      the above and the definition of <math|\<chi\>> that

      <\equation>
        <label|eq 18.148.024>a<rsub|n+1>\<leqslant\><rsub|<text|<reference|eq
        18.137.024>>>\<gamma\>\<less\>\<chi\>\<leqslant\>b<rsub|n+1>
      </equation>

      Let <math|i\<in\><around*|{|1,\<ldots\>,m|}>> then we have for
      <math|J<rsub|i>> either\ 

      <\description>
        <item*|<math|J<rsub|i>=\<emptyset\>>>then\ 

        <\eqnarray*>
          <tformat|<table|<row|<cell|v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>+<around*|(|\<chi\>-\<gamma\>|)>\<cdot\>v<rsup|n><around*|(|J<rsub|i>|)>>|<cell|=>|<cell|v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>+<around*|(|\<chi\>-\<gamma\>|)>\<cdot\>0>>|<row|<cell|>|<cell|=>|<cell|v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|eq
          18.148.024>+<reference|eq 18.149.024>>>>|<cell|v<rsup|n+1><around*|(|H<rsup|i,\<chi\>>|)>>>>>
        </eqnarray*>

        <item*|<math|J<rsub|i>\<neq\>\<emptyset\>>>then we have from
        <reference|eq 18.147.024> that <math|><math|<around*|(|a<rsup|i>|)><rsub|n+1>\<leqslant\>\<gamma\>\<less\><around*|(|b<rsup|i>|)><rsub|n+1>>
        so that <math|<around*|(|a<rsup|i>|)><rsub|n+1>\<leqslant\>\<gamma\>\<less\>\<chi\>\<leqslant\><rsub|<text|<reference|eq
        18.146.024>>>>, hence <math|<around*|(|a<rsup|i,\<xi\>>|)><rsub|n+1>=min<around*|(|<around*|(|a<rsup|i>|)><rsub|n+1>,\<chi\>|)>=<around*|(|a<rsup|i>|)><rsub|n+1>>,
        <math|<around*|(|b<rsup|i,\<chi\>>|)><rsub|n+1>=min<around*|(|<around*|(|b<rsup|i>|)><rsub|n+1>,\<chi\>|)>=\<chi\>>
        and <math|<around*|(|b<rsup|i,\<gamma\>>|)><rsub|n+1>=min<around*|(|<around*|(|b<rsup|i>|)><rsub|n+1>,\<gamma\>|)>=\<gamma\>>.
        So\ 

        <\equation>
          <label|eq 18.150.024><around*|(|a<rsup|i,\<chi\>>|)><rsub|n+1>=<around*|(|a<rsup|i>|)><rsub|n+1>\<wedge\><around*|(|b<rsup|i,\<chi\>>|)><rsub|n+1>=\<chi\>\<wedge\><around*|(|b<rsup|i,\<gamma\>>|)><rsub|n+1>=\<gamma\>
        </equation>
        ...
        <\eqnarray*>
          ...
          18.133.024.1>>>>|<cell|<around*|(|<big|prod><rsub|j=1><rsup|n><around*|(|<around*|(|b<rsup|i>|)><rsub|j>-<around*|(|a<rsup|i>|)><rsub|j>|)>|)>\<cdot\><around*|(|<around*|(|b<rsup|i,\<chi\>>|)><rsub|n+1>-<around*|(|a<rsup|i,\<chi\>>|)><rsub|n+1>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
          18.150.024>>>>|<cell|<around*|(|<big|prod><rsub|j=1><rsup|n><around*|(|<around*|(|b<rsup|i>|)><rsub|j>-<around*|(|a<rsup|i>|)><rsub|j>|)>|)>\<cdot\><around*|(|\<chi\>-<around*|(|a<rsup|i>|)><rsub|n+1>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<big|prod><rsub|j=1><rsup|n><around*|(|<around*|(|b<rsup|i>|)><rsub|j>-<around*|(|a<rsup|i>|)><rsub|j>|)>|)>\<cdot\><around*|(|\<chi\>-\<gamma\>+\<gamma\>-<around*|(|a<rsup|i>|)><rsub|n+1>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<big|prod><rsub|j=1><rsup|n><around*|(|<around*|(|b<rsup|i>|)><rsub|j>-<around*|(|a<rsup|i>|)><rsub|j>|)>|)>\<cdot\><around*|(|\<chi\>-\<gamma\>|)>+<around*|(|<big|prod><rsub|j=1><rsup|n><around*|(|<around*|(|b<rsup|i>|)><rsub|j>-<around*|(|a<rsup|i>|)><rsub|j>|)>|)>\<cdot\>*<around*|(|\<gamma\>-<around*|(|a<rsup|i>|)><rsub|n+1>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
          18.141.024>>>>|<cell|v<rsup|n><around*|(|J<rsub|i>|)>\<cdot\><around*|(|\<chi\>-\<gamma\>|)>+<around*|(|<big|prod><rsub|j=1><rsup|n><around*|(|<around*|(|b<rsup|i>|)><rsub|j>-<around*|(|a<rsup|i>|)><rsub|j>|)>|)>\<cdot\>*<around*|(|\<gamma\>-<around*|(|a<rsup|i>|)><rsub|n+1>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
          18.150.024>>>>|<cell|v<rsup|n><around*|(|J<rsub|i>|)>\<cdot\><around*|(|\<chi\>-\<gamma\>|)>+<around*|(|<big|prod><rsub|j=1><rsup|n><around*|(|<around*|(|b<rsup|i>|)><rsub|j>-<around*|(|a<rsup|i>|)><rsub|j>|)>|)>\<cdot\>*<around*|(|<around*|(|b<rsup|i,\<gamma\>>|)><rsub|n+1>-<around*|(|a<rsup|i>|)><rsub|n+1>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
          18.133.024.1>>>>|<cell|v<rsup|n><around*|(|J<rsub|i>|)>\<cdot\><around*|(|\<chi\>-\<gamma\>|)>+v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>>>>>
        </eqnarray*>
      </description>
      ...
      <\equation>
        <label|eq 18.151.024>\<forall\>i\<in\><around*|{|1,\<ldots\>,m|}> we
      ...
      <\eqnarray*>
        ...
        18.136.024.1>>>>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>+V\<cdot\><around*|(|\<chi\>-\<gamma\>|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|eq
        18.145.024>>>>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>+<around*|(|1+\<varepsilon\>|)>\<cdot\><around*|(|\<chi\>-\<gamma\>|)>\<cdot\><big|sum><rsub|i=1><rsup|m>v<rsup|n><around*|(|J<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=m+1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>+<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|m>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>+<around*|(|1+\<varepsilon\>|)>\<cdot\><around*|(|\<chi\>-\<gamma\>|)>\<cdot\><big|sum><rsub|i=1><rsup|m>v<rsup|n><around*|(|J<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=m+1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>+<around*|(|1+\<varepsilon\>|)>\<cdot\><around*|(|<big|sum><rsub|i=1><rsup|m>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>+<around*|(|\<chi\>-\<gamma\>|)>\<cdot\><big|sum><rsub|i=1><rsup|m>v<rsup|n><around*|(|J<rsub|i>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=m+1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>+<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsup|m><rsub|i=1><around*|(|v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>+<around*|(|\<chi\>-\<gamma\>|)>\<cdot\>v<rsup|n><around*|(|J<rsub|i>|)>|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|eq
        18.151.024>>>>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=m+1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>+<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|m>v<rsup|n+1><around*|(|H<rsup|i,\<chi\>>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,\<gamma\>>|)>>>>>
      </eqnarray*>

      which using <reference|eq 18.148.024> and the definition of
      <math|A<rsub|\<varepsilon\>>> proves that
      <math|\<chi\>\<in\>A<rsub|\<varepsilon\>>>. So
      <math|\<chi\>\<leqslant\>sup<around*|(|A<rsub|\<varepsilon\>>|)>=\<gamma\>>
      contradicting <math|\<gamma\>\<less\>\<chi\>> [see <reference|eq
      18.148.024>]. Hence the assumption that
      <math|\<gamma\>\<less\>b<rsub|n+1>> must be wrong. Combining this with
      <reference|eq 18.135.024> proves that\ 

      <\equation>
        <label|eq 18.154.024>b<rsub|n+1>=\<gamma\>\<in\>A<rsub|\<varepsilon\>>
      </equation>

      Using the definition of <math|A<rsub|\<varepsilon\>>> we have then that

      <\equation>
        <label|eq 18.155.024>V\<cdot\><around*|(|b<rsub|n+1>-a<rsub|n+1>|)>\<leqslant\><around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,b<rsub|n+1>>|)>
      </equation>

      As <math|H<rsup|i,b<rsub|n+1>>=<around*|{|x\<in\>\<bbb-R\><rsup|n+1><around*|\||x<rsub|n+1>\<leqslant\>b<rsub|n+1>|\<nobracket\>>|}><big|cap>R<rsub|i>\<subseteq\>R<rsub|i>>
      we have using <reference|volume is increasing> that

      <\equation>
        <label|eq 18.156.024>v<rsup|n+1><around*|(|H<rsup|i,b<rsub|n+1>>|)>\<leqslant\>v<rsup|n><around*|(|R<rsub|i>|)>
      </equation>

      Finally

      <\eqnarray*>
        <tformat|<table|<row|<cell|v<rsup|n+1><around*|(|R|)>>|<cell|\<equallim\><rsub|<text|<reference|eq
        18.130.024>>>>|<cell|V\<cdot\><around*|(|b<rsub|n+1>-a<rsub|n+1>|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|eq
        18.155.024>>>>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n+1><around*|(|H<rsup|i,b<rsub|n+1>>|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<text|<reference|eq
        18.156.024>>>>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n+1><around*|(|R<rsub|i>|)>>>>>
      </eqnarray*>

      which as <math|\<varepsilon\>\<gtr\>0> was choosen arbitrary proves
      that\ 
...
<\references>
  <\collection>
    ...
    <associate|Caratheodore|<tuple|18.59|?>>
    ...
    <associate|Lebesgue measure space|<tuple|18.65|?>>
    <associate|Lower half spaces|<tuple|18.43|?>>
    <associate|R can be covered by open intervals|<tuple|18.62|?>>
    ...
    <associate|auto-21|<tuple|Carathéodory theorem|?>>
    ...
    <associate|eq 18.127.024|<tuple|18.127|?>>
    <associate|eq 18.128.024|<tuple|18.128|?>>
    <associate|eq 18.129.024|<tuple|18.129|?>>
    <associate|eq 18.13.021|<tuple|18.13|?>>
    <associate|eq 18.130.024|<tuple|18.130|?>>
    <associate|eq 18.131.024|<tuple|18.131|?>>
    <associate|eq 18.132.024|<tuple|18.132|?>>
    <associate|eq 18.133.024.1|<tuple|18.134|?>>
    <associate|eq 18.134.024|<tuple|18.135|?>>
    <associate|eq 18.135.024|<tuple|18.136|?>>
    <associate|eq 18.136.024|<tuple|18.139|?>>
    <associate|eq 18.136.024.1|<tuple|18.138|?>>
    <associate|eq 18.137.024|<tuple|18.140|?>>
    <associate|eq 18.137.024.2|<tuple|18.137|?>>
    <associate|eq 18.138.024|<tuple|18.141|?>>
    <associate|eq 18.139.024|<tuple|18.142|?>>
    <associate|eq 18.14.021|<tuple|18.14|?>>
    <associate|eq 18.141.024|<tuple|18.144|?>>
    <associate|eq 18.142.024|<tuple|18.145|?>>
    <associate|eq 18.143.021|<tuple|18.146|?>>
    <associate|eq 18.143.024.3|<tuple|18.143|?>>
    <associate|eq 18.144.024|<tuple|18.147|?>>
    <associate|eq 18.145.024|<tuple|18.148|?>>
    <associate|eq 18.146.024|<tuple|18.149|?>>
    <associate|eq 18.147.024|<tuple|18.150|?>>
    <associate|eq 18.148.024|<tuple|18.151|?>>
    <associate|eq 18.149.024|<tuple|18.133|?>>
    <associate|eq 18.15.021|<tuple|18.15|?>>
    <associate|eq 18.150.024|<tuple|18.152|?>>
    <associate|eq 18.151.024|<tuple|18.153|?>>
    <associate|eq 18.154.024|<tuple|18.154|?>>
    <associate|eq 18.155.024|<tuple|18.155|?>>
    <associate|eq 18.156.024|<tuple|18.156|?>>
    ...
    <associate|outer measure on R|<tuple|18.64|?>>
    ...
    <associate|semi additivity of the length in the reals|<tuple|18.63|?>>
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      ...
      <tuple|<tuple|Carathéodory theorem>|<pageref|auto-21>>
