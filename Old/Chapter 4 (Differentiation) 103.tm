...
<\body>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\description>
        ...
        <math|h=-<around*|\||h|\|>> thus <math|<around*|\<\|\|\>|<frac|f<around*|(|x+h|)>-f<around*|(|x|)>|h>-d|\<\|\|\>><rsub|Y>\<equallim\><rsub|h=-<around*|\||h|\|>><around*|\<\|\|\>|<frac|f<around*|(|x-<around*|\||h|\|>|)>-f<around*|(|x|)>|-<around*|\||h|\|>>-d|\<\|\|\>><rsub|Y>\<less\>\<varepsilon\>>
      </description>
  ...
  <\proof>
    ...
    <math|\<sigma\><rsup|\<bbb-R\>><around*|(|t|)>=x+t\<cdot\>y>. Let
    <math|t\<in\>\<bbb-R\>>, <math|\<varepsilon\>\<gtr\>0> and take
    <math|\<delta\>=1> then if <math|0\<less\><around*|\||h|\|>\<less\>\<delta\>>
    we have\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|\<\|\|\>|<frac|\<sigma\><rsup|\<bbb-R\>><around*|(|t+h|)>-\<sigma\><rsup|\<bbb-R\>><around*|(|t|)>|h>-t|\<\|\|\>><rsub|Y>>|<cell|=>|<cell|<around*|\<\|\|\>|<frac|x+<around*|(|t+h|)>\<cdot\>y-<around*|(|x+h\<cdot\>y|)>|h>-t|\<\|\|\>><rsub|Y>>>|<row|<cell|>|<cell|=>|<cell|<around*|\<\|\|\>|<frac|t\<cdot\>h|h>-t|\<\|\|\>><rsub|Y>=0\<less\>\<varepsilon\>>>>>
    </eqnarray*>

    proving that <math|\<forall\>t\<in\>\<bbb-R\>>
    <math|<around*|(|\<sigma\><rsup|\<bbb-R\>>|)><rprime|'><around*|(|t|)>>
    exists and that <math|<around*|(|\<sigma\><rsup|\<bbb-R\>>|)><rprime|'><around*|(|t|)>=t>
    or <math|<around*|(|\<sigma\><rsup|\<bbb-R\>>|)><rprime|'>=\<bbb-1\><rsub|\<bbb-R\>>>
    which is continuous. Using <reference|C1 of real or complex function> it
    follows the that <math|\<sigma\><rsup|\<bbb-R\>>> is <math|C<rsup|1>>. As
    <math|\<bbb-R\>> is open, <math|<around*|[|a,b|]>\<subseteq\>\<bbb-R\>>
  ...
  <\proof>
    ...
    <math|h<rprime|'><around*|(|t|)>=Df<around*|(|\<sigma\><around*|(|t|)>|)><around*|(|y-x|)>\<Rightarrow\><around*|\<\|\|\>|h<rprime|'><around*|(|t|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|D
    f<around*|(|\<sigma\><around*|(|t|)>|)>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|y-x|\<\|\|\>><rsub|X>\<leqslant\>k\<cdot\><around*|\<\|\|\>|y-x|\<\|\|\>><rsub|X>>
    and thus
  ...
  <\proof>
    ...
    12.43>>><around*|\<\|\|\>|<around*|(|D
    f<around*|(|x+\<xi\>\<cdot\>v+w|)>- Df<around*|(|x|)>-D<rsup|2>f<around*|(|x|)><around*|(|\<varepsilon\>\<cdot\>v+w|)>|)><around*|(|v|)>-<around*|(|Df<around*|(|x+\<xi\>\<cdot\>v|)>-Df<around*|(|x|)>-D<rsup|2>f<around*|(|x|)><around*|(|\<xi\>\<cdot\>v|)>|)><around*|(|v|)>|\<\|\|\>><rsub|Y>\<leqslant\><around*|\<\|\|\>|<around*|(|Df<around*|(|x+\<xi\>\<cdot\>v+w|)>-
...
<\references>
  <\collection>
    ...
    <associate|(x,h)-\<gtr\>Df(x)(h) differentiability|<tuple|14.76|432>>
    ...
    <associate|C^@@=@@-times differentiable|<tuple|14.54|424>>
    <associate|C^n implies C^m|<tuple|14.56|424>>
    <associate|C^n is a local property|<tuple|14.60|427>>
    <associate|C^n of multivalued functions|<tuple|14.71|430>>
    <associate|D1 and composition|<tuple|14.72|?>>
    <associate|D^2g(x)(u)(v)=D^nf(x)(v:u:v1..vn-2)|<tuple|14.116|450>>
    <associate|D^nf(x)(h1:..hn)=D^(n-1)f(x)(h1:..hn-1)(hn)|<tuple|14.75|431>>
    ...
    <associate|constant functions are C^infinite|<tuple|14.65|428>>
    <associate|continuous billinear functions are
    C^infinity|<tuple|14.68|429>>
    ...
    <associate|differentiability of finite sum|<tuple|14.63|428>>
    ...
    <associate|eq 12.100|<tuple|14.150|467>>
    <associate|eq 12.101|<tuple|14.151|468>>
    <associate|eq 12.102|<tuple|14.152|468>>
    <associate|eq 12.103|<tuple|14.153|468>>
    <associate|eq 12.104|<tuple|14.154|468>>
    <associate|eq 12.105|<tuple|14.155|468>>
    <associate|eq 12.106|<tuple|14.156|468>>
    <associate|eq 12.107|<tuple|14.157|468>>
    <associate|eq 12.108|<tuple|14.158|468>>
    <associate|eq 12.109|<tuple|14.159|468>>
    <associate|eq 12.12|<tuple|14.23|422>>
    <associate|eq 12.128|<tuple|14.162|470>>
    <associate|eq 12.129|<tuple|14.163|?>>
    <associate|eq 12.130|<tuple|14.164|470>>
    <associate|eq 12.131|<tuple|14.168|471>>
    <associate|eq 12.132|<tuple|14.169|471>>
    <associate|eq 12.133|<tuple|14.170|471>>
    <associate|eq 12.134|<tuple|14.171|471>>
    <associate|eq 12.135|<tuple|14.172|471>>
    <associate|eq 12.136|<tuple|14.173|471>>
    <associate|eq 12.137|<tuple|14.174|471>>
    <associate|eq 12.138|<tuple|14.175|471>>
    <associate|eq 12.139|<tuple|14.176|471>>
    <associate|eq 12.140|<tuple|14.177|471>>
    <associate|eq 12.141|<tuple|14.177|471>>
    <associate|eq 12.2|<tuple|14.11|416>>
    <associate|eq 12.37|<tuple|14.59|444>>
    <associate|eq 12.38|<tuple|14.60|444>>
    <associate|eq 12.39|<tuple|14.61|445>>
    <associate|eq 12.40|<tuple|14.62|445>>
    <associate|eq 12.41|<tuple|14.73|447>>
    <associate|eq 12.42|<tuple|14.74|447>>
    <associate|eq 12.43|<tuple|14.75|447>>
    <associate|eq 12.44|<tuple|14.76|447>>
    <associate|eq 12.45|<tuple|14.77|447>>
    <associate|eq 12.46|<tuple|14.78|448>>
    <associate|eq 12.47|<tuple|14.79|448>>
    <associate|eq 12.48|<tuple|14.80|448>>
    <associate|eq 12.49|<tuple|14.81|448>>
    <associate|eq 12.50|<tuple|14.82|448>>
    <associate|eq 12.51|<tuple|14.83|448>>
    <associate|eq 12.52|<tuple|14.84|449>>
    <associate|eq 12.53|<tuple|14.85|450>>
    <associate|eq 12.54|<tuple|14.86|450>>
    <associate|eq 12.55|<tuple|14.87|450>>
    <associate|eq 12.56|<tuple|14.88|451>>
    <associate|eq 12.57|<tuple|14.89|451>>
    <associate|eq 12.58|<tuple|14.90|451>>
    <associate|eq 12.59|<tuple|14.91|452>>
    <associate|eq 12.60|<tuple|14.92|452>>
    <associate|eq 12.61|<tuple|14.93|452>>
    <associate|eq 12.62|<tuple|14.94|452>>
    <associate|eq 12.63|<tuple|14.95|452>>
    <associate|eq 12.64|<tuple|14.114|459>>
    <associate|eq 12.64-0|<tuple|14.96|454>>
    <associate|eq 12.65|<tuple|14.115|459>>
    <associate|eq 12.65-0|<tuple|14.97|454>>
    <associate|eq 12.66|<tuple|14.116|459>>
    <associate|eq 12.66-0|<tuple|14.98|454>>
    <associate|eq 12.67|<tuple|14.117|459>>
    <associate|eq 12.67-0|<tuple|14.99|454>>
    <associate|eq 12.68|<tuple|14.118|460>>
    <associate|eq 12.68-0|<tuple|14.100|454>>
    <associate|eq 12.69|<tuple|14.119|460>>
    <associate|eq 12.69-0|<tuple|14.101|454>>
    <associate|eq 12.70|<tuple|14.120|460>>
    <associate|eq 12.70-0|<tuple|14.102|454>>
    <associate|eq 12.71|<tuple|14.121|461>>
    <associate|eq 12.71-0|<tuple|14.103|454>>
    <associate|eq 12.72|<tuple|14.122|461>>
    <associate|eq 12.72-0|<tuple|14.104|454>>
    <associate|eq 12.72-1|<tuple|14.105|455>>
    <associate|eq 12.73|<tuple|14.123|461>>
    <associate|eq 12.74|<tuple|14.124|461>>
    <associate|eq 12.74-1|<tuple|14.106|456>>
    <associate|eq 12.75|<tuple|14.125|462>>
    <associate|eq 12.75-1|<tuple|14.107|456>>
    <associate|eq 12.76|<tuple|14.126|462>>
    <associate|eq 12.76-1|<tuple|14.108|456>>
    <associate|eq 12.77|<tuple|14.127|462>>
    <associate|eq 12.77-1|<tuple|14.109|456>>
    <associate|eq 12.78|<tuple|14.128|462>>
    <associate|eq 12.78-1|<tuple|14.110|456>>
    <associate|eq 12.79|<tuple|14.129|462>>
    <associate|eq 12.79-1|<tuple|14.111|456>>
    <associate|eq 12.80|<tuple|14.130|463>>
    <associate|eq 12.80-1|<tuple|14.112|457>>
    <associate|eq 12.81|<tuple|14.131|463>>
    <associate|eq 12.81-1|<tuple|14.113|457>>
    <associate|eq 12.82|<tuple|14.132|463>>
    <associate|eq 12.83|<tuple|14.133|463>>
    <associate|eq 12.84|<tuple|14.134|463>>
    <associate|eq 12.85|<tuple|14.135|463>>
    <associate|eq 12.86|<tuple|14.136|464>>
    <associate|eq 12.87|<tuple|14.137|465>>
    <associate|eq 12.88|<tuple|14.138|466>>
    <associate|eq 12.89|<tuple|14.139|466>>
    <associate|eq 12.9|<tuple|14.141|466>>
    <associate|eq 12.90|<tuple|14.140|466>>
    <associate|eq 12.92|<tuple|14.142|466>>
    <associate|eq 12.93|<tuple|14.143|466>>
    <associate|eq 12.94|<tuple|14.144|466>>
    <associate|eq 12.95|<tuple|14.145|466>>
    <associate|eq 12.96|<tuple|14.146|467>>
    <associate|eq 12.97|<tuple|14.147|467>>
    <associate|eq 12.98|<tuple|14.148|467>>
    <associate|eq 12.99|<tuple|14.149|467>>
    <associate|eq 13.50.317|<tuple|14.64|?>>
    <associate|eq 13.51.317|<tuple|14.65|?>>
    <associate|eq 13.52.317|<tuple|14.66|?>>
    <associate|eq 13.53.317|<tuple|14.67|?>>
    <associate|eq 13.54.317|<tuple|14.68|?>>
    <associate|eq 13.55.317|<tuple|14.69|?>>
    <associate|eq 13.56.317|<tuple|14.70|?>>
    <associate|eq 13.57.317|<tuple|14.71|?>>
    <associate|eq 13.58.317|<tuple|14.72|?>>
    ...
    <associate|eq 14.149.020|<tuple|14.160|?>>
    <associate|eq 14.15.100|<tuple|14.16|?>>
    <associate|eq 14.150.020|<tuple|14.161|?>>
    ...
    <associate|eq 14.46.004|<tuple|14.48|?>>
    <associate|eq 14.46.1.004|<tuple|14.47|?>>
    <associate|eq 14.46.102|<tuple|14.46|?>>
    <associate|eq 14.48.020|<tuple|14.49|?>>
    <associate|eq 14.49.020|<tuple|14.50|?>>
    <associate|eq 14.5.100|<tuple|14.5|?>>
    <associate|eq 14.50.020|<tuple|14.51|?>>
    <associate|eq 14.51.020|<tuple|14.52|?>>
    <associate|eq 14.52.020|<tuple|14.53|?>>
    <associate|eq 14.53.020|<tuple|14.54|?>>
    <associate|eq 14.54.020|<tuple|14.55|?>>
    <associate|eq 14.55.020|<tuple|14.56|?>>
    <associate|eq 14.56.020|<tuple|14.57|?>>
    <associate|eq 14.57.020|<tuple|14.58|?>>
    ...
    <associate|f_v is differentiable|<tuple|14.74|431>>
    <associate|fundamental theorem of calculus|<tuple|14.98|444>>
    <associate|generalized chain rule|<tuple|14.73|430>>
    <associate|i the substitution|<tuple|14.22|?>>
    <associate|i-H has inverse if norm of H is lower then
    1|<tuple|14.138|459>>
    <associate|if f is C^n then D^1f is C^n-1|<tuple|14.58|426>>
    ...
    <associate|linear continuous mappings are C^infinity|<tuple|14.66|428>>
    ...
    derivatives|<tuple|14.77|432>>
    <associate|n-times differentiability implies m-times
    differentiability|<tuple|14.55|424>>
    <associate|n-times differentiability is local|<tuple|14.59|426>>
    <associate|n-times differentiability is same as n-1 times
    differentiability of DF|<tuple|14.57|425>>
    <associate|n-times differentiability of multi valued
    function|<tuple|14.70|429>>
    ...
    differentiable|<tuple|14.78|432>>
    <associate|projection map is infinite times dimensions|<tuple|14.69|429>>
    ...
    <associate|sum of C^n functions is C^n|<tuple|14.62|427>>
    ...
    differentiable|<tuple|14.61|427>>
    ...
    <associate|translations are C-infinity|<tuple|14.67|428>>
