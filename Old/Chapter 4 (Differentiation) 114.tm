...
<\body>
  ...
  <\proof>
    ...
    <\proposition>
      ...
      <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>
      be a Banach space over <math|\<bbb-R\>>, <math|r\<in\>\<bbb-N\>>,
      <math|0\<in\>U\<subseteq\>X> an open set and <math|f:U\<rightarrow\>X>
      a differentiable function of class <math|C<rsup|r>> such that <math|D
      f<around*|(|0|)>=\<bbb-1\><rsub|X>> and <math|f<around*|(|0|)>=0> then
      <math|f> is a local diffeomorphism at <math|0>.
    </proposition>
    ...
    <\proof>
      ...
      <\proof>
        ...
        <\equation>
          ...
          then <around*|\<\|\|\>|g<around*|(|y<rsub|1>|)>-g<around*|(|y<rsub|2>|)>|\<\|\|\>><rsub|X>\<leqslant\>2\<cdot\><around*|\<\|\|\>|y<rsub|1>-y<rsub|2>|\<\|\|\>><rsub|X>
        </equation>
      ...
      <\equation>
        <label|eq 14.222.112>f<around*|(|0|)>\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,<frac|\<chi\>|2>|)><infix-and>0\<in\>U<rsub|\<chi\>>
      </equation>
    ...
    <\proof>
      ...
      <\equation*>
        f \ is a local diffeomorphism of class C<rsup|r> at x<rsub|0>
      </equation*>
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 14.237.112>f is C<rsup|1><infix-and>f<rprime|'>=D
    ...
    <\equation>
      ...
      and f<rsub|\|U<rprime|'>>:U<rprime|'>\<rightarrow\>V<rprime|'> is a
      diffeomorphism
    </equation>
  ...
  <\theorem>
    ...
    <\proof>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|>|<cell|\<pi\><rsup|X\<times\>Y><rsub|1>:X\<times\>Y\<rightarrow\>X
        defined by \<pi\><rsup|X\<times\>Y><rsub|1><around*|(|x,y|)>=x>|<cell|>>|<row|<cell|>|<cell|\<pi\><rsup|X\<times\>Y><rsub|2>:X\<times\>Y\<rightarrow\>Y
        defined by \<pi\><rsup|X\<times\>Y><rsub|2><around*|(|x,y|)>=y>|<cell|>>|<row|<cell|>|<cell|\<pi\><rsup|X\<times\>Z><rsub|1>:X\<times\>Z\<rightarrow\>X
        defined by \<pi\><rsup|X\<times\>Z><rsub|1><around*|(|x,y|)>=x>|<cell|>>|<row|<cell|>|<cell|\<pi\><rsup|X\<times\>Z><rsub|2>:X\<times\>Z\<rightarrow\>X
      ...
      <\equation>
        \<pi\><rsup|X\<times\>Y><rsub|1>,\<pi\><rsup|X\<times\>Y><rsub|2>,\<pi\><rsup|X\<times\>Z><rsub|1><infix-and>\<pi\><rsup|X\<times\>Z><rsub|2>
        and their restrictions to open sets \ are of class C<rsup|\<infty\>>
      </equation>

      Define now

      <\equation>
        \<varphi\>:U\<times\>V\<rightarrow\>X\<times\>Z by
      ...
      <\equation>
        <label|eq 14.242.112>\<pi\><rsub|1><rsup|X\<times\>Z>\<circ\>\<varphi\>=<around*|(|\<pi\><rsup|X\<times\>Y>|)><rsub|\|U\<times\>V>
        so by <text|<reference|projection map is infinite times dimensions>,
        <reference|C^n is a local property> >
        \<pi\><rsub|1><rsup|X\<times\>Z>\<circ\>\<varphi\> is
        C<rsup|\<infty\>>
      </equation>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|D<rsup|1><around*|(|\<pi\><rsub|1><rsup|X\<times\>Z>\<circ\>\<varphi\>|)>>|<cell|=>|<cell|D<rsup|1><around*|(|<around*|(|\<pi\><rsup|X\<times\>Y>|)><rsub|\|U\<times\>V>|)><around*|(|x,y|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|projection
        map is infinite times dimensions>, <reference|C^n is a local
        property> >>>|<cell|\<pi\><rsup|X\<times\>Y><eq-number>>>>>
      </eqnarray*>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|D<rsup|1><around*|(|\<pi\><rsup|X\<times\>Z><rsub|2>\<circ\>\<varphi\>|)>>|<cell|=>|<cell|D<rsup|1>f>>|<row|<cell|>|<cell|=>|<cell|D<rsup|1><rsub|1>f<around*|(|x|)>\<circ\>\<pi\><rsub|1><rsup|X\<times\>Y>+D<rsup|1><rsub|2>f<around*|(|x|)>\<circ\>\<pi\><rsub|2><rsup|X\<times\>Y>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|differentiability
      ...
      14.242.112> and <reference|eq 14.244.112> together with
      <reference|n-times differentiability of multi valued function> gives

      <\equation>
        <label|eq 14.246.112>\<varphi\> is of class
        C<rsup|r><infix-and>\<pi\><rsub|1><rsup|X\<times\>Y>\<circ\>D<rsup|1>\<varphi\><around*|(|x,y|)>=\<pi\><rsub|1><rsup|X\<times\>Y>
        and \<pi\><rsub|2><rsup|X\<times\>Y>\<circ\>D<rsup|1>\<varphi\><around*|(|x,y|)>=D<rsup|><rsub|1>f<around*|(|x|)>\<circ\>\<pi\><rsub|1><rsup|X\<times\>Y>+D<rsup|><rsub|2>f<around*|(|x|)>\<circ\>\<pi\><rsub|2>
      </equation>

      or

      <\equation>
        <label|eq 14.247.112.3>\<varphi\><around*|(|x,y|)><around*|(|r,s|)>=<around*|(|r,D<rsub|1>f<around*|(|x,y|)><around*|(|r|)>+D<rsub|2>f<around*|(|x,y|)><around*|(|s|)>|)>
      </equation>

      Using the above for <math|<around*|(|x<rsub|0>,y<rsub|0>|)>\<in\>U\<times\>V>
      we have <math|D<rsup|1>\<varphi\><around*|(|x<rsub|0>,y<rsub|0>|)><around*|(|x,y|)>=<around*|(|x,D<rsub|1>f<around*|(|x<rsub|0>,y<rsub|0>|)><around*|(|x|)>+D<rsub|2>f<around*|(|x<rsub|0>,y<rsub|0>|)><around*|(|y|)>|)>>.
      Using the above lemma <reference|T,S> and the fact that
      ...
      <math|<around*|(|\<varphi\><rsub|\|<wide|U<around*|(|x<rsub|0>,y<rsub|0>|)>|~>>|)><rsub|\|U<rsub|0>\<times\>V<rsub|0>>=\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>>
      gives

      <\equation>
        <label|eq 12.128>\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>:
        U<rsub|0>\<times\>V<rsub|0>\<rightarrow\>W<rsub|0> is a
      ...
      <\equation>
        ...
        and \<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>><around*|(|x<rsub|0>,y<rsub|0>|)>=<around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>\<in\>W<rsub|0>
      </equation>
      ...
      <\equation>
        <label|eq 14.249.112>x=\<pi\><rsup|X\<times\>Y><rsub|1><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>\<in\>\<pi\><rsub|1><rsup|X\<times\>Y><around*|(|U<rsub|0>\<times\>V<rsub|0>|)>=U<rsub|0><infix-and>z=f<around*|(|x,\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>|)>
      </equation>
      ...
      <\equation>
        <label|eq 12.130>g:<rsub|>W<rsub|0>\<rightarrow\>V<rsub|0> by
        g<around*|(|x,z|)>=\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>\<subseteq\><rsub|>V
        <around*|[|as U<rsub|0>\<times\>V<rsub|0>\<subseteq\><wide|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>|~>\<subseteq\>U\<times\>V|]>
      </equation>

      Further

      <\equation>
        <label|eq 14.252.112.2>\<forall\><around*|(|x,z|)>\<in\>W<rsub|0>=V<rsub|\<varphi\><around*|(|x<rsub|0>,y<rsub|0>|)>>
      ...
      and we have (1) of the theorem.

      To prove (2) we use proof by contradiction. So assume that there is a
      <math|h:W<rsub|0>\<rightarrow\>V<rsub|0>> with
      <math|\<forall\><around*|(|x,z|)>\<in\>W<rsub|0>>
      <math|f<around*|(|x,h<around*|(|x,z|)>|)>=z> and <math|h\<neq\>g> then
      <math|\<exists\><around*|(|x<rsub|1>,z<rsub|1>|)>\<in\>W<rsub|0>> with
      <math|g<around*|(|x<rsub|1>,z<rsub|1>|)>\<neq\>h<around*|(|x<rsub|1>,z<rsub|1>|)>>
      and derive a contradiction. As <math|<around*|(|x<rsub|1>,z<rsub|1>|)>\<in\>W<rsub|0>\<equallim\><rsub|<text|<reference|eq
      12.129>>>\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>><around*|(|U<rsub|0>\<times\>V<rsub|0>|)>>
      there exists a <math|<around*|(|x<rsub|2>,y<rsub|2>|)>\<in\>U<rsub|0>\<times\>V<rsub|0>>
      such that <math|<around*|(|x<rsub|1>,z<rsub|1>|)>=\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>><around*|(|x<rsub|2>,y<rsub|2>|)>=\<varphi\><around*|(|x<rsub|2>,y<rsub|2>|)>=<around*|(|x<rsub|2>,f<around*|(|x<rsub|2>,y<rsub|2>|)>|)>\<Rightarrow\>x<rsub|1>=x<rsub|2>\<in\>\<pi\><rsub|1><rsup|X\<times\>Y><around*|(|U<rsub|0>\<times\>V<rsub|0>|)>>.
      Further as <math|h<around*|(|x<rsub|1>,z<rsub|1>|)>,g<around*|(|x<rsub|1>,z<rsub|1>|)>\<in\>V<rsub|0>\<equallim\><rsub|<text|<reference|eq
      14.251.112.1>>>\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>|)>>
      proving that

      <\equation>
        <label|eq 14.255.112><around*|(|x<rsub|1>,g<around*|(|x<rsub|1>,z<rsub|1>|)>|)>,<around*|(|x<rsub|2>,h<around*|(|x<rsub|2>,z<rsub|2>|)>|)>\<in\>U<rsub|0>\<times\>V<rsub|0>
      </equation>

      So that\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>><around*|(|x<rsub|1>,g<around*|(|x<rsub|1>,z<rsub|1>|)>|)>>|<cell|\<equallim\><rsub|<text|<reference|eq
        14.255.112>>>>|<cell|\<varphi\><around*|(|x<rsub|1>,g<around*|(|x<rsub|1>,z<rsub|1>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x<rsub|1>,f<around*|(|x<rsub|1>,g<around*|(|x<rsub|1>,z<rsub|1>|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x<rsub|1>,z<rsub|1>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x<rsub|1>,f<around*|(|x<rsub|1>,h<around*|(|x<rsub|1>,z<rsub|1>|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<varphi\><around*|(|x<rsub|1>,h<around*|(|x<rsub|1>,z<rsub|1>|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
        14.255.112>>>>|<cell|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>><around*|(|x<rsub|1>,h<around*|(|x<rsub|1>,z<rsub|1>|)>|)>>>>>
      </eqnarray*>

      which as <math|><math|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>>
      is a bijection means that <math|<around*|(|x<rsub|1>,g<around*|(|x<rsub|1>,z<rsub|1>|)>|)>=<around*|(|x<rsub|1>,h<around*|(|x<rsub|1>,z<rsub|1>|)>|)>\<Rightarrow\>g<around*|(|x<rsub|1>,z<rsub|1>|)>=h<around*|(|x<rsub|1>,z<rsub|1>|)>>
      contradicting <math|g<around*|(|x<rsub|1>,z<rsub|1>|)>\<neq\>h<around*|(|x<rsub|1>,z<rsub|1>|)>>.
      Hence we must have that <math|h=g> proving (2) of the theorem.\ 

      Now to prove <math|<around|(|3.a|)>> note that by <reference|eq 12.128>
      and <reference|diffeomorphism are toplinear> we have
      <math|\<forall\><around*|(|x,y|)>\<in\>U<rsub|0>\<times\>V<rsub|0>>
      that <math|D <around*|(|\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>>|)><around*|(|x,y|)>>
      ...
      <math|r=s> giving that

      <\equation>
        <label|eq 14.258.112.4>D<rsub|2>f<around*|(|x,y|)> is injective
      </equation>
      ...
      hence <math|r=0> and <math|D<rsub|1>f<around*|(|x,y|)><around*|(|0|)>+D<rsub|2>f<around*|(|x,y|)><around*|(|s|)>=<around*|(|0,z|)>>
      ...
      <\equation>
        <label|eq 14.259.112.4>\<forall\><around*|(|x,y|)>\<in\>U<rsub|0>\<times\>V<rsub|0>
        we have D<rsub|2>f<around*|(|x,y|)> is bijective
      </equation>

      Take now <math|<around*|(|x,z|)>\<in\>W<rsub|0>> then using
      <reference|eq 14.249.112> we have <math|x\<in\>U<rsub|0>> and as by
      <reference|eq 12.130> <math|g<around*|(|x,z|)>\<in\>Y<rsub|0>> we have
      that\ 

      <\equation>
        <label|eq 14.260.113>\<forall\>*<around*|(|x,y|)>\<in\>W<rsub|0> we
        have that D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)> is bijective
        so that <around*|[|D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>|]><rsup|-1>
        exists
      </equation>
      ...
      <\equation>
        ...
        <around*|[|the neutral element in L<around*|(|X,Z|)>|]>
      </equation>

      Also\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|\<pi\><rsub|1><rsup|X\<times\>Z>\<circ\><around*|(|\<psi\>\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>|)>|)><around*|(|t|)>>|<cell|=>|<cell|\<pi\><rsub|1><rsup|X\<times\>Z><around*|(|\<psi\><around*|(|<around*|(|1\<rightarrow\><around*|(|x,z|)>|)><around*|(|t|)>|)>|)><rsub|>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|1><rsup|X\<times\>Z><around*|(|\<psi\><around*|(|<around*|(|t,z|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|1><rsup|X\<times\>Z><around*|(|t,g<around*|(|t,z|)>|)>>>|<row|<cell|>|<cell|=>|<cell|t>>|<row|<cell|>|<cell|=>|<cell|\<bbb-1\><rsub|X><around*|(|t|)>>>>>
      </eqnarray*>

      and

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|\<pi\><rsub|2><rsup|X\<times\>Z>\<circ\><around*|(|\<psi\>\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>|)>|)><around*|(|t|)>>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|\<psi\><around*|(|<around*|(|1\<rightarrow\><around*|(|x,z|)>|)><around*|(|t|)>|)>|)><rsub|>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|\<psi\><around*|(|<around*|(|t,z|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|t,g<around*|(|t,z|)>|)>>>|<row|<cell|>|<cell|=>|<cell|g<around*|(|t,z|)>>>|<row|<cell|>|<cell|=>|<cell|g<around*|(|<around*|(|1\<rightarrow\><around*|(|x,z|)>|)><around*|(|t|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|g\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>|)><around*|(|t|)>>>>>
      </eqnarray*>
      ...
      We can now calculate <math|D<rsub|1><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>>
      as follows\ 
      ...
      <\eqnarray*>
        ...
        f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\><around*|(|D\<bbb-1\><rsub|X><around*|(|x|)>,D<around*|(|g\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)><around*|(|x|)>|)>|)>|)><around*|(|h|)>>|<cell|=>|<cell|>>|<row|<cell|<around*|(|D
      ...
      <\equation>
        \<forall\><around*|(|x,z|)>\<in\>W<rsub|o> we have
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|\<pi\><rsub|2><rsup|X\<times\>Z>\<circ\><around*|(|2\<rightarrow\><around*|(|x,z|)>|)>|)><around*|(|t|)>>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|<around*|(|2\<rightarrow\><around*|(|x,z|)>|)><around*|(|t|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|x,t|)>>>|<row|<cell|>|<cell|=>|<cell|t>>|<row|<cell|>|<cell|=>|<cell|\<bbb-1\><rsub|\<bbb-Z\>><around*|(|t|)><eq-number><label|eq
        14.267.113>>>>>
      </eqnarray*>
      ...
      We calculate now <math|D<rsub|2><around*|(|f\<circ\>\<psi\>|)><around*|(|z|)>>
      in another way
      ...
      <\equation>
        \<forall\><around*|(|x,z|)>\<in\>W<rsub|0> we have
...
<\references>
  <\collection>
    ...
    <associate|eq 12.130|<tuple|14.252|470>>
    ...
    <associate|eq 14.249.112|<tuple|14.251|?>>
    <associate|eq 14.25.101|<tuple|14.41|?>>
    <associate|eq 14.25.110|<tuple|14.25|?>>
    <associate|eq 14.252.112.2|<tuple|14.253|?>>
    <associate|eq 14.255.112|<tuple|14.256|?>>
