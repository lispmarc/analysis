...
<\body>
  ...
  So we can use the defintion of a convergent (divergent) serie in
  ...
  <\definition>
    ...
    <math|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<bbb-C\>>
    be a sequence then we define\ 

    <\enumerate>
      <item> <math|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><rsub|>=<around*|{|z\<in\>\<bbb-C\>\|<big|sum><rsub|i=0><rsup|\<infty\>>a<rsub|i>\<cdot\>z<rsup|i>
      is convergent|}>>, <math|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><rsub|>>
      is called the <with|font-series|bold|convergence domain> of <math|a>

      <item><math|<wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><rsub|>|\<bar\>>=<around*|{|z\<in\>\<bbb-C\>\|<big|sum><rsub|i=1><rsup|\<infty\>>a<rsub|i>
      is absolute convergent|}>>, <math|<wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><rsub|>|\<bar\>>>
      is called the <with|font-series|bold|absolute convergence domain>
    </enumerate>
  </definition>

  <\theorem>
    Let <math|a=<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<bbb-C\>>
    be a sequence <math|0\<in\><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><rsub|>|\<bar\>>\<subseteq\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><rsub|>>
  </theorem>

  <\proof>
    Using <reference|power series 0> we have that
    <math|0\<in\><wide|\<cal-D\><rsub|<around*|{|a|}>>|\<bar\>>>, further as
    absolute convergence implies convergence (see \ <reference|corollary
    12.340>) we have that <math|<wide|\<cal-D\><rsub|<around*|{|a|}>>|\<bar\>>\<subseteq\>\<cal-D\><rsub|<around*|{|a|}>>>
  </proof>

  <\theorem>
    Let <math|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<bbb-C\>>
    then for <math|0\<neq\>z<rsub|0>\<in\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><rsub|>>
  ...
  <\corollary>
    ...
    <math|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<bbb-C\>>
    and let <math|0\<neq\>z<rsub|0>\<in\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>>
    then <math|B<rsub|<around*|\|||\|>><around*|(|0,<around*|\||z<rsub|0>|\|>|)>\<subseteq\><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>\<subseteq\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>>
  </corollary>
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|z=0>>then we have <math|z=0\<in\><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>>
      ...
      is absolute convergent and thus <math|z\<in\><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>>.
    </description>
  </proof>

  From the above it follows that <math|0\<in\><around*|[|0,\<infty\>|[><big|cap>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<Rightarrow\>\<emptyset\>\<neq\><around*|[|0,\<infty\>|[><big|cap>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><rsub|>>
  ...
  <\definition>
    ...
    <math|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<bbb-C\>>
    be a sequence then <math|R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>=sup<around*|(|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><big|cap><around*|[|0,\<infty\>|[>|)>>
  </definition>
  ...
  <\corollary>
    <math|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<bbb-C\>>
    be a sequence then we have for <math|R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>>\ 

    <\enumerate>
      <item>If <math|0\<leqslant\>R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<less\>\<infty\>>
      then <math|B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|)>\<subseteq\><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>\<subseteq\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<subseteq\><wide|B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|)>|\<bar\>>>

      <item>If <math|><math|R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>=\<infty\>>
      then <math|><math|<wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>=\<bbb-C\>=\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>>
    </enumerate>
  </corollary>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>For <math|0\<leqslant\>R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<less\>\<infty\>>
      we have either

      <\description>
        <item*|<math|R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>=0>>if
        <math|0\<neq\>z\<in\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>>
        ...
        domain and balls>>><around*|[|0,\<infty\>|[><big|cap>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>>.
        From this it follows that <math|R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>=sup<around*|(|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><big|cap><around*|[|0,\<infty\>|[>|)>\<gtr\>0>
        a contradiction. So we have that <math|B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|)>=\<emptyset\>\<subseteq\><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>\<subseteq\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>=<around*|{|0|}>=>
        \ <math|<wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>\<subseteq\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<equallim\><rsub|0\<in\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>><around*|{|0|}>=<wide|B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|)>|\<bar\>>>.

        <item*|<math|0\<less\>R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<less\>\<infty\>>>Let
        <math|z\<in\>B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|)>>
        then we have either\ 

        <\description>
          <item*|z=0>then <math|z=0\<in\><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>>

          <item*|<math|z\<neq\>0>>then <math|0\<less\><around*|\||z|\|>\<less\>R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>=sup<around*|(|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><big|cap><around*|[|0,\<infty\>|[>|)>>
          so there exists a <math|z<rprime|'>\<in\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><big|cap><around*|[|0,\<infty\>|[>>
          such that <math|0\<less\><around*|\||z|\|>\<less\>z<rprime|'>\<leqslant\>R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>>.
          ...
          domain and balls>>><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>>
        </description>
        ...
        <\equation>
          <label|eq 17.3.515>B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|)>\<subseteq\><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>\<subseteq\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>
        </equation>

        If <math|z\<nin\><wide|B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|)>|\<bar\>>>
        then <math|R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<less\><around*|\||z|\|>>
        then <math|\<exists\>r\<in\><around*|[|0,\<infty\>|[>> such that
        <math|R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<less\>r\<less\><around*|\||z|\|>>.
        If now <math|z\<in\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>>
        then by <reference|convergence domain and balls> we have that
        <math|r\<in\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><big|cap><around*|[|0,\<infty\>|[>>
        hence <math|r\<leqslant\>sup<around*|(|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><big|cap><around*|[|0,\<infty\>|[>|)>=R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<less\>r>
        a contradiction. So we must have that
        <math|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<subseteq\><wide|B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|)>|\<bar\>>>
        proving using <reference|eq 17.3.515> that\ 

        <\equation*>
          B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|)>\<subseteq\><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>\<subseteq\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<subseteq\><wide|B<rsub|<around*|\|||\|>><around*|(|0,R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|)>|\<bar\>>
        </equation*>
      </description>

      <item>If <math|z\<in\>\<bbb-C\>> then as
      <math|><math|R<rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>=\<infty\>>
      there exists by <reference|condition for supremum (infinum) to be
      infinite> a <math|r\<in\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>><big|cap><around*|[|0,\<infty\>|[>>
      ...
      domain and balls>>><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>>
      proving that <math|\<bbb-C\>\<subseteq\><wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>\<subseteq\>\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>\<subseteq\>\<bbb-C\>>
      giving

      <\equation*>
        <wide|\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>|\<bar\>>=\<bbb-C\>=\<cal-D\><rsub|<around*|{|a<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>>
      </equation*>
    </enumerate>
  </proof>
  ...
  <\corollary>
    Let <math|z\<in\>\<bbb-C\>> then <math|<big|sum><rsub|n=0><rsup|\<infty\>><frac|<around*|\||z|\|><rsup|n>|n!>>
    and <math|<big|sum><rsub|n=0><rsup|\<infty\>><frac|z<rsup|n>|n!>>
    converges and <math|<big|sum><rsub|n=0><rsup|\<infty\>><frac|0<rsup|i>|i!>=1>.
    So we have <math|\<cal-D\><rsub|<around*|{|<frac|z<rsup|n>|n!>|}><rsub|n\<in\>\<bbb-N\>>>=\<bbb-C\>=<wide|\<cal-D\><rsub|<around*|{|<frac|z<rsup|n>|n!>|}><rsub|n\<in\>\<bbb-N\>>>|\<bar\>>>
  </corollary>
...
<\references>
  <\collection>
    <associate|(a-b)+(c-d)=(a+c)-(b+d)|<tuple|16.21|578>>
    <associate|-sup A=inf -A|<tuple|16.27|581>>
    <associate|0\<less\>=y then z=x+y=\<gtr\>z\<less\>=y|<tuple|16.19|577>>
    <associate|Abel-Dirichlet|<tuple|17.12|636>>
    <associate|Power series|<tuple|17.2|633>>
    <associate|a serie of extented positive reals converges always and is
    independent of the order|<tuple|16.110|626>>
    <associate|a-b=c-d=\<gtr\>a+d=c+b|<tuple|16.22|578>>
    <associate|absolute value in the extended reals|<tuple|16.28|582>>
    <associate|absolute value on the extended real
    properties|<tuple|16.30|582>>
    <associate|adding of positive extented reals|<tuple|16.24|579>>
    <associate|alternative definition of limit in the extented
    reals|<tuple|16.79|614>>
    <associate|alternative graph of sum of functions|<tuple|16.97|623>>
    <associate|associativity of inifinite series|<tuple|16.115|630>>
    <associate|associativity of series of extended reals|<tuple|16.113|628>>
    <associate|auto-1|<tuple|16|569>>
    <associate|auto-10|<tuple|16.32|583>>
    <associate|auto-11|<tuple|16.32|583>>
    <associate|auto-12|<tuple|16.32|583>>
    <associate|auto-13|<tuple|16.33|583>>
    <associate|auto-14|<tuple|16.33|583>>
    <associate|auto-15|<tuple|16.2.1|587>>
    <associate|auto-16|<tuple|16.39|587>>
    <associate|auto-17|<tuple|16.39|587>>
    <associate|auto-18|<tuple|16.39|587>>
    <associate|auto-19|<tuple|16.42|587>>
    <associate|auto-2|<tuple|16.1|569>>
    <associate|auto-20|<tuple|16.43|587>>
    <associate|auto-21|<tuple|16.44|587>>
    <associate|auto-22|<tuple|16.52|595>>
    <associate|auto-23|<tuple|16.52|595>>
    <associate|auto-24|<tuple|16.2.2|608>>
    <associate|auto-25|<tuple|16.60|608>>
    <associate|auto-26|<tuple|16.60|608>>
    <associate|auto-27|<tuple|16.64|610>>
    <associate|auto-28|<tuple|16.64|610>>
    <associate|auto-29|<tuple|16.2.3|621>>
    <associate|auto-3|<tuple|16.2|569>>
    <associate|auto-30|<tuple|16.116|631>>
    <associate|auto-31|<tuple|17|633>>
    <associate|auto-32|<tuple|17.1|633>>
    <associate|auto-33|<tuple|17.1.1|633>>
    <associate|auto-34|<tuple|17.4|633>>
    <associate|auto-35|<tuple|17.4|633>>
    <associate|auto-36|<tuple|17.8|634>>
    <associate|auto-37|<tuple|17.8|634>>
    <associate|auto-38|<tuple|17.1.2|635>>
    <associate|auto-39|<tuple|17.16|638>>
    <associate|auto-4|<tuple|16.8|571>>
    <associate|auto-5|<tuple|16.8|571>>
    <associate|auto-6|<tuple|16.9|571>>
    <associate|auto-7|<tuple|16.9|571>>
    <associate|auto-8|<tuple|16.2|582>>
    <associate|auto-9|<tuple|16.32|583>>
    <associate|closed sets in the extended reals|<tuple|16.34|584>>
    <associate|condition for supremum (infinum) to be
    infinite|<tuple|16.11|571>>
    <associate|convergence domain and balls|<tuple|17.7|634>>
    <associate|convergence in real implies that lim inferior = lim
    superior|<tuple|16.69|611>>
    <associate|convergence radius|<tuple|17.8|634>>
    <associate|countable sum of countable sums is a countable
    sum|<tuple|16.114|630>>
    <associate|d'Alembert|<tuple|17.14|637>>
    <associate|definition of limit in the extented reals|<tuple|16.70|612>>
    <associate|density of the extented reals|<tuple|16.7|571>>
    <associate|difference in extented reals|<tuple|16.18|577>>
    <associate|distributivity in the extented reals|<tuple|16.25|579>>
    <associate|eq 13.1.123|<tuple|16.6|584>>
    <associate|eq 13.1.300|<tuple|16.1|580>>
    <associate|eq 13.11.40|<tuple|16.18|615>>
    <associate|eq 13.12.40|<tuple|16.19|615>>
    <associate|eq 13.13.40|<tuple|16.20|615>>
    <associate|eq 13.14.41|<tuple|16.21|626>>
    <associate|eq 13.15.41|<tuple|16.22|627>>
    <associate|eq 13.16.41|<tuple|16.23|627>>
    <associate|eq 13.17.50|<tuple|16.30|630>>
    <associate|eq 13.2.123|<tuple|16.7|584>>
    <associate|eq 13.2.300|<tuple|16.2|580>>
    <associate|eq 13.3|<tuple|16.14|611>>
    <associate|eq 13.3.301|<tuple|16.3|581>>
    <associate|eq 13.4|<tuple|16.15|611>>
    <associate|eq 13.4.39|<tuple|16.10|609>>
    <associate|eq 13.5|<tuple|16.16|611>>
    <associate|eq 13.5.39|<tuple|16.11|609>>
    <associate|eq 13.6|<tuple|16.17|611>>
    <associate|eq 13.6.39|<tuple|16.12|609>>
    <associate|eq 13.7.39|<tuple|16.13|609>>
    <associate|eq 14.22.423|<tuple|16.24|628>>
    <associate|eq 14.23.409|<tuple|16.31|631>>
    <associate|eq 14.23.424|<tuple|16.26|629>>
    <associate|eq 14.23.425|<tuple|16.25|628>>
    <associate|eq 14.24.409|<tuple|16.32|631>>
    <associate|eq 14.24.424|<tuple|16.27|629>>
    <associate|eq 14.25.411|<tuple|16.33|631>>
    <associate|eq 14.25.424|<tuple|16.28|629>>
    <associate|eq 14.26.424|<tuple|16.29|629>>
    <associate|eq 14.4.472|<tuple|16.4|581>>
    <associate|eq 14.5.472|<tuple|16.5|582>>
    <associate|eq 17.1.514|<tuple|17.7|637>>
    <associate|eq 17.1.515|<tuple|17.1|633>>
    <associate|eq 17.2.514|<tuple|17.8|637>>
    <associate|eq 17.2.515|<tuple|17.2|634>>
    <associate|eq 17.3.515|<tuple|17.3|634>>
    <associate|eq 17.4.515.1|<tuple|17.4|636>>
    <associate|eq 17.5.515|<tuple|17.5|636>>
    <associate|eq 17.6.515|<tuple|17.6|636>>
    <associate|eq 17.7.515|<tuple|17.7|?>>
    <associate|equivalence of limits on increasing (decreasing) sequences of
    extented reals|<tuple|16.75|613>>
    <associate|every non empty set in the extented reals has a
    limit|<tuple|16.10|571>>
    <associate|existance of lim inf and lim sup|<tuple|16.63|609>>
    <associate|exp(z)|<tuple|17.16|638>>
    <associate|extented reals|<tuple|16.2|569>>
    <associate|finite infinite sum means finite terms|<tuple|16.107|626>>
    <associate|finite sum of constants in the extented
    reals|<tuple|16.102|625>>
    <associate|finite sum of denumerable sums|<tuple|16.112|627>>
    <associate|finite sum of extented reals|<tuple|16.89|621>>
    <associate|finite sum of extented reals properties|<tuple|16.101|624>>
    <associate|finite sum of extented reals starting at n|<tuple|16.90|621>>
    <associate|finite sum of extented reals written as infinite
    sum|<tuple|16.108|626>>
    <associate|finite sum of limits of functions|<tuple|16.98|623>>
    <associate|finite sum of limits of scalar product with
    functions|<tuple|16.100|624>>
    <associate|finite sum of non negative extented reals is non
    negative|<tuple|16.91|621>>
    <associate|graph of sum of functions|<tuple|16.96|623>>
    <associate|increasing (decreasing) sequence|<tuple|16.60|608>>
    <associate|increasing (decreasing) sequence converges|<tuple|16.62|?>>
    <associate|independence of limit inf and limit sup of start
    index|<tuple|16.65|610>>
    <associate|inequality of Abel|<tuple|17.11|635>>
    <associate|infinity can not be a right limit|<tuple|16.41|587>>
    <associate|interchange infinite and finite sum|<tuple|16.111|626>>
    <associate|left (right) continuity|<tuple|16.52|595>>
    <associate|left and right limit implies limit|<tuple|16.48|593>>
    <associate|left limit of a function|<tuple|16.42|587>>
    <associate|left, right limit of sum and scalar product|<tuple|16.47|588>>
    <associate|lemma 15.75|<tuple|16.84|620>>
    <associate|lemma 17.2|<tuple|17.13|637>>
    <associate|lim inf -xn|<tuple|16.67|610>>
    <associate|lim inf and lim sup|<tuple|16.64|610>>
    <associate|lim sup xn+x|<tuple|16.66|610>>
    <associate|limit and absolut value|<tuple|16.80|615>>
    <associate|limit and continuity in the extented reals|<tuple|16.51|595>>
    <associate|limit at infinity of ascending (descending)
    functions|<tuple|16.56|604>>
    <associate|limit for f\<less\>=L or L\<less\>=f|<tuple|16.58|607>>
    <associate|limit for f\<less\>=g|<tuple|16.57|605>>
    <associate|limit n|<tuple|16.86|621>>
    <associate|limit of 1/f|<tuple|16.85|620>>
    <associate|limit of a constant function|<tuple|16.45|588>>
    <associate|limit of a function|<tuple|16.44|587>>
    <associate|limit of constant extented real|<tuple|16.72|612>>
    <associate|limit of constants|<tuple|16.78|613>>
    <associate|limit of finite sums in the extented reals|<tuple|16.94|622>>
    <associate|limit of functions and sequences|<tuple|16.77|613>>
    <associate|limit of monotone functions|<tuple|16.55|602>>
    <associate|limit points|<tuple|16.39|587>>
    <associate|limit points and plus or min infinity|<tuple|16.40|587>>
    <associate|limit xi+x|<tuple|16.73|612>>
    <associate|limits at infinity|<tuple|16.50|594>>
    <associate|limxi=x=\<gtr\>\|x-xi\|-\<gtr\>0|<tuple|16.87|621>>
    <associate|notation for limit of increasing/decreasing
    sequences|<tuple|16.76|613>>
    <associate|open sets and addition scalar
    multiplication|<tuple|16.36|585>>
    <associate|power series 0|<tuple|17.3|633>>
    <associate|properties of the limit in the extented
    reals|<tuple|16.81|615>>
    <associate|right limit|<tuple|16.43|587>>
    <associate|series and product with a scalar|<tuple|16.104|625>>
    <associate|series are increasing|<tuple|16.92|622>>
    <associate|series of positive extented reals is
    increasing|<tuple|16.105|625>>
    <associate|sets for basis of topology on the extented
    reals|<tuple|16.32|583>>
    <associate|special cases of limits|<tuple|16.53|595>>
    <associate|sum and order relation in the extented
    reals|<tuple|16.106|625>>
    <associate|sum from -infinity to infinity|<tuple|16.116|631>>
    <associate|sum of extented reals and product|<tuple|16.93|622>>
    <associate|sum of extented reals is indepenent of order the
    reals|<tuple|16.109|626>>
    <associate|sup of set and sum|<tuple|16.26|580>>
    <associate|supremum (infinum) of increasing (decreasing) sequence is
    indpendent of start|<tuple|16.74|612>>
    <associate|supremum, infinum of extented real set|<tuple|16.9|571>>
    <associate|supremum, infinum of real set|<tuple|16.8|571>>
    <associate|the limit inferior is lower then limit
    superior|<tuple|16.68|611>>
    <associate|the positive extented reals form a abelian
    semi-group|<tuple|16.23|579>>
    <associate|the topology on the extented reals is
    Hausdorff|<tuple|16.38|586>>
    <associate|topology on extented reals|<tuple|16.33|583>>
    <associate|uniqueness of limits in extented reals|<tuple|16.46|588>>
    <associate|usefull properties of open sets in the extented reals
    |<tuple|16.54|601>>
    <associate|x+z=y+z=\<gtr\>x=y|<tuple|16.16|574>>
    <associate|x\<less\>=y=\<gtr\>-y\<less\>=-x|<tuple|16.14|573>>
    <associate|x\<less\>=y=\<gtr\>lx\<less\>=ly|<tuple|16.15|573>>
    <associate|x\<less\>=y=\<gtr\>x+z\<less\>=y+z|<tuple|16.17|576>>
  </collection>
</references>
