...
<\body>
  ...
  <\lemma>
    ...
    R^n><math|\<cal-B\><around*|[|\<cal-R\><rsup|n>|]>=\<sigma\><around*|[|\<cal-R\><rsup|n>|]>>
    (where <math|\<cal-B\><around*|[|\<cal-R\><rsup|n>|]>=\<cal-B\><around*|[|\<bbb-R\><rsup|n>,\<cal-T\><rsub|\<bbb-R\><rsup|n>>|]>=\<sigma\><around*|[|\<cal-T\><rsub|\<bbb-R\><rsup|n>>|]>>
  ...
  open intervals in R^n> and <smart-ref|half open intervals and Borel sets in
  R^n> that\ 
  ...
  <\theorem>
    ...
    <math|\<sigma\><around*|[|<around*|{|<around*|[|a,b|[>\|a,b\<in\>\<bbb-R\><rsup|n>
    with a\<leqslant\>b|}>|]>=\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>\<subseteq\>\<cal-L\><rsup|n>>
  ...
  <\lemma>
    ...
    <math|<around*|\<langle\>|X,\<cal-A\>|\<rangle\>>> be a measurable space,
    <math|D,E\<subseteq\>X> and <math|f:D\<rightarrow\>\<bbb-R\>> a Borel
    measurable function then <math|\<forall\>a\<in\>\<bbb-R\>> we have that
  ...
  <\proof>
    ...
    <\enumerate>
      <item>As <math|f> is Borel measurable we have that
  ...
  <\definition>
    ...
    then <math|f> is monotonic if either\ 

    <\enumerate>
      <item><math|\<forall\>x,y\<in\>D> with <math|x\<less\>y> we have
      <math|f<around*|(|x|)>\<less\>f<around*|(|y|)>> (f is non decreasing)

      <item><math|\<forall\>x,y\<in\>D> with <math|x\<less\>y> we have
      <math|f<around*|(|y|)>\<less\>f<around*|(|x|)>> (f is non increasing)
    </enumerate>
  </definition>
  ...
  <\proposition>
    ...
    <\enumerate>
      ...
      <item>If <math|n=1> and <math|f> is monotone (meaning that ) then
      <math|f> is Borel measurable.
    </enumerate>
  </proposition>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <item>If <math|f,g> are Borel measurable functions then
      ...
      <item>If <math|f> is Borel measurable and <math|C\<subseteq\>X> then
      <math|f<rsub|\|C>:D<big|cap>C\<rightarrow\>\<bbb-R\>> is Borel
      measurable
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      Given <math|q\<in\>\<bbb-Q\>> we have as <math|f,g> are Borel
      measurable that <math|<around*|{|f\<less\>q|}>\<in\>\<cal-A\><rsub|\|D>>
      ...
      so that <math|c\<cdot\>f> is a constant function which is by (1) Borel
      measurable. So we should check only the cases where <math|c\<neq\>0>.
      ...
      <\description>
        ...
        (as <math|f> is Borel measurable). Using <smart-ref|measurable
        functions conditions> it follows then that <math|c\<cdot\>f> is Borel
        measurable.
      ...
      Now given <math|q\<in\>\<bbb-Q\>> we have as <math|f,g> are Borel
      measurable that <math|<around*|{|f\<less\>q|}>,<around*|{|q\<less\>f|}>\<in\>\<cal-A\><rsub|\|D>>
      ...
      <\equation*>
        f\<cdot\>g is Borel measurable\ 
      </equation*>

      <item>Using (4) it is enough to prove that
      <math|<frac|1|g>:E<big|cap><around*|{|x\<in\>E\|g<around*|(|x|)>\<neq\>0|}>\<rightarrow\>\<bbb-R\>>
      is Borel measurable. Let now <math|a\<in\>\<bbb-R\>> then we have for
      <math|a> the following cases\ 
  ...
  <\theorem>
    ...
    <math|f<rsub|i>> is Borel measurable then we have\ 
    ...
    <\enumerate>
      ...
      inf|i\<rightarrow\>\<infty\>>f<rsub|i><around*|(|x|)>> is Borel
      measurable.
      ...
      sup|i\<rightarrow\>\<infty\>>f<rsub|i><around*|(|x|)>> is Borel
      measurable.
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <math|f<rsub|n>:D<rsub|n>\<rightarrow\>\<bbb-R\>> is Borel measurable,
    ...
    <\enumerate>
      ...
      <\equation*>
        <below|lim|i\<rightarrow\>\<infty\>>f<rsub|i> is Borel measurable
      </equation*>
      ...
      <\equation*>
        <below|sup|i\<in\>\<bbb-N\>>f<rsub|i> is Borel measurable
      </equation*>

      <item>As <math|\<forall\>i\<in\>\<bbb-N\>> <math|f<rsub|i>> is Borel
      measurable we have by <smart-ref|measurable function operations> (3)
      that <math|-f<rsub|i>> is Borel measurable. So by (2)
      <math|<below|sup|i\<in\>\<bbb-N\>><around*|(|-f<rsub|i>|)>> is Borel
      measurable and using <smart-ref|measurable function operations> (3)
      again we have that <math|<below|-sup|i\<in\>\<bbb-N\>><around*|(|-f<rsub|i>|)>>
      is Borel measurable. Further as\ 
      ...
      <\equation*>
        <below|inf|i\<in\>\<bbb-N\>>f<rsub|i> is Borel measurable
      </equation*>
      ...
      Borel measurable, so that by (2) <math|<below|sup|i\<in\>\<bbb-N\>>f<rsub|i+n-1>>
      is Borel measurable. Finally by (3)
      <math|><math|<below|inf|n\<in\>\<bbb-N\>><around*|(|<below|sup|i\<in\>\<bbb-N\>>f<rsub|i+n-1>|)>>
      is Borel measurable proving that\ 

      <\equation*>
        <below|lim sup|i\<rightarrow\>\<infty\>>f<rsub|i> is Borel measurable
      </equation*>
      ...
      Let <math|n\<in\>\<bbb-N\>> then as <math|\<forall\>i\<in\>\<bbb-N\>>
      <math|i+n-1\<in\>\<bbb-N\>> we have that <math|><math|f<rsub|i+n-1>> is
      Borel measurable, so that by (3) <math|<below|inf|i\<in\>\<bbb-N\>>f<rsub|i+n-1>>
      is Borel measurable. Finally by (2)
      <math|><math|<below|sup|n\<in\>\<bbb-N\>><around*|(|<below|inf|i\<in\>\<bbb-N\>>f<rsub|i+n-1>|)>>
      is Borel measurable proving that\ 

      <\equation*>
        <below|lim inf|i\<rightarrow\>\<infty\>>f<rsub|i> is Borel measurable
      </equation*>
    </enumerate>
  </proof>
  ...
  <\proposition>
    ...
    space, <math|D\<subseteq\>X> and <math|f:D\<rightarrow\>\<bbb-R\>> then
    <math|f> is Borel measurable if and only if
    <math|\<exists\>h:X\<rightarrow\>\<bbb-R\>> Borel measurable such that
    <math|h<rsub|\|D>=f>
  </proposition>

  <\proof>
    \ If <math|h:X\<rightarrow\>\<bbb-R\>> is a Borel measurable function
    such that <math|h<rsub|\|D>=f> then by <smart-ref|measurable function
    operations> (6) <math|h<rsub|\|D>> is Borel measurable hence <math|f> is
    Borel measurable. So we must only prove the opposite implication. Let
    <math|f:D\<rightarrow\>\<bbb-R\>> be a Borel measurable function. Take
    <math|q\<in\>\<bbb-Q\>> then <math|<around*|{|f\<leqslant\>q|}>\<in\>\<cal-A\><rsub|\|D>>
    ...
    Set <math|H=X\\<around*|(|F<big|cup>G|)>> hten using <smart-ref|eq
    ...
    Further as <math|x\<nin\>G> so there exists a <math|n\<in\>\<bbb-N\>>
    such that <math|\<forall\>q\<in\>Q> with <math|q\<leqslant\>-n> we have
    <math|x\<nin\>A<rsub|q>>. So for all <math|q\<in\><around*|{|q\<in\>\<bbb-Q\>\|x\<in\>A<rsub|q>|}>>
    we must have that <math|-n\<leqslant\>q>. To summarize\ 

    <\equation>
      <label|eq 18.181.003>\<forall\>x\<in\>H=X\\<around*|(|F<big|cup>G|)>
      <around*|{|q\<in\>Q\|x\<in\>A<rsub|q>|}>\<neq\>\<emptyset\>\<wedge\>bounded
      below so that inf<around*|(|<around*|{|q\<in\>Q\|x\<in\>A<rsub|q>|}>|)>
      exist
    </equation>
    ...
    <math|f<around*|(|x|)>> we can find using <smart-ref|density theorem for
    the reals> there a <math|q\<in\>\<bbb-Q\>> such that
    <math|f<around*|(|x|)>\<less\>q\<less\>f<around*|(|x+1|)>> hence
    <math|q\<in\><around*|{|f\<leqslant\>q|}>\<subseteq\>A<rsub|q>> so that
    <math|f<around*|(|x|)>\<leqslant\>inf<around*|(|<around*|{|q\<in\>\<bbb-Q\>\|x\<in\>A<rsub|q>|}>|)>=h<around*|(|x|)>>
    proving that
    ...
    <\description>
      ...
      <\equation>
        <label|eq 18.186.003><around*|{|x\<in\>X\|h<around*|(|x|)>\<less\>a|}>\<subseteq\><around*|(|H<big|cap><big|cup><rsub|q\<in\><around*|{|q\<in\>\<bbb-Q\>\|q\<less\>a|}>>A<rsub|q>|)><big|cup><around*|(|F<big|cup>G|)>
      </equation>
      ...
      <\description>
        ...
        then <math|x\<in\>H> and <math|\<exists\>q\<in\>Q with q\<less\>a>
      ...
      Hence in all cases <math|x\<in\><around*|{|x\<in\>X\|h<around*|(|x|)>\<less\>a|}>>
      ...
      which together with <smart-ref|eq 18.185.003> gives\ 
      ...
      then <math|x\<in\>X> and <math|\<exists\>q\<in\>Q> with
    ...
    <\equation>
      <label|eq 18.191.003>h is Borel measurable
    </equation>
...
<\references>
  <\collection>
    ...
    <associate|Borel functions and intersection|<tuple|18.90|?>>
    ...
    <associate|eq 18.139.003|<tuple|18.142|?>>
    <associate|eq 18.14.001|<tuple|18.18|?>>
    <associate|eq 18.140.003|<tuple|18.143|?>>
    <associate|eq 18.141.003|<tuple|18.144|?>>
    <associate|eq 18.142.003|<tuple|18.145|?>>
    <associate|eq 18.143.003|<tuple|18.146|?>>
    <associate|eq 18.144.003|<tuple|18.147|?>>
    <associate|eq 18.145.003|<tuple|18.148|?>>
    <associate|eq 18.149.003|<tuple|18.149|?>>
    <associate|eq 18.15.001|<tuple|18.19|?>>
    <associate|eq 18.150.003|<tuple|18.150|?>>
    <associate|eq 18.151.003|<tuple|18.151|?>>
    <associate|eq 18.152.003|<tuple|18.152|?>>
    <associate|eq 18.153.003|<tuple|18.153|?>>
    <associate|eq 18.154.003|<tuple|18.154|?>>
    <associate|eq 18.155.003|<tuple|18.155|?>>
    <associate|eq 18.156.003|<tuple|18.156|?>>
    <associate|eq 18.157.003|<tuple|18.157|?>>
    <associate|eq 18.158.003|<tuple|18.158|?>>
    <associate|eq 18.159.003|<tuple|18.159|?>>
    <associate|eq 18.16.001|<tuple|18.27|?>>
    <associate|eq 18.160.003|<tuple|18.160|?>>
    <associate|eq 18.161.003|<tuple|18.161|?>>
    <associate|eq 18.162.003|<tuple|18.162|?>>
    <associate|eq 18.163.003|<tuple|18.163|?>>
    <associate|eq 18.164.003|<tuple|18.164|?>>
    <associate|eq 18.165.003|<tuple|18.165|?>>
    <associate|eq 18.166.003|<tuple|18.166|?>>
    <associate|eq 18.167.003|<tuple|18.167|?>>
    <associate|eq 18.168.003|<tuple|18.168|?>>
    <associate|eq 18.169.003|<tuple|18.169|?>>
    <associate|eq 18.17.001|<tuple|18.28|?>>
    <associate|eq 18.17.002|<tuple|18.20|?>>
    <associate|eq 18.170.003|<tuple|18.170|?>>
    <associate|eq 18.171.003|<tuple|18.171|?>>
    <associate|eq 18.172.003|<tuple|18.172|?>>
    <associate|eq 18.173.003|<tuple|18.173|?>>
    <associate|eq 18.174.003|<tuple|18.174|?>>
    <associate|eq 18.175.003|<tuple|18.175|?>>
    <associate|eq 18.176.003|<tuple|18.176|?>>
    <associate|eq 18.177.003|<tuple|18.177|?>>
    <associate|eq 18.178.003|<tuple|18.178|?>>
    <associate|eq 18.179.003|<tuple|18.179|?>>
    <associate|eq 18.18.001|<tuple|18.29|?>>
    <associate|eq 18.18.002|<tuple|18.21|?>>
    <associate|eq 18.180.003|<tuple|18.180|?>>
    <associate|eq 18.181.003|<tuple|18.181|?>>
    <associate|eq 18.182.003|<tuple|18.182|?>>
    <associate|eq 18.183.003|<tuple|18.183|?>>
    <associate|eq 18.184.003|<tuple|18.184|?>>
    <associate|eq 18.185.003|<tuple|18.185|?>>
    <associate|eq 18.186.003|<tuple|18.186|?>>
    <associate|eq 18.187.003|<tuple|18.188|?>>
    <associate|eq 18.187.003.1|<tuple|18.187|?>>
    <associate|eq 18.188.003|<tuple|18.189|?>>
    <associate|eq 18.189.003|<tuple|18.190|?>>
    <associate|eq 18.19.001|<tuple|18.30|?>>
    <associate|eq 18.19.002|<tuple|18.22|?>>
    <associate|eq 18.191.003|<tuple|18.191|?>>
    ...
    sets|<tuple|18.79|?>>
    <associate|half open intervals and Borel sets in R^n|<tuple|18.80|?>>
    ...
    <associate|measurable function operations|<tuple|18.93|?>>
    <associate|measurable functions|<tuple|18.82|?>>
    <associate|measurable functions and continuity|<tuple|18.86|?>>
    <associate|measurable functions and generators|<tuple|18.85|?>>
    <associate|measurable functions and limits|<tuple|18.94|?>>
    <associate|measurable functions conditions|<tuple|18.89|?>>
    <associate|measurable maps composition|<tuple|18.87|?>>
