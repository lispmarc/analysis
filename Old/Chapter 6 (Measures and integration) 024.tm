...
<\body>
  ...
  <\proof>
    ...
    this by induction on <math|n> so let <math|\<cal-S\>\<ni\><around*|{|n\<in\>\<bbb-N\><rsub|0>\|\<forall\>R,<around*|{|R<rsub|i>|}><rsub|i\<in\>\<bbb-N\>>\<subseteq\>\<cal-R\><rsup|n><text|
    ...
    <\description>
      ...
      <\equation>
        <label|eq 18.127.021><around*|[|\<alpha\><rsub|1>,\<beta\><rsub|1>|[>\<subseteq\><big|cup><rsub|k\<in\>\<bbb-N\>><around*|[|\<alpha\><rsub|k,1>,\<beta\><rsub|k,1>|[>
      </equation>
      ...
      <\equation>
        <label|eq 18.128.021>\<beta\><rsub|1>-\<alpha\><rsub|1>=l<around*|(|<around*|[|a<rsub|1>,\<beta\><rsub|1>|[>|)>\<leqslant\><big|sum><rsub|k=1><rsup|\<infty\>>l<around*|(|<around*|[|\<alpha\><rsub|k,1>,\<beta\><rsub|k,1>|[>|)>=<big|sum><rsub|k=1><rsup|\<infty\>><around*|(|\<beta\><rsub|k,1>-\<alpha\><rsub|k,1>|)>
      </equation>
      ...
      <\eqnarray*>
        ...
        18.128.021>>>>|<cell|<big|sum><rsub|k=1><rsup|\<infty\>><around*|(|\<beta\><rsub|k,1>-\<alpha\><rsub|k,1>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|k=1><rsup|\<infty\>><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,1|}>><around*|(|\<beta\><rsub|k,i>-\<alpha\><rsub|k,i>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|k=1><rsup|\<infty\>>v<rsup|1><around*|(|R<rsub|i>|)>>>>>
      </eqnarray*>
      ...
      <math|a<rsup|i>\<leqslant\>b<rsup|i>>. Define now\ 

      <\equation>
        <label|eq 18.129.021>V=<big|prod><rsub|i=1><rsup|n><around*|(|b<rsub|i>-a<rsub|i>|)>\<geqslant\>0
      </equation>

      Then

      <\eqnarray*>
        <tformat|<table|<row|<cell|v<rsup|n+1><around*|(|R|)>>|<cell|=>|<cell|v<rsup|n+1><around*|(|<around*|[|a,b|[>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|prod><rsub|i=1><rsup|n+1><around*|(|b<rsub|i>-a<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<big|prod><rsub|i=1><rsup|n><around*|(|b<rsub|i>-a<rsub|i>|)>|)>\<cdot\><around*|(|b<rsub|n+1>-a<rsub|n+1>|)>>>|<row|<cell|>|<cell|=>|<cell|V\<cdot\><around*|(|b<rsub|n+1>-a<rsub|n+1>|)><eq-number><label|eq
        18.130.021>>>>>
      </eqnarray*>

      Take <math|\<varepsilon\>\<gtr\>0>. Given <math|r\<in\>\<bbb-R\>>
      define <math|H<rsub|r>=<around*|{|x\<in\>\<bbb-R\><rsup|n+1>\|x<rsub|n+1>\<less\>r|}>>
      then given <math|i\<in\>\<bbb-N\>> we have for
      <math|R<rsub|i><big|cap>H<rsub|r>> either\ 

      <\description>
        <item*|<math|R<rsub|i><big|cap>H<rsub|r>=\<emptyset\>>>then let
        <math|0=<around*|(|<wide*|0,\<ldots\>,0|\<wide-underbrace\>><rsub|n+1>|)>\<in\>\<bbb-R\><rsup|+1>>
        we have <math|R<rsub|i><big|cap>H<rsub|r>=\<emptyset\>=<around*|[|0,0|[>\<in\>\<cal-R\><rsup|n+1>>

        <item*|<math|R<rsub|i><big|cap>H<rsub|r>\<neq\>\<emptyset\>>>then we
        have if we take <math|b<rsup|i,r>\<in\>\<bbb-R\><rsup|n+1>> defined
        by <math|<around*|(|b<rsup|i,r>|)><rsub|j>=<choice|<tformat|<table|<row|<cell|<around*|(|b<rsup|i>|)><rsub|j>
        j\<in\><around*|{|1,\<ldots\>,n|}>>>|<row|<cell|min<around*|(|<around*|(|b<rsup|i>|)><rsub|n+1>,r|)>>>>>>>

        <\eqnarray*>
          <tformat|<table|<row|<cell|x\<in\>R<rsub|i><big|cap>H<rsub|r>>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>j\<in\><around*|{|1,\<ldots\>,n+1|}><text|
          we have >x<rsub|j>\<in\><around*|[|<around*|(|a<rsup|i>|)><rsub|j>,<around*|(|b<rsup|i>|)><rsub|j>|[>\<wedge\>x<rsub|n+1>\<less\>r>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>j\<in\><around*|{|1,\<ldots\>,n+1|}><text|
          we have ><around*|(|a<rsup|i>|)><rsub|j>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rsup|i>|)><rsub|j>\<wedge\>x<rsub|n+1>\<less\>r>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>j\<in\><around*|{|1,\<ldots\>,n+1|}><text|
          we have ><around*|(|a<rsup|i>|)><rsub|j>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rsup|i,r>|)><rsub|j>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|[|a<rsup|i>,b<rsup|i,r>|[>>>>>
        </eqnarray*>

        proving that <math|R<rsub|i><big|cap>H<rsub|r>=<around*|[|a<rsup|i>,b<rsup|i,r>|[>\<in\>\<cal-R\><rsup|n+1>>
      </description>

      So in all cases we have that <math|R<rsub|i><big|cap>H<rsub|r>\<in\>\<cal-R\><rsup|n+1>>
      proving that <math|v<rsup|n+1><around*|(|R<rsub|i><big|cap>H<rsub|r>|)>>
      is well defined for all <math|i\<in\>\<bbb-N\>>. Hence the following
      set is well defined\ 

      <\equation>
        <label|eq 18.131.021>A<rsub|\<varepsilon\>,r>=<around*|{|x\<in\><around*|[|a<rsub|n+1>,b<rsub|n+1>\||[>V\<cdot\><around*|(|x-a<rsub|n+1>|)>\<leqslant\><around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|j=1><rsup|\<infty\>>v<rsup|n+1><around*|(|R<rsub|j><big|cap>H<rsub|r>|)>|}>\<subseteq\><around*|[|a<rsub|n+1>,b<rsub|n+1>|[>
      </equation>

      \;

      Now as <math|V\<cdot\><around*|(|a<rsub|n+1>-a<rsub|n+1>|)>=0\<leqslant\><around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|j=1><rsup|\<infty\>>v<rsup|n+1><around*|(|R<rsub|j><big|cap>H<rsub|r>|)>>
      we have that

      <\equation>
        <label|eq 18.132.021>a<rsub|n+1>\<in\>A<rsub|\<varepsilon\>,r>\<Rightarrow\>A<rsub|\<varepsilon\>,r>\<neq\>\<emptyset\>
      </equation>

      So as <math|A<rsub|\<varepsilon\>,r>\<neq\>\<emptyset\>> and
      <math|A<rsub|\<varepsilon\>,r>\<subseteq\><around*|[|a<rsub|n+1>,b<rsub|n+1>|]>>
      so that <math|A<rsub|\<varepsilon\>,r>> is upper bounded by
      <math|b<rsub|n+1>> it follows using the conditional completenes of the
      real numbers [see <reference|the reals are conditional complete>] that\ 

      <\equation>
        <label|eq 18.133.021>\<gamma\>=sup<around*|(|A<rsub|\<varepsilon\>,r>|)><text|
        exists and >a<rsub|n+1>\<leqslant\>\<gamma\>\<less\>b<rsub|n+1>
      </equation>

      Now we have\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|V\<cdot\><around*|(|\<gamma\>-a<rsub|n+1>|)>>|<cell|=>|<cell|V\<cdot\><around*|(|sup<around*|(|A<rsub|\<varepsilon\>,r>|)>-a<rsub|n+1>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<smart-ref|sup
        of set and sum>>>>|<cell|V\<cdot\>sup<around*|(|<around*|{|x-a<rsub|n+1>\|x\<in\>A<rsub|\<varepsilon\>,r>|}>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<smart-ref|sup
        of set and sum>><infix-and>0\<leqslant\>V>>|<cell|sup<around*|(|<around*|{|V\<cdot\><around*|(|x-a<rsub|n+1>|)>\|x\<in\>A<rsub|\<varepsilon\>,r>|}>|)>>>|<row|<cell|>|<cell|\<leqslant\><rsub|def
        of A<rsub|\<varepsilon\>,r>>>|<cell|<around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|j=1><rsup|\<infty\>>v<rsup|n+1><around*|(|R<rsub|j><big|cap>H<rsub|r>|)>>>>>
      </eqnarray*>

      which proves together with <reference|eq 18.133.021> and the
      definitionof <math|A<rsub|\<varepsilon\>,r>> that

      <\equation>
        <label|eq 18.134.021>\<gamma\>\<in\>A<rsub|\<varepsilon\>,r><rsub|>
      </equation>

      Assume now that <math|\<gamma\>\<less\>b<rsub|n+1>>. then

      <\equation>
        <label|eq 18.135.021>\<gamma\>\<in\><around*|[|a<rsub|n+1>,b<rsub|n+1>|[>
      </equation>

      Set\ 

      <\equation>
        <label|eq 18.136.021>J=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R|}><text|
        and >\<forall\>j\<in\>\<bbb-N\> J<rsub|j>=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<lambda\>|)>\<in\>R<rsub|j>|}>
      </equation>

      Take <math|a<rprime|'>=<around*|(|a<rsub|1>,\<ldots\>,a<rsub|n>|)>,b<rprime|'>=<around*|(|b<rsub|1>,\<ldots\>,b<rsub|n>|)>\<in\>\<bbb-R\><rsup|n>>
      ...
      so <math|a<rprime|'>\<leqslant\>b<rprime|'>>. Further

      <\eqnarray*>
        <tformat|<table|<row|<cell|x\<in\><around*|[|a<rprime|'>,b<rprime|'>|[>>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>\<wedge\>a<rsub|i>=<around*|(|a<rprime|'>|)><rsub|i>\<leqslant\>x<rsub|i>\<less\><around*|(|b<rprime|'>|)><rsub|i>=b<rsub|i>>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|<text|<reference|eq
        18.134.021>>>>|<cell|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>\<wedge\>a<rsub|i>\<leqslant\>x<rsub|i>\<less\>b<rsub|i>\<wedge\>a<rsub|n+1>\<leqslant\>\<gamma\>\<less\>b<rsub|n+1>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|X\<in\>J>>>>
      </eqnarray*>

      proving that\ 

      <\equation>
        <label|eq 18.137.021>J=<around*|[|a<rprime|'>,b<rprime|'>|[>\<in\>\<cal-R\><rsup|n>
      </equation>

      Further given <math|j\<in\>\<bbb-N\>> we have either\ 

      <\description>
        <item*|<math|\<gamma\>\<in\><around*|[|<around*|(|a<rsup|j>|)><rsub|n+1><around*|(|b<rsup|j>|)><rsub|n+1>|[>>>Take
        <math|a<rprime|'><rsup|j>=<around*|(|<around*|(|a<rsup|j>|)><rsub|1>,\<ldots\>,<around*|(|a<rsup|j>|)><rsub|n>|)>,b<rprime|'><rsup|j>=<around*|(|<around*|(|b<rsup|j>|)><rsub|1>,\<ldots\>,<around*|(|b<rsup|j>|)><rsub|n>|)>\<in\>\<bbb-R\><rsup|n>>
        then <math|we have that \ \<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>>
        <math|<around*|(|a<rprime|'><rsup|j>|)><rsub|i>=<around*|(|a<rsup|j>|)><rsub|i>\<leqslant\><around*|(|b<rsup|j>|)><rsub|i>=<around*|(|b<rprime|'><rsup|j>|)><rsub|i>>
        so that <math|a<rprime|'><rsup|j>\<leqslant\>b<rprime|'><rsup|j>>.
        Further\ 

        <\eqnarray*>
          <tformat|<table|<row|<cell|x\<in\>J<rsub|j>>|<cell|\<Leftrightarrow\>>|<cell|<around*|(|x<rsub|1>,\<ldots\>x<rsub|n>,\<gamma\>|)>\<in\>R<rsub|j>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>
          <around*|(|a<rsup|j>|)><rsub|i>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rsup|j>|)><rsub|i><text|
          and ><around*|(|a<rsup|j>|)><rsub|n+1>\<leqslant\>\<gamma\>\<less\><around*|(|b<rsup|j>|)><rsub|n+1>>>|<row|<cell|>|<cell|\<Leftrightarrowlim\><rsub|\<gamma\>\<in\><around*|[|<around*|(|a<rsup|j>|)><rsub|i><around*|(|b<rsup|j>|)><rsub|i>|[>>>|<cell|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}><text|
          ><around*|(|a<rsup|j>|)><rsub|i>\<leqslant\>x<rsub|j>\<less\><around*|(|b<rsup|j>|)><rsub|i>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|x\<in\><around*|[|a<rprime|'><rsup|j>,b<rprime|'><rsup|j>|[>>>>>
        </eqnarray*>

        proving that <math|J<rsub|i>=<around*|[|a<rprime|'><rsup|j>,b<rprime|'><rsup|j>|[>\<in\>\<cal-R\><rsup|n>>

        <item*|<math|\<gamma\>\<nin\><around*|[|<around*|(|a<rsup|j>|)><rsub|n+1><around*|(|b<rsup|j>|)><rsub|n+1>|[>>>then
        <math|J<rsub|j>=\<emptyset\>\<in\>\<cal-R\><rsup|n>>
      </description>

      so we have\ 

      <\equation>
        <label|eq 18.138.021>J<rsub|j>\<in\>\<cal-R\><rsup|n><text| and
        either >J<rsub|j>=<around*|[|a<rprime|'><rsup|j>,b<rprime|'><rsup|j>|[>\<Rightarrow\>v<rsup|n><around*|(|J<rsub|i>|)>=<big|prod><rsub|i=1><rsup|n><around*|(|<around*|(|b<rsup|j>|)><rsub|i>-<around*|(|a<rsup|j>|)><rsub|i>|)><text|
        or >J<rsub|j>=\<emptyset\>\<Rightarrow\>v<rsup|n><around*|(|J<rsub|j>|)>=0
      </equation>

      Now if <math|x\<in\>J> then <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>R<rsub|i>>
      so that <math|\<exists\>i\<in\>\<bbb-N\>> such that
      <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R<rsub|i>>
      hence <math|x\<in\>J<rsub|i>> proving\ 

      <\equation>
        <label|eq 18.139.021>J\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\>>J<rsub|i>
      </equation>

      As <math|n\<in\>\<cal-S\>> we have using <reference|eq 18.137.021>,
      <reference|eq 18.138.021> and <reference|eq 18.139.021> it follows that
      <math|v<rsup|n><around*|(|J|)>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|J<rsub|i>|)>>.
      Further <math|v<rsup|n><around*|(|J|)>\<equallim\><rsub|<text|<reference|eq
      18.137.021>>><big|prod><rsub|i=1><rsup|n><around*|(|<around*|(|b<rprime|'>|)><rsub|i>-<around*|(|a<rprime|'>|)><rsub|i>|)>\<equallim\><rsub|def
      a<rprime|'>,b<rprime|'>><big|prod><rsub|i=1><rsup|n><around*|(|b<rsub|i>-a<rsub|i>|)>\<equallim\><rsub|<text|<reference|eq
      18.129.021>>>V> so that

      <\equation>
        <label|eq 18.140.021>V=v<rsup|n><around*|(|J|)>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n>J<rsub|i>
      </equation>

      As <math|\<emptyset\>\<neq\>R=<big|prod><rsub|i=1><rsup|n+1><around*|[|a<rsub|i>,b<rsub|i>|[>>
      it follows [see <reference|conventions for product of sets>] \ that
      <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n+1|}>>
      <math|<around*|[|a<rsub|i>,b<rsub|i>|[>\<neq\>\<emptyset\>> hence
      <math|a<rsub|i>\<less\>b<rsub|i>> which proves that
      <math|V=<big|prod><rsub|i=1><rsup|n><around*|(|b<rsub|i>-a<rsub|i>|)>\<gtr\>0>.
      As we have taken <math|\<varepsilon\>\<gtr\>0\<Rightarrow\>1+\<varepsilon\>\<gtr\>1>
      so that <math|<frac|V|1+\<varepsilon\>>\<less\>V\<leqslant\><big|sum><rsup|\<infty\>><rsub|i=1>v<rsup|n><around*|(|J<rsub|i>|)>\<equallim\><rsub|<text|<smart-ref|series
      of positive extented reals is increasing>>>sup<around*|(|<around*|{|<big|sum><rsub|i=1><rsup|m>v<rsup|n><around*|(|J<rsub|i>|)>\|m\<in\>\<bbb-N\>|}>|)>>.
      Using the definition of a supremum it follows that
      <math|\<exists\>m\<in\>\<bbb-N\>> such that
      <math|<frac|V|1+\<varepsilon\>>\<less\><big|sum><rsub|i=1><rsup|m>v<rsup|n><around*|(|J<rsub|i>|)>\<leqslant\><big|sum><rsub|i=1><rsup|\<infty\>>v<rsup|n><around*|(|J<rsub|i>|)>>.
      So\ 

      <\equation>
        <label|eq 18.141.021>V\<less\><around*|(|1+\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|m>v<rsup|n><around*|(|J<rsub|i>|)>
      </equation>

      Next define\ 

      <\equation>
        <label|eq 18.142.021>\<chi\>=min<around*|(|<around*|{|b<rsub|n+1>|}><big|cup><around*|{|<around*|(|b<rsup|j>|)><rsub|n+1>\|j\<in\><around*|{|j\<in\><around*|{|1,\<ldots\>,m|}>\|J<rsub|j>\<neq\>\<emptyset\>|}>|}>|)>
      </equation>

      Now if <math|J<rsub|j>\<neq\>\<emptyset\>> then
      <math|\<exists\>x\<in\>\<bbb-R\><rsup|n>> such that
      <math|<around*|(|x<rsub|1>,\<ldots\>,x<rsub|n>,\<gamma\>|)>\<in\>R<rsub|j>=\<gamma\>\<in\><around*|[|<around*|(|a<rsup|j>|)><rsub|n+1>,<around*|(|b<rsup|j>|)><rsub|n+1>|[>>
      hence <math|\<gamma\>\<less\><around*|(|b<rsup|j>|)><rsub|n+1>> and as
      we assumed that <math|\<gamma\>\<less\>b<rsub|n+1>> we have that\ 

      <\equation>
        <label|eq 18.143.021>a<rsub|n+1>\<leqslant\><rsub|<text|<reference|eq
        18.135.021>>>\<gamma\>\<less\>\<chi\>\<leqslant\>b<rsub|n+1>
      </equation>

      For <math|j\<in\><around*|{|1,\<ldots\>,m|}>> we have we have either

      <\description>
        <item*|<math|J<rsub|j>=\<emptyset\>>>then\ 

        <\eqnarray*>
          <tformat|<table|<row|<cell|v<rsup|n+1><around*|(|R<rsub|j><big|cap>H<rsub|\<gamma\>>|)>+<around*|(|\<chi\>-\<gamma\>|)>\<cdot\>v<rsup|n><around*|(|J<rsub|j>|)>>|<cell|=>|<cell|v<rsup|n+1><around*|(|R<rsub|j><big|cap>H<rsub|\<gamma\>>|)>+0>>>>
        </eqnarray*>

        TODO

        <item*|<math|J<rsub|j>\<neq\>\<emptyset\>>>
      </description>
    </description>
...
<\references>
  <\collection>
    ...
    <associate|Borel algebra on R^n (1)|<tuple|18.39|?>>
    <associate|Borel algebra on R^n (2)|<tuple|18.44|?>>
    <associate|Borel algebra on R^n equivalences|<tuple|18.45|?>>
    <associate|Borel algebras on R|<tuple|18.23|?>>
    <associate|Caratheodore|<tuple|18.58|?>>
    <associate|Dyadic cube properties|<tuple|18.35|?>>
    <associate|Dyadic cubes|<tuple|18.32|?>>
    <associate|Dyadic interval basic property|<tuple|18.34|?>>
    <associate|Lebesgue measure space|<tuple|18.64|?>>
    <associate|Lower half spaces|<tuple|18.42|?>>
    <associate|R can be covered by open intervals|<tuple|18.61|?>>
    ...
    <associate|countable additivity implies additivity|<tuple|18.48|?>>
    ...
    <associate|eq 18.127.021|<tuple|18.127|?>>
    <associate|eq 18.128.021|<tuple|18.128|?>>
    <associate|eq 18.129.021|<tuple|18.129|?>>
    <associate|eq 18.13.021|<tuple|18.13|?>>
    <associate|eq 18.130.021|<tuple|18.130|?>>
    <associate|eq 18.131.021|<tuple|18.131|?>>
    <associate|eq 18.132.021|<tuple|18.132|?>>
    <associate|eq 18.133.021|<tuple|18.133|?>>
    <associate|eq 18.134.021|<tuple|18.134|?>>
    <associate|eq 18.135.021|<tuple|18.135|?>>
    <associate|eq 18.136.021|<tuple|18.136|?>>
    <associate|eq 18.137.021|<tuple|18.137|?>>
    <associate|eq 18.138.021|<tuple|18.138|?>>
    <associate|eq 18.139.021|<tuple|18.139|?>>
    <associate|eq 18.14.021|<tuple|18.14|?>>
    <associate|eq 18.140.021|<tuple|18.140|?>>
    <associate|eq 18.141.021|<tuple|18.141|?>>
    <associate|eq 18.142.021|<tuple|18.142|?>>
    <associate|eq 18.143.021|<tuple|18.143|?>>
    ...
    <associate|length of interval is increasing|<tuple|18.30|?>>
    <associate|lower half open spaces|<tuple|18.40|?>>
    <associate|lower half open spaces are open|<tuple|18.41|?>>
    <associate|measurable set alternative definition|<tuple|18.57|?>>
    <associate|measurable space|<tuple|18.10|?>>
    <associate|measure|<tuple|18.47|?>>
    <associate|measure is subadditive|<tuple|18.50|?>>
    <associate|measure properties (1)|<tuple|18.49|?>>
    <associate|measure properties (2)|<tuple|18.51|?>>
    <associate|measureable set|<tuple|18.56|?>>
    <associate|open,half open and bounded intervals are
    different|<tuple|18.21|?>>
    <associate|outer measure|<tuple|18.53|?>>
    <associate|outer measure finite subadditivity|<tuple|18.54|?>>
    <associate|outer measure on R|<tuple|18.63|?>>
    <associate|outermeasure construction|<tuple|18.55|?>>
    <associate|properties of algebras|<tuple|18.7|?>>
    <associate|rectangle and half open sets|<tuple|18.43|?>>
    <associate|semi additivity of the length in the reals|<tuple|18.62|?>>
