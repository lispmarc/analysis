...
<\body>
  ...
  <\definition>
    ...
    <\enumerate>
      <item><math|<around*|[|a,b|]>=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|a\<leqslant\>x<rsub|i>\<leqslant\>b|}>>

      <item><math|<around*|[|a,b|[>=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|a\<leqslant\>x<rsub|i>\<less\>b|}>>

      <item><math|<around*|]|a,b|]>=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|a\<less\>x<rsub|i>\<leqslant\>b|}>>

      <item><math|<around*|]|a,b|[>=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|a\<less\>x<rsub|i>\<less\>b|}>>

      <item><math|<around*|]|-\<infty\>,a|]>=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|x<rsub|i>\<leqslant\>a|}>>

      <item><math|<around*|]|-\<infty\>,a|[>=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|x<rsub|i>\<less\>a|}>>

      <item><math|<around*|[|a,\<infty\>|[>=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|a\<leqslant\>x<rsub|i>|}>>

      <item><math|<around*|]|a,\<infty\>|[>=<around*|{|x\<in\>\<bbb-R\><rsup|n>\|a\<less\>x<rsub|i>|}>>
    </enumerate>
  </definition>

  <\lemma>
    <label|R^n is a unin of rectangles>Let <math|n\<in\>\<bbb-N\><rsub|0>>
    then <math|\<bbb-R\><rsup|n>=<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|]|<around*|(|-i|)>,<around*|(|i|)>|[>=<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|]|-i,i|[>>
  </lemma>

  <\proof>
    First as <math|\<forall\>i\<in\>\<bbb-N\><rsub|0>>
    <math|<around*|]|<around*|(|-i|)>,<around*|(|i|)>|[>\<subseteq\><around*|]|<around*|(|-i|)>,<around*|(|i|)>|]>\<subseteq\>\<bbb-R\><rsup|n>>
    we have trivially that

    <\equation*>
      <big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|]|<around*|(|-i|)>,<around*|(|i|)>|[>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|[|<around*|(|-i|)>,<around*|(|i|)>|[>\<subseteq\>\<bbb-R\><rsup|n>.
    </equation*>
    ...
    <\equation*>
      \<bbb-R\><rsup|n>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|[|<around*|(|-i|)>,<around*|(|i|)>|[>\<subseteq\><big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|]|<around*|(|-i|)>,<around*|(|i|)>|[>
    </equation*>
  </proof>
  ...
  <\proposition>
    Let <math|n\<in\>\<bbb-N\><rsub|0>> then if <math|\<mu\>> is a measure on
  ...
  <\proof>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|A>|<cell|=>|<cell|A<big|cap>\<bbb-R\><rsup|n>>>|<row|<cell|>|<cell|\<equallim\>>|<cell|A<big|cap><around*|(|<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|]|<around*|(|-i|)>,<around*|(|i|)>|[>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>><around*|(|A<big|cap><around*|]|<around*|(|-i|)>,<around*|(|i|)>|[>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|cup><rsub|i\<in\>\<bbb-N\><rsub|0>>A<rsub|i>
      were A<rsub|i>=A<big|cap><around*|]|<around*|(|-i|)>,<around*|(|i|)>|[>\<in\>\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>\<wedge\>A<rsub|i>\<subseteq\><around*|]|<around*|(|-i|)>,<around*|(|i|)>|[>>>>>
    </eqnarray*>
    ...
    with <math|B<rsub|i>\<subseteq\>A<rsub|i>\<subseteq\><around*|]|<around*|(|-i|)>,<around*|(|i|)>|[>>.
    Hence we have that\ 
  ...
  intervals and <math|<around*|[|<around*|(|0|)>,<around*|(|1|)>|[>> as a
  disjoint union of Dyadic cubes.
  ...
  <\proof>
    First if <math|m\<in\>\<bbb-N\>> and <math|z\<in\>\<bbb-Z\>> we have as
    <math|<around*|[|<frac|z|2<rsup|m>>,<frac|z+1|2<rsub|m>>|[>=<around*|[|<frac|z|2<rsup|m>>+0,<frac|z|2<rsup|m>>+<around*|(|<frac|1|m>|)>|[>\<equallim\><rsub|<text|<reference|translation
    properties>>><around*|[|<around*|(|0|)>,<around*|(|<frac|1|m>|)>|[>+<frac|z|2<rsup|m>>>.
    Hence\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|\<mu\><around*|(|<around*|[|<frac|z|2<rsup|m>>,<frac|z+1|2<rsup|m>>|[>|)>>|<cell|=>|<cell|\<mu\><around*|(|<around*|[|<around*|(|0|)>,<around*|(|<frac|1|m>|)>|[>+<around*|(|<frac|1|2<rsup|m>>|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<around*|(|3|)>,<around*|[|<frac|z|2<rsup|m>>,<frac|z+1|2<rsup|m>>|[>\<in\>\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>>>|<cell|\<mu\><around*|(|<around*|[|<around*|(|0|)>,<around*|(|<frac|1|m>|)>|[>|)><eq-number><label|eq
      18.197.028>>>|<row|<cell|>|<cell|\<leqslant\><rsub|<around*|(|<frac|1|2<rsup|m>>|)>\<less\><around*|(|1|)>>>|<cell|\<mu\><around*|(|<around*|[|<around*|(|0|)>,<around*|(|1|)>|[>|)><eq-number><label|eq
      18.198.028>>>>>
    </eqnarray*>
    ...
    <math|D<rsub|i>=<around*|[|<frac|z|2<rsup|m>>,<frac|z+1|2<rsup|m>>|[>=<around*|[|<frac|z|2<rsup|m>>,<frac|z+1|2<rsup|m>>+<frac|1|m>|[>\<equallim\><rsub|<text|<reference|translation
    properties>>><around*|[|0,<frac|1|2<rsup|m>>|[>+<frac|z|2<rsup|m>>> so
    that <math|\<mu\><around*|(|D<rsub|i>|)>=\<mu\><around*|(|<around*|[|0,<frac|1|2<rsup|m>>|[>+<frac|z|2<rsup|m>>|)>\<leqslant\><rsub|<text|<reference|eq
    18.198.028>>>\<mu\><around*|(|<around*|[|0,1|[>|)>>. Hence if
    <math|\<mu\><around*|(|<around*|[|0,1|[>|)>=0> we have that
    ...
    Further if <math|<around*|{|A<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>\<subseteq\>\<cal-B\><around*|[|\<bbb-R\><rsup|n>|]>>
    ...
    <\equation>
      \<nu\><text| is a measure >
    </equation>

    \;
  </proof>

  TODO <reference|Dyadic cube properties>
...
<\references>
  <\collection>
    ...
    <associate|Borel algebra on R^n (1)|<tuple|18.41|?>>
    <associate|Borel algebra on R^n (2)|<tuple|18.46|?>>
    <associate|Borel algebra on R^n equivalences|<tuple|18.47|?>>
    ...
    <associate|Caratheodore|<tuple|18.63|?>>
    <associate|Dyadic cube properties|<tuple|18.37|?>>
    <associate|Dyadic cubes|<tuple|18.35|?>>
    <associate|Dyadic interval basic property|<tuple|18.34|?>>
    <associate|Dyadic interval properties|<tuple|18.90|?>>
    <associate|Dyadic intervals|<tuple|18.33|?>>
    ...
    <associate|Lebesgue measure space|<tuple|18.69|?>>
    <associate|Lebesgue measure space on R^n|<tuple|18.76|?>>
    <associate|Lebesgue measure spaces are complete|<tuple|18.97|?>>
    <associate|Lower half spaces|<tuple|18.44|?>>
    <associate|R can be covered by open intervals|<tuple|18.66|?>>
    ...
    <associate|almost complete|<tuple|18.94|?>>
    ...
    <associate|complete measures|<tuple|18.95|?>>
    <associate|completion lemma|<tuple|18.98|?>>
    <associate|countable additivity implies additivity|<tuple|18.51|?>>
    ...
    <associate|eq 18.197.028|<tuple|18.197|?>>
    <associate|eq 18.198.028|<tuple|18.198|?>>
    ...
    <associate|lower half open spaces|<tuple|18.42|?>>
    <associate|lower half open spaces are open|<tuple|18.43|?>>
    <associate|measurable set alternative definition|<tuple|18.61|?>>
    <associate|measurable sets and null sets|<tuple|18.62|?>>
    <associate|measurable space|<tuple|18.10|?>>
    <associate|measure|<tuple|18.49|?>>
    <associate|measure is subadditive|<tuple|18.54|?>>
    <associate|measure properties (1)|<tuple|18.52|?>>
    <associate|measure properties (2)|<tuple|18.55|?>>
    <associate|measureable set|<tuple|18.60|?>>
    <associate|negligibility|<tuple|18.92|?>>
    <associate|negligible set properties|<tuple|18.93|?>>
    <associate|open,half open and bounded intervals are
    different|<tuple|18.21|?>>
    <associate|outer measure|<tuple|18.57|?>>
    <associate|outer measure definition on rectangles|<tuple|18.74|?>>
    <associate|outer measure finite subadditivity|<tuple|18.58|?>>
    <associate|outer measure is translation invariant|<tuple|18.87|?>>
    <associate|outer measure on R|<tuple|18.68|?>>
    <associate|outer measure on rectangles|<tuple|18.75|?>>
    <associate|outermeasure construction|<tuple|18.59|?>>
    <associate|properties of algebras|<tuple|18.7|?>>
    <associate|rectangle and half open sets|<tuple|18.45|?>>
    <associate|replace countable untion of sets by disjoint union of
    sets|<tuple|18.53|?>>
    <associate|restriction of measure space to a sub sigma
    algebra|<tuple|18.50|?>>
    <associate|semi additivity of the length in the reals|<tuple|18.67|?>>
    ...
    <associate|the set of Dyadic cubes is denumerable|<tuple|18.38|?>>
