...
<\body>
  ...
  <\proposition>
    ...
    <\note>
      If from the context it is clear which measure <math|\<mu\>> is used
      then we us the term conegligible instead of <math|\<mu\>>-conegligible.
    </note>
  ...
  <\definition>
    ...
    <\enumerate>
      <item>Let <math|f:X\<rightarrow\>\<bbb-R\>> a partial fuction,
      ...
      is the partial function defined by <math|<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)><around*|(|x|)>=<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>>
      <math|\<forall\>x\<in\>dom<around*|(|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>|)>=<around*|{|x\<in\><big|cup><rsub|n\<in\>\<bbb-N\>><around*|(|<big|cap><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>dom<around*|(|f<rsub|i>|)>|)>\|\<exists\>k\<in\>\<bbb-N\>
  ...
  <\definition>
    ...
    measurable set then for partial functions
    <math|f,g:X\<rightarrow\>\<bbb-R\>> with
    <math|dom<around*|(|f|)>,dom<around*|(|g|)>\<subseteq\>X> we have\ 

    <\enumerate>
      <item><math|f\<leqslant\><rsub|a.e.>g> iff
      <math|<around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|f<around*|(|x|)>\<leqslant\>g<around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible

      <item><math|f\<less\><rsub|a.e>g> iff
      <math|<around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|f<around*|(|x|)>\<less\>g<around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible

      <item><math|f=<rsub|a.e.>g> iff <math|<around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|f<around*|(|x|)>=g<around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible\ 

      <item>Take <math|a\<in\>\<bbb-R\>> then
      <math|a\<leqslant\><rsub|a.e.>f> iff
      <math|<around*|{|x\<in\>dom<around*|(|f|)>\|a\<leqslant\>f<around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible

      <item>Take <math|a\<in\>\<bbb-R\>> then <math|a\<less\><rsub|a.e.>f>
      iff <math|<around*|{|x\<in\>dom<around*|(|f|)>\|a\<less\>f<around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible

      <item>Take <math|a\<in\>\<bbb-R\>> then
      <math|f\<leqslant\><rsub|a.e.>a> iff
      <math|<around*|{|x\<in\>dom<around*|(|f|)>\|f<around*|(|x|)>\<leqslant\>a|}>>
      is <math|\<mu\>>-conegligible

      <item>Take <math|a\<in\>\<bbb-R\>> then <math|f\<less\><rsub|a.e.>a>
      iff <math|<around*|{|x\<in\>dom<around*|(|f|)>\|f<around*|(|x|)>\<less\>a|}>>
      is <math|\<mu\>>-conegligible

      <item>Take <math|a\<in\>\<bbb-R\>> then <math|f=<rsub|a.e.>a> iff
      <math|<around*|{|x\<in\>dom<around*|(|f|)>\|f<around*|(|x|)>=a|}>> is
      <math|\<mu\>>-conegligible

      <item>Take <math|a\<in\>\<bbb-R\>> then <math|f\<neq\><rsub|a.e.>a> iff
    ...
    <\enumerate>
      ...
      <item><math|g\<leqslant\><rsub|a.e.>f> iff
      <math|<around*|{|x\<in\>dom<around*|(|g|)>\|g<around*|(|x|)>\<leqslant\>f<around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible

      <item><math|g\<less\><rsub|a.e.>f> iff
      <math|<around*|{|x\<in\>dom<around*|(|g|)>\|g<around*|(|x|)>\<less\>f<around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible

      <item><math|f=<rsub|a.e.>g> iff <math|<around*|{|x\<in\>dom<around*|(|g|)>\|f<around*|(|x|)>=g<around*|(|x|)>|}>>
      is <math|\<mu\>>-conegligible\ 
    </enumerate>

    If we have a sequence <math|<around*|{|f<rsub|n>|}><rsub|n\<in\>\<bbb-N\>>>
    of partial functions with <math|\<forall\>n\<in\>\<bbb-N\>>
    <math|dom<around*|(|f<rsub|n>|)>\<subseteq\>X> then we have

    <\enumerate>
      <item><math|<below|lim|n-\<less\>\<infty\>>f<rsub|n>=<rsub|a.e.>f> iff
      <math|<around*|{|x\<in\>dom<around*|(|f|)><big|cap><around*|(|<big|cap><rsub|n\<in\>\<bbb-N\>>dom<around*|(|f<rsub|n>|)>|)><around*|\||<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>=f|(>x|}>>
      is <math|\<mu\>>-conegligible
    </enumerate>

    and if <math|> we have a sequence <math|<around*|{|f<rsub|n>|}><rsub|n\<in\>\<bbb-N\>>>
    of functions between <math|X> and <math|\<bbb-R\>> then we have

    <\enumerate>
      <item><math|<below|lim|n-\<less\>\<infty\>>f<rsub|n>=<rsub|a.e.>f> iff
      <math|<around*|{|x\<in\>dom<around*|(|f|)><around*|\||<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>=f|(>x|}>>
      is <math|\<mu\>>-conegligible
    </enumerate>
  </definition>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <math|\<cal-A\>>-measurable.<space|255em>
  ...
  <\lemma>
    ...
    <\enumerate>
      ...
      [meaning that <math|<around*|{|x\<in\>dom<around*|(|f|)>\|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=f<around*|(|x|)>|}>>
      is conegligible]
    </enumerate>
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 18.223.005>E=<around*|{|x\<in\>dom<around*|(|f|)>\|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=f<around*|(|x|)>|}>
      is conegligible
    </equation>
  ...
  <\definition>
    Let <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a
    measure space then a function <math|f:X\<rightarrow\>\<bbb-R\>> is a
    positive integrable partial function iff\ 
  ...
  <\remark>
    ...
    <math|<around*|(|2.c|)> <around*|{|x\<in\>dom<around*|(|f|)>\|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=f<around*|(|x|)>|}>>
    is assumed to be conegligible and <math|<around*|{|x\<in\>dom<around*|(|f|)>\|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=f<around*|(|x|)>|}>\<subseteq\>dom<around*|(|f|)>>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      Now if <math|g\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>> such that
      <math|g\<leqslant\><rsub|a.e.>h> then
      <math|<around*|{|x\<in\>dom<around*|(|g|)><big|cap>dom<around*|(|h|)>\|g<around*|(|x|)>\<leqslant\>h<around*|(|x|)>|}>>
      is conegligible, as <math|<around*|{|x\<in\>dom<around*|(|h|)><big|cap>dom<around*|(|f|)>\|h<around*|(|x|)>\<leqslant\>f<around*|(|x|)>|}>>
      is also conegligible we have also that
      G=<math|<around*|{|x\<in\>dom<around*|(|g|)><big|cap>dom<around*|(|h|)>\|g<around*|(|x|)>\<leqslant\>h<around*|(|x|)>|}><big|cap><around*|{|x\<in\>dom<around*|(|h|)><big|cap>dom<around*|(|f|)>\|h<around*|(|x|)>\<leqslant\>f<around*|(|x|)>|}>>
      is conegligible [see <smart-ref|conegligible sets properties>]. Hence
      if <math|x\<in\>G> then <math|g<around*|(|x|)>\<leqslant\>h<around*|(|x|)>\<leqslant\>f<around*|(|x|)>>
      proving that <math|g\<leqslant\><rsub|a.e>f>. So if
      <math|g\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>> such that
      <math|g\<leqslant\><rsub|a.e.>h> then <math|g\<leqslant\><rsub|a.e>f>
      from which it follows that <math|<around*|{|<big|int><rsup|S>g
      ...
      Applying then <smart-ref|measure space properties> gives\ 
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      that <math|F=<around*|{|x\<in\>dom<around*|(|f|)>\|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=f<around*|(|x|)>|}>,G=<around*|{|x\<in\>dom<around*|(|g|)>\|<below|lim|n\<rightarrow\>\<infty\>>g<rsub|n><around*|(|x|)>=g<around*|(|x|)>|}>>
      ...
      Further <math|\<forall\>x\<in\><around*|{|x\<in\>dom<around*|(|f|)>\|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=f<around*|(|x|)>|}>>
      ...
      <item>As <math|f,g\<in\>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>>
      with <math|f\<leqslant\><rsub|a.e.>g> it follows that
      <math|E=<around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|f<around*|(|x|)>\<leqslant\>g<around*|(|x|)>|}>>
      is conegligible. Let now <math|h\<in\>\<cal-S\><around*|[|X,\<cal-A\>|]>>
      such that <math|h\<leqslant\><rsub|a.e.>f> then
      <math|F=<around*|{|x\<in\>dom<around*|(|f|)>\|h<around*|(|x|)>\<leqslant\>f<around*|(|x|)>|}>>
      is conegligible. So <math|\<forall\>x\<in\>E<big|cap>F> [a conegligible
      set] we have that <math|h<around*|(|x|)>\<leqslant\>f<around*|(|x|)>\<leqslant\>g<around*|(|x|)>\<Rightarrow\>h<around*|(|x|)>\<leqslant\>g<around*|(|x|)>
      which proves that h\<leqslant\><rsub|a.e.>g>. Hence
      ...
      <math|f=<rsub|a.e.><below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>> and
      <math|sup<around*|(|<around*|{|<big|int><rsup|S>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)>\<less\>\<infty\>>.
      Given that <math|f=<rsub|a.e.>g> the set
      <math|E=<around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|f<around*|(|x|)>=g<around*|(|x|)>|}>>
      is conegligible, Further as <math|f=<rsub|a.e.><below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>>
      the set <math|F=<around*|{|x\<in\>dom<around*|(|f|)>\|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=f<around*|(|x|)>|}>>
      is conegligible. Now <math|\<forall\>x\<in\>E<big|cap>F> [a
      conegligible set by <smart-ref|conegligible sets properties>] we have
      that <math|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>=f<around*|(|x|)>=g<around*|(|x|)>>
      hence <math|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n>=<rsub|a.e.>g>
      which proves that\ 
  ...
  <\proof>
    ...
    <\description>
      ...
      <item*|<math|2\<Rightarrow\>3>>First by the hypothese exists a
      ...
      by hypothese we can use <smart-ref|positive integrable function
  ...
  <\lemma>
    Let <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a
    measure space, <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
    such that <math|0\<leqslant\><rsub|a.e.>f> then there exists a
    conegligble set <math|E\<in\>\<cal-A\>> such that
    <math|f<rsub|\|E>>,<math|\<forall\>a\<in\>\<gtr\>0>
    <math|<around*|{|a\<leqslant\>f<rsub|\|E>|}>\<in\>\<cal-A\>> and
    <math|\<mu\><around*|(|<around*|{|a\<leqslant\>f<rsub|\|E>|}>|)>\<less\>\<infty\>>.<math|>
    </lemma>
  ...
  <\proof>
    ...
    <\equation*>
      <around*|\||f|\|>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>
    </equation*>

    As <math|0\<leqslant\><rsub|a.e.>f> we have that
    <math|G=<around*|{|x\<in\>dom<around*|(|f|)>\|0\<leqslant\>f<around*|(|x|)>|}>>
    is conegligible. Now <math|\<forall\>x\<in\>G> we have that
    <math|f<around*|(|x|)>=<around*|\||f<around*|(|x|)>|\|>> which as
    <math|G> is conegligible proves that <math|f<rsub|\|G>=<rsub|a.e><around*|\||f|\|>>.\ 
  ...
  <\corollary>
    ...
    <\proof>
      ...
      <\enumerate>
        ...
        <\description>
          <item*|<math|\<Rightarrow\>>>If
          <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> then by
          <smart-ref|measure integral and absolute value>
        ...
        exists a <math|g\<in\>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>>
        such that <math|<around*|\||f|\|>\<leqslant\><rsub|a.e.>g> and a
        conegligible set <math|E> such that <math|f<rsub|\|E>> is
        <math|\<cal-A\>>-measurable. Further as <math|h=<rsub|a.e.>f> we have
        <math|F=<around*|{|x\<in\>dom<around*|(|f|)><big|cap>dom<around*|(|g|)>\|f<around*|(|x|)>=h<around*|(|x|)>|}>\<subseteq\>dom<around*|(|g|)>,dom<around*|(|g|)>>
        is conegligible and from <math|<around*|\||f|\|>\<leqslant\><rsub|a.e.>g>
        we have <math|G=<around*|{|x\<in\>dom<around*|(|g|)><big|cap>dom<around*|(|f|)>\|<around*|\||f|\|><around*|(|x|)>=<around*|\||f<around*|(|x|)>|\|>\<leqslant\>g<around*|(|x|)>|}>>
        is also conegligible. Now <math|dom<around*|(|<around*|(|f<rsub|\|E>|)><rsub|\|F>|)>=dom<around*|(|f<rsub|\|E>|)><big|cap>F=dom<around*|(|f|)><big|cap>E<big|cap>F\<equallim\><rsub|F\<subseteq\>dom<around*|(|f|)>>E<big|cap>F>
        and <math|\<forall\>x\<in\>dom<around*|(|f|)><big|cap>E<big|cap>F> we
        have <math|<around*|(|f<rsub|\|E>|)><rsub|\|F><around*|(|x|)>=f<around*|(|x|)>=g<around*|(|x|)>=g<rsub|\|E<big|cap>F><around*|(|x|)>>,
        as also <math|dom<around*|(|g<rsub|\|E<big|cap>F>|)>=dom<around*|(|g|)><big|cap>E<big|cap>F\<equallim\><rsub|F\<nocomma\>\<subseteq\>dom<around*|(|g|)>>E<big|cap>F>
        which proves that\ 

        <\equation>
          <label|eq eq 18.268.007><around*|(|f<rsub|\|E>|)><rsub|\|F>=g<rsub|\|E<big|cap>F>
        </equation>

        From the <math|\<cal-A\>>-measurability of <math|f<rsub|\|A>> it
        follows by <smart-ref|measurable function operations> that
        <math|<around*|(|f<rsub|\|E>|)><rsub|\|F>> is
        <math|\<cal-A\>>-measurable and as <math|E<big|cap>F> is conegligible
        (zee <smart-ref|conegligible sets properties>) we have that\ 

        <\equation>
          <text|<label|eq 18.269.007>>E<big|cap>F is
          conegligible<infix-and>g<rsub|\|E<big|cap>F> is
          \<cal-A\><text|-measurable>
        </equation>

        Further <math|\<forall\>x\<in\>E<big|cap>F<big|cap>G> [a conegligible
        set by <smart-ref|measurable function operations>] we have
        <math|<around*|\||g|\|><around*|(|x|)>=<around*|\||g<around*|(|x|)>|\|>=<around*|\||f<around*|(|x|)>|\|>=<around*|\||f|\|><around*|(|x|)>>
        proving that\ 

        <\equation>
          <label|eq 18.270.007><around*|\||h|\|>\<leqslant\><rsub|a.e.>g
        </equation>

        Finally <smart-ref|eq 18.269.007> and <smart-ref|eq 18.270.007>
        allows us to apply <smart-ref|measure integral and absolute value>
        which proves that\ 
        ...
        <item>Take <math|f\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
        with <math|0\<leqslant\><rsub|a.e.>f> and <math|<big|int>f
        d\<mu\>\<leqslant\>0>. Assume now that <math|f=<rsub|a.e.>0> is
        false. Using <smart-ref|measure integral and absolute value> there
        exists a conegligible set <math|E<rsub|1>> such that
        <math|f<rsub|\|E<rsub|1>>> is <math|\<cal-A\>>-measurable, from
        <math|0\<leqslant\><rsub|a.e.>f> it follows that
        <math|E<rsub|2>=<around*|{|x\<in\>dom<around*|(|f|)>\|0\<leqslant\>f<around*|(|x|)>|}>>
        is conegligible and as <math|dom<around*|(|f|)>> is conegligible [see
        <smart-ref|domain of integrable functions are conegligible>] we have
        by <smart-ref|conegligible sets properties> that\ 

        <\equation>
          <label|eq 18.271.007>\<exists\>E<rprime|'>\<in\>\<cal-A\> such that
          E<rprime|'>\<subseteq\>E<rsub|1><big|cap>E<rsub|2><big|cap>dom<around*|(|f|)><infix-and>E<rprime|'>
          conegligible
        </equation>

        Now as <math|f<rsub|\|E<rsub|1>>> is <math|\<cal-A\>>-measurable it
        follows from <smart-ref|measurable function operations> that
        <math|f<rsub|\|E<rprime|'>>\<equallim\><rsub|E<rprime|'>\<subseteq\>E<rsub|1><text|
        and <smart-ref|restriction of restricted
        function>>><around*|(|f<rsub|\|E<rsub|1>>|)><rsub|\|E<rprime|'>>> is
        <math|\<cal-A\>>-measurable, as <math|E<rprime|'>\<in\>\<cal-A\>> it
        follows from <smart-ref|measurable function restriction property>
        that\ 

        <\equation>
          <label|eq 18.272.007>\<forall\>a\<in\>\<bbb-R\>
          <around*|{|a\<leqslant\>f<rsub|\|E<rprime|'>>|}>\<in\>\<cal-A\> and
          <around*|{|a\<less\>f<rsub|\|E<rprime|'>>|}>\<in\>\<cal-A\>
        </equation>

        Now if <math|x\<in\>E<rprime|'>\<subseteq\>E<rsub|2>> then
        <math|0\<leqslant\>f<around*|(|x|)>> so that
        <math|f<rsub|\|E<rprime|'>><around*|(|x|)>=f<around*|(|x|)>=<around*|\||f<around*|(|x|)>|\|>=<around*|\||f|\|><around*|(|x|)>>
        which as <math|E<rprime|'>> is conegligible proves that
        <math|f<rsub|\|E<rprime|'>>=<rsub|a.e.><around*|\||f|\|>>, applying
        then <smart-ref|integral of positive integrable functions properties>
        (4) proves as <math|<around*|\||f|\|>\<in\>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>>
        [see <smart-ref|measure integral and absolute value>] that
        <math|f<rsub|\|E<rprime|'>>\<in\>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>>.
        If we use then <smart-ref|positive integrable function alternative>
        (1) w have that\ 

        <\equation>
          <label|eq 18.273.007>\<forall\>a\<gtr\>0 we have
          \<mu\><around*|(|<around*|{|a\<leqslant\>f<rsub|\|E<rprime|'>>|}>|)>\<less\>\<infty\>
        </equation>

        Take <math|F=<around*|{|x\<in\>E<rprime|'>\|0\<less\>f<around*|(|x|)>=f<rsub|\|E><around*|(|x|)>|}>=<around*|{|0\<less\>f<rsub|\|E<rprime|'>>|}>>
        then from <smart-ref|eq 18.272.007> <math|\<mu\><around*|(|F|)>> make
        sense. Assume now <math|\<mu\><around*|(|F|)>=0> then <math|F> is
        negligible so that <math|X\\F> is conegligible and thus
        <math|E<rsub|2><big|cap><around*|(|X\\F|)>> is conegligble. If
        <math|x\<in\>E<rsub|2><big|cap><around*|(|X\\F|)>> then
        <math|0\<leqslant\>f<around*|(|x|)>\<wedge\>0\<nless\>f<rsub|\|E<rprime|'>><around*|(|x|)>=f<around*|(|x|)>\<Rightarrow\>f<around*|(|x|)>=0>
        so that <math|f=<rsub|a.e.>0> contradicting the assumption that
        <math|f=<rsub|a.e.>0> is not true. So we must have that\ 

        <\equation>
          <label|eq 18.274.007>0\<less\>\<mu\><around*|(|F|)>
        </equation>

        Now for every <math|n\<in\>\<bbb-N\>> define
        <math|F<rsub|k>=<around*|{|<frac|1|n>\<leqslant\>f<rsub|\|E<rprime|'>>|}>>
        then if <math|x\<in\>F<rsub|k>> we have that
        <math|0\<less\><frac|1|n>\<leqslant\>f<rsub|\|E<rprime|'>><around*|(|x|)>=f<around*|(|x|)>>
        proving that <math|x\<in\>F> hence <math|F<rsub|k>\<subseteq\>F> so
        that <math|<big|cup><rsub|k\<in\>\<bbb-N\>>F<rsub|k>\<subseteq\>F>.
        Further if <math|x\<in\>F> then <math|0\<less\>f<rsub|\|E<rprime|'>><around*|(|x|)>>
        and using <smart-ref|consequence of the archimedean property for the
        reals> there exists a <math|n\<in\>\<bbb-N\>> such that
        <math|0\<less\><frac|1|n>\<less\>f<rsub|\|E<rprime|'>><around*|(|x|)>>
        proving that <math|x\<in\>F<rsub|n>> hence
        <math|F\<subseteq\><big|cup><rsub|k\<in\>\<bbb-N\>>F<rsub|k>>. From
        this it follows that <math|F=<big|cup><rsub|n\<in\>\<bbb-N\>>F<rsub|n>>
        and by <smart-ref|measure space properties> together with
        <smart-ref|eq 18.272.007> we have then that
        <math|\<mu\><around*|(|F|)>\<leqslant\><big|sum><rsub|n=1><rsup|\<infty\>>\<mu\><around*|(|F<rsub|k>|)>>.
        From this and <smart-ref|eq 18.274.007> there must exists a
        <math|k\<in\>\<bbb-N\>> such that

        <\equation>
          <label|eq 18.275.007>0\<less\>\<mu\><around*|(|F<rsub|k>|)>.
        </equation>

        Take then

        <\equation>
          <label|eq 18.276.007>g=<frac|1|k>\<cdot\>\<cal-X\><rsub|F<rsub|k>>=<frac|1|k>\<cdot\>\<cal-X\><rsub|<around*|{|<frac|1|k>\<leqslant\>f<rsub|\|E<rprime|'>>|}>>\<in\>\<cal-S\><around*|[|X,\<cal-A\>,\<mu\>|]>.
        </equation>

        Then if <math|x\<in\>E<rprime|'>\<subseteq\>E<rsub|1>> we have either
        <math|f<around*|(|x|)>=f<rsub|\|E<rprime|'>><around*|(|x|)>\<less\><frac|1|k>>
        so that <math|g<around*|(|x|)>=0\<leqslant\>f<around*|(|x|)>> or
        <math|<frac|1|k>\<leqslant\>f<around*|(|x|)>=f<rsub|\|E<rprime|'>><around*|(|x|)>>
        and then <math|g<around*|(|x|)>=<frac|1|k>\<leqslant\>f<around*|(|x|)>>
        proving that <math|\<forall\>x\<in\>E<rprime|'>>
        <math|g<around*|(|x|)>\<leqslant\>f<around*|(|x|)>> or that
        <math|g\<leqslant\><rsub|a.e.>f>. From this, the fact that
        <math|g\<in\>\<cal-S\><around*|[|X,\<cal-A\>,\<mu\>|]>\<subseteq\><rsub|<text|<smart-ref|integral
        of simple function extension>>>\<cal-L\><rsub|+><around*|[|X,\<cal-A\>,\<mu\>|]>\<subseteq\><rsub|<text|<smart-ref|measure
        integral extension>>>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>> and
        <smart-ref|measure integral properties (1)> (4) we have that
        <math|<big|int>g d\<mu\>\<leqslant\><big|int>f d\<mu\>>. As
        <math|0\<less\><rsub|<text|<smart-ref|eq
        18.274.007>>><frac|1|k>\<cdot\>\<mu\><around*|(|F<rsub|k>|)>=<big|int>g
        d\<mu\>> it follows that <math|0\<less\><big|int>f d\<mu\>>
        contradicting <math|<big|int>f d\<mu\>\<leqslant\>0> so the
        assumption that <math|f=<rsub|a.e.>0> is false is wrong which finally
        proves that\ 
        ...
        stated that <math|<big|int>g d\<mu\>\<leqslant\><big|int>f d\<mu\>>
        we have that <math|<big|int><around*|(|g-f|)>d\<mu\>=<big|int>g
        d\<mu\>-<big|int>f d\<mu\>\<leqslant\>0>. Applying then (3) proves
        that <math|g-f=<rsub|a.e.>0> which as
        <math|g<around*|(|x|)>-f<around*|(|x|)>\<Leftrightarrow\><around*|(|g-f|)><around*|(|x|)>=0>
        proves that
  ...
  <\proof>
    ...
    we have by <smart-ref|increasing (decreasing) sequence converges>\ 

    <\equation>
      <below|lim|n\<rightarrow\>\<infty\>><big|int>f<rsub|n>d\<mu\>=sup<around*|(|<around*|{|<big|int>f<rsub|n>d\<mu\>\|n\<in\>\<bbb-N\>|}>|)>\<less\>\<infty\>
    </equation>

    From <math|f<rsub|1>=<rsub|a.e.>0> it follows that
    <math|<around*|{|x\<in\>dom<around*|(|f<rsub|1>|)>\|f<rsub|1><around*|(|x|)>=0|}>>
    is conegligible, further <math|>as <math|\<forall\>n\<in\>\<bbb-N\>>
    <math|f<rsub|n>\<leqslant\><rsub|a.e>f<rsub|n+1>> we have that
    <math|<around*|{|x\<in\>dom<around*|(|f<rsub|n>|)><big|cap>dom<around*|(|f<rsub|n+1>|)>\|f<rsub|n><around*|(|x|)>\<leqslant\>f<rsub|n+1><around*|(|x|)>|}>>
    is conegligible. Hence using <smart-ref|conegligible sets properties> we
    have that

    <\equation>
      F=<around*|{|x\<in\>dom<around*|(|f<rsub|1>|)>\|f<rsub|1><around*|(|x|)>=0|}><big|cap><around*|(|<big|cap><around*|{|x\<in\>dom<around*|(|f<rsub|n>|)><big|cap>dom<around*|(|f<rsub|n+1>|)>|}>\|f<rsub|n><around*|(|x|)>\<leqslant\>f<rsub|n+1><around*|(|x|)>|)>
      is conegligible
    </equation>

    As <math|\<forall\>n\<in\>\<bbb-N\> f<rsub|n>\<in\>\<cal-L\><around*|[|X,\<cal-A\>,\<mu\>|]>>
    we have by <smart-ref|measure integral and absolute value> (2)

    <\equation>
      \<forall\>n\<in\>\<bbb-N\><space|1em>\<exists\>E<rsub|n> conegligible
      such that f<rsub|n\|E<rsub|n>> is \<cal-A\><text|-measurable>
    </equation>

    Further using <smart-ref|conegligible sets properties> we have\ 

    <\equation>
      \<exists\>E<rsup|\<ast\>>\<in\>\<cal-A\>,E<rsup|\<ast\>> conegligible
      such that E<rsup|\<ast\>>\<subseteq\>F<big|cap><around*|(|<big|cap><rsub|n\<in\>\<bbb-N\>>E<rsub|n>|)>
    </equation>

    Take <math|a\<gtr\>0> and define\ 
...
<\references>
  <\collection>
    ...
    <associate|Beppo Levi|<tuple|18.144|?>>
    <associate|Beppo Levi positive numbers|<tuple|18.143|?>>
    <associate|Borel algebras|<tuple|18.13|?>>
    <associate|Borel algebras and generator|<tuple|18.11|?>>
    <associate|Borel functions and intersection|<tuple|18.98|?>>
    <associate|Borel sets and closed sets|<tuple|18.14|?>>
    <associate|Borel sets and half spaces|<tuple|18.85|?>>
    <associate|Borel sets on R and Lebesgue sets|<tuple|18.61|?>>
    <associate|Borel sigma-algebra|<tuple|18.12|?>>
    <associate|Caratheodory|<tuple|18.32|?>>
    <associate|Dyadic cube|<tuple|18.75|?>>
    <associate|Dyadic cubes and open sets|<tuple|18.79|?>>
    <associate|Dyadic cubes properties|<tuple|18.77|?>>
    <associate|Dyadic intervals|<tuple|18.49|?>>
    <associate|Dyadic intervals and open sets|<tuple|18.54|?>>
    <associate|Dyadic properties|<tuple|18.53|?>>
    <associate|Lebesgue|<tuple|18.44|?>>
    <associate|Lebesgue R^n|<tuple|18.71|?>>
    <associate|Lebesgue measure|<tuple|Lebesgue measurable set|?>>
    <associate|[a,@@[|<tuple|18.60|?>>
    <associate|]-@@,a]|<tuple|18.58|?>>
    <associate|]a,@@[|<tuple|18.59|?>>
    <associate|a.e. condition|<tuple|18.28|?>>
    <associate|absolute function is Borel measurable|<tuple|18.97|?>>
    <associate|alternate definition of a sigma algebra|<tuple|18.6|?>>
    ...
    <associate|auto-36|<tuple|18.2.2.1|?>>
    <associate|auto-37|<tuple|<with|mode|<quote|math>|\<cal-X\><rsub|A>>|?>>
    <associate|auto-38|<tuple|characteristics function recap|?>>
    <associate|auto-39|<tuple|18.2.2.2|?>>
    <associate|auto-4|<tuple|<with|mode|<quote|math>|\<sigma\>>-algebra|?>>
    <associate|auto-40|<tuple|integral of positive integrable function|?>>
    <associate|auto-41|<tuple|<big|int>f d\<mu\>|?>>
    <associate|auto-42|<tuple|18.2.2.3|?>>
    <associate|auto-43|<tuple|<with|mode|<quote|math>|<big|int>f d\<mu\>>|?>>
    <associate|auto-44|<tuple|integral|?>>
    <associate|auto-45|<tuple|18.3|?>>
    ...
    <associate|boundary of a interval|<tuple|18.39|?>>
    <associate|bounds of a half open interval|<tuple|18.38|?>>
    <associate|characteristics function properties|<tuple|18.108|?>>
    <associate|characteristics function recapitulation|<tuple|18.105|?>>
    <associate|charcteristics function is measurable|<tuple|18.107|?>>
    <associate|closed intervals and Borel Sets|<tuple|18.57|?>>
    <associate|conegligible sets|<tuple|18.25|?>>
    <associate|conegligible sets properties|<tuple|18.27|?>>
    <associate|constructing a outer measure|<tuple|18.31|?>>
    <associate|constructing pairwise disjoint sequences|<tuple|18.19|?>>
    <associate|decomposition of a function in two positive
    functions|<tuple|18.139|?>>
    <associate|domain of integrable functions are
    conegligible|<tuple|18.134|?>>
    ...
    <associate|eq 18.227.005|<tuple|18.237|?>>
    <associate|eq 18.227.006|<tuple|18.227|?>>
    <associate|eq 18.228.005|<tuple|18.238|?>>
    <associate|eq 18.228.006|<tuple|18.228|?>>
    <associate|eq 18.229.005|<tuple|18.239|?>>
    <associate|eq 18.229.006|<tuple|18.229|?>>
    <associate|eq 18.23.001|<tuple|18.34|?>>
    <associate|eq 18.230.005|<tuple|18.240|?>>
    <associate|eq 18.230.006|<tuple|18.230|?>>
    <associate|eq 18.231.005|<tuple|18.241|?>>
    <associate|eq 18.231.006|<tuple|18.231|?>>
    <associate|eq 18.232.006|<tuple|18.232|?>>
    <associate|eq 18.233.006|<tuple|18.233|?>>
    <associate|eq 18.234.006|<tuple|18.234|?>>
    <associate|eq 18.235.006|<tuple|18.235|?>>
    <associate|eq 18.236.006|<tuple|18.236|?>>
    <associate|eq 18.24.001|<tuple|18.35|?>>
    <associate|eq 18.242.006|<tuple|18.242|?>>
    <associate|eq 18.243.006|<tuple|18.243|?>>
    <associate|eq 18.244.006|<tuple|18.244|?>>
    <associate|eq 18.245.006|<tuple|18.245|?>>
    <associate|eq 18.246.006|<tuple|18.246|?>>
    <associate|eq 18.247.006|<tuple|18.247|?>>
    <associate|eq 18.248.006|<tuple|18.248|?>>
    <associate|eq 18.249.006|<tuple|18.249|?>>
    <associate|eq 18.25.001|<tuple|18.36|?>>
    <associate|eq 18.250.006|<tuple|18.250|?>>
    <associate|eq 18.252.006|<tuple|18.251|?>>
    <associate|eq 18.253.006|<tuple|18.252|?>>
    <associate|eq 18.254.006|<tuple|18.253|?>>
    <associate|eq 18.255.006|<tuple|18.254|?>>
    <associate|eq 18.256.006|<tuple|18.255|?>>
    <associate|eq 18.257.006|<tuple|18.256|?>>
    <associate|eq 18.258.006|<tuple|18.257|?>>
    <associate|eq 18.259.006|<tuple|18.258|?>>
    <associate|eq 18.26.001|<tuple|18.37|?>>
    <associate|eq 18.260.007|<tuple|18.260|?>>
    <associate|eq 18.261.006|<tuple|18.259|?>>
    <associate|eq 18.261.007|<tuple|18.261|?>>
    <associate|eq 18.262.007|<tuple|18.262|?>>
    <associate|eq 18.263.007|<tuple|18.263|?>>
    <associate|eq 18.264.007|<tuple|18.264|?>>
    <associate|eq 18.265.007|<tuple|18.265|?>>
    <associate|eq 18.266.007|<tuple|18.266|?>>
    <associate|eq 18.267.007|<tuple|18.267|?>>
    <associate|eq 18.269.007|<tuple|18.269|?>>
    <associate|eq 18.27.001|<tuple|18.38|?>>
    <associate|eq 18.270.007|<tuple|18.270|?>>
    <associate|eq 18.271.007|<tuple|18.271|?>>
    <associate|eq 18.272.007|<tuple|18.272|?>>
    <associate|eq 18.273.007|<tuple|18.273|?>>
    <associate|eq 18.274.007|<tuple|18.274|?>>
    <associate|eq 18.275.007|<tuple|18.275|?>>
    <associate|eq 18.276.007|<tuple|18.276|?>>
    ...
    <associate|eq eq 18.268.007|<tuple|18.268|?>>
    <associate|half open interval|<tuple|18.36|?>>
    <associate|half open interval and Borel Sets|<tuple|18.56|?>>
    <associate|half open interval as union of open sets|<tuple|18.55|?>>
    <associate|half open interval in R^n and a intersection of open
    sets|<tuple|18.81|?>>
    <associate|half open intervals and Borel sets in R^n|<tuple|18.82|?>>
    <associate|half spaces are Lebesgue|<tuple|18.72|?>>
    <associate|half spaces is closed|<tuple|18.84|?>>
    <associate|image measure|<tuple|18.21|?>>
    <associate|integral|<tuple|18.133|?>>
    <associate|integral of increasing simple functions|<tuple|18.121|?>>
    <associate|integral of positive integrable function|<tuple|18.128|?>>
    <associate|integral of positive integrable function
    alternative|<tuple|18.129|?>>
    <associate|integral of positive integrable functions
    properties|<tuple|18.132|?>>
    <associate|integral of simple function extension|<tuple|18.130|?>>
    <associate|integral of simple function properties|<tuple|18.118|?>>
    <associate|integral of te zero function|<tuple|18.131|?>>
    <associate|intersection of interval and segments|<tuple|18.45|?>>
    <associate|intervals in R^1|<tuple|18.68|?>>
    <associate|length is semi-additive|<tuple|18.42|?>>
    <associate|make measurable sets pairwise disjoint|<tuple|18.114|?>>
    <associate|measurable function extension|<tuple|18.103|?>>
    <associate|measurable function operations|<tuple|18.101|?>>
    <associate|measurable function restriction property|<tuple|18.126|?>>
    <associate|measurable functions|<tuple|18.89|?>>
    <associate|measurable functions and continuity|<tuple|18.93|?>>
    <associate|measurable functions and generators|<tuple|18.92|?>>
    <associate|measurable functions and limits|<tuple|18.102|?>>
    <associate|measurable functions conditions|<tuple|18.96|?>>
    <associate|measurable maps composition|<tuple|18.94|?>>
    <associate|measurable space|<tuple|18.4|?>>
    <associate|measure integral and absolute value|<tuple|18.140|?>>
    <associate|measure integral extension|<tuple|18.137|?>>
    <associate|measure integral properties (1)|<tuple|18.138|?>>
    <associate|measure space|<tuple|18.15|?>>
    <associate|measure space alternative definition|<tuple|18.17|?>>
    <associate|measure space properties|<tuple|18.20|?>>
    <associate|negligible set|<tuple|18.22|?>>
    <associate|negligible sets properties|<tuple|18.24|?>>
    <associate|open set as union of ]a,b]|<tuple|18.80|?>>
    <associate|outer measure|<tuple|18.30|?>>
    <associate|outer measure induced by a measure|<tuple|18.33|?>>
    <associate|outer measure on the real numbers|<tuple|18.43|?>>
    <associate|partial function construction|<tuple|18.87|?>>
    <associate|positive integrable function alternative|<tuple|18.127|?>>
    <associate|positive integrable function properties|<tuple|18.122|?>>
    <associate|positive integrable functions dom is
    conegligible|<tuple|18.124|?>>
    <associate|property of Dyadic interval of order n|<tuple|18.52|?>>
    <associate|reindex union of sets|<tuple|18.16|?>>
    <associate|representation of a simple function|<tuple|18.111|?>>
    <associate|segments are lebesgue measurable|<tuple|18.46|?>>
    <associate|set of Dyadic intervals is denumerable|<tuple|18.51|?>>
    <associate|set of dyadic cubes is denumerable|<tuple|18.78|?>>
    <associate|set of segments is a sigma algebra|<tuple|18.47|?>>
    <associate|sigma algebra generated|<tuple|18.10|?>>
    <associate|sigma algebra of half open intervals|<tuple|18.48|?>>
    <associate|sigma algebra of half open intervals in R^n|<tuple|18.74|?>>
    <associate|sigma algebra of half spaces|<tuple|18.73|?>>
    <associate|sigma algebra properties|<tuple|18.8|?>>
    <associate|sigma-algebra|<tuple|18.3|?>>
    <associate|simple function null set|<tuple|18.119|?>>
    <associate|simple function standard representation|<tuple|18.115|?>>
    <associate|simple functions increasing and sup|<tuple|18.120|?>>
    <associate|simple functions properties (basic)|<tuple|18.113|?>>
    <associate|sub-algebra|<tuple|18.9|?>>
    <associate|subspace measure|<tuple|18.34|?>>
    <associate|trivial measurable space|<tuple|18.5|?>>
    <associate|trivial sigma algebra|<tuple|18.7|?>>
    <associate|union of two sets to finite union of two sets|<tuple|18.29|?>>
    <associate|volume is semi-additive|<tuple|18.69|?>>
    <associate|writing a partial function as a limit|<tuple|18.125|?>>
  </collection>
</references>
