...
<\body>
  ...
  <\definition>
    <label|minimum of two functions>Let <math|X> be a set and
    ...
    <\enumerate>
      ...
      is defined by <math|<around*|(|f\<wedge\>g|)><around*|(|x|)>=min<around*|(|f<around*|(|x|)>,g<around*|(|x|)>|)>>
  ...
  <\definition>
    Let <math|X> be a set, <math|n\<in\>\<bbb-N\><rsub|0>> and
    <math|<around*|{|f<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    then <math|max<around*|(|<around*|{|f<rsub|i>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)>>
    is defined by <math|max<around*|(|<around*|{|f<rsub|i>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)><around*|(|x|)>=max<around*|(|<around*|{|f<rsub|i><around*|(|x|)>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)>>
  </definition>

  <\lemma>
    <label|maximum of finite set of functions>Let <math|X> be a set,
    <math|n\<in\><around*|{|2,\<ldots\>,\<infty\>|}>> then if
    <math|<around*|{|f<rsub|i>|}><rsub|i\<in\><around*|{|2,\<ldots\>,n|}>>\<subseteq\><wide|\<bbb-R\>|\<wide-bar\>><rsup|X>>
    we have\ 

    <\enumerate>
      <item><math|\<forall\>k\<in\><around*|{|1,\<ldots\>m|}><text| we have
      ...
      <item>If <math|<around*|{|f<rsub|i>|}><rsub|i\<in\><around*|{|2,\<ldots\>,n|}>>\<subseteq\>\<bbb-R\><rsup|X>>
      then <math|><math|max<around*|(|<around*|{|f<rsub|i>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)>\<subseteq\>\<bbb-R\><rsup|X>>
    </enumerate>
  </lemma>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>Let <math|x\<in\>A> then if <math|m=max<around*|(|<around*|{|f<rsub|i>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)><around*|(|x|)>=max<around*|(|<around*|{|f<rsub|i><around*|(|x|)>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)>>
      ...
      <\description>
        <item*|<math|i\<in\><around*|{|1,\<ldots\>,|}>\\<around*|{|k|}>>>then
        ...
        <math|f<rsub|i><around*|(|x|)>\<leqslant\>m> we have
        <math|max<around*|(|<around*|{|f<rsub|i><around*|(|x|)>\|i\<in\><around*|{|1,\<ldots\>,n|}>\\<around*|{|k|}>|}>|)>\<leqslant\>m>
      ...
      <item>Let <math|m=max<around*|(|<around*|{|f<rsub|i>\|i\<in\><around*|{|1,\<ldots\>n|}>|}>|)><around*|(|x|)>=max<around*|(|<around*|{|f<rsub|i><around*|(|x|)>\|i\<in\><around*|{|1,\<ldots\>n|}>|}>|)>>
  ...
  <\proof>
    ...
    <\description>
      ...
      <\equation*>
        max<around*|(|<around*|{|f<rsub|i>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)><around*|(|x|)>=max<around*|(|<around*|{|f<rsub|i><around*|(|x|)>\|i\<in\><around*|{|1,\<ldots\>,|}>|}>|)>=max<around*|(|<around*|{|f<rsub|1><around*|(|x|)>|}>|)>=f<rsub|1><around*|(|x|)>
      </equation*>
      ...
      we have by <reference|measurable functions properties (1)> that
    ...
    <math|f<rsub|i><around*|(|x|)>\<in\>\<bbb-R\>> so that by
    <reference|maximum of finite set of functions>
    <math|max<around*|(|<around*|{|f<rsub|i>\|i\<in\><around*|{|1,\<ldots\>,n|}>|}>|)><around*|(|x|)>\<in\>\<bbb-R\>>
  ...
  <\definition>
    ...
    <\lemma>
      ...
      <\enumerate>
        ...
        <math|<around*|(|\<alpha\>\<cdot\>f|)><rsup|-1>=-\<alpha\>\<cdot\>f<rsup|->>
        and <math|<around*|(|\<alpha\>\<cdot\>f|)><rsup|->=-\<alpha\>\<cdot\>f<rsup|+>>
    ...
    <\proof>
      ...
      <\enumerate>
        ...
        <\description>
          ...
          <\eqnarray*>
            <tformat|<table|<row|<cell|<around*|(|\<alpha\>\<cdot\>f|)><rsup|-1><around*|(|x|)>>|<cell|=>|<cell|-min<around*|(|\<alpha\>\<cdot\>f<around*|(|x|)>,0|)>>>|<row|<cell|>|<cell|=>|<cell|0>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>0>>|<row|<cell|>|<cell|=>|<cell|a\<cdot\><around*|(|-min<around*|(|f<around*|(|x|)>,0|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>f<rsup|-><around*|(|x|)>>>>>
          </eqnarray*>
        </description>
        ...
        <\description>
          ...
          <\eqnarray*>
            <tformat|<table|<row|<cell|<around*|(|\<alpha\>\<cdot\>f|)><rsup|-1><around*|(|x|)>>|<cell|=>|<cell|-min<around*|(|\<alpha\>\<cdot\>f<around*|(|x|)>,0|)>>>|<row|<cell|>|<cell|=>|<cell|0>>|<row|<cell|>|<cell|=>|<cell|-\<alpha\>\<cdot\>0>>|<row|<cell|>|<cell|=>|<cell|-\<alpha\>\<cdot\>max<around*|(|f<around*|(|x|)>,0|)>>>|<row|<cell|>|<cell|=>|<cell|-\<alpha\>\<cdot\>f<rsup|+><around*|(|x|)>>>>>
          </eqnarray*>
        ...
        <\enumerate>
          <item>then <math|f<around*|(|x|)>\<leqslant\>max<around*|(|f<around*|(|x|)>,0|)>=f<rsup|+><around*|(|x|)>>
  ...
  <\theorem>
    ...
    exists a sequence <math|<around*|{|f<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>
  ...
  <\proof>
    ...
    <\description>
      ...
      prove it for non negative real simple functions, for simple functions
  ...
  Recap the definition of a simple function [see <reference|simple function>]
  we define now the set of measurable simple functions on a measurable space
  as follows:

  <\definition>
    Let <math|<around*|\<langle\>|X,\<cal-A\>|\<rangle\>>> be a measurable
    space then the set of measurable simple real valued functions
    <math|\<cal-S\><around*|[|X,\<cal-A\>|]>\<subseteq\>\<cal-M\><around*|[|X,\<cal-A\>|]>>
    is defined as\ 
  ...
  <\proof>
    ...
    Next using <reference|simple functions are measurable> we have
    <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,n|}>> that
    <math|A<rsub|i>=f<rsup|-1><around*|(|<around*|{|\<beta\><around*|(|i|)>|}>|)>\<in\>\<cal-A\>>.
    Finally assume in addition that <math|f\<in\>\<cal-S\><rsup|+><around*|[|X,\<cal-A\>|]>>
    then <math|f<around*|(|X|)>\<subseteq\><around*|[|0,\<infty\>|]>>. Take
    <math|i\<in\><around*|{|1,\<ldots\>,n|}>> then as
    <math|\<beta\><around*|(|i|)>\<in\>f<around*|(|X|)>> there exists a
    <math|x<rsub|i>\<in\>X> such that <math|f<around*|(|x<rsub|i>|)>=\<beta\><around*|(|i|)>\<in\><around*|{|\<beta\><around*|(|i|)>|}>>
    proving that <math|x<rsub|i>\<in\>A<rsub|i>> \ <math|,further >
    <math|\<forall\>j\<in\><around*|{|1,\<ldots\>,n|}>\\<around*|{|i|}>> we
    have <math|x<rsub|i>\<in\>A<rsub|j>>. So
    <math|a<rsub|i>=<big|sum><rsub|j=1><rsup|n>a<rsub|j>\<cdot\>\<cal-X\><rsub|A<rsub|j>><around*|(|x<rsub|i>|)>=f<around*|(|x<rsub|i>|)>\<in\><around*|[|0,\<infty\>|]>>
    proving that <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\><around*|[|0,\<infty\>|]>>.
  </proof>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\description>
        ...
        and <math|A=X\\<around*|(|<big|cup><rsub|i\<in\>J>A<rsub|i>|)>> then
        as <math|<around*|{|A<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\>\<cal-A\>>
        we have that

        <\equation>
          <label|eq 18.364.035.1>A\<in\>\<cal-A\>
        </equation>

        Let <math|x\<in\>A> then as <math|x\<in\>X> we have either\ 

        <\description>
          <item*|<math|x\<in\><big|cup><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>A<rsub|i>>>then
          <math|\<exists\>i\<in\><around*|{|1,\<ldots\>,n|}>\\J> such that
          <math|x\<in\>A<rsub|i>>, hence <math|f<around*|(|x|)>\<equallim\><rsub|<around*|(|1|)>>a<rsub|i>\<equallim\><rsub|i\<nin\>J>0>\ 

          <item*|<math|x\<in\>X\\<around*|(|<big|cup><rsub|i\<in\><around*|{|1,\<ldots\>n|}>>A<rsub|i>|)>>>then
          by (1) <math|f<around*|(|x|)>=0>
        </description>

        So in all cases we have <math|x\<in\>f<rsup|-1><around*|(|<around*|{|0|}>|)>>
        proving that\ 
        ...
        (1) proves that <math|f<around*|(|x|)>=a<rsub|i>\<neq\>0>, a
        contradiction. Hence <math|x\<in\>A> or
        <math|f<rsup|-1><around*|(|<around*|{|0|}>|)>\<subseteq\>A> which by
        <reference|eq 18.365.035.1> proves that\ 

        <\equation*>
          f<rsup|-1><around*|(|<around*|{|y|}>|)>=f<rsup|-1><around*|(|<around*|{|0|}>|)>=A\<in\><rsub|<text|<reference|eq
          18.364.035.1>>>\<cal-A\>
        </equation*>
  ...
  <\proposition>
    ...
    <\note>
      ...
      so that <math|<big|sum><rsub|i=1><rsup|n>a<rsub|i>\<cdot\>\<mu\><around*|(|A<rsub|i>|)>>
  ...
  <\proof>
    ...
    have that <math|f<around*|(|x|)>=<big|sum><rsub|i\<in\>I>a<rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>=a<rsub|i>\<neq\>0>.
    Assume that <math|x\<nin\><big|cup><rsub|i\<in\>J>B<rsub|i>> we have
    ...
    <\equation>
      ...
      18.365.035>>>B<rsub|i><big|cap><around*|(|<big|sqcup><rsub|j\<in\>J>A<rsub|j>|)>=<big|sqcup><rsub|j\<in\>J><around*|(|A<rsub|i><big|cap>B<rsub|j>|)>
    </equation>
    ...
    <math|A<rsub|i><big|cap>B<rsub|j>\<neq\>\<emptyset\>> such that
    <math|\<exists\>x\<in\>A<rsub|i><big|cap>B<rsub|j>>, So

    <\equation*>
      a<rsub|i>=<big|sum><rsub|j\<in\>I>a<rsub|j>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>=f<around*|(|x|)>=<big|sum><rsub|j\<in\>I>b<rsub|j>\<cdot\>\<cal-X\><rsub|B<rsub|j>><around*|(|x|)>=b<rsub|j>
    </equation*>
  ...
  <reference|simple functions integral (1)> make sure that the following
  definition is well defined (existence and uniqueness). That defined the
  ...
  <\definition>
    ...
    is defined by <math|f\<rightarrow\><big|int><rsup|S>f d\<mu\>> so that
  ...
  <\proposition>
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        and <math|<big|int><rsup|\<cal-S\>><around*|(|f\<wedge\>g|)>
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        <\eqnarray*>
          ...
          function condition (2)>>>>|<cell|min<around*|(|f<rsub|i>,g<rsub|i>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|simple
          function condition (2)>>>>|<cell|<around*|(|<big|sum><rsub|i=1><rsup|n>in<around*|(|f<rsub|i>,g<rsub|i>|)>\<cdot\>\<cal-X\><rsub|C<rsub|i>>|)><around*|(|x|)>>>>>
        </eqnarray*>
      ...
      <\equation*>
        ...
        such that ><around*|{|x\<in\>X\|0\<less\>f<around*|(|x|)>|}>\<subseteq\>N
      </equation*>
      ...
      and a <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>\<subseteq\><around*|[|0,\<infty\>|]>>
      such that <math|f=<big|sum><rsub|i=1><rsup|n>a<rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>>>.
      Take <math|I=<around*|{|i\<in\><around*|{|1,\<ldots\>,n|}>\|0\<less\>a<rsub|i>|}>\<subseteq\><around*|{|1,\<ldots\>,n|}>>
      a finite set. Then we have either\ 
      ...
      <\description>
        ...
        <\equation*>
          <big|int>f d\<mu\>=<big|sum><rsub|i=1><rsup|n>a<rsub|i>\<cdot\>\<mu\><around*|(|A<rsub|i>|)>=<big|sum><rsub|i=1><rsup|n>0\<cdot\>\<mu\><around*|(|A<rsub|i>|)>=0
        </equation*>

        <item*|<math|I\<neq\>\<emptyset\>>>then there exists a
        <math|m\<in\>\<bbb-N\><rsub|0>> and a bijection
        <math|\<beta\>:<around*|{|1,\<ldots\>,m|}>\<rightarrow\>I>. Let
        <math|x\<in\>X> then\ 

        <\eqnarray*>
          <tformat|<table|<row|<cell|f<around*|(|x|)>>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|n>a<rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\>I>a<rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>\\I>a<rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>+<big|sum><rsub|i\<in\>I>a<rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i\<in\>I>a<rsub|i>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|generalized
          sums and bijections>>>>|<cell|<big|sum><rsub|i=1><rsup|m>a<rsub|\<beta\><around*|(|i|)>>\<cdot\>\<cal-X\><rsub|A<rsub|i>><around*|(|x|)>>>>>
        </eqnarray*>

        proving that\ 

        <\equation>
          <label|eq 18.387.035>f=<big|sum><rsub|i=1><rsup|m>a<rsub|\<beta\><around*|(|i|)>>\<cdot\>\<cal-X\><rsub|A<rsub|\<beta\><around*|(|i|)>>><around*|(|x|)>
        </equation>

        If <math|i\<in\><around*|{|1,\<ldots\>,m|}>> then if
        <math|x\<in\>A<rsub|\<beta\><around*|(|i|)>>> we have that
        <math|f<around*|(|x|)>=a<rsub|\<beta\><around*|(|i|)>>\<gtr\>0>
        proving that <math|A<rsub|\<beta\><around*|(|i|)>>\<subseteq\>N> so
        that <math|\<mu\><around*|(|A<rsub|\<beta\><around*|(|i|)>>|)>\<leqslant\>\<mu\><around*|(|N|)>=0>

        <\equation>
          <label|eq 18.388.035.11>\<forall\>i\<in\><around*|{|1,\<ldots\>,m|}>
          \<mu\><around*|(|A<rsub|\<beta\><around*|(|i|)>>|)>=0
        </equation>
        ...
        <\eqnarray*>
          ...
          d\<mu\>>|<cell|\<equallim\><rsub|<text|<reference|eq
          18.387.035>>>>|<cell|<big|sum><rsub|i=1><rsup|m>\<alpha\><rsub|\<beta\><around*|(|i|)>>\<cdot\>\<mu\><around*|(|A<rsub|\<beta\><around*|(|i|)>>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
          18.388.035.11>>>>|<cell|<big|sum><rsub|i=1><rsup|m>\<alpha\><rsub|\<beta\><around*|(|i|)>>\<cdot\>0>>|<row|<cell|>|<cell|=>|<cell|0>>>>
        </eqnarray*>
      </description>
    </enumerate>
  </proof>
  ...
  <\proposition>
    ...
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
    space and let <math|f\<in\>\<cal-S\><rsup|+><around*|[|X,\<cal-A\>|]>>
  ...
  <\proof>
    ...
    <\description>
      ...
      <\equation*>
        \<mu\><around*|(|<big|sqcup><rsub|k\<in\>\<bbb-N\><rsub|0>>B<rsub|k,i>|)>=<below|lim|k\<rightarrow\>\<infty\>>\<mu\><around*|(|B<rsub|k,i>|)>=sup<around*|(|<around*|{|\<mu\><around*|(|B<rsub|k,u>|)>\|k\<in\>\<bbb-N\><rsub|0>|}>|)>
      </equation*>

      proving using <reference|eq 18.392.035> that\ 

      <\equation>
        <label|eq 18.394.035>\<mu\><around*|(|B<rsub|i>|)>=<below|lim|k\<rightarrow\>\<infty\>>\<mu\><around*|(|B<rsub|k,i>|)>=sup<around*|(|<around*|{|\<mu\><around*|(|B<rsub|k,u>|)>\|k\<in\>\<bbb-N\><rsub|0>|}>|)>
      </equation>
      ...
      Let's calculate now the limit of the integrals of <math|g<rsub|k>>
      ...
      <\eqnarray*>
        ...
        18.394.035>>>>|<cell|<big|sum><rsub|i=1><rsup|m><around*|(|1-\<varepsilon\>|)>\<cdot\>b<rsub|i>\<cdot\>\<mu\><around*|(|B<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|1-\<varepsilon\>|)>\<cdot\><big|sum><rsub|i=1><rsup|m>b<rsub|i>\<cdot\>\<mu\><around*|(|B<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|1-\<varepsilon\>|)>\<cdot\><big|int><rsup|\<cal-S\>>f
        d\<mu\><eq-number><label|eq 18.398.035>>>>>
      </eqnarray*>

      Next as by <reference|eq 18.397.035> we have using <reference|simple
      functions integral properties (1)> that
      <math|<big|int><rsup|\<cal-S\>>g<rsub|k>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|1-\<varepsilon\>|)>\<cdot\><big|int><rsup|\<cal-S\>>f
        d\<mu\>\<leqslant\><below|lim|k\<rightarrow\>\<infty\>><big|int><rsup|\<cal-S\>>f<rsub|k>
        d\<mu\>>|<cell|\<Rightarrow\>>|<cell|<big|int><rsup|\<cal-S\>>f
        d\<mu\>\<leqslant\><below|lim|k\<rightarrow\>\<infty\>><big|int><rsup|\<cal-S\>>f<rsub|k>
        d\<mu\>+\<varepsilon\>\<cdot\><big|int><rsup|\<cal-S\>>f d\<mu\>>>>>
      </eqnarray*>

      whcih using <reference|consequence of the Archimedean property (2)>
      proves that <math|<big|int><rsup|\<cal-S\>>f
      d\<mu\>\<leqslant\><below|lim|k\<rightarrow\>\<infty\>><big|int><rsup|\<cal-S\>>f<rsub|k>
      d\<mu\>> the opposite ineqaulity of <reference|eq 18.389.035>. Hence\ 
  ...
  We extend now the integral on non negative function to non negative
  ...
  <\note>
    Using <reference|real (extended real) measurability> we have if
    <math|\<cal-M\><around*|[|X,\<cal-A\>|]>\<subseteq\><wide|\<cal-M\><around*|[|X,\<cal-A\>|]>|\<wide-bar\>>>
    proving that <math|><math|\<cal-M\><rsup|+><around*|[|X,\<cal-A\>|]>\<subseteq\>\<cal-M\><rsup|+><around*|[|X,\<cal-A\>|]>>
  </note>
  ...
  <\definition>
    ...
    [or <math|f> is a non negative <math|\<cal-A\>>-measurable function].
    Then <math|<big|int><rsup|+>:<wide|\<cal-M\><rsup|+><around*|[|X,\<cal-A\>|]>|\<wide-bar\>>\<rightarrow\><around*|[|0,\<infty\>|]>
  ...
  <\note>
    ...
    definition works for every non negative function. However the the
    requirement that <math|f> is <math|\<cal-A\>>-measurable gives us nice
    limit properties to the limit.
  </note>
  ...
  <\theorem>
    ...
    <math|f<rsub|n><around*|(|x|)>\<leqslant\>f<rsub|n+1><around*|(|x|)>>
    then <math|<below|lim|n\<rightarrow\>\<infty\>><big|int><rsup|S>f<rsub|n>
    d\<mu\>> exists and

    <\equation*>
      <big|int><rsup|+>f d\<mu\>=<below|lim|n\<rightarrow\>\<infty\>><big|int><rsup|S>f<rsub|n>
  ...
  <\proof>
    ...
    <\description>
      ...
      <math|f<rsub|n><around*|(|x|)>\<leqslant\>g<around*|(|x|)>>, so
  ...
  In the following corollary we make use of the requirement that the function
  is measurable.

  <\corollary>
    <label|integral of positive functions (1)>Let
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
    space abd <math|f:X\<rightarrow\><wide|\<bbb-R\>|\<wide-bar\>>> such that
  ...
  integral of simple functions to be translated to properties of the integral
  of non negative measurable functions. <reference|simple functions integral
  properties (1)>
  ...
  <\definition>
    ...
    <math|\<cal-S\><rsup|1><around*|[|X,\<cal-A\>,\<mu\>,\<bbb-R\>|]>> and
  ...
  The above defines integrability on functions whose domain is the measure
  space it self. If <math|A> is a measurable set of a measure space we can
  define integrability on this set as follows.
  ...
  <\definition>
    ...
    measure space, <math|A\<in\>\<cal-A\>> then <math|f> is
    <with|font-series|bold|<math|\<mu\>>-integrable> on <math|A> if
  ...
  The above defines integrability on a measureble set but for a function
  graph with domain the measurable space. We want to define the integrability
  and the integral to functions on a measurable set of a measure space. First
  we define a extension of a function on a sub set to a function on a
  superset.\ 
  ...
  <\definition>
    ...
    <math|A >> if \ <math|f<rsub|A\<rightarrow\>X>> is
  ...
  <math|f<rsub|X\<rightarrow\>A>> is <math|\<cal-A\>>-measurable and either
  <math|<big|int><rsup|+><around*|(|f<rsub|A\<rightarrow\>X>|)><rsup|+>
  d\<mu\>> or <math|<big|int><rsup|+><around*|(|f<rsub|A\<rightarrow\>X>|)><rsup|->
  d\<mu\>> is finite. We can reduce this to the condition that <math|f> must
  be <math|\<cal-A\>>-measurable and either
  <math|<big|int><rsup|+><around*|(|f<rsub|A\<rightarrow\>X>|)><rsup|+>
  d\<mu\>> or <math|<big|int><rsup|+><around*|(|f<rsub|A\<rightarrow\>X>|)><rsup|->
  ...
  <\proof>
    ...
    <\description>
      ...
      <math|\<cal-A\>>-measurable and either
      <math|<big|int><rsup|+><around*|(|f\<cdot\>\<cal-X\><rsub|X>|)><rsup|+>d\<mu\>>,
      <math|<big|int><rsup|+><around*|(|f\<cdot\>\<cal-X\><rsub|X>|)><rsup|->d\<mu\>>
      is finite then using <reference|eq 18.412.035> we have that
      ...
      <math|\<cal-A\>>-measurable and and either
      <math|<big|int><rsup|+><around*|(|f<rsub|X\<rightarrow\>X>|)><rsup|+>d\<mu\>>,
      <math|<big|int><rsup|+><around*|(|f<rsub|X\<rightarrow\>X>|)><rsup|->d\<mu\>>
      is finite then using <reference|eq 18.412.035> we have that <math|f> is
      <math|\<cal-A\>>-measurable <math|<big|int><rsup|+>f<rsup|+>d\<mu\>>,
  ...
  <\proof>
    ...
    <math|\<cal-A\>>-measurable hence as <math|f<around*|(|X|)>\<subseteq\><around*|[|0,\<infty\>|]>>
    it follows that <math|f\<in\>\<cal-M\><rsup|+><around*|[|X,\<cal-A\>|]>>,
    further <math|<big|int><rsup|+>f<rsup|+>d\<mu\>> and
    ...
    <math|f\<in\><wide|\<cal-M\><rsup|+><around*|[|X,\<cal-A\>|]>|\<wide-bar\>>>
    then <math|f> is <math|\<cal-A\>>-mesurable and if <math|<big|int>f
    d\<mu\>\<less\>\<infty\>> we have by <reference|eq 18.413.035> that
    <math|<big|int><rsup|+>f<rsup|+> d\<mu\>\<less\>\<infty\>> and
    <math|<big|int><rsup|+>f<rsup|->d\<mu\>=<big|int><rsup|+>C<rsub|0>d\<mu\>\<equallim\><rsub|<text|<reference|integral
  ...
  <\proof>
    ...
    From <reference|eq 18.428.035> and <reference|eq 18.429.035> it follows
    that\ 
  ...
  <\lemma>
    ...
    be non negative real functions <math|\<mu\>>-integrable functions [see
  ...
  <\proof>
    ...
    <math|\<mu\>>-itnegrable and non negative we have by the above
    ...
    <\equation*>
      <big|int><rsup|+>f<rsub|1>d\<mu\>+<big|int><rsup|+>g<rsub|2>d\<mu\>\<equallim\><rsub|<text|<reference|integral
      of positive function properties (2)>>><big|int><rsup|+><around*|(|f<rsub|1>+g<rsub|2>|)>
      d\<mu\>\<equallim\><rsub|<text|<reference|eq
    ...
    which combined with <reference|eq 18.414.035> proves that
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\description>
        ...
        d\<mu\>=0=0\<cdot\><big|int>f d\<mu\>\<alpha\>=\<cdot\><big|int>f
        d\<mu\>>.
      ...
      we have <math|0\<leqslant\>g<around*|(|x|)>-f<around*|(|x|)>=<around*|(|g-f|)>>
  ...
  <\proof>
    ...
    <\description>
      ...
      properties (10)> we have that <math|<around*|\||f|\|>> is
      <math|\<mu\>>-integrable.\ 
  ...
  <\proof>
    ...
    First we take the case where <math|f,g> are non negative functions.
  ...
  <\proof>
    ...
    proving that <math|0\<leqslant\>g<around*|(|x|)>\<leqslant\>f<around*|(|x|)>\<cdot\>\<cal-X\><rsub|A<rsub|t>>>
  ...
  <\definition>
    ...
    <math|A\<subseteq\>X> is <math|\<sigma\>>-finite under <math|\<mu\>> if
    there exists a sequence <math|<around*|{|A<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>\<subseteq\>\<cal-A\>>
  ...
  <\corollary>
    ...
    [<math|f> is <math|\<mu\>>-integrable] then
    <math|<around*|{|x\<in\>X\|f<around*|(|x|)>\<neq\>0|}>> is
    <math|\<sigma\>>-finite under <math|\<mu\>>
  </corollary>

  <\proof>
    Let <math|n\<in\>\<bbb-N\><rsub|0>> we have\ 
    ...
    <around*|\||<math|f>|\|> is <math|\<mu\>>-integrable and that
    <math|<big|int><rsup|+><around*|\||f|\|> d\<mu\>\<less\>\<infty\>>. Using
    <reference|integral properties (14)> we have that
    ...
    there exists a <math|N\<in\>\<bbb-N\><rsub|0>> such that
    <math|x\<in\>A<rsub|n>>, hence <math|<around*|\||f<around*|(|x|)>|\|>\<gtr\>0>
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 18.440.036>\<mu\><around*|(|<around*|{|x\<in\>X\|<around*|\||f<around*|(|x|)>|\|>\<geqslant\><frac|1|n>|}>|)>\<leqslant\>n\<cdot\><big|int><around*|\||f|\|>
      d\<mu\>=0
    </equation>
    ...
    On the other side if <math|x\<in\><big|cup><rsub|n\<in\>\<bbb-N\><rsub|0>><around*|{|x\<in\>X\|<around*|\||f<around*|(|x|)>|\|>\<geqslant\><frac|1|n>|}>>
    there exists a <math|N\<in\>\<bbb-N\><rsub|0>> such that
    <math|x\<in\><around*|{|x\<in\>X\|<around*|\||f<around*|(|x|)>|\|>\<geqslant\><frac|1|n>|}>>,
    hence <math|<around*|\||f<around*|(|x|)>|\|>\<gtr\>0> giving
    <math|f<around*|(|x|)>\<neq\>0> which proves that
  ...
  <\proof>
    Let <math|A=<around*|{|x\<in\>X\|f<around*|(|x|)>\<less\>0|}>=<around*|{|f\<less\>0|}>\<in\>\<cal-A\>>,
    ...
    <\description>
      ...
      <\equation*>
        <around*|(|\<cal-X\><rsub|A>\<cdot\>f|)><rsup|+><around*|(|x|)>=max<around*|(|<around*|(|\<cal-X\><rsub|A>\<cdot\>f|)><around*|(|x|)>|)>=0
      </equation*>

      <item*|<math|x\<in\>X\\A>>Then <math|f<around*|(|x|)>\<less\>0> and
      <math|\<cal-X\><rsub|A><around*|(|x|)>=0> so that
      <math|<around*|(|\<cal-X\><rsub|A>\<cdot\>f|)><around*|(|x|)>=f<around*|(|x|)>\<less\>0>
      hence
  ...
  <\corollary>
    ...
    [<math|f> is a <math|\<mu\>>-integrable <math|\<cal-A\>>-measurable
  ...
  <\proof>
    ...
    <\equation>
      ...
      >\<mu\><around*|(|<around*|{|x\<in\>X\|<around*|\||f<around*|(|x|)>|\|>\<geqslant\>n|}>|)>\<leqslant\><frac|1|n>\<cdot\><big|int><around*|\||f|\|>
      d\<mu\>
    </equation>
    ...
    As <math|n> is choosen arbitrary we have by <reference|consequence of the
  ...
  <\corollary>
    ...
    valued <math|\<mu\>>-integrable function that is equel to <math|f> almost
    everywhere.
  </corollary>
  ...
  <\proof>
    ...
    <\description>
      ...
      <\equation>
        <label|eq 18.447.036>f<around*|(|x|)>=g<around*|(|x|)><text|
        >\<mu\><text|-always measurable>
      </equation>
  ...
  <\proof>
    ...
    For the reverse inequality take <math|n\<in\>\<bbb-N\><rsub|0>> fixed
    then using <reference|measurable functions properties (6)> there exists a
    ...
    leading to the contradiction <math|sup<around*|(|<around*|{|h<rsub|n><around*|(|x|)>\|n\<in\>\<bbb-N\><rsub|0>|}>|)>\<less\>h<rsub|n,max<around*|(|n,k|)>><around*|(|x|)>>.
    ...
    whcih combined with <reference|eq 18.456.036> proves that\ 
    ...
    <\eqnarray*>
      ...
      d\<mu\><text| [>h<rsub|n><around*|(|x|)>\<leqslant\>g<rsub|n><around*|(|x|)><text|
      see <reference|eq 18.455.036>><infix-and><reference|integral of
      positive function properties (2)><text|]>>>>>
    </eqnarray*>
  ...
  <\proof>
    Then there exists a <math|N\<in\>\<cal-A\>> with
    ...
    <\description>
      ...
      <\equation*>
        ...
        <around*|(|\<cal-X\><rsub|X\\A>\<cdot\>f|)><around*|(|x|)>=\<cal-X\><rsub|X\\A><around*|(|x|)>\<cdot\>f<rsub|n><around*|(|x|)>\<leqslant\>\<cal-X\><rsub|X\\A><around*|(|x|)>\<cdot\>f<rsub|n+1><around*|(|x|)>=<around*|(|\<cal-X\><rsub|Z\\A>\<cdot\>f<rsub|n+1>|)><around*|(|x|)>*
      </equation*>

      and\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|\<cal-X\><rsub|<rsub|A>>\<cdot\>f|)><around*|(|x|)>>|<cell|=>|<cell|\<cal-X\><rsub|A><around*|(|x|)>\<cdot\>f<around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|f<around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<below|lim|n\<rightarrow\>\<infty\>><around*|(|\<cal-X\><rsub|A><around*|(|x|)>\<cdot\>f<rsub|n><around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<below|lim|n\<rightarrow\>\<infty\>><around*|(|\<cal-X\><rsub|A>\<cdot\>f<rsub|n><around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<below|lim|n\<rightarrow\>\<infty\>><around*|(|\<cal-X\><rsub|A>\<cdot\>f<rsub|n>|)><around*|(|x|)>>>>>
      </eqnarray*>
      ...
      <\equation*>
        \<forall\>n\<in\>\<bbb-N\><rsub|0><text| >
        <around*|(|\<cal-X\><rsub|X\\A>\<cdot\>f|)><around*|(|x|)>=0\<cdot\>f<rsub|n><around*|(|x|)>=0\<leqslant\>0\<cdot\>f<rsub|n+1><around*|(|x|)>=\<cal-X\><rsub|X\\A><around*|(|x|)>\<cdot\>f<rsub|n+1><around*|(|x|)>=<around*|(|\<cal-X\><rsub|Z\\A>\<cdot\>f<rsub|n+1>|)><around*|(|x|)>
      </equation*>
  ...
  <\proof>
    ...
    <\equation*>
      \<forall\>n\<in\>\<bbb-N\><rsub|0><text|
      >f<rsub|n><around*|(|x|)>\<leqslant\>f<rsub|n+1><around*|(|x|)>\<wedge\><around*|(|<big|sum><rsub|i=1><rsup|\<infty\>>f<rsub|i>|)><around*|(|x|)>=<big|sum><rsub|i=1><rsup|\<infty\>>f<rsub|i><around*|(|x|)>\<equallim\><rsub|<text|<reference|series
    ...
    <\eqnarray*>
      ...
      d\<mu\>>|<cell|=>|<cell|<big|int><rsup|+><around*|(|<below|lim|n\<rightarrow\>\<infty\>><around*|(|<big|sum><rsub|i=1><rsup|n>f<rsub|i>|)>|)>
      ...
      d\<mu\>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|integral
      of sum non negative positive functions>>>>|<cell|<below|lim|n\<rightarrow\>\<infty\>><around*|(|<big|sum><rsub|i=1><rsup|m><big|int><rsup|+>f<rsub|i>
  ...
  <\lemma>
    ...
    <\equation*>
      ...
      f<rsub|i>|)> d\<mu\>=<below|lim inf|n\<rightarrow\>\<infty\>>
      <big|int><rsup|+>f<rsub|i> d\<mu\>
    </equation*>
  </lemma>
  ...
  <\proof>
    ...
    So we can apply the Monotone Convergence Theorem [see <reference|monotone
    ...
    inf|n\<rightarrow\>\<infty\>><big|int><rsup|+>g<rsub|n>
    d\<mu\>\<leqslant\><below|lim|n\<rightarrow\>\<infty\>><big|int><rsup|+>f<rsub|n>
  ...
  <\theorem>
    ...
    <math|<around*|\<langle\>|X,\<cal-A\>,\<mu\>|\<rangle\>>> be a measure
    space , let <math|g\<in\><wide|\<cal-L\><rsup|1>|\<wide-bar\>>> [a
    <math|<around*|[|0,\<infty\>|]>> valued jntegrable function],
    ...
    <\equation*>
      f<around*|(|x|)>=<below|lim|n\<rightarrow\>\<infty\>>f<rsub|n><around*|(|x|)><rsub|>
    </equation*>
  ...
  <\proof>
    As <math|g\<in\><wide|\<cal-L\><rsup|1>|\<wide-bar\>>> and non negative
    we have by <reference|integrability of non negative functions (2)> we
    have that\ 
    ...
    <\equation*>
      ...
      f<rsub|n><around*|(|x|)>\<leqslant\>g<around*|(|x|)>|)>|}>\<subseteq\>N<rsub|2>
    </equation*>
    ...
    <\equation>
      ...
      f<rsub|n><around*|(|x|)>\<leqslant\>g<around*|(|x|)>|)>|}>\<subseteq\>N
    </equation>
    ...
    <reference|characteristic function is measurable> that
    ...
    <\equation>
      <label|eq 18.464.036><around*|(|\<cal-X\><rsub|X\\N>\<cdot\>f|)>\<in\><wide|\<cal-M\><around*|[|X,\<cal-A\>|]>|\<wide-bar\>>\<wedge\><around*|(|\<cal-X\><rsub|X\\N>\<cdot\>f|)>\<in\><wide|\<cal-M\><around*|[|X,\<cal-A\>|]>|\<wide-bar\>>\<wedge\>\<forall\>n\<in\>\<bbb-N\><rsub|0>
    ...
    <\description>
      ...
      <\equation*>
        ...
        ><around*|\||\<cal-X\><rsub|X\\A>\<cdot\>f<rsub|n>|\|><around*|(|x|)>=<around*|\||<around*|(|\<cal-X\><rsub|X\\N>\<cdot\>f<rsub|n>|)><around*|(|x|)>|\|>=<around*|\||\<cal-X\><rsub|X\\N><around*|(|x|)>\<cdot\>f<rsub|n><around*|(|x|)>|\|>=0\<leqslant\><around*|(|\<cal-X\><rsub|X\\N>\<cdot\>g|)><around*|(|x|)>
      </equation*>

      and

      <\equation*>
        <around*|(|\<cal-X\><rsub|X\\N>\<cdot\>f|)><around*|(|x|)>=\<cal-X\><rsub|X\\N><around*|(|x|)>\<cdot\>f<around*|(|x|)>=0=<below|lim|n\<rightarrow\>\<infty\>><around*|(|\<cal-X\><rsub|X\\N><around*|(|x|)>\<cdot\>f<around*|(|x|)>|)>=<below|lim|n\<rightarrow\>\<infty\>><around*|(|\<cal-X\><rsub|X\\N>\<cdot\>f|)><around*|(|x|)>
      </equation*>
      ...
      <\equation*>
        <around*|\||\<cal-X\><rsub|X\\N>\<cdot\>f<rsub|n>|\|><around*|(|x|)>=<around*|\||<around*|(|\<cal-X\><rsub|X\\N>\<cdot\>f<rsub|n>|)><around*|(|x|)>|\|>=<around*|\||f<rsub|n><around*|(|x|)>|\|>\<leqslant\><rsub|x\<nin\>A>g<around*|(|x|)>=\<cal-X\><rsub|X\\A><around*|(|x|)>\<cdot\>g<around*|(|x|)>=<around*|(|\<cal-X\><rsub|X\\A>\<cdot\>g|)><around*|(|x|)>
      </equation*>

      and

      <\eqnarray*>
        <tformat|<table|<row|<cell|<around*|(|\<cal-X\><rsub|X\\N>\<cdot\>f|)><around*|(|x|)>>|<cell|=>|<cell|\<cal-X\><rsub|X\\N><around*|(|x|)>\<cdot\>f<around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|f<around*|(|x|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|x\<nin\>A>>|<cell|<below|lim|n\<rightarrow\>\<infty\>>f<around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<below|lim|n\<rightarrow\>\<infty\>><around*|(|\<cal-X\><rsub|X\\N><around*|(|x|)>\<cdot\>f<around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<below|lim|n\<rightarrow\>\<infty\>><around*|(|\<cal-X\><rsub|X\\N>\<cdot\>f|)><around*|(|x|)>>>>>
      </eqnarray*>
    ...
    <\eqnarray*>
      ...
      <around*|\||\<cal-X\><rsub|X\\N>\<cdot\>f|\|><around*|(|x|)>\<leqslant\><around*|(|\<cal-X\><rsub|X\\N>\<cdot\>g|)><around*|(|x|)>\<less\>\<infty\>>|<cell|>>|<row|<cell|>|<cell|<around*|(|\<cal-X\><rsub|X\\N>\<cdot\>g|)><around*|(|x|)>\<less\>\<infty\>>|<cell|>>|<row|<cell|>|<cell|<below|lim|n\<rightarrow\>\<infty\>><around*|(|\<cal-X\><rsub|X\\N>\<cdot\>f<rsub|n>|)><around*|(|x|)>=<around*|(|\<cal-X\><rsub|X\\N>\<cdot\>f|)><around*|(|x|)>>|<cell|<eq-number><label|eq
      18.465.036>>>>>
    </eqnarray*>
    ...
    From <math|<around*|\||\<cal-X\><rsub|X\\N>\<cdot\>f<rsub|n>|\|><around*|(|x|)>\<leqslant\><around*|(|\<cal-X\><rsub|X\\A>\<cdot\>g|)><around*|(|x|)>>
    we have by <reference|eq 18.464.036>, <reference|integral of positive
    function properties (2)> that <math|<big|int><rsup|+><around*|\||\<cal-X\><rsub|X\\N>\<cdot\>f<rsub|n>|\|>
    d\<mu\>\<leqslant\><big|int><rsup|+><around*|(|\<cal-X\><rsub|X\\A>\<cdot\>g|)>
    d\<mu\>>. Using <reference|eq 18.465.036> we have then that
...
<\references>
  <\collection>
    ...
    <associate|Beppo Levi's Theorem|<tuple|18.233|?>>
    ...
    <associate|Fatou's Lemma|<tuple|18.234|?>>
    ...
    <associate|Lebesgue's Dominated Convergence Theorem|<tuple|18.237|?>>
    ...
    <associate|almost complete|<tuple|18.178|?>>
    <associate|almost everywhere equality and characteristic
    function|<tuple|18.180|?>>
    <associate|almost everywhere properties|<tuple|18.181|?>>
    ...
    <associate|eq 18.386.035|<tuple|18.389|?>>
    <associate|eq 18.386.035.4|<tuple|18.386|?>>
    <associate|eq 18.387.035|<tuple|18.387|?>>
    <associate|eq 18.388.035|<tuple|18.391|?>>
    <associate|eq 18.388.035.11|<tuple|18.388|?>>
    <associate|eq 18.389.035|<tuple|18.392|?>>
    <associate|eq 18.39.016|<tuple|18.87|?>>
    <associate|eq 18.39.022|<tuple|18.61|?>>
    <associate|eq 18.390.035|<tuple|18.393|?>>
    <associate|eq 18.391.035|<tuple|18.394|?>>
    <associate|eq 18.392.035|<tuple|18.395|?>>
    <associate|eq 18.393.035|<tuple|18.396|?>>
    <associate|eq 18.394.035|<tuple|18.397|?>>
    <associate|eq 18.395.035|<tuple|18.398|?>>
    <associate|eq 18.396.035|<tuple|18.399|?>>
    <associate|eq 18.397.035|<tuple|18.400|?>>
    <associate|eq 18.398.035|<tuple|18.401|?>>
    <associate|eq 18.399.035|<tuple|18.402|?>>
    <associate|eq 18.4.016|<tuple|18.7|?>>
    <associate|eq 18.40.016|<tuple|18.89|?>>
    <associate|eq 18.40.022|<tuple|18.62|?>>
    <associate|eq 18.400.035|<tuple|18.403|?>>
    <associate|eq 18.401.035|<tuple|18.404|?>>
    <associate|eq 18.403.35|<tuple|18.405|?>>
    <associate|eq 18.404.035|<tuple|18.406|?>>
    <associate|eq 18.405.35|<tuple|18.407|?>>
    <associate|eq 18.406.035|<tuple|18.408|?>>
    <associate|eq 18.407.035|<tuple|18.409|?>>
    <associate|eq 18.408.035|<tuple|18.410|?>>
    <associate|eq 18.409.035|<tuple|18.411|?>>
    <associate|eq 18.41.016|<tuple|18.90|?>>
    <associate|eq 18.41.022|<tuple|18.63|?>>
    <associate|eq 18.410.035|<tuple|18.413|?>>
    <associate|eq 18.410.35.1|<tuple|18.412|?>>
    <associate|eq 18.412.035|<tuple|18.414|?>>
    <associate|eq 18.413.035|<tuple|18.415|?>>
    <associate|eq 18.414.035|<tuple|18.418|?>>
    <associate|eq 18.415.035|<tuple|18.419|?>>
    <associate|eq 18.416.035|<tuple|18.420|?>>
    <associate|eq 18.417.035|<tuple|18.421|?>>
    <associate|eq 18.418.035|<tuple|18.422|?>>
    <associate|eq 18.419.035|<tuple|18.423|?>>
    <associate|eq 18.42.016|<tuple|18.91|?>>
    <associate|eq 18.42.022|<tuple|18.64|?>>
    <associate|eq 18.420.035|<tuple|18.424|?>>
    <associate|eq 18.421.035|<tuple|18.425|?>>
    <associate|eq 18.422.035|<tuple|18.426|?>>
    <associate|eq 18.423.035|<tuple|18.427|?>>
    <associate|eq 18.424.035|<tuple|18.428|?>>
    <associate|eq 18.425.035|<tuple|18.429|?>>
    <associate|eq 18.428.035|<tuple|18.416|?>>
    <associate|eq 18.429.035|<tuple|18.417|?>>
    <associate|eq 18.43.016|<tuple|18.92|?>>
    <associate|eq 18.43.022|<tuple|18.65|?>>
    <associate|eq 18.430.036.1|<tuple|18.430|?>>
    <associate|eq 18.432.036|<tuple|18.433|?>>
    <associate|eq 18.433.036|<tuple|18.434|?>>
    <associate|eq 18.434.036|<tuple|18.435|?>>
    <associate|eq 18.436.036|<tuple|18.436|?>>
    <associate|eq 18.437.036.1|<tuple|18.437|?>>
    <associate|eq 18.438.036|<tuple|18.438|?>>
    <associate|eq 18.439.036|<tuple|18.439|?>>
    ...
    <associate|eq 18.440.036|<tuple|18.440|?>>
    <associate|eq 18.441.036|<tuple|18.441|?>>
    <associate|eq 18.442.036|<tuple|18.442|?>>
    <associate|eq 18.443.036|<tuple|18.443|?>>
    <associate|eq 18.444.036|<tuple|18.444|?>>
    <associate|eq 18.445.036|<tuple|18.445|?>>
    <associate|eq 18.446.036|<tuple|18.446|?>>
    <associate|eq 18.447.036|<tuple|18.447|?>>
    <associate|eq 18.448.036|<tuple|18.448|?>>
    <associate|eq 18.449.036|<tuple|18.449|?>>
    <associate|eq 18.45.016|<tuple|18.94|?>>
    <associate|eq 18.45.022|<tuple|18.67|?>>
    <associate|eq 18.45.033|<tuple|18.45|?>>
    <associate|eq 18.450.036|<tuple|18.450|?>>
    <associate|eq 18.451.036|<tuple|18.451|?>>
    <associate|eq 18.452.036|<tuple|18.452|?>>
    <associate|eq 18.453.036|<tuple|18.453|?>>
    <associate|eq 18.454.036|<tuple|18.454|?>>
    <associate|eq 18.455.036|<tuple|18.455|?>>
    <associate|eq 18.456.036|<tuple|18.456|?>>
    <associate|eq 18.457.036|<tuple|18.457|?>>
    <associate|eq 18.458.036|<tuple|18.458|?>>
    <associate|eq 18.459.036|<tuple|18.459|?>>
    <associate|eq 18.46.016|<tuple|18.95|?>>
    <associate|eq 18.46.022|<tuple|18.68|?>>
    <associate|eq 18.46.033|<tuple|18.46|?>>
    <associate|eq 18.460.036|<tuple|18.460|?>>
    <associate|eq 18.461.036|<tuple|18.461|?>>
    <associate|eq 18.463.036|<tuple|18.462|?>>
    <associate|eq 18.463.036.1|<tuple|18.463|?>>
    <associate|eq 18.464.036|<tuple|18.464|?>>
    <associate|eq 18.465.036|<tuple|18.465|?>>
    <associate|eq 18.466.036|<tuple|18.466|?>>
    <associate|eq 18.467.036|<tuple|18.467|?>>
    <associate|eq 18.468.036|<tuple|18.468|?>>
    <associate|eq 18.469.036|<tuple|18.469|?>>
    <associate|eq 18.47.016|<tuple|18.96|?>>
    <associate|eq 18.47.022|<tuple|18.69|?>>
    <associate|eq 18.47.033|<tuple|18.47|?>>
    <associate|eq 18.470.036|<tuple|18.470|?>>
    ...
    <associate|eq 18.67.035|<tuple|18.390|?>>
    ...
    cubes|<tuple|18.50|?>>
    <associate|f+ and f-|<tuple|18.173|?>>
    <associate|f=g almost everywhere property|<tuple|18.182|?>>
    ...
    <associate|integrability of function with domain A|<tuple|18.213|?>>
    <associate|integrability of function with domain X on A|<tuple|18.210|?>>
    <associate|integrability of non negative functions (2)|<tuple|18.217|?>>
    <associate|integrability where X is A|<tuple|18.216|?>>
    <associate|integrable functions|<tuple|18.208|?>>
    <associate|integral difference|<tuple|18.219|?>>
    <associate|integral of everywhere zero function|<tuple|18.203|?>>
    <associate|integral of positive function properties (2)|<tuple|18.206|?>>
    <associate|integral of positive functions (1)|<tuple|18.205|?>>
    <associate|integral of positive functions properties
    (1)|<tuple|18.204|?>>
    <associate|integral of positive measurable functions|<tuple|18.199|?>>
    <associate|integral of sum non negative positive
    functions|<tuple|18.207|?>>
    <associate|integral of the null function|<tuple|18.202|?>>
    <associate|integral properties (10)|<tuple|18.220|?>>
    <associate|integral properties (11)|<tuple|18.221|?>>
    <associate|integral properties (11.1)|<tuple|18.222|?>>
    <associate|integral properties (12)|<tuple|18.223|?>>
    <associate|integral properties (14)|<tuple|18.224|?>>
    <associate|integral properties (15|<tuple|18.226|?>>
    <associate|integral properties (16)|<tuple|18.227|?>>
    <associate|integral properties (17)|<tuple|18.228|?>>
    <associate|integral properties (18)|<tuple|18.229|?>>
    ...
    <associate|measurable functions properties (4)|<tuple|18.171|?>>
    <associate|measurable functions properties (5)|<tuple|18.175|?>>
    <associate|measurable functions properties (6)|<tuple|18.176|?>>
    <associate|measurable positive functions|<tuple|18.197|?>>
    ...
    <associate|minimum of two functions|<tuple|18.161|?>>
    <associate|monotone convergence theorem|<tuple|18.232|?>>
    ...
    <associate|set of simple functions|<tuple|18.188|?>>
    ...
    <associate|simple function as a finite sum|<tuple|18.184|?>>
    <associate|simple function condition (2)|<tuple|18.189|?>>
    <associate|simple function condition (3)|<tuple|18.193|?>>
    <associate|simple function integral extension|<tuple|18.201|?>>
    <associate|simple function integral properties (4)|<tuple|18.196|?>>
    <associate|simple function properties|<tuple|18.185|?>>
    <associate|simple function properties (1)|<tuple|18.158|?>>
    <associate|simple functions are measurable|<tuple|18.159|?>>
    <associate|simple functions integral (1)|<tuple|18.190|?>>
    <associate|simple functions integral properties (1)|<tuple|18.194|?>>
    ...
    <associate|\|f(x)\| as f+ f-|<tuple|18.174|?>>
  </collection>
</references>
