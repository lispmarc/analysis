...
<\body>
  ...
  <\notation>
    ...
    <\enumerate>
      ...
      <item>Let <math|n\<in\>\<bbb-N\><rsub|0>> then
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 14.8.100>\<alpha\><rsub|X>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X<rsub|2>>\<leqslant\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X<rsub|1>>\<leqslant\>\<beta\><rsub|X>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X<rsub|2>><text|
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\equation>
        <label|eq 12.1>\<exists\>\<delta\><rsub|1>\<gtr\>0 <text|such that
        if> <around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<leqslant\>\<delta\><rsub|1>\<Rightarrow\>h\<in\>W<rsub|x>
      </equation>
      ...
      <\equation>
        <label|eq 12.2>if h\<in\>W<rsub|x> <text|and>
        <around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|2>
        <text|then> <around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D<around*|(|f<rsub|\|W>|)><around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>\<leqslant\>\<varepsilon\>\<cdot\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>
      </equation>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <item>There exists a <math|D f<around*|(|x|)>\<in\>L<around*|(|X,Y|)>>
      such that <math|\<forall\><around*|{|h<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>
  ...
  <\proof>
    ...
    <\description>
      ...
      <item*|<math|3\<Rightarrow\>4>>Let <math|<around*|{|h<rsub|i>|}><rsub|i\<in\>\<bbb-N\><rsub|0>>>
      ...
      and thus there exists a <math|N\<in\>\<bbb-N\><rsub|0>> such that for
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 14.2.100>\<exists\>\<delta\><rsub|1>\<gtr\>0 <text|such that
    ...
    <\equation>
      <label|eq 14.3.100>If h\<in\>U<rsub|x><text| and
      ><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|2>
      <text|then> <around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>-D
    ...
    <\equation>
      <label|eq 14.4.100>\<exists\>\<delta\><rsub|3>\<gtr\>0 <text|such that
      if> <around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|3><text|
      then> <around*|\<\|\|\>|D f<around*|(|x|)><around*|(|h|)>|\<\|\|\>><rsub|Y>\<less\><frac|\<delta\><rsub|1>|2>
    </equation>

    As <math|U> is open and <math|x\<in\>U> we have\ 

    <\equation>
      <label|eq 14.5.100>\<exists\>\<delta\><rsub|4>\<gtr\>0<text| such that>
    ...
    <\equation>
      ...
      <text|we have> \ <around*|\<\|\|\>|f<around*|(|y|)>-f<around*|(|x|)>-D
      f<around*|(|x|)><around*|(|y-x|)>|\<\|\|\>><rsub|Y>\<less\><frac|\<delta\><rsub|1>|2>
    </equation>
    ...
    <\equation>
      ...
      <text|we have> <around*|\<\|\|\>|D f<around*|(|x|)><around*|(|y-x|)>|\<\|\|\>><rsub|Y>\<less\><frac|\<delta\><rsub|1>|2>
    </equation>
  ...
  <\proof>
    ...
    <\equation>
      ...
      <text|we have> f<around*|(|x+h|)>-f<around*|(|x|)>-D
    ...
    <\equation>
      <label|eq 14.13.100>\<forall\>k\<in\>V<rsub|f<around*|(|x|)>> <text|we
    ...
    <\equation>
      ...
      <text|we have tha>t f<around*|(|x+h|)>-f<around*|(|x|)>\<in\>V<rsub|f<around*|(|x|)>>
    </equation>
    ...
    <\equation>
      ...
      <text|with> 0\<less\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>\<delta\><rsub|1>
      <text|we have> <frac|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>\<less\><around*|(|1+<around*|\<\|\|\>|D
      f<around*|(|x|)>|\<\|\|\>>|)>
    </equation>
    ...
    <\equation>
      <label|eq 14.18.100>\<forall\>k\<in\>V<rsub|f<around*|(|x|)>>
      <text|with> <around*|\<\|\|\>|k|\<\|\|\>><rsub|Y>\<less\>\<delta\><rsub|2>
      <text|we have> <around*|\<\|\|\>|\<varepsilon\><rsub|g><around*|(|k|)>|\<\|\|\>><rsub|Z>\<less\><frac|\<varepsilon\>|2\<cdot\><around*|(|1+<around*|\<\|\|\>|D
      f<around*|(|x|)>|\<\|\|\>>|)>>
    </equation>
    ...
    <\equation>
      ...
      <text|with> 0\<less\><around*|\<\|\|\>|h|\<\|\|\>><rsub|X>\<less\>min<around*|(|\<delta\><rsub|1>,\<delta\><rsub|3>|)>
      <text|we have> <around*|\<\|\|\>|\<varepsilon\><rsub|g><around*|(|f<around*|(|x+h|)>-f<around*|(|x|)>|)>|\<\|\|\>><rsub|X>\<cdot\><frac|<around*|\<\|\|\>|f<around*|(|x+h|)>-f<around*|(|x|)>|\<\|\|\>><rsub|Y>|<around*|\<\|\|\>|h|\<\|\|\>><rsub|X>>\<less\><frac|\<varepsilon\>|2>
    </equation>
    ...
    <\equation>
      ...
      <text|then> <around*|\<\|\|\>|D g<around*|(|f<around*|(|x|)>|)><around*|(|\<varepsilon\><rsub|f><around*|(|h|)>|)>|\<\|\|\>><rsub|Z>\<less\><frac|\<varepsilon\>|2>
    </equation>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      [or <math|D f<around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>D<rsub|i>f<around*|(|x|)>\<circ\>\<pi\><rsub|i>>]
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\description>
      ...
      <\equation*>
        D<rsub|i>f<around*|(|x|)> exists<text|<infix-and>>D<rsub|i>f<around*|(|x|)><around*|(|1|)>=\<partial\><rsub|i>f<around*|(|x|)>
      </equation*>
  ...
  <\theorem>
    <label|differentiability of K^n>Let <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>>,
    <math|<around*|\<langle\>|\<bbb-K\><rsup|n>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    be the vector space <math|\<bbb-K\><rsup|n>> equipped with the maximum
  ...
  <\definition>
    Let <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>>,
  ...
  <\proof>
    ...
    <\description>
      ...
      <\equation*>
        f <text|is differentiable a>t x
      </equation*>
    </description>
  </proof>

  <\corollary>
    <label|D(g@f) where g is multivalued>Let
    <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>>
    <math|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    be a finite family of normed spaces, <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>,<around*|\<langle\>|Z,<around*|\<\|\|\>||\<\|\|\>><rsub|Z>|\<rangle\>>>
    normed spaces, <math|<around*|\<langle\>|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    the normed space equipped with the maximum norm [see <reference|norm of
    finite product of normed spaces>], <math|U\<subseteq\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|i>>
    a open set, <math|V\<subseteq\>Y> a open set, <math|R\<subseteq\>Y>,
    <math|S\<subseteq\>Z> and <math|f:U\<rightarrow\>R> and
    <math|g:V\<rightarrow\>S> functions and
    <math|x\<in\>U<big|cap>f<rsup|-1><around*|(|V|)>> such that <math|f> is
    differentiable at <math|x> and <math|g> is differentiable at
    <math|f<around*|(|x|)>> then <math|g\<circ\>f:U<big|cap>f<rsup|-1><around*|(|V|)>\<rightarrow\>S>
    [so that by the chain rule <reference|chain rule>] <math|g\<circ\>f> is
    differentiable at <math|x>] then <math|D<around*|(|g\<circ\>f|)><around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>D<rsub|i>g<around*|(|f<around*|(|x|)>|)>\<circ\>D<around*|(|\<pi\><rsub|i>\<circ\>f|)><around*|(|x|)>>.
  </corollary>
  ...
  <\proof>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|D<around*|(|g\<circ\>f|)><around*|(|x|)><around*|(|h|)>>|<cell|\<equallim\><rsub|<text|<reference|chain
      rule>>>>|<cell|<around*|(|D g<around*|(|f<around*|(|x|)>|)>\<circ\>D
      f<around*|(|x|)>|)><around*|(|h|)>>>|<row|<cell|>|<cell|=>|<cell|D
      g<around*|(|f<around*|(|x|)>|)><around*|(|D
      f<around*|(|x|)><around*|(|h|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|differentiability
      on products of metric spaces>>>>|<cell|<big|sum><rsub|i=1><rsup|n>D<rsub|i>g<around*|(|f<around*|(|x|)>|)><around*|(|<around*|(|D
      ...
      f<around*|(|x|)>|)><around*|(|h|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|differentiability
      of map to product of spaces>>>>|<cell|<big|sum><rsub|i=1><rsup|n>D<rsub|i>g<around*|(|f<around*|(|x|)>|)><around*|(|<around*|(|D
      <around*|(|\<pi\><rsub|i>\<circ\>f|)><around*|(|x|)>|)><around*|(|h|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=1><rsup|n><around*|(|D<rsub|i>g<around*|(|f<around*|(|x|)>|)>\<circ\>D<around*|(|\<pi\><rsub|i>\<circ\>f|)><around*|(|x|)>|)><around*|(|h|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<big|sum><rsub|i=1><rsup|n>D<rsub|i>g<around*|(|f<around*|(|x|)>|)>\<circ\>D<around*|(|\<pi\><rsub|i>\<circ\>f|)><around*|(|x|)>|)><around*|(|h|)>>>>>
    </eqnarray*>

    proving that

    <\equation*>
      D<around*|(|g\<circ\>f|)><around*|(|x|)>=<big|sum><rsub|i=1><rsup|n>D<rsub|i>g<around*|(|f<around*|(|x|)>|)>\<circ\>D<around*|(|\<pi\><rsub|i>\<circ\>f|)><around*|(|x|)>
    </equation*>
  ...
  <\example>
    <label|Jacobian of linear map>Let <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>>,
    <math|<around*|\<langle\>|\<bbb-K\><rsup|n>,<around*|\<\|\|\>||\<\|\|\>><rsub|n>|\<rangle\>>>,
    <math|<around*|\<langle\>|\<bbb-K\><rsup|m>,<around*|\<\|\|\>||\<\|\|\>><rsub|m>|\<rangle\>>>
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|z\<in\>\<bbb-N\><rsub|0>>>We proceed here by induction so
      let <math|S=<around*|{|z\<in\>\<bbb-N\><rsub|0>\|\<ast\><rsup|z> has a
      derivate z\<cdot\>\<ast\><rsup|z-1>|}>> then we have\ 
      ...
      <item*|<math|z\<in\><around*|{|-z\|z\<in\>\<bbb-N\><rsub|0>|}>>>again
  ...
  <\definition>
    ...
    <math|\<infty\>>-differentiable if <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>>
    we have that <math|f> is <math|n>-differentiable.
  </definition>
  ...
  <\definition>
    ...
    that <math|f> is of class <math|C<rsup|n>>. Functions of class
  ...
  <\definition>
    ...
    then <math|f> has a <math|n>-the derivate <math|f<rsup|<around*|(|n|)>>>
    on <math|U> if one of the following is satisfied.
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|\<Rightarrow\>>>If <math|\<forall\>n\<in\>\<bbb-N\>> we
      have that <math|f> is of class <math|C<rsup|n>> then by definition we
      have that <math|f> is <math|n>-times differentiable proving that
      ...
      <math|n\<in\>\<bbb-N\><rsub|0>> we have that <math|f> is <math|n>-times
  ...
  <\proof>
    ...
    So if <math|m\<in\><around*|{|1,\<ldots\>,n|}>> take
  ...
  <\proposition>
    <label|C^n+m=\<gtr\>c^n is C^m>Let <math|n,m\<in\>\<bbb-N\><rsub|0>>,
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|U\<subseteq\>X> a open set, <math|V\<subseteq\>Y>
  ...
  <\proof>
    We prove this by induction so let <math|\<cal-S\><rsub|n>=<around*|{|m\<in\>\<bbb-N\><rsub|0>\|if
    ...
    <\description>
      ...
      <\equation>
        <label|eq 14.24.104>D<around*|(|D<rsup|n+m>f|)><text|
        exists<infix-and>is continuous with>
        D<rsup|n+<around*|(|m+1|)>>f=D<around*|(|D<rsup|n+m>f|)>
      </equation>
  ...
  <\corollary>
    <label|C^n=\<gtr\>C^n is C^1>Let <math|n\<in\>\<bbb-N\><rsub|0>> with
  ...
  <\proof>
    Take <math|m=n-k> then <math|m\<in\>\<bbb-N\><rsub|0>> so that
    <math|n=m+k> hence by <reference|C^n+m=\<gtr\>c^n is C^m> we have that
  ...
  <\proof>
    ...
    <\description>
      ...
      <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>> we have that
      ...
      <\equation>
        ...
        >n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}> then D<rsup|1>f is
        <around*|(|n-1|)><text|-times differentiable and>
  ...
  <\proof>
    ...
    <math|C<rsup|\<infty\>>> then for <math|n\<in\>\<bbb-N\><rsub|0>> we have
    either
    ...
    So <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> we have that <math|f> is of
    class <math|C<rsup|n>> proving that <math|f> is of class
    <math|C<rsup|\<infty\>>>. On the other side if <math|f> is of class
    <math|C<rsup|\<infty\>>> then given <math|n\<in\>\<bbb-N\>> we have that
    <math|f> is of class <math|C<rsup|n+1>> and using <reference|if f is C^n
    then D^1f is C^n-1> we have that <math|D<rsup|1>f> exists and
  ...
  <\theorem>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>> and <math|f:U\<rightarrow\>V<rsub|f>>,
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|if f,g are
      n<text|-times differentiable then >f+g is n<text|->times differentiable
      with D<rsup|n><around*|(|f+g|)>=D<rsup|n>f+D<rsup|n>g|}>> then we have\ 
      ...
      <item>We prove this by induction so let
      <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|if f is
  ...
  <\proof>
    We prove this by induction so let <math|S=<around*|{|k\<in\>\<bbb-N\><rsub|0>\|if
  ...
  <\theorem>
    ...
    and we have <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> that
  ...
  <\proof>
    ...
    <\description>
      ...
      <item*|<math|n\<in\>\<bbb-N\><rsub|0>>>We proceed then by induction,
      let <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|then
      ...
      So <math|\<forall\>n\<in\>\<bbb-N\>> we have that <math|C<rsub|U,Y,y>>
      is of class <math|C<rsup|n>> proving that <math|C<rsub|U,Y,y>> is of
      class <math|C<rsup|\<infty\>>> and <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>>
      <math|><math|D<rsup|n>C<rsub|U,Y,y>=C<rsub|U,L<rsup|n><around*|(|X,Y|)>,0>>.
    </description>
  </proof>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <item><math|\<forall\>n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>> then
      <math|D<rsup|n>L=C<rsub|X,L<rsup|n><around*|(|X;Y|)>,0>>\ 
    </enumerate>
  </theorem>

  <\proof>
    Let <math|n\<in\>\<bbb-N\><rsub|0>> then we have the following possible
    cases to consider
    ...
    <\description>
      ...
      <item*|<math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>>>Using (1) it
      follows that <math|D<rsup|1>L=C<rsub|X,L<around*|(|X,Y|)>,L>>. Next\ 
    ...
    As <math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> <math|D<rsup|n>L> exists we
    have using <reference|C^@@=@@-times differentiable> that <math|L> is of
  ...
  <\corollary>
    ...
    <math|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>,
    <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>> of normed vector spaces
    then given <math|i\<in\><around*|{|1,\<ldots\>,n|}>> and
  ...
  <\proposition>
    ...
    <\enumerate>
      ...
      <item><math|\<forall\>n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>> we
      have <math|D<rsup|n>\<tau\><rsub|x<rsub|0>>=C<rsub|X,L<rsup|n><around*|(|X;Y|)>,0>>
    </enumerate>
  </proposition>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <item>Let <math|x\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>> we have\ 
  ...
  <\proof>
    ...
    <\description>
      ...
      <\equation>
        <label|eq 14.26.101>D<rsup|1>L<text| is continuous>
      </equation>
  ...
  <\theorem>
    ...
    is <math|C<rsup|\<infty\>>> with <math|D<rsup|1>
    \<pi\><rsub|i>=C<rsub|<big|prod><rsub|j\<in\><around*|{|1,\<ldots\>,n|}>>X<rsub|j>,X<rsub|i>,\<pi\><rsub|i>>>
  </theorem>
  ...
  <\theorem>
    ...
    is r-times differentiable and then <math|\<pi\><rsub|i>\<circ\>D<rsup|r>f=D<rsup|r><around*|(|\<pi\><rsub|i>\<circ\>f|)>>
    [or equivalently <math|D<rsup|r>f=<around*|(|D<rsup|r><around*|(|\<pi\><rsub|1>\<circ\>f|)>,\<ldots\>,D<rsup|r><around*|(|\<pi\><rsub|n>\<circ\>f|)>|)>>]
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\equation>
        <label|eq 14.28.101><around*|(|\<circ\>|)> <text|is of class>
        C<rsup|\<infty\>>
      </equation>
      ...
      <\equation>
        <label|eq 14.30.101>If f,g <text|are over clas>s C<rsup|1>
        <text|then> h <text|is continuous>
      </equation>
  ...
  <\theorem>
    ...
    <\enumerate>
      <item><math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> if <math|f,g> are
      <math|n>-times differentiable then <math|g\<circ\>f:U<big|cap>f<rsup|-1><around*|(|V|)>\<rightarrow\>Z>
      is <math|n>-times differentiable

      <item><math|\<forall\>n,m\<in\>\<bbb-N\><rsub|0>> if <math|f> is
      <math|n>-times differentiable and <math|g> is <math|m>-times
      differentiable then <math|g\<circ\>f:U<big|cap>f<rsup|-1><around*|(|V|)>\<rightarrow\>Z>
      is <math|min<around*|(|n,m|)>>-times differentiable.

      <item><math|\<forall\>n\<in\>\<bbb-N\>> if <math|f,g> are of class
      <math|C<rsup|n>> then <math|g\<circ\>f:U<big|cap>f<rsup|-1><around*|(|V|)>\<rightarrow\>Z>
      is of class <math|C<rsup|n>>.

      <item><math|\<forall\>n,m\<in\>\<bbb-N\>> if <math|f> is of class
      <math|C<rsup|n>> and <math|g> is of class <math|C<rsup|m>> then
  ...
  <\lemma>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>,n\<gtr\>1> \ and <math|f:U\<rightarrow\>V>
    a n-times differentiable function [or <math|f> is of class
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 14.31.101>\<varphi\><rsub|v> is
      <around*|(|n-1|)><text|<text|-times >differentiabl>e <around*|[|or
      \<varphi\><rsub|v> is C<rsup|n-1>|]>
    </equation>
    ...
    <\equation>
      ...
      <text|is defined by> D<rsup|1>\<varphi\><rsub|v><around*|(|x|)>=<around*|(|D<rsup|2>f<around*|(|x|)>,C<rsub|X,X,0>|)>
    </equation>
    ...
    <\equation>
      ...
      <around*|(|n-1|)><text|<text|-times >differentiable> <around*|[|or
      C<rsup|n-1>|]>
    </equation>
  ...
  <\theorem>
    ...
    <math|r\<in\>\<bbb-N\>>, <math|A\<subseteq\>Y>, <math|B\<subseteq\>Z> and
    <math|f:S\<rightarrow\>A>, <math|g:T\<rightarrow\>B> functions of class
    <math|C<rsup|r>> then <math|g\<circ\>f:S<big|cap>f<rsup|-1><around*|(|T|)>>
    is <math|C<rsup|r>> on <math|S>.
  </theorem>
  ...
  <\proof>
    ...
    <\description>
      ...
      <\equation>
        ...
        <text|exists<infix-and>><around*|(|f<rsup|U>|)><rprime|'>:U\<rightarrow\>\<bbb-R\><text|
        is continuous>
      </equation>
      ...
      <\enumerate-alpha>
        ...
        <\equation>
          ...
          <around*|(|f<rsub|\|<around*|]|a,b|[>>|)><rprime|'><around*|(|x|)><text|
          and ><around*|(|f<rsub|\|<around*|]|a,b|[>>|)><rprime|'><around*|(|x|)>=<around*|(|f<rsup|U>|)><rprime|'><around*|(|x|)>.
        </equation>
        ...
        <\equation>
          <label|eq 14.40.102>f<rprime|'><rsub|+><around*|(|a|)> <text|exists
          and that> f<rprime|'><rsub|+><around*|(|a|)>=<around*|(|f<rsup|U>|)><rprime|'><around*|(|a|)>
        </equation>
        ...
        <\equation>
          ...
          <text|exists<infix-and>that> f<rprime|'><rsub|+><around*|(|b|)>=<around*|(|f<rsup|U>|)><rprime|'><around*|(|b|)>
        </equation>
        ...
        <\equation>
          <label|eq 14.44.102.1>f<rprime|'> <text|is continuous in the
          subspace topology on> <around*|[|a,b|]>
        </equation>
      </enumerate-alpha>
      ...
      <\equation>
        ...
        <text|exists and> <around*|(|f<rsup|<around*|]|a-1,b+1|[>>|)><rprime|'><around*|(|x|)>=<choice|<tformat|<table|<row|<cell|f<rprime|'><rsub|+><around*|(|a|)>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\equation*>
        ...
        and >\<forall\>x\<in\><around*|[|x<rsub|0>,x<rsub|0>+\<delta\>|[>
      ...
      <\equation*>
        \<forall\>x\<in\><around*|]|x<rsub|0>-\<delta\>,x<rsub|0><rsub|>|]>
        f<rprime|'><around*|(|x|)>\<geqslant\>f<rprime|'><around*|(|x<rsub|0>|)>=0<text|
        and >\<forall\>x\<in\><around*|[|x<rsub|0>,x<rsub|0>+\<delta\>|[>
  ...
  <\proof>
    ...
    <\description>
      ...
      <\equation>
        ...
        <text|we have> f<around*|(|x<rsub|0>|)>\<leqslant\>f<around*|(|x|)>
      </equation>
      ...
      <\equation>
        <label|eq 14.57.103>\<forall\>x\<in\><around*|]|x<rsub|0>-\<delta\>,x<rsub|0>+\<delta\>|[>\<subseteq\>U<text|
  ...
  <\proof>
    ...
    <\description>
      ...
      <\description>
        ...
        <\equation>
          <label|eq 14.66.103>\<forall\>y\<in\><around*|[|x,x+h|]> <text|we
          have> <around*|\<\|\|\>|f<around*|(|y|)>-f<around*|(|x|)>|\<\|\|\>>\<less\><frac|\<varepsilon\>|2>
        </equation>
        ...
        <\equation>
          <label|eq 14.67.103>\<forall\>y\<in\><around*|[|x+h,x|]> <text|we
          have> <around*|\<\|\|\>|f<around*|(|y|)>-f<around*|(|x|)>|\<\|\|\>>\<leqslant\><frac|\<varepsilon\>|2>
        </equation>
  ...
  <\proof>
    ...
    <math|\<rho\>:\<bbb-N\>\<rightarrow\>E> \ Take now
    ...
    <\equation>
      ...
      if <around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<beta\>|}>=\<emptyset\>>>|<row|<cell|<big|sum><rsub|n\<in\><around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<beta\>|}>><frac|1|2<rsup|n>>
      if \ <around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<beta\>|}>\<neq\>\<emptyset\>>>>>>
    </equation>

    [note that by <smart-ref|consequence of the archimedean property for the
    reals> <math|<around*|{|i\<in\>\<bbb-N\>\|\<sigma\><around*|(|i|)>\<less\>\<beta\>|}>>
    is finite as there exists a <math|n\<in\>\<bbb-N\><rsub|0>> such that
    <math|\<beta\>\<leqslant\>n> hence <math|<around*|{|i\<in\>\<bbb-N\><rsub|0><rsub|i>\|\<sigma\><around*|(|i|)>\<less\>\<beta\>|}>\<subseteq\><around*|{|1,\<ldots\>,n|}>>]
    \ and
    ...
    <math|\<rho\><around*|(|\<bbb-N\>|)>=E\<subseteq\><around*|[|a,b|]>\<Rightarrow\>\<forall\>i\<in\>\<bbb-N\>
    a\<leqslant\>\<rho\><around*|(|i|)>> so that
    <math|<around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>a|}>=\<emptyset\>>]
    it follows that\ 
    ...
    <\equation>
      <label|eq 13.52.317>\<forall\>\<beta\>\<in\>A<rsub|\<varepsilon\>>
      <text|we have> <around*|[|a,\<beta\>|]>\<subseteq\>A<rsub|\<varepsilon\>>
    </equation>
    ...
    <\equation>
      ...
      <text|where> \<sigma\>=sup<around*|(|A<rsub|\<varepsilon\>>|)>
    </equation>
    ...
    <\description>
      <item*|<math|><math|<around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<alpha\>|}>=\<emptyset\>>>then
      <math|\<xi\><around*|(|\<alpha\>|)>=0\<leqslant\>\<xi\><around*|(|\<beta\>|)>>

      <item*|<math|<around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<alpha\>|}>\<neq\>\<emptyset\>>>then
      <math|<around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<beta\>|}>\<neq\>\<emptyset\>>
      and <math|\<xi\><around*|(|\<alpha\>|)>=<big|sum><rsub|n\<in\><around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<alpha\>|}>><frac|1|2<rsup|n>>\<leqslant\><big|sum><rsub|n\<in\><around*|{|i\<in\>\<bbb-N\>\|\<rho\><around*|(|i|)>\<less\>\<beta\>|}>><frac|1|2<rsup|n>>=\<xi\><around*|(|\<beta\>|)>>
    </description>
    ...
    <\equation>
      ...
      <text|with> \<alpha\>\<leqslant\>\<beta\> <text|we have>
    ...
    <\equation>
      ...
      <text|we have> \<varphi\><around*|(|\<beta\>|)>-\<varphi\><around*|(|a|)>\<less\>\<varphi\><around*|(|\<sigma\>|)>-\<varphi\><around*|(|a|)>+<frac|\<xi\>|2>
    </equation>
    ...
    <\description>
      ...
      By the continuity of <math|f,\<varphi\>> at <math|\<sigma\>> together
      with <math|\<sigma\>\<less\>b> there exists
      ...
      <\eqnarray*>
        ...
        13.56.317>>>>|<cell|<frac|\<varepsilon\>|2>\<cdot\><frac|1|2<rsup|m>>+\<varphi\><around*|(|\<sigma\>|)>-\<varphi\><around*|(|a|)>+\<varepsilon\>\<cdot\><around*|(|\<sigma\>-a|)>+\<varepsilon\>\<cdot\>\<cal-E\><around*|(|\<sigma\>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|\<varepsilon\>|2>\<cdot\><frac|1|2<rsup|m>>+\<varphi\><around*|(|\<xi\>|)>-\<varphi\><around*|(|a|)>+\<varphi\><around*|(|\<sigma\>|)>-\<varphi\><around*|(|\<xi\>|)>+\<varepsilon\>\<cdot\><around*|(|\<sigma\>-a|)>+\<varepsilon\>\<cdot\>\<cal-E\><around*|(|\<sigma\>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|<frac|\<varepsilon\>|2>\<cdot\><frac|1|2<rsup|m>>+\<varphi\><around*|(|\<xi\>|)>-\<varphi\><around*|(|a|)>+<around*|\||\<varphi\><around*|(|\<sigma\>|)>-\<varphi\><around*|(|\<xi\>|)>|\|>+\<varepsilon\>\<cdot\><around*|(|\<sigma\>-a|)>+\<varepsilon\>\<cdot\>\<cal-E\><around*|(|\<sigma\>|)>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|<frac|\<varepsilon\>|2>\<cdot\><frac|1|2<rsup|m>>+\<varphi\><around*|(|\<xi\>|)>-\<varphi\><around*|(|a|)>+<frac|\<varepsilon\>|2>\<cdot\><frac|1|2<rsup|m>>+\<varepsilon\>\<cdot\><around*|(|\<sigma\>-a|)>+\<varepsilon\>\<cdot\>\<cal-E\><around*|(|\<sigma\>|)>>>|<row|<cell|>|<cell|=>|<cell|\<varphi\><around*|(|\<xi\>|)>-\<varphi\><around*|(|a|)>+\<varepsilon\>\<cdot\><around*|(|\<sigma\>-a|)>+\<varepsilon\>\<cdot\><frac|1|2<rsup|m>>+\<varepsilon\>\<cdot\><big|sum><rsub|n\<in\><around*|{|i\<in\>\<bbb-N\><rsub|0>\|\<rho\><around*|(|i|)>\<less\>\<sigma\>|}>><frac|1|2<rsup|n>>>>|<row|<cell|>|<cell|\<equallim\><rsub|\<sigma\>=\<rho\><around*|(|m|)>>>|<cell|\<varphi\><around*|(|\<xi\>|)>-\<varphi\><around*|(|a|)>+\<varepsilon\>\<cdot\><around*|(|\<sigma\>-a|)>+\<varepsilon\>\<cdot\><big|sum><rsub|n\<in\><around*|{|i\<in\>\<bbb-N\><rsub|0>\|\<rho\><around*|(|i|)>\<leqslant\>\<sigma\>|}>><frac|1|2<rsup|n>>>>|<row|<cell|>|<cell|\<leqslant\><rsub|\<sigma\>\<less\>\<xi\>>>|<cell|\<varphi\><around*|(|\<xi\>|)>-\<varphi\><around*|(|a|)>+\<varepsilon\>\<cdot\><around*|(|\<sigma\>-a|)>+\<varepsilon\>\<cdot\><big|sum><rsub|n\<in\><around*|{|i\<in\>\<bbb-N\><rsub|0>\|\<rho\><around*|(|i|)>\<less\>\<xi\>|}>><frac|1|2<rsup|n>>
        >>|<row|<cell|>|<cell|\<leqslant\><rsub|\<rho\><around*|(|m|)>=\<sigma\>\<less\>\<xi\>\<Rightarrow\><around*|{|i\<in\>\<bbb-N\><rsub|0>\|\<rho\><around*|(|i|)>\<less\>\<xi\>|}>\<neq\>\<emptyset\>>>|<cell|\<varphi\><around*|(|\<xi\>|)>-\<varphi\><around*|(|a|)>+\<varepsilon\>\<cdot\><around*|(|\<xi\>-a|)>+\<varepsilon\>\<cdot\>\<cal-E\><around*|(|\<xi\>|)>>>>>
      </eqnarray*>
  ...
  <\lemma>
    <label|evaluation operator (1)>Let <math|n\<in\>\<bbb-N\><rsub|0>>,
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
  ...
  <\proof>
    ...
    <\equation*>
      e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n>> <text|is linear>
    </equation*>
    ...
    <\equation*>
      e<rsub|v<rsub|1>,\<ldots\>,v<rsub|n> > <text|is continuous>
    </equation*>
  ...
  <\lemma>
    <label|lemma 14.119>Let <math|n\<in\>\<bbb-N\><rsub|0>> with
    <math|n\<geqslant\>2>, <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 14.104.104>g <text|is of class> C<rsup|1>
    </equation>
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 14.108.104>g <text|is of class> C<rsup|2>
    </equation>
  ...
  <\lemma>
    <label|lemma 14.121>Let <math|n\<in\>\<bbb-N\><rsub|0>> with
    <math|1\<less\>n>, <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>
  ...
  <\definition>
    <label|partial differential on U>Let <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>>,
  ...
  <\proof>
    We prove this by induction so let <math|\<cal-S\>=<around*|{|m\<in\>\<bbb-N\><rsub|0>\|if
    ...
    <\description>
      ...
      <\equation>
        <label|eq 14.126.106>\<Psi\><around*|(|L|)> <text|is multilinear>
      </equation>
      ...
      <\equation>
        <label|eq 14.131.106>\<forall\>x\<in\>U <text|we have that>
      ...
      <\equation>
        <label|eq 14.135.106.1><text|if> f is C<rsup|m+1> <text|then>
        D<rsup|m+1><rsub|i<rsub|m+1>...i<rsub|1>>f <text|is continuous>
      </equation>
  ...
  <\theorem>
    <label|differential of function of many variables>Let
    <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>>,
    <math|m\<in\>\<bbb-N\><rsub|0>>, <math|<around*|{|<around*|\<langle\>|X<rsub|i>,<around*|\<\|\|\>||\<\|\|\>><rsub|i>|\<rangle\>>|}><rsub|i\<in\><around*|{|1,\<ldots\>,n|}>>>
    a finite family of normed spaces, <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 14.146.106>D f<around*|(|x|)> <text|exists and >D
  ...
  with theroem <reference|differential of function of many variables> gives
  ...
  <\definition>
    Let <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>,m\<in\>\<bbb-N\><rsub|0>>,
    <math|<around*|\<langle\>|\<bbb-K\><rsup|n>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
  ...
  <\theorem>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>\\<around*|{|1|}>>,
    <math|m\<in\>\<bbb-N\><rsub|0>>, <math|<around*|\<langle\>|\<bbb-K\><rsup|n>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    be the vector space <math|\<bbb-K\><rsup|n>> with the maximum norm,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
  ...
  <\proof>
    We prove this by induction so let <math|\<cal-S\>=<around*|{|m\<in\>\<bbb-N\><rsub|0>\|<around*|{|i<rsub|j>|}><rsub|j\<in\><around*|{|1,\<ldots\>,m|}>>\<subseteq\><around*|{|1,\<ldots\>,n|}>,f:U\<rightarrow\>V
    ...
    <\description>
      ...
      <\equation>
        ...
        <text|is continuous then> \<partial\><rsup|1><rsub|i<rsub|1>,\<ldots\>,i<rsub|1>>f
        <text|is continuous>
      </equation>
      ...
      14.149.107>>>\<partial\><rsup|m+1><rsub|i<rsub|m+1>,\<ldots\>,i<rsub|1>>f<around*|(|x|)>>
      ...
      <\equation>
        ...
        <text|is continuous if> D<rsup|m+1><rsub|i<rsub|m+1>,\<ldots\>,i<rsub|1>>f
        <text|is continuous>
      </equation>
  ...
  <\lemma>
    ...
    <math|n\<in\>\<bbb-N\><rsub|0>> then if
    <math|<around*|\<\|\|\>||\<\|\|\>>> is the norm on
    <math|L<around*|(|X,X|)>> we have
  ...
  <\proof>
    ...
    <\enumerate>
      <item>We use induction so let <math|\<cal-S\>=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|H<rsup|n><text|
  ...
  <\proof>
    ...
    <\equation>
      ...
      <text|is convergent and ><around*|\<\|\|\>|<big|sum><rsub|i=1><rsup|\<infty\>>H<rsup|i><around*|(|x|)>|\<\|\|\>><rsub|X>\<leqslant\><frac|<around*|\<\|\|\>|H|\<\|\|\>>\<cdot\><around*|\<\|\|\>|x|\<\|\|\>><rsub|X>|1-<around*|\<\|\|\>|H|\<\|\|\>>>
    </equation>
    ...
    <\proof>
      Let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|<around*|(|\<bbb-1\><rsub|X>-H|)>\<circ\><around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)>=<around*|(|\<bbb-1\><rsub|X>-H<rsup|n+1>|)>|}>>
      then we have:
    ...
    <\proof>
      Let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|<around*|(|\<bbb-1\><rsub|X>+<big|sum><rsub|i=1><rsup|n>H<rsup|i>|)>\<circ\><around*|(|\<bbb-1\><rsub|X>-H|)>=\<bbb-1\><rsub|X>-H<rsup|n+1>|}>>
      then we have :
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\equation*>
        \<cal-G\>L<around*|(|X|)> <text|is a open set in> L<around*|(|X,X|)>
      </equation*>
      ...
      <\description>
        ...
        <\equation>
          <label|eq 14.171.110.2>\<varepsilon\> <text|is continuous at> 0
        </equation>
        ...
        <\equation>
          ...
          <text|we have that> \<varepsilon\><around*|(|H\<circ\>L<rsup|-1>|)>
          <text|is defined>
        </equation>
        ...
        <\equation>
          <label|eq 14.180.109>\<xi\><rprime|'> <text|is a>
      ...
      <\equation*>
        \<cal-X\> <text|is of class> C<rsup|\<infty\>>
      </equation*>
      ...
      <\equation>
        <label|eq 14.184.109>\<rho\> <text|is multilinear <around*|[|and thus
        bilinear|]>>
      </equation>
      ...
      <\equation>
        <label|eq 14.185.109>\<rho\> <text|is continuous>
      </equation>
      ...
      <\equation>
        <label|eq 14.186.109>\<rho\> <text|is of class> C<rsup|\<infty\>>
      </equation>
      ...
      We use now induction to prove that <math|\<forall\>n\<in\>\<bbb-N\>>
      <math|\<tau\>> is of class <math|C<rsup|n>> and thus by definition
      <math|C<rsup|\<infty\>>>. So let <math|\<b-S\>=<around*|{|n\<in\>\<bbb-N\>\|\<tau\>
      ...
      Mathematical induction proves then that <math|\<cal-S\>=\<bbb-N\>> and
      thus that\ 

      <\equation*>
        \<tau\> <text|is of class> C<rsup|\<infty\>>
      </equation*>
    </enumerate>
  ...
  <\proposition>
    ...
    <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>,
    <math|<around*|\<langle\>|Y,<around*|\<\|\|\>||\<\|\|\>><rsub|Y>|\<rangle\>>>
    be normed spaces, <math|r\<in\>\<bbb-N\>>,
  ...
  <\theorem>
    ...
    function of class <math|C<rsup|r>>, <math|r\<in\>\<bbb-N\><rsub|0>>.
    Assume that for a <math|x<rsub|0>\<in\>U> we have that <math|D
  ...
  <\proof>
    The proof is quite long and is done by proving several propositions and
    conjectures. First note that by the definition of the differential [see
    ...
    <\equation>
      <label|eq 12.87>D f<around*|(|x<rsub|0>|)><text| is a toplinear
      isomorphism>
    </equation>

    First we prove a more specific version of the the Inverse Function
    Theorem where <math|V=Y=X> that we will extend later to the more general
    case.

    <\proposition>
      <label|inverse theorem for Df(0)=1X>Let
      <math|<around*|\<langle\>|X,<around*|\<\|\|\>||\<\|\|\>><rsub|X>|\<rangle\>>>
      be a Banach space over <math|\<bbb-R\>>,
      <math|r\<in\>\<bbb-N\><rsub|0>>, <math|0\<in\>U\<subseteq\>X> an open
      set and <math|f:U\<rightarrow\>X> a differentiable function of class
      <math|C<rsup|r>> such that <math|D f<around*|(|0|)>=\<bbb-1\><rsub|X>>
      and <math|f<around*|(|0|)>=0> then <math|f> is a local diffeomorphism
      at <math|0>.
    </proposition>

    <\proof>
      Define <math|T=\<bbb-1\><rsub|X>-f:U\<rightarrow\>X> so that
      <math|T<around*|(|x|)>=\<bbb-1\><rsub|X><around*|(|x|)>-f<around*|(|x|)>>
      ...
      <\equation>
        <label|eq 12.88>D<rsup|1>T <text|is continuous on> U
        <around*|[|<text|as> 1\<leqslant\>r\<Rightarrow\>T <text|is of class>
        C<rsup|1>|]>
      </equation>
      ...
      <\equation>
        <label|eq 12.92>If x\<in\><wide|B|\<bar\>><rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,\<rho\>|)><text|
      ...
      <\proof>
        ...
        completeness of <math|X> are complete. Given
        ...
        \ <math|\<forall\>x\<in\><wide|B|\<bar\>><rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,\<sigma\>|)>\<subseteq\><rsub|\<sigma\>\<leqslant\>\<rho\>><wide|B|\<bar\>><rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,\<rho\>|)>>
        we have by <reference|eq 12.90> that
        <math|D<rsup|1>T<rsub|y><around*|(|x|)>\<less\><frac|1|2>>. Using the
        Mean Value Theorem <reference|Mean value theorem 2> gives

        <\equation>
          <label|eq 12.94>\<forall\>x<rsub|1>,x<rsub|2>\<in\><wide|B|\<bar\>><rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,\<sigma\>|)>
          <text|we have> <around*|\<\|\|\>|T<rsub|y><around*|(|x<rsub|1>|)>-T<rsub|y><around*|(|x<rsub|2>|)>|\<\|\|\>><rsub|X>\<leqslant\><frac|1|2>\<cdot\><around*|\<\|\|\>|x<rsub|1>-x<rsub|2>|\<\|\|\>><rsub|X>
        </equation>
      ...
      <\proof>
        ...
        <math|0\<less\>\<chi\>\<less\>\<rho\>> then
        <math|f<rsub|\|U<rsub|\<chi\>>>> is a bijection because\ 
        ...
        <\description>
          ...
          <\proof>
            ...
            <\eqnarray*>
              <tformat|<table|<row|<cell|<around*|\<\|\|\>|f<around*|(|x<rsub|1>|)>|\<\|\|\>><rsub|X>>|<cell|\<leqslant\>>|<cell|<around*|\<\|\|\>|f<around*|(|x|)>-f<around*|(|x<rsub|1>|)>|\<\|\|\>><rsub|X>+<around*|\<\|\|\>|f<around*|(|x|)>|\<\|\|\>><rsub|X>>>|<row|<cell|>|<cell|\<less\>>|<cell|\<varepsilon\>+<around*|\<\|\|\>|f<around*|(|x|)>|\<\|\|\>><rsub|X>>>|<row|<cell|>|<cell|\<equallim\><rsub|f<around*|(|x|)>=y>>|<cell|\<varepsilon\>+<around*|\<\|\|\>|y|\<\|\|\>><rsub|X>>>|<row|<cell|>|<cell|=>|<cell|<frac|\<chi\>|2>-<around*|\<\|\|\>|y|\<\|\|\>><rsub|X>+<around*|\<\|\|\>|y|\<\|\|\>><rsub|X>>>|<row|<cell|>|<cell|=>|<cell|<frac|\<chi\>|2>>>>>
            </eqnarray*>

            proving <math|f<around*|(|x<rsub|1>|)>\<in\><wide|B|\<bar\>><rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,<frac|\<chi\>|2>|)>>
      ...
      <\proof>
        ...
        <\equation>
          ...
          <text|we have> <around*|\<\|\|\>|x<rsub|1>-x<rsub|2>|\<\|\|\>><rsub|X>\<leqslant\>2\<cdot\><around*|\<\|\|\>|f<around*|(|x<rsub|1>|)>-f<around*|(|x<rsub|2>|)>|\<\|\|\>><rsub|X>
        </equation>
        ...
        <\equation>
          <label|eq 12.100>If y<rsub|1>,y<rsub|2>\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,<frac|\<chi\>|2>|)>
          <text|then> <around*|\<\|\|\>|g<around*|(|y<rsub|1>|)>-g<around*|(|y<rsub|2>|)>|\<\|\|\>><rsub|X>\<leqslant\>2\<cdot\><around*|\<\|\|\>|y<rsub|1>-y<rsub|2>|\<\|\|\>><rsub|X>
        </equation>
      ...
      <\proof>
        If <math|y\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,<frac|\<chi\>|2>|)>>
        ...
        14.199.111>>>U>. Further we have by <reference|eq 12.9> that <math|D
        ...
        <\equation>
          <label|eq 12.105.1>g<around*|(|y+h|)>-g<around*|(|y|)>-D
        ...
        follows from <reference|eq 12.105.1>
        ...
        <\eqnarray*>
          ...
          f<around*|(|g<around*|(|y|)>|)><rsup|-1><around*|(|\<zeta\><around*|(|g<around*|(|y+h|)>-g<around*|(|y|)>|)>|)>|\<\|\|\>><rsub|X>>>|<row|<cell|>|<cell|\<leqslant\>>|<cell|2\<cdot\><around*|\<\|\|\>|D
      ...
      Next we have to prove that <math|g> is of class <math|C<rsup|r>> to
      ...
      let <math|S=<around*|{|n\<in\>\<bbb-N\><rsub|0>\|if n\<leqslant\>r then
      g is C<rsup|n>|}>> then we have

      <\description>
        <item*|<math|1\<in\>\<cal-S\>>>Then using <reference|inverse mapping
        is c-infinite> we have that <math|\<tau\>> is
      ...
      <math|g> is <math|C<rsup|r>>. This proves that\ 

      <\equation>
        <label|eq 14.221.112>f<rsub|\|U<rsub|\<chi\>>>:U<rsub|\<chi\>>\<rightarrow\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,<frac|\<chi\>|2>|)>
        <text|is a diffeomorphism of class> C<rsup|r>
      </equation>
      ...
      <\equation>
        <label|eq 14.222.112>f<around*|(|0|)>\<in\>B<rsub|<around*|\<\|\|\>||\<\|\|\>><rsub|X>><around*|(|0,<frac|\<chi\>|2>|)><text|
        and >0\<in\>U<rsub|\<chi\>>
      </equation>

      From <reference|eq 14.221.112> and <reference|eq 14.222.112> it follows
      that <math|f> is a local <math|C<rsup|r>> diffeomorphism at <math|0>
      which proves this proposition [see <reference|inverse theorem for
      Df(0)=1X>].
    </proof>
    ...
    <\proof>
      ...
      <\equation>
        ...
        X with 0\<in\>U<rsub|0>,0=h<around*|(|0|)>\<in\>V<rsub|0><rprime|'>
        and h<rsub|\|U<rsub|0>>:U<rsub|0>\<rightarrow\>V<rprime|'><rsub|0>
      ...
      <\equation*>
        V<rsub|0>=D f<around*|(|0|)><around*|(|V<rprime|'><rsub|0>|)>
        <text|is open in> X
      </equation*>
      ...
      <math|C<rsup|r>>. This with the fact that <math|0\<in\>U<rsub|0>> and
      <math|f<around*|(|0|)>=0\<in\>V<rsub|0>> proves that <math|f> is a
      local diffeomorphism at <math|0>.
    </proof>
    ...
    <\proposition>
      ...
      <math|r\<in\>\<bbb-N\><rsub|0>>. Assume that for a
    ...
    <\proof>
      ...
      <\equation>
        <label|eq 14.225.111><text|Given> y\<in\>Y <text|define>
      ...
      <\equation>
        <label|eq 14.227.111>\<forall\>y\<in\>Y \ t<rsup|Y><rsub|y> <text|is
        a diffeomorphism of class> C<rsup|\<infty\>><text| and >D
      ...
      <\equation>
        <label|eq 14.228.111>\<forall\>y\<in\>X \ t<rsup|X><rsub|y> <text|is
        a diffeomorphism of class> C<rsup|\<infty\>><text| and >D
      ...
      <math|0\<in\>U<rprime|'><rsub|0>>, <math|0\<in\>V<rprime|'><rsub|0>>
      and

      <\equation>
        <label|eq 14.231.111>h<rsub|\|U<rprime|'><rsub|0>>:U<rprime|'><rsub|0>\<rightarrow\>V<rprime|'><rsub|0>
        <text|is a diffeomorphisme of class> C<rsup|r>
      </equation>
      ...
      <\equation>
        <label|eq 14.232.111>g <text|is a diffeomorphism of class> C<rsup|r>
      </equation>
      ...
      <\equation>
        <label|eq 14.233.111>g=f<rsub|\|U<rsub|x<rsub|0>>> <text|is a
        diffeomorphism of class> C<rsup|r>
      </equation>

      Next from <math|0\<in\>U<rprime|'><rsub|0>> we have that
      ...
      <\equation>
        <label|eq 14.234.111>x<rsub|0>\<in\>U<rsub|x<rsub|0>><text| and
        >f<around*|(|x<rsub|0>|)>\<in\>V<rsub|f<around*|(|x<rsub|0>|)>>
      </equation>
      ...
      <\equation*>
        f \ <text|is a local diffeomorphism of class> C<rsup|r> at x<rsub|0>
      </equation*>
  ...
  <\corollary>
    ...
    have that <math|f<rprime|'><around*|(|x|)>> exists, is continuous and for
    <math|x<rsub|0>\<in\>U> we have that <math|f<rprime|'><around*|(|x<rsub|0>|)>\<neq\>0>
    then there exists open sets <math|U<rprime|'>,V<rprime|'>> with
    ...
    has a derivative <math|<around*|(|<around*|(|f<rsub|\|U<rprime|'>><rsup|>|)><rsup|-1>|)><rprime|'><around*|(|x|)>>
    at every <math|x\<in\>V<rprime|'>> such that
    <math|<around*|(|<around*|(|f<rsub|\|U<rprime|'>><rsup|>|)><rsup|-1>|)><rprime|'><around*|(|x|)>\<cdot\>f<rprime|'><around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1><around*|(|x|)>|)>=1>.
  </corollary>

  <\proof>
    Using <reference|C1 of real or complex function> we have from the
    hypothese that\ 

    <\equation>
      <label|eq 14.237.112>f is C<rsup|1><text| and >f<rprime|'>=D
      f<around*|(|\<ast\>|)><around*|(|1|)>
    </equation>

    As <math|f<rprime|'><around*|(|x<rsub|0>|)>\<neq\>0> we can define the
    function <math|g:\<bbb-K\>\<rightarrow\>\<bbb-K\>> by
    <math|g<around*|(|t|)>=<frac|t|f<rprime|'><around*|(|x<rsub|0>|)>>> then
    we have <math|\<forall\>t\<in\>\<bbb-K\>> that

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|D
      f<around*|(|x<rsub|0>|)>\<circ\>g|)><around*|(|t|)>>|<cell|=>|<cell|D
      f<around*|(|x<rsub|0>|)><around*|(|g<around*|(|t|)>|)>>>|<row|<cell|>|<cell|=>|<cell|D
      f<around*|(|x<rsub|0>|)><around*|(|<frac|t|f<rprime|'><around*|(|x<rsub|0>|)>>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|t|f<rprime|'><around*|(|x<rsub|0>|)>>\<cdot\>D
      f<around*|(|x<rsub|0>|)><around*|(|1|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
      14.237.112>>>>|<cell|<frac|t|f<rprime|'><around*|(|x<rsub|0>|)>>\<cdot\>f<rprime|'><around*|(|x<rsub|0>|)><around*|(|1|)>>>|<row|<cell|>|<cell|=>|<cell|t>>|<row|<cell|>|<cell|=>|<cell|\<bbb-1\><rsub|\<bbb-K\>><around*|(|t|)>>>|<row|<cell|<around*|(|g\<circ\>D
      f<around*|(|x<rsub|0>|)>|)><around*|(|t|)>>|<cell|=>|<cell|g<around*|(|D
      f<around*|(|x<rsub|0>|)><around*|(|t|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|D
      f<around*|(|x<rsub|0>|)><around*|(|t|)>|f<rprime|'><around*|(|x<rsub|0>|)>>>>|<row|<cell|>|<cell|=>|<cell|<frac|D
      f<around*|(|x<rsub|0>|)><around*|(|t|)>|f<rprime|'><around*|(|x<rsub|0>|)>>>>|<row|<cell|>|<cell|=>|<cell|<frac|t\<cdot\>D
      f<around*|(|x<rsub|0>|)><around*|(|1|)>|f<rprime|'><around*|(|x<rsub|0>|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
      14.237.112>>>>|<cell|t>>|<row|<cell|>|<cell|=>|<cell|\<bbb-1\><rsub|\<bbb-K\>><around*|(|t|)>>>>>
    </eqnarray*>

    proving that <math|D f<around*|(|x<rsub|0>|)>\<circ\>g=\<bbb-1\><rsub|\<bbb-K\>>=g\<circ\>D
    f<around*|(|x<rsub|0>|)>> or\ 

    <\equation>
      <label|eq 14.238.112>D f<around*|(|x<rsub|0>|)> is a bijection with D
      f<around*|(|x<rsub|0>|)><rsup|-1>=g
    </equation>

    Using the Inverse Function Theorem [see <reference|inverse function
    theorem>] on <reference|eq 14.237.112> and <reference|eq 14.238.112>
    proves that <math|f> is a local diffeomorphism of class <math|C<rsup|1>>.
    Hence there exists a <math|U<rprime|'>>,<math|V<rprime|'>> open with
    <math|U<rprime|'>\<subseteq\>U>, <math|V<rprime|'>\<subseteq\>V> such
    that\ 

    <\equation>
      <label|eq 14.239.112>x<rsub|0>\<in\>U<rprime|'>\<wedge\>f<around*|(|x<rsub|0>|)>\<in\>V<rprime|'>
      <text|and> f<rsub|\|U<rprime|'>>:U<rprime|'>\<rightarrow\>V<rprime|'>
      <text|is a diffeomorphism>
    </equation>

    Let <math|x\<in\>V<rprime|'>> then <math|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1><around*|(|x|)>>
    exists, using <reference|diffeomorphism are toplinear> we have
    <math|D<around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1>|)><around*|(|x|)>\<circ\>D
    f<rsub|\|U<rprime|'>><around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1><around*|(|x|)>|)>=\<bbb-1\><rsub|<around*|\<\|\|\>||\<\|\|\>>>>
    hence\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|1>|<cell|=>|<cell|\<bbb-1\><rsub|<around*|\<\|\|\>||\<\|\|\>>><around*|(|1|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|D
      <around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1>|)><around*|(|x|)>\<circ\>D
      f<rsub|\|U<rprime|'>><around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1><around*|(|x|)>|)>|)><around*|(|1|)>>>|<row|<cell|>|<cell|=>|<cell|D
      <around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1>|)><around*|(|x|)><around*|(|D
      f<rsub|\|U<rprime|'>><around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1><around*|(|x|)>|)><around*|(|1|)>|)>>>|<row|<cell|>|<cell|=>|<cell|D
      <around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1>|)><around*|(|x|)><around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rprime|'><around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1><around*|(|x|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|f<rsub|\|U<rprime|'>>|)><rprime|'><around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1><around*|(|x|)>|)>\<cdot\>D
      <around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1>|)><around*|(|x|)><around*|(|1|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|f<rsub|\|U<rprime|'>>|)><rprime|'><around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1><around*|(|x|)>|)>\<cdot\><around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1>|)><rprime|'><around*|(|x|)>>>>>
    </eqnarray*>

    proving that\ 

    <\equation*>
      <around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1>|)><rprime|'><around*|(|x|)>\<cdot\><around*|(|f<rsub|\|U<rprime|'>>|)><rprime|'><around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1><around*|(|x|)>|)>=1
    </equation*>

    Using now the fact that the derivative is local [see
    <reference|derivative is local>] we have\ 

    <\equation*>
      <around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1>|)><rprime|'><around*|(|x|)>\<cdot\>f<rprime|'><around*|(|<around*|(|f<rsub|\|U<rprime|'>>|)><rsup|-1><around*|(|x|)>|)>=1
    </equation*>
  ...
  Function Theorem. First we need a little lemma.

  <\lemma>
    <label|T,S>Let <math|X,Y,Z> be vector spaces over the field
    <math|\<bbb-K\>>, <math|L\<in\>Hom<around*|(|X,Z|)>> and
    <math|H\<in\>Hom<around*|(|Y,Z|)>> such that
    <math|H<rsup|-1>\<in\>Hom<around*|(|Z,Y|)>> exists then
    <math|T:X\<times\>Y\<rightarrow\>X*\<times\>Z> defined by
    <math|<around*|(|x,y|)>\<rightarrow\><around*|(|x,L<around*|(|x|)>+H<around*|(|y|)>|)>>
    is a isomorphism with inverse \ <math|S:X\<times\>Z\<rightarrow\>X\<times\>Y>
    defined by <math|S<around*|(|x,y|)>=<around*|(|x,-H<rsup|-1><around*|(|L<around*|(|x|)>|)>+H<rsup|-1><around*|(|z|)>|)>>
    so that <math|T>\ 
  </lemma>

  <\proof>
    Take <math|<around*|(|x<rsub|1>,y<rsub|1>|)>,<around*|(|x<rsub|2>,y<rsub|2>|)>\<in\>X\<times\>Y>
    and <math|\<alpha\>,\<beta\>\<in\>\<bbb-K\>> then\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|T<around*|(|\<alpha\>\<cdot\>*<around*|(|x<rsub|1>,y<rsub|1>|)>+\<beta\>\<cdot\><around*|(|x<rsub|2>,y<rsub|2>|)>|)>>|<cell|=>|<cell|T<around*|(|\<alpha\>\<cdot\>x<rsub|1>+\<beta\>\<cdot\>x<rsub|2>,\<alpha\>\<cdot\>y<rsub|1>+\<beta\>\<cdot\>y<rsub|2>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\>x<rsub|1>+\<beta\>\<cdot\>x<rsub|2>,L<around*|(|\<alpha\>\<cdot\>x<rsub|1>+\<beta\>\<cdot\>x<rsub|2>|)>+H<around*|(|\<alpha\>\<cdot\>y<rsub|1>+\<beta\>\<cdot\>y<rsub|2>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\>x<rsub|1>+\<beta\>\<cdot\>x<rsub|2>,\<alpha\>\<cdot\>L<around*|(|x<rsub|1>|)>+\<beta\>\<cdot\>L<around*|(|x<rsub|2>|)>+\<alpha\>\<cdot\>H<around*|(|y<rsub|1>|)>+\<beta\>\<cdot\>H<around*|(|y<rsub|2>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<alpha\>\<cdot\>x<rsub|1>,\<alpha\>\<cdot\>L<around*|(|x<rsub|1>|)>+\<alpha\>\<cdot\>H<around*|(|y<rsub|1>|)>|)>+<around*|(|\<beta\>\<cdot\>x<rsub|2>,\<beta\>\<cdot\>L<around*|(|y<rsub|1>|)>+\<beta\>\<cdot\>H<around*|(|y<rsub|2>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\><around*|(|x<rsub|1>,L<around*|(|x<rsub|1>|)>+H<around*|(|y<rsub|1>|)>|)>+\<beta\>\<cdot\><around*|(|x<rsub|2>,L<around*|(|y<rsub|1>|)>+H<around*|(|y<rsub|2>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>T<around*|(|x<rsub|1>,y<rsub|1>|)>+\<beta\>\<cdot\>T<around*|(|x<rsub|2>,y<rsub|2>|)>>>>>
    </eqnarray*>
    ...
    First if <math|x\<in\>X>, <math|y\<in\>Y> and <math|z\<in\>Z> then

    <\eqnarray*>
      <tformat|<table|<row|<cell|T<around*|(|S<around*|(|x,z|)>|)>>|<cell|=>|<cell|T<around*|(|x,-H<rsup|-1><around*|(|L<around*|(|x|)>|)>+H<rsup|-1><around*|(|z|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x,L<around*|(|x|)>+H<around*|(|-H<rsup|-1><around*|(|L<around*|(|x|)>|)>+H<rsup|-1><around*|(|z|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x,L<around*|(|x|)>+-H<around*|(|H<rsup|-1><around*|(|L<around*|(|x|)>|)>|)>+H<around*|(|H<rsup|-1><around*|(|z|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x,L<around*|(|x|)>-L<around*|(|x|)>+z|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x,z|)>>>|<row|<cell|S<around*|(|T<around*|(|x,y|)>|)>>|<cell|=>|<cell|S<around*|(|x,L<around*|(|x|)>+H<around*|(|y|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x,-H<rsup|-1><around*|(|L<around*|(|x|)>|)>+H<rsup|-1><around*|(|L<around*|(|x|)>+H<around*|(|y|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x,-H<rsup|-1><around*|(|L<around*|(|x|)>|)>+H<rsup|-1><around*|(|L<around*|(|x|)>|)>+H<rsup|-1><around*|(|H<around*|(|y|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x,y|)>>>>>
    </eqnarray*>

    proving that <math|T> is a bijection with inverse <math|S>.
  </proof>
  ...
  <\theorem>
    ...
    <\enumerate>
      <item>There exists a open set <math|W<rsub|0>\<subseteq\>U\<times\>Z>
      and a open set <math|V<rsub|0>\<subseteq\>V> with
      \ <math|<around*|(|x<rsub|0,>f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>\<in\>W<rsub|0>>
      such that there exists a <math|C<rsup|r>> map
      <math|g:W<rsub|0><rsub|>\<rightarrow\>V<rsub|0>> such that
      <math|g<around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>=y<rsub|0>>
      and <math|\<forall\><around*|(|x,z|)>\<in\>W<rsub|0>>
      <math|f<around*|(|x<around*|(|g<around*|(|x,z|)>|)>|)>=z>.

      <item>If <math|h:W<rsub|0>\<rightarrow\>V<rsub|o>> such that
      <math|f<around*|(|x<around*|(|g<around*|(|x,z|)>|)>|)>=z> then
      <math|h=g> [so <math|g> is <with|font-series|bold|unique>]

      <item>Further <math|\<forall\><around*|(|x,z|)>\<in\>W<rsub|0>>\ 

      <\enumerate>
        <item><math|<around*|[|D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>|]><rsup|-1>>
        exist
  ...
  <\proof>
    First as we will have different project functions [see
    <reference|projection map is open and open>] we will use the following
    notations for the projection functions\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|>|<cell|\<pi\><rsup|X\<times\>Y><rsub|1>:X\<times\>Y\<rightarrow\>X<text|
      defined by > \<pi\><rsup|X\<times\>Y><rsub|1><around*|(|x,y|)>=x>|<cell|>>|<row|<cell|>|<cell|\<pi\><rsup|X\<times\>Y><rsub|2>:X\<times\>Y\<rightarrow\>Y<text|
      defined by >\<pi\><rsup|X\<times\>Y><rsub|2><around*|(|x,y|)>=y>|<cell|>>|<row|<cell|>|<cell|\<pi\><rsup|X\<times\>Z><rsub|1>:X\<times\>Z\<rightarrow\>X<text|
      defined by >\<pi\><rsup|X\<times\>Z><rsub|1><around*|(|x,y|)>=x>|<cell|>>|<row|<cell|>|<cell|\<pi\><rsup|X\<times\>Z><rsub|2>:X\<times\>Z\<rightarrow\>X<text|
      defined by >\<pi\><rsup|X\<times\>Z><rsub|2><around*|(|x,y|)>=y>|<cell|>>>>
    </eqnarray*>

    Note that by <reference|projection map is infinite times dimensions>,
    <reference|C^n is a local property> we have that

    <\equation>
      <label|eq 14.240.114>\<pi\><rsup|X\<times\>Y><rsub|1>,\<pi\><rsup|X\<times\>Y><rsub|2>,\<pi\><rsup|X\<times\>Z><rsub|1><text|
      and >\<pi\><rsup|X\<times\>Z><rsub|2> <text|and their restrictions to
      open sets \ are of class> C<rsup|\<infty\>>
    </equation>

    Define now

    <\equation>
      \<varphi\>:U\<times\>V\<rightarrow\>X\<times\>Z <text|by>
      \<varphi\><around*|(|x,y|)>=<around*|(|x,f<around*|(|x,y|)>|)>
    </equation>

    then <math|\<forall\><around*|(|x,y|)>\<in\>U\<times\>V> we have that\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|\<pi\><rsub|1><rsup|X\<times\>Z>\<circ\>\<varphi\>|)><around*|(|x,y|)>>|<cell|=>|<cell|\<pi\><rsub|1><rsup|X\<times\>Z><around*|(|\<varphi\><around*|(|x,y|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|1><rsup|X\<times\>Z><around*|(|x,f<around*|(|x,y|)>|)>>>|<row|<cell|>|<cell|=>|<cell|x>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsup|X\<times\>Y><rsub|1><around*|(|x,y|)>>>>>
    </eqnarray*>

    proving that <math|>

    <\equation>
      <label|eq 14.242.112>\<pi\><rsub|1><rsup|X\<times\>Z>\<circ\>\<varphi\>=<around*|(|\<pi\><rsub|1><rsup|X\<times\>Y>|)><rsub|\|U\<times\>V>
      <text|so by> <reference|eq 14.240.114><text| >
      \<pi\><rsub|1><rsup|X\<times\>Z>\<circ\>\<varphi\> is C<rsup|\<infty\>>
    </equation>

    Hence

    <\eqnarray*>
      <tformat|<table|<row|<cell|D<rsup|1><around*|(|\<pi\><rsub|1><rsup|X\<times\>Z>\<circ\>\<varphi\>|)><around*|(|x,y|)>>|<cell|=>|<cell|D<rsup|1><around*|(|<around*|(|\<pi\><rsup|X\<times\>Y>|)><rsub|\|U\<times\>V>|)><around*|(|x,y|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|projection
      map is infinite times dimensions>, <reference|C^n is a local property>
      >>>|<cell|\<pi\><rsup|X\<times\>Y><eq-number>>>>>
    </eqnarray*>

    Further we have that\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|\<pi\><rsup|X\<times\>Z><rsub|2>\<circ\>\<varphi\>|)><around*|(|x,y|)>>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|\<varphi\><around*|(|x,y|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|x,f<around*|(|x,y|)>|)>>>|<row|<cell|>|<cell|=>|<cell|f<around*|(|x,y|)>>>>>
    </eqnarray*>

    proving that

    <\equation>
      <label|eq 14.244.112>\<pi\><rsup|X\<times\>Z><rsub|2>\<circ\>\<varphi\>=f
      \ <text|a> C<rsup|r><text| function>
    </equation>

    and\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|D<rsup|1><around*|(|\<pi\><rsup|X\<times\>Z><rsub|2>\<circ\>\<varphi\>|)>>|<cell|=>|<cell|D<rsup|1>f>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|differentiability
      implies partial differentiability>>>>|<cell|D<rsup|><rsub|1>f<around*|(|x|)>\<circ\>\<pi\><rsub|1><rsup|X\<times\>Y>+D<rsup|><rsub|2>f<around*|(|x|)>\<circ\>\<pi\><rsub|2><rsup|X\<times\>Y><eq-number>>>>>
    </eqnarray*>

    Using <reference|C^n of multivalued functions> on <reference|eq
    14.242.112> and <reference|eq 14.244.112> gives

    <\equation>
      <label|eq 14.246.112>\<varphi\><text| is of class >C<rsup|r><text| and
      >\<pi\><rsub|1><rsup|X\<times\>Y>\<circ\>D<rsup|1>\<varphi\><around*|(|x,y|)>\<equallim\><rsub|<text|<reference|n-times
      differentiability of multi valued function>>>\<pi\><rsub|1><rsup|X\<times\>Y><text|
      and >\<pi\><rsub|2><rsup|X\<times\>Y>\<circ\>D<rsup|1>\<varphi\><around*|(|x,y|)>\<equallim\><rsub|<text|<reference|n-times
      differentiability of multi valued function>>>D<rsup|><rsub|1>f<around*|(|x|)>\<circ\>\<pi\><rsub|1><rsup|X\<times\>Y>+D<rsup|><rsub|2>f<around*|(|x|)>\<circ\>\<pi\><rsub|2>
    </equation>

    or

    <\equation>
      <label|eq 14.247.112.3>D<rsup|1>\<varphi\><around*|(|x,y|)><around*|(|r,s|)>\<equallim\><rsub|<text|<reference|n-times
      differentiability of multi valued function>>><around*|(|r,D<rsub|1>f<around*|(|x,y|)><around*|(|r|)>+D<rsub|2>f<around*|(|x,y|)><around*|(|s|)>|)>
    </equation>

    Using the above for <math|<around*|(|x<rsub|0>,y<rsub|0>|)>\<in\>U\<times\>V>
    gives <math|D<rsup|1>\<varphi\><around*|(|x<rsub|0>,y<rsub|0>|)><around*|(|x,y|)>=<around*|(|x,D<rsub|1>f<around*|(|x<rsub|0>,y<rsub|0>|)><around*|(|x|)>+D<rsub|2>f<around*|(|x<rsub|0>,y<rsub|0>|)><around*|(|y|)>|)>>.
    Using the lemma <reference|T,S> and the fact that
    <math|D<rsub|2>f<around*|(|x<rsub|0>,y<rsub|0>|)>> is a isomorphism
    proves that <math|D<rsup|1>\<varphi\><around*|(|x<rsub|0>,y<rsub|0>|)>>
    is a isomorphism. Using the Inverse Function Theorem [see
    <reference|inverse function theorem>] there exists open sets
    <math|<wide|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>|~>\<subseteq\>U\<times\>V,V<rsub|\<varphi\><around*|(|x<rsub|0>,y<rsub|0>|)>>\<subseteq\>X\<times\>Z>
    with <math|<around*|(|x<rsub|0>,y<rsub|0>|)>\<in\><wide|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>|~>>
    and <math|<around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>=\<varphi\><around*|(|x<rsub|0>,y<rsub|0>|)>\<in\><wide|V<rsub|\<varphi\><around*|(|x<rsub|0>,y<rsub|0>|)>>|~>>
    such that

    <\equation>
      <label|eq 14.248.113>\<varphi\><rsub|\|<wide|U<around*|(|x<rsub|0>,y<rsub|0>|)>|~>>:<wide|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>|~>\<rightarrow\><wide|V<rsub|\<varphi\><around*|(|x<rsub|0>,y<rsub|0>|)>>|~>
      <text|is a diffeomorphisme of class >C<rsup|r>
    </equation>

    Using the definition of the product topology on <math|X\<times\>Y> [see
    <reference|box topology> and <reference|finite product topology is box
    topology>] there exist open sets <math|U<rsub|0>\<subseteq\>X>,
    <math|V<rsub|0>\<subseteq\>Y> such that
    <math|<around*|(|x<rsub|0>,y<rsub|0>|)>\<in\>U<rsub|0>\<times\>V<rsub|0>\<subseteq\><wide|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>|~>>.
    Define then \ <math|W<rsub|0>=\<varphi\><around*|(|U<rsub|0>\<times\>V<rsub|0>|)>>
    then using <reference|diffeomorphism is a local property> together with
    <reference|eq 14.248.113> and the fact that
    <math|<around*|(|\<varphi\><rsub|\|<wide|U<around*|(|x<rsub|0>,y<rsub|0>|)>|~>>|)><rsub|\|U<rsub|0>\<times\>V<rsub|0>>\<equallim\><rsub|<text|<reference|restriction
    of restricted function>>>\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>>
    gives

    <\equation>
      <label|eq 12.128>\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>:
      U<rsub|0>\<times\>V<rsub|0>\<rightarrow\>W<rsub|0><text| is a
      diffeomorphisme of class > C<rsup|r>
    </equation>

    where

    <\equation>
      <label|eq 12.129>W<rsub|0>\<equallim\><rsub|def>\<varphi\><around*|(|U<rsub|0>\<times\>V<rsub|0>|)>\<subseteq\>U\<times\>Z
      <text| and > \<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>><around*|(|x<rsub|0>,y<rsub|0>|)>=<around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>\<in\>W<rsub|0>
    </equation>

    Also if <math|y\<in\>V<rsub|0>> then as <math|x<rsub|0>\<in\>U<rsub|0>>
    we have <math|<around*|(|x<rsub|0>,y|)>\<in\>U<rsub|0>\<times\>V<rsub|0>\<subseteq\><wide|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>|~>\<subseteq\>U\<times\>V>
    so that <math|y\<in\>V<rsub|0>> proving that\ 

    <\equation>
      V<rsub|0>\<subseteq\>V
    </equation>

    So <math|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1>:W<rsub|0>\<rightarrow\>U<rsub|0>\<times\>V<rsub|0>>
    exists and is <math|C<rsup|r>>. Hence if
    <math|<around*|(|x,z|)>\<in\>W<rsub|0>> then

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|x,z|)>>|<cell|=>|<cell|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<varphi\><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<varphi\><around*|(|\<pi\><rsup|X\<times\>Y><rsub|1><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>,\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<pi\><rsup|X\<times\>Y><rsub|1><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>,f<around*|(|\<pi\><rsup|X\<times\>Y><rsub|1><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>,\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>|)>|)>>>>>
    </eqnarray*>

    so that

    <\equation>
      <label|eq 14.249.112>x=\<pi\><rsup|X\<times\>Y><rsub|1><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>\<in\>\<pi\><rsub|1><rsup|X\<times\>Y><around*|(|U<rsub|0>\<times\>V<rsub|0>|)>=U<rsub|0>\<wedge\>z=f<around*|(|x,\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>|)>
    </equation>

    So if we take in account that <math|V<rsub|0>=\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|U<rsub|0>\<times\>V<rsub|0>|)>>
    we can define

    <\equation>
      <label|eq 12.130>g:<rsub|>W<rsub|0>\<rightarrow\>V<rsub|0><text| by
      >g<around*|(|x,z|)>=\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x,z|)>|)>
    </equation>

    Further

    <\equation>
      <label|eq 14.252.112.2>\<forall\><around*|(|x,z|)>\<in\>W<rsub|0><text|
      we have >f<around*|(|x,g<around*|(|x,z|)>|)>\<equallim\><rsub|<text|<reference|eq
      14.249.112> and <reference|eq 12.130>>>z
    </equation>

    As from <reference|eq 12.129> we have
    <math|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>><around*|(|x<rsub|0>,y<rsub|0>|)>=<around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>>
    it follows that <math|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>=<around*|(|x<rsub|0>,y<rsub|0>|)>\<Rightarrow\>y<rsub|0>=\<pi\><rsub|2><rsup|X\<times\>Y><around*|(|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1><around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>|)>=g<around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>>
    proving that
    ...
    <math|C<rsup|\<infty\>>> and <math|><math|<around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><rsup|-1>><space|1em>is
    ...
    So that point (1) of the theorem is proved.\ 

    To prove point (2) take <math|h:W<rsub|0>\<rightarrow\>V<rsub|0>> such
    that <math|\<forall\><around*|(|x,z|)>\<in\>W<rsub|o>>
    <math|f<around*|(|x,h<around*|(|x,z|)>|)>=z>. Let
    <math|<around*|(|x,z|)>\<in\>W<rsub|0>> then we have
    <math|f<around*|(|x,g<around*|(|x,z|)>|)>=z=f<around*|(|x,h<around*|(|x,z|)>|)>\<Rightarrow\>g<around*|(|x,z|)>=h<around*|(|x,z|)>>
    proving that <math|g=h>.\ 

    Now to prove <math|<around|(|3.a|)>> note that by <reference|eq 12.128>
    and <reference|diffeomorphism are toplinear> we have
    <math|\<forall\><around*|(|x,y|)>\<in\>U<rsub|0>\<times\>V<rsub|0>> that
    <math|D <around*|(|\<varphi\><rsub|\|U<rsub|<around*|(|x<rsub|0>,y<rsub|0>|)>>>|)><around*|(|x,y|)>>
    is bijective or using the fact that <math|D
    <around*|(|\<varphi\><rsub|\|U<rsub|0>\<times\>V<rsub|0>>|)><around*|(|x,y|)>\<equallim\><rsub|<text|<reference|differentiability
    and restricted mapping>>>D \<varphi\><around*|(|x,y|)>> we have\ 

    <\equation>
      <label|eq 14.256.112.3>\<forall\><around*|(|x,y|)>\<in\>U<rsub|0>\<times\>V<rsub|0><space|1em>D\<varphi\><around*|(|x,y|)>
      <text| is bijective>
    </equation>

    Take <math|r,s\<in\>Y> such that <math|D<rsub|2>f<around*|(|x,y|)><around*|(|r|)>=D<rsub|2>f<around*|(|x,y|)><around*|(|s|)>>
    then

    <\eqnarray*>
      <tformat|<table|<row|<cell|D\<varphi\><around*|(|x,y|)><around*|(|0,r|)>>|<cell|\<equallim\><rsub|<text|<reference|eq
      14.247.112.3>>>>|<cell|<around*|(|0,D<rsub|1>f<around*|(|x,y|)><around*|(|0|)>+D<rsub|2>f<around*|(|x,y|)><around*|(|r|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|0,D<rsub|1>f<around*|(|x,y|)><around*|(|0|)>+D<rsub|2>f<around*|(|x,y|)><around*|(|s|)>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
      14.247.112.3>>>>|<cell|D\<varphi\><around*|(|x,y|)><around*|(|0,s|)>>>>>
    </eqnarray*>

    proving as <math|D \<varphi\><around*|(|x,y|)>> is bijective that
    <math|<around*|(|0,r|)>=<around*|(|0,s|)>\<Rightarrow\>r=s> giving that

    <\equation>
      <label|eq 14.258.112.4>D<rsub|2>f<around*|(|x,y|)><text| is injective>
    </equation>

    If <math|z\<in\>Z> then as <math|D\<varphi\><around*|(|x,y|)>> is
    bijective there exists a <math|<around*|(|r,s|)>\<in\>X\<times\>Z> such
    that <math|D\<varphi\><around*|(|r,s|)>=<around*|(|0,z|)>\<Rightarrow\><around*|(|r,D<rsub|1>f<around*|(|x,y|)><around*|(|r|)>+D<rsub|2>f<around*|(|x,y|)><around*|(|s|)>|)>=<around*|(|0,z|)>>
    hence <math|r=0> and <math|D<rsub|1>f<around*|(|x,y|)><around*|(|0|)>+D<rsub|2>f<around*|(|x,y|)><around*|(|s|)>=z>
    or <math|D<rsub|2>f<around*|(|x,y|)><around*|(|s|)>=z>. So
    <math|D<rsub|2>f<around*|(|x,y|)>> is surjective which together with
    <reference|eq 14.258.112.4> proves\ 

    <\equation>
      <label|eq 14.259.112.4>\<forall\><around*|(|x,y|)>\<in\>U<rsub|0>\<times\>V<rsub|0><text|
      we have >D<rsub|2>f<around*|(|x,y|)><text| is bijective>
    </equation>

    Take now <math|<around*|(|x,z|)>\<in\>W<rsub|0>> then using <reference|eq
    14.249.112> we have <math|x\<in\>U<rsub|0>> and as by <reference|eq
    12.130> <math|g<around*|(|x,z|)>\<in\>V<rsub|0>> we have by the above
    that\ 

    <\equation>
      <label|eq 14.260.113>\<forall\>*<around*|(|x,y|)>\<in\>W<rsub|0><space|1em>
      D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)><text| is bijective so that
      ><around*|[|D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>|]><rsup|-1><text|
      exists>
    </equation>

    proving (3.a).

    Now to calculate the differentials of <math|g> define

    <\equation>
      <label|eq 12.131>\<psi\>:W<rsub|0>\<rightarrow\>X\<times\>Z by
      \<psi\><around*|(|x,z|)>=<around*|(|x,g<around*|(|x,z|)>|)>\ 
    </equation>

    then for <math|f\<circ\>\<psi\>:W<rsub|0>\<rightarrow\>Z> we have
    <math|<around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>=f<around*|(|\<psi\><around*|(|x,z|)>|)>=f<around*|(|x,g<around*|(|x,z|)>|)>\<equallim\><rsub|<text|<reference|eq
    14.252.112.2>>>z=\<pi\><rsup|X\<times\>Z><rsub|2><around*|(|x,z|)>>
    proving that

    <\equation>
      <label|eq 12.132>f\<circ\>\<psi\>=\<pi\><rsup|X\<times\>Z><rsub|2>
    </equation>

    Now as <math|<around*|(|<around*|(|f\<circ\>\<psi\>|)>\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>|)><around*|(|t|)>=\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|<around*|(|1\<rightarrow\><around*|(|x,z|)>|)><around*|(|t|)>|)>=\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|<around*|(|t,z|)>|)>=z=C<rsub|<around*|(|1\<rightarrow\><around*|(|x,z|)>|)><rsup|-1><around*|(|W<rsub|0>|)>,Z,z>>
    we have that <math|D<rsub|1><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>=D<around*|(|<around*|(|<around*|(|f\<circ\>\<psi\>|)>\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>|)>|)><around*|(|x|)>=0>
    so that\ 

    <\equation>
      <label|eq 12.133>D<rsub|1><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>=0
      <around*|[|<text|the neutral element in> L<around*|(|X,Z|)>|]>
    </equation>

    Also\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|\<pi\><rsub|1><rsup|X\<times\>Z>\<circ\><around*|(|\<psi\>\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>|)>|)><around*|(|t|)>>|<cell|=>|<cell|\<pi\><rsub|1><rsup|X\<times\>Z><around*|(|\<psi\><around*|(|<around*|(|1\<rightarrow\><around*|(|x,z|)>|)><around*|(|t|)>|)>|)><rsub|>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|1><rsup|X\<times\>Z><around*|(|\<psi\><around*|(|t,z|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|1><rsup|X\<times\>Z><around*|(|t,g<around*|(|t,z|)>|)>>>|<row|<cell|>|<cell|=>|<cell|t>>|<row|<cell|>|<cell|=>|<cell|\<bbb-1\><rsub|X><around*|(|t|)>>>>>
    </eqnarray*>

    and

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|\<pi\><rsub|2><rsup|X\<times\>Z>\<circ\><around*|(|\<psi\>\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>|)>|)><around*|(|t|)>>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|\<psi\><around*|(|<around*|(|1\<rightarrow\><around*|(|x,z|)>|)><around*|(|t|)>|)>|)><rsub|>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|\<psi\><around*|(|t,z|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|t,g<around*|(|t,z|)>|)>>>|<row|<cell|>|<cell|=>|<cell|g<around*|(|t,z|)>>>|<row|<cell|>|<cell|=>|<cell|g<around*|(|<around*|(|1\<rightarrow\><around*|(|x,z|)>|)><around*|(|t|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|g\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>|)><around*|(|t|)>>>>>
    </eqnarray*>

    proving that\ 

    <\equation>
      <label|eq 14.259.112>\<pi\><rsup|X\<times\>Z><rsub|1>\<circ\><around*|(|\<psi\>\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>|)>=\<bbb-1\><rsub|X>
    </equation>

    <\equation>
      <label|eq 14.260.112>\<pi\><rsub|2><rsup|X\<times\>Z>\<circ\><around*|(|\<psi\>\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>|)>=g\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>
    </equation>

    We can now recalculate <math|D<rsub|1><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>>
    as follows\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|D<rsub|1><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>|)><around*|(|h|)>>|<cell|\<equallim\><rsub|<text|<reference|chain
      rules of partial differentiable functions>>>>|<cell|>>|<row|<cell|<around*|(|D
      f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\>D<rsub|1>\<psi\><around*|(|x,z|)>|)><around*|(|h|)>>|<cell|\<equallim\><rsub|def>>|<cell|>>|<row|<cell|<around*|(|D
      f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\>D<around*|(|\<psi\>\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)>|)><around*|(|x|)>|)><around*|(|h|)>>|<cell|\<equallim\><rsub|<text|<reference|eq
      14.259.112>,<reference|eq 14.260.112>,<reference|differentiability of
      map to product of spaces>>>>|<cell|>>|<row|<cell|<around*|(|D
      f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\><around*|(|D\<bbb-1\><rsub|X><around*|(|x|)>,D<around*|(|g\<circ\><around*|(|1\<rightarrow\><around*|(|x,z|)>|)><around*|(|x|)>|)>|)>|)><around*|(|h|)>>|<cell|\<equallim\><rsub|def>>|<cell|>>|<row|<cell|<around*|(|D
      f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\><around*|(|\<bbb-1\><rsub|X>,D<rsub|1>g<around*|(|x,z|)>|)>|)><around*|(|h|)>>|<cell|=>|<cell|>>|<row|<cell|<around*|(|D
      f<around*|(|\<psi\><around*|(|x,z|)>|)><around*|(|h,D<rsub|1>g<around*|(|x,z|)><around*|(|h|)>|)>|\<nobracket\>>>|<cell|\<equallim\><rsub|<text|<reference|differentiability
      on products of metric spaces>>>>|<cell|>>|<row|<cell|D<rsub|1>f<around*|(|\<psi\><around*|(|x,z|)>|)><around*|(|h|)>+D<rsub|2>f<around*|(|\<psi\><around*|(|x,z|)>|)><around*|(|D<rsub|1>g<around*|(|x,z|)><around*|(|h|)>|)>>|=|<cell|>>|<row|<cell|D<rsub|1>f<around*|(|\<psi\><around*|(|x,z|)>|)><around*|(|h|)>+<around*|(|D<rsub|2>f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\>D<rsub|1>g<around*|(|x,z|)>|)><around*|(|h|)>>|<cell|=>|<cell|>>|<row|<cell|<around*|(|D<rsub|1>f<around*|(|\<psi\><around*|(|x,z|)>|)>+D<rsub|2>f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\>D<rsub|1>g<around*|(|x,z|)>|)><around*|(|h|)>>|<cell|\<equallim\><rsub|def
      of \<psi\>>>|<cell|>>|<row|<cell|<around*|(|D<rsub|1>f<around*|(|x,g<around*|(|x,z|)>|)>+<around*|\<nobracket\>|D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>\<circ\>D<rsub|1>g<around*|(|x,z|)>|)>|\<nobracket\>><around*|(|h|)>>|<cell|>|<cell|>>>>
    </eqnarray*>

    Proving that <math|D<rsub|1><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>=><math|D<rsub|1>f<around*|(|x,g<around*|(|x,z|)>|)>+<around*|\<nobracket\>|D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>\<circ\>D<rsub|1>g<around*|(|x,z|\<nobracket\>>|)>>
    which as by <reference|eq 12.133> <math|D<rsub|1><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>>=0
    gives

    <\equation*>
      D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>\<circ\>D<rsub|1>g<around*|(|x,z|)>=-D<rsub|1>f<around*|(|x,g<around*|(|x,z|)>|)>
    </equation*>

    Using <reference|eq 14.260.113> gives\ 

    <\equation>
      \<forall\><around*|(|x,z|)>\<in\>W<rsub|o><text|
      >D<rsub|1>g<around*|(|x,z|)>=-<around*|[|D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>|]><rsup|-1>\<circ\>D<rsub|1>f<around*|(|x,g<around*|(|x,z|)>|)>
    </equation>

    proving (3.b) of the theorem.

    To prove <math|<around*|(|3.c|)>> note that

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|\<pi\><rsub|2><rsup|X\<times\>Z>\<circ\><around*|(|2\<rightarrow\><around*|(|x,z|)>|)>|)><around*|(|t|)>>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|<around*|(|2\<rightarrow\><around*|(|x,z|)>|)><around*|(|t|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<pi\><rsub|2><rsup|X\<times\>Z><around*|(|x,t|)>>>|<row|<cell|>|<cell|=>|<cell|t>>|<row|<cell|>|<cell|=>|<cell|\<bbb-1\><rsub|Z><around*|(|t|)><eq-number><label|eq
      14.267.113>>>>>
    </eqnarray*>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|D<rsub|2><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>>|<cell|\<equallim\><rsub|<text|<reference|eq
      12.132>>>>|<cell|D<around*|(|\<pi\><rsub|2><rsup|X\<times\>Z>\<circ\><around*|(|2\<rightarrow\><around*|(|x,z|)>|)>|)><around*|(|z|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<reference|eq
      14.267.113>>>|<cell|D<around*|(|\<bbb-1\><rsub|Z>|)><around*|(|z|)>>>|<row|<cell|>|<cell|=>|<cell|\<bbb-1\><rsub|Z><eq-number><label|eq
      14.268.113>>>>>
    </eqnarray*>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|\<psi\>\<circ\><around*|(|2\<rightarrow\><around*|(|x,z|)>|)>|)><around*|(|t|)>>|<cell|=>|<cell|\<psi\><around*|(|<around*|(|2\<rightarrow\><around*|(|x,z|)>|)><around*|(|t|)>|)>>>|<row|<cell|>|<cell|=>|<cell|\<psi\><around*|(|x,t|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|<reference|eq
      12.131>>>>|<cell|<around*|(|x,g<around*|(|x,t|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|C<rsub|Z,X,x><around*|(|t|)>,<around*|(|g\<circ\><around*|(|2\<rightarrow\><around*|(|x,z|)>|)><around*|(|t|)>|)>|)>>>>>
    </eqnarray*>

    proving that\ 

    <\equation>
      <label|eq 14.269.113>\<pi\><rsub|1><rsup|X\<times\>Z>\<circ\><around*|(|\<psi\>\<circ\><around*|(|2\<rightarrow\><around*|(|x,z|)>|)>|)>=C<rsub|Z,X,x><infix-and>\<pi\><rsub|2><rsup|X\<times\>Z>\<circ\><rsup|><around*|(|\<psi\>\<circ\><around*|(|2\<rightarrow\><around*|(|x,z|)>|)>|)>=g\<circ\><around*|(|2\<rightarrow\><around*|(|x,z|)>|)>
    </equation>

    We calculate now <math|D<rsub|2><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>>
    in another way

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|D<rsub|2><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>|)><around*|(|h|)>>|<cell|\<equallim\><rsub|<text|<reference|chain
      rules of partial differentiable functions>>>>|<cell|>>|<row|<cell|<around*|(|D
      f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\>D<rsub|2>\<psi\><around*|(|x,z|)>|)><around*|(|h|)>>|<cell|\<equallim\><rsub|def>>|<cell|>>|<row|<cell|D
      f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\>D<around*|(|<around*|(|\<psi\>\<circ\><around*|(|2\<rightarrow\><around*|(|x,z|)>|)>|)><around*|(|x,z|)>|)><around*|(|h|)>>|<cell|\<equallim\><rsub|<text|<reference|eq
      14.269.113>,<reference|differentiability of map to product of
      spaces>>>>|<cell|>>|<row|<cell|<around*|(|D
      f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\><around*|(|D
      C<rsub|Z,X,x>,D<around*|(|g\<circ\><around*|(|2\<rightarrow\><around*|(|x,z|)>|)><around*|(|x|)>|)>|)>|)><around*|(|h|)>>|<cell|=>|<cell|>>|<row|<cell|<around*|(|D
      f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\><around*|(|0,D<rsub|2>g<around*|(|x,z|)>|)>|)><around*|(|h|)>>|<cell|=>|<cell|>>|<row|<cell|D
      f<around*|(|\<psi\><around*|(|x,z|)>|)><around*|(|0,D<rsub|2>g<around*|(|x,z|)><around*|(|h|)>|)>>|<cell|\<equallim\><rsub|<text|<reference|differentiability
      on products of metric spaces>>>>|<cell|>>|<row|<cell|D<rsub|1>f<around*|(|\<psi\><around*|(|x,z|)>|)><around*|(|0|)>+D<rsub|2>f<around*|(|\<psi\><around*|(|x,z|)>|)><around*|(|D<rsub|2>g<around*|(|x,z|)><around*|(|h|)>|)>>|<cell|=>|<cell|>>|<row|<cell|D<rsub|2>f<around*|(|\<psi\><around*|(|x,z|)>|)><around*|(|D<rsub|2>g<around*|(|x,z|)><around*|(|h|)>|)>>|<cell|=>|<cell|>>|<row|<cell|<around*|(|D<rsub|2>f<around*|(|\<psi\><around*|(|x,z|)>|)>\<circ\>D<rsub|2>g<around*|(|x,z|)>|)><around*|(|h|)>>|<cell|\<equallim\><rsub|<text|<reference|eq
      12.131>>>>|<cell|>>|<row|<cell|<around*|(|D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>\<circ\>D<rsub|2>g<around*|(|x,z|)>|)>>|<cell|>|<cell|>>>>
    </eqnarray*>

    proving that <math|D<rsub|2><around*|(|f\<circ\>\<psi\>|)><around*|(|x,z|)>=D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>\<circ\>D<rsub|2>g<around*|(|x,z|)>>
    or using <reference|eq 14.268.113> <math|\<bbb-1\><rsub|Z>=D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>\<circ\>D<rsub|2>g<around*|(|x,z|)>>
    giving using <reference|eq 14.260.113> that\ 

    <\equation>
      \<forall\><around*|(|x,z|)>\<in\>W<rsub|0> <text| we have
      >D<rsub|2>g<around*|(|x,z|)>=<around*|[|D<rsub|2>f<around*|(|x,g<around*|(|x,z|)>|)>|]><rsup|-1>
    </equation>

    proving (3.c) of the theorem.
  </proof>
  ...
  <\theorem>
    ...
    <math|g:W\<rightarrow\>V> such that <math|g<around*|(|x<rsub|0>|)>=y<rsub|0>>
    and <math|\<forall\>x\<in\>W> we have
    <math|f<around*|(|x,g<around*|(|x|)>|)>=f<around*|(|x<rsub|0>,z<rsub|0>|)>>.
    Further <math|\<forall\>x\<in\>W> <math|<around*|(|D<rsub|2>f<around*|(|x,g<around*|(|x|)>|)>|)><rsup|-1>>
    exist and <math|D g<around*|(|x|)>=-<around*|(|D<rsub|2>f<around*|(|x,g<around*|(|x|)>|)>|)><rsup|-1>\<circ\>D<rsub|1>f<around*|(|x,g<around*|(|x|)>|)>>
  </theorem>

  <\proof>
    Using the Implicit Function Theorem [see <reference|implicit function
    theorem>] there exists a open set <math|W<rsub|0>\<subseteq\>U\<times\>Z>
    with <math|<around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>\<in\>W<rsub|0>>,
    a open set <math|V<rsub|0>\<subseteq\>V> and a <math|C<rsup|r>> function
    <math|g<rprime|'>:W<rsub|0>\<rightarrow\>V<rsub|0>\<subseteq\>V> such
    that

    <\equation>
      <label|eq 14.271.114>g<rprime|'><around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>=y<rsub|0>
    </equation>

    and <math|\<forall\><around*|(|x,y|)>\<in\>W<rsub|0>> we have\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|>|<cell|<around*|[|D<rsub|2>f<around*|(|x,g<rprime|'><around*|(|x,z|)>|)>|]><rsup|-1><text|
      exists>>|<cell|<eq-number><label|eq
      14.272.114>>>|<row|<cell|>|<cell|f<around*|(|x,g<rprime|'><around*|(|x,z|)>|)>=z>|<cell|<eq-number><label|eq
      14.273.114>>>|<row|<cell|>|<cell|D<rsub|1>g<rprime|'><around*|(|x,z|)>=-<around*|[|D<rsub|2>f<around*|(|x,g<rprime|'><around*|(|x,z|)>|)>|]><rsup|-1>\<circ\>D<rsub|1>f<around*|(|x,g<rprime|'><around*|(|x,z|)>|)>>|<cell|<eq-number><label|eq
      14.274.114>>>|<row|<cell|>|<cell|D<rsub|2>g<rprime|'><around*|(|x,z|)>=<around*|[|D<rsub|2>f<around*|(|x,g<rprime|'><around*|(|x,z|)>|)>|]><rsup|-1>>|<cell|<eq-number><label|eq
      14.275.114>>>>>
    </eqnarray*>

    Using the definition of the product topology on <math|X\<times\>Y> [see
    <reference|box topology> and <reference|finite product topology is box
    topology>] there exist open sets there exists a open set <math|W> in
    <math|X> and a open set <math|R> in <math|Z> such that\ 

    <\equation*>
      W\<times\>R\<subseteq\>U\<times\>Z<text| and
      ><around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>\<in\>W\<times\>R
    </equation*>

    then <math|<around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>\<in\>W\<times\>R>
    and <math|\<forall\>x\<in\>W> we have that
    <math|<around*|(|x,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>\<in\>U\<times\>Z>
    so that the following function is welll defined

    <\equation>
      <label|eq 14.276.114>g:W\<rightarrow\>V by
      \ g<around*|(|x|)>=g<rprime|'><around*|(|x,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>
    </equation>

    then we have\ 

    <\equation>
      <label|eq 14.277.114>g<around*|(|x<rsub|0>|)>=g<rprime|'><around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>=y<rsub|0>
    </equation>

    Further <math|f<around*|(|x,g<around*|(|x|)>|)>=f<rprime|'><around*|(|x,g<rprime|'><around*|(|x,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>|)>\<equallim\><rsub|<text|<reference|eq
    14.273.114>>>f<around*|(|x<rsub|0>,y<rsub|0>|)>> hence\ 

    <\equation>
      <label|eq 14.278.114>f<around*|(|x,g<around*|(|x|)>|)>=f<around*|(|x<rsub|0>,y<rsub|0>|)>
    </equation>

    Further\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|g<rprime|'>\<circ\><around*|(|1\<rightarrow\><around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>|)>|)><around*|(|x|)>>|<cell|=>|<cell|g<rprime|'><around*|(|<around*|(|1\<rightarrow\><around*|(|x<rsub|0>,f<around*|(|x<rsub|9>,y<rsub|0>|)>|)><around*|(|x|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|g<rprime|'><around*|(|x,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|g<around*|(|x|)>>>>>
    </eqnarray*>

    which proves that\ 

    <\equation*>
      g=g<rprime|'>\<circ\><around*|(|1\<rightarrow\><around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>|)>
    </equation*>

    Using now the Chain Rule [see <reference|generalized chain rule>] we have
    using the fact that <math|<around*|(|1\<rightarrow\><around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>|)>>
    is <math|C<rsup|\<infty\>>> and <math|g<rprime|'>> is <math|C<rsup|r>>
    \ that\ 

    <\equation*>
      g is of class C<rsup|r>
    </equation*>

    and for <math|x\<in\>W>

    <\eqnarray*>
      <tformat|<table|<row|<cell|D g<around*|(|x|)>>|<cell|=>|<cell|D<around*|(|g<rprime|'>\<circ\><around*|(|1\<rightarrow\><around*|(|x<rsub|0>,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>|)>|)><around*|(|x|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|def>>|<cell|D<rsub|1>g<rprime|'><around*|(|x,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|-<around*|[|D<rsub|2>f<around*|(|x,g<rprime|'><around*|(|x,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>|)>|]><rsup|-1>\<circ\>D<rsub|1>f<around*|(|x,g<rprime|'><around*|(|x,f<around*|(|x<rsub|0>,y<rsub|0>|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|-<around*|[|D<rsub|2>f<around*|(|x,g<around*|(|x|)>|)>|]><rsup|-1>\<circ\>D<rsub|1>f<around*|(|x,g<around*|(|x|)>|)><eq-number><label|eq
      14.279.114>>>>>
    </eqnarray*>

    The theorem is then proved by <reference|eq 14.276.114>, <reference|eq
    14.277.114> and <reference|eq 14.278.114>.
  </proof>
...
<\references>
  <\collection>
    <associate|(-H)^n|<tuple|14.144|?>>
    <associate|(01,..,*,..,On) is C@@|<tuple|14.76|452>>
    <associate|(f1,..fn)|<tuple|14.42|?>>
    <associate|(i-\<gtr\>x)-1(A)|<tuple|14.28|?>>
    <associate|(x,h)-\<gtr\>Df(x)(h) differentiability|<tuple|14.86|432>>
    ...
    <associate|C1 of real or complex function|<tuple|14.58|423>>
    <associate|C^2 differential is symmetric|<tuple|14.122|447>>
    <associate|C^@@=@@-times differentiable|<tuple|14.61|424>>
    <associate|C^n implies C^m|<tuple|14.63|424>>
    <associate|C^n is a local property|<tuple|14.70|427>>
    <associate|C^n of multivalued functions|<tuple|14.81|430>>
    <associate|C^n+m=\<gtr\>c^n is C^m|<tuple|14.64|?>>
    <associate|C^n=\<gtr\>C^n is C^1|<tuple|14.65|?>>
    <associate|D(g@f) where g is multivalued|<tuple|14.44|?>>
    <associate|D1 and composition|<tuple|14.82|?>>
    <associate|D^2g(x)(u)(v)=D^nf(x)(v:u:v1..vn-2)|<tuple|14.126|450>>
    <associate|D^nf(x)(h1:..hn)=D^(n-1)f(x)(h1:..hn-1)(hn)|<tuple|14.85|431>>
    <associate|GL(X) is a group|<tuple|14.142|458>>
    <associate|I+H has inverse if norm of H is less then
    1|<tuple|14.149|461>>
    <associate|Jacobian Matrix|<tuple|14.45|421>>
    <associate|Jacobian of linear map|<tuple|14.46|?>>
    <associate|L0,1=[0,1]|<tuple|14.113|?>>
    <associate|Mean Value Theorem 3|<tuple|14.115|447>>
    <associate|Mean value theorem 1|<tuple|14.108|445>>
    <associate|Mean value theorem 2|<tuple|14.111|446>>
    <associate|Mean value theorem for balls|<tuple|14.116|?>>
    <associate|T,S|<tuple|14.168|?>>
    ...
    <associate|balls are convex|<tuple|14.110|445>>
    ...
    diffeomorphism|<tuple|14.157|465>>
    <associate|composition of differentials on arbitrary
    sets|<tuple|14.89|438>>
    <associate|condition for concavity (convexitivity)|<tuple|14.103|?>>
    <associate|conditions for minimum,maximum of a function|<tuple|14.105|?>>
    <associate|consequence of mean value theorem (2)|<tuple|14.121|?>>
    <associate|constant functions are C^infinite|<tuple|14.74|428>>
    <associate|continuity of partial derivates|<tuple|14.130|?>>
    <associate|continuous billinear functions are
    C^infinity|<tuple|14.78|429>>
    <associate|convex, concave functions|<tuple|14.101|?>>
    <associate|derivative|<tuple|14.18|416>>
    <associate|derivative and composition|<tuple|14.24|?>>
    <associate|derivative and local minimum (maximum)|<tuple|14.104|?>>
    <associate|derivative is local|<tuple|14.20|?>>
    <associate|derivative of product|<tuple|14.49|?>>
    <associate|derivative on a closed interval|<tuple|14.92|?>>
    <associate|diffeomorphism are toplinear|<tuple|14.156|?>>
    <associate|diffeomorphism is a local property|<tuple|14.154|?>>
    ...
    differentiability|<tuple|14.131|453>>
    <associate|differentiability of K^n|<tuple|14.40|420>>
    <associate|differentiability of finite sum|<tuple|14.73|428>>
    <associate|differentiability of map to product of
    spaces|<tuple|14.43|420>>
    <associate|differentiability of product of functions|<tuple|14.48|421>>
    <associate|differentiability on [a,b]|<tuple|<with|mode|<quote|math>|f<rprime|'><rsub|-><around*|(|x|)>>|438>>
    <associate|differentiability on [a,b] equivalences|<tuple|14.93|439>>
    <associate|differentiability on products of metric
    spaces|<tuple|14.35|419>>
    <associate|differential and partial differentials|<tuple|14.132|?>>
    <associate|differential of a billinear mapping|<tuple|14.47|421>>
    <associate|differential of a function|<tuple|14.8|414>>
    <associate|differential of a linear function|<tuple|14.17|416>>
    <associate|differential of function of many variables|<tuple|14.134|?>>
    ...
    <associate|eq 12.105.1|<tuple|14.215|?>>
    ...
    <associate|eq 12.128|<tuple|14.249|470>>
    <associate|eq 12.129|<tuple|14.250|?>>
    <associate|eq 12.130|<tuple|14.253|470>>
    <associate|eq 12.131|<tuple|14.261|471>>
    <associate|eq 12.132|<tuple|14.262|471>>
    <associate|eq 12.133|<tuple|14.263|471>>
    ...
    <associate|eq 12.95|<tuple|14.162|466>>
    ...
    <associate|eq 14.221.111|<tuple|14.223|?>>
    <associate|eq 14.221.112|<tuple|14.221|?>>
    <associate|eq 14.222.111|<tuple|14.224|?>>
    <associate|eq 14.222.112|<tuple|14.222|?>>
    <associate|eq 14.223.111|<tuple|14.225|?>>
    <associate|eq 14.224.111|<tuple|14.226|?>>
    <associate|eq 14.225.111|<tuple|14.227|?>>
    <associate|eq 14.226.111|<tuple|14.228|?>>
    <associate|eq 14.227.111|<tuple|14.229|?>>
    <associate|eq 14.228.111|<tuple|14.230|?>>
    <associate|eq 14.229.111|<tuple|14.231|?>>
    <associate|eq 14.23.014|<tuple|14.39|?>>
    <associate|eq 14.23.110|<tuple|14.23|?>>
    <associate|eq 14.230.111|<tuple|14.232|?>>
    <associate|eq 14.231.111|<tuple|14.233|?>>
    <associate|eq 14.232.111|<tuple|14.234|?>>
    <associate|eq 14.233.111|<tuple|14.235|?>>
    <associate|eq 14.234.111|<tuple|14.236|?>>
    <associate|eq 14.237.112|<tuple|14.237|?>>
    <associate|eq 14.238.112|<tuple|14.238|?>>
    <associate|eq 14.239.112|<tuple|14.239|?>>
    <associate|eq 14.24.101|<tuple|14.40|?>>
    <associate|eq 14.24.104|<tuple|14.38|?>>
    <associate|eq 14.24.110|<tuple|14.24|?>>
    <associate|eq 14.240.114|<tuple|14.240|?>>
    <associate|eq 14.242.112|<tuple|14.242|?>>
    <associate|eq 14.244.112|<tuple|14.244|?>>
    <associate|eq 14.246.112|<tuple|14.246|?>>
    <associate|eq 14.247.112.3|<tuple|14.247|?>>
    <associate|eq 14.248.113|<tuple|14.248|?>>
    <associate|eq 14.249.112|<tuple|14.252|?>>
    <associate|eq 14.25.101|<tuple|14.41|?>>
    <associate|eq 14.25.110|<tuple|14.25|?>>
    <associate|eq 14.252.112.2|<tuple|14.254|?>>
    <associate|eq 14.256.112.3|<tuple|14.257|?>>
    <associate|eq 14.258.112.4|<tuple|14.258|?>>
    <associate|eq 14.259.112|<tuple|14.264|?>>
    <associate|eq 14.259.112.4|<tuple|14.259|?>>
    <associate|eq 14.26.101|<tuple|14.42|?>>
    <associate|eq 14.260.112|<tuple|14.265|?>>
    <associate|eq 14.260.113|<tuple|14.260|?>>
    <associate|eq 14.267.113|<tuple|14.267|?>>
    <associate|eq 14.268.113|<tuple|14.268|?>>
    <associate|eq 14.269.113|<tuple|14.269|?>>
    <associate|eq 14.27.101|<tuple|14.43|?>>
    <associate|eq 14.271.114|<tuple|14.271|?>>
    <associate|eq 14.272.114|<tuple|14.272|?>>
    <associate|eq 14.273.114|<tuple|14.273|?>>
    <associate|eq 14.274.114|<tuple|14.274|?>>
    <associate|eq 14.275.114|<tuple|14.275|?>>
    <associate|eq 14.276.114|<tuple|14.276|?>>
    <associate|eq 14.277.114|<tuple|14.277|?>>
    <associate|eq 14.278.114|<tuple|14.278|?>>
    <associate|eq 14.279.114|<tuple|14.279|?>>
    ...
    <associate|equivalences of convexitivity (concavity)|<tuple|14.102|?>>
    <associate|evaluation operator (1)|<tuple|14.124|?>>
    <associate|extremum and derivate|<tuple|14.96|442>>
    <associate|f is C infinite if D1f is c infinite|<tuple|14.68|?>>
    <associate|f_v is differentiable|<tuple|14.84|431>>
    <associate|fundamental theorem of calculus|<tuple|14.107|444>>
    <associate|g is differentiable|<tuple|14.164|?>>
    <associate|generalized chain rule|<tuple|14.83|430>>
    <associate|higher order differential and partial
    derivates|<tuple|14.138|?>>
    <associate|i the substitution|<tuple|14.29|?>>
    <associate|i-H has inverse if norm of H is lower then
    1|<tuple|14.148|459>>
    <associate|if f is C^n then D^1f is C^n-1|<tuple|14.67|426>>
    <associate|implicit function theorem|<tuple|14.169|470>>
    <associate|in Banach spaces linear continuous mappings are
    toplinear|<tuple|14.140|458>>
    <associate|inverse function theorem|<tuple|14.159|465>>
    <associate|inverse mapping is c-infinite|<tuple|14.150|461>>
    <associate|inverse of derivative|<tuple|14.167|?>>
    <associate|inverse theorem for Df(0)=1X|<tuple|14.160|465>>
    <associate|lagranges theorem|<tuple|14.98|443>>
    <associate|left,right derivatives|<tuple|14.91|?>>
    <associate|lemma 14.119|<tuple|14.125|?>>
    <associate|lemma 14.121|<tuple|14.127|?>>
    <associate|lemma for diedonne main value|<tuple|14.118|?>>
    <associate|linear continuous mappings are C^infinity|<tuple|14.75|428>>
    <associate|linear isomrophisms between b=Banach spaces are
    C^oo|<tuple|14.153|?>>
    <associate|linearity of (01,...*,...0n)|<tuple|14.30|417>>
    <associate|mean value theorem (3)|<tuple|14.119|?>>
    <associate|n-times differentiability implies m-times
    differentiability|<tuple|14.62|424>>
    <associate|n-times differentiability is local|<tuple|14.69|426>>
    <associate|n-times differentiability is same as n-1 times
    differentiability of DF|<tuple|14.66|425>>
    <associate|n-times differentiability of multi valued
    function|<tuple|14.80|429>>
    <associate|nth derivate|<tuple|14.56|?>>
    <associate|partial derivate of higher order and partial
    differential|<tuple|14.137|?>>
    ...
    product|<tuple|14.37|?>>
    <associate|partial differential on U|<tuple|14.129|453>>
    <associate|power of a continuous linear mapping is linear and
    continuous|<tuple|14.145|458>>
    <associate|product of n-times differentiable functions is n-times
    differentiable|<tuple|14.87|432>>
    <associate|projection map is infinite times dimensions|<tuple|14.79|429>>
    <associate|proposition 12.116|<tuple|14.161|466>>
    <associate|proposition 12.118|<tuple|14.163|467>>
    <associate|proposition 12.120|<tuple|14.165|469>>
    <associate|rolles theorem|<tuple|14.97|443>>
    <associate|second mean value theorem|<tuple|14.117|447>>
    <associate|strictly increasing function and derivative|<tuple|14.99|?>>
    <associate|sum of (01,...,*,...0n)|<tuple|14.31|417>>
    <associate|sum of C^n functions is C^n|<tuple|14.72|427>>
    <associate|sum of differentiable functions|<tuple|14.21|417>>
    <associate|sum of linear function and infinite sum|<tuple|14.147|459>>
    <associate|sum of n-times differentiable functions is n-times
    differentiable|<tuple|14.71|427>>
    <associate|symmetry of L^n+t(X;Y) based on permutations and
    transposition|<tuple|14.123|449>>
    <associate|symmetry of partial differentials|<tuple|14.133|?>>
    <associate|the n-th differential is symmetric|<tuple|14.128|450>>
    <associate|toplinear in normed space|<tuple|14.139|457>>
    <associate|translations are C-infinity|<tuple|14.77|428>>
    <associate|uniqueness of differential|<tuple|14.7|413>>
    <associate|x+t.y is C infinite|<tuple|14.94|?>>
    <associate|x+t.y is C1 (1)|<tuple|14.60|?>>
  </collection>
</references>
