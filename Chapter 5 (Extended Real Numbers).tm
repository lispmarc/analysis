...
<\references>
  <\collection>
    <associate|(a-b)+(c-d)=(a+c)-(b+d)|<tuple|17.24|616>>
    <associate|-sup A=inf -A|<tuple|17.30|619>>
    <associate|0\<less\>=y then z=x+y=\<gtr\>z\<less\>=y|<tuple|17.22|616>>
    ...
    <associate|x\<less\>=y=\<gtr\>x+z\<less\>=y+z|<tuple|17.20|614>>
